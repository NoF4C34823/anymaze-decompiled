...
void FUN_140880540(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140880ef3:
      uVar49 = 0;
      if (param_3 == 0) goto LAB_140880787;
      uVar47 = 0;
      uVar50 = param_3;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140880ef3;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_140880ef3;
      ...
      if (uVar50 != 0) {
        do {
          *(float *)(param_2 + uVar47 * 4) =
               fVar6 * (float)((int)*(short *)(lVar44 + uVar47 * 2) +
                              (int)*(short *)(lVar45 + uVar47 * 2));
          uVar47 = uVar47 + 1;
        } while (uVar47 < uVar50);
      }
      ...
      if (param_3 < uVar49 + 1) goto LAB_140880787;
    ...
    if (uVar47 < uVar50) {
      do {
        *(float *)(param_2 + uVar49 * 4 + uVar47 * 4) =
             fVar6 * (float)((int)*(short *)(lVar53 * -2 + param_1 + uVar49 * 2 + uVar47 * 2) +
                            (int)*(short *)(param_1 + lVar53 * 2 + uVar49 * 2 + uVar47 * 2));
        uVar47 = uVar47 + 1;
      } while (uVar47 < uVar50);
    }
  }
      ...
      do {
        ...
        if (0 < (longlong)param_3) {
            ...
            if (uVar50 != 0) {
              do {
                *(float *)(param_2 + uVar54 * 4) =
                     fVar6 * (float)((int)*(short *)(lVar56 + 2) + (int)*(short *)(lVar55 + -2)) +
                     *(float *)(param_2 + uVar54 * 4) +
                     fVar69 * (float)((int)*(short *)(lVar56 + 4) + (int)*(short *)(lVar55 + -4));
                uVar54 = uVar54 + 1;
                lVar55 = lVar55 + 2;
                lVar56 = lVar56 + 2;
              } while (uVar54 < uVar50);
          ...
          if (uVar57 < param_3) {
            ...
            do {
              psVar1 = (short *)(lVar55 + 2);
              psVar2 = (short *)(lVar56 + -2);
              psVar3 = (short *)(lVar56 + -4);
              psVar4 = (short *)(lVar55 + 4);
              lVar55 = lVar55 + 2;
              lVar56 = lVar56 + 2;
              *(float *)(param_2 + uVar57 * 4) =
                   fVar6 * (float)((int)*psVar1 + (int)*psVar2) + *(float *)(param_2 + uVar57 * 4) +
...
LAB_140880ecd:
          uVar49 = 0;
          if (param_3 == 0) goto LAB_140880cf2;
          uVar47 = 0;
          uVar50 = param_3;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140880ecd;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_140880ecd;
          ...
          if (uVar50 != 0) {
            do {
              *(float *)(param_2 + uVar47 * 4) =
                   fVar6 * (float)((int)*(short *)(lVar46 + uVar47 * 2) +
                                  (int)*(short *)(lVar55 + uVar47 * 2)) +
                   *(float *)(param_2 + uVar47 * 4);
              uVar47 = uVar47 + 1;
            } while (uVar47 < uVar50);
          }
          ...
          if (param_3 < uVar49 + 1) goto LAB_140880cf2;
          uVar50 = param_3 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar47 = 0;
          }
        ...
        if (uVar47 < uVar50) {
          ...
          do {
            ...
            lVar55 = uVar47 * 2;
            uVar47 = uVar47 + 1;
            *pfVar48 = fVar6 * (float)((int)*(short *)(lVar44 + lVar45 * 2 + param_1 + uVar49 * 2 +
                                                      lVar46) +
                                      (int)*(short *)(param_1 + lVar45 * -2 + lVar53 * 2 +
                                                      uVar49 * 2 + lVar55)) + *pfVar48;
            pfVar48 = pfVar48 + 1;
          } while (uVar47 < uVar50);
        }
      }
...
LAB_140880eba:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140880eba;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_140880eba;
    uVar47 = 0;
    uVar49 = param_3 - (param_3 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
        *(float *)(param_2 + uVar47 * 4) =
             fVar6 * (float)(int)*(short *)(lVar51 + 2 + uVar47 * 2) +
             *(float *)(param_2 + uVar47 * 4);
        uVar47 = uVar47 + 1;
      } while (uVar47 < uVar50);
    }
...
LAB_140880e64:
  if (uVar50 < param_3) {
    ...
    do {
      lVar53 = uVar50 * 2;
      uVar50 = uVar50 + 1;
      *pfVar48 = fVar6 * (float)(int)*(short *)(lVar51 + uVar49 * 2 + 2 + lVar53) + *pfVar48;
      pfVar48 = pfVar48 + 1;
