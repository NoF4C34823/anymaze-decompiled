...
void FUN_140370120(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)uVar4) {
          ...
          do {
            ...
            if (0 < (longlong)uVar36) {
              ...
              for (; bVar39 = bVar40, uVar29 < uVar36; uVar29 = uVar29 + 1) {
                if (bVar39 < *(byte *)(uVar29 + uVar26)) {
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        if (0 < (longlong)uVar4) {
          ...
          do {
            ...
            if (0 < (longlong)uVar32) {
              ...
              for (; bVar39 = bVar40, uVar38 < uVar32; uVar38 = uVar38 + 1) {
                if (bVar39 < *(byte *)(uVar38 + uVar33)) {
        ...
        FUN_140374ca0(param_9,uVar37,param_3,uVar4,uVar34);
        uVar30 = uVar30 + 1;
        uVar34 = param_6[1];
