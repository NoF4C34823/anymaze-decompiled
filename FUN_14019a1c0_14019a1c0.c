...
void FUN_14019a1c0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_14019a41b:
    ...
    uVar20 = param_2 & 0xf;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14019a41b;
      uVar20 = 0x10 - uVar20 >> 2;
    }
    if ((longlong)uVar21 < (longlong)(uVar20 + 8)) goto LAB_14019a41b;
    uVar17 = 0;
