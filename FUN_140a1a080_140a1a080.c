...
void FUN_140a1a080(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4,int param_5)
  ...
  if (0 < (longlong)param_3) {
    ...
    if ((longlong)param_3 < 0x10) {
      ...
      if ((longlong)param_3 < 0x86) {
        ...
        if (uVar27 != 0) {
          uVar33 = 0;
          auVar57 = vmovdqu32_avx512f(_DAT_14308e980);
          auVar58 = vmovdqu32_avx512f(_DAT_14308e9c0);
          ...
          do {
            ...
            auVar61 = vpmovsxwd_avx512f(auVar39);
            auVar62 = vpmovsxwd_avx512f(auVar40);
          ...
          if (param_3 == uVar27) goto LAB_140a1a2a4;
        }
      }
      if ((longlong)(uVar27 + 0x10) <= (longlong)uVar26) {
        auVar63 = vbroadcastss_avx512f(auVar69);
        do {
          auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar23 * -2 + param_1 + uVar27 * 2));
          auVar58 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(param_1 + lVar23 * 2 + uVar27 * 2));
    ...
    if (uVar26 + 1 <= param_3) {
      ...
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_14308e980);
      bVar18 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_14308e9c0);
      bVar17 = (byte)uVar16;
      uVar37 = CONCAT11(bVar17,bVar18);
      ...
      auVar63 = vpmovsxwd_avx512f(auVar41);
      auVar58 = vpmovsxwd_avx512f(auVar42);
        ...
        if (0 < (longlong)param_3) {
          ...
          if ((longlong)param_3 < 0x10) {
            ...
            if ((longlong)param_3 < 0x53) {
              ...
              if (uVar32 != 0) {
                ...
                do {
                  ...
                  auVar65 = vpmovsxwd_avx512f(auVar43);
                  auVar66 = vpmovsxwd_avx512f(auVar44);
                  ...
                  *puVar1 = (uint)(bVar18 & 1) * auVar67._0_4_ | (uint)!(bool)(bVar18 & 1) * *puVar1
                  ...
                  auVar65 = vpmovsxwd_avx512f(auVar45);
                  auVar66 = vpmovsxwd_avx512f(auVar46);
                  auVar65 = vpaddd_avx512f(auVar65,auVar66);
                  lVar24 = lVar24 + 0x20;
                  auVar65 = vcvtdq2ps_avx512f(auVar65);
                ...
                if (param_3 == uVar32) goto LAB_140a1a62e;
              }
            }
            if ((longlong)(uVar32 + 0x10) <= (longlong)uVar27) {
              ...
              do {
                auVar61 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar25 + 2 + lVar22));
                auVar62 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar24 + -2 + lVar29));
                auVar64 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar24 + -4 + lVar29));
                auVar67 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar25 + 4 + lVar22));
                auVar61 = vpaddd_avx512f(auVar61,auVar62);
          ...
          if (uVar27 + 1 <= param_3) {
            ...
            auVar62 = vpmovsxwd_avx512f(auVar47);
            auVar64 = vpmovsxwd_avx512f(auVar48);
            ...
            *puVar1 = (uint)(bVar18 & 1) * auVar60._0_4_ | (uint)!(bool)(bVar18 & 1) * *puVar1;
            ...
            auVar61 = vpmovsxwd_avx512f(auVar49);
            auVar62 = vpmovsxwd_avx512f(auVar50);
            auVar61 = vpaddd_avx512f(auVar61,auVar62);
            auVar61 = vcvtdq2ps_avx512f(auVar61);
    ...
    if (lVar23 != lVar29) {
      ...
      if (0 < (longlong)param_3) {
          ...
          if ((longlong)param_3 < 0x47) {
            ...
            if (uVar27 != 0) {
              ...
              do {
                ...
                auVar61 = vpmovsxwd_avx512f(auVar51);
                auVar62 = vpmovsxwd_avx512f(auVar52);
                auVar61 = vpaddd_avx512f(auVar61,auVar62);
                lVar30 = lVar30 + 0x20;
                auVar61 = vcvtdq2ps_avx512f(auVar61);
                auVar61 = vfmadd213ps_avx512f(auVar61,auVar60,
              ...
              if (param_3 == uVar27) goto LAB_140a1a88c;
            }
          }
          if ((longlong)(uVar27 + 0x10) <= (longlong)uVar26) {
            auVar63 = vbroadcastss_avx512f(auVar69);
            do {
              auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar19 + uVar27 * 2));
              auVar58 = vpmovsxwd_avx512f(*(undefined1 (*) [32])
        ...
        if (uVar26 + 1 <= param_3) {
          ...
          auVar63 = vpmovsxwd_avx512f(auVar53);
          auVar58 = vpmovsxwd_avx512f(auVar54);
  ...
  if (0 < (longlong)param_3) {
    ...
    if ((longlong)param_3 < 0x10) {
      ...
      if ((longlong)param_3 < 0x27) {
        ...
        if (uVar27 != 0) {
          ...
          do {
            ...
            lVar23 = lVar23 + 0x20;
            auVar61 = vpmovsxwd_avx512f(auVar55);
            auVar61 = vcvtdq2ps_avx512f(auVar61);
            auVar61 = vfmadd213ps_avx512f(auVar61,auVar60,
                                          *(undefined1 (*) [64])(param_2 + uVar33 * 4));
            puVar1 = (uint *)(param_2 + uVar33 * 4);
      ...
      if ((longlong)(uVar27 + 0x10) <= (longlong)uVar26) {
        auVar63 = vbroadcastss_avx512f(auVar69);
        do {
          auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar19 + 2 + uVar27 * 2));
          auVar57 = vcvtdq2ps_avx512f(auVar57);
    ...
    if (uVar26 + 1 <= param_3) {
      ...
      auVar63 = vpmovsxwd_avx512f(auVar56);
      auVar63 = vcvtdq2ps_avx512f(auVar63);
      auVar63 = vfmadd213ps_avx512f(auVar57,auVar63,*(undefined1 (*) [64])(param_2 + uVar26 * 4));
      puVar1 = (uint *)(param_2 + uVar26 * 4);
      bVar3 = (bool)((byte)(uVar37 >> 1) & 1);
