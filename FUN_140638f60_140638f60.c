...
void FUN_140638f60(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1406397d6:
      uVar28 = 0;
      if (param_5 == 0) goto LAB_1406391de;
      uVar39 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar33 = uVar39 & 0xf;
      if (uVar33 != 0) {
        if ((uVar39 & 3) != 0) goto LAB_1406397d6;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar33 + 8)) goto LAB_1406397d6;
      ...
      if (param_5 < uVar28 + 1) goto LAB_1406391de;
...
LAB_140639444:
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar33 = param_4 & 0xf;
      if (uVar33 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406397f4;
        uVar33 = 0x10 - uVar33 >> 2;
      }
...
LAB_14063977c:
  ...
  if (7 < (longlong)param_5) {
    uVar33 = param_4 & 0xf;
    if (uVar33 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406397ed;
      uVar33 = 0x10 - uVar33 >> 2;
    }
