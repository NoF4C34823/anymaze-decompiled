...
void FUN_1406214e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001406221b7. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b540 + lVar7 * 8))(param_1,param_4,*param_5);
    return;
  }
  if (uVar13 == 6) {
    uVar21 = *param_8;
          ...
          if (uVar13 != 6) {
            if (uVar13 == 1) {
              ...
              if (lVar11 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140622140;
                while (uVar9 == 0) {
                  for (lVar8 = (lVar11 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_140622140:
                    if ((uint)uStack_88 != 0) goto LAB_140622010;
                  }
...
LAB_140622010:
        ...
        *(undefined4 *)(param_11 + lVar16 * 4) = uVar20;
        lVar16 = lVar16 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140622087. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b540 + lVar7 * 8))(param_11 + uVar14 * 4,param_4,lVar11,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    ...
    if (0 < (longlong)uVar18) {
      if (6 < (longlong)uVar18) {
        ...
        if ((lVar16 <= (longlong)(uVar12 - param_1)) || (lVar16 <= (longlong)-(uVar12 - param_1))) {
          ...
          if (uVar15 == 0) {
LAB_1406215e3:
            if ((longlong)uVar18 < (longlong)(uVar15 + 4)) goto LAB_14062208a;
...
LAB_140621744:
    if (uVar13 == 1) {
      if ((longlong)uVar14 < 1) goto LAB_1406219ee;
...
LAB_1406220eb:
        ...
        uVar15 = param_11 & 0xf;
        if (uVar15 != 0) {
          if ((param_11 & 3) != 0) goto LAB_1406220eb;
          uVar15 = 0x10 - uVar15 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar15 + 8)) goto LAB_1406220eb;
...
LAB_140622098:
        ...
        uVar15 = param_11 & 0xf;
        if (uVar15 != 0) {
          if ((param_11 & 3) != 0) goto LAB_140622098;
          uVar15 = 0x10 - uVar15 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar15 + 8)) goto LAB_140622098;
        uStack_88 = uVar14 - (uVar14 - uVar15 & 7);
        uVar10 = 0;
        if (uVar15 != 0) {
          do {
...
LAB_1406219ee:
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&DAT_14308b540 + lVar7 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001406220e9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (0 < (longlong)uVar18) {
    if (6 < (longlong)uVar18) {
      ...
      if ((lVar7 <= (longlong)(param_11 - lVar11)) || (lVar7 <= (longlong)-(param_11 - lVar11))) {
        ...
        if (uVar12 == 0) {
LAB_140621af1:
          if ((longlong)uVar18 < (longlong)(uVar12 + 4)) goto LAB_1406220a6;
          uVar10 = 0;
...
LAB_140621c1e:
  if (uVar13 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_140621ed6;
...
LAB_1406220b6:
          ...
          uVar12 = uVar18 & 0xf;
          if (uVar12 != 0) {
            if ((uVar18 & 3) != 0) goto LAB_1406220b6;
            uVar12 = 0x10 - uVar12 >> 2;
          }
          if ((longlong)uVar14 < (longlong)(uVar12 + 8)) goto LAB_1406220b6;
          uVar15 = 0;
  ...
  if ((uVar13 != 6) || ((longlong)uVar14 < 1)) goto LAB_140621ed6;
  if ((longlong)uVar14 < 8) {
LAB_1406220ae:
    uVar12 = 0;
  }
    ...
    uVar18 = lVar7 - 4U & 0xf;
    if (uVar18 != 0) {
      if ((lVar7 - 4U & 3) != 0) goto LAB_1406220ae;
      uVar18 = 0x10 - uVar18 >> 2;
    }
    if ((longlong)uVar14 < (longlong)(uVar18 + 8)) goto LAB_1406220ae;
    uVar15 = 0;
...
LAB_140621ed6:
                    /* WARNING: Could not recover jumptable at 0x000140621f05. Too many branches */
                    /* WARNING: Treating indirect jump as call */
