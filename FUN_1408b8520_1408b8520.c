...
void FUN_1408b8520(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308cfe0)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1408b862f;
    if ((param_7 & 0xf) == 6) {
      uVar3 = param_7 & 0x10;
      goto joined_r0x0001408b884e;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_1408b862f;
    if ((param_7 & 0xf) == 6) {
      uVar3 = param_7 & 0x20;
joined_r0x0001408b884e:
      if (uVar3 != 0) goto LAB_1408b862f;
      uVar4 = *param_5;
      uVar2 = *param_8;
      if ((longlong)uVar4 < 1) {
        return;
...
LAB_1408b87fb:
        ...
        if ((longlong)uVar4 < 0x1d) {
          ...
          uVar7 = param_4 & 0x1f;
          if (uVar7 != 0) {
            if ((param_4 & 3) != 0) goto LAB_1408b87fb;
            uVar7 = 0x20 - uVar7 >> 2;
          }
          if ((longlong)uVar4 < (longlong)(uVar7 + 0x10)) goto LAB_1408b87fb;
          uVar6 = 0;
...
LAB_1408b862f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_1408ba580(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
