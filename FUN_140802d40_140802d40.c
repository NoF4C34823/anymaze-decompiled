...
void FUN_140802d40(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    uVar31 = param_2 & 0x1f;
    if (uVar31 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140802f32;
...
LAB_140802f3b:
  FUN_140802ef3(fVar7,fVar6,param_3,0);
  return;
}
