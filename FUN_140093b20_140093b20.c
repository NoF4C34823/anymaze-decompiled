...
void FUN_140093b20(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140094096:
      uVar25 = 0;
      if (param_5 == 0) goto LAB_140093dc9;
      uVar21 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar18 & 0xf;
      if (uVar19 != 0) {
        if ((uVar18 & 3) != 0) goto LAB_140094096;
        uVar19 = 0x10 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 8)) goto LAB_140094096;
      ...
      if (param_5 < uVar25 + 1) goto LAB_140093dc9;
...
LAB_140093dc9:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar18 = param_4 & 0xf;
      if (uVar18 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1400940b3;
      ...
      if ((longlong)(uVar18 + 8) <= (longlong)param_5) {
        ...
        if ((lVar27 + uVar18 * 4 & 0xf) == 0) {
          do {
            ...
            auVar30 = packusdw(auVar32,auVar30);
          ...
          do {
            ...
            auVar35 = packusdw(auVar36,auVar35);
...
LAB_140094040:
  ...
  if (7 < (longlong)param_5) {
    uVar18 = param_4 & 0xf;
    if (uVar18 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1400940ac;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)(uVar18 + 8) <= (longlong)param_5) {
      uVar25 = 0;
      ...
      if ((lVar27 + uVar18 * 4 & 0xf) == 0) {
        do {
          ...
          auVar30 = packusdw(auVar33,auVar31);
          *(undefined1 (*) [16])(param_4 + uVar18 * 2) = auVar30;
          uVar18 = uVar18 + 8;
        } while (uVar18 < uVar19);
      }
        ...
        do {
          ...
          auVar35 = packusdw(auVar34,auVar7);
          *(undefined1 (*) [16])(param_4 + uVar18 * 2) = auVar35;
          uVar18 = uVar18 + 8;
        } while (uVar18 < uVar19);
      }
