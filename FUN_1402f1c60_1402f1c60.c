...
void FUN_1402f1c60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
              ...
              if (0 < (longlong)param_7) {
                ...
                if (((lVar6 - 1U < param_7) && (*(char *)(param_9 + -1 + lVar6 + lVar8) != '\0')) &&
                   (fVar1 = *(float *)((lVar6 - 1U) * (longlong)param_11 * 4 +
                                       param_1 + lVar2 + uVar7 * 4 + lVar4 * 4), fVar14 <= fVar1)) {
                  fVar14 = fVar1;
                }
              }
              uVar9 = uVar9 + 1;
