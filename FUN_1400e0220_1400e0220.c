...
void FUN_1400e0220(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1400e0c1d:
      ...
      uVar35 = uVar34 & 0x1f;
      if (uVar35 != 0) {
        if ((uVar34 & 3) != 0) goto LAB_1400e0c1d;
        uVar35 = 0x20 - uVar35 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar35 + 0x10)) goto LAB_1400e0c1d;
  ...
  if (1 < param_7) {
    ...
    do {
      while( true ) {
        ...
        uVar28 = uVar28 + 1;
        pfVar27 = pfVar27 + 1;
        if (param_7 - 1U <= uVar28) goto LAB_1400e0721;
      }
      uVar28 = uVar28 + 1;
      pfVar27 = pfVar27 + 1;
...
LAB_1400e0bb4:
      ...
      if ((longlong)param_5 < 0x15d) {
        ...
        uVar35 = uVar23 & 0x1f;
        if (uVar35 != 0) {
          if ((uVar23 & 3) != 0) goto LAB_1400e0bb4;
          uVar35 = 0x20 - uVar35 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar35 + 8)) goto LAB_1400e0bb4;
        lVar32 = param_2 * lVar25 + param_1;
        lVar22 = param_2 * lVar24 + param_1;
        uVar33 = 0;
...
LAB_1400e0be7:
      ...
      if ((longlong)param_5 < 0x12c0) {
        ...
        if ((longlong)param_5 < (longlong)(uVar23 + 0x20)) goto LAB_1400e0be7;
        lVar25 = param_2 * uVar19 + param_1;
        uVar35 = 0;
...
LAB_1400e0c06:
    ...
    if ((longlong)param_5 < (longlong)(uVar23 + 0x20)) goto LAB_1400e0c06;
    lVar25 = param_2 * uVar19 + param_1;
    uVar35 = 0;
    uVar34 = param_5 - (param_5 - uVar23 & 0x1f);
    if (uVar23 != 0) {
