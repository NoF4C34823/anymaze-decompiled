...
void FUN_1403f8d18(undefined8 param_1,longlong param_2,longlong param_3,ulonglong param_4)
  ...
  do {
    ...
    if (0 < (longlong)in_stack_00000150) {
      ...
      if (in_stack_00000150 >> 3 != 0) {
        ...
        do {
          if (*(short *)(lVar11 + lVar8 + unaff_RBP) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar8 + unaff_RBP);
          }
          if (*(short *)(lVar11 + lVar6) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar6);
          }
          if (*(short *)(lVar11 + lVar5) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar5);
          }
          if (*(short *)(lVar11 + lVar4) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar4);
          }
          if (*(short *)(lVar11 + lVar9) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar9);
          }
          if (*(short *)(lVar11 + lVar3) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar3);
          }
          if (*(short *)(lVar11 + lVar2) < sVar12) {
            sVar12 = *(short *)(lVar11 + lVar2);
          }
          uVar10 = uVar10 + 1;
          if (*(short *)(lVar11 + lVar1) < sVar12) {
