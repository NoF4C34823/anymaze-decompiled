...
void FUN_1408b3440(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308cf40)[lVar10])(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar18 < 0) goto LAB_1408b4ca4;
                while (uVar12 == 0) {
                  for (lVar20 = (lVar19 + -1) * 2 - lVar20; lVar20 < 0; lVar20 = -lVar20) {
LAB_1408b4ca4:
                    if ((uint)uStack_a8 != 0) goto LAB_1408b4b51;
                  }
...
LAB_1408b4b51:
    ...
    (*(code *)(&PTR_FUN_14308cf40)[lVar10])(param_11 + lVar29 * 3,param_4,lVar19,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar18 = lVar27 * 3;
...
LAB_1408b4c06:
            ...
            if ((longlong)uVar14 < 0xa91) {
              ...
              if ((longlong)uVar14 < (longlong)(uStack_a8 + 0x20)) goto LAB_1408b4c06;
...
LAB_1408b3751:
    ...
    pcStack_68 = (code *)(&PTR_FUN_14308cf40)[lVar10];
    ...
    if (0 < lVar10) {
      ...
      if ((longlong)uVar14 < 7) {
        ...
        if ((longlong)uVar14 < 0x20) {
          ...
          auVar46[0x1e] = uVar28;
          auVar46[0x1f] = uVar28;
          auVar5 = vpshufb_avx2(auVar41,_DAT_14308ce00);
          uVar22 = 0;
          auVar41 = vpshufb_avx2(auVar41,_DAT_14308cec0);
          auVar34 = vpshufb_avx2(auVar46,_DAT_14308ce20);
          auVar37 = vpshufb_avx2(auVar46,_DAT_14308cee0);
          ...
          auVar37[0x1f] = bVar4;
          uVar11 = uVar14 & 0xffffffffffffffe0;
          auVar46 = vpshufb_avx2(auVar37,_DAT_14308ce40);
          lVar19 = 0;
          auVar37 = vpshufb_avx2(auVar37,_DAT_14308cf00);
          auVar37 = vpor_avx2(auVar41,auVar37);
          auVar41 = vpblendvb_avx2(auVar5,auVar34,_DAT_14308ce60);
          auVar5 = vpblendvb_avx2(auVar34,auVar5,_DAT_14308ce60);
          auVar41 = vpblendvb_avx2(auVar41,auVar46,_DAT_14308ce80);
          auVar5 = vpblendvb_avx2(auVar5,auVar46,_DAT_14308cea0);
    ...
    if (6 < (longlong)uVar14) {
      ...
      if ((2 < lVar18) || ((longlong)(uVar14 * 3) <= -lVar18)) {
        ...
        if ((longlong)uVar14 < 0x20) {
          ...
          auVar38[0x1f] = uVar26;
          uVar22 = 0;
          auVar5 = vpshufb_avx2(auVar45,_DAT_14308ce20);
          uVar11 = uVar14 & 0xffffffffffffffe0;
          auVar41 = vpshufb_avx2(auVar38,_DAT_14308cec0);
          auVar37 = vpshufb_avx2(auVar45,_DAT_14308cee0);
          auVar34 = vpshufb_avx2(auVar38,_DAT_14308ce00);
          auVar41 = vpor_avx2(auVar41,auVar37);
          auVar40[1] = bVar4;
          auVar40[0] = bVar4;
          auVar40[2] = bVar4;
          ...
          auVar40[0x1f] = bVar4;
          lVar27 = 0;
          auVar46 = vpshufb_avx2(auVar40,_DAT_14308ce40);
          auVar37 = vpshufb_avx2(auVar40,_DAT_14308cf00);
          auVar37 = vpor_avx2(auVar41,auVar37);
          auVar41 = vpblendvb_avx2(auVar34,auVar5,_DAT_14308ce60);
          auVar5 = vpblendvb_avx2(auVar5,auVar34,_DAT_14308ce60);
          auVar41 = vpblendvb_avx2(auVar41,auVar46,_DAT_14308ce80);
          auVar5 = vpblendvb_avx2(auVar5,auVar46,_DAT_14308cea0);
