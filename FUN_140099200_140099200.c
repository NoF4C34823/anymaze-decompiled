...
void FUN_140099200(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014009a1f1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086a40 + lVar15 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
          ...
          if (uVar20 != 6) {
            if (uVar20 == 1) {
              ...
              if (lVar10 < 2) {
                ...
                if (lVar19 < 0) goto LAB_14009a180;
                while (uStack_80 == 0) {
                  for (lVar7 = (lVar10 + -1) * 2 - lVar7; lVar7 < 0; lVar7 = -lVar7) {
LAB_14009a180:
                    if (uVar8 != 0) goto LAB_14009a06e;
                  }
...
LAB_14009a06e:
        ...
        *(undefined1 *)(lVar23 + 2 + param_11) = uVar13;
        lVar23 = lVar23 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014009a111. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086a40 + lVar15 * 8))(param_11 + lVar12 * 3,param_4,lVar10,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar23 = lVar12 * 3;
...
LAB_14009a114:
            ...
            if ((longlong)uVar17 < (longlong)(uVar4 + 0x10)) goto LAB_14009a114;
...
LAB_140099471:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_143086a40 + lVar15 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014009a14d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_140099f3d:
                    /* WARNING: Could not recover jumptable at 0x000140099f6b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
