...
void FUN_140616a20(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14061717d:
      uVar40 = 0;
      if (param_5 == 0) goto LAB_140616f1d;
      uVar36 = 0;
      uVar50 = param_5;
    }
    else {
      ...
      uVar50 = uVar49 & 0xf;
      if (uVar50 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_14061717d;
        uVar50 = 0x10 - uVar50 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar50 + 8)) goto LAB_14061717d;
      lVar44 = param_2 * lVar37 + param_1;
      lVar34 = param_2 * lVar35 + param_1;
      lVar46 = param_2 * lVar42 + param_1;
      lVar45 = param_2 * lVar41 + param_1;
      uVar40 = param_5 - (param_5 - uVar50 & 7);
      ...
      if ((lVar34 + uVar50 * 4 & 0xf) == 0) {
        do {
          ...
          fVar23 = pfVar6[2];
          fVar24 = pfVar6[3];
          pfVar2 = (float *)(lVar47 + uVar50 * 4);
          fVar25 = pfVar2[1];
          fVar26 = pfVar2[2];
          fVar27 = pfVar2[3];
          pfVar3 = (float *)(lVar45 + uVar50 * 4);
          fVar28 = pfVar3[1];
          fVar29 = pfVar3[2];
          fVar30 = pfVar3[3];
          ...
          *pfVar5 = (*pfVar1 + *pfVar6) * fVar7 + (*pfVar3 + *pfVar2) * fVar8 + *pfVar4 * fVar9;
          pfVar5[1] = (fVar19 + fVar22) * fVar7 + (fVar28 + fVar25) * fVar8 + fVar31 * fVar9;
          pfVar5[2] = (fVar20 + fVar23) * fVar7 + (fVar29 + fVar26) * fVar8 + fVar32 * fVar9;
          pfVar5[3] = (fVar21 + fVar24) * fVar7 + (fVar30 + fVar27) * fVar8 + fVar33 * fVar9;
      ...
      if (param_5 < uVar40 + 1) goto LAB_140616f1d;
      uVar50 = param_5 - uVar40;
      if ((longlong)uVar50 < 4) {
        ...
        do {
          pfVar1 = (float *)(lVar44 + uVar40 * 4 + uVar48 * 4);
          fVar19 = pfVar1[1];
          fVar20 = pfVar1[2];
          fVar21 = pfVar1[3];
          pfVar2 = (float *)(lVar46 + uVar40 * 4 + uVar48 * 4);
          fVar22 = pfVar2[1];
          fVar23 = pfVar2[2];
          fVar24 = pfVar2[3];
          pfVar3 = (float *)(lVar47 + uVar40 * 4 + uVar48 * 4);
          fVar25 = pfVar3[1];
          fVar26 = pfVar3[2];
          fVar27 = pfVar3[3];
          pfVar6 = (float *)(lVar45 + uVar40 * 4 + uVar48 * 4);
          fVar28 = pfVar6[1];
          fVar29 = pfVar6[2];
          fVar30 = pfVar6[3];
          pfVar4 = (float *)(lVar34 + uVar40 * 4 + uVar48 * 4);
          fVar31 = pfVar4[1];
          fVar32 = pfVar4[2];
          fVar33 = pfVar4[3];
          pfVar5 = (float *)(uVar49 + uVar40 * 4 + uVar48 * 4);
    ...
    if (uVar36 < uVar50) {
      do {
        *(float *)(param_2 * 5 + param_1 + uVar40 * 4 + uVar36 * 4) =
             (*(float *)(lVar37 * param_2 + param_1 + uVar40 * 4 + uVar36 * 4) +
             *(float *)(lVar42 * param_2 + param_1 + uVar40 * 4 + uVar36 * 4)) * fVar7 +
             (*(float *)(lVar41 * param_2 + param_1 + uVar40 * 4 + uVar36 * 4) +
             *(float *)(lVar43 * param_2 + param_1 + uVar40 * 4 + uVar36 * 4)) * fVar8 +
             *(float *)(lVar35 * param_2 + param_1 + uVar40 * 4 + uVar36 * 4) * fVar9;
        uVar36 = uVar36 + 1;
      } while (uVar36 < uVar50);
    }
  }
LAB_140616f1d:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar49 = uVar50 & 0xf;
      if (uVar49 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_14061719a;
        uVar49 = 0x10 - uVar49 >> 2;
      }
      if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
        uVar36 = 0;
        uVar40 = param_5 - (param_5 - uVar49 & 7);
        if (uVar49 != 0) {
          do {
            iVar39 = (int)ROUND(*(float *)(uVar50 + uVar36 * 4));
            if (0xfe < iVar39) {
              iVar39 = 0xff;
            }
            ...
            *(undefined1 *)(uVar36 + param_4) = uVar38;
            uVar36 = uVar36 + 1;
          } while (uVar36 < uVar49);
        }
        do {
...
LAB_140617122:
    ...
    do {
      iVar39 = (int)ROUND(*(float *)(param_1 + param_2 * 5 + uVar40 * 4));
      if (0xfe < iVar39) {
        iVar39 = 0xff;
      }
      uVar38 = (undefined1)iVar39;
      ...
      *(undefined1 *)(uVar40 + param_4) = uVar38;
      uVar40 = uVar40 + 1;
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar49 = uVar50 & 0xf;
    if (uVar49 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_140617193;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
      uVar36 = 0;
