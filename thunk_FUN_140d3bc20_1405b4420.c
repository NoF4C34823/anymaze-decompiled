...
void thunk_FUN_140d3bc20(undefined1 (*param_1) [64],undefined1 (*param_2) [64],ulonglong param_3,
...

{
  ...
  if (param_4 == 3) {
    if (0 < (longlong)uVar4) {
      auVar9 = vmovdqu32_avx512f(_DAT_143092700);
      do {
        auVar13 = vpminuw_avx512bw(auVar9,*param_1);
        lVar2 = lVar2 + 0x80;
        auVar12 = vpminuw_avx512bw(auVar9,param_1[1]);
        auVar11 = vpminuw_avx512bw(auVar9,param_1[2]);
        auVar10 = vpminuw_avx512bw(auVar9,param_1[3]);
        auVar13 = vpminuw_avx512bw(auVar13,*(undefined1 (*) [64])(*param_1 + lVar6 * 2));
        auVar12 = vpminuw_avx512bw(auVar12,*(undefined1 (*) [64])(param_1[1] + lVar6 * 2));
        auVar11 = vpminuw_avx512bw(auVar11,*(undefined1 (*) [64])(param_1[2] + lVar6 * 2));
        auVar10 = vpminuw_avx512bw(auVar10,*(undefined1 (*) [64])(param_1[3] + lVar6 * 2));
        auVar13 = vpminuw_avx512bw(auVar13,*(undefined1 (*) [64])(*param_1 + lVar6 * 4));
        auVar12 = vpminuw_avx512bw(auVar12,*(undefined1 (*) [64])(param_1[1] + lVar6 * 4));
        auVar11 = vpminuw_avx512bw(auVar11,*(undefined1 (*) [64])(param_1[2] + lVar6 * 4));
        auVar10 = vpminuw_avx512bw(auVar10,*(undefined1 (*) [64])(param_1[3] + lVar6 * 4));
        *param_2 = auVar13;
        param_2[1] = auVar12;
        param_2[2] = auVar11;
        param_2[3] = auVar10;
    ...
    if (0 < (longlong)uVar4) {
      ...
      do {
        ...
        auVar11 = vpminuw_avx512bw(auVar11,*(undefined1 (*) [64])(param_1[2] + lVar6 * 4));
        auVar10 = vpminuw_avx512bw(auVar10,*(undefined1 (*) [64])(param_1[3] + lVar6 * 4));
        auVar13 = vpminuw_avx512bw(auVar13,*(undefined1 (*) [64])(*param_1 + lVar6 * 6));
        auVar12 = vpminuw_avx512bw(auVar12,*(undefined1 (*) [64])(param_1[1] + lVar6 * 6));
        auVar11 = vpminuw_avx512bw(auVar11,*(undefined1 (*) [64])(param_1[2] + lVar6 * 6));
        auVar10 = vpminuw_avx512bw(auVar10,*(undefined1 (*) [64])(param_1[3] + lVar6 * 6));
        auVar13 = vpminuw_avx512bw(auVar13,*(undefined1 (*) [64])(*param_1 + lVar6 * 8));
        auVar12 = vpminuw_avx512bw(auVar12,*(undefined1 (*) [64])(param_1[1] + lVar6 * 8));
        auVar11 = vpminuw_avx512bw(auVar11,*(undefined1 (*) [64])(param_1[2] + lVar6 * 8));
        auVar10 = vpminuw_avx512bw(auVar10,*(undefined1 (*) [64])(param_1[3] + lVar6 * 8));
        *param_2 = auVar13;
        param_2[1] = auVar12;
        param_2[2] = auVar11;
        param_2[3] = auVar10;
  ...
  if (lVar2 < (longlong)uVar4) {
    ...
    do {
      ...
      if (0 < param_4) {
        do {
          lVar7 = lVar7 + 1;
          auVar10 = vpminuw_avx512bw(auVar10,*pauVar5);
          auVar11 = vpminuw_avx512bw(auVar11,pauVar5[1]);
          auVar12 = vpminuw_avx512bw(auVar12,pauVar5[2]);
          auVar13 = vpminuw_avx512bw(auVar13,pauVar5[3]);
  ...
  if (lVar2 < (longlong)(param_3 & 0xffffffffffffffc0)) {
    ...
    do {
      ...
      if (0 < param_4) {
        do {
          lVar7 = lVar7 + 1;
          auVar12 = vpminuw_avx512bw(auVar12,*pauVar5);
          auVar13 = vpminuw_avx512bw(auVar13,pauVar5[1]);
          pauVar5 = (undefined1 (*) [64])(*pauVar5 + lVar6 * 2);
        } while (lVar7 < param_4);
      }
      lVar2 = lVar2 + 0x40;
  ...
  if (lVar2 < (longlong)(param_3 & 0xffffffffffffffe0)) {
    ...
    do {
      ...
      if (0 < param_4) {
        do {
          lVar8 = lVar8 + 1;
          auVar13 = vpminuw_avx512bw(auVar13,*(undefined1 (*) [64])(*param_1 + lVar7 * 2));
          lVar7 = lVar7 + lVar6;
        } while (lVar8 < param_4);
      }
      lVar2 = lVar2 + 0x20;
  ...
  if (lVar2 < (longlong)param_3) {
    ...
    if (0 < param_4) {
      do {
        ...
        lVar7 = lVar7 + 1;
        auVar9 = vpminuw_avx512bw(auVar9,auVar13);
        lVar2 = lVar2 + lVar6 * 2;
      } while (lVar7 < param_4);
    }
