...
void FUN_1403b8dc0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar17 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403a4f20(lVar4,lVar14,uVar5,(longlong)(int)param_6,4);
        lVar19 = lVar19 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403a4f20(lVar4,lVar14,uVar5,(longlong)(int)param_6,4);
        thunk_FUN_142d23d30(param_9,uVar2,param_3,uVar5,(longlong)param_6._4_4_);
        lVar17 = lVar17 + 1;
        lVar19 = lVar19 + 1;
        lVar14 = lVar14 + uVar2 * 4;
