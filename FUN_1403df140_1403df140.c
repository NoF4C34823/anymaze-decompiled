...
void FUN_1403df140(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar8 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (lVar8 = (lVar8 - 1U) * 4 + lVar4, *(byte *)(lVar8 + uVar14) < bVar5)) {
    ...
    if (0 < param_5._4_4_) {
      do {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar11 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (lVar11 = (lVar11 - 1U) * 4 + lVar4 + lVar8, *(byte *)(lVar11 + uVar14) < bVar5)) {
        ...
        FUN_1403e4f20(param_9,uVar3,param_3,uVar10,(longlong)param_6._4_4_);
        uVar9 = uVar9 + 1;
        uVar12 = uVar12 + 1;
