...
void FUN_140706210(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         ...
         (float)((uint)*(ushort *)(param_4 + -2 + in_RAX * 2) +
                (uint)*(ushort *)(param_4 + 2 + in_RAX * 2)) * unaff_XMM9_Da +
         (float)*(ushort *)(param_4 + in_RAX * 2) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < param_1);
  puVar37 = (ulonglong *)(param_1 * 2 + param_4);
  do {
    uVar2 = *(ulonglong *)((longlong)puVar37 + -6);
    uVar3 = *(ulonglong *)((longlong)puVar37 + 6);
    auVar9._8_4_ = 0;
    auVar9._0_8_ = uVar2;
    ...
    auVar24._0_4_ = (uint)uVar3;
    auVar24._6_8_ = SUB148(auVar31 << 0x40,6);
    uVar4 = *(ulonglong *)((longlong)puVar37 + 4);
    uVar5 = *(ulonglong *)((longlong)puVar37 + -4);
    auVar11._8_4_ = 0;
    auVar11._0_8_ = uVar5;
    ...
    auVar12._8_4_ = 0;
    auVar12._0_8_ = uVar4;
    auVar12._12_2_ = (short)(uVar4 >> 0x30);
    auVar19._8_2_ = (short)(uVar4 >> 0x20);
    auVar19._0_8_ = uVar4;
    auVar19._10_4_ = auVar12._10_4_;
    auVar33._6_8_ = 0;
    auVar33._0_6_ = auVar19._8_6_;
    auVar26._4_2_ = (short)(uVar4 >> 0x10);
    auVar26._0_4_ = (uint)uVar4;
    auVar26._6_8_ = SUB148(auVar33 << 0x40,6);
    uVar6 = *(ulonglong *)((longlong)puVar37 + 2);
    uVar7 = *(ulonglong *)((longlong)puVar37 + -2);
    auVar13._8_4_ = 0;
    auVar13._0_8_ = uVar7;
    ...
    *pfVar1 = (float)(((uint)uVar2 & 0xffff) + ((uint)uVar3 & 0xffff)) * param_2 +
              (float)(((uint)uVar5 & 0xffff) + ((uint)uVar4 & 0xffff)) * in_XMM2_Da +
              (float)(((uint)uVar7 & 0xffff) + ((uint)uVar6 & 0xffff)) * unaff_XMM9_Da +
              (float)((uint)uVar8 & 0xffff) * in_XMM0_Da;
    pfVar1[1] = (float)(auVar23._4_4_ + auVar24._4_4_) * param_2 +
                (float)(auVar25._4_4_ + auVar26._4_4_) * in_XMM2_Da +
                (float)(auVar27._4_4_ + auVar28._4_4_) * unaff_XMM9_Da +
                (float)auVar29._4_4_ * in_XMM0_Da;
    pfVar1[2] = (float)(auVar16._8_4_ + auVar17._8_4_) * param_2 +
                (float)(auVar18._8_4_ + auVar19._8_4_) * in_XMM2_Da +
                (float)(auVar20._8_4_ + auVar21._8_4_) * unaff_XMM9_Da +
                (float)auVar22._8_4_ * in_XMM0_Da;
    pfVar1[3] = (float)((auVar9._10_4_ >> 0x10) + (auVar10._10_4_ >> 0x10)) * param_2 +
                (float)((auVar11._10_4_ >> 0x10) + (auVar12._10_4_ >> 0x10)) * in_XMM2_Da +
                (float)((auVar13._10_4_ >> 0x10) + (auVar14._10_4_ >> 0x10)) * unaff_XMM9_Da +
    ...
    do {
      *(float *)(in_R10 + in_RDX * 4) =
           (float)((uint)*(ushort *)(param_4 + -6 + in_RDX * 2) +
                  (uint)*(ushort *)(param_4 + 6 + in_RDX * 2)) * param_2 +
           (float)((uint)*(ushort *)(param_4 + -4 + in_RDX * 2) +
                  (uint)*(ushort *)(param_4 + 4 + in_RDX * 2)) * in_XMM2_Da +
           (float)((uint)*(ushort *)(param_4 + -2 + in_RDX * 2) +
                  (uint)*(ushort *)(param_4 + 2 + in_RDX * 2)) * unaff_XMM9_Da +
