...
longlong *
FUN_14078d1e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,longlong *param_5,
...

{
  ...
  if (0 < iVar21) {
    ...
    lStack_80 = param_3;
    uStack_78 = uVar13;
    if (uStack_70 == 0xf0) goto LAB_14078d603;
    uVar10 = 0;
    lStack_58 = param_2;
    lStack_50 = param_1;
LAB_14078d2bb:
    ...
    if ((param_5[1] <= (longlong)uVar10) && (param_7 != 0xf0)) {
      if (uVar20 == 6) {
        if (uStack_90 == 0) goto LAB_14078d3f4;
      }
      else {
        if (uVar20 != 1) goto LAB_14078d2f7;
        if (uStack_90 == 0) {
          uVar14 = param_5[1] - 1;
        }
      }
...
LAB_14078d37a:
    do {
      ...
      in_RAX = (longlong *)
               FUN_14078dde0(lStack_50,lStack_58,uVar14,lVar9,in_stack_ffffffffffffff18,param_6,
          ...
          if (uStack_48 <= uVar10) {
            ...
            if (uStack_78 != 0) {
              ...
              do {
                ...
                plVar7 = (longlong *)
                         FUN_14078dde0(lStack_50,lStack_58,lVar9,lVar12,&lStack_a8,param_6,param_7,
...
LAB_14078d603:
          ...
          in_RAX = (longlong *)
                   (*(code *)(&PTR_FUN_14308c1c0)[param_6])
        ...
        if (-1 < (longlong)uVar10) goto LAB_14078d2bb;
        uVar14 = uVar10;
        if (param_7 == 0xf0) goto LAB_14078d37a;
        if (uVar20 != 6) break;
        if (uStack_78 != 0) goto LAB_14078d37a;
LAB_14078d3f4:
...
LAB_14078db53:
            ...
            uVar14 = uVar8 & 0xf;
            if (uVar14 != 0) {
              if ((uVar8 & 3) != 0) goto LAB_14078db53;
              uVar14 = 0x10 - uVar14 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar14 + 4)) goto LAB_14078db53;
            uVar11 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_9c = *(undefined4 *)((longlong)param_5 + 0xc);
      in_RAX = (longlong *)
               FUN_14078dde0((int)*param_5,param_2,lVar12,param_3,&lStack_a8,param_6,param_7,param_8
...
LAB_14078d967:
            ...
            if (plVar19 != (longlong *)0x0) {
              if ((uVar14 & 3) != 0) goto LAB_14078d967;
              plVar19 = (longlong *)(0x10U - (longlong)plVar19 >> 2);
            }
            if ((longlong)plVar7 < (longlong)plVar19 + 4) goto LAB_14078d967;
...
LAB_14078d2f7:
  ...
  if (uVar20 == 3) {
    ...
    if (lVar18 < 2) {
      ...
      if ((longlong)uVar10 < 0) goto LAB_14078d5a0;
      while (uStack_90 == 0) {
