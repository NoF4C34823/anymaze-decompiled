...
void FUN_140624680(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140625757. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b480 + lVar5 * 8))(pbVar20,param_4,*param_5);
    return;
  }
  if (uVar21 == 6) {
    uVar9 = (uint)*param_8;
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar22 < 2) {
                ...
                if (lVar12 < 0) goto LAB_1406256e0;
                while (uVar11 == 0) {
                  for (lVar6 = (lVar22 + -1) * 2 - lVar6; lVar6 < 0; lVar6 = -lVar6) {
LAB_1406256e0:
                    if (uVar9 != 0) goto LAB_1406255e3;
                  }
          ...
          bVar16 = bVar13;
          if (uVar17 != 0) goto LAB_1406255e3;
        }
        else {
LAB_1406255e3:
        ...
        *(byte *)(lVar14 + param_11) = bVar16;
        lVar14 = lVar14 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140625643. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b480 + lVar5 * 8))(param_11 + uVar19,param_4,lVar22,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar19 == 1) {
...
LAB_140625657:
              ...
              if ((longlong)uVar18 < (longlong)(uVar8 + 0x10)) goto LAB_140625657;
...
LAB_140625666:
              ...
              if ((longlong)uVar19 < (longlong)(uVar7 + 0x10)) goto LAB_140625666;
              uVar23 = 0;
...
LAB_14062565e:
          ...
          if ((longlong)uVar19 < (longlong)(uVar7 + 0x10)) goto LAB_14062565e;
          uVar23 = 0;
          uVar8 = uVar19 - (uVar19 - uVar7 & 0xf);
          if (uVar7 != 0) {
            do {
      ...
      in_XMM0._0_8_ =
           (**(code **)(&DAT_14308b480 + lVar5 * 8))(lStack_78,param_4,uVar19,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001406256bf. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b480 + lVar5 * 8))(pbVar20,param_4,lVar22);
    return;
  }
  if ((longlong)uVar19 < lVar22) {
    lVar22 = lVar22 - uVar19;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_14308b480 + lVar5 * 8))(pbVar20,param_4,lVar22,param_9,param_10);
...
LAB_14062566d:
          ...
          if ((longlong)uVar18 < (longlong)(uVar7 + 0x10)) goto LAB_14062566d;
...
LAB_1406251dd:
  if (uVar21 == 1) {
    if ((longlong)uVar19 < 1) goto LAB_140625491;
    if ((longlong)uVar19 < 7) {
      lVar22 = 1;
      if (uVar19 >> 1 != 0) {
...
LAB_14062567d:
      ...
      if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_14062567d;
      uVar8 = 0;
  ...
  if ((uVar21 != 6) || ((longlong)uVar19 < 1)) goto LAB_140625491;
  if ((longlong)uVar19 < 0x10) {
LAB_140625675:
    uVar7 = 0;
  }
    ...
    if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_140625675;
    uVar8 = 0;
    uVar7 = uVar19 - (uVar19 - uVar18 & 0xf);
    if (uVar18 != 0) {
      do {
...
LAB_140625491:
                    /* WARNING: Could not recover jumptable at 0x0001406254d1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_14308b480 + lVar5 * 8))(param_11 + uVar19,param_4,uVar19);
  return;
}
