...
void FUN_1401c00a0(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)param_3) {
    uVar7 = param_2 & 0xf;
    if (uVar7 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401c038e;
      uVar7 = 0x10 - uVar7 >> 2;
    }
    if ((longlong)(uVar7 + 4) <= (longlong)param_3) {
      ...
      goto joined_r0x0001401c02db;
    }
  }
LAB_1401c038e:
  uVar9 = 0;
joined_r0x0001401c02db:
