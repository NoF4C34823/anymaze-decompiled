...
void FUN_140321a80(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar19 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (bVar31 = *(byte *)(lVar8 + -4 + lVar19 * 4 + uVar23), bVar31 < bVar32)) {
                bVar32 = bVar31;
              }
            }
    ...
    if (0 < param_5._4_4_) {
      ...
      do {
        if (0 < (longlong)uVar2) {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar19 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (bVar31 = *(byte *)(lVar8 + uVar28 + -4 + lVar19 * 4 + uVar13), bVar31 < bVar32)) {
                bVar32 = bVar31;
              }
            }
            uVar13 = uVar13 + 1;
        ...
        FUN_140328840(param_9,uVar12,param_3,uVar2,lVar20);
        uVar17 = uVar17 + 1;
        uVar9 = uVar9 + 1;
                  ...
                  if ((longlong)(uVar14 + 0x10) <= (longlong)uVar12) {
                    ...
                    if (uVar14 != 0) {
                      do {
                        if ((*(char *)(uVar11 + uVar13) != '\0') &&
                           (bVar31 = *(byte *)(lVar8 + uVar9 + uVar11 * 4), bVar31 < bVar32)) {
                          bVar32 = bVar31;
                        }
                        uVar11 = uVar11 + 1;
                      } while (uVar11 < uVar14);
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar29 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar5 = auVar34[0];
                        auVar30[0] = (bVar5 < bVar32) * bVar5 | (bVar5 >= bVar32) * bVar32;
                        bVar32 = auVar34[1];
                        auVar30[1] = (bVar32 < bVar31) * bVar32 | (bVar32 >= bVar31) * bVar31;
                        bVar32 = auVar34[2];
                        auVar30[2] = (bVar32 < bVar35) * bVar32 | (bVar32 >= bVar35) * bVar35;
                        bVar32 = auVar34[3];
                        auVar30[3] = (bVar32 < bVar36) * bVar32 | (bVar32 >= bVar36) * bVar36;
                        bVar32 = auVar34[4];
                        auVar30[4] = (bVar32 < bVar37) * bVar32 | (bVar32 >= bVar37) * bVar37;
                        bVar32 = auVar34[5];
                        auVar30[5] = (bVar32 < bVar38) * bVar32 | (bVar32 >= bVar38) * bVar38;
                        bVar32 = auVar34[6];
                        auVar30[6] = (bVar32 < bVar39) * bVar32 | (bVar32 >= bVar39) * bVar39;
                        bVar32 = auVar34[7];
                        auVar30[7] = (bVar32 < bVar40) * bVar32 | (bVar32 >= bVar40) * bVar40;
                        bVar32 = auVar34[8];
                        auVar30[8] = (bVar32 < bVar41) * bVar32 | (bVar32 >= bVar41) * bVar41;
                        bVar32 = auVar34[9];
                        auVar30[9] = (bVar32 < bVar3) * bVar32 | (bVar32 >= bVar3) * bVar3;
                        bVar32 = auVar34[10];
                        auVar30[10] = (bVar32 < bVar4) * bVar32 | (bVar32 >= bVar4) * bVar4;
                        bVar32 = auVar34[0xb];
                        auVar30[0xb] = (bVar32 < bVar7) * bVar32 | (bVar32 >= bVar7) * bVar7;
                        bVar32 = auVar34[0xc];
                        auVar30[0xc] = (bVar32 < bVar10) * bVar32 | (bVar32 >= bVar10) * bVar10;
                        bVar32 = auVar34[0xd];
                        auVar30[0xd] = (bVar32 < bVar15) * bVar32 | (bVar32 >= bVar15) * bVar15;
                        bVar32 = auVar34[0xe];
                        auVar30[0xe] = (bVar32 < bVar16) * bVar32 | (bVar32 >= bVar16) * bVar16;
                        bVar32 = auVar34[0xf];
                        auVar30[0xf] = (bVar32 < bVar18) * bVar32 | (bVar32 >= bVar18) * bVar18;
                    ...
                    bVar32 = auVar34[8];
                    bVar31 = auVar34[0];
                    bVar31 = (bVar32 < bVar31) * bVar32 | (bVar32 >= bVar31) * bVar31;
                    bVar32 = auVar34[9];
                    bVar35 = auVar34[1];
                    bVar35 = (bVar32 < bVar35) * bVar32 | (bVar32 >= bVar35) * bVar35;
                    bVar32 = auVar34[10];
                    bVar36 = auVar34[2];
                    bVar36 = (bVar32 < bVar36) * bVar32 | (bVar32 >= bVar36) * bVar36;
                    bVar32 = auVar34[0xb];
                    bVar37 = auVar34[3];
                    bVar37 = (bVar32 < bVar37) * bVar32 | (bVar32 >= bVar37) * bVar37;
                    bVar32 = auVar34[0xc];
                    bVar38 = auVar34[4];
                    bVar38 = (bVar32 < bVar38) * bVar32 | (bVar32 >= bVar38) * bVar38;
                    bVar32 = auVar34[0xd];
                    bVar39 = auVar34[5];
                    bVar39 = (bVar32 < bVar39) * bVar32 | (bVar32 >= bVar39) * bVar39;
                    bVar32 = auVar34[0xe];
                    bVar40 = auVar34[6];
                    bVar40 = (bVar32 < bVar40) * bVar32 | (bVar32 >= bVar40) * bVar40;
                    bVar32 = auVar34[0xf];
                    bVar41 = auVar34[7];
                    bVar41 = (bVar32 < bVar41) * bVar32 | (bVar32 >= bVar41) * bVar41;
                    bVar32 = (bVar38 < bVar31) * bVar38 | (bVar38 >= bVar31) * bVar31;
                    bVar31 = (bVar39 < bVar35) * bVar39 | (bVar39 >= bVar35) * bVar35;
                    bVar35 = (bVar40 < bVar36) * bVar40 | (bVar40 >= bVar36) * bVar36;
                    bVar36 = (bVar41 < bVar37) * bVar41 | (bVar41 >= bVar37) * bVar37;
                    bVar32 = (bVar35 < bVar32) * bVar35 | (bVar35 >= bVar32) * bVar32;
                    bVar31 = (bVar36 < bVar31) * bVar36 | (bVar36 >= bVar31) * bVar31;
