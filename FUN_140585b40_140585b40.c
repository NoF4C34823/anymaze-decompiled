...
/* WARNING: Instruction at (ram,0x000140585e58) overlaps instruction at (ram,0x000140585e57)
    */

void FUN_140585b40(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
  ...
  if (0 < lStack_48) {
    ...
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        lVar9 = param_2;
        FUN_140585ec0(param_1,param_2,param_3,uVar18);
      ...
      if (lVar19 != 0) {
        lVar17 = 0;
        auVar25 = vpmaxub_avx512bw(*pauVar11,*(undefined1 (*) [64])(*pauVar11 + param_2));
        auVar25 = vpmaxub_avx512bw(auVar25,*(undefined1 (*) [64])(*pauVar11 + param_2 * 2));
        if (0 < lVar19) {
          do {
            lVar17 = lVar17 + 1;
            auVar26 = vpmaxub_avx512bw(pauVar11[1],*(undefined1 (*) [64])(pauVar11[1] + param_2));
            auVar26 = vpmaxub_avx512bw(auVar26,*(undefined1 (*) [64])(pauVar11[1] + param_2 * 2));
            pauVar11 = pauVar11 + 1;
            ...
            *(int *)(lVar9 + -0xd) = *(int *)(lVar9 + -0xd) + iVar14;
            ...
            auVar25 = vpmaxub_avx512bw(auVar27,auVar25);
            auVar25 = vpmaxub_avx512bw(in_ZMM5,auVar25);
            *pauVar16 = auVar25;
            pauVar16 = pauVar16 + 1;
            auVar25 = auVar26;
          } while (lVar17 < lVar19);
      ...
      if (lVar19 != 0) {
        lVar17 = 0;
        auVar23 = vpmaxub_avx2(*(undefined1 (*) [32])*pauVar11,
                               *(undefined1 (*) [32])(*pauVar11 + param_2));
        auVar23 = vpmaxub_avx2(auVar23,*(undefined1 (*) [32])(*pauVar11 + param_2 * 2));
        if (0 < lVar19) {
          do {
            lVar17 = lVar17 + 1;
            auVar24 = vpmaxub_avx2(*(undefined1 (*) [32])(*pauVar11 + 0x20),
                                   *(undefined1 (*) [32])(*pauVar11 + param_2 + 0x20));
            auVar21 = vpmaxub_avx512vl(auVar24,*(undefined1 (*) [32])
            ...
            auVar23 = vpmaxub_avx2(auVar24,auVar23);
            auVar23 = vpmaxub_avx512vl(auVar22,auVar23);
  ...
  if (lVar13 < param_6) {
    ...
    do {
      ...
      if (lVar9 != 0) {
        ...
        auVar23 = vpmaxub_avx2(*(undefined1 (*) [32])*pauVar11,*pauVar20);
        pauVar12 = (undefined1 (*) [32])(*pauVar11 + param_2 * 2);
        auVar23 = vpmaxub_avx2(auVar23,*pauVar12);
        auVar25 = ZEXT3264(auVar23);
        lVar19 = 0;
        pcVar10 = (char *)(lVar9 + -1);
        puVar15 = param_4;
        if (pcVar10 == (char *)0x0 || lVar9 < 1) goto LAB_140585e35;
        do {
          lVar19 = lVar19 + 1;
          auVar23 = vpmaxub_avx2(*(undefined1 (*) [32])(*pauVar11 + 0x20),
                                 *(undefined1 (*) [32])(*pauVar11 + param_2 + 0x20));
          auVar22 = vpmaxub_avx512vl(auVar23,*(undefined1 (*) [32])(*pauVar11 + lStack_48 + 0x20));
          pauVar11 = (undefined1 (*) [64])(*pauVar11 + 0x20);
          ...
          auVar23 = vpmaxub_avx2(auVar23,auVar21);
          auVar23 = vpmaxub_avx512vl(auVar24,auVar23);
          auVar23 = vmovdqu32_avx512vl(auVar23);
          *(undefined1 (*) [32])*pauVar16 = auVar23;
          pauVar16 = (undefined1 (*) [64])(*pauVar16 + 0x20);
...
LAB_140585e35:
          ...
          do {
            auVar23 = vpmaxub_avx2(ZEXT232(uVar6),ZEXT232(uVar4));
            auVar23 = vpmaxub_avx2(auVar23,ZEXT232(uVar5));
      ...
      if ((uVar8 & 0x1f) != 0) {
        FUN_140585ec0(pauVar11,param_2);
      }
      lVar13 = lVar13 + 1;
      param_1 = (undefined1 (*) [64])(*param_1 + param_2);
      param_3 = (undefined1 (*) [64])(*param_3 + (longlong)param_4);
