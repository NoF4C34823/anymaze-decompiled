...
void FUN_140082c20(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140083d12. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086960 + lVar4 * 8))(psVar14,param_4,*param_5);
    return;
  }
  if (uVar20 == 6) {
    sVar19 = *param_8;
          ...
          if (uVar20 != 6) {
            if (uVar20 == 1) {
              ...
              if (lVar21 < 2) {
                ...
                if (lVar23 < 0) goto LAB_140083ca0;
                while (uStack_78 == 0) {
                  for (lVar11 = (lVar21 + -1) * 2 - lVar11; lVar11 < 0; lVar11 = -lVar11) {
LAB_140083ca0:
                    if (uVar17 != 0) goto LAB_140083ba4;
                  }
...
LAB_140083ba4:
        ...
        *(short *)(param_11 + lVar15 * 2) = sVar10;
        lVar15 = lVar15 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140083c08. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086960 + lVar4 * 8))(param_11 + uVar9 * 2,param_4,lVar21,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar9 == 1) {
...
LAB_140083c1d:
              ...
              uVar8 = uVar22 & 0xf;
              if (uVar8 != 0) {
                if ((uVar22 & 1) != 0) goto LAB_140083c1d;
                uVar8 = 0x10 - uVar8 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar8 + 8)) goto LAB_140083c1d;
              uVar5 = 0;
...
LAB_1400830c3:
      if (uVar20 == 1) {
        if ((longlong)uVar9 < 1) goto LAB_1400832ee;
...
LAB_140083c7d:
          ...
          uVar8 = param_11 & 0xf;
          if (uVar8 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140083c7d;
            uVar8 = 0x10 - uVar8 >> 1;
          }
          if ((longlong)uVar9 < (longlong)(uVar8 + 8)) goto LAB_140083c7d;
...
LAB_140083c24:
          ...
          uVar8 = param_11 & 0xf;
          if (uVar8 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140083c24;
            uVar8 = 0x10 - uVar8 >> 1;
          }
          if ((longlong)uVar9 < (longlong)(uVar8 + 8)) goto LAB_140083c24;
          uVar5 = 0;
          uVar7 = uVar9 - (uVar9 - uVar8 & 7);
          if (uVar8 != 0) {
            do {
...
LAB_1400832ee:
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143086960 + lVar4 * 8))(uVar22,param_4,uVar9,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140083c7a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086960 + lVar4 * 8))(psVar14,param_4,lVar21);
    return;
  }
  if ((longlong)uVar9 < lVar21) {
    lVar21 = lVar21 - uVar9;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143086960 + lVar4 * 8))(psVar14,param_4,lVar21,param_9,param_10);
...
LAB_140083c2b:
          ...
          uVar22 = param_11 & 0xf;
          if (uVar22 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140083c2b;
            uVar22 = 0x10 - uVar22 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar22 + 8)) goto LAB_140083c2b;
          uVar7 = 0;
...
LAB_140083760:
  if (uVar20 == 1) {
    if ((longlong)uVar9 < 1) goto LAB_140083a46;
    if (6 < (longlong)uVar9) {
...
LAB_140083c3a:
          ...
          uVar22 = uVar18 & 0xf;
          if (uVar22 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_140083c3a;
            uVar22 = 0x10 - uVar22 >> 1;
          }
          if ((longlong)uVar9 < (longlong)(uVar22 + 8)) goto LAB_140083c3a;
          uVar8 = 0;
          lVar21 = param_11 + lVar23 * 2;
  ...
  if ((uVar20 != 6) || ((longlong)uVar9 < 1)) goto LAB_140083a46;
  if ((longlong)uVar9 < 8) {
LAB_140083c32:
    uVar22 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar21 - 2U & 1) != 0) goto LAB_140083c32;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar9 < (longlong)(uVar18 + 8)) goto LAB_140083c32;
    uVar8 = 0;
...
LAB_140083a46:
                    /* WARNING: Could not recover jumptable at 0x000140083a81. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143086960 + lVar4 * 8))(param_11 + uVar9 * 2,param_4,uVar9);
  return;
}
