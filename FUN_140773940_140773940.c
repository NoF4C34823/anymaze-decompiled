...
void FUN_140773940(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140774698:
      ...
      uVar23 = param_2 & 0xf;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140774698;
        uVar23 = 0x10 - uVar23 >> 2;
      }
      if ((longlong)uVar11 < (longlong)(uVar23 + 8)) goto LAB_140774698;
...
LAB_140774661:
          uVar32 = 0;
          if (uVar11 == 0) goto LAB_14077442d;
          uVar34 = 0;
          uVar23 = uVar11;
        }
        else {
          uVar23 = param_2 & 0xf;
          if (uVar23 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140774661;
            uVar23 = 0x10 - uVar23 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar23 + 0x10)) goto LAB_140774661;
          uVar34 = 0;
          ...
          if (uVar11 < uVar32 + 1) goto LAB_14077442d;
...
LAB_14077442d:
  ...
  if (0xf < (longlong)uVar11) {
    uVar23 = param_2 & 0xf;
    if (uVar23 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140774656;
      uVar23 = 0x10 - uVar23 >> 2;
    }
    if ((longlong)(uVar23 + 0x10) <= (longlong)uVar11) {
      ...
      goto joined_r0x0001407745ff;
    }
  }
LAB_140774656:
  uVar32 = 0;
joined_r0x0001407745ff:
