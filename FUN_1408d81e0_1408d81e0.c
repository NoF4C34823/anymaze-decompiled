...
void FUN_1408d81e0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1408d8a21:
      ...
      if ((longlong)param_5 < 0x3fd) {
        ...
        uVar11 = uVar10 & 0x1f;
        if (uVar11 != 0) {
          if ((uVar10 & 3) != 0) goto LAB_1408d8a21;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 8)) goto LAB_1408d8a21;
        lStack_78 = param_2 * lVar12 + param_1;
        lStack_70 = param_2 * lVar15 + param_1;
        lStack_60 = param_2 * lVar21 + param_1;
        lStack_50 = param_2 * lVar16 + param_1;
...
LAB_1408d8abb:
      ...
      if ((longlong)param_5 < 0x12c0) {
        ...
        if ((longlong)param_5 < (longlong)(uVar10 + 0x20)) goto LAB_1408d8abb;
        lVar12 = param_2 * 7 + param_1;
        uVar13 = 0;
...
LAB_1408d8adf:
    ...
    if ((longlong)param_5 < (longlong)(uVar10 + 0x20)) goto LAB_1408d8adf;
    lVar12 = param_2 * 7 + param_1;
    uVar13 = 0;
    uVar11 = param_5 - (param_5 - uVar10 & 0x1f);
    if (uVar10 != 0) {
