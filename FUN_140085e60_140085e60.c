...
void FUN_140085e60(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)param_3) {
    uVar38 = param_2 & 0xf;
    if (uVar38 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400860cd;
    ...
    if ((longlong)(uVar38 + 4) <= (longlong)param_3) {
      ...
      goto joined_r0x000140086052;
    }
  }
LAB_1400860cd:
  uVar36 = 0;
joined_r0x000140086052:
