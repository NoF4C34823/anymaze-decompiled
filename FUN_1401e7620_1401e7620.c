...
void FUN_1401e7620(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1401e7b27:
      ...
      uVar20 = param_4 & 0x1f;
      if (uVar20 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1401e7b27;
        uVar20 = 0x20 - uVar20 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar20 + 8)) goto LAB_1401e7b27;
...
LAB_1401e7b18:
    ...
    uVar20 = param_4 & 0x1f;
    if (uVar20 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1401e7b18;
      uVar20 = 0x20 - uVar20 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar20 + 0x10)) goto LAB_1401e7b18;
    lVar24 = param_2 * lVar23 + param_1;
    lVar26 = param_2 * lVar21 + param_1;
    lVar18 = param_2 * lVar22 + param_1;
