...
void FUN_1406ca120(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1406ca672:
      ...
      uVar21 = uVar20 & 0xf;
      if (uVar21 != 0) {
        if ((uVar20 & 3) != 0) goto LAB_1406ca672;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar21 + 8)) goto LAB_1406ca672;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar21 = param_4 & 0xf;
      if (uVar21 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1406ca681;
...
LAB_1406ca620:
  ...
  if (7 < (longlong)param_5) {
    uVar21 = param_4 & 0xf;
    if (uVar21 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1406ca67a;
      uVar21 = 0x10 - uVar21 >> 1;
    }
    if ((longlong)(uVar21 + 8) <= (longlong)param_5) {
      lVar22 = param_2 * 3 + param_1;
