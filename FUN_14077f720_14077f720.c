...
void FUN_14077f720(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar46 = uVar45 & 0xf;
      if (uVar46 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_14077fbe5;
...
LAB_14077fbe5:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar39 = param_4 & 0xf;
      if (uVar39 != 0) {
        if ((param_4 & 1) != 0) goto LAB_14077fffc;
...
LAB_14077ff5f:
  ...
  if (7 < (longlong)param_5) {
    uVar39 = param_4 & 0xf;
    if (uVar39 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14077fff5;
      uVar39 = 0x10 - uVar39 >> 1;
    }
    if ((longlong)(uVar39 + 8) <= (longlong)param_5) {
      uVar46 = 0;
