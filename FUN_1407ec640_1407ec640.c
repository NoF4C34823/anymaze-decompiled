...
void FUN_1407ec640(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1407ece10:
      ...
      uVar47 = uVar46 & 0x1f;
      if (uVar47 != 0) {
        if ((uVar46 & 3) != 0) goto LAB_1407ece10;
        uVar47 = 0x20 - uVar47 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar47 + 8)) goto LAB_1407ece10;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar46 = uVar47 & 0xf;
      if (uVar46 != 0) {
        if ((uVar47 & 3) != 0) goto LAB_1407ece1e;
...
LAB_1407ecd9a:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar46 = uVar47 & 0xf;
    if (uVar46 != 0) {
      if ((uVar47 & 3) != 0) goto LAB_1407ece17;
      uVar46 = 0x10 - uVar46 >> 2;
    }
