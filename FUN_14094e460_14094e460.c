...
void FUN_14094e460(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14094ef28:
      ...
      if ((longlong)param_3 < 0x1d) {
        ...
        uVar25 = param_2 & 0x1f;
        if (uVar25 != 0) {
          if ((param_2 & 3) != 0) goto LAB_14094ef28;
          uVar25 = 0x20 - uVar25 >> 2;
        }
        if ((longlong)param_3 < (longlong)(uVar25 + 0x10)) goto LAB_14094ef28;
        lVar18 = lVar29 * -2 + param_1;
        uVar22 = 0;
...
LAB_14094ef0a:
          ...
          uVar20 = param_2 & 0x1f;
          if (uVar20 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14094ef0a;
            uVar20 = 0x20 - uVar20 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar20 + 0x10)) goto LAB_14094ef0a;
  ...
  if (0xf < (longlong)param_3) {
    uVar20 = param_2 & 0x1f;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14094eefb;
      uVar20 = 0x20 - uVar20 >> 2;
    }
