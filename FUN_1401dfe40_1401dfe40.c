...
void FUN_1401dfe40(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_1401e0242:
    ...
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401e0242;
      uVar19 = 0x20 - uVar19 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar19 + 0x10)) goto LAB_1401e0242;
    uVar17 = 0;
