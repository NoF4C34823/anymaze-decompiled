...
void FUN_140414800(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  sVar30 = _UNK_143089eee;
  sVar29 = _UNK_143089eec;
  sVar28 = _UNK_143089eea;
  sVar27 = _UNK_143089ee8;
  sVar26 = _UNK_143089ee6;
  sVar25 = _UNK_143089ee4;
  sVar24 = _UNK_143089ee2;
  sVar23 = _DAT_143089ee0;
  param_2 = param_2 >> 1;
  uVar47 = param_6[1];
  uVar41 = *param_6;
  uVar9 = *param_5;
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar47 - 1)) {
      while( true ) {
        FUN_140402380(param_1,lVar31,uVar9,uVar41,1);
        uVar47 = param_6[1];
        lVar34 = lVar34 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        FUN_140402380(param_1,lVar31,uVar9,*param_6,1);
        uVar47 = param_6[1];
        if (0 < (longlong)uVar9) {
          uVar41 = 0;
          do {
            ...
            if (0 < (longlong)uVar47) {
              ...
              if (uVar47 >> 3 != 0) {
                ...
                do {
                  if (*(ushort *)(lVar48 + lVar10 + param_9) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar10 + param_9);
                  }
                  if (*(ushort *)(lVar48 + lVar6) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar6);
                  }
                  if (*(ushort *)(lVar48 + lVar5) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar5);
                  }
                  if (*(ushort *)(lVar48 + lVar4) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar4);
                  }
                  if (*(ushort *)(lVar48 + lVar32) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar32);
                  }
                  if (*(ushort *)(lVar48 + lVar3) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar3);
                  }
                  if (*(ushort *)(lVar48 + lVar2) < uVar52) {
                    uVar52 = *(ushort *)(lVar48 + lVar2);
                  }
                  uVar36 = uVar36 + 1;
                  if (*(ushort *)(lVar48 + lVar1) < uVar52) {
              ...
              do {
                if (0 < (longlong)uVar41) {
                  if ((longlong)uVar41 < 8) {
                    ...
                    uVar37 = 0;
                    lVar1 = lVar48 + lVar35;
                    uVar57 = CONCAT22((short)uVar53,(short)uVar53);
                    ...
                    do {
                      ...
                      auVar59._2_2_ = sVar64;
                      auVar59._0_2_ = sVar61;
                      auVar59._6_2_ = sVar40;
                      auVar59._4_2_ = sVar38;
                      auVar59._10_2_ = sVar44;
                      auVar59._8_2_ = sVar42;
                      auVar59._14_2_ = sVar51;
                      auVar59._12_2_ = sVar46;
                      auVar66._0_2_ =
                           -(ushort)((short)(auVar58._0_2_ - sVar23) < (short)(sVar61 - sVar23));
                      auVar66._2_2_ =
                           -(ushort)((short)(auVar58._2_2_ - sVar24) < (short)(sVar64 - sVar24));
                      auVar66._4_2_ =
                           -(ushort)((short)(auVar58._4_2_ - sVar25) < (short)(sVar38 - sVar25));
                      auVar66._6_2_ =
                           -(ushort)((short)(auVar58._6_2_ - sVar26) < (short)(sVar40 - sVar26));
                      auVar66._8_2_ =
                           -(ushort)((short)(auVar58._8_2_ - sVar27) < (short)(sVar42 - sVar27));
                      auVar66._10_2_ =
                           -(ushort)((short)(auVar58._10_2_ - sVar28) < (short)(sVar44 - sVar28));
                      auVar66._12_2_ =
                           -(ushort)((short)(auVar58._12_2_ - sVar29) < (short)(sVar46 - sVar29));
                      auVar66._14_2_ =
                           -(ushort)((short)(auVar58._14_2_ - sVar30) < (short)(sVar51 - sVar30));
                      uVar37 = uVar37 + 8;
                      auVar58 = (auVar66 & (auVar58 ^ auVar59) ^ auVar59) & auVar62 |
                                ~auVar62 & auVar58;
                    } while (uVar37 < uVar39);
                    auVar56._0_8_ = auVar58._8_8_;
                    auVar56._8_4_ = auVar58._0_4_;
                    auVar56._12_4_ = auVar58._0_4_;
                    sVar61 = auVar58._0_2_;
                    sVar64 = auVar58._2_2_;
                    auVar63._0_2_ =
                         -(ushort)((short)(auVar58._8_2_ - sVar23) < (short)(sVar61 - sVar23));
                    auVar63._2_2_ =
                         -(ushort)((short)(auVar58._10_2_ - sVar24) < (short)(sVar64 - sVar24));
                    auVar63._4_2_ =
                         -(ushort)((short)(auVar58._12_2_ - sVar25) <
                                  (short)(auVar58._4_2_ - sVar25));
                    auVar63._6_2_ =
                         -(ushort)((short)(auVar58._14_2_ - sVar26) <
                                  (short)(auVar58._6_2_ - sVar26));
                    auVar63._8_2_ =
                         -(ushort)((short)(sVar61 - sVar27) < (short)(auVar58._8_2_ - sVar27));
                    auVar63._10_2_ =
                         -(ushort)((short)(sVar64 - sVar28) < (short)(auVar58._10_2_ - sVar28));
                    auVar63._12_2_ =
                         -(ushort)((short)(sVar61 - sVar29) < (short)(auVar58._12_2_ - sVar29));
                    auVar63._14_2_ =
                         -(ushort)((short)(sVar64 - sVar30) < (short)(auVar58._14_2_ - sVar30));
                    auVar58 = auVar63 & (auVar56 ^ auVar58) ^ auVar58;
                    auVar60._0_12_ = auVar58._4_12_;
                    auVar60._12_4_ = auVar58._0_4_;
                    auVar54._0_2_ =
                         -(ushort)((short)(auVar58._4_2_ - sVar23) < (short)(auVar58._0_2_ - sVar23)
                                  );
                    auVar54._2_2_ =
                         -(ushort)((short)(auVar58._6_2_ - sVar24) < (short)(auVar58._2_2_ - sVar24)
                                  );
                    auVar54._4_4_ = 0;
                    auVar54._8_2_ =
                         -(ushort)((short)(auVar58._12_2_ - sVar27) <
                                  (short)(auVar58._8_2_ - sVar27));
                    auVar54._10_2_ =
                         -(ushort)((short)(auVar58._14_2_ - sVar28) <
                                  (short)(auVar58._10_2_ - sVar28));
                    auVar54._12_2_ =
                         -(ushort)((short)(auVar58._0_2_ - sVar29) <
                                  (short)(auVar58._12_2_ - sVar29));
                    auVar54._14_2_ =
                         -(ushort)((short)(auVar58._2_2_ - sVar30) <
                                  (short)(auVar58._14_2_ - sVar30));
                    auVar58 = auVar54 & (auVar60 ^ auVar58) ^ auVar58;
                    uVar53 = (uint)(ushort)-(ushort)((short)(auVar58._2_2_ - sVar23) <
                                                    (short)(auVar58._0_2_ - sVar23)) &
                  ...
                  if (uVar39 < uVar41) {
                    ...
                    do {
                      if (*(char *)(uVar39 + param_7 + lVar32) != '\0') {
                        ...
                        if (*(ushort *)(lVar1 + uVar39 * 2) < uVar52) {
