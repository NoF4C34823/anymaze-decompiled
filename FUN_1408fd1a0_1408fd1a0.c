...
void FUN_1408fd1a0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)
...
LAB_1408fd5f6:
    ...
    if ((longlong)param_3 < 0x1d) {
      ...
      uVar23 = param_2 & 0x1f;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1408fd5f6;
        uVar23 = 0x20 - uVar23 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar23 + 0x10)) goto LAB_1408fd5f6;
      uVar21 = 0;
