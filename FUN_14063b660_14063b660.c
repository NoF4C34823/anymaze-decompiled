...
void FUN_14063b660(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14063bbf9:
      uVar28 = 0;
      if (param_5 == 0) goto LAB_14063b908;
      uVar24 = 0;
      uVar22 = param_5;
    }
    else {
      ...
      uVar22 = uVar21 & 0xf;
      if (uVar22 != 0) {
        if ((uVar21 & 3) != 0) goto LAB_14063bbf9;
        uVar22 = 0x10 - uVar22 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar22 + 8)) goto LAB_14063bbf9;
      ...
      if (param_5 < uVar28 + 1) goto LAB_14063b908;
...
LAB_14063b908:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar22 & 0xf;
      if (uVar21 != 0) {
        if ((uVar22 & 3) != 0) goto LAB_14063bc16;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)(uVar21 + 4) <= (longlong)param_5) {
        uVar24 = 0;
        uVar28 = param_5 - (param_5 - uVar21 & 3);
        uVar16 = _UNK_14308b6ac;
        uVar17 = _UNK_14308b6a8;
        uVar18 = _UNK_14308b6a4;
        uVar19 = _DAT_14308b6a0;
        if (uVar21 != 0) {
          do {
...
LAB_14063bbaf:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar21 = uVar22 & 0xf;
    if (uVar21 != 0) {
      if ((uVar22 & 3) != 0) goto LAB_14063bc0f;
      uVar21 = 0x10 - uVar21 >> 2;
    }
