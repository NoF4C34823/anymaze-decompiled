...
void FUN_140301200(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar26 != 0 && 0 < (longlong)uVar9) {
      do {
        FUN_14031cfa0(lVar11,lVar24,uVar3,(longlong)(int)param_6,4);
        lVar25 = lVar25 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_14031cfa0(lVar11,lVar24,uVar3,(longlong)(int)param_6,4);
        FUN_140328840(param_9,uVar22,param_3,uVar3,uVar9);
        lVar26 = lVar26 + 1;
        lVar24 = lVar24 + uVar22;
...
LAB_140301931:
                    ...
                    if (lVar23 < (longlong)(uVar14 + 0x10)) goto LAB_140301931;
                    uVar17 = 0;
                    uVar19 = lVar23 - (lVar23 - uVar14 & 0xf);
                    if (uVar14 != 0) {
                      do {
                        if ((*(char *)(uVar17 + uVar21) != '\0') &&
                           (bVar29 = *(byte *)(lVar1 + lVar25 + uVar17 * 4), bVar29 < bVar30)) {
                          bVar30 = bVar29;
                        }
                        uVar17 = uVar17 + 1;
                      } while (uVar17 < uVar14);
                  ...
                  for (; uVar19 < (ulonglong)(longlong)(int)param_6; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar21) != '\0') &&
                       (bVar29 = *(byte *)(lVar1 + lVar25 + uVar19 * 4), bVar29 < bVar30)) {
                      bVar30 = bVar29;
                    }
                  }
                }
