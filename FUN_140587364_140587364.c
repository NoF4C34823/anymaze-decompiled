...
void FUN_140587364(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_140d34600(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,uStack0000000000000060,1);
