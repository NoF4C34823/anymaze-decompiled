...
void FUN_1406ec640(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1406ed046:
      ...
      uVar35 = uVar39 & 0xf;
      if (uVar35 != 0) {
        if ((uVar39 & 3) != 0) goto LAB_1406ed046;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar35 + 8)) goto LAB_1406ed046;
...
LAB_1406ecac4:
        ...
        uVar38 = uVar38 + 1;
        pfVar36 = pfVar36 + 1;
        if (iVar30 - 1U <= uVar38) goto LAB_1406ecb43;
      }
      uVar38 = uVar38 + 1;
      pfVar36 = pfVar36 + 1;
...
LAB_1406ed034:
      ...
      uVar43 = uVar31 & 0xf;
      if (uVar43 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_1406ed034;
        uVar43 = 0x10 - uVar43 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar43 + 8)) goto LAB_1406ed034;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar31 = uVar43 & 0xf;
      if (uVar31 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_1406ed042;
      ...
      if ((longlong)(uVar31 + 4) <= (longlong)param_5) {
        ...
        auVar29 = _DAT_14308bd40;
        auVar28 = _DAT_14308bd30;
        lVar42 = uVar31 * 2;
        do {
...
LAB_1406ecfc8:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar31 = uVar43 & 0xf;
    if (uVar31 != 0) {
      if ((uVar43 & 3) != 0) goto LAB_1406ed03b;
      uVar31 = 0x10 - uVar31 >> 2;
    }
