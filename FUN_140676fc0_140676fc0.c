...
void FUN_140676fc0(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140677b14:
      ...
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140677b14;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)uVar8 < (longlong)(uVar35 + 8)) goto LAB_140677b14;
...
LAB_140677ade:
          ...
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140677ade;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)uVar8 < (longlong)(uVar35 + 8)) goto LAB_140677ade;
          lVar37 = lVar40 * 0xc;
          lVar38 = lVar33 * -0xc;
          uVar29 = uVar8 - (uVar8 - uVar35 & 7);
          ...
          if (uVar8 < uVar29 + 1) goto LAB_14067792a;
          uVar36 = uVar8 - uVar29;
...
LAB_14067792a:
  ...
  if (7 < (longlong)uVar8) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_140677ad2;
      uVar35 = 0x10 - uVar35 >> 2;
    }
