...
void FUN_140804640(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14080505b:
      uVar31 = 0;
      if (uVar37 == 0) goto LAB_14080487c;
      uVar29 = 0;
      uVar32 = uVar37;
    }
    else {
      ...
      if (uVar32 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_14080505b;
        uVar32 = 0x20 - uVar32 >> 2;
      }
      if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_14080505b;
      uVar29 = 0;
      ...
      if (uVar37 < uVar31 + 1) goto LAB_14080487c;
...
LAB_140805020:
          uVar31 = 0;
          if (uVar37 == 0) goto LAB_140804e65;
          uVar29 = 0;
          uVar32 = uVar37;
        }
        else {
          uVar32 = (ulonglong)param_2 & 0x1f;
          if (uVar32 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140805020;
            uVar32 = 0x20 - uVar32 >> 2;
          }
          if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_140805020;
          uVar31 = uVar37 - (uVar37 - uVar32 & 0xf);
          ...
          if (uVar37 < uVar31 + 1) goto LAB_140804e65;
          uVar32 = uVar37 - uVar31;
          if ((longlong)uVar32 < 4) {
            uVar29 = 0;
          }
...
LAB_14080500d:
    ...
    uVar32 = (ulonglong)param_2 & 0x1f;
    if (uVar32 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_14080500d;
      uVar32 = 0x20 - uVar32 >> 2;
    }
    if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_14080500d;
    uVar29 = 0;
    uVar31 = uVar37 - (uVar37 - uVar32 & 0xf);
    if (uVar32 != 0) {
      do {
