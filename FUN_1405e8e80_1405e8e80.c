...
void FUN_1405e8e80(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1405e9918:
      ...
      if (uVar33 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_1405e9918;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)uVar39 < (longlong)(uVar33 + 8)) goto LAB_1405e9918;
      uVar31 = 0;
...
LAB_1405e98e4:
          uVar29 = 0;
          if (uVar39 == 0) goto LAB_1405e9703;
          uVar31 = 0;
          uVar33 = uVar39;
        }
        else {
          uVar33 = (ulonglong)param_2 & 0xf;
          if (uVar33 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_1405e98e4;
            uVar33 = 0x10 - uVar33 >> 2;
          }
          if ((longlong)uVar39 < (longlong)(uVar33 + 8)) goto LAB_1405e98e4;
          lVar30 = lVar34 * -0xc;
          uVar29 = uVar39 - (uVar39 - uVar33 & 7);
          ...
          if (uVar39 < uVar29 + 1) goto LAB_1405e9703;
...
LAB_1405e9703:
  ...
  if (7 < (longlong)uVar39) {
    uVar33 = (ulonglong)param_2 & 0xf;
    if (uVar33 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_1405e98d1;
      uVar33 = 0x10 - uVar33 >> 2;
    }
