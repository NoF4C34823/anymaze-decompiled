...
void FUN_1401b2d80(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < iVar18) {
    ...
    uVar16 = param_7 & 0x20;
    lVar15 = lVar10;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_1401b31a1;
    uVar9 = 0;
LAB_1401b2e60:
    uVar12 = uVar9;
    if (((longlong)param_5[1] <= (longlong)uVar9) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar16 == 0) goto LAB_1401b2fb7;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_1401b2e9a;
        if (uVar16 == 0) {
          uVar12 = param_5[1] - 1;
        }
      }
...
LAB_1401b2f1b:
    do {
      FUN_1401b3a00(param_1,param_2,uVar12);
      while( true ) {
        while( true ) {
          iVar8 = (int)uVar9;
          uVar9 = uVar9 + 1;
          ...
          if (uVar19 <= uVar9) {
            if (uVar5 != 0) {
              ...
              lVar14 = -uVar19;
              do {
                FUN_1401b3a00(param_1,param_2,lVar14,param_3);
                lVar11 = lVar11 + 1;
                lVar14 = lVar14 + 1;
...
LAB_1401b31a1:
          (**(code **)(&UNK_143087ec0 + (longlong)param_6 * 8))
                    (param_2 * uVar9 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar9) goto LAB_1401b2e60;
        uVar12 = uVar9;
        if (param_7 == 0xf0) goto LAB_1401b2f1b;
        if ((param_7 & 0xf) != 6) break;
        if (uVar5 != 0) goto LAB_1401b2f1b;
LAB_1401b2fb7:
        uVar12 = *param_5;
...
LAB_1401b3964:
            ...
            uVar6 = uVar7 & 0xf;
            if (uVar6 != 0) {
              if ((uVar7 & 3) != 0) goto LAB_1401b3964;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar6 + 8)) goto LAB_1401b3964;
            uVar13 = 0;
...
LAB_1401b3890:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1401b3890;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 8)) goto LAB_1401b3890;
            uVar17 = 0;
...
LAB_1401b3733:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1401b3733;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1401b3733;
            uVar17 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      if (((lVar11 < 0) || ((longlong)param_5[1] <= lVar11)) && (param_7 != 0xf0)) {
        if ((longlong)param_5[1] < 2) {
          ...
          if (lVar11 < 0) goto LAB_1401b3560;
...
LAB_1401b3560:
      ...
      FUN_1401b3a00(param_1,param_2,lVar11,param_3);
    }
    lVar11 = 1;
    uVar9 = 0;
    if (1 < iVar18) {
...
LAB_1401b3526:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1401b3526;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1401b3526;
...
LAB_1401b2e9a:
  ...
  if ((param_7 & 0xf) == 3) {
    if ((longlong)param_5[1] < 2) {
      ...
      if ((longlong)uVar9 < 0) goto LAB_1401b3140;
      while (uVar16 == 0) {
