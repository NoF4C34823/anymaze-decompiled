...
void FUN_14086d380(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014086e4f2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca20)[lVar6])(pbVar21,param_4,*param_5);
    return;
  }
  if (uVar22 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar22 != 6) {
            if (uVar22 == 1) {
              ...
              if (lVar24 < 2) {
                ...
                if (lVar12 < 0) goto LAB_14086e480;
                while (uVar11 == 0) {
                  for (lVar10 = (lVar24 + -1) * 2 - lVar10; lVar10 < 0; lVar10 = -lVar10) {
LAB_14086e480:
                    if (uVar8 != 0) goto LAB_14086e382;
                  }
          ...
          bVar16 = bVar13;
          if (uVar17 != 0) goto LAB_14086e382;
        }
        else {
LAB_14086e382:
        ...
        *(byte *)(lVar7 + param_11) = bVar16;
        lVar7 = lVar7 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014086e3e2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca20)[lVar6])(param_11 + uVar23,param_4,lVar24,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar23 == 1) {
...
LAB_14086e3f6:
              ...
              if ((longlong)uVar20 < (longlong)(uVar14 + 0x10)) goto LAB_14086e3f6;
...
LAB_14086e404:
              ...
              if ((longlong)uVar23 < (longlong)(uVar18 + 0x10)) goto LAB_14086e404;
              uVar19 = 0;
...
LAB_14086e3fd:
          ...
          if ((longlong)uVar23 < (longlong)(uVar18 + 0x10)) goto LAB_14086e3fd;
          uVar19 = 0;
          uVar14 = uVar23 - (uVar23 - uVar18 & 0xf);
          if (uVar18 != 0) {
            do {
      ...
      (*(code *)(&PTR_FUN_14308ca20)[lVar6])(uVar23 + param_11,param_4,uVar23,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014086e465. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca20)[lVar6])(pbVar21,param_4,lVar24);
    return;
  }
  if ((longlong)uVar23 < lVar24) {
    lVar24 = lVar24 - uVar23;
    (*(code *)(&PTR_FUN_14308ca20)[lVar6])(pbVar21,param_4,lVar24,param_9,param_10);
...
LAB_14086e40b:
          ...
          if ((longlong)uVar20 < (longlong)(uVar18 + 0x10)) goto LAB_14086e40b;
...
LAB_14086de9c:
  if (uVar22 == 1) {
    if ((longlong)uVar23 < 1) goto LAB_14086e231;
    if ((longlong)uVar23 < 7) {
      lVar24 = 1;
      if (uVar23 >> 1 != 0) {
...
LAB_14086e423:
      ...
      if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_14086e423;
      uVar14 = 0;
  ...
  if (uVar22 != 3) {
    if ((uVar22 != 6) || ((longlong)uVar23 < 1)) goto LAB_14086e231;
    if ((longlong)uVar23 < 0x10) {
LAB_14086e41b:
      uVar18 = 0;
    }
      ...
      if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_14086e41b;
      uVar14 = 0;
      uVar18 = uVar23 - (uVar23 - uVar20 & 0xf);
      if (uVar20 != 0) {
        do {
...
LAB_14086e413:
    ...
    if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_14086e413;
    uVar14 = 0;
    lVar7 = 0;
    uVar18 = uVar23 - (uVar23 - uVar20 & 0xf);
    if (uVar20 != 0) {
...
LAB_14086e231:
                    /* WARNING: Could not recover jumptable at 0x00014086e271. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308ca20)[lVar6])(param_11 + uVar23,param_4,uVar23);
  return;
}
