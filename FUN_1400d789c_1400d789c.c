...
void FUN_1400d789c(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4)

{
  ...
  if (param_2 + 1U <= param_4) {
    ...
    if (uVar6 < param_4) {
      ...
      do {
        auVar9._0_4_ = (float)((uint)*(ushort *)(param_1 + -2 + uVar6 * 2) +
        ...
        auVar10 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM2_Da *
                                                (float)*(ushort *)(param_1 + uVar6 * 2))),auVar9,
                                  auVar5);
