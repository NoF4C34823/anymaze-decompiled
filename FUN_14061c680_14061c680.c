...
/* WARNING: Removing unreachable block (ram,0x00014061d393) */

void FUN_14061c680(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b560 + lVar18 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar11 < 2) {
                ...
                if (lVar16 < 0) goto LAB_14061d760;
                while (uVar14 == 0) {
                  for (lVar5 = (lVar11 + -1) * 2 - lVar5; lVar5 < 0; lVar5 = -lVar5) {
LAB_14061d760:
                    if (uVar7 != 0) goto LAB_14061d62c;
                  }
...
LAB_14061d62c:
    ...
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b560 + lVar18 * 8))(param_11 + uVar21 * 0xc,param_4,lVar11,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_198 = uVar21 * 3;
      ...
      if (uVar15 != 0 && SCARRY8(uVar10,-3) == (longlong)uVar15 < 0) {
        if (6 < (longlong)uVar15) {
          ...
          if ((lVar16 <= (longlong)(uStack_1a0 - param_1)) ||
            ...
            if (uVar6 == 0) {
LAB_14061c7e3:
              if ((longlong)uVar15 < (longlong)(uVar6 + 4)) goto LAB_14061d6fc;
              uVar8 = 0;
...
LAB_14061cf34:
      uStack_1c0 = uVar10;
      pcStack_1b8 = *(code **)(&DAT_14308b560 + lVar18 * 8);
      iStack_1d8 = param_10;
      uStack_190 = param_7;
