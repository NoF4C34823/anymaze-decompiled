...
void FUN_1406c3760(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1406c4084:
      ...
      uVar32 = param_2 & 0xf;
      if (uVar32 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1406c4084;
        uVar32 = 0x10 - uVar32 >> 2;
      }
      if ((longlong)uVar37 < (longlong)(uVar32 + 8)) goto LAB_1406c4084;
...
LAB_1406c4066:
          uVar26 = 0;
          if (uVar37 == 0) goto LAB_1406c3e6a;
          uVar34 = 0;
          uVar32 = uVar37;
        }
        else {
          uVar32 = param_2 & 0xf;
          if (uVar32 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1406c4066;
            uVar32 = 0x10 - uVar32 >> 2;
          }
          if ((longlong)uVar37 < (longlong)(uVar32 + 8)) goto LAB_1406c4066;
          uVar26 = uVar37 - (uVar37 - uVar32 & 7);
          ...
          if (uVar37 < uVar26 + 1) goto LAB_1406c3e6a;
...
LAB_1406c4053:
    ...
    uVar32 = param_2 & 0xf;
    if (uVar32 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406c4053;
      uVar32 = 0x10 - uVar32 >> 2;
    }
    if ((longlong)uVar37 < (longlong)(uVar32 + 8)) goto LAB_1406c4053;
    uVar34 = 0;
    uVar26 = uVar37 - (uVar37 - uVar32 & 7);
    if (uVar32 != 0) {
      do {
