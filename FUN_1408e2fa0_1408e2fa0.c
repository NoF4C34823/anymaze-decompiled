...
void FUN_1408e2fa0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1408e30af;
    if ((param_7 & 0xf) == 6) {
      uVar1 = param_7 & 0x10;
      goto joined_r0x0001408e33c2;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_1408e30af;
    if ((param_7 & 0xf) == 6) {
      uVar1 = param_7 & 0x20;
joined_r0x0001408e33c2:
      if (uVar1 == 0) {
        fVar9 = (float)*param_8;
        fVar8 = (float)param_8[1];
        fVar10 = (float)param_8[2];
        if (0 < *param_5 * 3) {
          uVar4 = (*param_5 * 3 + 2) / 3;
...
LAB_1408e30af:
  lStack_38 = *param_5;
  lStack_30 = param_5[1];
  FUN_1408ead00(lStack_38,param_2,param_3,param_4,&lStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
