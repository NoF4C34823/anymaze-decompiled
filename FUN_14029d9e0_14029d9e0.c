...
void FUN_14029d9e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar25 != 0 && 0 < (longlong)uVar9) {
      do {
        FUN_14031cfa0(lVar11,lVar16,(longlong)(int)param_5,uVar22,1);
        lVar26 = lVar26 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_14031cfa0(lVar11,lVar16,(longlong)(int)param_5,uVar22,1);
        FUN_140328840(param_9,uVar23,param_3,(longlong)(int)param_5,uVar9);
        lVar25 = lVar25 + 1;
        lVar16 = lVar16 + uVar23;
...
LAB_14029e131:
                    ...
                    if ((longlong)uVar22 < (longlong)(uVar14 + 0x10)) goto LAB_14029e131;
                    uVar24 = 0;
                    uVar19 = uVar22 - (uVar22 - uVar14 & 0xf);
                    if (uVar14 != 0) {
                      do {
                        if ((*(char *)(uVar24 + uVar21) != '\0') &&
                           (bVar29 = *(byte *)(lVar1 + lVar26 + uVar24), bVar29 < bVar30)) {
                          bVar30 = bVar29;
                        }
                        uVar24 = uVar24 + 1;
                      } while (uVar24 < uVar14);
                    ...
                    do {
                      ...
                      uVar14 = uVar14 + 0x10;
                      bVar6 = auVar32[0];
                      auVar28[0] = (bVar6 < bVar30) * bVar6 | (bVar6 >= bVar30) * bVar30;
                      bVar30 = auVar32[1];
                      ...
                      bVar30 = auVar32[9];
                      auVar28[9] = (bVar30 < bVar4) * bVar30 | (bVar30 >= bVar4) * bVar4;
                      bVar30 = auVar32[10];
                      auVar28[10] = (bVar30 < bVar5) * bVar30 | (bVar30 >= bVar5) * bVar5;
                      bVar30 = auVar32[0xb];
                      auVar28[0xb] = (bVar30 < bVar8) * bVar30 | (bVar30 >= bVar8) * bVar8;
                      bVar30 = auVar32[0xc];
                      auVar28[0xc] = (bVar30 < bVar12) * bVar30 | (bVar30 >= bVar12) * bVar12;
                      bVar30 = auVar32[0xd];
                      auVar28[0xd] = (bVar30 < bVar10) * bVar30 | (bVar30 >= bVar10) * bVar10;
                      bVar30 = auVar32[0xe];
                      auVar28[0xe] = (bVar30 < bVar15) * bVar30 | (bVar30 >= bVar15) * bVar15;
                      bVar30 = auVar32[0xf];
                  ...
                  for (; uVar19 < uVar22; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar21) != '\0') &&
                       (bVar29 = *(byte *)(lVar1 + lVar26 + uVar19), bVar29 < bVar30)) {
                      bVar30 = bVar29;
                    }
                  }
                }
