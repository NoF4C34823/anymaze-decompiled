...
void FUN_14016d700(ulonglong param_1,float param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    uVar18 = in_RDX & 0xf;
    if (uVar18 != 0) {
      if ((in_RDX & 3) != 0) goto LAB_14016d8f3;
...
LAB_14016d8fc:
  FUN_14016d898(uVar18,param_2,fVar7,0);
  return;
}
