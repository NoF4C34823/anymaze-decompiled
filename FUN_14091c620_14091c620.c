...
/* WARNING: Removing unreachable block (ram,0x00014091e40a) */

void FUN_14091c620(longlong param_1,longlong param_2,float *param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar19 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_14091e9dd;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      uStack_1b0 = 0;
      uStack_110 = 0;
      pcStack_d8 = (code *)(&PTR_FUN_14308d480)[lVar14];
            ...
            if (lStack_c8 < (longlong)(uVar18 + uVar22)) {
              ...
              do {
                ...
                if (lVar8 < 0) {
                  if (uStack_118 != 0xf0) {
                    if (iVar19 == 6) {
                      if (uStack_e0 == 0) goto LAB_14091e957;
                    }
                    else {
                      if (iVar19 != 1) goto LAB_14091e8cd;
LAB_14091ea7b:
                      lVar12 = 0;
                      if (uStack_e0 != 0) {
                        lVar12 = lVar8;
...
LAB_14091e93b:
                  ...
                  if ((lVar8 < (longlong)uVar22) || (uStack_118 == 0xf0)) goto LAB_14091e93b;
                  if (iVar19 != 6) {
                    if (iVar19 == 1) {
                      if (lVar8 < 0) goto LAB_14091ea7b;
                      if (uStack_b8 == 0) {
                        lVar12 = lStack_100;
                      }
                    }
...
LAB_14091eaa0:
                  ...
                  if (uStack_b8 != 0) goto LAB_14091e93b;
LAB_14091e957:
                  sVar6 = *psVar24;
                  sVar16 = psVar24[1];
                  sVar21 = psVar24[2];
...
LAB_14091ea1b:
                      ...
                      if ((longlong)uStack_f8 < 0x2b9) {
                        ...
                        if (((uStack_148 != 0) && (uVar15 = uStack_190, uStack_150 != 0)) ||
                           ((longlong)uStack_f8 < (longlong)(uVar15 + 0x10))) goto LAB_14091ea1b;
...
LAB_14091d861:
                    ...
                    sVar6 = psStack_d0[2];
                    if ((longlong)uStack_178 < 0x10) goto LAB_14091d861;
                    uVar15 = 0;
                    lVar14 = 0;
                    do {
                      sVar16 = *psStack_d0;
...
LAB_14091cae5:
            ...
            if ((longlong)uVar18 < 0xbd) {
              ...
              if (uVar15 != 0) {
                if (((ulonglong)pfVar17 & 3) != 0) goto LAB_14091cae5;
                uVar15 = 0x20 - uVar15 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_14091cae5;
              uVar26 = 0;
    ...
    if ((uStack_48 ^ (ulonglong)auStack_218) != DAT_1436b4680) goto LAB_14091c7fa;
  }
  else {
    if (uVar13 == 3) {
...
LAB_14091c985:
              ...
              if ((longlong)uVar18 < 0xbd) {
                ...
                uVar15 = (ulonglong)pfVar17 & 0x1f;
                if (uVar15 != 0) {
                  if (((ulonglong)pfVar17 & 3) != 0) goto LAB_14091c985;
                  uVar15 = 0x20 - uVar15 >> 2;
                }
                if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_14091c985;
                lVar8 = (longlong)param_3 + (lVar25 - lVar8);
                uVar26 = 0;
                uVar22 = uVar18 - (uVar18 - uVar15 & 7);
                if (uVar15 != 0) {
