...
void FUN_1408f50f9(ulonglong param_1,float param_2,ulonglong param_3)

{
  ...
  do {
    pfVar2 = (float *)(in_R10 + -4 + param_1 * 4);
    pfVar3 = (float *)(in_R10 + 4 + param_1 * 4);
    pfVar4 = (float *)(in_R10 + -8 + param_1 * 4);
    ...
    *(undefined1 (*) [32])(in_RDX + param_1 * 4) = ZEXT1632(auVar11);
    ...
    pfVar3 = (float *)(in_R10 + 0x24 + param_1 * 4);
    ...
    pfVar2 = (float *)(in_R10 + 0x28 + param_1 * 4);
    ...
    auVar11 = vfmadd231ps_fma(auVar8,auVar18,auVar12);
  ...
  if (in_R11 + 1 <= param_3) {
    ...
    if ((longlong)param_3 < 4) {
      FUN_1408f524d(param_1,in_RDX,param_3,0);
      return;
    }
    uVar9 = 0;
    ...
    do {
      ...
      pfVar2 = (float *)(in_R10 + in_R11 * 4 + 8 + uVar9 * 4);
      auVar17._0_4_ = *pfVar4 + *pfVar2;
      auVar17._4_4_ = pfVar4[1] + pfVar2[1];
      auVar17._8_4_ = pfVar4[2] + pfVar2[2];
      auVar17._12_4_ = pfVar4[3] + pfVar2[3];
      auVar15 = vfmadd231ps_fma(auVar15,auVar17,auVar11);
    ...
    if (uVar10 < param_3) {
      ...
      do {
        ...
        auVar11 = vfmadd213ss_fma(ZEXT416((uint)(*(float *)(lVar1 + -8 + uVar10 * 4) +
                                                *(float *)(lVar1 + 8 + uVar10 * 4))),auVar6,
                                  ZEXT416((uint)(in_XMM0_Da * *(float *)(lVar1 + uVar10 * 4))));
        auVar5._4_12_ = in_register_00001244;
        auVar5._0_4_ = param_2;
        auVar11 = vfmadd213ss_fma(ZEXT416((uint)(*(float *)(lVar1 + -4 + uVar10 * 4) +
                                                *(float *)(lVar1 + 4 + uVar10 * 4))),auVar5,auVar11)
        ;
