...
void FUN_14065a06e(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         (float)((int)*(short *)(param_4 + -0x12 + in_RAX * 2) +
                (int)*(short *)(param_4 + 0x12 + in_RAX * 2)) * param_2 +
         (float)((int)*(short *)(param_4 + -0xc + in_RAX * 2) +
                (int)*(short *)(param_4 + 0xc + in_RAX * 2)) * in_XMM2_Da +
         (float)((int)*(short *)(param_4 + -6 + in_RAX * 2) +
                (int)*(short *)(param_4 + 6 + in_RAX * 2)) * in_XMM5_Da +
         (float)(int)*(short *)(param_4 + in_RAX * 2) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < in_RDX);
  do {
    uVar2 = *(ulonglong *)(param_4 + -0x12 + in_RDX * 2);
    ...
    auVar9._2_2_ = uVar25;
    auVar9._0_2_ = uVar25;
    uVar25 = (undefined2)(uVar3 >> 0x30);
    auVar18._8_4_ = 0;
    auVar18._0_8_ = uVar3;
    auVar18._12_2_ = uVar25;
    auVar18._14_2_ = uVar25;
    uVar25 = (undefined2)(uVar3 >> 0x20);
    auVar17._12_4_ = auVar18._12_4_;
    auVar17._8_2_ = 0;
    auVar17._0_8_ = uVar3;
    auVar17._10_2_ = uVar25;
    auVar16._10_6_ = auVar17._10_6_;
    auVar16._8_2_ = uVar25;
    auVar16._0_8_ = uVar3;
    uVar25 = (undefined2)(uVar3 >> 0x10);
    auVar10._4_8_ = auVar16._8_8_;
    auVar10._2_2_ = uVar25;
    auVar10._0_2_ = uVar25;
    uVar4 = *(ulonglong *)(param_4 + -0xc + in_RDX * 2);
    uVar5 = *(ulonglong *)(param_4 + 0xc + in_RDX * 2);
    uVar25 = (undefined2)(uVar4 >> 0x30);
    auVar34._8_4_ = 0;
    auVar34._0_8_ = uVar4;
    auVar34._12_2_ = uVar25;
    auVar34._14_2_ = uVar25;
    uVar25 = (undefined2)(uVar4 >> 0x20);
    ...
    auVar32._0_8_ = uVar4;
    uVar25 = (undefined2)(uVar4 >> 0x10);
    auVar11._4_8_ = auVar32._8_8_;
    auVar11._2_2_ = uVar25;
    auVar11._0_2_ = uVar25;
    uVar25 = (undefined2)(uVar5 >> 0x30);
    auVar21._8_4_ = 0;
    auVar21._0_8_ = uVar5;
    auVar21._12_2_ = uVar25;
    auVar21._14_2_ = uVar25;
    uVar25 = (undefined2)(uVar5 >> 0x20);
    auVar20._12_4_ = auVar21._12_4_;
    auVar20._8_2_ = 0;
    auVar20._0_8_ = uVar5;
    auVar20._10_2_ = uVar25;
    auVar19._10_6_ = auVar20._10_6_;
    auVar19._8_2_ = uVar25;
    auVar19._0_8_ = uVar5;
    uVar25 = (undefined2)(uVar5 >> 0x10);
    auVar12._4_8_ = auVar19._8_8_;
    ...
    auVar15._4_8_ = auVar22._8_8_;
    auVar15._2_2_ = uVar25;
    auVar15._0_2_ = uVar25;
    pfVar1 = (float *)(in_R10 + in_RDX * 4);
    *pfVar1 = (float)((int)(short)uVar2 + (int)(short)uVar3) * param_2 +
              (float)((int)(short)uVar4 + (int)(short)uVar5) * in_XMM2_Da +
              (float)((int)(short)uVar7 + (int)(short)uVar6) * in_XMM5_Da +
    ...
    pfVar1[1] = (float)((auVar9._0_4_ >> 0x10) + (auVar10._0_4_ >> 0x10)) * param_2 +
                ...
                (float)((auVar14._0_4_ >> 0x10) + (auVar13._0_4_ >> 0x10)) * in_XMM5_Da +
                (float)(auVar15._0_4_ >> 0x10) * in_XMM0_Da;
    pfVar1[2] = (float)((auVar26._8_4_ >> 0x10) + (auVar16._8_4_ >> 0x10)) * param_2 +
                (float)((auVar32._8_4_ >> 0x10) + (auVar19._8_4_ >> 0x10)) * in_XMM2_Da +
                (float)((auVar35._8_4_ >> 0x10) + (auVar29._8_4_ >> 0x10)) * in_XMM5_Da +
                (float)(auVar22._8_4_ >> 0x10) * in_XMM0_Da;
    pfVar1[3] = (float)((auVar27._12_4_ >> 0x10) + (auVar17._12_4_ >> 0x10)) * param_2 +
                (float)((auVar33._12_4_ >> 0x10) + (auVar20._12_4_ >> 0x10)) * in_XMM2_Da +
                (float)((auVar36._12_4_ >> 0x10) + (auVar30._12_4_ >> 0x10)) * in_XMM5_Da +
                (float)(auVar23._12_4_ >> 0x10) * in_XMM0_Da;
    in_RDX = in_RDX + 4;
