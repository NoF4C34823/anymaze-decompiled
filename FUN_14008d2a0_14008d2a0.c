...
void FUN_14008d2a0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14008db8c:
      uVar13 = 0;
      if (uVar16 == 0) goto LAB_14008d4c5;
      uVar15 = 0;
      uVar8 = uVar16;
    }
    else {
      uVar8 = param_2 & 0xf;
      if (uVar8 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14008db8c;
        uVar8 = 0x10 - uVar8 >> 2;
      }
      if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14008db8c;
      uVar15 = 0;
      ...
      if (uVar16 < uVar13 + 1) goto LAB_14008d4c5;
      uVar8 = uVar16 - uVar13;
      if ((longlong)uVar8 < 4) {
        uVar15 = 0;
      }
...
LAB_14008db66:
          uVar13 = 0;
          if (uVar16 == 0) goto LAB_14008d9ad;
          uVar15 = 0;
          uVar8 = uVar16;
        }
        else {
          uVar8 = param_2 & 0xf;
          if (uVar8 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14008db66;
            uVar8 = 0x10 - uVar8 >> 2;
          }
          if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14008db66;
          uVar15 = 0;
          ...
          if (uVar16 < uVar13 + 1) goto LAB_14008d9ad;
          uVar8 = uVar16 - uVar13;
          if ((longlong)uVar8 < 4) {
            uVar15 = 0;
          }
...
LAB_14008db53:
    ...
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14008db53;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14008db53;
    uVar15 = 0;
    uVar13 = uVar16 - (uVar16 - uVar8 & 7);
    if (uVar8 != 0) {
      do {
