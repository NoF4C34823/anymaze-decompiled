...
void FUN_1401faa00(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401fbb72. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088200 + lVar6 * 8))(pbVar21,param_4,*param_5);
    return;
  }
  if (uVar22 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar22 != 6) {
            if (uVar22 == 1) {
              ...
              if (lVar24 < 2) {
                ...
                if (lVar12 < 0) goto LAB_1401fbb00;
                while (uVar11 == 0) {
                  for (lVar10 = (lVar24 + -1) * 2 - lVar10; lVar10 < 0; lVar10 = -lVar10) {
LAB_1401fbb00:
                    if (uVar8 != 0) goto LAB_1401fba02;
                  }
          ...
          bVar16 = bVar13;
          if (uVar17 != 0) goto LAB_1401fba02;
        }
        else {
LAB_1401fba02:
        ...
        *(byte *)(lVar7 + param_11) = bVar16;
        lVar7 = lVar7 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401fba62. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088200 + lVar6 * 8))(param_11 + uVar23,param_4,lVar24,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar23 == 1) {
...
LAB_1401fba76:
              ...
              if ((longlong)uVar20 < (longlong)(uVar14 + 0x10)) goto LAB_1401fba76;
...
LAB_1401fba84:
              ...
              if ((longlong)uVar23 < (longlong)(uVar18 + 0x10)) goto LAB_1401fba84;
              uVar19 = 0;
...
LAB_1401fba7d:
          ...
          if ((longlong)uVar23 < (longlong)(uVar18 + 0x10)) goto LAB_1401fba7d;
          uVar19 = 0;
          uVar14 = uVar23 - (uVar23 - uVar18 & 0xf);
          if (uVar18 != 0) {
            do {
      ...
      (**(code **)(&DAT_143088200 + lVar6 * 8))(uVar23 + param_11,param_4,uVar23,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401fbae5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088200 + lVar6 * 8))(pbVar21,param_4,lVar24);
    return;
  }
  if ((longlong)uVar23 < lVar24) {
    lVar24 = lVar24 - uVar23;
    (**(code **)(&DAT_143088200 + lVar6 * 8))(pbVar21,param_4,lVar24,param_9,param_10);
...
LAB_1401fba8b:
          ...
          if ((longlong)uVar20 < (longlong)(uVar18 + 0x10)) goto LAB_1401fba8b;
...
LAB_1401fb51c:
  if (uVar22 == 1) {
    if ((longlong)uVar23 < 1) goto LAB_1401fb8b1;
    if ((longlong)uVar23 < 7) {
      lVar24 = 1;
      if (uVar23 >> 1 != 0) {
...
LAB_1401fbaa3:
      ...
      if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_1401fbaa3;
      uVar14 = 0;
  ...
  if (uVar22 != 3) {
    if ((uVar22 != 6) || ((longlong)uVar23 < 1)) goto LAB_1401fb8b1;
    if ((longlong)uVar23 < 0x10) {
LAB_1401fba9b:
      uVar18 = 0;
    }
      ...
      if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_1401fba9b;
      uVar14 = 0;
      uVar18 = uVar23 - (uVar23 - uVar20 & 0xf);
      if (uVar20 != 0) {
        do {
...
LAB_1401fba93:
    ...
    if ((longlong)uVar23 < (longlong)(uVar20 + 0x10)) goto LAB_1401fba93;
    uVar14 = 0;
    lVar7 = 0;
    uVar18 = uVar23 - (uVar23 - uVar20 & 0xf);
    if (uVar20 != 0) {
...
LAB_1401fb8b1:
                    /* WARNING: Could not recover jumptable at 0x0001401fb8f1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_143088200 + lVar6 * 8))(param_11 + uVar23,param_4,uVar23);
  return;
}
