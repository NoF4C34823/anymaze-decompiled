...
void FUN_140952600(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140953127:
      ...
      if ((longlong)uVar23 < 0x1d) {
        ...
        uVar28 = param_2 & 0x1f;
        if (uVar28 != 0) {
          if ((param_2 & 3) != 0) goto LAB_140953127;
          uVar28 = 0x20 - uVar28 >> 2;
        }
        if ((longlong)uVar23 < (longlong)(uVar28 + 0x10)) goto LAB_140953127;
        lVar18 = lVar33 * -6 + param_1;
...
LAB_140953109:
          ...
          uVar21 = param_2 & 0x1f;
          if (uVar21 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140953109;
            uVar21 = 0x20 - uVar21 >> 2;
          }
          if ((longlong)uVar23 < (longlong)(uVar21 + 0x10)) goto LAB_140953109;
  ...
  if (0xf < (longlong)uVar23) {
    uVar21 = param_2 & 0x1f;
    if (uVar21 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1409530fb;
      uVar21 = 0x20 - uVar21 >> 2;
    }
