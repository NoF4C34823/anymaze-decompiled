...
void FUN_1408ffc00(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar19 = param_4 & 0x1f;
      if (uVar19 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1409001ac;
...
LAB_14090022f:
    ...
    if ((longlong)param_5 < 0x1d) {
      ...
      uVar19 = param_4 & 0x1f;
      if (uVar19 != 0) {
        if ((param_4 & 3) != 0) goto LAB_14090022f;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_14090022f;
      lStack_60 = param_2 * lVar12 + param_1;
      lStack_58 = param_2 * lVar11 + param_1;
      lVar18 = param_2 * lVar14 + param_1;
      lVar17 = param_2 * lVar13 + param_1;
