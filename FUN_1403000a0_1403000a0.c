...
void FUN_1403000a0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && 0 < lVar5) {
      do {
        FUN_142d21fa0(param_1,lVar3,lVar1,(longlong)(int)param_6 * 3,3);
        lVar7 = lVar7 + 1;
