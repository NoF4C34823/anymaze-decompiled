...
void FUN_140547600(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6) {
    do {
      ...
      if (uVar7 != 0) {
        ...
        FUN_1405477e0(param_1,param_2,param_3,uVar7);
      ...
      if (lVar12 != 0) {
        ...
        auVar14 = vminps_avx(*pauVar6,*pauVar8);
        pauVar13 = (undefined1 (*) [32])(*pauVar6 + param_2 * 8);
        auVar14 = vminps_avx(auVar14,*pauVar13);
        lVar5 = 0;
        auVar2 = auVar14;
        if (1 < lVar12) {
          do {
            lVar5 = lVar5 + 1;
            auVar14 = vminps_avx(pauVar6[1],*(undefined1 (*) [32])(pauVar6[1] + param_2 * 4));
            auVar14 = vminps_avx(auVar14,*(undefined1 (*) [32])(pauVar6[1] + param_2 * 8));
            pauVar6 = pauVar6 + 1;
