...
void FUN_14062f140(longlong param_1,longlong param_2,longlong param_3,float *param_4)

{
  ...
  if (7 < (longlong)uVar29) {
    ...
    if (uVar27 != 0) {
      if ((param_1 + 0x18U & 3) != 0) goto LAB_14062f4af;
    ...
    if ((longlong)(uVar27 + 8) <= (longlong)uVar29) {
      ...
      if ((longlong)uVar29 < 4) {
        FUN_14062f437(fVar10,fVar8,0,uVar28,CONCAT44(unaff_XMM8_Dd,unaff_XMM8_Dc),
