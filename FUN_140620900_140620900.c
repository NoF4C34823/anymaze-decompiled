...
void FUN_140620900(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1406209ce:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar9) && (param_7 != 0xf0)) {
      if (uVar18 == 6) {
        if (uStack_90 == 0) goto LAB_140620b14;
      }
      else {
        if (uVar18 != 1) goto LAB_140620a08;
        if (uStack_90 == 0) {
          uVar10 = param_5[1] - 1;
        }
      }
...
LAB_140620a9b:
    do {
      ...
      uStack_68 = *param_5;
      uStack_60 = param_5[1];
      FUN_1406214e0(lStack_50,lStack_58,uVar10,lVar17,in_stack_ffffffffffffff18,param_6,param_7,
          ...
          if (uStack_48 <= uVar9) {
            if (uStack_78 != 0) {
              ...
              do {
                uStack_a8 = *param_5;
                uStack_a0 = param_5[1];
                FUN_1406214e0(lStack_50,lStack_58,lVar14,lVar13,&uStack_a8,param_6,param_7,param_8,
            ...
            param_3 = lStack_88;
            iVar6 = iStack_80;
            if (uVar18 != 1) goto LAB_140620d99;
            uVar9 = 0;
            uVar7 = *param_5;
            goto LAB_140621100;
          }
...
LAB_140620cdc:
          ...
          (**(code **)(&DAT_14308b540 + (longlong)param_6 * 8))
        ...
        if (-1 < (longlong)uVar9) goto LAB_1406209ce;
        uVar10 = uVar9;
        if (param_7 == 0xf0) goto LAB_140620a9b;
        if (uVar18 != 6) break;
        if (uStack_78 != 0) goto LAB_140620a9b;
LAB_140620b14:
        uVar10 = *param_5;
        uVar19 = *param_8;
...
LAB_14062143b:
            ...
            uVar11 = uVar5 & 0xf;
            if (uVar11 != 0) {
              if ((uVar5 & 3) != 0) goto LAB_14062143b;
              uVar11 = 0x10 - uVar11 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar11 + 8)) goto LAB_14062143b;
            uVar12 = 0;
...
LAB_140620d99:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_a8 = *param_5;
    uStack_a0 = param_5[1];
    FUN_1406214e0(param_1,param_2,lVar13,param_3,&uStack_a8,param_6,param_7,param_8,param_9,param_10
                  ,param_11);
  }
  lVar13 = 1;
  uVar7 = 0;
...
LAB_140621045:
        ...
        uVar10 = uVar8 & 0xf;
        if (uVar10 != 0) {
          if ((uVar8 & 3) != 0) goto LAB_140621045;
          uVar10 = 0x10 - uVar10 >> 2;
        }
        if ((longlong)uVar9 < (longlong)(uVar10 + 4)) goto LAB_140621045;
...
LAB_14062136d:
      ...
      uVar8 = uVar10 & 0xf;
      if (uVar8 != 0) {
        if ((uVar10 & 3) != 0) goto LAB_14062136d;
        uVar8 = 0x10 - uVar8 >> 2;
      }
      if ((longlong)uVar7 < (longlong)(uVar8 + 8)) goto LAB_14062136d;
      uVar11 = 0;
...
LAB_14062122f:
      ...
      uVar10 = uVar5 & 0xf;
      if (uVar10 != 0) {
        if ((uVar5 & 3) != 0) goto LAB_14062122f;
        uVar10 = 0x10 - uVar10 >> 2;
      }
      if ((longlong)uVar7 < (longlong)(uVar10 + 4)) goto LAB_14062122f;
      uVar16 = 0;
...
LAB_140620a08:
  ...
  if (uVar18 == 3) {
    ...
    if ((longlong)uVar5 < 2) {
      ...
      if ((longlong)uVar9 < 0) goto LAB_140620c80;
      while (uStack_90 == 0) {
