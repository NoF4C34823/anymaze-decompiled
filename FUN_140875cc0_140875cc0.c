...
void FUN_140875cc0(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...
LAB_140875de8:
    ...
    if ((param_5[1] <= (longlong)uVar9) && (uStack_68 != 0xf0)) {
      if (uStack_a8 == 6) {
        if ((int)uStack_c8 == 0) goto LAB_140875f1f;
      }
      else {
        if (uStack_a8 != 1) goto LAB_140875e32;
        if ((int)uStack_c8 == 0) {
          uVar12 = param_5[1] - 1;
        }
      }
...
LAB_140875ec0:
    do {
      ...
      lStack_98 = *param_5;
      lStack_90 = param_5[1];
      FUN_140876ce0(lStack_58,lStack_50,uVar12,param_3,in_stack_fffffffffffffec8,(int)lStack_60,
        ...
        while( true ) {
          ...
          if (uStack_40 <= uVar9) {
            ...
            if (uStack_b8 != 0) {
              ...
              do {
                lStack_f8 = *param_5;
                psStack_f0 = (short *)param_5[1];
                FUN_140876ce0(lStack_58,lStack_50,lVar4,puVar3,&lStack_f8,(int)lStack_60,uVar16,
...
LAB_140876358:
          ...
          (*(code *)(&PTR_FUN_14308cac0)[lStack_60])
                    (lStack_50 * uVar9 + lStack_58,param_3,*param_5,uStack_70,
                     in_stack_fffffffffffffec8);
          lVar10 = lStack_f8;
          param_8 = psStack_f0;
        }
        if (-1 < (longlong)uVar9) goto LAB_140875de8;
        uVar12 = uVar9;
        if (uStack_68 == 0xf0) goto LAB_140875ec0;
        if (uStack_a8 != 6) break;
        if (uStack_b8 != 0) goto LAB_140875ec0;
LAB_140875f1f:
        auVar22._0_4_ = (float)(int)param_8[2];
        auVar22._4_8_ = SUB128(ZEXT812(0),4);
        auVar22._12_4_ = 0;
        auVar18._0_4_ = (float)(int)*param_8;
        auVar18._4_8_ = SUB128(ZEXT812(0),4);
        auVar18._12_4_ = 0;
        auVar19._0_4_ = (float)(int)param_8[1];
...
LAB_1408763d7:
  if (uVar14 == 6) {
    uVar9 = 0;
    auVar25._0_4_ = (float)(int)*param_8;
    auVar25._4_8_ = SUB128(ZEXT812(0),4);
    auVar25._12_4_ = 0;
    auVar24._0_4_ = (float)(int)param_8[1];
    auVar24._4_8_ = SUB128(ZEXT812(0),4);
    auVar24._12_4_ = 0;
    auVar23._0_4_ = (float)(int)param_8[2];
...
LAB_14087683e:
            ...
            if (uVar13 != 0) {
              if (((ulonglong)puVar3 & 3) != 0) goto LAB_14087683e;
              uVar13 = 0x20 - uVar13 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar13 + 8)) goto LAB_14087683e;
            uVar6 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      lStack_f8 = *param_5;
      psStack_f0 = (short *)param_5[1];
      FUN_140876ce0(lStack_58,lStack_50,lVar10,puStack_b0,&lStack_f8,(int)lStack_60,param_7,param_8,
...
LAB_140876645:
            ...
            uVar13 = (ulonglong)puVar3 & 0x1f;
            if (uVar13 != 0) {
              if (((ulonglong)puVar3 & 3) != 0) goto LAB_140876645;
              uVar13 = 0x20 - uVar13 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar13 + 8)) goto LAB_140876645;
...
LAB_140875e32:
  ...
  if (uStack_a8 == 3) {
    ...
    if (lVar4 < 2) {
      ...
      if ((longlong)uVar9 < 0) goto LAB_140876300;
