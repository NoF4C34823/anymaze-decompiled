...
uint FUN_140a9a9c0(byte *param_1,ulonglong param_2,uint param_3,undefined8 param_4,uint param_5,
...
LAB_140a9d40b:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9d40b;
            uVar10 = 0;
...
LAB_140a9cfa1:
    ...
    if (lVar23 < 1) {
      uVar7 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a9d275;
LAB_140a9d18f:
      if ((int)uVar7 < 1) {
        return param_5;
      }
...
LAB_140a9d41a:
        ...
        if ((longlong)uVar11 < (longlong)(uVar13 + 0x10)) goto LAB_140a9d41a;
...
LAB_140a9d412:
          ...
          iVar8 = (int)uVar18;
          if (param_3 < iVar8 + 0x10U) goto LAB_140a9d412;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) {
        uVar7 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a9d18f;
LAB_140a9d275:
        if ((int)uVar7 < 1) {
          return param_5;
        }
        ...
        *(byte *)(lVar20 + 3 + param_2) = param_1[lVar23 + -1];
        lVar20 = (longlong)(int)uVar15;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar7 < 1) goto LAB_140a9d3ea;
          goto LAB_140a9d198;
        }
        if ((int)uVar7 < 1) goto LAB_140a9d3ea;
      }
...
LAB_140a9d421:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9d421;
            uVar16 = 0;
...
LAB_140a9cd46:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9cd46;
            uVar10 = 0;
            uVar13 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar18 & 0xf));
            if (uVar18 != 0) {
              do {
...
LAB_140a9cd4d:
          ...
          iVar8 = (int)uVar18;
          if (param_3 < iVar8 + 0x10U) goto LAB_140a9cd4d;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
              *(byte *)(uVar13 + uVar11) = param_1[uVar13];
    ...
    iVar8 = (int)lVar20;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar7 < 1) goto LAB_140a9cd1e;
      if (6 < (int)uVar7) {
        uVar11 = param_2 + lVar20;
        uVar18 = 4 - (longlong)(int)param_5;
...
LAB_140a9cd5b:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9cd5b;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a9cd54:
      ...
      if ((longlong)uVar11 < (longlong)(uVar13 + 0x10)) goto LAB_140a9cd54;
...
LAB_140a9c6d8:
                ...
                if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9c6d8;
        ...
        if ((int)(param_5 - 1) < 0) goto LAB_140a9c0c4;
        if (6 < (int)param_5) {
...
LAB_140a9c6df:
              ...
              if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9c6df;
              uVar10 = 0;
              uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
              if (uVar18 != 0) {
                do {
        ...
        if (iVar8 - 1U < param_5) goto LAB_140a9c0ac;
      }
    }
    else {
      if (uVar15 < 7) {
LAB_140a9ba17:
        ...
        if (((longlong)(uVar18 - (longlong)param_1) < (longlong)uVar11) &&
           ((longlong)-(uVar18 - (longlong)param_1) < (longlong)uVar11)) goto LAB_140a9ba17;
        if (uVar15 < 0x10) {
LAB_140a9c6c1:
          uVar13 = 0;
        }
          ...
          iVar8 = (int)uVar11;
          if (uVar15 < iVar8 + 0x10U) goto LAB_140a9c6c1;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) goto LAB_140a9bd98;
      if ((param_6 & 0x40) == 0) {
        if ((int)(param_5 - 1) < 0) goto LAB_140a9c0c4;
        if (6 < (int)param_5) {
          lVar24 = (longlong)(int)param_5;
...
LAB_140a9c6c8:
              ...
              if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9c6c8;
              uVar10 = 0;
              uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
              if (uVar18 != 0) {
                do {
...
LAB_140a9c6d0:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9c6d0;
            uVar10 = 0;
            uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
            if (uVar18 != 0) {
              do {
      ...
      if (param_5 <= iVar8 - 1U) goto LAB_140a9c0c4;
LAB_140a9c0ac:
...
LAB_140a9c0c4:
    ...
    if (lVar23 < 5) {
      ...
      uVar15 = iVar9 + 4;
      if ((param_6 & 0x80) != 0) {
        if ((int)uVar15 < 1) goto LAB_140a9c6a0;
        if (6 < (int)uVar15) {
          uVar11 = param_2 + lVar20;
          pbVar2 = param_1 + lVar23;
          uVar18 = 4 - (longlong)(int)param_5;
...
LAB_140a9c6fc:
              ...
              if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9c6fc;
              uVar16 = 0;
              uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
              if (uVar13 != 0) {
                do {
...
LAB_140a9c6f5:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9c6f5;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a9c6ee:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9c6ee;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a9c6e7:
          ...
          if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9c6e7;
          uVar16 = 0;
          uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
          if (uVar13 != 0) {
            do {
            ...
            do {
              while( true ) {
                *(byte *)(lVar24 + param_2) = param_1[lVar24 - lVar20];
                ...
                do {
                  if (lVar24 < 0) goto LAB_140a9b27a;
LAB_140a9b909:
                  uVar18 = uVar11;
            ...
            bVar26 = -1 < lVar24;
            if ((((bVar26) && (bVar26)) && (bVar26)) && (bVar26)) goto LAB_140a9b909;
          }
        }
        goto LAB_140a9b27a;
      }
            ...
            do {
              while( true ) {
                *(undefined1 *)(lVar24 + param_2) = *(undefined1 *)(param_2 + lVar25);
                ...
                if ((longlong)(uVar18 + 1) < lVar23) break;
                do {
                  if (lVar24 < 0) goto LAB_140a9b386;
LAB_140a9b8c9:
                  lVar25 = (longlong)(int)((int)lVar24 + uVar7) + 1;
                  uVar18 = uVar11;
                } while (lVar23 <= (longlong)uVar11);
          ...
          else if (-1 < lVar24) goto LAB_140a9b8c9;
        }
LAB_140a9b386:
        if (4 < lVar23) goto LAB_140a9b489;
        goto LAB_140a9b390;
      }
      if (-1 < (int)(param_5 - 1)) {
        iVar8 = 1;
      ...
      if (lVar23 < 5) goto LAB_140a9b6d1;
    }
    else {
      uVar14 = (uint)uVar18;
      if (uVar14 < 7) {
LAB_140a9af96:
        ...
        if (((longlong)(uVar13 - (longlong)param_1) < (longlong)uVar18) &&
           ((longlong)-(uVar13 - (longlong)param_1) < (longlong)uVar18)) goto LAB_140a9af96;
        if (uVar14 < 0x10) {
LAB_140a9b8a7:
          uVar10 = 0;
        }
          ...
          iVar8 = (int)uVar18;
          if (uVar14 < iVar8 + 0x10U) goto LAB_140a9b8a7;
          uVar10 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) goto LAB_140a9b316;
      if ((param_6 & 0x40) == 0) {
        if (-1 < (int)(param_5 - 1)) {
          iVar8 = 1;
          lVar24 = 0;
...
LAB_140a9b8ae:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9b8ae;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              uVar16 = 0;
              do {
...
LAB_140a9b6d1:
        uVar7 = -param_5 + 4;
        if ((int)uVar7 < 1) goto LAB_140a9b840;
        iVar8 = (int)lVar12;
        if (6 < (int)uVar7) {
...
LAB_140a9b8f3:
              ...
              if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9b8f3;
              uVar16 = 0;
              uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
              if (uVar13 != 0) {
                do {
...
LAB_140a9b8ec:
          ...
          if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9b8ec;
          uVar16 = 0;
          uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
          if (uVar13 != 0) {
            do {
...
LAB_140a9aea5:
          ...
          if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9aea5;
          uVar10 = 0;
          uVar13 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar18 & 0xf));
          if (uVar18 != 0) {
            do {
...
LAB_140a9ac54:
      ...
      uVar18 = param_2 + lVar20;
      if (((longlong)(uVar18 - (longlong)param_1) < (longlong)uVar11) &&
         ((longlong)-(uVar18 - (longlong)param_1) < (longlong)uVar11)) goto LAB_140a9ac54;
      if (uVar7 < 0x10) {
LAB_140a9aeac:
        uVar13 = 0;
      }
        ...
        iVar8 = (int)uVar11;
        if (uVar7 < iVar8 + 0x10U) goto LAB_140a9aeac;
        uVar13 = 0;
        if (iVar8 != 0) {
          do {
            *(byte *)(uVar13 + uVar18) = param_1[uVar13];
    ...
    uVar15 = uVar14;
    lVar20 = (longlong)(int)uVar15;
    if (lVar23 < 5) goto LAB_140a9ad05;
    uVar15 = uVar15 + 4;
    *(byte *)(lVar20 + param_2) = param_1[lVar23 + -4];
    *(byte *)(lVar20 + 1 + param_2) = param_1[lVar23 + -3];
    *(byte *)(lVar20 + 2 + param_2) = param_1[lVar23 + -2];
    *(byte *)(lVar20 + 3 + param_2) = param_1[lVar23 + -1];
    uVar7 = 4 - param_5;
    lVar20 = (longlong)(int)uVar15;
    if ((int)uVar7 < 1) goto LAB_140a9ae67;
  }
  iVar8 = (int)lVar20;
  if ((int)uVar7 < 7) {
LAB_140a9adf5:
    ...
    if (((longlong)(uVar11 - (longlong)pbVar2) < (longlong)uVar18) &&
       ((longlong)-(uVar11 - (longlong)pbVar2) < (longlong)uVar18)) goto LAB_140a9adf5;
    if ((longlong)uVar18 < 0x10) {
LAB_140a9aeb3:
      uVar10 = 0;
    }
      ...
      if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9aeb3;
      uVar16 = 0;
      uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
      if (uVar13 != 0) {
        do {
