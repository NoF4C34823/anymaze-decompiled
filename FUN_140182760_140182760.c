...
/* WARNING: Removing unreachable block (ram,0x0001401834e0) */

void FUN_140182760(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (**(code **)(&UNK_143087d20 + lStack_e8 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar24 != 6) {
            if (uVar24 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar21 < 0) goto LAB_1401838c0;
                while (uVar9 == 0) {
                  for (lVar11 = (lVar16 + -1) * 2 - lVar11; lVar11 < 0; lVar11 = -lVar11) {
LAB_1401838c0:
                    if (uVar18 != 0) goto LAB_14018378e;
                  }
...
LAB_14018378e:
    ...
    iStack_158 = param_10;
    (**(code **)(&UNK_143087d20 + lStack_e8 * 8))(param_11 + lVar29 * 6,param_4,lVar16,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar21 = uVar19 * 3;
...
LAB_140183860:
              ...
              if (uVar13 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_140183860;
                uVar13 = 0x10 - uVar13 >> 1;
              }
              if ((longlong)uVar15 < (longlong)(uVar13 + 8)) goto LAB_140183860;
              uVar20 = 0;
...
LAB_14018305d:
      lStack_130 = lVar11;
      puStack_140 = puVar8;
      pcStack_138 = *(code **)(&UNK_143087d20 + lStack_e8 * 8);
      iStack_158 = param_10;
      uStack_110 = param_7;
      lStack_108 = param_4;
