...
void FUN_1409f8d17(longlong param_1,ulonglong param_2,longlong param_3,ulonglong param_4)

{
  ...
  do {
    auVar27 = vmulps_avx512f(in_ZMM0,*(undefined1 (*) [64])(in_R11 + in_R10 * 4));
    auVar28 = vaddps_avx512f(*(undefined1 (*) [64])(in_RAX + in_R10 * 4),
                             *(undefined1 (*) [64])(param_1 + in_R10 * 4));
    auVar27 = vfmadd231ps_avx512f(auVar27,auVar28,in_ZMM1);
    *(undefined1 (*) [64])(param_3 + in_R10 * 4) = auVar27;
    in_R10 = in_R10 + 0x10;
  } while (in_R10 < unaff_R12);
    ...
    if ((longlong)param_2 < 0x20) {
      ...
      if ((longlong)param_2 < 0x121) {
        ...
        if (uVar20 != 0) {
          ...
          do {
            ...
            auVar26 = vpackssdw_avx512vl(auVar31._0_32_,auVar26);
      ...
      if ((longlong)(uVar20 + 0x20) <= (longlong)uVar21) {
        do {
          ...
          auVar27 = vpackssdw_avx512bw(auVar29,auVar27);
...
LAB_1409f9190:
    ...
    uVar21 = param_4 & 0x3f;
    if (uVar21 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1409f9190;
