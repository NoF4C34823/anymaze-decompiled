...
void FUN_14076e660(longlong param_1,longlong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    ...
    if (uVar32 != 0) {
      if ((param_1 + 8U & 3) != 0) goto LAB_14076e9cb;
    ...
    if ((longlong)(uVar32 + 8) <= (longlong)param_3) {
      ...
      if ((longlong)param_3 < 2) {
        FUN_14076e95d(fVar10,uVar31,param_3,fVar9,CONCAT44(unaff_XMM8_Dd,unaff_XMM8_Dc),
