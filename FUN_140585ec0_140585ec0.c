...
void FUN_140585ec0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
                  ulonglong param_4)

{
  ...
  if (param_4 < 0x1e) {
    ...
    if (0x1e < param_4) {
      auVar3 = vpmaxub_avx2(auVar5,auVar6);
      auVar5 = vpmaxub_avx512vl(auVar3,auVar4);
      auVar3 = vpmaxub_avx2(ZEXT132((byte)param_1[1][0]),ZEXT132((byte)param_1[1][param_2]));
      auVar3 = vpmaxub_avx512vl(auVar3,ZEXT132((byte)param_1[1][param_2 * 2]));
      goto LAB_140586008;
    }
  }
  auVar5 = vpmaxub_avx2(auVar5,auVar6);
  auVar5 = vpmaxub_avx512vl(auVar5,auVar4);
LAB_140586008:
  auVar6 = vshufi32x4_avx512vl(auVar5,auVar3,1);
  auVar3 = vpalignr_avx2(auVar6,auVar5,1);
  auVar6 = vpalignr_avx2(auVar6,auVar5,2);
  auVar3 = vpmaxub_avx2(auVar5,auVar3);
  auVar3 = vpmaxub_avx2(auVar3,auVar6);
