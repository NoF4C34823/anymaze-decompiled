...
void FUN_140089040(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140089cf6:
      ...
      uVar24 = param_2 & 0xf;
      if (uVar24 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140089cf6;
        uVar24 = 0x10 - uVar24 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar24 + 8)) goto LAB_140089cf6;
      uVar28 = 0;
...
LAB_140089cc0:
          uVar26 = 0;
          if (param_3 == 0) goto LAB_140089aad;
          uVar28 = 0;
          uVar24 = param_3;
        }
        else {
          uVar24 = param_2 & 0xf;
          if (uVar24 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140089cc0;
            uVar24 = 0x10 - uVar24 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar24 + 0x10)) goto LAB_140089cc0;
          ...
          if (param_3 < uVar26 + 1) goto LAB_140089aad;
...
LAB_140089aad:
  ...
  if (0xf < (longlong)param_3) {
    uVar24 = param_2 & 0xf;
    if (uVar24 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140089cb5;
      uVar24 = 0x10 - uVar24 >> 2;
    }
    if ((longlong)(uVar24 + 0x10) <= (longlong)param_3) {
      ...
      goto joined_r0x000140089c78;
    }
  }
LAB_140089cb5:
  uVar26 = 0;
joined_r0x000140089c78:
