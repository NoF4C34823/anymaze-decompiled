...
void FUN_14062b380(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014062c439. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b500 + lVar5 * 8))(psVar20,param_4,*param_5);
    return;
  }
  if (uVar12 == 6) {
    sVar24 = *param_8;
          ...
          if (uVar12 != 6) {
            if (uVar12 == 1) {
              ...
              if (lVar14 < 2) {
                ...
                if (lVar26 < 0) goto LAB_14062c3c0;
                while (uVar22 == 0) {
                  for (lVar8 = (lVar14 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_14062c3c0:
                    if (uVar7 != 0) goto LAB_14062c2c5;
                  }
...
LAB_14062c2c5:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar25;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014062c326. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b500 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,lVar14,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar11 == 1) {
...
LAB_14062c33a:
              ...
              uVar16 = uVar6 & 0xf;
              if (uVar16 != 0) {
                if ((uVar6 & 1) != 0) goto LAB_14062c33a;
                uVar16 = 0x10 - uVar16 >> 1;
              }
              if ((longlong)uVar17 < (longlong)(uVar16 + 8)) goto LAB_14062c33a;
...
LAB_14062b83b:
      if (uVar12 == 1) {
        if ((longlong)uVar11 < 1) goto LAB_14062ba4e;
...
LAB_14062c39e:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14062c39e;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar16 + 8)) goto LAB_14062c39e;
          uVar10 = 0;
...
LAB_14062c341:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14062c341;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar16 + 8)) goto LAB_14062c341;
          uVar10 = 0;
          uVar23 = uVar11 - (uVar11 - uVar16 & 7);
          if (uVar16 != 0) {
            do {
...
LAB_14062ba4e:
      in_XMM0._0_8_ =
           (**(code **)(&DAT_14308b500 + lVar5 * 8))(uVar6,param_4,uVar11,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014062c39b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b500 + lVar5 * 8))(psVar20,param_4,lVar14);
    return;
  }
  if ((longlong)uVar11 < lVar14) {
    lVar14 = lVar14 - uVar11;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_14308b500 + lVar5 * 8))(psVar20,param_4,lVar14,param_9,param_10);
...
LAB_14062c349:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14062c349;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar17 < (longlong)(uVar6 + 8)) goto LAB_14062c349;
...
LAB_14062bedc:
  if (uVar12 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_14062c178;
...
LAB_14062c357:
          ...
          uVar6 = uVar17 & 0xf;
          if (uVar6 != 0) {
            if ((uVar17 & 1) != 0) goto LAB_14062c357;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_14062c357;
          uVar16 = 0;
  ...
  if ((uVar12 != 6) || ((longlong)uVar11 < 1)) goto LAB_14062c178;
  if ((longlong)uVar11 < 8) {
LAB_14062c350:
    uVar6 = 0;
  }
    ...
    if (uVar17 != 0) {
      if ((lVar14 - 2U & 1) != 0) goto LAB_14062c350;
      uVar17 = 0x10 - uVar17 >> 1;
    }
    if ((longlong)uVar11 < (longlong)(uVar17 + 8)) goto LAB_14062c350;
    uVar16 = 0;
...
LAB_14062c178:
                    /* WARNING: Could not recover jumptable at 0x00014062c1b5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_14308b500 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,uVar11);
  return;
}
