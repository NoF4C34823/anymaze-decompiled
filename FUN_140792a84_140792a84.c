...
void FUN_140792a84(longlong param_1,float param_2,ulonglong param_3,float param_4)
  ...
  if (uVar6 < param_3) {
    ...
    do {
      *(float *)(unaff_RDI + in_RDX * 4 + uVar6 * 4) =
           ...
           (*(float *)(param_1 + -4 + uVar6 * 4) + *(float *)(param_1 + 4 + uVar6 * 4)) * param_4 +
           *(float *)(param_1 + uVar6 * 4) * in_XMM0_Da;
      uVar6 = uVar6 + 1;
    } while (uVar6 < param_3);
  }
  return;
