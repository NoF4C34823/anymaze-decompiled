...
void thunk_FUN_140d3c3c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < param_6) {
    lVar12 = 0;
    lVar2 = param_7 * 2 + 2;
    auVar18 = vmovdqu32_avx512f(_DAT_143092780);
    lVar8 = 0;
    do {
            ...
            do {
              ...
              if (uVar17 != 0) {
                ...
                do {
                  ...
                  lVar15 = lVar15 + 1;
                  auVar19 = vpminuw_avx512bw(auVar19,*(undefined1 (*) [64])(lVar1 + uVar13 * 2));
                  auVar20 = vpminuw_avx512bw(auVar20,*(undefined1 (*) [64])
                                                      (lVar1 + 0x40 + uVar13 * 2));
                  auVar21 = vpminuw_avx512bw(auVar21,*(undefined1 (*) [64])
                                                      (lVar1 + 0x80 + uVar13 * 2));
                  auVar22 = vpminuw_avx512bw(auVar22,*(undefined1 (*) [64])
                                                      (lVar1 + 0xc0 + uVar13 * 2));
      ...
      for (; lVar4 < (longlong)(param_5 & 0xffffffffffffffc0); lVar4 = lVar4 + 0x40) {
        lVar14 = 0;
        lVar5 = 0;
        lVar9 = 0;
        lVar10 = 0;
      ...
      for (; lVar4 < (longlong)(param_5 & 0xffffffffffffffe0); lVar4 = lVar4 + 0x20) {
        lVar14 = 0;
        lVar5 = 0;
        lVar9 = 0;
        lVar10 = 0;
          ...
          do {
            ...
            if (uVar17 != 0) {
              do {
                ...
                auVar22 = vpminuw_avx512bw(auVar22,auVar20);
