...
void FUN_1403442e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar20 != 0 && 0 < (longlong)uVar39) {
      do {
        FUN_140334640(lVar25,lVar17,(longlong)(int)param_5,uVar23,1);
        lVar35 = lVar35 + 1;
                ...
                if (0 < (longlong)uVar23) {
                  if ((longlong)uVar23 < 8) {
                    ...
                    do {
                      ...
                      sVar3 = auVar47._0_2_;
                      auVar51._0_2_ =
                           (ushort)(sVar3 < sVar32) * sVar3 | (ushort)(sVar3 >= sVar32) * sVar32;
                      sVar32 = auVar47._2_2_;
                      auVar51._2_2_ =
                           (ushort)(sVar32 < sVar44) * sVar32 | (ushort)(sVar32 >= sVar44) * sVar44;
                      sVar32 = auVar47._4_2_;
                      auVar51._4_2_ =
                           (ushort)(sVar32 < sVar22) * sVar32 | (ushort)(sVar32 >= sVar22) * sVar22;
                      sVar32 = auVar47._6_2_;
                      auVar51._6_2_ =
                           (ushort)(sVar32 < sVar16) * sVar32 | (ushort)(sVar32 >= sVar16) * sVar16;
                      sVar32 = auVar47._8_2_;
                      auVar51._8_2_ =
                           (ushort)(sVar32 < sVar30) * sVar32 | (ushort)(sVar32 >= sVar30) * sVar30;
                      sVar32 = auVar47._10_2_;
                      auVar51._10_2_ =
                           (ushort)(sVar32 < sVar38) * sVar32 | (ushort)(sVar32 >= sVar38) * sVar38;
                      sVar32 = auVar47._12_2_;
                      auVar51._12_2_ =
                           (ushort)(sVar32 < sVar28) * sVar32 | (ushort)(sVar32 >= sVar28) * sVar28;
                      sVar32 = auVar47._14_2_;
                      auVar51._14_2_ =
                           (ushort)(sVar32 < sVar27) * sVar32 | (ushort)(sVar32 >= sVar27) * sVar27;
                      auVar47 = auVar51 & auVar41 | ~auVar41 & auVar47;
                    } while (uVar19 < uVar29);
                    sVar32 = auVar47._8_2_;
                    sVar44 = auVar47._0_2_;
                    uVar43 = (ushort)(sVar32 < sVar44) * sVar32 |
                             (ushort)(sVar32 >= sVar44) * sVar44;
                    sVar32 = auVar47._10_2_;
                    sVar44 = auVar47._2_2_;
                    uVar48 = (ushort)(sVar32 < sVar44) * sVar32 |
                             (ushort)(sVar32 >= sVar44) * sVar44;
                    sVar32 = auVar47._12_2_;
                    sVar44 = auVar47._4_2_;
                    uVar49 = (ushort)(sVar32 < sVar44) * sVar32 |
                             (ushort)(sVar32 >= sVar44) * sVar44;
                    sVar32 = auVar47._14_2_;
                    sVar44 = auVar47._6_2_;
                    uVar50 = (ushort)(sVar32 < sVar44) * sVar32 |
                             (ushort)(sVar32 >= sVar44) * sVar44;
