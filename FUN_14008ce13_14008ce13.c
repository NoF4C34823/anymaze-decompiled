...
void FUN_14008ce13(longlong param_1,ulonglong param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  do {
    *(float *)(in_R10 + param_2 * 4) =
         (float)((uint)*(ushort *)(param_1 + -0xc + param_2 * 2) +
                (uint)*(ushort *)(param_1 + 0xc + param_2 * 2)) * in_XMM2_Da +
         (float)((uint)*(ushort *)(param_1 + -6 + param_2 * 2) +
                (uint)*(ushort *)(param_1 + 6 + param_2 * 2)) * in_XMM4_Da +
         (float)*(ushort *)(param_1 + param_2 * 2) * in_XMM0_Da;
    param_2 = param_2 + 1;
  } while (param_2 < in_RAX);
  do {
    auVar3 = pmovzxwd(unaff_XMM7,*(undefined8 *)(param_1 + -0xc + in_RAX * 2));
    auVar2 = pmovzxwd(unaff_XMM6,*(undefined8 *)(param_1 + 0xc + in_RAX * 2));
    ...
    auVar2 = pmovzxwd(auVar2,*(undefined8 *)(param_1 + 6 + in_RAX * 2));
    auVar3 = pmovzxwd(auVar4,*(undefined8 *)(param_1 + -6 + in_RAX * 2));
