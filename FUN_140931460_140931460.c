...
/* WARNING: Removing unreachable block (ram,0x000140932755) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_140931460(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_208 = param_10;
    (*(code *)(&PTR_FUN_14308d780)[lVar20])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar11 != 6) {
            if (uVar11 == 1) {
              ...
              if (lVar22 < 2) {
                ...
                if (lVar17 < 0) goto LAB_140932d20;
                while (uVar3 == 0) {
                  for (lVar12 = (lVar22 + -1) * 2 - lVar12; lVar12 < 0; lVar12 = -lVar12) {
LAB_140932d20:
                    if (uVar16 != 0) goto LAB_140932b6c;
                  }
...
LAB_140932b6c:
    ...
    iStack_208 = param_10;
    (*(code *)(&PTR_FUN_14308d780)[lVar20])(*param_11 + lVar13 * 0xc,param_4,lVar22,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
...
LAB_140932c57:
              ...
              if ((longlong)uVar9 < 0xbd) {
                ...
                if (uVar5 != 0) {
                  if (((ulonglong)puStack_b8 & 3) != 0) goto LAB_140932c57;
                  uVar5 = 0x20 - uVar5 >> 2;
                }
                if ((longlong)uVar9 < (longlong)(uVar5 + 8)) goto LAB_140932c57;
                uVar14 = 0;
        ...
        if (6 < (longlong)uVar9) {
          ...
          if ((((longlong)(uVar9 * 0xc) <= lVar17) || (7 < -lVar17)) &&
            ...
            if ((longlong)uVar9 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_14308d640,auVar24);
              auVar24 = vpermd_avx2(_DAT_14308d660,auVar33);
              auVar29 = vpermd_avx2(_DAT_14308d680,auVar29);
...
LAB_140932163:
      uStack_c8 = pauVar1;
      uStack_d0 = (code *)(&PTR_FUN_14308d780)[lVar20];
      iStack_208 = param_10;
      uStack_a8 = param_7;
      lStack_a0 = param_4;
        ...
        if (0 < lVar22) {
          ...
          if ((longlong)uVar4 < 7) {
            ...
            if ((longlong)uVar4 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_14308d640,auVar27);
              uVar9 = uVar4 & 0xfffffffffffffff0;
              uVar5 = 0;
              auVar24 = vpermd_avx2(_DAT_14308d660,auVar35);
              auVar29 = vpermd_avx2(_DAT_14308d680,auVar31);
              auVar25 = vpblendd_avx2(auVar27,auVar24,0x92);
              auVar24 = vpblendd_avx2(auVar24,auVar29,0x92);
              auVar27 = vpblendd_avx2(auVar29,auVar27,0x92);
              auVar29 = vpblendd_avx2(auVar25,auVar27,0x24);
        ...
        if (6 < (longlong)uVar4) {
          ...
          if ((((longlong)(uVar4 * 0xc) <= lVar20) || (7 < -lVar20)) &&
            ...
            if ((longlong)uVar4 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_14308d640,auVar26);
              uVar9 = uVar4 & 0xfffffffffffffff0;
              uVar5 = 0;
              auVar24 = vpermd_avx2(_DAT_14308d660,auVar34);
              auVar29 = vpermd_avx2(_DAT_14308d680,auVar30);
              auVar25 = vpblendd_avx2(auVar27,auVar24,0x92);
              auVar24 = vpblendd_avx2(auVar24,auVar29,0x92);
              auVar27 = vpblendd_avx2(auVar29,auVar27,0x92);
              auVar29 = vpblendd_avx2(auVar25,auVar27,0x24);
