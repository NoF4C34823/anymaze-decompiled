...
void FUN_1403b98bf(undefined8 param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < in_stack_000000f0._4_4_) {
    ...
    do {
      FUN_1403bffa0(unaff_RSI,unaff_RBX);
      thunk_FUN_142d25930(in_stack_00000110,lStack0000000000000098,lVar2);
