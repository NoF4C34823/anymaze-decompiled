...
void FUN_140226e40(longlong param_1,longlong param_2,float *param_3,longlong param_4,
...

{
  ...
  if (iVar22 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      uStack_b0 = param_9;
      pcStack_c8 = *(code **)(&DAT_143088540 + (longlong)(int)lStack_1f0 * 8);
      pbStack_98 = param_8;
            ...
            if (lStack_b8 < (longlong)(uVar29 + lVar11)) {
              ...
              do {
                ...
                if (lVar15 < 0) {
                  if (uStack_100 != 0xf0) {
                    if (uVar19 == 6) {
                      if (uStack_d0 == 0) goto LAB_140228e95;
                    }
                    else {
                      if (uVar19 != 1) goto LAB_140228e0c;
LAB_140228fbe:
                      lVar17 = 0;
                      if (uStack_d0 != 0) {
                        lVar17 = lVar15;
...
LAB_140228e7c:
                  ...
                  if ((lVar15 < lVar11) || (uStack_100 == 0xf0)) goto LAB_140228e7c;
                  if (uVar19 != 6) {
                    if (uVar19 == 1) {
                      if (lVar15 < 0) goto LAB_140228fbe;
                      if (uStack_a8 == 0) {
                        lVar17 = lStack_e0;
                      }
                    }
...
LAB_140228e0c:
                      if (uVar19 == 3) {
                        if (lVar11 < 2) {
                          ...
                          if (lVar15 < 0) goto LAB_140228fe0;
                          if (lVar11 <= lVar15) {
                            while (uStack_a8 == 0) {
                              for (lVar17 = lStack_e0 * 2 - lVar17; lVar17 < 0; lVar17 = -lVar17) {
LAB_140228fe0:
                                if (uStack_d0 != 0) goto LAB_140228e7c;
                              }
                  ...
                  if (uStack_a8 != 0) goto LAB_140228e7c;
LAB_140228e95:
                  bVar12 = *pbVar26;
                  bVar18 = pbVar26[1];
                  bVar23 = pbVar26[2];
...
LAB_140228f44:
                      ...
                      if ((longlong)uStack_d8 < 0xa91) {
                        ...
                        if ((longlong)uStack_d8 < (longlong)(uVar24 + 0x20)) goto LAB_140228f44;
              ...
              if (uVar19 == 1) {
                if (0 < lStack_108) {
                  if ((longlong)uStack_168 < 7) {
                    ...
                    if ((longlong)uStack_168 < 0x20) {
                      ...
                      auVar49[0x1f] = bVar12;
                      lVar20 = 0;
                      auVar7 = vpshufb_avx2(auVar44,_DAT_143088620);
                      auVar44 = vpshufb_avx2(auVar44,_DAT_1430886e0);
                      auVar40 = vpshufb_avx2(auVar36,_DAT_143088640);
                      auVar36 = vpshufb_avx2(auVar36,_DAT_143088700);
                      auVar44 = vpor_avx2(auVar44,auVar36);
                      auVar35 = vpshufb_avx2(auVar49,_DAT_143088660);
                      auVar36 = vpshufb_avx2(auVar49,_DAT_143088720);
                      auVar36 = vpor_avx2(auVar44,auVar36);
                      auVar44 = vpblendvb_avx2(auVar7,auVar40,_DAT_143088680);
                      auVar7 = vpblendvb_avx2(auVar40,auVar7,_DAT_143088680);
                      auVar44 = vpblendvb_avx2(auVar44,auVar35,_DAT_1430886a0);
                      auVar7 = vpblendvb_avx2(auVar7,auVar35,_DAT_1430886c0);
                ...
                if (((longlong)uStack_168 < 7) ||
                  ...
                  if ((longlong)uStack_168 < 0x20) {
                    ...
                    auVar38[0x1f] = bVar23;
                    lVar20 = 0;
                    auVar44 = vpshufb_avx2(auVar35,_DAT_1430886e0);
                    auVar7 = vpshufb_avx2(auVar48,_DAT_143088700);
                    auVar40 = vpshufb_avx2(auVar35,_DAT_143088620);
                    auVar35 = vpshufb_avx2(auVar38,_DAT_143088660);
                    auVar49 = vpshufb_avx2(auVar48,_DAT_143088640);
                    auVar36 = vpshufb_avx2(auVar38,_DAT_143088720);
                    auVar44 = vpor_avx2(auVar44,auVar7);
                    auVar36 = vpor_avx2(auVar44,auVar36);
                    auVar44 = vpblendvb_avx2(auVar40,auVar49,_DAT_143088680);
                    auVar7 = vpblendvb_avx2(auVar49,auVar40,_DAT_143088680);
                    auVar44 = vpblendvb_avx2(auVar44,auVar35,_DAT_1430886a0);
                    auVar7 = vpblendvb_avx2(auVar7,auVar35,_DAT_1430886c0);
...
LAB_1402272b1:
            ...
            if ((longlong)uVar29 < 0xbd) {
              ...
              if (uVar21 != 0) {
                if (((ulonglong)pfVar27 & 3) != 0) goto LAB_1402272b1;
                uVar21 = 0x20 - uVar21 >> 2;
              }
              if ((longlong)uVar29 < (longlong)(uVar21 + 8)) goto LAB_1402272b1;
              uVar28 = 0;
...
LAB_140227165:
            ...
            if ((longlong)uVar29 < 0xbd) {
              ...
              uVar21 = (ulonglong)pfVar27 & 0x1f;
              if (uVar21 != 0) {
                if (((ulonglong)pfVar27 & 3) != 0) goto LAB_140227165;
                uVar21 = 0x20 - uVar21 >> 2;
              }
              if ((longlong)uVar29 < (longlong)(uVar21 + 8)) goto LAB_140227165;
              lVar11 = (longlong)param_3 + (lVar25 - lVar11);
              uVar28 = 0;
              uVar24 = uVar29 - (uVar29 - uVar21 & 7);
              if (uVar21 != 0) {
