...
void FUN_1408dace0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1408db69c:
      ...
      uVar32 = uVar33 & 0x1f;
      if (uVar32 != 0) {
        if ((uVar33 & 3) != 0) goto LAB_1408db69c;
        uVar32 = 0x20 - uVar32 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar32 + 0x10)) goto LAB_1408db69c;
  ...
  if (1 < param_7) {
    ...
    do {
      while( true ) {
        ...
        uVar19 = uVar19 + 1;
        pfVar26 = pfVar26 + 1;
        if (param_7 - 1U <= uVar19) goto LAB_1408db1b9;
      }
      uVar19 = uVar19 + 1;
      pfVar26 = pfVar26 + 1;
...
LAB_1408db635:
      ...
      if ((longlong)param_5 < 0x15d) {
        ...
        uVar33 = uVar28 & 0x1f;
        if (uVar33 != 0) {
          if ((uVar28 & 3) != 0) goto LAB_1408db635;
          uVar33 = 0x20 - uVar33 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar33 + 8)) goto LAB_1408db635;
        lVar22 = param_2 * lVar21 + param_1;
        lVar27 = param_2 * lVar20 + param_1;
        uVar25 = 0;
...
LAB_1408db667:
      ...
      if ((longlong)param_5 < 0x7b9) {
        ...
        uVar28 = param_4 & 0x1f;
        if (uVar28 != 0) {
          if ((param_4 & 1) != 0) goto LAB_1408db667;
          uVar28 = 0x20 - uVar28 >> 1;
        }
        if ((longlong)param_5 < (longlong)(uVar28 + 0x10)) goto LAB_1408db667;
        lVar20 = param_2 * uVar29 + param_1;
        uVar33 = 0;
  ...
  if (0xf < (longlong)param_5) {
    uVar28 = param_4 & 0x1f;
    if (uVar28 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1408db68d;
      uVar28 = 0x20 - uVar28 >> 1;
    }
