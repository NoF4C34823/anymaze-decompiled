...
void FUN_1409ccba0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0xf < (longlong)param_5) {
    uVar25 = param_4 & 0x3f;
    if (uVar25 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1409ccdeb;
    ...
    if (uVar25 != 0) {
      auVar31 = vmovdqu32_avx512f(_DAT_14308e300);
      auVar32 = vmovdqu32_avx512f(_DAT_14308e340);
