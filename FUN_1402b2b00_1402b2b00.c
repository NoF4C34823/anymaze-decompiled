...
void FUN_1402b2b00(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              if (7 < (longlong)uVar31) {
                ...
                uVar22 = uVar35 & 0xf;
                if (uVar22 != 0) {
                  if ((uVar35 & 1) != 0) goto LAB_1402b2d7a;
                ...
                if ((longlong)(uVar22 + 8) <= (longlong)uVar31) {
                  ...
                  do {
                    ...
                    sVar34 = psVar3[6];
                    sVar44 = psVar3[7];
                    uVar48 = (ushort)((short)uVar48 < sVar24) * sVar24 |
                             ((short)uVar48 >= sVar24) * uVar48;
                    uVar49 = (ushort)((short)uVar49 < sVar59) * sVar59 |
                             ((short)uVar49 >= sVar59) * uVar49;
                    uVar50 = (ushort)((short)uVar50 < sVar18) * sVar18 |
                             ((short)uVar50 >= sVar18) * uVar50;
                    uVar51 = (ushort)((short)uVar51 < sVar25) * sVar25 |
                             ((short)uVar51 >= sVar25) * uVar51;
                    uVar52 = (ushort)((short)uVar52 < sVar27) * sVar27 |
                             ((short)uVar52 >= sVar27) * uVar52;
                    uVar53 = (ushort)((short)uVar53 < sVar30) * sVar30 |
                             ((short)uVar53 >= sVar30) * uVar53;
                    uVar54 = (ushort)((short)uVar54 < sVar34) * sVar34 |
                             ((short)uVar54 >= sVar34) * uVar54;
                    uVar55 = (ushort)((short)uVar55 < sVar44) * sVar44 |
                             ((short)uVar55 >= sVar44) * uVar55;
                    uVar22 = uVar22 + 8;
                  } while (uVar22 < uVar19);
                  uVar52 = ((short)uVar48 < (short)uVar52) * uVar52 |
                           ((short)uVar48 >= (short)uVar52) * uVar48;
                  uVar53 = ((short)uVar49 < (short)uVar53) * uVar53 |
                           ((short)uVar49 >= (short)uVar53) * uVar49;
                  uVar49 = ((short)uVar50 < (short)uVar54) * uVar54 |
                           ((short)uVar50 >= (short)uVar54) * uVar50;
                  uVar50 = ((short)uVar51 < (short)uVar55) * uVar55 |
                           ((short)uVar51 >= (short)uVar55) * uVar51;
                  ...
                  uVar26 = (uint)(ushort)(((short)uVar49 < (short)uVar50) * uVar50 |
                                         ((short)uVar49 >= (short)uVar50) * uVar49);
                }
              }
LAB_1402b2d7a:
              if (uVar19 < uVar31) {
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              if (7 < (longlong)uVar31) {
                ...
                uVar23 = uVar22 & 0xf;
                if (uVar23 != 0) {
                  if ((uVar22 & 1) != 0) goto LAB_1402b2fda;
...
LAB_1402b2fda:
        ...
        FUN_1402bc1c0(param_9,uVar45,param_3,uVar32,lVar43);
        uVar42 = uVar42 + 1;
              ...
              if (0 < (longlong)uVar45) {
                if (7 < (longlong)uVar45) {
                  ...
                  do {
                    ...
                    sVar4 = auVar61._0_2_;
                    auVar62._0_2_ =
                         (ushort)(sVar24 < sVar4) * sVar4 | (ushort)(sVar24 >= sVar4) * sVar24;
                    sVar24 = auVar61._2_2_;
                    auVar62._2_2_ =
                         (ushort)(sVar59 < sVar24) * sVar24 | (ushort)(sVar59 >= sVar24) * sVar59;
                    sVar24 = auVar61._4_2_;
                    auVar62._4_2_ =
                         (ushort)(sVar18 < sVar24) * sVar24 | (ushort)(sVar18 >= sVar24) * sVar18;
                    sVar24 = auVar61._6_2_;
                    auVar62._6_2_ =
                         (ushort)(sVar25 < sVar24) * sVar24 | (ushort)(sVar25 >= sVar24) * sVar25;
                    sVar24 = auVar61._8_2_;
                    auVar62._8_2_ =
                         (ushort)(sVar27 < sVar24) * sVar24 | (ushort)(sVar27 >= sVar24) * sVar27;
                    sVar24 = auVar61._10_2_;
                    auVar62._10_2_ =
                         (ushort)(sVar30 < sVar24) * sVar24 | (ushort)(sVar30 >= sVar24) * sVar30;
                    sVar24 = auVar61._12_2_;
                    auVar62._12_2_ =
                         (ushort)(sVar34 < sVar24) * sVar24 | (ushort)(sVar34 >= sVar24) * sVar34;
                    sVar24 = auVar61._14_2_;
                    auVar62._14_2_ =
                         (ushort)(sVar44 < sVar24) * sVar24 | (ushort)(sVar44 >= sVar24) * sVar44;
                    auVar61 = auVar62 & auVar57 | ~auVar57 & auVar61;
                  } while (uVar19 < (uVar45 & 0xfffffffffffffff8));
                  sVar24 = auVar61._8_2_;
                  sVar59 = auVar61._0_2_;
                  uVar49 = (ushort)(sVar59 < sVar24) * sVar24 | (ushort)(sVar59 >= sVar24) * sVar59;
                  sVar24 = auVar61._10_2_;
                  sVar59 = auVar61._2_2_;
                  uVar50 = (ushort)(sVar59 < sVar24) * sVar24 | (ushort)(sVar59 >= sVar24) * sVar59;
                  sVar24 = auVar61._12_2_;
                  sVar59 = auVar61._4_2_;
                  uVar51 = (ushort)(sVar59 < sVar24) * sVar24 | (ushort)(sVar59 >= sVar24) * sVar59;
                  sVar24 = auVar61._14_2_;
                  sVar59 = auVar61._6_2_;
                  uVar52 = (ushort)(sVar59 < sVar24) * sVar24 | (ushort)(sVar59 >= sVar24) * sVar59;
                  uVar49 = ((short)uVar49 < (short)uVar51) * uVar51 |
                           ((short)uVar49 >= (short)uVar51) * uVar49;
