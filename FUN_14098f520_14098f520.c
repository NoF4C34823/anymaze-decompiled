...
void FUN_14098f520(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308de80)[lVar7])(pbVar9,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar16 == 6) {
    uVar22 = (uint)*param_8;
          ...
          if (uVar16 != 6) {
            if (uVar16 == 1) {
              ...
              if (lVar13 < 2) {
                ...
                if (lVar24 < 0) goto LAB_140990bc0;
                while (uVar11 == 0) {
                  for (lVar21 = (lVar13 + -1) * 2 - lVar21; lVar21 < 0; lVar21 = -lVar21) {
LAB_140990bc0:
                    if (uVar19 != 0) goto LAB_140990a63;
                  }
          ...
          if (uVar17 != 0) goto LAB_140990a63;
          bVar23 = (byte)uVar22;
        }
        else {
LAB_140990a63:
    ...
    (*(code *)(&PTR_LAB_14308de80)[lVar7])(param_11 + uVar25,param_4,lVar13,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar25 == 1) {
            ...
            if ((longlong)uVar15 < 0x40) {
              ...
              if ((longlong)uVar15 < 0x116) {
                ...
                if (uVar18 != 0) {
                  ...
                  if (uVar15 == uVar18) goto LAB_14098fa47;
                }
              }
            ...
            if ((longlong)uVar25 < 0x40) {
              ...
              if ((longlong)uVar25 < 0x96) {
                ...
                if (uVar10 != 0) {
                  ...
                  if (uVar25 == uVar10) goto LAB_14098feb6;
                }
              }
...
LAB_14098feb6:
      (*(code *)(&PTR_LAB_14308de80)[lVar7])(lStack_60,param_4,uVar25,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_LAB_14308de80)[lVar7])(pbVar9,param_4,lVar13,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar15 < 0x40) {
          ...
          if ((longlong)uVar15 < 0xeb) {
            ...
            if (uVar10 != 0) {
              ...
              if (uVar15 == uVar10) goto LAB_1409903a3;
            }
          }
          if ((longlong)(uVar10 + 0x40) <= (longlong)uVar12) {
            do {
...
LAB_1409903a3:
    ...
    if (0 < (longlong)uVar25) {
      if ((longlong)uVar25 < 7) {
        ...
        if ((longlong)uVar25 < 0x40) {
          ...
          if ((longlong)uVar25 < 0xd6) {
            ...
            if (uVar12 != 0) {
              ...
              if (uVar25 == uVar12) goto LAB_14099091a;
            }
          }
        ...
        if (uVar15 + 1 <= uVar25) {
          ...
          auVar33 = vmovdqu32_avx512f(_DAT_14308dc80);
          auVar34 = vmovdqu32_avx512f(_DAT_14308dcc0);
          do {
  ...
  if ((longlong)uVar25 < 1) goto LAB_14099091a;
...
LAB_140990b36:
    ...
    if ((longlong)uVar25 < 0x181) {
      ...
      if ((longlong)uVar25 < (longlong)(uVar15 + 0x10)) goto LAB_140990b36;
      uVar10 = 0;
      lVar8 = 0;
...
LAB_14099091a:
  (*(code *)(&PTR_LAB_14308de80)[lVar7])(param_11 + uVar25,param_4,uVar25,param_9,param_10);
  return;
}
