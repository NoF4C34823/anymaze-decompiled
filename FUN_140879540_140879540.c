...
void FUN_140879540(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar32) {
    uVar30 = param_2 & 0x1f;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140879734;
...
LAB_14087973d:
  FUN_1408796f3(fVar6,fVar5,param_3,0);
  return;
}
