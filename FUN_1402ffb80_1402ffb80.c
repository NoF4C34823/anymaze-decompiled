...
longlong FUN_1402ffb80(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && 0 < lVar5) {
      do {
        FUN_142d21fa0(param_1,lVar4,lVar1,(longlong)(int)param_6,1);
        lVar7 = lVar7 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_142d21fa0(param_1,lVar4,(longlong)(int)param_5,(longlong)(int)param_6,1);
        thunk_FUN_142d22130(param_9,uVar2,param_3,(longlong)(int)param_5,lVar5);
        lVar6 = lVar6 + 1;
        lVar4 = lVar4 + uVar2 * 4;
        if (lVar5 <= lVar6) {
          lVar4 = param_9;
