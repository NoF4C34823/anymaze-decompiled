...
void FUN_1407c0b60(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  lVar20 = (longlong)param_3 + -1;
  if (SCARRY8((longlong)param_3,-1) != lVar20 < 0) {
    lVar20 = 2;
  }
  fVar5 = *param_6;
  fVar6 = param_6[1];
  lVar19 = (longlong)(int)lVar20 + 1;
  if (2 < lVar19) {
    lVar19 = 0;
  }
  lVar21 = (longlong)(int)lVar19 + 1;
  if (2 < lVar21) {
    lVar21 = 0;
  }
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar18 = param_4 & 0xf;
      if (uVar18 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1407c0fe7;
        uVar18 = 0x10 - uVar18 >> 2;
      }
      if ((longlong)(uVar18 + 4) <= (longlong)param_5) {
        uVar17 = param_5 - (param_5 - uVar18 & 3);
        lVar24 = param_2 * lVar19 + param_1;
        lVar22 = param_2 * lVar20 + param_1;
...
LAB_1407c0f6a:
    ...
    do {
      *(float *)(param_4 + uVar17 * 4) =
           (*(float *)(lVar20 * param_2 + param_1 + uVar17 * 4) +
           *(float *)(param_1 + param_2 * lVar21 + uVar17 * 4)) * fVar5 +
           *(float *)(lVar19 * param_2 + param_1 + uVar17 * 4) * fVar6;
      uVar17 = uVar17 + 1;
...
LAB_1407c0fd8:
    ...
    uVar18 = param_4 & 0xf;
    if (uVar18 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1407c0fd8;
      uVar18 = 0x10 - uVar18 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar18 + 8)) goto LAB_1407c0fd8;
    uVar17 = param_5 - (param_5 - uVar18 & 7);
    lVar16 = param_2 * lVar19 + param_1;
    lVar22 = param_2 * lVar20 + param_1;
  ...
  if (uVar18 < param_5) {
    do {
      *(float *)(param_4 + uVar17 * 4 + uVar18 * 4) =
           (*(float *)(lVar20 * param_2 + param_1 + uVar17 * 4 + uVar18 * 4) +
           *(float *)(lVar21 * param_2 + param_1 + uVar17 * 4 + uVar18 * 4)) * fVar5 +
           *(float *)(param_1 + param_2 * lVar19 + uVar17 * 4 + uVar18 * 4) * fVar6;
      uVar18 = uVar18 + 1;
