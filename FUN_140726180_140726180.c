...
void FUN_140726180(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)param_3) {
    uVar38 = param_2 & 0xf;
    if (uVar38 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407263ed;
    ...
    if ((longlong)(uVar38 + 4) <= (longlong)param_3) {
      ...
      goto joined_r0x000140726372;
    }
  }
LAB_1407263ed:
  uVar36 = 0;
joined_r0x000140726372:
