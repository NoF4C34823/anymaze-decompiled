...
void FUN_140776b60(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)param_3) {
    uVar7 = param_2 & 0xf;
    if (uVar7 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140776e4e;
      uVar7 = 0x10 - uVar7 >> 2;
    }
    if ((longlong)(uVar7 + 4) <= (longlong)param_3) {
        ...
        do {
          auVar13._0_4_ =
               (float)((int)*(short *)(param_1 + -6 + uVar8 * 2) +
                      (int)*(short *)(param_1 + 6 + uVar8 * 2));
          auVar13._4_4_ =
               (float)((int)*(short *)(param_1 + -4 + uVar8 * 2) +
                      (int)*(short *)(param_1 + 4 + uVar8 * 2));
          auVar13._12_4_ = (float)(int)*(short *)(param_1 + uVar8 * 2);
          auVar13._8_4_ =
               (float)((int)*(short *)(param_1 + -2 + uVar8 * 2) +
                      (int)*(short *)(param_1 + 2 + uVar8 * 2));
      ...
      do {
        auVar13 = pmovsxwd(in_XMM2,*(undefined8 *)(param_1 + -6 + uVar7 * 2));
        auVar12 = pmovsxwd(auVar12,*(undefined8 *)(param_1 + 6 + uVar7 * 2));
        auVar10 = pmovsxwd(in_XMM0,*(undefined8 *)(param_1 + 4 + uVar7 * 2));
        ...
        auVar13 = pmovsxwd(auVar12,*(undefined8 *)(param_1 + -4 + uVar7 * 2));
        ...
        auVar10 = pmovsxwd(auVar10,*(undefined8 *)(param_1 + -2 + uVar7 * 2));
        in_XMM2 = pmovsxwd(auVar14,*(undefined8 *)(param_1 + 2 + uVar7 * 2));
        ...
        in_XMM0 = pmovsxwd(auVar11,*(undefined8 *)(param_1 + uVar7 * 2));
      ...
      goto joined_r0x000140776d9b;
    }
  }
LAB_140776e4e:
  uVar9 = 0;
joined_r0x000140776d9b:
  for (; uVar9 < param_3; uVar9 = uVar9 + 1) {
    auVar10._0_4_ =
         (float)((int)*(short *)(param_1 + -6 + uVar9 * 2) +
                (int)*(short *)(param_1 + 6 + uVar9 * 2));
    auVar10._4_4_ =
         (float)((int)*(short *)(param_1 + -4 + uVar9 * 2) +
                (int)*(short *)(param_1 + 4 + uVar9 * 2));
    auVar10._12_4_ = (float)(int)*(short *)(param_1 + uVar9 * 2);
    auVar10._8_4_ =
         (float)((int)*(short *)(param_1 + -2 + uVar9 * 2) +
                (int)*(short *)(param_1 + 2 + uVar9 * 2));
