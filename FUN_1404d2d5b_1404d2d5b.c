...
void FUN_1404d2d5b(longlong param_1,longlong param_2,undefined1 (*param_3) [16],longlong param_4)

{
  ...
  do {
    ...
    if (uVar6 != 0) {
      ...
      FUN_1404d2f00(in_R10,param_2,param_3);
    ...
    if (lVar3 != 0) {
      ...
      auVar10 = vminps_avx(*pauVar4,auVar10);
      ...
      if (0 < lVar3) {
        do {
          ...
          auVar8 = vminps_avx(pauVar4[1],auVar11);
          ...
          auVar10 = vminps_avx(auVar8,auVar10);
