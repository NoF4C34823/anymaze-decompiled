...
longlong FUN_1405b1880(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
    ...
    if (0 < param_5._4_4_) {
      do {
        ...
        FUN_140d3b3a0(param_9,uVar2,param_3,(longlong)(int)param_5,lVar5);
        lVar6 = lVar6 + 1;
        lVar4 = lVar4 + uVar2 * 2;
        if (lVar5 <= lVar6) {
          lVar4 = param_9;
