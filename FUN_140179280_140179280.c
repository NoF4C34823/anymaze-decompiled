...
void FUN_140179280(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140179777:
      uVar33 = 0;
      if (param_5 == 0) goto LAB_140179528;
      uVar29 = 0;
      uVar27 = param_5;
    }
    else {
      ...
      uVar27 = uVar26 & 0xf;
      if (uVar27 != 0) {
        if ((uVar26 & 3) != 0) goto LAB_140179777;
        uVar27 = 0x10 - uVar27 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar27 + 8)) goto LAB_140179777;
      lVar28 = param_2 * lVar34 + param_1;
      lVar36 = param_2 * lVar35 + param_1;
      lVar25 = param_2 * lVar32 + param_1;
      ...
      if (param_5 < uVar33 + 1) goto LAB_140179528;
    ...
    if (uVar29 < uVar27) {
      do {
        *(float *)(param_2 * 3 + param_1 + uVar33 * 4 + uVar29 * 4) =
             ...
             *(float *)(lVar32 * param_2 + param_1 + uVar33 * 4 + uVar29 * 4)) * fVar5 +
...
LAB_140179528:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar26 = uVar27 & 0xf;
      if (uVar26 != 0) {
        if ((uVar27 & 3) != 0) goto LAB_140179795;
      ...
      if ((longlong)(uVar26 + 8) <= (longlong)param_5) {
        ...
        if (uVar26 != 0) {
          do {
            iVar31 = (int)ROUND(*(float *)(uVar27 + uVar29 * 4));
            if (0xfe < iVar31) {
              iVar31 = 0xff;
            }
            ...
            *(undefined1 *)(uVar29 + param_4) = uVar30;
            uVar29 = uVar29 + 1;
          } while (uVar29 < uVar26);
        }
        do {
...
LAB_140179723:
    ...
    do {
      iVar31 = (int)ROUND(*(float *)(param_1 + param_2 * 3 + uVar33 * 4));
      if (0xfe < iVar31) {
        iVar31 = 0xff;
      }
      uVar30 = (undefined1)iVar31;
      ...
      *(undefined1 *)(uVar33 + param_4) = uVar30;
      uVar33 = uVar33 + 1;
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar26 = uVar27 & 0xf;
    if (uVar26 != 0) {
      if ((uVar27 & 3) != 0) goto LAB_14017978e;
      uVar26 = 0x10 - uVar26 >> 2;
    }
    if ((longlong)(uVar26 + 8) <= (longlong)param_5) {
      uVar29 = 0;
