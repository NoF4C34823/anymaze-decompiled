...
/* WARNING: Removing unreachable block (ram,0x000140098d53) */

void FUN_140097fa0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1d8 = param_10;
    (**(code **)(&UNK_143086b00 + lVar14 * 8))(param_1,param_4,*param_5,param_9);
...
LAB_14009900b:
    ...
    iStack_1d8 = param_10;
    (**(code **)(&UNK_143086b00 + lVar14 * 8))(param_11 + lVar19 * 0xc,param_4,lVar11,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_190 = lVar19 * 3;
      ...
      if (uVar4 != 0 && SCARRY8(uVar9,-3) == (longlong)uVar4 < 0) {
        if (6 < (longlong)uVar4) {
          ...
          if ((lVar16 <= (longlong)(uStack_198 - param_1)) ||
            ...
            if (uVar5 == 0) {
LAB_1400980f8:
              if ((longlong)uVar4 < (longlong)(uVar5 + 4)) goto LAB_1400990e8;
...
LAB_1400988df:
      uStack_1b0 = uVar9;
      pcStack_1b8 = *(code **)(&UNK_143086b00 + lVar14 * 8);
      iStack_1d8 = param_10;
      lStack_188 = param_1;
      uStack_180 = param_7;
