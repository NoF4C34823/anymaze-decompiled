...
void FUN_14069f5a0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14069fec6:
      ...
      uVar30 = param_2 & 0xf;
      if (uVar30 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14069fec6;
        uVar30 = 0x10 - uVar30 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_14069fec6;
      uVar31 = 0;
...
LAB_14069fea7:
          uVar24 = 0;
          if (param_3 == 0) goto LAB_14069fcac;
          uVar31 = 0;
          uVar30 = param_3;
        }
        else {
          uVar30 = param_2 & 0xf;
          if (uVar30 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14069fea7;
            uVar30 = 0x10 - uVar30 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_14069fea7;
          ...
          if (param_3 < uVar24 + 1) goto LAB_14069fcac;
...
LAB_14069fe93:
    ...
    uVar30 = param_2 & 0xf;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14069fe93;
      uVar30 = 0x10 - uVar30 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_14069fe93;
    uVar31 = 0;
    uVar24 = param_3 - (param_3 - uVar30 & 7);
    if (uVar30 != 0) {
      do {
