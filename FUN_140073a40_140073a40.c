...
void FUN_140073a40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140074a5b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086900 + lVar17 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar12 < 2) {
                ...
                if (lVar14 < 0) goto LAB_1400749e0;
                while (uVar8 == 0) {
                  for (lVar22 = (lVar12 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_1400749e0:
                    if (uVar7 != 0) goto LAB_1400748ce;
                  }
...
LAB_1400748ce:
        ...
        *(undefined1 *)(lVar19 + 2 + param_11) = uVar15;
        lVar19 = lVar19 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140074974. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086900 + lVar17 * 8))(param_11 + lVar20 * 3,param_4,lVar12,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar19 = lVar20 * 3;
...
LAB_140074976:
            ...
            if ((longlong)uVar18 < (longlong)(uVar5 + 0x10)) goto LAB_140074976;
...
LAB_140073cd9:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_143086900 + lVar17 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001400749b2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_1400747a7:
                    /* WARNING: Could not recover jumptable at 0x0001400747d8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
