...
void FUN_140546660(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  auVar3 = _DAT_14308abc0;
  auVar2 = _DAT_14308aba0;
  lVar20 = 0;
                  ...
                  do {
                    ...
                    if (uVar10 != 0) {
                      do {
                        ...
                        auVar24 = vminps_avx(auVar26._0_16_,auVar24);
                        auVar26 = ZEXT1664(auVar24);
                      } while (lVar19 < (longlong)uVar10);
                    }
                    lVar15 = lVar15 + 1;
        ...
        do {
          ...
          if (0 < lVar20) {
            do {
              ...
              lVar11 = lVar11 + 1;
              auVar32 = vminps_avx(auVar33._0_32_,*(undefined1 (*) [32])(lVar6 + lVar7 * 4));
              auVar33 = ZEXT3264(auVar32);
              auVar30 = vminps_avx(auVar31._0_32_,*(undefined1 (*) [32])(lVar6 + 0x20 + lVar7 * 4));
              auVar31 = ZEXT3264(auVar30);
              auVar28 = vminps_avx(auVar29._0_32_,*(undefined1 (*) [32])(lVar6 + 0x40 + lVar7 * 4));
              auVar29 = ZEXT3264(auVar28);
              auVar25 = vminps_avx(auVar26._0_32_,*(undefined1 (*) [32])(lVar6 + 0x60 + lVar7 * 4));
      ...
      for (; lVar17 < (longlong)uVar9; lVar17 = lVar17 + 0x10) {
        ...
        if (0 < lVar20) {
          do {
            lVar7 = alStack_448[lVar11];
            lVar11 = lVar11 + 1;
            auVar24 = vminps_avx(auVar33._0_16_,*(undefined1 (*) [16])(lVar6 + lVar7 * 4));
            auVar33 = ZEXT1664(auVar24);
            auVar23 = vminps_avx(auVar31._0_16_,*(undefined1 (*) [16])(lVar6 + 0x10 + lVar7 * 4));
            auVar31 = ZEXT1664(auVar23);
            auVar27 = vminps_avx(auVar29._0_16_,*(undefined1 (*) [16])(lVar6 + 0x20 + lVar7 * 4));
            auVar29 = ZEXT1664(auVar27);
            auVar22 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + 0x30 + lVar7 * 4));
      ...
      for (; lVar17 < (longlong)uStack_498; lVar17 = lVar17 + 8) {
        ...
        if (0 < lVar20) {
          do {
            ...
            lVar11 = lVar11 + 1;
            auVar24 = vminps_avx(auVar29._0_16_,*(undefined1 (*) [16])(lVar6 + *plVar1 * 4));
            auVar29 = ZEXT1664(auVar24);
            auVar23 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + 0x10 + *plVar1 * 4));
      ...
      for (; lVar17 < (longlong)uStack_488; lVar17 = lVar17 + 4) {
        ...
        if (0 < lVar20) {
          do {
            plVar1 = alStack_448 + lVar11;
            lVar11 = lVar11 + 1;
            auVar24 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + *plVar1 * 4));
            auVar26 = ZEXT1664(auVar24);
          } while (lVar11 < lVar20);
        }
        lVar6 = lVar6 + 0x10;
      ...
      for (; lVar17 < (longlong)uStack_490; lVar17 = lVar17 + 2) {
        ...
        if (0 < lVar20) {
          do {
            ...
            auVar24 = vminps_avx(auVar26._0_16_,auVar23);
            auVar26 = ZEXT1664(auVar24);
      ...
      for (; lVar17 < (longlong)param_5; lVar17 = lVar17 + 1) {
        ...
        if (0 < lVar20) {
          do {
            plVar1 = alStack_448 + lVar11;
            lVar11 = lVar11 + 1;
            auVar24 = vminps_avx(auVar26._0_16_,ZEXT416(*(uint *)(lVar6 + *plVar1 * 4)));
            auVar26 = ZEXT1664(auVar24);
          } while (lVar11 < lVar20);
        }
        lVar6 = lVar6 + 4;
