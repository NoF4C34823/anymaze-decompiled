...
void FUN_1400aca20(longlong param_1,float param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  if (param_4 + 1 <= param_3) {
    ...
    if ((longlong)param_3 < 4) {
      ...
      puVar12 = (uint *)(param_4 + param_1);
      do {
        auVar9 = vpmovzxbw_avx(ZEXT416(*(uint *)((longlong)puVar12 + -1)));
        auVar10 = vpmovzxbw_avx(ZEXT416(*(uint *)((longlong)puVar12 + 1)));
        ...
        pfVar1 = (float *)(in_R10 + param_4 * 4 + uVar13 * 4);
    ...
    if (uVar11 < param_3) {
      ...
      do {
        *(float *)(in_R10 + param_4 * 4 + uVar11 * 4) =
             param_2 * (float)((uint)*(byte *)((uVar11 - 1) + param_1) +
