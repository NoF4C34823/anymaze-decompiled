...
void FUN_1405f5380(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1405f5bbf:
      uVar35 = 0;
      if (param_5 == 0) goto LAB_1405f587d;
      uVar31 = 0;
      uVar45 = param_5;
    }
    else {
      ...
      uVar45 = uVar44 & 0xf;
      if (uVar45 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_1405f5bbf;
        uVar45 = 0x10 - uVar45 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar45 + 8)) goto LAB_1405f5bbf;
      ...
      if (param_5 < uVar35 + 1) goto LAB_1405f587d;
...
LAB_1405f587d:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar45 & 0xf;
      if (uVar44 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_1405f5bdc;
        uVar44 = 0x10 - uVar44 >> 2;
      }
      if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
        uVar31 = 0;
        uVar35 = param_5 - (param_5 - uVar44 & 3);
        uVar25 = _UNK_14308b46c;
        uVar26 = _UNK_14308b468;
        uVar27 = _UNK_14308b464;
        uVar28 = _DAT_14308b460;
        if (uVar44 != 0) {
          do {
...
LAB_1405f5b4d:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar44 = uVar45 & 0xf;
    if (uVar44 != 0) {
      if ((uVar45 & 3) != 0) goto LAB_1405f5bd5;
      uVar44 = 0x10 - uVar44 >> 2;
    }
