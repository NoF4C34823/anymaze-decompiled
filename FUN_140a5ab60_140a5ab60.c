...
void FUN_140a5ab60(longlong param_1,ulonglong param_2,int param_3,undefined8 param_4,
...

{
  ...
  auVar27 = _DAT_14308ee40;
  iVar34 = (int)param_4;
  uVar38 = (ulonglong)(int)((ulonglong)param_4 >> 0x20);
  uVar29 = 0;
  if (0 < (longlong)uVar38) {
    lVar35 = (longlong)iVar34;
    iVar28 = iVar34 + -0x10;
    uVar44 = (longlong)(((ulonglong)(lVar35 >> 3) >> 0x3c) + lVar35) >> 4;
    do {
      iVar37 = 0;
      lVar40 = *(longlong *)(param_1 + uVar29 * 8);
      lVar30 = *(longlong *)(param_1 + 8 + uVar29 * 8);
      lVar36 = *(longlong *)(param_1 + 0x10 + uVar29 * 8);
      lVar33 = *(longlong *)(param_1 + 0x18 + uVar29 * 8);
      lVar32 = *(longlong *)(param_1 + 0x20 + uVar29 * 8);
      if ((param_2 & 0xf) == 0) {
        if (param_6 == 0) {
          uVar39 = 0;
          lVar45 = 0;
          ...
          if (-1 < iVar28) {
            do {
              psVar1 = (short *)(lVar42 + lVar40);
              uVar39 = uVar39 + 1;
              psVar7 = (short *)(lVar42 + 0x10 + lVar40);
              psVar2 = (short *)(lVar42 + lVar30);
              psVar8 = (short *)(lVar42 + 0x10 + lVar30);
              psVar3 = (short *)(lVar42 + lVar36);
              psVar9 = (short *)(lVar42 + 0x10 + lVar36);
              psVar4 = (short *)(lVar42 + lVar33);
              psVar10 = (short *)(lVar42 + 0x10 + lVar33);
              psVar5 = (short *)(lVar42 + lVar32);
              ...
              psVar1 = (short *)(lVar42 + 0x10 + lVar32);
...
LAB_140a5adc3:
      ...
      if (iVar37 < iVar34) {
        iVar41 = 1;
        uVar39 = 0;
        uVar43 = (uint)(iVar34 - iVar37) >> 2;
        lVar42 = (longlong)iVar37;
        if (uVar43 != 0) {
          lVar45 = param_2 + lVar42;
          do {
            iVar37 = ((int)*(short *)(lVar40 + uVar39 * 8) + (int)*(short *)(lVar30 + uVar39 * 8) +
                      (int)*(short *)(lVar36 + uVar39 * 8) +
                     (int)*(short *)(lVar33 + uVar39 * 8) + (int)*(short *)(lVar32 + uVar39 * 8)) *
                     0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar31 = (undefined1)iVar37;
            if (0xfe < iVar37) {
              uVar31 = 0xff;
            }
            *(undefined1 *)(lVar45 + uVar39 * 4) = uVar31;
            iVar37 = ((int)*(short *)(lVar40 + 2 + uVar39 * 8) +
                      (int)*(short *)(lVar30 + 2 + uVar39 * 8) +
                      (int)*(short *)(lVar36 + 2 + uVar39 * 8) +
                     (int)*(short *)(lVar33 + 2 + uVar39 * 8) +
                     (int)*(short *)(lVar32 + 2 + uVar39 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar31 = (undefined1)iVar37;
            ...
            *(undefined1 *)(lVar45 + 1 + uVar39 * 4) = uVar31;
            iVar37 = ((int)*(short *)(lVar40 + 4 + uVar39 * 8) +
                      (int)*(short *)(lVar30 + 4 + uVar39 * 8) +
                      (int)*(short *)(lVar36 + 4 + uVar39 * 8) +
                     (int)*(short *)(lVar33 + 4 + uVar39 * 8) +
                     (int)*(short *)(lVar32 + 4 + uVar39 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar31 = (undefined1)iVar37;
            ...
            *(undefined1 *)(lVar45 + 2 + uVar39 * 4) = uVar31;
            iVar37 = ((int)*(short *)(lVar40 + 6 + uVar39 * 8) +
                      (int)*(short *)(lVar30 + 6 + uVar39 * 8) +
                      (int)*(short *)(lVar36 + 6 + uVar39 * 8) +
                     (int)*(short *)(lVar33 + 6 + uVar39 * 8) +
                     (int)*(short *)(lVar32 + 6 + uVar39 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar31 = (undefined1)iVar37;
            ...
            *(undefined1 *)(lVar45 + 3 + uVar39 * 4) = uVar31;
            uVar39 = uVar39 + 1;
          } while (uVar39 < uVar43);
          iVar41 = (int)uVar39 * 4 + 1;
        }
        uVar39 = (longlong)iVar41 - 1;
        if (uVar39 < (ulonglong)(lVar35 - lVar42)) {
          do {
            iVar37 = ((int)*(short *)(lVar40 + uVar39 * 2) + (int)*(short *)(lVar30 + uVar39 * 2) +
                      (int)*(short *)(lVar36 + uVar39 * 2) +
                     (int)*(short *)(lVar33 + uVar39 * 2) + (int)*(short *)(lVar32 + uVar39 * 2)) *
                     0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            ...
            *(undefined1 *)(uVar39 + lVar42 + param_2) = uVar31;
            uVar39 = uVar39 + 1;
          } while (uVar39 < (ulonglong)(lVar35 - lVar42));
        }
      }
      uVar29 = uVar29 + 1;
