...
void FUN_1403cb140(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403bffa0(param_1,lVar3,lVar5,(longlong)(int)param_6,4);
        FUN_142d25930(param_9,uVar1,param_3,lVar5,(longlong)param_6._4_4_);
        lVar4 = lVar4 + 1;
        lVar6 = lVar6 + 1;
        lVar3 = lVar3 + uVar1 * 4;
