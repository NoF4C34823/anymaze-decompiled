...
void FUN_14036a0e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar21 - 1)) {
      while( true ) {
        FUN_140334640(param_1,lVar25,uVar4,uVar26,1);
        uVar21 = param_6[1];
        lVar31 = lVar31 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_140334640(param_1,lVar25,uVar4,*param_6,1);
        FUN_14033f6c0(param_9,uVar39,param_3,uVar4,param_6[1]);
        lVar31 = lVar31 + 1;
        lVar32 = lVar32 + 1;
        param_1 = param_1 + param_2 * 2;
                ...
                if (0 < (longlong)uVar26) {
                  if ((longlong)uVar26 < 8) {
                    ...
                    do {
                      ...
                      auVar51._2_2_ =
                           (ushort)(sVar36 < sVar44) * sVar36 | (ushort)(sVar36 >= sVar44) * sVar44;
                      ...
                      auVar51._8_2_ =
                           (ushort)(sVar36 < sVar28) * sVar36 | (ushort)(sVar36 >= sVar28) * sVar28;
                      sVar36 = auVar47._10_2_;
                      auVar51._10_2_ =
                           (ushort)(sVar36 < sVar30) * sVar36 | (ushort)(sVar36 >= sVar30) * sVar30;
                    ...
                    uVar43 = (ushort)(sVar36 < sVar44) * sVar36 |
                             (ushort)(sVar36 >= sVar44) * sVar44;
                    sVar36 = auVar47._10_2_;
                    sVar44 = auVar47._2_2_;
                    uVar48 = (ushort)(sVar36 < sVar44) * sVar36 |
                             (ushort)(sVar36 >= sVar44) * sVar44;
                    sVar36 = auVar47._12_2_;
                    sVar44 = auVar47._4_2_;
                    uVar49 = (ushort)(sVar36 < sVar44) * sVar36 |
                             (ushort)(sVar36 >= sVar44) * sVar44;
                    sVar36 = auVar47._14_2_;
                    sVar44 = auVar47._6_2_;
                    uVar50 = (ushort)(sVar36 < sVar44) * sVar36 |
                             (ushort)(sVar36 >= sVar44) * sVar44;
