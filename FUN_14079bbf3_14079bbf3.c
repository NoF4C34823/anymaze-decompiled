...
void FUN_14079bbf3(longlong param_1,ulonglong param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  do {
    *(float *)(in_R10 + param_2 * 4) =
         (float)((int)*(short *)(param_1 + -0xc + param_2 * 2) +
                (int)*(short *)(param_1 + 0xc + param_2 * 2)) * in_XMM2_Da +
         (float)((int)*(short *)(param_1 + -6 + param_2 * 2) +
                (int)*(short *)(param_1 + 6 + param_2 * 2)) * in_XMM4_Da +
         (float)(int)*(short *)(param_1 + param_2 * 2) * in_XMM0_Da;
    param_2 = param_2 + 1;
  } while (param_2 < in_RAX);
  do {
    auVar3 = pmovsxwd(unaff_XMM7,*(undefined8 *)(param_1 + -0xc + in_RAX * 2));
    auVar2 = pmovsxwd(unaff_XMM6,*(undefined8 *)(param_1 + 0xc + in_RAX * 2));
    ...
    auVar2 = pmovsxwd(auVar2,*(undefined8 *)(param_1 + 6 + in_RAX * 2));
    auVar3 = pmovsxwd(auVar4,*(undefined8 *)(param_1 + -6 + in_RAX * 2));
    ...
    unaff_XMM7 = pmovsxwd(auVar5,*(undefined8 *)(param_1 + in_RAX * 2));
  ...
  if (param_3 < param_4) {
    do {
      *(float *)(in_R10 + param_3 * 4) =
           (float)((int)*(short *)(param_1 + -0xc + param_3 * 2) +
                  (int)*(short *)(param_1 + 0xc + param_3 * 2)) * in_XMM2_Da +
           (float)((int)*(short *)(param_1 + -6 + param_3 * 2) +
                  (int)*(short *)(param_1 + 6 + param_3 * 2)) * in_XMM4_Da +
           (float)(int)*(short *)(param_1 + param_3 * 2) * in_XMM0_Da;
      param_3 = param_3 + 1;
