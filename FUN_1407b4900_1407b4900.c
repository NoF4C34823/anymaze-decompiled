...
longlong *
FUN_1407b4900(longlong param_1,longlong param_2,longlong param_3,longlong param_4,longlong *param_5,
...

{
  ...
  if (0 < iVar21) {
    ...
    lStack_80 = param_3;
    uStack_78 = uVar13;
    if (uStack_70 == 0xf0) goto LAB_1407b4d23;
    uVar10 = 0;
    lStack_58 = param_2;
    lStack_50 = param_1;
LAB_1407b49db:
    ...
    if ((param_5[1] <= (longlong)uVar10) && (param_7 != 0xf0)) {
      if (uVar20 == 6) {
        if (uStack_90 == 0) goto LAB_1407b4b14;
      }
      else {
        if (uVar20 != 1) goto LAB_1407b4a17;
        if (uStack_90 == 0) {
          uVar14 = param_5[1] - 1;
        }
      }
...
LAB_1407b4a9a:
    do {
      ...
      in_RAX = (longlong *)
               FUN_1407b5500(lStack_50,lStack_58,uVar14,lVar9,in_stack_ffffffffffffff18,param_6,
          ...
          if (uStack_48 <= uVar10) {
            ...
            if (uStack_78 != 0) {
              ...
              do {
                ...
                plVar7 = (longlong *)
                         FUN_1407b5500(lStack_50,lStack_58,lVar9,lVar12,&lStack_a8,param_6,param_7,
...
LAB_1407b4d23:
          ...
          in_RAX = (longlong *)
                   (*(code *)(&PTR_FUN_14308c320)[param_6])
        ...
        if (-1 < (longlong)uVar10) goto LAB_1407b49db;
        uVar14 = uVar10;
        if (param_7 == 0xf0) goto LAB_1407b4a9a;
        if (uVar20 != 6) break;
        if (uStack_78 != 0) goto LAB_1407b4a9a;
LAB_1407b4b14:
        in_RAX = (longlong *)(ulonglong)(uint)(int)*param_8;
        fVar24 = (float)(int)*param_8;
        fVar23 = (float)(int)param_8[1];
        fVar22 = (float)(int)param_8[2];
        if (0 < *param_5 * 3) {
          uVar14 = *param_5 * 3 + 2;
          lVar9 = 1;
          lVar6 = 0;
...
LAB_1407b4dcb:
  if (uVar20 == 6) {
    uVar10 = 0;
    plVar7 = (longlong *)(ulonglong)(uint)(int)*param_8;
    fVar24 = (float)(int)*param_8;
    fVar23 = (float)(int)param_8[1];
    fVar22 = (float)(int)param_8[2];
    lVar12 = 0;
...
LAB_1407b5273:
            ...
            uVar14 = uVar8 & 0xf;
            if (uVar14 != 0) {
              if ((uVar8 & 3) != 0) goto LAB_1407b5273;
              uVar14 = 0x10 - uVar14 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar14 + 4)) goto LAB_1407b5273;
            uVar11 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_9c = *(undefined4 *)((longlong)param_5 + 0xc);
      in_RAX = (longlong *)
               FUN_1407b5500((int)*param_5,param_2,lVar12,param_3,&lStack_a8,param_6,param_7,param_8
...
LAB_1407b5087:
            ...
            if (plVar19 != (longlong *)0x0) {
              if ((uVar14 & 3) != 0) goto LAB_1407b5087;
              plVar19 = (longlong *)(0x10U - (longlong)plVar19 >> 2);
            }
            if ((longlong)plVar7 < (longlong)plVar19 + 4) goto LAB_1407b5087;
...
LAB_1407b4a17:
  ...
  if (uVar20 == 3) {
    ...
    if (lVar18 < 2) {
      ...
      if ((longlong)uVar10 < 0) goto LAB_1407b4cc0;
      while (uStack_90 == 0) {
