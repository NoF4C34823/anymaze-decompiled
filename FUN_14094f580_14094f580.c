...
void FUN_14094f580(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)
...
LAB_14094fa17:
    ...
    if ((longlong)uVar23 < 0x1d) {
      ...
      uVar24 = param_2 & 0x1f;
      if (uVar24 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14094fa17;
        uVar24 = 0x20 - uVar24 >> 2;
      }
      if ((longlong)uVar23 < (longlong)(uVar24 + 0x10)) goto LAB_14094fa17;
      uVar21 = 0;
