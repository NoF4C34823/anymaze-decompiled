...
uint FUN_140a94a60(byte *param_1,ulonglong param_2,uint param_3,undefined8 param_4,uint param_5,
...
LAB_140a974ab:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a974ab;
            uVar10 = 0;
...
LAB_140a97041:
    ...
    if (lVar23 < 1) {
      uVar7 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a97315;
LAB_140a9722f:
      if ((int)uVar7 < 1) {
        return param_5;
      }
...
LAB_140a974ba:
        ...
        if ((longlong)uVar11 < (longlong)(uVar13 + 0x10)) goto LAB_140a974ba;
...
LAB_140a974b2:
          ...
          iVar8 = (int)uVar18;
          if (param_3 < iVar8 + 0x10U) goto LAB_140a974b2;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) {
        uVar7 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a9722f;
LAB_140a97315:
        if ((int)uVar7 < 1) {
          return param_5;
        }
        ...
        *(byte *)(lVar20 + 3 + param_2) = param_1[lVar23 + -1];
        lVar20 = (longlong)(int)uVar15;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar7 < 1) goto LAB_140a9748a;
          goto LAB_140a97238;
        }
        if ((int)uVar7 < 1) goto LAB_140a9748a;
      }
...
LAB_140a974c1:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a974c1;
            uVar16 = 0;
...
LAB_140a96de6:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a96de6;
            uVar10 = 0;
            uVar13 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar18 & 0xf));
            if (uVar18 != 0) {
              do {
...
LAB_140a96ded:
          ...
          iVar8 = (int)uVar18;
          if (param_3 < iVar8 + 0x10U) goto LAB_140a96ded;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
              *(byte *)(uVar13 + uVar11) = param_1[uVar13];
    ...
    iVar8 = (int)lVar20;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar7 < 1) goto LAB_140a96dbe;
      if (6 < (int)uVar7) {
        uVar11 = param_2 + lVar20;
        uVar18 = 4 - (longlong)(int)param_5;
...
LAB_140a96dfb:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a96dfb;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a96df4:
      ...
      if ((longlong)uVar11 < (longlong)(uVar13 + 0x10)) goto LAB_140a96df4;
...
LAB_140a96778:
                ...
                if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a96778;
        ...
        if ((int)(param_5 - 1) < 0) goto LAB_140a96164;
        if (6 < (int)param_5) {
...
LAB_140a9677f:
              ...
              if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a9677f;
              uVar10 = 0;
              uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
              if (uVar18 != 0) {
                do {
        ...
        if (iVar8 - 1U < param_5) goto LAB_140a9614c;
      }
    }
    else {
      if (uVar15 < 7) {
LAB_140a95ab7:
        ...
        if (((longlong)(uVar18 - (longlong)param_1) < (longlong)uVar11) &&
           ((longlong)-(uVar18 - (longlong)param_1) < (longlong)uVar11)) goto LAB_140a95ab7;
        if (uVar15 < 0x10) {
LAB_140a96761:
          uVar13 = 0;
        }
          ...
          iVar8 = (int)uVar11;
          if (uVar15 < iVar8 + 0x10U) goto LAB_140a96761;
          uVar13 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) goto LAB_140a95e38;
      if ((param_6 & 0x40) == 0) {
        if ((int)(param_5 - 1) < 0) goto LAB_140a96164;
        if (6 < (int)param_5) {
          lVar24 = (longlong)(int)param_5;
...
LAB_140a96768:
              ...
              if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a96768;
              uVar10 = 0;
              uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
              if (uVar18 != 0) {
                do {
...
LAB_140a96770:
            ...
            if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a96770;
            uVar10 = 0;
            uVar13 = (ulonglong)(int)((int)uVar11 - ((int)uVar11 - (int)uVar18 & 0xfU));
            if (uVar18 != 0) {
              do {
      ...
      if (param_5 <= iVar8 - 1U) goto LAB_140a96164;
LAB_140a9614c:
...
LAB_140a96164:
    ...
    if (lVar23 < 5) {
      ...
      uVar15 = iVar9 + 4;
      if ((param_6 & 0x80) != 0) {
        if ((int)uVar15 < 1) goto LAB_140a96740;
        if (6 < (int)uVar15) {
          uVar11 = param_2 + lVar20;
          pbVar2 = param_1 + lVar23;
          uVar18 = 4 - (longlong)(int)param_5;
...
LAB_140a9679c:
              ...
              if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9679c;
              uVar16 = 0;
              uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
              if (uVar13 != 0) {
                do {
...
LAB_140a96795:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a96795;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a9678e:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9678e;
            uVar16 = 0;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              do {
...
LAB_140a96787:
          ...
          if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a96787;
          uVar16 = 0;
          uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
          if (uVar13 != 0) {
            do {
            ...
            do {
              while( true ) {
                *(byte *)(lVar24 + param_2) = param_1[lVar24 - lVar20];
                ...
                do {
                  if (lVar24 < 0) goto LAB_140a9531a;
LAB_140a959a9:
                  uVar18 = uVar11;
            ...
            bVar26 = -1 < lVar24;
            if ((((bVar26) && (bVar26)) && (bVar26)) && (bVar26)) goto LAB_140a959a9;
          }
        }
        goto LAB_140a9531a;
      }
            ...
            do {
              while( true ) {
                *(undefined1 *)(lVar24 + param_2) = *(undefined1 *)(param_2 + lVar25);
                ...
                if ((longlong)(uVar18 + 1) < lVar23) break;
                do {
                  if (lVar24 < 0) goto LAB_140a95426;
LAB_140a95969:
                  lVar25 = (longlong)(int)((int)lVar24 + uVar7) + 1;
                  uVar18 = uVar11;
                } while (lVar23 <= (longlong)uVar11);
          ...
          else if (-1 < lVar24) goto LAB_140a95969;
        }
LAB_140a95426:
        if (4 < lVar23) goto LAB_140a95529;
        goto LAB_140a95430;
      }
      if (-1 < (int)(param_5 - 1)) {
        iVar8 = 1;
      ...
      if (lVar23 < 5) goto LAB_140a95771;
    }
    else {
      uVar14 = (uint)uVar18;
      if (uVar14 < 7) {
LAB_140a95036:
        ...
        if (((longlong)(uVar13 - (longlong)param_1) < (longlong)uVar18) &&
           ((longlong)-(uVar13 - (longlong)param_1) < (longlong)uVar18)) goto LAB_140a95036;
        if (uVar14 < 0x10) {
LAB_140a95947:
          uVar10 = 0;
        }
          ...
          iVar8 = (int)uVar18;
          if (uVar14 < iVar8 + 0x10U) goto LAB_140a95947;
          uVar10 = 0;
          if (iVar8 != 0) {
            do {
      ...
      if (lVar23 < 5) goto LAB_140a953b6;
      if ((param_6 & 0x40) == 0) {
        if (-1 < (int)(param_5 - 1)) {
          iVar8 = 1;
          lVar24 = 0;
...
LAB_140a9594e:
            ...
            if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9594e;
            uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
            if (uVar13 != 0) {
              uVar16 = 0;
              do {
...
LAB_140a95771:
        uVar7 = -param_5 + 4;
        if ((int)uVar7 < 1) goto LAB_140a958e0;
        iVar8 = (int)lVar12;
        if (6 < (int)uVar7) {
...
LAB_140a95993:
              ...
              if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a95993;
              uVar16 = 0;
              uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
              if (uVar13 != 0) {
                do {
...
LAB_140a9598c:
          ...
          if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a9598c;
          uVar16 = 0;
          uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
          if (uVar13 != 0) {
            do {
...
LAB_140a94f45:
          ...
          if ((longlong)uVar11 < (longlong)(uVar18 + 0x10)) goto LAB_140a94f45;
          uVar10 = 0;
          uVar13 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar18 & 0xf));
          if (uVar18 != 0) {
            do {
...
LAB_140a94cf4:
      ...
      uVar18 = param_2 + lVar20;
      if (((longlong)(uVar18 - (longlong)param_1) < (longlong)uVar11) &&
         ((longlong)-(uVar18 - (longlong)param_1) < (longlong)uVar11)) goto LAB_140a94cf4;
      if (uVar7 < 0x10) {
LAB_140a94f4c:
        uVar13 = 0;
      }
        ...
        iVar8 = (int)uVar11;
        if (uVar7 < iVar8 + 0x10U) goto LAB_140a94f4c;
        uVar13 = 0;
        if (iVar8 != 0) {
          do {
            *(byte *)(uVar13 + uVar18) = param_1[uVar13];
    ...
    uVar15 = uVar14;
    lVar20 = (longlong)(int)uVar15;
    if (lVar23 < 5) goto LAB_140a94da5;
    uVar15 = uVar15 + 4;
    *(byte *)(lVar20 + param_2) = param_1[lVar23 + -4];
    *(byte *)(lVar20 + 1 + param_2) = param_1[lVar23 + -3];
    *(byte *)(lVar20 + 2 + param_2) = param_1[lVar23 + -2];
    *(byte *)(lVar20 + 3 + param_2) = param_1[lVar23 + -1];
    uVar7 = 4 - param_5;
    lVar20 = (longlong)(int)uVar15;
    if ((int)uVar7 < 1) goto LAB_140a94f07;
  }
  iVar8 = (int)lVar20;
  if ((int)uVar7 < 7) {
LAB_140a94e95:
    ...
    if (((longlong)(uVar11 - (longlong)pbVar2) < (longlong)uVar18) &&
       ((longlong)-(uVar11 - (longlong)pbVar2) < (longlong)uVar18)) goto LAB_140a94e95;
    if ((longlong)uVar18 < 0x10) {
LAB_140a94f53:
      uVar10 = 0;
    }
      ...
      if ((longlong)uVar18 < (longlong)(uVar13 + 0x10)) goto LAB_140a94f53;
      uVar16 = 0;
      uVar10 = (ulonglong)(int)((int)uVar18 - ((int)uVar18 - (int)uVar13 & 0xfU));
      if (uVar13 != 0) {
        do {
