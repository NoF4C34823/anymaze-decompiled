...
void FUN_1402f1c7e(undefined8 param_1,longlong param_2,longlong param_3,longlong param_4)
            ...
            if (0 < (longlong)in_stack_00000120) {
                ...
                do {
                  ...
                  if ((*(char *)(in_stack_00000130 + lVar7 + 1 + uVar11 * 2) != '\0') &&
                     (fVar1 = *(float *)((longlong)in_stack_00000140 * 4 + in_RAX + lVar2 +
                                         uVar6 * 4 + lVar3 + lVar10 * 8), fVar13 <= fVar1)) {
                    fVar13 = fVar1;
                  }
                  uVar12 = uVar11 + 1;
              ...
              if (((lVar5 - 1U < in_stack_00000120) &&
                 ...
                 (fVar1 = *(float *)((lVar5 - 1U) * (longlong)in_stack_00000140 * 4 +
                                     in_RAX + lVar2 + uVar6 * 4 + lVar4 * 4), fVar13 <= fVar1)) {
                fVar13 = fVar1;
              }
            }
            uVar8 = uVar8 + 1;
