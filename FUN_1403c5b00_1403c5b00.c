...
void FUN_1403c5b00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  sVar24 = _UNK_143089dfe;
  sVar23 = _UNK_143089dfc;
  sVar22 = _UNK_143089dfa;
  sVar21 = _UNK_143089df8;
  sVar20 = _UNK_143089df6;
  sVar19 = _UNK_143089df4;
  sVar18 = _UNK_143089df2;
  sVar17 = _DAT_143089df0;
  param_2 = param_2 >> 1;
  uVar45 = param_6[1];
  uVar34 = *param_6;
  uVar4 = *param_5;
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar45 - 1)) {
      while( true ) {
        FUN_1403920a0(param_1,lVar39,uVar4,uVar34,1);
        uVar45 = param_6[1];
        lVar27 = lVar27 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_1403920a0(param_1,lVar39,uVar4,*param_6,1);
        FUN_14039b8e0(param_9,uVar35,param_3,uVar4,param_6[1]);
        lVar27 = lVar27 + 1;
        lVar28 = lVar28 + 1;
        lVar39 = lVar39 + uVar35 * 2;
              ...
              do {
                if (0 < (longlong)uVar34) {
                  if ((longlong)uVar34 < 8) {
                    ...
                    uVar48 = CONCAT22((short)uVar44,(short)uVar44);
                    uVar30 = 0;
                    ...
                    do {
                      ...
                      auVar55._14_2_ = -(ushort)(cVar56 == '\0');
                      auVar55 = auVar55 ^ auVar47;
                      if ((auVar55 >> 7 & (undefined1  [16])0x1) == (undefined1  [16])0x0) {
                        sVar50 = 0;
                      }
                      else {
                        sVar50 = *(short *)(lVar2 + uVar30 * 2);
                      }
                      if ((auVar55 >> 0x17 & (undefined1  [16])0x1) == (undefined1  [16])0x0) {
                        sVar54 = 0;
                      }
                      else {
                        sVar54 = *(short *)(lVar2 + 2 + uVar30 * 2);
                      }
                      ...
                      auVar51._2_2_ = sVar54;
                      auVar51._0_2_ = sVar50;
                      auVar51._6_2_ = sVar26;
                      auVar51._4_2_ = sVar25;
                      auVar51._10_2_ = sVar37;
                      auVar51._8_2_ = sVar32;
                      auVar51._14_2_ = sVar46;
                      auVar51._12_2_ = sVar42;
                      uVar30 = uVar30 + 8;
                      auVar57._0_2_ =
                           -(ushort)((short)(auVar49._0_2_ - sVar17) < (short)(sVar50 - sVar17));
                      auVar57._2_2_ =
                           -(ushort)((short)(auVar49._2_2_ - sVar18) < (short)(sVar54 - sVar18));
                      auVar57._4_2_ =
                           -(ushort)((short)(auVar49._4_2_ - sVar19) < (short)(sVar25 - sVar19));
                      auVar57._6_2_ =
                           -(ushort)((short)(auVar49._6_2_ - sVar20) < (short)(sVar26 - sVar20));
                      auVar57._8_2_ =
                           -(ushort)((short)(auVar49._8_2_ - sVar21) < (short)(sVar32 - sVar21));
                      auVar57._10_2_ =
                           -(ushort)((short)(auVar49._10_2_ - sVar22) < (short)(sVar37 - sVar22));
                      auVar57._12_2_ =
                           -(ushort)((short)(auVar49._12_2_ - sVar23) < (short)(sVar42 - sVar23));
                      auVar57._14_2_ =
                           -(ushort)((short)(auVar49._14_2_ - sVar24) < (short)(sVar46 - sVar24));
                      auVar49 = (auVar57 & (auVar51 ^ auVar49) ^ auVar49) & auVar55 |
                                ~auVar55 & auVar49;
                    } while (uVar30 < uVar31);
                    auVar53._0_8_ = auVar49._8_8_;
                    auVar53._8_4_ = auVar49._0_4_;
                    auVar53._12_4_ = auVar49._0_4_;
                    sVar50 = auVar49._0_2_;
                    sVar54 = auVar49._2_2_;
                    auVar52._0_2_ =
                         -(ushort)((short)(auVar49._8_2_ - sVar17) < (short)(sVar50 - sVar17));
                    auVar52._2_2_ =
                         -(ushort)((short)(auVar49._10_2_ - sVar18) < (short)(sVar54 - sVar18));
                    auVar52._4_2_ =
                         -(ushort)((short)(auVar49._12_2_ - sVar19) <
                                  (short)(auVar49._4_2_ - sVar19));
                    auVar52._6_2_ =
                         -(ushort)((short)(auVar49._14_2_ - sVar20) <
                                  (short)(auVar49._6_2_ - sVar20));
                    auVar52._8_2_ =
                         -(ushort)((short)(sVar50 - sVar21) < (short)(auVar49._8_2_ - sVar21));
                    auVar52._10_2_ =
                         -(ushort)((short)(sVar54 - sVar22) < (short)(auVar49._10_2_ - sVar22));
                    auVar52._12_2_ =
                         -(ushort)((short)(sVar50 - sVar23) < (short)(auVar49._12_2_ - sVar23));
                    auVar52._14_2_ =
                         -(ushort)((short)(sVar54 - sVar24) < (short)(auVar49._14_2_ - sVar24));
                    auVar53 = auVar52 & (auVar49 ^ auVar53) ^ auVar53;
                    auVar59._0_12_ = auVar53._4_12_;
                    auVar59._12_4_ = auVar53._0_4_;
                    auVar58._0_2_ =
                         -(ushort)((short)(auVar53._4_2_ - sVar17) < (short)(auVar53._0_2_ - sVar17)
                                  );
                    auVar58._2_2_ =
                         -(ushort)((short)(auVar53._6_2_ - sVar18) < (short)(auVar53._2_2_ - sVar18)
                                  );
                    auVar58._4_4_ = 0;
                    auVar58._8_2_ =
                         -(ushort)((short)(auVar53._12_2_ - sVar21) <
                                  (short)(auVar53._8_2_ - sVar21));
                    auVar58._10_2_ =
                         -(ushort)((short)(auVar53._14_2_ - sVar22) <
                                  (short)(auVar53._10_2_ - sVar22));
                    auVar58._12_2_ =
                         -(ushort)((short)(auVar53._0_2_ - sVar23) <
                                  (short)(auVar53._12_2_ - sVar23));
                    auVar58._14_2_ =
                         -(ushort)((short)(auVar53._2_2_ - sVar24) <
                                  (short)(auVar53._14_2_ - sVar24));
                    auVar59 = auVar58 & (auVar53 ^ auVar59) ^ auVar59;
                    uVar44 = (uint)(ushort)-(ushort)((short)(auVar59._2_2_ - sVar17) <
                  ...
                  if (uVar31 < uVar34) {
                    ...
                    do {
                      if (*(char *)(uVar31 + param_7 + lVar40) != '\0') {
                        ...
                        if (uVar43 < *(ushort *)(lVar2 + uVar31 * 2)) {
