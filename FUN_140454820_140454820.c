...
void FUN_140454820(undefined1 (*param_1) [16],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6) {
    ...
    do {
      ...
      if (uVar13 != 0) {
        ...
        FUN_140454aa0(param_1,param_2,param_3,uVar13);
      ...
      if ((longlong)uVar12 >> 2 != 0) {
        ...
        lVar16 = 0;
        auVar19 = maxps(*pauVar11,*(undefined1 (*) [16])(*pauVar11 + lVar1));
        uVar14 = uVar13 & 0xfffffffffffffffe;
        auVar19 = maxps(auVar19,*(undefined1 (*) [16])(*pauVar11 + param_2 * 8));
        if (0 < (longlong)uVar14) {
          do {
            lVar16 = lVar16 + 2;
            auVar18 = maxps(pauVar11[1],*(undefined1 (*) [16])(pauVar11[1] + lVar1));
            auVar18 = maxps(auVar18,*(undefined1 (*) [16])(pauVar11[1] + param_2 * 8));
            auVar2._16_16_ = auVar18;
            auVar2._0_16_ = auVar19;
            auVar3._16_16_ = auVar18;
            auVar3._0_16_ = auVar19;
            auVar19 = maxps(auVar2._4_16_,auVar19);
            auVar19 = maxps(auVar3._8_16_,auVar19);
            *pauVar15 = auVar19;
            auVar19 = maxps(pauVar11[2],*(undefined1 (*) [16])(pauVar11[2] + lVar1));
            pauVar10 = pauVar11 + 2;
            pauVar11 = pauVar11 + 2;
            auVar19 = maxps(auVar19,*(undefined1 (*) [16])(*pauVar10 + param_2 * 8));
            auVar4._16_16_ = auVar19;
            auVar4._0_16_ = auVar18;
            auVar5._16_16_ = auVar19;
            auVar5._0_16_ = auVar18;
            auVar18 = maxps(auVar4._4_16_,auVar18);
            auVar18 = maxps(auVar5._8_16_,auVar18);
            pauVar15[1] = auVar18;
            pauVar15 = pauVar15 + 2;
        ...
        while (lVar16 < (longlong)uVar13) {
          ...
          auVar19 = maxps(auVar6._4_16_,auVar19);
          auVar19 = maxps(auVar7._8_16_,auVar19);
          *pauVar15 = auVar19;
          pauVar15 = pauVar15 + 1;
          auVar19 = auVar18;
        }
        ...
        auVar19 = maxps(auVar9._4_16_,auVar19);
        auVar19 = maxps(auVar8._8_16_,auVar19);
        *pauVar15 = auVar19;
        pauVar15 = pauVar15 + 1;
      }
      if ((uVar12 & 3) != 0) {
        FUN_140454aa0(pauVar11,param_2,pauVar15);
      }
      lVar17 = lVar17 + 1;
