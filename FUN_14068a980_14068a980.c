...
void FUN_14068a980(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_14068aa61:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar17) && (param_7 != 0xf0)) {
      if (uVar19 == 6) {
        if (uVar13 == 0) goto LAB_14068abb8;
      }
      else {
        if (uVar19 != 1) goto LAB_14068aa9c;
        if (uVar13 == 0) {
          uVar10 = param_5[1] - 1;
        }
      }
...
LAB_14068ab1b:
    do {
      FUN_14068b620(param_1,param_2,uVar10);
      while( true ) {
        while( true ) {
          iVar16 = (int)uVar17;
          uVar17 = uVar17 + 1;
          ...
          if (uVar21 <= uVar17) {
            if (uVar7 != 0) {
              ...
              lVar18 = -uVar21;
              do {
                FUN_14068b620(param_1,param_2,lVar18,param_3);
                lVar12 = lVar12 + 1;
                lVar18 = lVar18 + 1;
            ...
            if (uVar19 != 1) goto LAB_14068ae59;
            uVar10 = 0;
            uVar17 = *param_5;
            goto LAB_14068b1e0;
          }
...
LAB_14068ada1:
          (**(code **)(&DAT_14308b920 + (longlong)param_6 * 8))
                    (param_2 * uVar17 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar17) goto LAB_14068aa61;
        uVar10 = uVar17;
        if (param_7 == 0xf0) goto LAB_14068ab1b;
        if (uVar19 != 6) break;
        if (uVar7 != 0) goto LAB_14068ab1b;
LAB_14068abb8:
        uVar10 = *param_5;
        uVar4 = *param_8;
...
LAB_14068b564:
            ...
            uVar11 = uVar8 & 0xf;
            if (uVar11 != 0) {
              if ((uVar8 & 3) != 0) goto LAB_14068b564;
              uVar11 = 0x10 - uVar11 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar11 + 8)) goto LAB_14068b564;
            uVar9 = 0;
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    if (((lVar12 < 0) || ((longlong)param_5[1] <= lVar12)) && (param_7 != 0xf0)) {
      if ((longlong)param_5[1] < 2) {
        ...
        if (lVar12 < 0) goto LAB_14068b160;
...
LAB_14068b160:
    ...
    FUN_14068b620(param_1,param_2,lVar12,param_3);
  }
  lVar12 = 1;
  uVar17 = 0;
  if (iVar20 < 2) {
...
LAB_14068b126:
        ...
        uVar10 = uVar11 & 0xf;
        if (uVar10 != 0) {
          if ((uVar11 & 3) != 0) goto LAB_14068b126;
          uVar10 = 0x10 - uVar10 >> 2;
        }
        if ((longlong)uVar21 < (longlong)(uVar10 + 4)) goto LAB_14068b126;
...
LAB_14068b48f:
      ...
      uVar11 = uVar8 & 0xf;
      if (uVar11 != 0) {
        if ((uVar8 & 3) != 0) goto LAB_14068b48f;
        uVar11 = 0x10 - uVar11 >> 2;
      }
      if ((longlong)uVar17 < (longlong)(uVar11 + 8)) goto LAB_14068b48f;
      uVar9 = 0;
...
LAB_14068b333:
      ...
      uVar11 = uVar8 & 0xf;
      if (uVar11 != 0) {
        if ((uVar8 & 3) != 0) goto LAB_14068b333;
        uVar11 = 0x10 - uVar11 >> 2;
      }
      if ((longlong)uVar17 < (longlong)(uVar11 + 4)) goto LAB_14068b333;
      uVar9 = 0;
...
LAB_14068aa9c:
  ...
  if (uVar19 == 3) {
    if ((longlong)param_5[1] < 2) {
      ...
      if ((longlong)uVar17 < 0) goto LAB_14068ad40;
      while (uVar13 == 0) {
