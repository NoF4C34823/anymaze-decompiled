...
void FUN_1409255da(ulonglong param_1,ulonglong param_2,longlong param_3,undefined4 param_4)

{
  ...
  do {
    auVar2 = *(undefined1 (*) [32])(unaff_RBX + 0xc + in_R9 * 2);
    auVar3 = *(undefined1 (*) [32])(unaff_RBX + -0xc + in_R9 * 2);
    auVar4 = *(undefined1 (*) [32])(unaff_RBX + 6 + in_R9 * 2);
    auVar5 = *(undefined1 (*) [32])(unaff_RBX + -6 + in_R9 * 2);
    auVar6 = *(undefined1 (*) [32])(unaff_RBX + in_R9 * 2);
    auVar12 = vpmovzxwd_avx2(auVar3._0_16_);
    auVar13 = vpmovzxwd_avx2(auVar2._0_16_);
    ...
    auVar12 = vpmovzxwd_avx2(auVar5._0_16_);
    auVar13 = vpmovzxwd_avx2(auVar4._0_16_);
    auVar12 = vpaddd_avx2(auVar12,auVar13);
    ...
    auVar2 = vpmovzxwd_avx2(auVar6._0_16_);
    auVar3 = vpmovzxwd_avx2(auVar6._16_16_);
    ...
    *(undefined1 (*) [32])(param_3 + in_R9 * 4) = ZEXT1632(auVar19);
    *(undefined1 (*) [32])(param_3 + 0x20 + in_R9 * 4) = ZEXT1632(auVar22);
    in_R9 = in_R9 + 0x10;
  } while (in_R9 < param_1);
  if (param_1 + 1 <= param_2) {
    ...
    do {
      auVar7._8_8_ = 0;
      auVar7._0_8_ = *(ulonglong *)(unaff_RBX + param_1 * 2 + 0xc + uVar17 * 2);
      auVar7 = vpmovzxwd_avx(auVar7);
      lVar1 = uVar17 + param_1;
      auVar8._8_8_ = 0;
      auVar8._0_8_ = *(ulonglong *)(unaff_RBX + -0xc + lVar1 * 2);
      auVar8 = vpmovzxwd_avx(auVar8);
      auVar8 = vpaddd_avx(auVar8,auVar7);
      auVar9._8_8_ = 0;
      auVar9._0_8_ = *(ulonglong *)(unaff_RBX + -6 + lVar1 * 2);
      auVar7 = vpmovzxwd_avx(auVar9);
      auVar10._8_8_ = 0;
      auVar10._0_8_ = *(ulonglong *)(unaff_RBX + 6 + lVar1 * 2);
      ...
      auVar11._8_8_ = 0;
      auVar11._0_8_ = *(ulonglong *)(unaff_RBX + lVar1 * 2);
      auVar7 = vpmovzxwd_avx(auVar11);
      auVar7 = vcvtdq2ps_avx(auVar7);
      auVar7 = vfmadd231ps_fma(auVar8,auVar7,auVar22);
      *(undefined1 (*) [16])(param_3 + param_1 * 4 + uVar17 * 4) = auVar7;
      uVar17 = uVar17 + 4;
    } while (uVar17 < uVar16);
    if (uVar16 < param_2) {
      lVar1 = unaff_RBX + param_1 * 2;
      do {
        auVar18._0_4_ = (float)*(ushort *)(lVar1 + uVar16 * 2);
        auVar18._4_8_ = SUB128(ZEXT812(0),4);
        auVar18._12_4_ = 0;
        auVar20._0_4_ =
             (float)((uint)*(ushort *)(lVar1 + -0xc + uVar16 * 2) +
                    (uint)*(ushort *)(lVar1 + 0xc + uVar16 * 2));
        ...
        auVar19 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM5_Da *
                                                (float)((uint)*(ushort *)(lVar1 + -6 + uVar16 * 2) +
                                                       (uint)*(ushort *)(lVar1 + 6 + uVar16 * 2)))),
                                  auVar20,auVar15);
        auVar14._4_12_ = in_register_000012c4;
        auVar14._0_4_ = param_4;
        auVar19 = vfmadd231ss_fma(auVar19,auVar18,auVar14);
        *(int *)(param_3 + param_1 * 4 + uVar16 * 4) = auVar19._0_4_;
        uVar16 = uVar16 + 1;
