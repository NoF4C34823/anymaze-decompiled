...
void FUN_1408069fb(longlong param_1,float param_2,longlong param_3,undefined8 param_4)

{
  ...
  if ((longlong)uVar6 < 4) {
    ...
    puVar7 = (uint *)(param_3 + param_1);
    do {
      auVar3 = vpmovzxbw_avx(ZEXT416(*(uint *)((longlong)puVar7 + -3)));
      auVar4 = vpmovzxbw_avx(ZEXT416(*(uint *)((longlong)puVar7 + 3)));
      ...
      pfVar1 = (float *)(in_R10 + param_3 * 4 + uVar8 * 4);
  ...
  if (uVar5 < uVar6) {
    ...
    do {
      *(float *)(in_R10 + param_3 * 4 + uVar5 * 4) =
           param_2 * (float)((uint)*(byte *)((uVar5 - 3) + param_1) +
                            (uint)*(byte *)(uVar5 + 3 + param_1)) +
