...
void FUN_14051f55a(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    thunk_FUN_140d27be0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,uStack0000000000000060,
                        1);
    FUN_140d280c0(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
