...
void FUN_140726420(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140726ec1:
      ...
      uVar32 = 0;
      uVar35 = param_3;
      if (param_3 == 0) goto LAB_14072663c;
    }
    else {
      uVar35 = (ulonglong)param_2 & 0xf;
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140726ec1;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140726ec1;
      uVar32 = 0;
      ...
      if (param_3 < uVar33 + 1) goto LAB_14072663c;
...
LAB_140726e85:
          uVar32 = 0;
          if (param_3 == 0) goto LAB_140726ca4;
          uVar33 = 0;
          uVar35 = param_3;
        }
        else {
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140726e85;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140726e85;
          ...
          if (param_3 < uVar32 + 1) goto LAB_140726ca4;
...
LAB_140726ca4:
  ...
  if (7 < (longlong)param_3) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_140726e72;
      uVar35 = 0x10 - uVar35 >> 2;
    }
