...
uint FUN_140a80f80(undefined1 *param_1,ulonglong param_2,uint param_3,undefined8 param_4,
...
LAB_140a83dac:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a83dac;
            uVar6 = 0;
...
LAB_140a838e2:
    ...
    if (lVar17 < 1) {
      uVar4 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a83c16;
LAB_140a83b10:
      if ((int)uVar4 < 1) {
        return param_5;
      }
...
LAB_140a83dbb:
        ...
        if ((longlong)uVar7 < (longlong)(uVar8 + 0x10)) goto LAB_140a83dbb;
...
LAB_140a83db3:
          ...
          iVar5 = (int)uVar12;
          if (param_3 < iVar5 + 0x10U) goto LAB_140a83db3;
          uVar8 = 0;
      ...
      if (lVar17 < 5) {
        uVar4 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a83b10;
LAB_140a83c16:
        if ((int)uVar4 < 1) {
          return param_5;
        }
        ...
        *(undefined1 *)(lVar19 + 3 + param_2) = param_1[lVar17 + -1];
        lVar19 = (longlong)(int)uVar11;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar4 < 1) goto LAB_140a83d8b;
          goto LAB_140a83b19;
        }
        if ((int)uVar4 < 1) goto LAB_140a83d8b;
      }
...
LAB_140a83dc2:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a83dc2;
            uVar13 = 0;
...
LAB_140a83645:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a83645;
            uVar6 = 0;
            uVar8 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar12 & 0xf));
            if (uVar12 != 0) {
              do {
...
LAB_140a8364c:
          ...
          iVar5 = (int)uVar12;
          if (param_3 < iVar5 + 0x10U) goto LAB_140a8364c;
          uVar8 = 0;
          iVar9 = param_3 - (param_3 - iVar5 & 0xf);
          if (iVar5 != 0) {
            do {
    ...
    iVar5 = (int)lVar19;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar4 < 1) goto LAB_140a8361d;
      if (6 < (int)uVar4) {
        uVar7 = param_2 + lVar19;
        uVar12 = 4 - (longlong)(int)param_5;
...
LAB_140a8365a:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a8365a;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a83653:
      ...
      if ((longlong)uVar7 < (longlong)(uVar8 + 0x10)) goto LAB_140a83653;
...
LAB_140a82f3b:
                ...
                if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a82f3b;
                uVar6 = 0;
        ...
        if ((int)(param_5 - 1) < 0) goto LAB_140a828a5;
        if (6 < (int)param_5) {
...
LAB_140a82f43:
              ...
              if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a82f43;
              uVar6 = 0;
              uVar8 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar12 & 0xfU));
              if (uVar12 != 0) {
                do {
        ...
        if (iVar5 - 1U < param_5) goto LAB_140a8288d;
      }
    }
    else {
      uVar11 = (uint)uVar7;
...
LAB_140a82198:
        ...
        if (((longlong)(uVar12 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar12 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a82198;
        if (uVar11 < 0x10) {
LAB_140a82f25:
          uVar8 = 0;
        }
          ...
          iVar5 = (int)uVar7;
          if (uVar11 < iVar5 + 0x10U) goto LAB_140a82f25;
          uVar8 = 0;
      ...
      if (lVar17 < 5) goto LAB_140a82539;
      if ((param_6 & 0x40) == 0) {
        if ((int)(param_5 - 1) < 0) goto LAB_140a828a5;
        if (6 < (int)param_5) {
          lVar20 = (longlong)(int)param_5;
...
LAB_140a82f2c:
              ...
              if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a82f2c;
              uVar6 = 0;
...
LAB_140a82f34:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a82f34;
            uVar6 = 0;
            uVar8 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar12 & 0xfU));
            if (uVar12 != 0) {
              do {
      ...
      if (param_5 <= iVar5 - 1U) goto LAB_140a828a5;
LAB_140a8288d:
      *(undefined1 *)(((longlong)(int)param_5 + param_2) - (longlong)iVar5) =
...
LAB_140a828a5:
    ...
    if (lVar17 < 5) {
      ...
      uVar11 = iVar9 + 4;
      if ((param_6 & 0x80) != 0) {
        if ((int)uVar11 < 1) goto LAB_140a82f04;
        if (6 < (int)uVar11) {
          uVar7 = param_2 + lVar19;
          puVar2 = param_1 + lVar17;
          uVar12 = 4 - (longlong)(int)param_5;
...
LAB_140a82f60:
              ...
              if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a82f60;
              uVar13 = 0;
              uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
              if (uVar8 != 0) {
                do {
...
LAB_140a82f58:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a82f58;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a82f51:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a82f51;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a82f4a:
          ...
          if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a82f4a;
          uVar13 = 0;
          uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
          if (uVar8 != 0) {
            do {
            ...
            do {
              while( true ) {
                *(undefined1 *)(lVar20 + param_2) = param_1[lVar20 - lVar14];
                ...
                do {
                  if (lVar20 < 0) goto LAB_140a8195b;
LAB_140a82049:
                  uVar12 = uVar7;
            ...
            bVar22 = -1 < lVar20;
            if ((((bVar22) && (bVar22)) && (bVar22)) && (bVar22)) goto LAB_140a82049;
          }
        }
        goto LAB_140a8195b;
      }
            ...
            do {
              while( true ) {
                ...
                *(undefined1 *)(lVar20 + param_2) = *puVar2;
                ...
                if ((longlong)(uVar12 + 1) < lVar17) break;
                do {
                  if (lVar20 < 0) goto LAB_140a81a89;
LAB_140a82009:
                  lVar21 = (longlong)(int)((int)lVar20 + uVar4) + 1;
                  uVar12 = uVar7;
                } while (lVar17 <= (longlong)uVar7);
          ...
          else if (-1 < lVar20) goto LAB_140a82009;
        }
LAB_140a81a89:
        if (4 < lVar17) goto LAB_140a81b8a;
        goto LAB_140a81a93;
      }
      if (-1 < (int)(param_5 - 1)) {
        iVar5 = 1;
      ...
      if (lVar17 < 5) goto LAB_140a81df0;
    }
    else {
      uVar10 = (uint)uVar12;
      if (uVar10 < 7) {
LAB_140a81637:
        ...
        if (((longlong)(uVar8 - (longlong)param_1) < (longlong)uVar12) &&
           ((longlong)-(uVar8 - (longlong)param_1) < (longlong)uVar12)) goto LAB_140a81637;
        if (uVar10 < 0x10) {
LAB_140a81fe9:
          uVar6 = 0;
        }
          ...
          iVar5 = (int)uVar12;
          if (uVar10 < iVar5 + 0x10U) goto LAB_140a81fe9;
          uVar6 = 0;
      ...
      lVar19 = (longlong)(int)uVar11;
      if (lVar17 < 5) goto LAB_140a81a1b;
      if ((param_6 & 0x40) == 0) {
        if (-1 < (int)(param_5 - 1)) {
          iVar5 = 1;
          lVar20 = 0;
...
LAB_140a81ff0:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a81ff0;
...
LAB_140a81df0:
        uVar4 = -param_5 + 4;
        if ((int)uVar4 < 1) goto LAB_140a81f82;
        iVar5 = (int)lVar19;
        if (6 < (int)uVar4) {
          uVar7 = param_2 + lVar19;
          puVar2 = param_1 + lVar17;
...
LAB_140a82034:
              ...
              if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a82034;
              uVar13 = 0;
              uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
              if (uVar8 != 0) {
                do {
...
LAB_140a8202d:
          ...
          if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a8202d;
          uVar13 = 0;
          uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
          if (uVar8 != 0) {
            do {
...
LAB_140a814e6:
          ...
          if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a814e6;
          uVar6 = 0;
          uVar8 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar12 & 0xf));
          if (uVar12 != 0) {
            do {
...
LAB_140a81277:
      ...
      uVar12 = param_2 + lVar19;
      if (((longlong)(uVar12 - (longlong)param_1) < (longlong)uVar7) &&
         ((longlong)-(uVar12 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a81277;
      if (uVar4 < 0x10) {
LAB_140a814ed:
        uVar8 = 0;
      }
        ...
        iVar5 = (int)uVar7;
        if (uVar4 < iVar5 + 0x10U) goto LAB_140a814ed;
        uVar8 = 0;
    ...
    uVar11 = uVar10;
    lVar19 = (longlong)(int)uVar11;
    if (lVar17 < 5) goto LAB_140a81326;
    uVar11 = uVar11 + 4;
    *(undefined1 *)(lVar19 + param_2) = param_1[lVar17 + -4];
    uVar4 = 4 - param_5;
    *(undefined1 *)(lVar19 + 1 + param_2) = param_1[lVar17 + -3];
    ...
    *(undefined1 *)(lVar19 + 3 + param_2) = param_1[lVar17 + -1];
    lVar19 = (longlong)(int)uVar11;
    if ((int)uVar4 < 1) goto LAB_140a814a8;
  }
  iVar5 = (int)lVar19;
  if ((int)uVar4 < 7) {
LAB_140a81437:
    ...
    if (((longlong)(uVar7 - (longlong)puVar2) < (longlong)uVar12) &&
       ((longlong)-(uVar7 - (longlong)puVar2) < (longlong)uVar12)) goto LAB_140a81437;
    if ((longlong)uVar12 < 0x10) {
LAB_140a814f4:
      uVar6 = 0;
    }
      ...
      if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a814f4;
      uVar13 = 0;
      uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
      if (uVar8 != 0) {
        do {
