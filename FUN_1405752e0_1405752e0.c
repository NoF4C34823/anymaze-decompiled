...
void FUN_1405752e0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6 + -1) {
    ...
    do {
      ...
      if (uVar30 == 0) {
        ...
        uVar34 = FUN_140576200(pauVar33);
        param_1 = (undefined1 (*) [32])(*pauVar33 + param_2 * 2);
        uVar35 = FUN_140576200(param_1,iVar24);
        uVar36 = FUN_140576200(*pauVar33 + param_2 * 4,iVar24);
        iVar24 = (int)uVar26 * 2 + -0x1c;
        uVar37 = FUN_140576200(pauVar33 + 1);
        uVar38 = FUN_140576200(param_1 + 1,iVar24);
        auVar39._0_8_ = FUN_140576200((longlong)(*pauVar33 + param_2 * 4) + 0x20,iVar24);
...
LAB_1405754e8:
          if (3 < (longlong)uVar26) {
            *(longlong *)*pauStack_70 = auVar43._0_8_;
            ...
            uVar26 = uVar26 - 4;
            if (uVar26 == 0) goto LAB_14057554e;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar43;
          ...
          uVar26 = uVar26 - 8;
          if (uVar26 != 0) goto LAB_1405754e8;
        }
LAB_14057554e:
      ...
      if (lVar25 != 0) {
        auVar44 = vpminuw_avx2(*pauVar33,*(undefined1 (*) [32])(*pauVar33 + param_2 * 2));
        lVar23 = 0;
        auVar44 = vpminuw_avx2(auVar44,*(undefined1 (*) [32])(*pauVar33 + param_2 * 4));
        if (0 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            auVar5 = vpminuw_avx2(pauVar33[1],*(undefined1 (*) [32])(pauVar33[1] + param_2 * 2));
            auVar6 = vpminuw_avx2(auVar5,*(undefined1 (*) [32])(pauVar33[1] + param_2 * 4));
            pauVar33 = pauVar33 + 1;
            auVar7 = vperm2i128_avx2(auVar44,auVar6,0x21);
            auVar5 = vpalignr_avx2(auVar7,auVar44,2);
            auVar7 = vpalignr_avx2(auVar7,auVar44,4);
            auVar44 = vpminuw_avx2(auVar5,auVar44);
            auVar44 = vpminuw_avx2(auVar7,auVar44);
            *pauVar28 = auVar44;
            pauVar28 = pauVar28 + 1;
            auVar44 = auVar6;
          } while (lVar23 < lVar25);
      ...
      if (uVar30 != 0) {
        ...
        uVar34 = FUN_140576200(pauVar33);
        uVar35 = FUN_140576200(*pauVar33 + param_2 * 2,iVar24);
        uVar36 = FUN_140576200(*pauVar33 + param_2 * 4,iVar24);
        iVar24 = (int)uVar30 * 2 + -0x1c;
        uVar37 = FUN_140576200(pauVar33 + 1);
        uVar38 = FUN_140576200((longlong)(*pauVar33 + param_2 * 2) + 0x20,iVar24);
        auVar40._0_8_ = FUN_140576200((longlong)(*pauVar33 + param_2 * 4) + 0x20,iVar24);
        ...
        if (7 < uVar30) {
          *(undefined1 (*) [16])*pauVar28 = auVar43;
          ...
          uVar30 = uVar30 - 8;
          if (uVar30 == 0) goto LAB_14057577e;
        }
  ...
  if (lVar29 < param_6) {
    do {
      ...
      if (uVar30 == 0) {
        ...
        uVar34 = FUN_140576200(param_1);
        pauVar33 = (undefined1 (*) [32])(*param_1 + param_2 * 2);
        uVar35 = FUN_140576200(pauVar33,iVar24);
        puVar2 = *param_1 + param_2 * 4;
        uVar36 = FUN_140576200(puVar2,iVar24);
        uVar26 = uVar27 * 2 - 0x1c;
        uVar37 = FUN_140576200(param_1 + 1);
        auVar41._0_8_ = FUN_140576200(pauVar33 + 1,uVar26 & 0xffffffff);
...
LAB_140575ef3:
          if (3 < (longlong)uVar27) {
            *(longlong *)*pauStack_68 = auVar43._0_8_;
            ...
            auVar43 = vpsrldq_avx(auVar43,8);
            uVar27 = uVar27 - 4;
            if (uVar27 == 0) goto LAB_140575f59;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar43;
          ...
          uVar27 = uVar27 - 8;
          if (uVar27 != 0) goto LAB_140575ef3;
        }
LAB_140575f59:
      ...
      if (lVar25 != 0) {
        ...
        auVar44 = vpminuw_avx2(*param_1,*pauVar31);
        pauVar32 = (undefined1 (*) [32])(*param_1 + param_2 * 4);
        auVar44 = vpminuw_avx2(auVar44,*pauVar32);
        lVar23 = 0;
        auVar5 = auVar44;
        if (1 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            auVar44 = vpminuw_avx2(param_1[1],*(undefined1 (*) [32])(param_1[1] + param_2 * 2));
            auVar44 = vpminuw_avx2(auVar44,*(undefined1 (*) [32])(param_1[1] + param_2 * 4));
            param_1 = param_1 + 1;
            auVar6 = vperm2i128_avx2(auVar5,auVar44,0x21);
            auVar7 = vpalignr_avx2(auVar6,auVar5,2);
            auVar6 = vpalignr_avx2(auVar6,auVar5,4);
            auVar5 = vpminuw_avx2(auVar7,auVar5);
            auVar5 = vpminuw_avx2(auVar6,auVar5);
            *pauVar28 = auVar5;
            pauVar28 = pauVar28 + 1;
            auVar5 = auVar44;
        ...
        pauVar1 = param_1 + 1;
        param_1 = param_1 + 1;
        auVar5 = vpminuw_avx2(ZEXT432(*(uint *)*pauVar1),ZEXT432(*(uint *)pauVar31[1]));
        auVar5 = vpminuw_avx2(auVar5,ZEXT432(*(uint *)pauVar32[1]));
      ...
      if (uVar30 != 0) {
        iVar24 = (int)uVar30 * 2 + 4;
        uVar34 = FUN_140576200(param_1);
        uVar35 = FUN_140576200(*param_1 + param_2 * 2,iVar24);
        uVar36 = FUN_140576200(*param_1 + param_2 * 4,iVar24);
        iVar24 = (int)uVar30 * 2 + -0x1c;
        uVar37 = FUN_140576200(param_1 + 1);
        uVar38 = FUN_140576200((longlong)(*param_1 + param_2 * 2) + 0x20,iVar24);
        auVar42._0_8_ = FUN_140576200((longlong)(*param_1 + param_2 * 4) + 0x20,iVar24);
        ...
        if (7 < uVar30) {
          *(undefined1 (*) [16])*pauVar28 = auVar43;
          ...
          pauVar28 = (undefined1 (*) [32])(*pauVar28 + 0x10);
          uVar30 = uVar30 - 8;
          if (uVar30 == 0) goto LAB_1405761be;
        }
        if (3 < (longlong)uVar30) {
          *(longlong *)*pauVar28 = auVar43._0_8_;
          pauVar28 = (undefined1 (*) [32])(*pauVar28 + 8);
