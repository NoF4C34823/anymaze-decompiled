...
void FUN_1402fa500(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar9 - 1)) {
      while( true ) {
        FUN_1402dd1e0(param_1,lVar15,uVar2,uVar10,4);
        uVar9 = param_6[1];
        lVar11 = lVar11 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_1402dd1e0(param_1,lVar15,uVar2,*param_6,4);
        thunk_FUN_142d20530(param_9,uVar18,param_3,uVar2,param_6[1]);
        lVar11 = lVar11 + 1;
        lVar12 = lVar12 + 1;
        param_1 = param_1 + param_2 * 4;
                  ...
                  if (uVar10 >> 1 != 0) {
                    ...
                    do {
                      ...
                      if ((*(char *)(param_7 + lVar16 + uVar6 * 2) != '\0') &&
                         (fVar3 = *(float *)(lVar4 + lVar8), fVar20 <= fVar3)) {
                        fVar20 = fVar3;
                      }
                      if ((*(char *)(param_7 + lVar16 + 1 + uVar6 * 2) != '\0') &&
                         (fVar3 = *(float *)(lVar4 + 0x10 + lVar8), fVar20 <= fVar3)) {
                        fVar20 = fVar3;
                      }
                      uVar7 = uVar6 + 1;
                      lVar4 = lVar4 + 0x20;
