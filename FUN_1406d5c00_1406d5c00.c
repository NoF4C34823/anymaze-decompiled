...
ulonglong *
FUN_1406d5c00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,ulonglong *param_5
...

{
  ...
  if (iVar27 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcStack_a0 = (code *)(&PTR_FUN_14308bb00)[param_6];
            ...
            if (lStack_a8 < (longlong)(uStack_50 + uVar25)) {
              ...
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar7 == 6) {
                      if (uStack_b0 == 0) goto LAB_1406d720d;
                    }
                    else {
                      if (uVar7 != 1) goto LAB_1406d7186;
LAB_1406d72cf:
                      lVar23 = 0;
                      if (uStack_b0 != 0) {
                        lVar23 = lVar10;
...
LAB_1406d71f4:
                  ...
                  if ((lVar10 < (longlong)uVar25) || (param_7 == 0xf0)) goto LAB_1406d71f4;
                  if (uVar7 != 6) {
                    if (uVar7 == 1) {
                      if (lVar10 < 0) goto LAB_1406d72cf;
                      if (uStack_90 == 0) {
                        lVar23 = uVar25 - 1;
                      }
                    }
...
LAB_1406d7186:
                      if (uVar7 == 3) {
                        if ((longlong)uVar25 < 2) {
                          ...
                          if (lVar10 < 0) goto LAB_1406d72e2;
...
LAB_1406d72e2:
                  ...
                  if (uStack_90 != 0) goto LAB_1406d71f4;
LAB_1406d720d:
                  bVar12 = (byte)*puVar28;
...
LAB_1406d72a3:
                      ...
                      if ((longlong)uStack_b8 < (longlong)(uVar17 + 0x10)) goto LAB_1406d72a3;
                      uVar22 = 0;
...
LAB_1406d60f2:
            ...
            uVar17 = uVar20 & 0xf;
            if (uVar17 != 0) {
              if ((uVar20 & 3) != 0) goto LAB_1406d60f2;
              uVar17 = 0x10 - uVar17 >> 2;
            }
            if ((longlong)uVar25 < (longlong)(uVar17 + 4)) goto LAB_1406d60f2;
            uVar14 = 0;
...
LAB_1406d5f66:
            ...
            if (puVar8 != (ulonglong *)0x0) {
              if ((uVar25 & 3) != 0) goto LAB_1406d5f66;
              puVar8 = (ulonglong *)(0x10U - (longlong)puVar8 >> 2);
            }
            if ((longlong)puVar16 < (longlong)puVar8 + 4) goto LAB_1406d5f66;
