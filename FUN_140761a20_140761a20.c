...
void FUN_140761a20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014076263b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c100)[lVar15])(param_1,param_4,*param_5,param_9);
    return;
  }
  if (uVar12 == 6) {
    uVar21 = *param_8;
          ...
          if (uVar12 != 6) {
            if (uVar12 == 1) {
              ...
              if (lVar10 < 2) {
                ...
                if (lVar19 < 0) goto LAB_1407625c0;
                while (uVar8 == 0) {
                  for (lVar7 = (lVar10 + -1) * 2 - lVar7; lVar7 < 0; lVar7 = -lVar7) {
LAB_1407625c0:
                    if (uVar17 != 0) goto LAB_1407624af;
                  }
...
LAB_1407624af:
        ...
        *(undefined4 *)(param_11 + lVar13 * 4) = uVar20;
        lVar13 = lVar13 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140762526. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c100)[lVar15])(param_11 + uVar14 * 4,param_4,lVar10,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    ...
    if (0 < (longlong)uVar16) {
      if (6 < (longlong)uVar16) {
        ...
        if ((lVar19 <= (longlong)(uVar11 - param_1)) || (lVar19 <= (longlong)-(uVar11 - param_1))) {
          ...
          if (uVar6 == 0) {
LAB_140761b28:
            if ((longlong)uVar16 < (longlong)(uVar6 + 4)) goto LAB_140762529;
...
LAB_140761c78:
    if (uVar12 == 1) {
      if ((longlong)uVar14 < 1) goto LAB_140761e8f;
...
LAB_14076258b:
        ...
        uVar6 = param_11 & 0xf;
        if (uVar6 != 0) {
          if ((param_11 & 3) != 0) goto LAB_14076258b;
          uVar6 = 0x10 - uVar6 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar6 + 8)) goto LAB_14076258b;
        uVar9 = 0;
...
LAB_140762537:
        ...
        uVar6 = param_11 & 0xf;
        if (uVar6 != 0) {
          if ((param_11 & 3) != 0) goto LAB_140762537;
          uVar6 = 0x10 - uVar6 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar6 + 8)) goto LAB_140762537;
        uVar9 = 0;
        uVar18 = uVar14 - (uVar14 - uVar6 & 7);
        if (uVar6 != 0) {
          do {
...
LAB_140761e8f:
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308c100)[lVar15];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140762589. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (0 < (longlong)uVar16) {
    if (6 < (longlong)uVar16) {
      ...
      if ((lVar15 <= (longlong)(param_11 - lVar10)) || (lVar15 <= (longlong)-(param_11 - lVar10))) {
        ...
        if (uVar11 == 0) {
LAB_140761f86:
          if ((longlong)uVar16 < (longlong)(uVar11 + 4)) goto LAB_14076253f;
          uVar18 = 0;
...
LAB_1407620c1:
  if (uVar12 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_140762377;
...
LAB_14076254e:
          ...
          uVar11 = uVar16 & 0xf;
          if (uVar11 != 0) {
            if ((uVar16 & 3) != 0) goto LAB_14076254e;
            uVar11 = 0x10 - uVar11 >> 2;
          }
          if ((longlong)uVar14 < (longlong)(uVar11 + 8)) goto LAB_14076254e;
          uVar6 = 0;
  ...
  if ((uVar12 != 6) || ((longlong)uVar14 < 1)) goto LAB_140762377;
  if ((longlong)uVar14 < 8) {
LAB_140762546:
    uVar11 = 0;
  }
    ...
    if (uVar16 != 0) {
      if ((lVar15 - 4U & 3) != 0) goto LAB_140762546;
      uVar16 = 0x10 - uVar16 >> 2;
    }
    if ((longlong)uVar14 < (longlong)(uVar16 + 8)) goto LAB_140762546;
    uVar6 = 0;
...
LAB_140762377:
                    /* WARNING: Could not recover jumptable at 0x0001407623ae. Too many branches */
                    /* WARNING: Treating indirect jump as call */
