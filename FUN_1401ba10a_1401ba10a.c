...
void FUN_1401ba10a(longlong param_1,undefined8 param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    auVar9 = pmovzxbw(unaff_XMM6,*(undefined8 *)((in_RAX - 1) + param_1));
    auVar6 = pmovzxbw(in_XMM4,*(undefined8 *)(in_RAX + 1 + param_1));
    auVar11 = pmovzxbw(unaff_XMM7,*(undefined8 *)(in_RAX + 7 + param_1));
    ...
    auVar7 = pmovzxbw(in_XMM5,*(undefined8 *)(in_RAX + 9 + param_1));
  ...
  if (unaff_RBP + 1 <= param_3) {
    ...
    if ((longlong)param_3 < 4) {
      ...
      do {
        ...
        pfVar1 = (float *)(param_4 + unaff_RBP * 4 + uVar5 * 4);
    ...
    if (uVar3 < param_3) {
      param_1 = param_1 + unaff_RBP;
      do {
        *(float *)(param_4 + unaff_RBP * 4 + uVar3 * 4) =
