...
void FUN_1408a8def(longlong param_1,longlong param_2,ulonglong param_3)

{
  ...
  if (in_RAX < param_3) {
    ...
    do {
      auVar1._0_4_ = (float)(int)*(short *)(param_1 + in_RAX * 2);
      auVar1._4_8_ = SUB128(ZEXT812(0),4);
      auVar1._12_4_ = 0;
      auVar2._0_4_ = (float)((int)*(short *)(param_1 + -4 + in_RAX * 2) +
                            (int)*(short *)(param_1 + 4 + in_RAX * 2));
      auVar2._4_8_ = SUB128(ZEXT812(0),4);
      auVar2._12_4_ = 0;
      auVar2 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM5_Da *
                                             (float)((int)*(short *)(param_1 + -2 + in_RAX * 2) +
                                                    (int)*(short *)(param_1 + 2 + in_RAX * 2)))),
                               auVar2,in_XMM4);
