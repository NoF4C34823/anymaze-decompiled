...
void FUN_140a3c0a0(longlong param_1,ulonglong param_2,int param_3,undefined8 param_4,
...

{
  ...
  auVar27 = _DAT_14308ed80;
  uVar33 = (ulonglong)(int)((ulonglong)param_4 >> 0x20);
  iVar28 = (int)param_4;
  uVar30 = 0;
  if (0 < (longlong)uVar33) {
    ...
    do {
      ...
      iVar37 = 0;
      lVar34 = *(longlong *)(param_1 + 8 + uVar30 * 8);
      lVar36 = *(longlong *)(param_1 + 0x10 + uVar30 * 8);
      lVar35 = *(longlong *)(param_1 + 0x18 + uVar30 * 8);
      lVar31 = *(longlong *)(param_1 + 0x20 + uVar30 * 8);
      if ((param_2 & 0xf) == 0) {
        if (param_6 == 0) {
          uVar38 = 0;
          lVar45 = 0;
          ...
          if (-1 < iVar29) {
            do {
              ...
              psVar2 = (short *)(lVar42 + lVar34);
              psVar8 = (short *)(lVar42 + 0x10 + lVar34);
              psVar3 = (short *)(lVar42 + lVar36);
              psVar9 = (short *)(lVar42 + 0x10 + lVar36);
              psVar4 = (short *)(lVar42 + lVar35);
              psVar10 = (short *)(lVar42 + 0x10 + lVar35);
              psVar5 = (short *)(lVar42 + lVar31);
              ...
              psVar1 = (short *)(lVar42 + 0x10 + lVar31);
...
LAB_140a3c303:
      ...
      if (iVar37 < iVar28) {
        ...
        if (uVar43 != 0) {
          ...
          do {
            iVar37 = ((int)*(short *)(lVar39 + uVar38 * 8) + (int)*(short *)(lVar34 + uVar38 * 8) +
                      (int)*(short *)(lVar36 + uVar38 * 8) +
                     (int)*(short *)(lVar35 + uVar38 * 8) + (int)*(short *)(lVar31 + uVar38 * 8)) *
                     0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            ...
            *(undefined1 *)(lVar45 + uVar38 * 4) = uVar32;
            iVar37 = ((int)*(short *)(lVar39 + 2 + uVar38 * 8) +
                     ...
                     (int)*(short *)(lVar35 + 2 + uVar38 * 8) +
                     (int)*(short *)(lVar31 + 2 + uVar38 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar32 = (undefined1)iVar37;
            ...
            *(undefined1 *)(lVar45 + 1 + uVar38 * 4) = uVar32;
            iVar37 = ((int)*(short *)(lVar39 + 4 + uVar38 * 8) +
                     ...
                     (int)*(short *)(lVar35 + 4 + uVar38 * 8) +
                     (int)*(short *)(lVar31 + 4 + uVar38 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar32 = (undefined1)iVar37;
            ...
            *(undefined1 *)(lVar45 + 2 + uVar38 * 4) = uVar32;
            iVar37 = ((int)*(short *)(lVar39 + 6 + uVar38 * 8) +
                     ...
                     (int)*(short *)(lVar35 + 6 + uVar38 * 8) +
                     (int)*(short *)(lVar31 + 6 + uVar38 * 8)) * 0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
            uVar32 = (undefined1)iVar37;
        ...
        if (uVar38 < (ulonglong)(lVar41 - lVar42)) {
          do {
            iVar37 = ((int)*(short *)(lVar39 + uVar38 * 2) + (int)*(short *)(lVar34 + uVar38 * 2) +
                      (int)*(short *)(lVar36 + uVar38 * 2) +
                     (int)*(short *)(lVar35 + uVar38 * 2) + (int)*(short *)(lVar31 + uVar38 * 2)) *
                     0xa3d >> 0x10;
            if (iVar37 < 1) {
              iVar37 = 0;
            }
