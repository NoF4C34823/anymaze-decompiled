...
/* WARNING: Removing unreachable block (ram,0x0001406639d3) */

void FUN_140662cc0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b7a0 + lVar18 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar11 < 2) {
                ...
                if (lVar16 < 0) goto LAB_140663da0;
                while (uVar14 == 0) {
                  for (lVar5 = (lVar11 + -1) * 2 - lVar5; lVar5 < 0; lVar5 = -lVar5) {
LAB_140663da0:
                    if (uVar7 != 0) goto LAB_140663c6c;
                  }
...
LAB_140663c6c:
    ...
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b7a0 + lVar18 * 8))(param_11 + uVar21 * 0xc,param_4,lVar11,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_198 = uVar21 * 3;
      ...
      if (uVar15 != 0 && SCARRY8(uVar10,-3) == (longlong)uVar15 < 0) {
        if (6 < (longlong)uVar15) {
          ...
          if ((lVar16 <= (longlong)(uStack_1a0 - param_1)) ||
            ...
            if (uVar6 == 0) {
LAB_140662e23:
              if ((longlong)uVar15 < (longlong)(uVar6 + 4)) goto LAB_140663d3c;
              uVar8 = 0;
...
LAB_140663574:
      uStack_1c0 = uVar10;
      pcStack_1b8 = *(code **)(&DAT_14308b7a0 + lVar18 * 8);
      iStack_1d8 = param_10;
      uStack_190 = param_7;
