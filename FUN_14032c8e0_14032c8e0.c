...
void FUN_14032c8e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar14 != 0 && 0 < (longlong)uVar24) {
      do {
        FUN_14031cfa0(lVar17,lVar23,uVar6,(longlong)(int)param_6,3);
        lVar25 = lVar25 + 1;
        ...
        if (0 < (longlong)uVar6) {
          do {
            ...
            if (0 < (longlong)uVar24) {
              ...
              if (uVar12 <= uVar24) {
                    /* WARNING: Could not recover jumptable at 0x00014032ccec. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_14032ccee +
                          (byte)(&DAT_143089c78)[(uint)(param_6._4_4_ - (int)uVar12)]))();
                return;
              }
            }
...
LAB_14032d3b1:
                    ...
                    if (lVar8 < (longlong)(uStack_b8 + 0x10)) goto LAB_14032d3b1;
                    uVar20 = 0;
                    uVar18 = lVar8 - (lVar8 - uStack_b8 & 0xf);
                    if (uStack_b8 != 0) {
                      do {
                        if ((*(char *)(uVar20 + uVar12) != '\0') &&
                           (bVar29 = *(byte *)(lVar15 + uVar20 * 3 + lVar25), bVar29 < bVar30)) {
                          bVar30 = bVar29;
                        }
                        uVar20 = uVar20 + 1;
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar27 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar4 = auVar32[0];
                        auVar28[0] = (bVar4 < bVar30) * bVar4 | (bVar4 >= bVar30) * bVar30;
                        bVar30 = auVar32[1];
                        ...
                        bVar30 = auVar32[9];
                        auVar28[9] = (bVar30 < bVar9) * bVar30 | (bVar30 >= bVar9) * bVar9;
                        bVar30 = auVar32[10];
                        auVar28[10] = (bVar30 < bVar13) * bVar30 | (bVar30 >= bVar13) * bVar13;
                        bVar30 = auVar32[0xb];
                        auVar28[0xb] = (bVar30 < bVar2) * bVar30 | (bVar30 >= bVar2) * bVar2;
                        bVar30 = auVar32[0xc];
                        auVar28[0xc] = (bVar30 < bVar3) * bVar30 | (bVar30 >= bVar3) * bVar3;
                        bVar30 = auVar32[0xd];
                        auVar28[0xd] = (bVar30 < bVar7) * bVar30 | (bVar30 >= bVar7) * bVar7;
                        bVar30 = auVar32[0xe];
                        auVar28[0xe] = (bVar30 < bVar10) * bVar30 | (bVar30 >= bVar10) * bVar10;
                        bVar30 = auVar32[0xf];
                  ...
                  for (; uVar18 < (ulonglong)(longlong)(int)param_6; uVar18 = uVar18 + 1) {
                    if ((*(char *)(uVar18 + uVar12) != '\0') &&
                       (bVar29 = *(byte *)(lVar15 + uVar18 * 3 + lVar25), bVar29 < bVar30)) {
                      bVar30 = bVar29;
                    }
                  }
                }
