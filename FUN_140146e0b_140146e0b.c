...
void FUN_140146e0b(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_1402dd1e0(unaff_RSI,unaff_RBX);
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_1402dd1e0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,lStack0000000000000060,1);
      thunk_FUN_142d20530(in_stack_00000100,param_1,lVar3,(longlong)iStack00000000000000e0,lVar1);
      unaff_R12 = unaff_R12 + 1;
      unaff_RBX = unaff_RBX + param_1 * 4;
      if (lVar1 <= unaff_R12) {
        unaff_RBX = in_stack_00000100;
      }
      unaff_RSI = unaff_RSI + lStack0000000000000068 * 4;
      if (lVar1 <= unaff_R12) {
        unaff_R12 = 0;
      }
      lVar2 = lVar2 + 1;
