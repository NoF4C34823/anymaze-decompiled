...
void FUN_1400b50a0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar63 = param_4 & 0x1f;
      if (uVar63 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1400b5867;
...
LAB_1400b5867:
  ...
  if (7 < (longlong)param_5) {
    uVar64 = param_4 & 0x1f;
    if (uVar64 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1400b5942;
