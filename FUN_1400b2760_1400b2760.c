...
void FUN_1400b2760(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1400b3113:
      uVar49 = 0;
      if (param_3 == 0) goto LAB_1400b29a7;
      uVar47 = 0;
      uVar50 = param_3;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400b3113;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1400b3113;
      ...
      if (param_3 < uVar49 + 1) goto LAB_1400b29a7;
...
LAB_1400b30ed:
          uVar49 = 0;
          if (param_3 == 0) goto LAB_1400b2f12;
          uVar47 = 0;
          uVar50 = param_3;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1400b30ed;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1400b30ed;
          ...
          if (param_3 < uVar49 + 1) goto LAB_1400b2f12;
          uVar50 = param_3 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar47 = 0;
          }
...
LAB_1400b30da:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400b30da;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1400b30da;
    uVar47 = 0;
    uVar49 = param_3 - (param_3 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
