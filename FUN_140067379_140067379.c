...
void FUN_140067379(ulonglong param_1,ulonglong param_2,ulonglong param_3,float param_4)

{
  ...
  do {
    ...
    uVar43 = *(ulonglong *)((longlong)puVar42 + 6);
    auVar6._8_4_ = 0;
    auVar6._0_8_ = uVar44;
    ...
    *pfVar1 = (float)(((uint)uVar44 & 0xffff) + ((uint)uVar43 & 0xffff)) * param_4 +
    ...
    uVar43 = *(ulonglong *)((longlong)puVar42 + 0xe);
    auVar9._8_4_ = 0;
    auVar9._0_8_ = uVar44;
  ...
  if (param_1 + 1 <= param_3) {
    ...
    uVar44 = 0;
    do {
      uVar3 = *(ulonglong *)(lVar2 + -6 + uVar44 * 2);
      uVar4 = *(ulonglong *)(lVar2 + 6 + uVar44 * 2);
      auVar12._8_4_ = 0;
      auVar12._0_8_ = uVar3;
    ...
    if (uVar43 < param_3) {
      ...
      do {
        *(float *)(in_R10 + param_1 * 4 + uVar43 * 4) =
             (float)((uint)*(ushort *)(in_R9 + -6 + uVar43 * 2) +
                    (uint)*(ushort *)(in_R9 + 6 + uVar43 * 2)) * param_4 +
