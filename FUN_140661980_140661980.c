...
void FUN_140661980(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140662247:
      ...
      uVar42 = uVar41 & 0xf;
      if (uVar42 != 0) {
        if ((uVar41 & 3) != 0) goto LAB_140662247;
        uVar42 = 0x10 - uVar42 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar42 + 4)) goto LAB_140662247;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar41 = param_4 & 0xf;
      if (uVar41 != 0) {
        if ((param_4 & 1) != 0) goto LAB_140662255;
...
LAB_1406621c1:
  ...
  if (7 < (longlong)param_5) {
    uVar41 = param_4 & 0xf;
    if (uVar41 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14066224e;
      uVar41 = 0x10 - uVar41 >> 1;
    }
    if ((longlong)(uVar41 + 8) <= (longlong)param_5) {
      lVar43 = param_2 * 7 + param_1;
