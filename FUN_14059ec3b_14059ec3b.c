...
ulonglong FUN_14059ec3b(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
                       ulonglong param_4)

{
  ...
  do {
    ...
    if (uVar5 != 0) {
      ...
      auVar17 = vminps_avx512f(*pauVar3,*pauVar10);
      pauVar4 = (undefined1 (*) [64])(*pauVar3 + in_R10 * 8);
      auVar18 = vminps_avx512f(auVar17,*pauVar4);
      lVar6 = 0;
      auVar17 = auVar18;
      if (1 < (longlong)uVar5) {
        do {
          lVar6 = lVar6 + 1;
          auVar18 = vminps_avx512f(pauVar3[1],
                                   *(undefined1 (*) [64])(pauVar3[1] + lStack0000000000000058));
          auVar18 = vminps_avx512f(auVar18,*(undefined1 (*) [64])
                                            (pauVar3[1] + lStack0000000000000050));
          pauVar3 = pauVar3 + 1;
          auVar19 = valignd_avx512f(auVar18,auVar17,3);
          auVar20 = valignd_avx512f(auVar18,auVar17,6);
          auVar17 = vminps_avx512f(auVar19,auVar17);
          auVar17 = vminps_avx512f(auVar20,auVar17);
          *pauVar8 = auVar17;
          pauVar8 = pauVar8 + 1;
          auVar17 = auVar18;
      ...
      pauVar1 = pauVar3 + 1;
      pauVar3 = pauVar3 + 1;
      auVar17 = vminps_avx512f(ZEXT2464(SUB3224(*(undefined1 (*) [32])*pauVar1,0)),
                               ZEXT2464(SUB3224(*(undefined1 (*) [32])pauVar10[1],0)));
      auVar17 = vminps_avx512f(auVar17,ZEXT2464(SUB3224(*(undefined1 (*) [32])pauVar4[1],0)));
      auVar19 = valignd_avx512f(auVar17,auVar18,3);
      auVar17 = valignd_avx512f(auVar17,auVar18,6);
      auVar18 = vminps_avx512f(auVar19,auVar18);
      auVar17 = vminps_avx512f(auVar17,auVar18);
      *pauVar8 = auVar17;
      pauVar8 = pauVar8 + 1;
    }
    ...
    if (lVar6 != 0) {
      ...
      auVar14 = vminps_avx(*(undefined1 (*) [32])*pauVar3,*pauVar7);
      pauVar11 = (undefined1 (*) [32])(*pauVar3 + in_R10 * 8);
      auVar14 = vminps_avx(auVar14,*pauVar11);
      uVar5 = 0;
      auVar16 = auVar14;
      if (1 < lVar6) {
        do {
          uVar5 = uVar5 + 1;
          auVar14 = vminps_avx(*(undefined1 (*) [32])(*pauVar3 + 0x20),
                               *(undefined1 (*) [32])(*pauVar3 + lStack0000000000000058 + 0x20));
          auVar14 = vminps_avx512vl(auVar14,*(undefined1 (*) [32])
          ...
          auVar16 = vminps_avx512vl(auVar15,auVar16);
      ...
      auVar16 = vminps_avx512vl(auVar16,auVar15);
      ...
      auVar14 = vminps_avx512vl(auVar16,auVar14);
      auVar14 = vminps_avx512vl(in_YMM27,auVar14);
      *(undefined1 (*) [32])*pauVar8 = auVar14;
    }
    if ((uVar9 & 7) != 0) {
      uVar5 = FUN_14059ef80(pauVar3);
    }
    in_RAX = in_RAX + 1;
