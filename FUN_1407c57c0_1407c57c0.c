...
void FUN_1407c57c0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar43 & 0xf;
      if (uVar44 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_1407c5c85;
...
LAB_1407c5c85:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar37 = param_4 & 0xf;
      if (uVar37 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1407c6078;
...
LAB_1407c5fe0:
  ...
  if (7 < (longlong)param_5) {
    uVar37 = param_4 & 0xf;
    if (uVar37 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1407c6071;
      uVar37 = 0x10 - uVar37 >> 1;
    }
    if ((longlong)(uVar37 + 8) <= (longlong)param_5) {
      uVar44 = 0;
