...
void FUN_140264240(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar26 - 1)) {
      while( true ) {
        FUN_14031cfa0(lVar27,lVar17,uVar8,uVar21,3);
        uVar26 = param_6[1];
        lVar23 = lVar23 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_14031cfa0(lVar27,lVar17,uVar8,*param_6,3);
        FUN_140328840(param_9,uVar11,param_3,uVar8,param_6[1]);
        lVar23 = lVar23 + 1;
        lVar24 = lVar24 + 1;
        lVar17 = lVar17 + uVar11;
...
LAB_140264973:
                    ...
                    if ((longlong)uVar21 < (longlong)(uStack_60 + 0x10)) goto LAB_140264973;
                    uVar14 = 0;
                    uVar19 = uVar21 - (uVar21 - uStack_60 & 0xf);
                    if (uStack_60 != 0) {
                      do {
                        if ((*(char *)(uVar14 + uVar12) != '\0') &&
                           (bVar30 = *(byte *)(lVar1 + uVar14 * 3 + lVar24), bVar30 < bVar31)) {
                          bVar31 = bVar30;
                        }
                        uVar14 = uVar14 + 1;
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar28 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar6 = auVar33[0];
                        auVar29[0] = (bVar6 < bVar31) * bVar6 | (bVar6 >= bVar31) * bVar31;
                        bVar31 = auVar33[1];
                        ...
                        bVar31 = auVar33[9];
                        auVar29[9] = (bVar31 < bVar10) * bVar31 | (bVar31 >= bVar10) * bVar10;
                        bVar31 = auVar33[10];
                        auVar29[10] = (bVar31 < bVar16) * bVar31 | (bVar31 >= bVar16) * bVar16;
                        bVar31 = auVar33[0xb];
                        auVar29[0xb] = (bVar31 < bVar4) * bVar31 | (bVar31 >= bVar4) * bVar4;
                        bVar31 = auVar33[0xc];
                        auVar29[0xc] = (bVar31 < bVar5) * bVar31 | (bVar31 >= bVar5) * bVar5;
                        bVar31 = auVar33[0xd];
                        auVar29[0xd] = (bVar31 < bVar9) * bVar31 | (bVar31 >= bVar9) * bVar9;
                        bVar31 = auVar33[0xe];
                        auVar29[0xe] = (bVar31 < bVar13) * bVar31 | (bVar31 >= bVar13) * bVar13;
                        bVar31 = auVar33[0xf];
                  ...
                  for (; uVar19 < uVar21; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar12) != '\0') &&
                       (bVar30 = *(byte *)(lVar1 + uVar19 * 3 + lVar24), bVar30 < bVar31)) {
                      bVar31 = bVar30;
                    }
                  }
                }
