...
void FUN_1406b4c00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < iVar18) {
    ...
    uVar16 = param_7 & 0x20;
    lVar15 = lVar10;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_1406b5021;
    uVar9 = 0;
LAB_1406b4ce0:
    uVar12 = uVar9;
    if (((longlong)param_5[1] <= (longlong)uVar9) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar16 == 0) goto LAB_1406b4e37;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_1406b4d1a;
        if (uVar16 == 0) {
          uVar12 = param_5[1] - 1;
        }
      }
...
LAB_1406b4d9b:
    do {
      FUN_1406b5880(param_1,param_2,uVar12);
      while( true ) {
        while( true ) {
          iVar8 = (int)uVar9;
          uVar9 = uVar9 + 1;
          ...
          if (uVar19 <= uVar9) {
            if (uVar5 != 0) {
              ...
              lVar14 = -uVar19;
              do {
                FUN_1406b5880(param_1,param_2,lVar14,param_3);
                lVar11 = lVar11 + 1;
                lVar14 = lVar14 + 1;
...
LAB_1406b5021:
          (**(code **)(&DAT_14308b9e0 + (longlong)param_6 * 8))
                    (param_2 * uVar9 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar9) goto LAB_1406b4ce0;
        uVar12 = uVar9;
        if (param_7 == 0xf0) goto LAB_1406b4d9b;
        if ((param_7 & 0xf) != 6) break;
        if (uVar5 != 0) goto LAB_1406b4d9b;
LAB_1406b4e37:
        uVar12 = *param_5;
...
LAB_1406b57e4:
            ...
            uVar6 = uVar7 & 0xf;
            if (uVar6 != 0) {
              if ((uVar7 & 3) != 0) goto LAB_1406b57e4;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar6 + 8)) goto LAB_1406b57e4;
            uVar13 = 0;
...
LAB_1406b5710:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1406b5710;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 8)) goto LAB_1406b5710;
            uVar17 = 0;
...
LAB_1406b55b3:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1406b55b3;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1406b55b3;
            uVar17 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      if (((lVar11 < 0) || ((longlong)param_5[1] <= lVar11)) && (param_7 != 0xf0)) {
        if ((longlong)param_5[1] < 2) {
          ...
          if (lVar11 < 0) goto LAB_1406b53e0;
...
LAB_1406b53e0:
      ...
      FUN_1406b5880(param_1,param_2,lVar11,param_3);
    }
    lVar11 = 1;
    uVar9 = 0;
    if (1 < iVar18) {
...
LAB_1406b53a6:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1406b53a6;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1406b53a6;
...
LAB_1406b4d1a:
  ...
  if ((param_7 & 0xf) == 3) {
    if ((longlong)param_5[1] < 2) {
      ...
      if ((longlong)uVar9 < 0) goto LAB_1406b4fc0;
      while (uVar16 == 0) {
