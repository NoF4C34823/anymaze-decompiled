...
void FUN_140896780(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  if (iVar34 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcVar7 = (code *)(&PTR_FUN_14308cbe0)[param_6];
      lVar12 = lVar37 * 3;
      uVar16 = param_7 & 0xf;
            ...
            if (lVar19 < (longlong)(uVar49 + lVar35)) {
              ...
              do {
                ...
                if (lVar43 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar16 == 6) {
                      if (uVar23 == 0) goto LAB_1408981b5;
                    }
                    else {
                      if (uVar16 != 1) goto LAB_14089812c;
LAB_14089829e:
                      lVar30 = 0;
                      if (uVar23 != 0) {
                        lVar30 = lVar43;
...
LAB_14089819c:
                  ...
                  if ((lVar43 < lVar35) || (param_7 == 0xf0)) goto LAB_14089819c;
                  if (uVar16 != 6) {
                    if (uVar16 == 1) {
                      if (lVar43 < 0) goto LAB_14089829e;
                      if (uVar17 == 0) {
                        lVar30 = lVar35 + -1;
                      }
                    }
...
LAB_14089812c:
                      if (uVar16 == 3) {
                        if (lVar35 < 2) {
                          ...
                          if (lVar43 < 0) goto LAB_1408982c0;
                          if (lVar35 <= lVar43) {
                            while (uVar17 == 0) {
                              for (lVar30 = (lVar35 + -1) * 2 - lVar30; lVar30 < 0; lVar30 = -lVar30
                                  ) {
LAB_1408982c0:
                                if (uVar23 != 0) goto LAB_14089819c;
                              }
                  ...
                  if (uVar17 != 0) goto LAB_14089819c;
LAB_1408981b5:
                  bVar22 = *pbVar46;
                  bVar31 = pbVar46[1];
                  bVar39 = pbVar46[2];
...
LAB_140898259:
                      ...
                      if ((longlong)uVar1 < (longlong)(uVar21 + 0x10)) goto LAB_140898259;
                ...
                if (0 < lVar14) {
                  if ((longlong)uVar13 < 7) {
                    ...
                    if ((longlong)uVar13 < 0x10) {
                      ...
                      auVar55 = vpshufb_avx(auVar55,_DAT_14308cd60);
                      auVar56 = vpshufb_avx(auVar51,_DAT_14308cd70);
                      auVar52 = vpshufb_avx(auVar11,_DAT_14308cd80);
                      auVar10 = vpshufb_avx(auVar51,_DAT_14308cd90);
                      auVar51 = vpshufb_avx(auVar51,_DAT_14308cdc0);
                      auVar8 = vpunpckhbw_avx(auVar11,auVar9);
                      auVar55 = vpor_avx(auVar55,auVar56);
                      auVar11 = vpshufb_avx(auVar9,_DAT_14308cda0);
                      auVar8 = vpshufb_avx(auVar8,_DAT_14308cdb0);
...
LAB_140896c04:
            ...
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_140896c04;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_140896c04;
            uVar40 = 0;
...
LAB_140896aa5:
            ...
            uVar44 = (ulonglong)puVar32 & 0x1f;
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_140896aa5;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_140896aa5;
