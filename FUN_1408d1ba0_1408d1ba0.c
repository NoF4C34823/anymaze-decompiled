...
void FUN_1408d1ba0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)
...
LAB_1408d2037:
    ...
    if ((longlong)uVar23 < 0x1d) {
      ...
      uVar24 = param_2 & 0x1f;
      if (uVar24 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1408d2037;
        uVar24 = 0x20 - uVar24 >> 2;
      }
      if ((longlong)uVar23 < (longlong)(uVar24 + 0x10)) goto LAB_1408d2037;
      uVar21 = 0;
      uVar22 = uVar23 - (uVar23 - uVar24 & 0xf);
      if (uVar24 != 0) {
        do {
          auVar28._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -0xc + uVar21 * 2) +
                      (uint)*(ushort *)(param_1 + 0xc + uVar21 * 2));
          auVar28._4_12_ = in_ZMM2._4_12_;
          auVar28 = vfmadd231ss_fma(ZEXT416((uint)(fVar4 * (float)((uint)*(ushort *)
                                                                          (param_1 + -6 + uVar21 * 2
                                                                          ) +
                                                                  (uint)*(ushort *)
                                                                         (param_1 + 6 + uVar21 * 2))
                                                  )),auVar28,ZEXT416((uint)fVar3));
          auVar25 = vfmadd231ss_fma(ZEXT416((uint)(fVar5 * (float)*(ushort *)(param_1 + uVar21 * 2))
    ...
    do {
      ...
      auVar20 = vpmovzxwd_avx2(auVar6._0_16_);
      auVar34 = vpmovzxwd_avx2(auVar7._0_16_);
      ...
      auVar34 = vpmovzxwd_avx2(auVar8._0_16_);
      auVar20 = vpaddd_avx2(auVar20,auVar34);
  ...
  if (uVar22 + 1 <= uVar23) {
    ...
    if (uVar24 < uVar23) {
      ...
      do {
        auVar29._0_4_ =
             (float)((uint)*(ushort *)(param_1 + -0xc + uVar24 * 2) +
                    (uint)*(ushort *)(param_1 + 0xc + uVar24 * 2));
        ...
        auVar25 = vfmadd231ss_fma(ZEXT416((uint)(fVar5 * (float)*(ushort *)(param_1 + uVar24 * 2))),
                                  ZEXT416((uint)(float)((uint)*(ushort *)
                                                               (param_1 + -0x12 + uVar24 * 2) +
                                                       (uint)*(ushort *)
                                                              (param_1 + 0x12 + uVar24 * 2))),
                                  ZEXT416(uVar2));
        in_ZMM2 = ZEXT1664(auVar25);
