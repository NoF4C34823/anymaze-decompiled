...
void FUN_140706d60(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  fVar3 = *param_4;
  fVar4 = param_4[1];
  if ((longlong)uVar48 < 1) {
    return;
  }
  if (7 < (longlong)uVar48) {
    uVar47 = param_2 & 0xf;
    if (uVar47 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140706fa0;
      uVar47 = 0x10 - uVar47 >> 2;
    }
    if ((longlong)(uVar47 + 8) <= (longlong)uVar48) {
      uVar45 = 0;
      uVar46 = uVar48 - (uVar48 - uVar47 & 7);
      if (uVar47 != 0) {
        do {
          *(float *)(param_2 + uVar45 * 4) =
               (float)((uint)*(ushort *)(param_1 + -6 + uVar45 * 2) +
                      (uint)*(ushort *)(param_1 + 6 + uVar45 * 2)) * fVar3 +
      ...
      do {
        ...
        uVar5 = *(ulonglong *)((longlong)puVar44 + 6);
        auVar8._8_4_ = 0;
        auVar8._0_8_ = uVar45;
        ...
        *pfVar1 = (float)(((uint)uVar45 & 0xffff) + ((uint)uVar5 & 0xffff)) * fVar3 +
        ...
        uVar5 = *(ulonglong *)((longlong)puVar44 + 0xe);
        auVar11._8_4_ = 0;
      ...
      if (3 < (longlong)uVar48) {
        lVar2 = param_1 + uVar46 * 2;
        uVar45 = uVar48 & 0xfffffffffffffffc;
        uVar47 = 0;
        do {
          uVar5 = *(ulonglong *)(lVar2 + -6 + uVar47 * 2);
          uVar6 = *(ulonglong *)(lVar2 + 6 + uVar47 * 2);
          auVar14._8_4_ = 0;
          auVar14._0_8_ = uVar5;
