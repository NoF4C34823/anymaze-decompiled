...
void FUN_1403ea780(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar15 - 1)) {
      while( true ) {
        FUN_14036ade0(lVar27,lVar26,uVar6,uVar20,1);
        uVar15 = param_6[1];
        lVar24 = lVar24 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_14036ade0(lVar27,lVar26,uVar6,*param_6,1);
        FUN_140374ca0(param_9,uVar21,param_3,uVar6,param_6[1]);
        lVar24 = lVar24 + 1;
        lVar25 = lVar25 + 1;
        lVar26 = lVar26 + uVar21;
...
LAB_1403eae93:
                    ...
                    if ((longlong)uVar20 < (longlong)(uVar13 + 0x10)) goto LAB_1403eae93;
                    uVar19 = 0;
                    ...
                    do {
                      ...
                      bVar31 = auVar33[9];
                      auVar29[9] = (bVar4 < bVar31) * bVar31 | (bVar4 >= bVar31) * bVar4;
                      bVar31 = auVar33[10];
                      auVar29[10] = (bVar5 < bVar31) * bVar31 | (bVar5 >= bVar31) * bVar5;
                      bVar31 = auVar33[0xb];
                      auVar29[0xb] = (bVar9 < bVar31) * bVar31 | (bVar9 >= bVar31) * bVar9;
                      bVar31 = auVar33[0xc];
                      auVar29[0xc] = (bVar12 < bVar31) * bVar31 | (bVar12 >= bVar31) * bVar12;
                      bVar31 = auVar33[0xd];
                      auVar29[0xd] = (bVar11 < bVar31) * bVar31 | (bVar11 >= bVar31) * bVar11;
                      bVar31 = auVar33[0xe];
                      auVar29[0xe] = (bVar14 < bVar31) * bVar31 | (bVar14 >= bVar31) * bVar14;
                      bVar31 = auVar33[0xf];
                      auVar29[0xf] = (bVar16 < bVar31) * bVar31 | (bVar16 >= bVar31) * bVar16;
