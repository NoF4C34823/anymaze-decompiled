...
void FUN_1409a8980(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
    ...
    if ((longlong)param_5 < 0x20) {
      ...
      if ((longlong)param_5 < 0xf6) {
        ...
        if (uVar21 != 0) {
          ...
          do {
            ...
            auVar30 = vpackusdw_avx512vl(auVar36._0_32_,auVar30);
      ...
      if ((longlong)(uVar21 + 0x20) <= (longlong)uVar22) {
        do {
          ...
          auVar31 = vpackusdw_avx512bw(auVar33,auVar31);
