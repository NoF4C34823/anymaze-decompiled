...
void FUN_1401eb360(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1401eb8db:
      uVar34 = 0;
      if (param_5 == 0) goto LAB_1401eb648;
      uVar31 = 0;
      uVar30 = param_5;
    }
    else {
      ...
      uVar30 = uVar37 & 0x1f;
      if (uVar30 != 0) {
        if ((uVar37 & 3) != 0) goto LAB_1401eb8db;
        uVar30 = 0x20 - uVar30 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar30 + 0x10)) goto LAB_1401eb8db;
      ...
      if (param_5 < uVar34 + 1) goto LAB_1401eb648;
...
LAB_1401eb648:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar30 = param_4 & 0x1f;
      if (uVar30 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1401eb8f9;
...
LAB_1401eb86b:
  ...
  if (7 < (longlong)param_5) {
    uVar30 = param_4 & 0xf;
    if (uVar30 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1401eb8f2;
