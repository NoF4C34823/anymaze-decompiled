...
void FUN_1403db020(longlong param_1,longlong param_2,ulonglong param_3,ulonglong param_4,
                  longlong param_5)
    ...
    do {
      ...
      if (0 < (longlong)param_4) {
        ...
        if (uVar10 <= param_4) {
          ...
          (*(code *)(&UNK_1403db313 + (byte)(&DAT_143089e40)[(uint)((int)param_4 - (int)uVar10)]))()
          ;
          return;
        }
      }
