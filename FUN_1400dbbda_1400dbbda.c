...
void FUN_1400dbbda(ulonglong param_1,ulonglong param_2,longlong param_3,undefined4 param_4)

{
  ...
  if (param_1 + 1 <= param_2) {
    ...
    if (uVar16 < param_2) {
      ...
      do {
        auVar18._0_4_ = (float)(int)*(short *)(lVar1 + uVar16 * 2);
        auVar18._4_8_ = SUB128(ZEXT812(0),4);
        auVar18._12_4_ = 0;
        auVar20._0_4_ =
             (float)((int)*(short *)(lVar1 + -0xc + uVar16 * 2) +
                    (int)*(short *)(lVar1 + 0xc + uVar16 * 2));
        ...
        auVar19 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM5_Da *
                                                (float)((int)*(short *)(lVar1 + -6 + uVar16 * 2) +
                                                       (int)*(short *)(lVar1 + 6 + uVar16 * 2)))),
                                  auVar20,auVar15);
