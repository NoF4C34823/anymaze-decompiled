...
void FUN_1404a54a0(undefined1 (*param_1) [16],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6 + -1) {
    do {
      ...
      if (((ulonglong)param_3 & 0xf) != 0) {
        ...
        FUN_1404a5820(param_1,param_2,param_3,uVar11);
      ...
      if (uVar11 != 0) {
        lVar3 = 0;
        auVar13 = vpmaxub_avx(*pauVar4,*(undefined1 (*) [16])(*pauVar4 + param_2));
        auVar13 = vpmaxub_avx(auVar13,*(undefined1 (*) [16])(*pauVar4 + param_2 * 2));
        auVar14 = ZEXT1664(auVar13);
        if (0 < (longlong)(uVar11 & 0xfffffffffffffffe)) {
          do {
            auVar13 = vpmaxub_avx(pauVar4[1],*(undefined1 (*) [16])(pauVar4[1] + param_2));
            lVar3 = lVar3 + 2;
            auVar2 = vpmaxub_avx(auVar13,*(undefined1 (*) [16])(pauVar4[1] + param_2 * 2));
            auVar12 = auVar14._0_16_;
            auVar13 = vpalignr_avx(auVar2,auVar12,3);
            auVar1 = vpalignr_avx(auVar2,auVar12,6);
            auVar13 = vpmaxub_avx(auVar13,auVar12);
            auVar13 = vpmaxub_avx(auVar1,auVar13);
            *pauVar8 = auVar13;
            auVar13 = vpmaxub_avx(pauVar4[2],*(undefined1 (*) [16])(pauVar4[2] + param_2));
            auVar1 = vpmaxub_avx(auVar13,*(undefined1 (*) [16])(pauVar4[2] + param_2 * 2));
            auVar14 = ZEXT1664(auVar1);
            pauVar4 = pauVar4 + 2;
            auVar13 = vpalignr_avx(auVar1,auVar2,3);
            auVar1 = vpalignr_avx(auVar1,auVar2,6);
            auVar13 = vpmaxub_avx(auVar13,auVar2);
            auVar13 = vpmaxub_avx(auVar1,auVar13);
            pauVar8[1] = auVar13;
            pauVar8 = pauVar8 + 2;
  ...
  if (lVar7 < param_6) {
    do {
      ...
      if (lVar3 != 0) {
        ...
        auVar13 = vpmaxub_avx(*pauVar4,*pauVar6);
        pauVar9 = (undefined1 (*) [16])(*pauVar4 + param_2 * 2);
        auVar13 = vpmaxub_avx(auVar13,*pauVar9);
        auVar1 = auVar13;
        if (1 < lVar3) {
          do {
            auVar13 = vpmaxub_avx(pauVar4[1],*(undefined1 (*) [16])(pauVar4[1] + param_2));
            lVar10 = lVar10 + 1;
            auVar13 = vpmaxub_avx(auVar13,*(undefined1 (*) [16])(pauVar4[1] + param_2 * 2));
            pauVar4 = pauVar4 + 1;
            auVar2 = vpalignr_avx(auVar13,auVar1,3);
            auVar12 = vpalignr_avx(auVar13,auVar1,6);
            auVar1 = vpmaxub_avx(auVar2,auVar1);
            auVar1 = vpmaxub_avx(auVar12,auVar1);
            *pauVar8 = auVar1;
            pauVar8 = pauVar8 + 1;
            auVar1 = auVar13;
        ...
        auVar13 = vpmaxub_avx(auVar1,auVar13);
        auVar13 = vpmaxub_avx(auVar2,auVar13);
        *pauVar8 = auVar13;
        pauVar8 = pauVar8 + 1;
      }
      if ((uVar5 & 0xf) != 0) {
        FUN_1404a5820(pauVar4,param_2,pauVar8);
      }
      lVar7 = lVar7 + 1;
      param_1 = (undefined1 (*) [16])(*param_1 + param_2);
      param_3 = (undefined1 (*) [16])(*param_3 + param_4);
