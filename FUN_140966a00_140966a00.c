...
void FUN_140966a00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_140966b06:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar14) && (uStack_c0 != 0xf0)) {
      if (uStack_90 != 6) goto joined_r0x000140966b36;
      if ((param_7 & 0x20) == 0) goto LAB_140966c4c;
    }
LAB_140966be0:
    do {
      FUN_1409676e0(param_1,param_2);
      while( true ) {
        while( true ) {
          uStack_90 = param_7 & 0xf;
          iVar13 = (int)uVar14;
          ...
          if (uVar16 <= uVar14) {
            if (uVar9 != 0) {
              ...
              lVar15 = -uVar16;
              do {
                FUN_1409676e0(param_1,param_2,lVar15,param_3);
                lVar7 = lVar7 + 1;
                lVar15 = lVar15 + 1;
...
LAB_140966ecf:
          (**(code **)(&UNK_14308d960 + (longlong)param_6 * 8))(param_2 * uVar14 + param_1,lVar8);
        }
        param_8 = pbStack_c8;
        if (-1 < (longlong)uVar14) goto LAB_140966b06;
...
LAB_14096762c:
            ...
            if ((longlong)uVar10 < 0x1d) {
              ...
              uVar19 = uVar17 & 0x1f;
              if (uVar19 != 0) {
                if ((uVar17 & 3) != 0) goto LAB_14096762c;
                uVar19 = 0x20 - uVar19 >> 2;
              }
              if ((longlong)uVar10 < (longlong)(uVar19 + 0x10)) goto LAB_14096762c;
              uVar12 = 0;
...
LAB_140967554:
            ...
            if ((longlong)uVar16 < 0x1d) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_140967554;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 0x10)) goto LAB_140967554;
              uVar19 = 0;
...
LAB_140967391:
            ...
            if ((longlong)uVar16 < 0xbd) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_140967391;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 8)) goto LAB_140967391;
              uVar19 = 0;
    ...
    if ((uStack_c0 & 0xf0) == 0xf0) {
      (**(code **)(&UNK_14308d960 + (longlong)param_6 * 8))
      ...
      FUN_1409676e0(param_1,param_2,lVar7,param_3);
    }
    lVar7 = 1;
    uVar14 = 0;
    if (1 < iVar11) {
...
LAB_1409671a4:
            ...
            if ((longlong)uVar16 < 0xbd) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_1409671a4;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 8)) goto LAB_1409671a4;
              lVar8 = lVar15 - lVar8;
              uVar19 = 0;
              uVar17 = uVar16 - (uVar16 - uVar18 & 7);
              if (uVar18 != 0) {
