...
void FUN_1405ccc9b(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         (float)((int)*(short *)(param_4 + -0xc + in_RAX * 2) +
                (int)*(short *)(param_4 + 0xc + in_RAX * 2)) * param_2 +
         (float)((int)*(short *)(param_4 + -6 + in_RAX * 2) +
                (int)*(short *)(param_4 + 6 + in_RAX * 2)) * in_XMM4_Da +
  ...
  do {
    ...
    *pfVar1 = (float)((int)(short)uVar2 + (int)(short)uVar3) * param_2 +
              (float)((int)(short)uVar4 + (int)(short)uVar5) * in_XMM4_Da +
    ...
    pfVar1[2] = (float)((auVar12._8_4_ >> 0x10) + (auVar19._8_4_ >> 0x10)) * param_2 +
                (float)((auVar16._8_4_ >> 0x10) + (auVar22._8_4_ >> 0x10)) * in_XMM4_Da +
                (float)(auVar25._8_4_ >> 0x10) * in_XMM0_Da;
    pfVar1[3] = (float)((auVar13._12_4_ >> 0x10) + (auVar20._12_4_ >> 0x10)) * param_2 +
                (float)((auVar17._12_4_ >> 0x10) + (auVar23._12_4_ >> 0x10)) * in_XMM4_Da +
                (float)(auVar26._12_4_ >> 0x10) * in_XMM0_Da;
    in_RDX = in_RDX + 4;
    ...
    do {
      *(float *)(in_R10 + param_1 * 4) =
           (float)((int)*(short *)(param_4 + -0xc + param_1 * 2) +
                  (int)*(short *)(param_4 + 0xc + param_1 * 2)) * param_2 +
           (float)((int)*(short *)(param_4 + -6 + param_1 * 2) +
                  (int)*(short *)(param_4 + 6 + param_1 * 2)) * in_XMM4_Da +
