...
void FUN_1405a9d80(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6 + -1) {
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        FUN_1405aa100(param_1,param_2,param_3,uVar11);
        pauVar5 = (undefined1 (*) [64])(*param_1 + uVar11);
        uVar2 = param_5 - uVar11;
        pauVar8 = (undefined1 (*) [32])(*param_3 + uVar11);
      }
      if ((longlong)uVar2 >> 6 != 0) {
        auVar17 = vpminub_avx512bw(*pauVar5,*(undefined1 (*) [64])(*pauVar5 + param_2));
        auVar17 = vpminub_avx512bw(auVar17,*(undefined1 (*) [64])(*pauVar5 + param_2 * 2));
        if (0 < (longlong)uVar2 >> 6) {
          auVar18 = vpminub_avx512bw(pauVar5[1],*(undefined1 (*) [64])(pauVar5[1] + param_2));
          auVar18 = vpminub_avx512bw(auVar18,*(undefined1 (*) [64])(pauVar5[1] + param_2 * 2));
      ...
      if (lVar3 != 0) {
        lVar9 = 0;
        auVar15 = vpminub_avx2(*(undefined1 (*) [32])*pauVar5,
                               *(undefined1 (*) [32])(*pauVar5 + param_2));
        auVar15 = vpminub_avx2(auVar15,*(undefined1 (*) [32])(*pauVar5 + param_2 * 2));
        if (0 < lVar3) {
          do {
            lVar9 = lVar9 + 1;
            auVar16 = vpminub_avx2(*(undefined1 (*) [32])(*pauVar5 + 0x20),
                                   *(undefined1 (*) [32])(*pauVar5 + param_2 + 0x20));
            auVar13 = vpminub_avx512vl(auVar16,*(undefined1 (*) [32])(*pauVar5 + param_2 * 2 + 0x20)
                                      );
            ...
            auVar15 = vpminub_avx2(auVar16,auVar15);
            auVar15 = vpminub_avx512vl(auVar14,auVar15);
  ...
  if (lVar7 < param_6) {
    do {
      ...
      if (lVar3 != 0) {
        ...
        auVar15 = vpminub_avx2(*(undefined1 (*) [32])*pauVar5,*pauVar12);
        pauVar6 = (undefined1 (*) [32])(*pauVar5 + param_2 * 2);
        auVar15 = vpminub_avx2(auVar15,*pauVar6);
        lVar10 = 0;
        lVar9 = lVar3 + -1;
        if (lVar9 != 0 && 0 < lVar3) {
          do {
        ...
        puVar1 = *pauVar5;
        pauVar5 = (undefined1 (*) [64])(*pauVar5 + 0x20);
        auVar16 = vpminub_avx2(ZEXT832(*(ulonglong *)(puVar1 + 0x20)),
                               ZEXT832(*(ulonglong *)pauVar12[1]));
        auVar16 = vpminub_avx2(auVar16,ZEXT832(*(ulonglong *)pauVar6[1]));
        ...
        *pbVar4 = *pbVar4 >> 1 | *pbVar4 << 7;
        ...
        auVar15 = vpminub_avx512vl(in_YMM18,auVar15);
        auVar15 = vmovdqu32_avx512vl(auVar15);
        *pauVar8 = auVar15;
        pauVar8 = pauVar8 + 1;
      }
      if ((uVar2 & 0x1f) != 0) {
        FUN_1405aa100(pauVar5,param_2,pauVar8);
      }
      lVar7 = lVar7 + 1;
      param_1 = (undefined1 (*) [64])(*param_1 + param_2);
      param_3 = (undefined1 (*) [32])(*param_3 + param_4);
