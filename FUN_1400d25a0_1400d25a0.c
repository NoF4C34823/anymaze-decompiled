...
void FUN_1400d25a0(ulonglong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)
...
LAB_1400d2754:
    ...
    if ((longlong)param_3 < 0x1d) {
      ...
      uVar9 = param_2 & 0x1f;
      if (uVar9 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400d2754;
        uVar9 = 0x20 - uVar9 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar9 + 0x10)) goto LAB_1400d2754;
      uVar8 = 0;
  ...
  if (uVar10 + 1 <= param_3) {
    ...
    if ((longlong)param_3 < 4) {
      FUN_1400d2710(uVar9,param_2,param_3,0);
      return;
    }
    uVar9 = 0;
    auVar11._4_4_ = uVar4;
