...
longlong FUN_1404be8a0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && 0 < lVar5) {
      do {
        thunk_FUN_140d229c0(param_1,lVar4,lVar1,(longlong)(int)param_6,1);
        lVar7 = lVar7 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        thunk_FUN_140d229c0(param_1,lVar4,(longlong)(int)param_5,(longlong)(int)param_6,1);
        thunk_FUN_140d22de0(param_9,uVar2,param_3,(longlong)(int)param_5,lVar5);
        lVar6 = lVar6 + 1;
        lVar4 = lVar4 + uVar2 * 2;
        if (lVar5 <= lVar6) {
          lVar4 = param_9;
