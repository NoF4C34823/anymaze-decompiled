...
void FUN_14082d360(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14082de29:
      uVar42 = 0;
      if (param_3 == 0) goto LAB_14082d588;
      uVar39 = 0;
      uVar40 = param_3;
    }
    else {
      uVar40 = param_2 & 0x1f;
      if (uVar40 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14082de29;
        uVar40 = 0x20 - uVar40 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_14082de29;
      uVar39 = 0;
      ...
      if (param_3 < uVar42 + 1) goto LAB_14082d588;
...
LAB_14082dded:
          uVar42 = 0;
          if (param_3 == 0) goto LAB_14082dc11;
          uVar39 = 0;
          uVar40 = param_3;
        }
        else {
          uVar40 = param_2 & 0x1f;
          if (uVar40 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14082dded;
            uVar40 = 0x20 - uVar40 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_14082dded;
          ...
          if (param_3 < uVar42 + 1) goto LAB_14082dc11;
          uVar40 = param_3 - uVar42;
          if ((longlong)uVar40 < 4) {
            uVar39 = 0;
          }
...
LAB_14082ddda:
    ...
    uVar40 = param_2 & 0x1f;
    if (uVar40 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14082ddda;
      uVar40 = 0x20 - uVar40 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_14082ddda;
    uVar39 = 0;
    uVar42 = param_3 - (param_3 - uVar40 & 0xf);
    if (uVar40 != 0) {
      do {
