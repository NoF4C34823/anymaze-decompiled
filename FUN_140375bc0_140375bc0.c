...
void FUN_140375bc0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar18 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_14036ade0(lVar12,lVar16,uVar8,(longlong)(int)param_6,3);
        lVar19 = lVar19 + 1;
          ...
          do {
            ...
            if (0 < param_6._4_4_) {
              ...
              if (uVar17 != 0) {
                ...
                bVar10 = 0;
                do {
                  if (bVar10 < *(byte *)(param_9 + uVar15 + lVar9 * 8)) {
              ...
              if (uVar13 <= (ulonglong)(longlong)param_6._4_4_) {
                    /* WARNING: Could not recover jumptable at 0x00014037604f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_140376051 +
                          (byte)(&DAT_143089d20)[(uint)(param_6._4_4_ - (int)uVar13)]))
                    ...
                    do {
                      if ((*(char *)(param_7 + lVar19 + uVar15 * 2) != '\0') &&
                         (bVar7 = *(byte *)(uVar15 * 6 + uVar22 + ((lVar16 * -3 + param_1) - lVar18)
                                           + (uVar14 + uVar17) * lVar11), bVar10 < bVar7)) {
                        bVar10 = bVar7;
                      }
