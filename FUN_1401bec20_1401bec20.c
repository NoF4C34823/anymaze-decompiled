...
void FUN_1401bec20(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_1401bee39:
    ...
    uVar4 = param_2 & 0xf;
    if (uVar4 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401bee39;
      uVar4 = 0x10 - uVar4 >> 2;
    }
    if ((longlong)uVar7 < (longlong)(uVar4 + 8)) goto LAB_1401bee39;
    uVar5 = 0;
    uVar6 = uVar7 - (uVar7 - uVar4 & 7);
    if (uVar4 != 0) {
      do {
        *(float *)(param_2 + uVar5 * 4) =
             (float)((uint)*(ushort *)(param_1 + -6 + uVar5 * 2) +
                    (uint)*(ushort *)(param_1 + 6 + uVar5 * 2)) * fVar2 +
             (float)*(ushort *)(param_1 + uVar5 * 2) * fVar3;
        uVar5 = uVar5 + 1;
      } while (uVar5 < uVar4);
    }
    do {
      auVar10 = pmovzxwd(in_XMM5,*(undefined8 *)(param_1 + -6 + uVar4 * 2));
      auVar8 = pmovzxwd(in_XMM4,*(undefined8 *)(param_1 + 6 + uVar4 * 2));
      auVar9 = pmovzxwd(auVar8,*(undefined8 *)(param_1 + uVar4 * 2));
      ...
      *(undefined1 (*) [16])(param_2 + uVar4 * 4) = auVar9;
      auVar8 = pmovzxwd(auVar11,*(undefined8 *)(param_1 + 2 + uVar4 * 2));
      auVar9 = pmovzxwd(auVar9,*(undefined8 *)(param_1 + 0xe + uVar4 * 2));
      auVar11 = pmovzxwd(auVar9,*(undefined8 *)(param_1 + 8 + uVar4 * 2));
    ...
    if (3 < (longlong)uVar7) {
      ...
      do {
        auVar8 = pmovzxwd(in_XMM4,*(undefined8 *)(lVar1 + -6 + uVar5 * 2));
        auVar9 = pmovzxwd(in_XMM5,*(undefined8 *)(lVar1 + 6 + uVar5 * 2));
        auVar11 = pmovzxwd(auVar9,*(undefined8 *)(lVar1 + uVar5 * 2));
        in_XMM5._0_4_ = (float)auVar11._0_4_ * fVar3;
        in_XMM5._4_4_ = (float)auVar11._4_4_ * fVar3;
        in_XMM5._8_4_ = (float)auVar11._8_4_ * fVar3;
        in_XMM5._12_4_ = (float)auVar11._12_4_ * fVar3;
  ...
  if (uVar4 < uVar7) {
    ...
    do {
      *(float *)(param_2 + uVar6 * 4 + uVar4 * 4) =
           (float)((uint)*(ushort *)(param_1 + -6 + uVar4 * 2) +
                  (uint)*(ushort *)(param_1 + 6 + uVar4 * 2)) * fVar2 +
