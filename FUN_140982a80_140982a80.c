...
void FUN_140982a80(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
  ...
  if (param_8 == 0) {
    ...
    if (0xf < (longlong)param_5) {
      if ((longlong)param_5 < 0x399) {
        ...
        if (uVar6 != 0) {
          auVar17 = vmovdqu32_avx512f(_DAT_14308dc80);
          auVar18 = vmovdqu32_avx512f(_DAT_14308dcc0);
    ...
    uVar2 = vpcmpgtq_avx512f(auVar19,_DAT_14308dc80);
    bVar4 = (byte)uVar2;
    uVar2 = vpcmpgtq_avx512f(auVar19,_DAT_14308dcc0);
    bVar3 = (byte)uVar2;
    uVar15 = CONCAT11(bVar3,bVar4);
...
LAB_1409831de:
    ...
    uVar5 = param_4 & 0x3f;
    if (uVar5 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1409831de;
      uVar5 = 0x40 - uVar5 >> 1;
