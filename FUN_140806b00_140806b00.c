...
void FUN_140806b00(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_140806eff:
    ...
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140806eff;
      uVar19 = 0x20 - uVar19 >> 2;
    }
    if ((longlong)uVar20 < (longlong)(uVar19 + 0x10)) goto LAB_140806eff;
    uVar17 = 0;
