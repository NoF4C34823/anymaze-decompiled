...
void FUN_14055e4c0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6 + -1) {
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        uVar26 = uVar29 & 0x1f;
        iVar24 = (int)uVar26 + 8;
        uVar33 = FUN_14055f400(param_1);
        uVar34 = FUN_14055f400(*param_1 + param_2,iVar24);
        uVar35 = FUN_14055f400(*param_1 + param_2 * 2,iVar24);
        iVar24 = (int)uVar26 + -0x18;
        uVar36 = FUN_14055f400(param_1 + 1);
        uVar37 = FUN_14055f400(param_1[1] + param_2,iVar24);
        auVar38._0_8_ = FUN_14055f400((longlong)(*param_1 + param_2 * 2) + 0x20,iVar24);
...
LAB_14055e6c7:
          if (7 < (longlong)uVar26) {
            *(longlong *)*pauStack_68 = auVar42._0_8_;
            ...
            uVar26 = uVar26 - 8;
            if (uVar26 == 0) goto LAB_14055e753;
          }
          ...
          if (1 < (longlong)uVar26) {
            ...
            *(short *)*pauStack_68 = auVar42._0_2_;
            ...
            if (uVar26 == 2) goto LAB_14055e753;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar42;
          ...
          uVar26 = uVar26 - 0x10;
          if (uVar26 != 0) goto LAB_14055e6c7;
        }
LAB_14055e753:
      ...
      if (lVar25 != 0) {
        auVar44 = vpminub_avx2(*pauVar32,*(undefined1 (*) [32])(*pauVar32 + param_2));
        auVar44 = vpminub_avx2(auVar44,*(undefined1 (*) [32])(*pauVar32 + param_2 * 2));
        lVar23 = 0;
        if (0 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            auVar5 = vpminub_avx2(pauVar32[1],*(undefined1 (*) [32])(pauVar32[1] + param_2));
            auVar6 = vpminub_avx2(auVar5,*(undefined1 (*) [32])(pauVar32[1] + param_2 * 2));
            pauVar32 = pauVar32 + 1;
            auVar7 = vperm2i128_avx2(auVar44,auVar6,0x21);
            auVar5 = vpalignr_avx2(auVar7,auVar44,4);
            auVar7 = vpalignr_avx2(auVar7,auVar44,8);
            auVar44 = vpminub_avx2(auVar5,auVar44);
            auVar44 = vpminub_avx2(auVar7,auVar44);
            *pauVar27 = auVar44;
            pauVar27 = pauVar27 + 1;
            auVar44 = auVar6;
          } while (lVar23 < lVar25);
      ...
      if (uVar29 != 0) {
        iVar24 = (int)uVar29 + 8;
        uVar33 = FUN_14055f400(pauVar32);
        uVar34 = FUN_14055f400(*pauVar32 + param_2,iVar24);
        uVar35 = FUN_14055f400(*pauVar32 + param_2 * 2,iVar24);
        iVar24 = (int)uVar29 + -0x18;
        uVar36 = FUN_14055f400(pauVar32 + 1);
        uVar37 = FUN_14055f400(pauVar32[1] + param_2,iVar24);
        auVar39._0_8_ = FUN_14055f400((longlong)(*pauVar32 + param_2 * 2) + 0x20,iVar24);
        ...
        if (0xf < uVar29) {
          *(undefined1 (*) [16])*pauVar27 = auVar42;
          ...
          uVar29 = uVar29 - 0x10;
          if (uVar29 == 0) goto LAB_14055e95b;
        }
        ...
        if (1 < (longlong)uVar29) {
          ...
          *(short *)*pauVar27 = auVar42._0_2_;
          ...
          if (uVar29 == 2) goto LAB_14055e95b;
        }
  ...
  if (lVar28 < param_6) {
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        uVar35 = FUN_14055f400(puVar2,iVar24);
        uVar36 = FUN_14055f400(param_1 + 1);
        auVar40._0_8_ = FUN_14055f400(param_1[1] + param_2,uVar26 - 0x18 & 0xffffffff);
...
LAB_14055f0d2:
          if (7 < (longlong)uVar26) {
            *(longlong *)*pauStack_60 = auVar42._0_8_;
            ...
            auVar42 = vpsrldq_avx(auVar42,8);
            uVar26 = uVar26 - 8;
            if (uVar26 == 0) goto LAB_14055f15e;
          }
          if (3 < (longlong)uVar26) {
          ...
          if (1 < (longlong)uVar26) {
            ...
            *(short *)*pauStack_60 = auVar42._0_2_;
            ...
            if (uVar26 == 2) goto LAB_14055f15e;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar42;
          ...
          uVar26 = uVar26 - 0x10;
          if (uVar26 != 0) goto LAB_14055f0d2;
        }
LAB_14055f15e:
        uVar26 = param_5 - uVar29;
        pauVar27 = (undefined1 (*) [32])(*param_3 + uVar29);
      ...
      if (lVar25 != 0) {
        ...
        auVar44 = vpminub_avx2(*pauVar32,*pauVar30);
        pauVar31 = (undefined1 (*) [32])(*pauVar32 + param_2 * 2);
        auVar44 = vpminub_avx2(auVar44,*pauVar31);
        lVar23 = 0;
        auVar5 = auVar44;
        if (1 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            auVar44 = vpminub_avx2(pauVar32[1],*(undefined1 (*) [32])(pauVar32[1] + param_2));
            auVar44 = vpminub_avx2(auVar44,*(undefined1 (*) [32])(pauVar32[1] + param_2 * 2));
            pauVar32 = pauVar32 + 1;
            auVar6 = vperm2i128_avx2(auVar5,auVar44,0x21);
            auVar7 = vpalignr_avx2(auVar6,auVar5,4);
            auVar6 = vpalignr_avx2(auVar6,auVar5,8);
            auVar5 = vpminub_avx2(auVar7,auVar5);
        ...
        pauVar1 = pauVar32 + 1;
        pauVar32 = pauVar32 + 1;
        auVar5 = vpminub_avx2(ZEXT832(*(ulonglong *)*pauVar1),ZEXT832(*(ulonglong *)pauVar30[1]));
        auVar5 = vpminub_avx2(auVar5,ZEXT832(*(ulonglong *)pauVar31[1]));
      ...
      if (uVar29 != 0) {
        ...
        uVar36 = FUN_14055f400(pauVar32 + 1);
        uVar37 = FUN_14055f400(pauVar32[1] + param_2,iVar24);
        auVar41._0_8_ = FUN_14055f400((longlong)(*pauVar32 + param_2 * 2) + 0x20,iVar24);
        ...
        if (0xf < uVar29) {
          *(undefined1 (*) [16])*pauVar27 = auVar42;
          ...
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 0x10);
          uVar29 = uVar29 - 0x10;
          if (uVar29 == 0) goto LAB_14055f3b7;
        }
        if (7 < (longlong)uVar29) {
          *(longlong *)*pauVar27 = auVar42._0_8_;
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 8);
        ...
        if (1 < (longlong)uVar29) {
          ...
          *(short *)*pauVar27 = auVar42._0_2_;
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 2);
          if (uVar29 == 2) goto LAB_14055f3b7;
        }
        (*pauVar27)[0] = auVar43[0];
      }
LAB_14055f3b7:
