...
void FUN_1407c17c0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar49 = param_4 & 0xf;
      if (uVar49 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1407c2126;
...
LAB_1407c2058:
  ...
  if (3 < (longlong)param_5) {
    uVar49 = param_4 & 0xf;
    if (uVar49 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1407c211f;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 4) <= (longlong)param_5) {
      lVar50 = param_2 * lVar47 + param_1;
