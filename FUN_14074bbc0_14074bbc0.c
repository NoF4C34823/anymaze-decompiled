...
void FUN_14074bbc0(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14074c727:
      ...
      uVar36 = 0;
      uVar38 = uVar33;
      if (uVar33 == 0) goto LAB_14074bdff;
    }
    else {
      uVar38 = (ulonglong)param_2 & 0xf;
      if (uVar38 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_14074c727;
        uVar38 = 0x10 - uVar38 >> 2;
      }
      if ((longlong)uVar33 < (longlong)(uVar38 + 8)) goto LAB_14074c727;
      uVar36 = 0;
      ...
      if (uVar33 < uVar39 + 1) goto LAB_14074bdff;
...
LAB_14074c6e8:
          uVar36 = 0;
          if (uVar33 == 0) goto LAB_14074c508;
          uVar39 = 0;
          uVar38 = uVar33;
        }
        else {
          uVar38 = (ulonglong)param_2 & 0xf;
          if (uVar38 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_14074c6e8;
            uVar38 = 0x10 - uVar38 >> 2;
          }
          if ((longlong)uVar33 < (longlong)(uVar38 + 8)) goto LAB_14074c6e8;
          uVar39 = 0;
          lVar34 = lVar46 * -0xc;
          ...
          if (uVar33 < uVar36 + 1) goto LAB_14074c508;
...
LAB_14074c508:
  ...
  if (7 < (longlong)uVar33) {
    uVar38 = (ulonglong)param_2 & 0xf;
    if (uVar38 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_14074c6d4;
      uVar38 = 0x10 - uVar38 >> 2;
    }
