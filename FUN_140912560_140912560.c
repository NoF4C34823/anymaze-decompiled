...
void FUN_140912560(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308d3e0)[lVar10])(pbVar27,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar26 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar26 != 6) {
            if (uVar26 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140913b40;
                while (uVar11 == 0) {
                  for (lVar25 = (lVar15 + -1) * 2 - lVar25; lVar25 < 0; lVar25 = -lVar25) {
LAB_140913b40:
                    if (uVar13 != 0) goto LAB_1409139a2;
                  }
          ...
          bVar28 = bVar17;
          if (uVar24 != 0) goto LAB_1409139a2;
        }
        else {
LAB_1409139a2:
    ...
    (*(code *)(&PTR_FUN_14308d3e0)[lVar10])(param_11 + uVar19,param_4,lVar15,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar19 == 1) {
...
LAB_140913a64:
              ...
              if ((longlong)uVar19 < 0x671) {
                ...
                if ((longlong)uVar19 < (longlong)(uVar16 + 0x20)) goto LAB_140913a64;
                uVar23 = 0;
...
LAB_140913a45:
          ...
          if ((longlong)uVar19 < 0x671) {
            ...
            if ((longlong)uVar19 < (longlong)(uVar16 + 0x20)) goto LAB_140913a45;
            uVar23 = 0;
            uVar18 = uVar19 - (uVar19 - uVar16 & 0x1f);
            if (uVar16 != 0) {
              do {
      ...
      (*(code *)(&PTR_FUN_14308d3e0)[lVar10])(param_11 + uVar19,param_4,uVar19,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_FUN_14308d3e0)[lVar10])(pbVar27,param_4,lVar15,param_9,param_10);
    return;
  }
...
LAB_140913a82:
          ...
          if ((longlong)uVar22 < 0xa71) {
            ...
            if ((longlong)uVar22 < (longlong)(uVar16 + 0x20)) goto LAB_140913a82;
...
LAB_1409132a4:
  if (uVar26 == 1) {
    if ((longlong)uVar19 < 1) goto LAB_140913855;
    if ((longlong)uVar19 < 7) {
      lVar15 = 1;
      if (uVar19 >> 1 != 0) {
...
LAB_140913adb:
      ...
      if ((longlong)uVar19 < 0x6a1) {
        ...
        if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140913adb;
        uVar18 = 0;
  ...
  if (uVar26 != 3) {
    if ((uVar26 != 6) || ((longlong)uVar19 < 1)) goto LAB_140913855;
    if ((longlong)uVar19 < 0x20) {
LAB_140913abd:
      uVar16 = 0;
    }
      ...
      if ((longlong)uVar19 < 0x6a1) {
        ...
        if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140913abd;
        uVar18 = 0;
        uVar16 = uVar19 - (uVar19 - uVar22 & 0x1f);
        if (uVar22 != 0) {
          do {
...
LAB_140913aa0:
    ...
    if ((longlong)uVar19 < 0xaa1) {
      ...
      if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140913aa0;
      uVar18 = 0;
      lVar12 = 0;
      uVar16 = uVar19 - (uVar19 - uVar22 & 0x1f);
      if (uVar22 != 0) {
