...
void FUN_14031aac0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar9 - 1)) {
      while( true ) {
        FUN_1402fd0c0(param_1,lVar15,uVar3,uVar10,3);
        uVar9 = param_6[1];
        lVar11 = lVar11 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_1402fd0c0(param_1,lVar15,uVar3,*param_6,3);
        thunk_FUN_142d22130(param_9,uVar18,param_3,uVar3,param_6[1]);
        lVar11 = lVar11 + 1;
        lVar12 = lVar12 + 1;
        param_1 = param_1 + param_2 * 4;
                  ...
                  if (uVar10 >> 1 != 0) {
                    ...
                    do {
                      ...
                      if ((*(char *)(param_7 + lVar16 + uVar7 * 2) != '\0') &&
                         (fVar2 = *(float *)(lVar6 + lVar4), fVar2 <= fVar20)) {
                        fVar20 = fVar2;
                      }
                      if ((*(char *)(param_7 + lVar16 + 1 + uVar7 * 2) != '\0') &&
                         (fVar2 = *(float *)(lVar6 + 0xc + lVar4), fVar2 <= fVar20)) {
                        fVar20 = fVar2;
                      }
                      uVar8 = uVar7 + 1;
                      lVar6 = lVar6 + 0x18;
