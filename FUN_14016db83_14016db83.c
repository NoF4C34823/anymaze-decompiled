...
void FUN_14016db83(float param_1,float param_2,ulonglong param_3,float param_4)

{
  ...
  do {
    ...
    *pfVar3 = (*pfVar6 + *pfVar7) * (float)in_XMM2_Qa + (*pfVar5 + *pfVar4) * in_XMM4_Da +
    ...
    pfVar3[2] = (fVar18 + fVar21) * in_XMM2_Dc + (fVar12 + fVar9) * in_XMM4_Dc + fVar15 * in_XMM5_Dc
    ;
