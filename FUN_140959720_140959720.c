...
void FUN_140959720(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140959e35:
      ...
      if ((longlong)param_5 < 0x960) {
        ...
        uVar23 = param_4 & 0x1f;
        if (uVar23 != 0) {
          if ((param_4 & 1) != 0) goto LAB_140959e35;
          uVar23 = 0x20 - uVar23 >> 1;
        }
        if ((longlong)param_5 < (longlong)(uVar23 + 0x10)) goto LAB_140959e35;
        lStack_58 = param_2 * lVar12 + param_1;
        lStack_60 = param_2 * lVar13 + param_1;
        lVar22 = param_2 * lVar16 + param_1;
        lVar20 = param_2 * lVar15 + param_1;
  ...
  if (7 < (longlong)param_5) {
    uVar17 = param_4 & 0x1f;
    if (uVar17 != 0) {
      if ((param_4 & 1) != 0) goto LAB_140959e8b;
