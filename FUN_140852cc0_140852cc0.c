...
void FUN_140852cc0(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1408536db:
      uVar31 = 0;
      if (uVar37 == 0) goto LAB_140852efc;
      uVar29 = 0;
      uVar32 = uVar37;
    }
    else {
      ...
      if (uVar32 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_1408536db;
        uVar32 = 0x20 - uVar32 >> 2;
      }
      if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_1408536db;
      uVar29 = 0;
      ...
      if (uVar37 < uVar31 + 1) goto LAB_140852efc;
...
LAB_1408536a0:
          uVar31 = 0;
          if (uVar37 == 0) goto LAB_1408534e5;
          uVar29 = 0;
          uVar32 = uVar37;
        }
        else {
          uVar32 = (ulonglong)param_2 & 0x1f;
          if (uVar32 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_1408536a0;
            uVar32 = 0x20 - uVar32 >> 2;
          }
          if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_1408536a0;
          uVar31 = uVar37 - (uVar37 - uVar32 & 0xf);
          ...
          if (uVar37 < uVar31 + 1) goto LAB_1408534e5;
          uVar32 = uVar37 - uVar31;
          if ((longlong)uVar32 < 4) {
            uVar29 = 0;
          }
...
LAB_14085368d:
    ...
    uVar32 = (ulonglong)param_2 & 0x1f;
    if (uVar32 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_14085368d;
      uVar32 = 0x20 - uVar32 >> 2;
    }
    if ((longlong)uVar37 < (longlong)(uVar32 + 0x10)) goto LAB_14085368d;
    uVar29 = 0;
    uVar31 = uVar37 - (uVar37 - uVar32 & 0xf);
    if (uVar32 != 0) {
      do {
