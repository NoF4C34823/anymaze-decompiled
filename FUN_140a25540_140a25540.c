...
/* WARNING: Removing unreachable block (ram,0x000140a26688) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_140a25540(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_198 = param_10;
    (*(code *)(&PTR_LAB_14308ebe0)[lVar20])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar11 != 6) {
            if (uVar11 == 1) {
              ...
              if ((longlong)uVar12 < 2) {
                ...
                if (lVar16 < 0) goto LAB_140a26b68;
                while (uVar17 == 0) {
                  for (lVar8 = (uVar12 - 1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_140a26b68:
                    if ((uint)uStack_c8 != 0) goto LAB_140a269f5;
                  }
...
LAB_140a269f5:
    ...
    iStack_198 = param_10;
    (*(code *)(&PTR_LAB_14308ebe0)[lVar20])(param_11 + lVar27 * 6,param_4,uVar12,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
            ...
            if ((longlong)uVar9 < 0x20) {
              ...
              if ((longlong)uVar9 < 0x76) {
                ...
                if (uVar10 != 0) {
                  ...
                  if (uVar9 == uVar10) goto LAB_140a25908;
                }
              }
        ...
        if (0 < lStack_98) {
          ...
          if (((longlong)uVar9 < 7) ||
            ...
            if ((longlong)uVar9 < 0x10) {
              ...
              auVar35 = vmovdqu32_avx512f(_DAT_14308eac0);
              auVar32 = vmovdqu32_avx512f(_DAT_14308eb00);
...
LAB_140a26131:
      pcStack_c0 = (code *)(&PTR_LAB_14308ebe0)[lVar20];
      iStack_198 = param_10;
      uStack_90 = param_7;
      lStack_88 = param_4;
