...
void FUN_1402ffc0b(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_142d21fa0(unaff_RSI,unaff_RBX);
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_142d21fa0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,lStack0000000000000060,1);
      thunk_FUN_142d22130(in_stack_00000100,param_1,lVar3,(longlong)iStack00000000000000e0,lVar1);
