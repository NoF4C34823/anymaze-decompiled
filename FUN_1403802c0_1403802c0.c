...
void FUN_1403802c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar11 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_14036ade0(lVar13,lVar7,uVar2,(longlong)(int)param_6,4);
        lVar14 = lVar14 + 1;
        lVar13 = lVar13 + lVar4;
        lVar7 = lVar7 + uVar5;
      } while (lVar14 < lVar11);
