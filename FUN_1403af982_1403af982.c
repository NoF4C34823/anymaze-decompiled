...
void FUN_1403af982(undefined8 param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < in_stack_000000f0._4_4_) {
    ...
    do {
      ...
      FUN_142d23d30(in_stack_00000110,lStack0000000000000098,param_3);
