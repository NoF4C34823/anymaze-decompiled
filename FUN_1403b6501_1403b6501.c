...
void FUN_1403b6501(ulonglong param_1,longlong param_2,longlong param_3,longlong param_4)
            ...
            if (0 < (longlong)in_stack_00000130) {
              ...
              if (((lVar4 - 1U < in_stack_00000130) &&
                 ...
                 (fVar2 = *(float *)((lVar4 - 1U) * (longlong)in_stack_00000150 * 4 +
                                     in_RAX + lVar3 + lVar1 + lVar7 * 4), fVar13 <= fVar2)) {
                fVar13 = fVar2;
              }
            }
            uVar9 = uVar9 + 1;
