...
void FUN_14053be00(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6) {
    do {
      ...
      if (uVar5 != 0) {
        ...
        FUN_14053c020(param_1,param_2,param_3,uVar5);
      ...
      if (lVar10 != 0) {
        ...
        auVar12 = vmaxps_avx(auVar12,*pauVar11);
        lVar3 = 0;
        auVar13 = auVar12;
        if (1 < lVar10) {
          do {
            lVar3 = lVar3 + 1;
            auVar12 = vmaxps_avx(pauVar4[1],*(undefined1 (*) [32])(pauVar4[1] + param_2 * 4));
            auVar12 = vmaxps_avx(auVar12,*(undefined1 (*) [32])(pauVar4[1] + param_2 * 8));
            pauVar4 = pauVar4 + 1;
      ...
      if ((uVar9 & 7) != 0) {
        FUN_14053c020(pauVar4,param_2,pauVar8);
      }
      lVar7 = lVar7 + 1;
