...
void FUN_1402f4260(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar27 != 0 && 0 < (longlong)uVar13) {
      do {
        FUN_1402dd1e0(lVar15,lVar25,(longlong)(int)param_5,uVar22,1);
        lVar28 = lVar28 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1402dd1e0(lVar15,lVar25,(longlong)(int)param_5,uVar22,1);
        thunk_FUN_142d20530(param_9,uVar17,param_3,(longlong)(int)param_5,uVar13);
        lVar27 = lVar27 + 1;
        lVar25 = lVar25 + uVar17 * 4;
                  ...
                  if (uVar29 < uVar22) {
                    do {
                      if ((*(char *)(uVar29 + param_7 + lVar24) != '\0') &&
                         (fVar2 = *(float *)(lVar1 + lVar18 + uVar29 * 4), auVar75._0_4_ <= fVar2))
                      {
                        auVar75._0_4_ = fVar2;
                      }
                      uVar29 = uVar29 + 1;
