...
void FUN_140747700(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407487b5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(psVar25,param_4,*param_5);
    return;
  }
  if (uVar14 == 6) {
    sVar19 = *param_8;
          ...
          if (uVar14 != 6) {
            if (uVar14 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar12 < 0) goto LAB_140748740;
                while (uVar8 == 0) {
                  for (lVar23 = (lVar20 + -1) * 2 - lVar23; lVar23 < 0; lVar23 = -lVar23) {
LAB_140748740:
                    if (uVar16 != 0) goto LAB_140748643;
                  }
...
LAB_140748643:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar22;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407486a6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(param_11 + uVar10 * 2,param_4,lVar20,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar10 == 1) {
...
LAB_1407486ba:
              ...
              uVar17 = uVar7 & 0xf;
              if (uVar17 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_1407486ba;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar17 + 8)) goto LAB_1407486ba;
...
LAB_140747bdd:
      if (uVar14 == 1) {
        if ((longlong)uVar10 < 1) goto LAB_140747ded;
...
LAB_14074871a:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14074871a;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_14074871a;
          uVar5 = 0;
...
LAB_1407486c1:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407486c1;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_1407486c1;
          uVar5 = 0;
          uVar21 = uVar10 - (uVar10 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_140747ded:
      in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(uVar7,param_4,uVar10,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140748717. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(psVar25,param_4,lVar20);
    return;
  }
  if ((longlong)uVar10 < lVar20) {
    lVar20 = lVar20 - uVar10;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(psVar25,param_4,lVar20,param_9,param_10);
...
LAB_1407486c8:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407486c8;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar7 + 8)) goto LAB_1407486c8;
...
LAB_14074825c:
  if (uVar14 == 1) {
    if ((longlong)uVar10 < 1) goto LAB_1407484fb;
...
LAB_1407486d8:
          ...
          uVar7 = uVar18 & 0xf;
          if (uVar7 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_1407486d8;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar7 + 8)) goto LAB_1407486d8;
          uVar17 = 0;
  ...
  if ((uVar14 != 6) || ((longlong)uVar10 < 1)) goto LAB_1407484fb;
  if ((longlong)uVar10 < 8) {
LAB_1407486d0:
    uVar7 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar20 - 2U & 1) != 0) goto LAB_1407486d0;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar10 < (longlong)(uVar18 + 8)) goto LAB_1407486d0;
    uVar17 = 0;
...
LAB_1407484fb:
                    /* WARNING: Could not recover jumptable at 0x000140748534. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308bfa0)[lVar4])(param_11 + uVar10 * 2,param_4,uVar10);
  return;
}
