...
void FUN_1404be928(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    thunk_FUN_140d229c0(unaff_RSI,unaff_RBX);
  ...
  if (0 < iStack00000000000000e4) {
    do {
      thunk_FUN_140d229c0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,
