...
void FUN_1405171c0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
                  ulonglong param_4)

{
  ...
  if (param_4 < 0x1e) {
    ...
    if (0x1e < param_4) {
      auVar11 = vpmaxub_avx2(auVar7,auVar3);
      auVar7 = vpmaxub_avx2(auVar11,auVar13);
      auVar11 = vpmaxub_avx2(ZEXT132((byte)param_1[1][0]),ZEXT132((byte)param_1[1][param_2]));
      auVar11 = vpmaxub_avx2(auVar11,ZEXT132((byte)param_1[1][param_2 * 2]));
      goto LAB_140517303;
    }
  }
  auVar7 = vpmaxub_avx2(auVar7,auVar3);
  auVar7 = vpmaxub_avx2(auVar7,auVar13);
LAB_140517303:
  auVar13 = vperm2i128_avx2(auVar7,auVar11,0x21);
  auVar11 = vpalignr_avx2(auVar13,auVar7,1);
  auVar3 = vpmaxub_avx2(auVar7,auVar11);
  auVar11 = vpalignr_avx2(auVar13,auVar7,2);
  auVar11 = vpmaxub_avx2(auVar3,auVar11);
