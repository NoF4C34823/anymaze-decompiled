...
void FUN_1400ad600(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1400ae0c9:
      uVar42 = 0;
      if (param_3 == 0) goto LAB_1400ad828;
      uVar39 = 0;
      uVar40 = param_3;
    }
    else {
      uVar40 = param_2 & 0x1f;
      if (uVar40 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400ae0c9;
        uVar40 = 0x20 - uVar40 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_1400ae0c9;
      uVar39 = 0;
      ...
      if (param_3 < uVar42 + 1) goto LAB_1400ad828;
...
LAB_1400ae08d:
          uVar42 = 0;
          if (param_3 == 0) goto LAB_1400adeb1;
          uVar39 = 0;
          uVar40 = param_3;
        }
        else {
          uVar40 = param_2 & 0x1f;
          if (uVar40 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1400ae08d;
            uVar40 = 0x20 - uVar40 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_1400ae08d;
          ...
          if (param_3 < uVar42 + 1) goto LAB_1400adeb1;
          uVar40 = param_3 - uVar42;
          if ((longlong)uVar40 < 4) {
            uVar39 = 0;
          }
...
LAB_1400ae07a:
    ...
    uVar40 = param_2 & 0x1f;
    if (uVar40 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400ae07a;
      uVar40 = 0x20 - uVar40 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_1400ae07a;
    uVar39 = 0;
    uVar42 = param_3 - (param_3 - uVar40 & 0xf);
    if (uVar40 != 0) {
      do {
