...
void FUN_1408a305e(longlong param_1,undefined4 param_2,longlong param_3,ulonglong param_4)

{
  ...
  if (in_RDX + 1U <= param_4) {
    ...
    do {
      ...
      auVar2._8_8_ = 0;
      auVar2._0_8_ = *(ulonglong *)((uVar13 - 2) + lVar1);
      auVar2 = vpmovzxbw_avx(auVar2);
      auVar3._8_8_ = 0;
      auVar3._0_8_ = *(ulonglong *)(uVar13 + 2 + lVar1);
      auVar3 = vpmovzxbw_avx(auVar3);
      auVar2 = vpaddw_avx(auVar2,auVar3);
      auVar7 = vpmovzxwd_avx2(auVar2);
      auVar4._8_8_ = 0;
      auVar4._0_8_ = *(ulonglong *)((uVar13 - 1) + lVar1);
      auVar2 = vpmovzxbw_avx(auVar4);
      auVar7 = vcvtdq2ps_avx(auVar7);
      auVar5._8_8_ = 0;
      auVar5._0_8_ = *(ulonglong *)(uVar13 + 1 + lVar1);
      ...
      *(undefined1 (*) [32])(param_3 + in_RDX * 4 + uVar13 * 4) = ZEXT1632(auVar2);
      uVar13 = uVar13 + 8;
    } while (uVar13 < uVar12);
    if (uVar12 < param_4) {
      ...
      do {
        ...
        auVar14._12_4_ = 0;
        auVar15._0_4_ =
             (float)((uint)*(byte *)((uVar12 - 2) + param_1) + (uint)*(byte *)(uVar12 + 2 + param_1)
                    );
        ...
        auVar2 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM4_Da *
                                               (float)((uint)*(byte *)((uVar12 - 1) + param_1) +
        ...
        *(int *)(param_3 + in_RDX * 4 + uVar12 * 4) = auVar2._0_4_;
        uVar12 = uVar12 + 1;
