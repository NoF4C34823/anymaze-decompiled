...
void FUN_1408420e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308c940)[lVar8])(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar12 == 6) {
          ...
          if (uVar12 != 6) {
            if (uVar12 == 1) {
              ...
              if (lVar13 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140842fe0;
                while (uVar14 == 0) {
                  for (lVar9 = (lVar13 + -1) * 2 - lVar9; lVar9 < 0; lVar9 = -lVar9) {
LAB_140842fe0:
                    if ((uint)pcStack_80 != 0) goto LAB_140842e4f;
                  }
...
LAB_140842e4f:
    ...
    (*(code *)(&PTR_FUN_14308c940)[lVar8])(param_11 + uVar16 * 4,param_4,lVar13,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
...
LAB_140842ed1:
            ...
            uVar11 = uVar10 & 0x1f;
            if (uVar11 != 0) {
              if ((uVar10 & 3) != 0) goto LAB_140842ed1;
              uVar11 = 0x20 - uVar11 >> 2;
            }
            if ((longlong)uVar15 < (longlong)(uVar11 + 8)) goto LAB_140842ed1;
...
LAB_140842316:
    uStack_78 = uVar16;
    if (uVar12 == 1) {
      if ((longlong)uVar16 < 1) goto LAB_140842773;
      uVar14 = *(uint *)(param_11 + uVar16 * 4);
      if ((longlong)uVar16 < 0x10) {
LAB_140842f7a:
        pcStack_80 = (code *)0x0;
        if (uVar16 == 0) goto LAB_140842773;
        uStack_70 = 0;
      }
      else {
        uVar11 = param_11 & 0x1f;
        if (uVar11 != 0) {
          if ((param_11 & 3) != 0) goto LAB_140842f7a;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)uVar16 < (longlong)(uVar11 + 0x10)) goto LAB_140842f7a;
        ...
        if (uVar16 < (longlong)pcStack_80 + 1U) goto LAB_140842773;
...
LAB_140842eed:
        ...
        uVar11 = param_11 & 0x1f;
        if (uVar11 != 0) {
          if ((param_11 & 3) != 0) goto LAB_140842eed;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)uVar16 < (longlong)(uVar11 + 0x10)) goto LAB_140842eed;
        pcStack_80 = (code *)(uVar16 - (uVar16 - uVar11 & 0xf));
        uVar17 = 0;
        if (uVar11 != 0) {
          do {
...
LAB_140842773:
    pcStack_80 = (code *)(&PTR_FUN_14308c940)[lVar8];
...
LAB_140842f11:
          ...
          if (uVar10 != 0) {
            if ((param_11 & 3) != 0) goto LAB_140842f11;
            uVar10 = 0x20 - uVar10 >> 2;
          }
          if ((longlong)uVar15 < (longlong)(uVar10 + 8)) goto LAB_140842f11;
          uVar17 = 0;
...
LAB_1408429a8:
  if (uVar12 == 1) {
    if ((longlong)uVar16 < 1) goto LAB_140842d1c;
...
LAB_140842f3c:
          uVar15 = 0;
          if (uVar16 == 0) goto LAB_140842d1c;
          uVar11 = 0;
          uVar10 = uVar16;
        }
        else {
          uVar10 = uVar15 & 0x1f;
          if (uVar10 != 0) {
            if ((uVar15 & 3) != 0) goto LAB_140842f3c;
            uVar10 = 0x20 - uVar10 >> 2;
          }
          if ((longlong)uVar16 < (longlong)(uVar10 + 0x10)) goto LAB_140842f3c;
          uVar11 = 0;
          ...
          if (uVar16 < uVar15 + 1) goto LAB_140842d1c;
  ...
  if ((uVar12 != 6) || ((longlong)uVar16 < 1)) goto LAB_140842d1c;
  if ((longlong)uVar16 < 0x10) {
LAB_140842f1f:
    uVar10 = 0;
    if (uVar16 == 0) goto LAB_140842d1c;
    ...
    if (uVar15 != 0) {
      if ((lVar8 - 4U & 3) != 0) goto LAB_140842f1f;
      uVar15 = 0x20 - uVar15 >> 2;
    }
    if ((longlong)uVar16 < (longlong)(uVar15 + 0x10)) goto LAB_140842f1f;
    uVar11 = 0;
    ...
    if (uVar16 < uVar10 + 1) goto LAB_140842d1c;
