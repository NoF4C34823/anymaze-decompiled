...
void FUN_1403f1f50(undefined8 param_1,longlong param_2,undefined8 param_3,longlong param_4)

{
  ...
  do {
    FUN_1403bffa0(unaff_RSI,unaff_RBX,param_3,(longlong)iStack00000000000000f8,1);
  ...
  if (0 < in_stack_000000f0._4_4_) {
    ...
    do {
      FUN_1403bffa0(unaff_RSI,unaff_RBX,param_3,(longlong)iStack00000000000000f8,1);
      thunk_FUN_142d25930(in_stack_00000110,lStack0000000000000098,lVar2,param_3,
