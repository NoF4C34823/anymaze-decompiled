...
void FUN_1402f1fa0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...
LAB_1402f26f1:
                    ...
                    if ((longlong)uVar22 < (longlong)(uVar14 + 0x10)) goto LAB_1402f26f1;
                    uVar24 = 0;
