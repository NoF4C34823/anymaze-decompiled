...
void FUN_1405d3f00(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar20 & 0xf;
      if (uVar21 != 0) {
        if ((uVar20 & 3) != 0) goto LAB_1405d47e8;
...
LAB_1405d47d8:
    ...
    uVar21 = uVar20 & 0xf;
    if (uVar21 != 0) {
      if ((uVar20 & 3) != 0) goto LAB_1405d47d8;
      uVar21 = 0x10 - uVar21 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar21 + 8)) goto LAB_1405d47d8;
