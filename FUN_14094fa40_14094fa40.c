...
void FUN_14094fa40(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140950567:
      ...
      if ((longlong)uVar23 < 0x1d) {
        ...
        uVar28 = param_2 & 0x1f;
        if (uVar28 != 0) {
          if ((param_2 & 3) != 0) goto LAB_140950567;
          uVar28 = 0x20 - uVar28 >> 2;
        }
        if ((longlong)uVar23 < (longlong)(uVar28 + 0x10)) goto LAB_140950567;
        lVar18 = lVar33 * -6 + param_1;
        ...
        if (uVar28 != 0) {
          do {
            *(float *)(param_2 + uVar26 * 4) =
                 fVar5 * (float)((uint)*(ushort *)(lVar18 + uVar26 * 2) +
                                (uint)*(ushort *)(lVar30 + uVar26 * 2));
            uVar26 = uVar26 + 1;
          } while (uVar26 < uVar28);
        }
      }
      do {
        ...
        auVar16 = vpmovzxwd_avx2(auVar48._0_16_);
        auVar49 = vpmovzxwd_avx2(auVar52._0_16_);
        auVar16 = vpaddd_avx2(auVar16,auVar49);
        auVar16 = vcvtdq2ps_avx(auVar16);
        auVar48 = vpmovzxwd_avx2(auVar48._16_16_);
        auVar52 = vpmovzxwd_avx2(auVar52._16_16_);
      ...
      if (uVar26 < uVar28) {
        do {
          *(float *)(param_2 + uVar21 * 4 + uVar26 * 4) =
               fVar5 * (float)((uint)*(ushort *)(lVar33 * -6 + param_1 + uVar21 * 2 + uVar26 * 2) +
                              (uint)*(ushort *)(param_1 + lVar33 * 6 + uVar21 * 2 + uVar26 * 2));
          uVar26 = uVar26 + 1;
        } while (uVar26 < uVar28);
      }
    }
        ...
        if (0 < (longlong)uVar23) {
          if (((longlong)uVar23 < 0x10) ||
            ...
            if (uVar28 != 0) {
              do {
                auVar36._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 0xc) + (uint)*(ushort *)(lVar24 + -0xc));
                auVar36._4_8_ = SUB128(ZEXT812(0),4);
                auVar36._12_4_ = 0;
                auVar42._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 6) + (uint)*(ushort *)(lVar24 + -6));
            ...
            do {
              ...
              auVar49 = vpmovzxwd_avx2(auVar16._0_16_);
              auVar50 = vpmovzxwd_avx2(SUB3216(*(undefined1 (*) [32])(lVar24 + 6),0));
              auVar17 = vpmovzxwd_avx2(SUB3216(*(undefined1 (*) [32])(lVar24 + 6),0x10));
              ...
              auVar49 = vpmovzxwd_avx2(SUB3216(*pauVar1,0));
              auVar50 = vpmovzxwd_avx2(SUB3216(*pauVar1,0x10));
          ...
          if (uVar32 + 1 <= uVar23) {
            ...
            if (uVar29 < uVar28) {
              ...
              do {
                lVar2 = uVar29 * 2;
                auVar38._0_4_ =
                     (float)((uint)*(ushort *)(lVar24 + 0xc + uVar29 * 2) +
                            (uint)*(ushort *)(lVar31 + -0xc + uVar29 * 2));
                auVar38._4_8_ = SUB128(ZEXT812(0),4);
                auVar38._12_4_ = 0;
                lVar3 = uVar29 * 2;
                uVar29 = uVar29 + 1;
                auVar44._0_4_ =
                     (float)((uint)*(ushort *)(lVar24 + 6 + lVar3) +
                            (uint)*(ushort *)(lVar31 + -6 + lVar2));
...
LAB_140950549:
          ...
          uVar21 = param_2 & 0x1f;
          if (uVar21 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140950549;
            uVar21 = 0x20 - uVar21 >> 2;
          }
          if ((longlong)uVar23 < (longlong)(uVar21 + 0x10)) goto LAB_140950549;
          ...
          if (uVar21 != 0) {
            do {
              auVar45._0_4_ =
                   (float)((uint)*(ushort *)(lStack_98 + uVar26 * 2) +
                          (uint)*(ushort *)(lVar19 + uVar26 * 2));
          ...
          do {
            ...
            auVar16 = vpmovzxwd_avx2(auVar48._0_16_);
            auVar50 = vpmovzxwd_avx2(auVar52._0_16_);
        ...
        if (uVar28 + 1 <= uVar23) {
          ...
          if (uVar26 < uVar21) {
            ...
            do {
              auVar47._0_4_ =
                   (float)((uint)*(ushort *)
                                  (lVar18 + lVar30 * 6 + param_1 + uVar28 * 2 + uVar26 * 2) +
                          (uint)*(ushort *)
                                 (param_1 + lVar30 * -6 + lVar33 * 6 + uVar28 * 2 + uVar26 * 2));
  ...
  if (0xf < (longlong)uVar23) {
    uVar21 = param_2 & 0x1f;
    if (uVar21 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14095053b;
      uVar21 = 0x20 - uVar21 >> 2;
    }
    if ((longlong)(uVar21 + 0x10) <= (longlong)uVar23) {
      ...
      if (uVar21 != 0) {
        do {
          auVar39._0_4_ = (float)*(ushort *)(lStack_98 + 6 + uVar26 * 2);
      ...
      do {
        ...
        auVar52 = vpmovzxwd_avx2(auVar48._0_16_);
        auVar16 = vpmovzxwd_avx2(auVar48._16_16_);
        auVar48 = vcvtdq2ps_avx(auVar52);
  ...
  if (uVar28 + 1 <= uVar23) {
    ...
    if (uVar21 < uVar23) {
      ...
      do {
        lVar33 = uVar21 * 2;
        uVar21 = uVar21 + 1;
        auVar41._0_4_ = (float)*(ushort *)(lStack_98 + uVar28 * 2 + 6 + lVar33);
