...
undefined8
FUN_140007980(undefined1 (*param_1) [16],int param_2,undefined1 (*param_3) [16],int param_4,
             undefined8 param_5)

{
  ...
  if ((0 < (int)param_5) && (0 < (int)param_5._4_4_)) {
    uVar9 = 0;
    uVar10 = (int)param_5 >> 1;
    ...
    do {
      ...
      if (0 < (int)(uVar10 & 0xfffffff8)) {
        ...
        pauVar16 = param_1 + uVar17 * 3;
        auVar34 = ZEXT1664(_DAT_143085720);
        pauVar12 = param_3 + uVar17 * 2;
        auVar31 = ZEXT1664(_DAT_143085710);
        auVar37 = ZEXT1664(_DAT_143085700);
        auVar23 = ZEXT1664(_DAT_1430856a0);
        iVar19 = (int)uVar17 << 3;
      ...
      if (lVar13 < lVar11) {
        if (((longlong)pauVar12 - (longlong)pauVar16 < (lVar11 - iVar19) * 6) &&
          ...
          for (; uVar18 < uVar17; uVar18 = uVar18 + 1) {
            ...
            (*pauVar12)[uVar18 * 4 + 2] =
                 (char)((uint)(byte)(*pauVar16)[lVar13 + 3] * 0x41cb + (uint)bVar2 * 0x8106 +
                        0x100000 + (uint)bVar3 * 0x1917 >> 0x10);
            lVar20 = lVar13 + 1;
