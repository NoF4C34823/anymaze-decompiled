...
void FUN_140950ba0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)
...
LAB_140950ff6:
    ...
    if ((longlong)param_3 < 0x1d) {
      ...
      uVar23 = param_2 & 0x1f;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140950ff6;
        uVar23 = 0x20 - uVar23 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar23 + 0x10)) goto LAB_140950ff6;
      uVar21 = 0;
