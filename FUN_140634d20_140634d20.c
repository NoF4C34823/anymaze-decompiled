...
void FUN_140634d20(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140635670:
      uVar94 = 0;
      if (uVar100 == 0) goto LAB_140634f23;
      uVar95 = 0;
      uVar98 = uVar100;
    }
    else {
      uVar98 = param_2 & 0xf;
      if (uVar98 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140635670;
        uVar98 = 0x10 - uVar98 >> 2;
      }
      if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_140635670;
      ...
      if (uVar100 < uVar94 + 1) goto LAB_140634f23;
...
LAB_14063564b:
          uVar94 = 0;
          if (uVar100 == 0) goto LAB_14063548c;
          uVar95 = 0;
          uVar98 = uVar100;
        }
        else {
          uVar98 = param_2 & 0xf;
          if (uVar98 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14063564b;
            uVar98 = 0x10 - uVar98 >> 2;
          }
          if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_14063564b;
          uVar94 = uVar100 - (uVar100 - uVar98 & 7);
          ...
          if (uVar100 < uVar94 + 1) goto LAB_14063548c;
          uVar98 = uVar100 - uVar94;
          if ((longlong)uVar98 < 4) {
            uVar95 = 0;
          }
...
LAB_140635638:
    ...
    uVar98 = param_2 & 0xf;
    if (uVar98 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140635638;
      uVar98 = 0x10 - uVar98 >> 2;
    }
    if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_140635638;
    uVar95 = 0;
    uVar94 = uVar100 - (uVar100 - uVar98 & 7);
    if (uVar98 != 0) {
      do {
