...
void FUN_1403e7fa0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar26 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403db020(lVar22,lVar24,(longlong)(int)param_5,(longlong)(int)param_6,1);
        lVar18 = lVar18 + 1;
          ...
          do {
            ...
            if (0 < param_6._4_4_) {
              ...
              if (uVar30 != 0) {
                ...
                bVar34 = 0xff;
                do {
                  if (*(byte *)(param_9 + uVar23 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(param_9 + uVar23 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar7 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar7 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar3 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar3 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar6 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar6 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar14 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar14 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar5 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar5 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar2 + lVar12 * 8) < bVar34) {
                    bVar34 = *(byte *)(lVar2 + lVar12 * 8);
                  }
                  if (*(byte *)(lVar1 + lVar12 * 8) < bVar34) {
              ...
              if (uVar19 <= (ulonglong)(longlong)param_6._4_4_) {
                    /* WARNING: Could not recover jumptable at 0x0001403e844d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_1403e844f +
                          (byte)(&DAT_143089e80)[(uint)(param_6._4_4_ - (int)uVar19)]))
...
LAB_1403e8ace:
                    ...
                    if (lVar14 < (longlong)(uVar19 + 0x10)) goto LAB_1403e8ace;
                    uVar25 = 0;
                    uVar29 = lVar14 - (lVar14 - uVar19 & 0xf);
                    if (uVar19 != 0) {
                      do {
                        if ((*(char *)(uVar25 + uVar23) != '\0') &&
                           (*(byte *)(lVar1 + lVar12 + uVar25) < bVar34)) {
                    ...
                    do {
                      ...
                      uVar19 = uVar19 + 0x10;
                      bVar10 = auVar36[0];
                      auVar32[0] = (bVar10 < bVar34) * bVar10 | (bVar10 >= bVar34) * bVar34;
                      bVar34 = auVar36[1];
                      auVar32[1] = (bVar34 < bVar33) * bVar34 | (bVar34 >= bVar33) * bVar33;
                      bVar34 = auVar36[2];
                      auVar32[2] = (bVar34 < bVar37) * bVar34 | (bVar34 >= bVar37) * bVar37;
                      bVar34 = auVar36[3];
                      auVar32[3] = (bVar34 < bVar38) * bVar34 | (bVar34 >= bVar38) * bVar38;
                      bVar34 = auVar36[4];
                      auVar32[4] = (bVar34 < bVar39) * bVar34 | (bVar34 >= bVar39) * bVar39;
                      bVar34 = auVar36[5];
                      auVar32[5] = (bVar34 < bVar40) * bVar34 | (bVar34 >= bVar40) * bVar40;
                      bVar34 = auVar36[6];
                      auVar32[6] = (bVar34 < bVar41) * bVar34 | (bVar34 >= bVar41) * bVar41;
                      bVar34 = auVar36[7];
                      auVar32[7] = (bVar34 < bVar42) * bVar34 | (bVar34 >= bVar42) * bVar42;
                      bVar34 = auVar36[8];
                      auVar32[8] = (bVar34 < bVar43) * bVar34 | (bVar34 >= bVar43) * bVar43;
                      bVar34 = auVar36[9];
                      auVar32[9] = (bVar34 < bVar8) * bVar34 | (bVar34 >= bVar8) * bVar8;
                      bVar34 = auVar36[10];
                      auVar32[10] = (bVar34 < bVar9) * bVar34 | (bVar34 >= bVar9) * bVar9;
                      bVar34 = auVar36[0xb];
                      auVar32[0xb] = (bVar34 < bVar15) * bVar34 | (bVar34 >= bVar15) * bVar15;
                      bVar34 = auVar36[0xc];
                      auVar32[0xc] = (bVar34 < bVar13) * bVar34 | (bVar34 >= bVar13) * bVar13;
                      bVar34 = auVar36[0xd];
                      auVar32[0xd] = (bVar34 < bVar16) * bVar34 | (bVar34 >= bVar16) * bVar16;
                      bVar34 = auVar36[0xe];
                      auVar32[0xe] = (bVar34 < bVar17) * bVar34 | (bVar34 >= bVar17) * bVar17;
                      bVar34 = auVar36[0xf];
                      auVar32[0xf] = (bVar34 < bVar21) * bVar34 | (bVar34 >= bVar21) * bVar21;
                      auVar36 = auVar32 & auVar31 | ~auVar31 & auVar36;
                    } while (uVar19 < uVar29);
                    bVar34 = auVar36[8];
                    bVar33 = auVar36[0];
                    bVar33 = (bVar34 < bVar33) * bVar34 | (bVar34 >= bVar33) * bVar33;
                    bVar34 = auVar36[9];
                    bVar37 = auVar36[1];
                    bVar37 = (bVar34 < bVar37) * bVar34 | (bVar34 >= bVar37) * bVar37;
                    bVar34 = auVar36[10];
                    bVar38 = auVar36[2];
                    bVar38 = (bVar34 < bVar38) * bVar34 | (bVar34 >= bVar38) * bVar38;
                    bVar34 = auVar36[0xb];
                    bVar39 = auVar36[3];
                    bVar39 = (bVar34 < bVar39) * bVar34 | (bVar34 >= bVar39) * bVar39;
                    bVar34 = auVar36[0xc];
                    bVar40 = auVar36[4];
                    bVar40 = (bVar34 < bVar40) * bVar34 | (bVar34 >= bVar40) * bVar40;
                    bVar34 = auVar36[0xd];
                    bVar41 = auVar36[5];
                    bVar41 = (bVar34 < bVar41) * bVar34 | (bVar34 >= bVar41) * bVar41;
                    bVar34 = auVar36[0xe];
                    bVar42 = auVar36[6];
                    bVar42 = (bVar34 < bVar42) * bVar34 | (bVar34 >= bVar42) * bVar42;
                    bVar34 = auVar36[0xf];
                    bVar43 = auVar36[7];
                    bVar43 = (bVar34 < bVar43) * bVar34 | (bVar34 >= bVar43) * bVar43;
                    bVar34 = (bVar40 < bVar33) * bVar40 | (bVar40 >= bVar33) * bVar33;
                    bVar33 = (bVar41 < bVar37) * bVar41 | (bVar41 >= bVar37) * bVar37;
                    bVar37 = (bVar42 < bVar38) * bVar42 | (bVar42 >= bVar38) * bVar38;
                    bVar38 = (bVar43 < bVar39) * bVar43 | (bVar43 >= bVar39) * bVar39;
                    bVar34 = (bVar37 < bVar34) * bVar37 | (bVar37 >= bVar34) * bVar34;
                    bVar33 = (bVar38 < bVar33) * bVar38 | (bVar38 >= bVar33) * bVar33;
                  ...
                  for (; uVar29 < (ulonglong)(longlong)(int)param_6; uVar29 = uVar29 + 1) {
                    if ((*(char *)(uVar29 + uVar23) != '\0') &&
                       (*(byte *)(lVar1 + lVar12 + uVar29) < bVar34)) {
