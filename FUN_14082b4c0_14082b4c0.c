...
void FUN_14082b4c0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar32) {
    uVar30 = param_2 & 0x1f;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14082b6b4;
...
LAB_14082b6bd:
  FUN_14082b673(fVar6,fVar5,param_3,0);
  return;
}
