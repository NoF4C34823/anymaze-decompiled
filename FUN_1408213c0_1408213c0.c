...
void FUN_1408213c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001408225b5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c700)[lVar30])(param_1,param_4,*param_5,param_9);
    return;
  }
...
LAB_140822410:
        ...
        *(byte *)(lVar28 + 2 + param_11) = bVar20;
        lVar28 = lVar28 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001408224af. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c700)[lVar30])(param_11 + lVar29 * 3,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar17 = lVar29 * 3;
...
LAB_1408224b2:
            ...
            if ((longlong)uVar13 < (longlong)(uVar10 + 0x10)) goto LAB_1408224b2;
            uVar21 = 0;
...
LAB_1408215cf:
    ...
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308c700)[lVar30];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001408224fa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (0 < lVar30) {
      ...
      if ((longlong)uVar13 < 7) {
        ...
        if ((longlong)uVar13 < 0x10) {
          ...
          auVar6 = vpshufb_avx(auVar6,_DAT_14308c800);
          auVar4 = vpshufb_avx(auVar5,_DAT_14308c810);
          auVar6 = vpor_avx(auVar6,auVar4);
          auVar4 = vpshufb_avx(auVar31,_DAT_14308c820);
          auVar32 = vpshufb_avx(auVar5,_DAT_14308c830);
          auVar5 = vpshufb_avx(auVar5,_DAT_14308c860);
          auVar31 = vpunpckhbw_avx(auVar31,auVar7);
          auVar4 = vpor_avx(auVar4,auVar32);
          auVar32 = vpshufb_avx(auVar7,_DAT_14308c840);
          auVar31 = vpshufb_avx(auVar31,_DAT_14308c850);
          auVar4 = vpor_avx(auVar4,auVar32);
...
LAB_1408222d4:
                    /* WARNING: Could not recover jumptable at 0x000140822302. Too many branches */
                    /* WARNING: Treating indirect jump as call */
