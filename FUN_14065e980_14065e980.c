...
void FUN_14065e980(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14065ef19:
      uVar28 = 0;
      if (param_5 == 0) goto LAB_14065ec28;
      uVar24 = 0;
      uVar22 = param_5;
    }
    else {
      ...
      uVar22 = uVar21 & 0xf;
      if (uVar22 != 0) {
        if ((uVar21 & 3) != 0) goto LAB_14065ef19;
        uVar22 = 0x10 - uVar22 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar22 + 8)) goto LAB_14065ef19;
      ...
      if (param_5 < uVar28 + 1) goto LAB_14065ec28;
...
LAB_14065ec28:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar22 & 0xf;
      if (uVar21 != 0) {
        if ((uVar22 & 3) != 0) goto LAB_14065ef36;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)(uVar21 + 4) <= (longlong)param_5) {
        uVar24 = 0;
        uVar28 = param_5 - (param_5 - uVar21 & 3);
        uVar16 = _UNK_14308b84c;
        uVar17 = _UNK_14308b848;
        uVar18 = _UNK_14308b844;
        uVar19 = _DAT_14308b840;
        if (uVar21 != 0) {
          do {
...
LAB_14065eecf:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar21 = uVar22 & 0xf;
    if (uVar21 != 0) {
      if ((uVar22 & 3) != 0) goto LAB_14065ef2f;
      uVar21 = 0x10 - uVar21 >> 2;
    }
