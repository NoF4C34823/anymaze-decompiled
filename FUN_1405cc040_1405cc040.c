...
void FUN_1405cc040(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1405cc94e:
      uVar40 = 0;
      if (param_3 == 0) goto LAB_1405cc246;
      uVar38 = 0;
      uVar42 = param_3;
    }
    else {
      uVar42 = param_2 & 0xf;
      if (uVar42 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1405cc94e;
        uVar42 = 0x10 - uVar42 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_1405cc94e;
      ...
      if (param_3 < uVar40 + 1) goto LAB_1405cc246;
...
LAB_1405cc928:
          uVar40 = 0;
          if (param_3 == 0) goto LAB_1405cc771;
          uVar38 = 0;
          uVar42 = param_3;
        }
        else {
          uVar42 = param_2 & 0xf;
          if (uVar42 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1405cc928;
            uVar42 = 0x10 - uVar42 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_1405cc928;
          ...
          if (param_3 < uVar40 + 1) goto LAB_1405cc771;
          uVar42 = param_3 - uVar40;
          if ((longlong)uVar42 < 4) {
            uVar38 = 0;
          }
...
LAB_1405cc915:
    ...
    uVar42 = param_2 & 0xf;
    if (uVar42 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1405cc915;
      uVar42 = 0x10 - uVar42 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_1405cc915;
    uVar38 = 0;
    uVar40 = param_3 - (param_3 - uVar42 & 7);
    if (uVar42 != 0) {
      do {
