...
void FUN_1402c9f33(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < in_stack_000000f0._4_4_) {
    do {
      FUN_1402dd1e0(unaff_RSI,unaff_RBX,lStack0000000000000068,lStack0000000000000060,3);
      thunk_FUN_142d20530(in_stack_00000110,param_1,lVar3,lStack0000000000000068,lVar1);
