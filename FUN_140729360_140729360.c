...
void FUN_140729360(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14072a016:
      ...
      uVar24 = param_2 & 0xf;
      if (uVar24 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14072a016;
        uVar24 = 0x10 - uVar24 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar24 + 8)) goto LAB_14072a016;
      uVar28 = 0;
...
LAB_140729fe0:
          uVar26 = 0;
          if (param_3 == 0) goto LAB_140729dcd;
          uVar28 = 0;
          uVar24 = param_3;
        }
        else {
          uVar24 = param_2 & 0xf;
          if (uVar24 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140729fe0;
            uVar24 = 0x10 - uVar24 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar24 + 0x10)) goto LAB_140729fe0;
          ...
          if (param_3 < uVar26 + 1) goto LAB_140729dcd;
...
LAB_140729dcd:
  ...
  if (0xf < (longlong)param_3) {
    uVar24 = param_2 & 0xf;
    if (uVar24 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140729fd5;
      uVar24 = 0x10 - uVar24 >> 2;
    }
    if ((longlong)(uVar24 + 0x10) <= (longlong)param_3) {
      ...
      goto joined_r0x000140729f98;
    }
  }
LAB_140729fd5:
  uVar26 = 0;
joined_r0x000140729f98:
