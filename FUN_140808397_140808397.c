...
void FUN_140808397(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         param_2 * (float)((uint)*(ushort *)(param_4 + -4 + in_RAX * 2) +
                          (uint)*(ushort *)(param_4 + 4 + in_RAX * 2)) +
         in_XMM4_Da *
         (float)((uint)*(ushort *)(param_4 + -2 + in_RAX * 2) +
                (uint)*(ushort *)(param_4 + 2 + in_RAX * 2)) +
  ...
  do {
    ...
    auVar11 = vpmovzxwd_avx(auVar9);
    auVar10._8_8_ = 0;
    auVar10._0_8_ = *(ulonglong *)(param_4 + 8 + in_RDX * 2);
    auVar13 = vpmovzxwd_avx(auVar10);
  ...
  if (param_1 < param_3) {
    do {
      *(float *)(in_R10 + param_1 * 4) =
           param_2 * (float)((uint)*(ushort *)(param_4 + -4 + param_1 * 2) +
                            (uint)*(ushort *)(param_4 + 4 + param_1 * 2)) +
           in_XMM4_Da *
           (float)((uint)*(ushort *)(param_4 + -2 + param_1 * 2) +
                  (uint)*(ushort *)(param_4 + 2 + param_1 * 2)) +
