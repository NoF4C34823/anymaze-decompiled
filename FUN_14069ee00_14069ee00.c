...
void FUN_14069ee00(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_14069f077:
    ...
    uVar20 = param_2 & 0xf;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14069f077;
      uVar20 = 0x10 - uVar20 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar20 + 8)) goto LAB_14069f077;
    uVar17 = 0;
