...
void FUN_140823260(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140824274. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c720)[lVar6])(puVar22,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140824200;
                while (uVar13 == 0) {
                  for (lVar24 = (lVar15 + -1) * 2 - lVar24; lVar24 < 0; lVar24 = -lVar24) {
LAB_140824200:
                    if (uVar8 != 0) goto LAB_140824102;
                  }
          ...
          uVar23 = uVar25;
          if (uVar21 != 0) goto LAB_140824102;
        }
        else {
LAB_140824102:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar23;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140824162. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c720)[lVar6])(param_11 + uVar12 * 2,param_4,lVar15,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_140824176:
              ...
              uVar7 = uVar17 & 0xf;
              if (uVar7 != 0) {
                if ((uVar17 & 1) != 0) goto LAB_140824176;
                uVar7 = 0x10 - uVar7 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar7 + 8)) goto LAB_140824176;
...
LAB_1408236bd:
      if (uVar18 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_1408238cd;
...
LAB_1408241d8:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1408241d8;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1408241d8;
          uVar11 = 0;
...
LAB_14082417d:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14082417d;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_14082417d;
          uVar11 = 0;
          uVar9 = uVar12 - (uVar12 - uVar7 & 7);
          if (uVar7 != 0) {
            do {
...
LAB_1408238cd:
      (*(code *)(&PTR_FUN_14308c720)[lVar6])(uVar17,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001408241d5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c720)[lVar6])(puVar22,param_4,lVar15);
    return;
  }
  if ((longlong)uVar12 < lVar15) {
    lVar15 = lVar15 - uVar12;
    (*(code *)(&PTR_FUN_14308c720)[lVar6])(puVar22,param_4,lVar15,param_9,param_10);
...
LAB_140824185:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140824185;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_140824185;
...
LAB_140823d1c:
  if (uVar18 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_140823fba;
...
LAB_140824193:
          ...
          uVar17 = uVar19 & 0xf;
          if (uVar17 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_140824193;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_140824193;
          uVar7 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar12 < 1)) goto LAB_140823fba;
  if ((longlong)uVar12 < 8) {
LAB_14082418c:
    uVar17 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar15 - 2U & 1) != 0) goto LAB_14082418c;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar19 + 8)) goto LAB_14082418c;
    uVar7 = 0;
...
LAB_140823fba:
                    /* WARNING: Could not recover jumptable at 0x000140823ff8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c720)[lVar6])(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
