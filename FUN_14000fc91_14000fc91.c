...
void FUN_14000fc91(byte *param_1,undefined1 *param_2,uint param_3)
  ...
  if (((longlong)param_2 - (longlong)param_1 < (longlong)((ulonglong)param_3 * 4 + -1)) &&
    ...
    if (param_3 >> 1 != 0) {
      do {
        uVar6 = uVar7;
        param_2[uVar6 * 2] =
             (char)(param_1[uVar6 * 8] * uVar3 + param_1[uVar6 * 8 + 1] * uVar2 + 0x4000 +
                    param_1[uVar6 * 8 + 2] * uVar1 >> 0xf);
        param_2[uVar6 * 2 + 1] =
             (char)(param_1[uVar6 * 8 + 4] * uVar3 + param_1[uVar6 * 8 + 5] * uVar2 + 0x4000 +
                    param_1[uVar6 * 8 + 6] * uVar1 >> 0xf);
        uVar7 = uVar6 + 1;
      } while (uVar7 < param_3 >> 1);
      iVar4 = (int)uVar6 + 2 + (int)uVar7;
    }
    if (param_3 <= iVar4 - 1U) {
      return;
    }
    ...
    param_2[lVar5 + -1] =
         (char)(uVar3 * param_1[lVar5 * 4 + -4] + uVar2 * param_1[lVar5 * 4 + -3] + 0x4000 +
                uVar1 * param_1[lVar5 * 4 + -2] >> 0xf);
    return;
  }
  switch(param_3) {
  case 1:
...
LAB_14000fe54:
  *param_2 = (char)(uVar3 * *param_1 + uVar2 * param_1[1] + 0x4000 + uVar1 * param_1[2] >> 0xf);
