...
ulonglong FUN_1406ad440(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    uVar3 = (**(code **)(&DAT_14308b9c0 + (longlong)param_6 * 8))
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return uVar3;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1406ad556;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x0001406ad71c;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_1406ad556;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x0001406ad71c:
      if (uVar2 == 0) {
...
LAB_1406ad556:
  lStack_28 = *param_5;
  lStack_20 = param_5[1];
  uVar3 = FUN_1406b3be0(param_1,param_2,param_3,param_4,&lStack_28,param_6,param_7,param_8,param_9,
                        param_10,param_11);
  return uVar3;
}
