...
void FUN_1400b1ec0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_1400b2168:
    ...
    uVar22 = param_2 & 0x1f;
    if (uVar22 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400b2168;
      uVar22 = 0x20 - uVar22 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar22 + 0x10)) goto LAB_1400b2168;
    uVar20 = 0;
