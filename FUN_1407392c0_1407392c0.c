...
/* WARNING: Removing unreachable block (ram,0x00014073a09e) */

void FUN_1407392c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308bf80)[lVar20])(param_1,param_4,*param_5,param_9);
...
LAB_14073a36f:
    ...
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308bf80)[lVar20])(param_11 + lVar24 * 6,param_4,lVar14,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_118 = lVar24 * 3;
...
LAB_14073a446:
              ...
              if (uVar13 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_14073a446;
                uVar13 = 0x10 - uVar13 >> 1;
              }
              if ((longlong)uVar9 < (longlong)(uVar13 + 8)) goto LAB_14073a446;
...
LAB_140739c2b:
      uStack_140 = uVar9;
      pcStack_138 = (code *)(&PTR_FUN_14308bf80)[lVar20];
      iStack_158 = param_10;
      lStack_110 = param_1;
      uStack_108 = param_7;
