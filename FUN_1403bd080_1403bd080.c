...
void FUN_1403bd080(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar21 - 1)) {
      while( true ) {
        FUN_1403a4f20(uVar23,lVar19,uVar4,uVar16,1);
        uVar21 = param_6[1];
        lVar9 = lVar9 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_1403a4f20(uVar23,lVar19,uVar4,*param_6,1);
        thunk_FUN_142d23d30(param_9,uVar17,param_3,uVar4,param_6[1]);
        lVar9 = lVar9 + 1;
        lVar10 = lVar10 + 1;
        lVar19 = lVar19 + uVar17 * 4;
                  ...
                  if (uVar13 < uVar16) {
                    do {
                      if ((*(char *)(uVar13 + param_7 + lVar20) != '\0') &&
                         (fVar3 = *(float *)(lVar1 + lVar11 + uVar13 * 4), auVar27._0_4_ <= fVar3))
                      {
                        auVar27._0_4_ = fVar3;
                      }
                      uVar13 = uVar13 + 1;
