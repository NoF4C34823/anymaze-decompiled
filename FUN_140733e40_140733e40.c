...
void FUN_140733e40(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1407343b6:
      uVar25 = 0;
      if (param_5 == 0) goto LAB_1407340e9;
      uVar21 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar18 & 0xf;
      if (uVar19 != 0) {
        if ((uVar18 & 3) != 0) goto LAB_1407343b6;
        uVar19 = 0x10 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 8)) goto LAB_1407343b6;
      ...
      if (param_5 < uVar25 + 1) goto LAB_1407340e9;
...
LAB_1407340e9:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar18 = param_4 & 0xf;
      if (uVar18 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1407343d3;
...
LAB_140734360:
  ...
  if (7 < (longlong)param_5) {
    uVar18 = param_4 & 0xf;
    if (uVar18 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1407343cc;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)(uVar18 + 8) <= (longlong)param_5) {
      uVar25 = 0;
