...
void FUN_14047c940(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar8 != 0 && SCARRY8(lVar6,-1) == lVar8 < 0) {
      do {
        FUN_140449740(param_1,lVar4,lVar1,lVar2,4);
        lVar7 = lVar7 + 1;
    ...
    if (0 < (longlong)param_5._4_4_) {
      do {
        FUN_140449740(param_1,lVar4,lVar1,lVar2,4);
        thunk_FUN_142d27530(param_9,uVar5,param_3,lVar1,lVar6);
        lVar9 = lVar8 + 1;
        lVar7 = lVar7 + 1;
        lVar8 = lVar9;
        if (lVar6 <= lVar9) {
