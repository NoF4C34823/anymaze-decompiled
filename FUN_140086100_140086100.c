...
void FUN_140086100(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140086ba1:
      ...
      uVar32 = 0;
      uVar35 = param_3;
      if (param_3 == 0) goto LAB_14008631c;
    }
    else {
      uVar35 = (ulonglong)param_2 & 0xf;
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140086ba1;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140086ba1;
      uVar32 = 0;
      ...
      if (param_3 < uVar33 + 1) goto LAB_14008631c;
...
LAB_140086b65:
          uVar32 = 0;
          if (param_3 == 0) goto LAB_140086984;
          uVar33 = 0;
          uVar35 = param_3;
        }
        else {
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140086b65;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140086b65;
          ...
          if (param_3 < uVar32 + 1) goto LAB_140086984;
...
LAB_140086984:
  ...
  if (7 < (longlong)param_3) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_140086b52;
      uVar35 = 0x10 - uVar35 >> 2;
    }
