...
void FUN_14038b8c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  param_1 = param_1 + ((longlong)((int)param_6 + -1 >> 1) * 4 + (param_6._4_4_ + -1 >> 1) * lVar2) *
                      -4;
  if (param_7 == 0) {
    lVar6 = 0;
    ...
    if (lVar4 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403bffa0(param_1,lVar3,lVar5,(longlong)(int)param_6,4);
        lVar6 = lVar6 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403bffa0(param_1,lVar3,lVar5,(longlong)(int)param_6,4);
        thunk_FUN_142d25930(param_9,uVar1,param_3,lVar5,(longlong)param_6._4_4_);
        lVar4 = lVar4 + 1;
        lVar6 = lVar6 + 1;
        lVar3 = lVar3 + uVar1 * 4;
    ...
    FUN_1403d1560(param_1,lVar2,param_3,(longlong)param_4 >> 2,lVar5,(longlong)param_5._4_4_,
