...
void FUN_1401f9d60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1401f9e65:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar8) && (param_7 != 0xf0)) {
      if (uVar10 == 6) {
        if (uStack_b0 == 0) goto LAB_1401f9fab;
      }
      else {
        if (uVar10 != 1) goto LAB_1401f9ea0;
        if (uStack_b0 == 0) {
          uVar11 = param_5[1] - 1;
        }
      }
...
LAB_1401f9f40:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_1401faa00(lStack_78,lStack_70,uVar11,param_3,in_stack_fffffffffffffee8,(int)lStack_50,
        ...
        if (uStack_48 <= uVar8) {
          ...
          if (uStack_a0 != 0) {
            ...
            do {
              uStack_d8 = *param_5;
              uStack_d0 = param_5[1];
              FUN_1401faa00(lStack_78,lStack_70,lVar13,lVar3,&uStack_d8,(int)lStack_50,param_7,
...
LAB_1401fa22d:
        ...
        (**(code **)(&DAT_143088200 + lStack_50 * 8))
      ...
      if (-1 < (longlong)uVar8) goto LAB_1401f9e65;
      uVar11 = uVar8;
      if (param_7 == 0xf0) goto LAB_1401f9f40;
      if (uVar10 != 6) {
        if (uVar10 != 1) goto LAB_1401f9ea0;
        uVar11 = 0;
        if (uStack_a0 != 0) {
      ...
      if (uStack_a0 != 0) goto LAB_1401f9f40;
LAB_1401f9fab:
      uVar11 = *param_5;
...
LAB_1401fa944:
      uVar12 = 0;
      if (uVar11 == 0) goto LAB_1401fa100;
LAB_1401fa951:
      uVar15 = 0;
    }
    else {
      ...
      uVar15 = uVar6 & 0x1f;
      if (uVar15 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_1401fa944;
        uVar15 = 0x20 - uVar15 >> 2;
      }
      if ((longlong)uVar11 < (longlong)(uVar15 + 0x10)) goto LAB_1401fa944;
      uVar14 = 0;
      ...
      if (uVar11 < uVar12 + 1) goto LAB_1401fa100;
      uVar11 = uVar11 - uVar12;
      if ((longlong)uVar11 < 4) goto LAB_1401fa951;
...
LAB_1401fa6cf:
            ...
            uVar9 = uVar11 & 0x1f;
            if (uVar9 != 0) {
              if ((uVar11 & 3) != 0) goto LAB_1401fa6cf;
              uVar9 = 0x20 - uVar9 >> 2;
            }
            if ((longlong)uVar8 < (longlong)(uVar9 + 8)) goto LAB_1401fa6cf;
            uVar15 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_d8 = *param_5;
      uStack_d0 = param_5[1];
      FUN_1401faa00(lStack_78,lStack_70,lVar3,lStack_98,&uStack_d8,(int)lStack_50,param_7,param_8,
...
LAB_1401fa4e5:
            ...
            uVar11 = uVar9 & 0x1f;
            if (uVar11 != 0) {
              if ((uVar9 & 3) != 0) goto LAB_1401fa4e5;
              uVar11 = 0x20 - uVar11 >> 2;
            }
            if ((longlong)uVar8 < (longlong)(uVar11 + 8)) goto LAB_1401fa4e5;
...
LAB_1401f9ea0:
  ...
  if (uVar10 == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar8 < 0) goto LAB_1401fa1c0;
      while (uStack_b0 == 0) {
