...
void FUN_14065b120(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar37 = param_4 & 0xf;
      if (uVar37 != 0) {
        if ((param_4 & 3) != 0) goto LAB_14065b8c4;
...
LAB_14065b8b4:
    ...
    uVar37 = param_4 & 0xf;
    if (uVar37 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14065b8b4;
      uVar37 = 0x10 - uVar37 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar37 + 8)) goto LAB_14065b8b4;
