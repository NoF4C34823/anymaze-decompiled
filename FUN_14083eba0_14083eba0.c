...
/* WARNING: Removing unreachable block (ram,0x00014083fcd1) */

void FUN_14083eba0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c920)[lStack_e0])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar23 != 6) {
            if (uVar23 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar16 < 0) goto LAB_140840220;
                while (uVar7 == 0) {
                  for (lVar11 = (lVar15 + -1) * 2 - lVar11; lVar11 < 0; lVar11 = -lVar11) {
LAB_140840220:
                    if (uVar19 != 0) goto LAB_1408400cf;
                  }
...
LAB_1408400cf:
    ...
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c920)[lStack_e0])(param_11 + lVar26 * 6,param_4,lVar15,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar20 = lVar16 * 3;
...
LAB_1408401a2:
              ...
              if (uVar10 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_1408401a2;
                uVar10 = 0x10 - uVar10 >> 1;
              }
              if ((longlong)uVar12 < (longlong)(uVar10 + 8)) goto LAB_1408401a2;
              uVar18 = 0;
...
LAB_14083f701:
      pcStack_148 = (code *)(&PTR_FUN_14308c920)[lStack_e0];
      iStack_158 = param_10;
      uStack_110 = param_7;
      lStack_108 = param_1;
