...
void thunk_FUN_140d1d680(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
...

{
  ...
  if (param_5 == 3) {
    if (0 < (longlong)uVar5) {
      do {
        ...
        auVar22 = vmaxps_avx(*param_1,auVar26);
        ...
        auVar28 = vmaxps_avx(auVar28,auVar20);
    ...
    do {
      ...
      if (0 < param_5) {
        do {
          lVar6 = lVar6 + 1;
          auVar13 = vmaxps_avx(auVar13,*pauVar8);
          auVar28 = vmaxps_avx(auVar28,pauVar8[1]);
          auVar29 = vmaxps_avx(auVar24._0_32_,pauVar8[2]);
          auVar24 = ZEXT3264(auVar29);
          pauVar1 = pauVar8 + 3;
          pauVar8 = (undefined1 (*) [32])(*pauVar8 + param_2 * 4);
          auVar14 = vmaxps_avx(auVar37._0_32_,*pauVar1);
  ...
  auVar13 = _DAT_143091f20;
  auVar22 = _DAT_143091f20;
  for (; _DAT_143091f20 = auVar22, lVar11 < (longlong)(param_4 & 0xfffffffffffffff0);
      lVar11 = lVar11 + 0x10) {
    lVar6 = 0;
    pauVar8 = param_1;
    auVar22 = auVar13;
  ...
  for (; lVar11 < (longlong)(param_4 & 0xfffffffffffffff8); lVar11 = lVar11 + 8) {
    ...
    if (0 < param_5) {
      do {
        ...
        lVar9 = lVar9 + param_2;
        auVar13 = vmaxps_avx(auVar13,auVar36);
      } while (lVar6 < param_5);
    }
    param_1 = param_1 + 1;
    _DAT_143091f40 = auVar3;
    *param_3 = auVar13._0_16_;
    param_3[1] = auVar13._16_16_;
    param_3 = param_3 + 2;
    auVar3 = _DAT_143091f40;
  ...
  for (; lVar11 < (longlong)(param_4 & 0xfffffffffffffffc); lVar11 = lVar11 + 4) {
    ...
    if (0 < param_5) {
      do {
        lVar6 = lVar6 + 1;
        auVar25 = vmaxps_avx(auVar25,*(undefined1 (*) [16])(*param_1 + lVar9 * 4));
        lVar9 = lVar9 + param_2;
      } while (lVar6 < param_5);
    }
    param_1 = (undefined1 (*) [32])(*param_1 + 0x10);
    _DAT_143091f40 = auVar4;
    *param_3 = auVar25;
    param_3 = param_3 + 1;
    auVar4 = _DAT_143091f40;
  }
  auVar3 = auVar4;
  for (; _DAT_143091f40 = auVar3, lVar11 < (longlong)(param_4 & 0xfffffffffffffffe);
      lVar11 = lVar11 + 2) {
    lVar9 = 0;
    uVar19 = auVar4._0_8_;
    lVar6 = 0;
    ...
    if (0 < param_5) {
      do {
        ...
        auVar3 = vmaxps_avx(auVar3,auVar25);
        uVar19 = auVar3._0_8_;
      } while (lVar9 < param_5);
    }
  ...
  for (; lVar11 < (longlong)param_4; lVar11 = lVar11 + 1) {
    ...
    if (0 < param_5) {
      do {
        ...
        lVar6 = lVar6 + param_2 * 4;
        auVar4 = vmaxps_avx(auVar24._0_16_,ZEXT416(*puVar2));
