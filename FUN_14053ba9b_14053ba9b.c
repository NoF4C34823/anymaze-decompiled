...
void FUN_14053ba9b(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
                  longlong param_4)

{
  ...
  do {
    ...
    if (lVar11 != 0) {
      ...
      auVar13 = vmaxps_avx(*pauVar6,*pauVar8);
      pauVar12 = (undefined1 (*) [32])(*pauVar6 + in_R10 * 8);
      auVar13 = vmaxps_avx(auVar13,*pauVar12);
      lVar5 = 0;
      auVar2 = auVar13;
      if (1 < lVar11) {
        do {
          lVar5 = lVar5 + 1;
          auVar13 = vmaxps_avx(pauVar6[1],
                               *(undefined1 (*) [32])(pauVar6[1] + lStack0000000000000058));
          auVar13 = vmaxps_avx(auVar13,*(undefined1 (*) [32])(pauVar6[1] + lStack0000000000000050));
          pauVar6 = pauVar6 + 1;
      ...
      auVar2 = vmaxps_avx(auVar2,ZEXT832(*(ulonglong *)pauVar12[1]));
      ...
      auVar13 = vmaxps_avx(auVar2,auVar13);
      *pauVar9 = auVar13;
    }
    if ((uVar10 & 7) != 0) {
      FUN_14053bc60(pauVar6);
    }
    in_RAX = in_RAX + 1;
