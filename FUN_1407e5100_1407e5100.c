...
void FUN_1407e5100(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1407e5b14:
      uVar49 = 0;
      if (uVar51 == 0) goto LAB_1407e5347;
      uVar48 = 0;
      uVar50 = uVar51;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1407e5b14;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_1407e5b14;
      uVar48 = 0;
      ...
      if (uVar51 < uVar49 + 1) goto LAB_1407e5347;
...
LAB_1407e5aee:
          uVar49 = 0;
          if (uVar51 == 0) goto LAB_1407e590f;
          uVar48 = 0;
          uVar50 = uVar51;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1407e5aee;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_1407e5aee;
          uVar49 = uVar51 - (uVar51 - uVar50 & 0xf);
          ...
          if (uVar51 < uVar49 + 1) goto LAB_1407e590f;
          uVar50 = uVar51 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar48 = 0;
          }
...
LAB_1407e5ada:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407e5ada;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_1407e5ada;
    uVar48 = 0;
    uVar49 = uVar51 - (uVar51 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
