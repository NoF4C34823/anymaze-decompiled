...
void FUN_1408cbdc0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)
...
LAB_1408cbf95:
    ...
    if ((longlong)uVar9 < 0x1d) {
      ...
      uVar8 = param_2 & 0x1f;
      if (uVar8 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1408cbf95;
        uVar8 = 0x20 - uVar8 >> 2;
      }
      if ((longlong)uVar9 < (longlong)(uVar8 + 0x10)) goto LAB_1408cbf95;
      uVar7 = 0;
