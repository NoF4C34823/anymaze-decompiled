...
void FUN_1407c7140(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar10 = uVar23 & 0xf;
      if (uVar10 != 0) {
        if ((uVar23 & 3) != 0) goto LAB_1407c79ec;
...
LAB_1407c7a7f:
    ...
    uVar23 = uVar22 & 0xf;
    if (uVar23 != 0) {
      if ((uVar22 & 3) != 0) goto LAB_1407c7a7f;
      uVar23 = 0x10 - uVar23 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar23 + 8)) goto LAB_1407c7a7f;
