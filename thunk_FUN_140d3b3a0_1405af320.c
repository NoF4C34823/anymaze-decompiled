...
void thunk_FUN_140d3b3a0(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
...

{
  ...
  if (0 < (longlong)(param_4 & 0xffffffffffffff80)) {
    auVar7 = vmovdqu32_avx512f(_DAT_143092680);
    do {
      lVar5 = 0;
      pauVar3 = param_1;
      auVar11 = auVar7;
      ...
      if (0 < param_5) {
        do {
          lVar5 = lVar5 + 1;
          auVar8 = vpminsw_avx512bw(auVar8,*pauVar3);
          auVar9 = vpminsw_avx512bw(auVar9,pauVar3[1]);
          auVar10 = vpminsw_avx512bw(auVar10,pauVar3[2]);
          auVar11 = vpminsw_avx512bw(auVar11,pauVar3[3]);
  ...
  if (lVar2 < (longlong)(param_4 & 0xffffffffffffffc0)) {
    ...
    do {
      ...
      if (0 < param_5) {
        do {
          lVar5 = lVar5 + 1;
          auVar10 = vpminsw_avx512bw(auVar10,*pauVar3);
          auVar11 = vpminsw_avx512bw(auVar11,pauVar3[1]);
          pauVar3 = (undefined1 (*) [64])(*pauVar3 + param_2 * 2);
        } while (lVar5 < param_5);
      }
      lVar2 = lVar2 + 0x40;
  ...
  if (lVar2 < (longlong)(param_4 & 0xffffffffffffffe0)) {
    ...
    do {
      ...
      if (0 < param_5) {
        do {
          lVar6 = lVar6 + 1;
          auVar11 = vpminsw_avx512bw(auVar11,*(undefined1 (*) [64])(*param_1 + lVar5 * 2));
          lVar5 = lVar5 + param_2;
        } while (lVar6 < param_5);
      }
      lVar2 = lVar2 + 0x20;
  ...
  if (lVar2 < (longlong)param_4) {
    ...
    if (0 < param_5) {
      do {
        ...
        lVar5 = lVar5 + 1;
        auVar7 = vpminsw_avx512bw(auVar7,auVar10);
