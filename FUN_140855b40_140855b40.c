...
void FUN_140855b40(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1408566aa:
      uVar44 = 0;
      if (uVar40 == 0) goto LAB_140855d87;
      uVar41 = 0;
      uVar43 = uVar40;
    }
    else {
      uVar43 = param_2 & 0x1f;
      if (uVar43 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1408566aa;
        uVar43 = 0x20 - uVar43 >> 2;
      }
      if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_1408566aa;
      ...
      if (uVar40 < uVar44 + 1) goto LAB_140855d87;
...
LAB_14085666d:
          uVar44 = 0;
          if (uVar40 == 0) goto LAB_140856492;
          uVar41 = 0;
          uVar43 = uVar40;
        }
        else {
          uVar43 = param_2 & 0x1f;
          if (uVar43 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14085666d;
            uVar43 = 0x20 - uVar43 >> 2;
          }
          if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_14085666d;
          ...
          if (uVar40 < uVar44 + 1) goto LAB_140856492;
          uVar43 = uVar40 - uVar44;
          if ((longlong)uVar43 < 4) {
            uVar41 = 0;
          }
...
LAB_14085665a:
    ...
    uVar43 = param_2 & 0x1f;
    if (uVar43 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14085665a;
      uVar43 = 0x20 - uVar43 >> 2;
    }
    if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_14085665a;
    uVar41 = 0;
    uVar44 = uVar40 - (uVar40 - uVar43 & 0xf);
    if (uVar43 != 0) {
      do {
