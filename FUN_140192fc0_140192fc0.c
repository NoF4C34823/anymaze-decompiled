...
void FUN_140192fc0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (3 < (longlong)param_3) {
    uVar36 = param_2 & 0xf;
    if (uVar36 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14019322c;
    ...
    if ((longlong)(uVar36 + 4) <= (longlong)param_3) {
      ...
      do {
        pfVar3 = (float *)(param_1 + -8 + uVar36 * 4);
        fVar13 = pfVar3[1];
        fVar14 = pfVar3[2];
        fVar15 = pfVar3[3];
        ...
        fVar17 = pfVar4[2];
        fVar18 = pfVar4[3];
        pfVar5 = (float *)(param_1 + 0xc + uVar36 * 4);
        fVar19 = pfVar5[1];
        fVar20 = pfVar5[2];
        fVar21 = pfVar5[3];
        pfVar6 = (float *)(param_1 + 8 + uVar36 * 4);
        fVar22 = pfVar6[1];
        fVar23 = pfVar6[2];
        fVar24 = pfVar6[3];
        pfVar7 = (float *)(param_1 + -4 + uVar36 * 4);
        fVar25 = pfVar7[1];
        fVar26 = pfVar7[2];
        fVar27 = pfVar7[3];
        ...
        *pfVar2 = (*pfVar4 + *pfVar5) * fVar9 + (*pfVar3 + *pfVar6) * fVar10 +
                  (*pfVar7 + *pfVar8) * fVar11 + *pfVar1 * fVar12;
        pfVar2[1] = (fVar16 + fVar19) * fVar9 + (fVar13 + fVar22) * fVar10 +
                    (fVar25 + fVar28) * fVar11 + fVar31 * fVar12;
        pfVar2[2] = (fVar17 + fVar20) * fVar9 + (fVar14 + fVar23) * fVar10 +
                    (fVar26 + fVar29) * fVar11 + fVar32 * fVar12;
        pfVar2[3] = (fVar18 + fVar21) * fVar9 + (fVar15 + fVar24) * fVar10 +
                    (fVar27 + fVar30) * fVar11 + fVar33 * fVar12;
        uVar36 = uVar36 + 4;
      } while (uVar36 < uVar34);
