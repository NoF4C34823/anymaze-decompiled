...
/* WARNING: Removing unreachable block (ram,0x000140665ba0) */

void FUN_140664e20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (**(code **)(&DAT_14308b720 + lStack_e8 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar24 != 6) {
            if (uVar24 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar21 < 0) goto LAB_140665f80;
                while (uVar9 == 0) {
                  for (lVar11 = (lVar16 + -1) * 2 - lVar11; lVar11 < 0; lVar11 = -lVar11) {
LAB_140665f80:
                    if (uVar18 != 0) goto LAB_140665e4e;
                  }
...
LAB_140665e4e:
    ...
    iStack_158 = param_10;
    (**(code **)(&DAT_14308b720 + lStack_e8 * 8))(param_11 + lVar29 * 6,param_4,lVar16,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar21 = uVar19 * 3;
...
LAB_140665f20:
              ...
              if (uVar13 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_140665f20;
                uVar13 = 0x10 - uVar13 >> 1;
              }
              if ((longlong)uVar15 < (longlong)(uVar13 + 8)) goto LAB_140665f20;
              uVar20 = 0;
...
LAB_14066571d:
      lStack_130 = lVar11;
      puStack_140 = puVar8;
      pcStack_138 = *(code **)(&DAT_14308b720 + lStack_e8 * 8);
      iStack_158 = param_10;
      uStack_110 = param_7;
      lStack_108 = param_4;
