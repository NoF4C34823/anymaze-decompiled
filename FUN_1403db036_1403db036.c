...
void FUN_1403db036(longlong param_1,longlong param_2,ulonglong param_3,ulonglong param_4)
  ...
  do {
    ...
    if (0 < (longlong)param_4) {
      ...
      if (param_4 >> 3 != 0) {
        ...
        do {
          if (*(byte *)(param_1 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(param_1 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000030 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lStack0000000000000030 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000038 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lStack0000000000000038 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000040 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lStack0000000000000040 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000048 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lStack0000000000000048 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000050 + unaff_RDI + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lStack0000000000000050 + unaff_RDI + lVar2 * 8);
          }
          if (*(byte *)(lVar1 + lVar2 * 8) < bVar3) {
            bVar3 = *(byte *)(lVar1 + lVar2 * 8);
          }
          if (*(byte *)(lStack0000000000000028 + unaff_RDI + lVar2 * 8) < bVar3) {
      ...
      if (uVar4 <= param_4) {
        lStack0000000000000058 = param_1;
                    /* WARNING: Could not recover jumptable at 0x0001403db311. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)(&UNK_1403db313 + (byte)(&DAT_143089e40)[(uint)((int)param_4 - (int)uVar4)]))();
        return;
      }
    }
