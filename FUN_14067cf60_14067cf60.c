...
void FUN_14067cf60(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (3 < (longlong)uVar9) {
    uVar17 = param_2 & 0xf;
    if (uVar17 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14067d197;
      uVar17 = 0x10 - uVar17 >> 2;
    }
    if ((longlong)(uVar17 + 4) <= (longlong)uVar9) {
      uVar15 = 0;
      uVar18 = uVar9 - (uVar9 - uVar17 & 3);
      if (uVar17 != 0) {
        do {
      ...
      puVar16 = (ulonglong *)(uVar17 * 2 + param_1);
      do {
        uVar15 = *(ulonglong *)((longlong)puVar16 + -0xc);
        uVar5 = *(ulonglong *)((longlong)puVar16 + 0xc);
        uVar25 = (undefined2)(uVar15 >> 0x30);
        auVar28._8_4_ = 0;
        auVar28._0_8_ = uVar15;
        auVar28._12_2_ = uVar25;
        auVar28._14_2_ = uVar25;
        uVar25 = (undefined2)(uVar15 >> 0x20);
        ...
        uVar6 = *(ulonglong *)((longlong)puVar16 + 6);
        uVar7 = *(ulonglong *)((longlong)puVar16 + -6);
        ...
        *pfVar1 = (float)((int)(short)uVar15 + (int)(short)uVar5) * fVar2 +
        ...
        pfVar1[2] = (float)((auVar26._8_4_ >> 0x10) + (auVar19._8_4_ >> 0x10)) * fVar2 +
                    (float)((auVar29._8_4_ >> 0x10) + (auVar22._8_4_ >> 0x10)) * fVar3 +
                    (float)(auVar32._8_4_ >> 0x10) * fVar4;
        pfVar1[3] = (float)((auVar27._12_4_ >> 0x10) + (auVar20._12_4_ >> 0x10)) * fVar2 +
                    (float)((auVar30._12_4_ >> 0x10) + (auVar23._12_4_ >> 0x10)) * fVar3 +
                    (float)(auVar33._12_4_ >> 0x10) * fVar4;
        uVar17 = uVar17 + 4;
      } while (uVar17 < uVar18);
      for (; uVar18 < uVar9; uVar18 = uVar18 + 1) {
        *(float *)(param_2 + uVar18 * 4) =
             (float)((int)*(short *)(param_1 + -0xc + uVar18 * 2) +
                    (int)*(short *)(param_1 + 0xc + uVar18 * 2)) * fVar2 +
             (float)((int)*(short *)(param_1 + -6 + uVar18 * 2) +
                    (int)*(short *)(param_1 + 6 + uVar18 * 2)) * fVar3 +
             (float)(int)*(short *)(param_1 + uVar18 * 2) * fVar4;
      }
      return;
    }
  }
LAB_14067d197:
  FUN_14067d139(fVar4,0);
  return;
}
