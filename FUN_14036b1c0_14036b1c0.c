...
ulonglong FUN_14036b1c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)(int)param_5) {
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              for (; bVar41 = bVar42, uVar28 < uVar31; uVar28 = uVar28 + 1) {
                if (bVar41 < *(byte *)(uVar28 + uVar29)) {
    ...
    if (0 < param_5._4_4_) {
      ...
      do {
        ...
        if (0 < (longlong)uVar29) {
          ...
          do {
            ...
            if (0 < (longlong)uVar28) {
              ...
              for (; bVar41 = bVar42, uVar21 < uVar28; uVar21 = uVar21 + 1) {
                if (bVar41 < *(byte *)(uVar21 + uVar35)) {
        ...
        FUN_140374ca0(param_9,uVar20,param_3,uVar29,(longlong)param_6._4_4_);
        uVar26 = uVar26 + 1;
        uVar23 = uVar23 + 1;
        uVar22 = 0;
