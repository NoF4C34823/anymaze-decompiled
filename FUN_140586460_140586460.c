...
void FUN_140586460(undefined1 (*param_1) [32],longlong param_2,undefined8 param_3,uint param_4)

{
  ...
  auVar8 = vpmaxub_avx2(auVar8,auVar9);
  auVar7 = vpmaxub_avx2(auVar11,auVar7);
  auVar8 = vpmaxub_avx2(auVar8,auVar10);
  auVar7 = vpmaxub_avx2(auVar7,auVar12);
