...
void FUN_1401f5b40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1401f5c47:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar15) && (param_7 != 0xf0)) {
      if (uVar13 == 6) {
        if (uStack_b0 == 0) goto LAB_1401f5d8a;
      }
      else {
        if (uVar13 != 1) goto LAB_1401f5c84;
        if (uStack_b0 == 0) {
          uVar7 = param_5[1] - 1;
        }
      }
...
LAB_1401f5d20:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_1401f67a0(lStack_78,lStack_70,uVar7,param_3,in_stack_fffffffffffffee8,(int)lStack_50,param_7
        ...
        if (uStack_48 <= uVar15) {
          if (uStack_a0 != 0) {
            ...
            do {
              uStack_d8 = *param_5;
              uStack_d0 = param_5[1];
              FUN_1401f67a0(lStack_78,lStack_70,lVar9,lVar3,&uStack_d8,(int)lStack_50,param_7,
          ...
          param_10 = iStack_a8;
          if (uVar13 != 1) goto LAB_1401f606b;
          uVar12 = *param_5;
          uVar15 = 0;
          goto LAB_1401f6360;
        }
...
LAB_1401f5fee:
        ...
        (**(code **)(&DAT_1430882c0 + lStack_50 * 8))
      ...
      if (-1 < (longlong)uVar15) goto LAB_1401f5c47;
      uVar7 = uVar15;
      if (param_7 == 0xf0) goto LAB_1401f5d20;
      if (uVar13 != 6) {
        if (uVar13 != 1) goto LAB_1401f5c84;
        uVar7 = 0;
        if (uStack_a0 != 0) {
      ...
      if (uStack_a0 != 0) goto LAB_1401f5d20;
LAB_1401f5d8a:
      uVar7 = *param_5;
      uVar5 = *param_8;
...
LAB_1401f66f0:
      ...
      uVar11 = uVar6 & 0x1f;
      if (uVar11 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_1401f66e3;
        uVar11 = 0x20 - uVar11 >> 2;
      }
      if ((longlong)uVar7 < (longlong)(uVar11 + 0x10)) goto LAB_1401f66e3;
      uVar10 = 0;
      ...
      if (uVar7 < uVar8 + 1) goto LAB_1401f5ec0;
      uVar7 = uVar7 - uVar8;
      if ((longlong)uVar7 < 4) goto LAB_1401f66f0;
...
LAB_1401f606b:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_d8 = *param_5;
    uStack_d0 = param_5[1];
    FUN_1401f67a0(lStack_78,lStack_70,lVar3,lStack_98,&uStack_d8,(int)lStack_50,param_7,param_8,
...
LAB_1401f62a5:
        ...
        uVar6 = uVar7 & 0x1f;
        if (uVar6 != 0) {
          if ((uVar7 & 3) != 0) goto LAB_1401f62a5;
          uVar6 = 0x20 - uVar6 >> 2;
        }
        if ((longlong)uVar15 < (longlong)(uVar6 + 8)) goto LAB_1401f62a5;
...
LAB_1401f6470:
      ...
      uVar7 = uVar6 & 0x1f;
      if (uVar7 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_1401f6470;
        uVar7 = 0x20 - uVar7 >> 2;
      }
      if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1401f6470;
      uVar8 = 0;
...
LAB_1401f5c84:
  ...
  if (uVar13 == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar15 < 0) goto LAB_1401f5f80;
      while (uStack_b0 == 0) {
