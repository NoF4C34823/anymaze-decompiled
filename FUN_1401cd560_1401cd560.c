...
/* WARNING: Removing unreachable block (ram,0x0001401ce33e) */

void FUN_1401cd560(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (**(code **)(&DAT_1430880a0 + lVar20 * 8))(param_1,param_4,*param_5,param_9);
...
LAB_1401ce60f:
    ...
    iStack_158 = param_10;
    (**(code **)(&DAT_1430880a0 + lVar20 * 8))(param_11 + lVar24 * 6,param_4,lVar14,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_118 = lVar24 * 3;
...
LAB_1401ce6e6:
              ...
              if (uVar13 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_1401ce6e6;
                uVar13 = 0x10 - uVar13 >> 1;
              }
              if ((longlong)uVar9 < (longlong)(uVar13 + 8)) goto LAB_1401ce6e6;
...
LAB_1401cdecb:
      uStack_140 = uVar9;
      pcStack_138 = *(code **)(&DAT_1430880a0 + lVar20 * 8);
      iStack_158 = param_10;
      lStack_110 = param_1;
      uStack_108 = param_7;
