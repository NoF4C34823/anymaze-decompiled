...
void FUN_1408d42d6(longlong param_1,ulonglong param_2,longlong param_3)

{
  ...
  if (uVar6 < param_2) {
    ...
    do {
      auVar9._0_4_ = (float)((int)*(short *)(lVar1 + -6 + uVar6 * 2) +
                            (int)*(short *)(lVar1 + 6 + uVar6 * 2));
      ...
      auVar10 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM2_Da *
                                              (float)(int)*(short *)(lVar1 + uVar6 * 2))),auVar9,
                                auVar5);
