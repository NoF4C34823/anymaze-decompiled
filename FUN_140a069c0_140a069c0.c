...
void FUN_140a069c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (iVar47 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      uStack_c0 = param_9;
      pcStack_d8 = (code *)(&PTR_LAB_14308e860)[(int)uStack_220];
      lStack_138 = 0;
      uStack_f0 = 0;
            ...
            if (lStack_c8 < (longlong)(uStack_60 + uVar42)) {
              ...
              do {
                ...
                if (lVar45 < 0) {
                  if (uStack_f8 != 0xf0) {
                    if (iVar47 == 6) {
                      if (uStack_e0 == 0) goto LAB_140a08fd4;
                    }
                    else {
                      if (iVar47 != 1) goto LAB_140a08f4c;
LAB_140a09117:
                      lVar51 = 0;
                      if (uStack_e0 != 0) {
                        lVar51 = lVar45;
...
LAB_140a08fbc:
                  ...
                  if ((lVar45 < (longlong)uVar42) || (uStack_f8 == 0xf0)) goto LAB_140a08fbc;
                  if (iVar47 != 6) {
                    if (iVar47 == 1) {
                      if (lVar45 < 0) goto LAB_140a09117;
                      if (uStack_b8 == 0) {
                        lVar51 = lStack_e8;
                      }
                    }
...
LAB_140a09140:
                  ...
                  if (uStack_b8 != 0) goto LAB_140a08fbc;
LAB_140a08fd4:
                  bVar46 = *pbVar58;
                  bVar56 = pbVar58[1];
                  bVar52 = pbVar58[2];
                  ...
                  if ((lStack_158 + -3 <= (longlong)puStack_d0 - lVar44) ||
                    ...
                    if ((longlong)uVar50 < 0x40) {
                      ...
                      if ((longlong)uVar50 < 0x116) {
                        ...
                        if (uVar55 != 0) {
                          auVar69 = vmovdqu32_avx512f(_DAT_14308e640);
                          uVar53 = 0;
                          auVar70 = vmovdqu32_avx512f(_DAT_14308e680);
                          ...
                          if (uVar50 == uVar55) goto LAB_140a076ad;
                        }
                      }
...
LAB_140a07bfb:
  ...
  if (uVar54 == 6) {
    ...
    auVar64._12_4_ = 0;
    if (0 < iVar47) {
      auVar74 = vmovdqu32_avx512f(_DAT_14308e640);
      auVar69 = vmovdqu32_avx512f(_DAT_14308e680);
      ...
      do {
        if (0 < (longlong)(*param_5 * 3)) {
          if ((longlong)uVar49 < 0x10) {
            ...
            uVar42 = 0;
            auVar71 = vmovdqu32_avx512f(_DAT_14308e740);
            lVar57 = 0;
            do {
        ...
        if (0 < (longlong)uVar49) {
          if ((longlong)uVar49 < 0x10) {
            ...
            while (0x3a < (longlong)uVar49) {
              ...
              if (uVar41 == 0) goto LAB_140a06ebc;
              uVar53 = 0;
              auVar71 = vpbroadcastq_avx512f();
              auVar73 = auVar70;
              auVar72 = auVar69;
              ...
              if (uVar49 != uVar41) goto LAB_140a06ebc;
              uVar50 = uVar50 + 1;
              if (uVar43 <= uVar50) {
                return;
              }
        ...
        if (0 < (longlong)uVar49) {
          if ((longlong)uVar49 < 0x10) {
            ...
            while (0x3a < (longlong)uVar49) {
              ...
              if (uVar41 == 0) goto LAB_140a06cdc;
              uVar55 = 0;
              auVar71 = vpbroadcastq_avx512f();
              auVar73 = auVar70;
              auVar72 = auVar69;
              ...
              if (uVar49 != uVar41) goto LAB_140a06cdc;
              lVar45 = uVar50 + 2;
              uVar50 = uVar50 + 1;
