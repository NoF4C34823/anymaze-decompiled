...
void FUN_1407fbc20(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407fcc34. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c580)[lVar6])(puVar22,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_1407fcbc0;
                while (uVar13 == 0) {
                  for (lVar24 = (lVar15 + -1) * 2 - lVar24; lVar24 < 0; lVar24 = -lVar24) {
LAB_1407fcbc0:
                    if (uVar8 != 0) goto LAB_1407fcac2;
                  }
          ...
          uVar23 = uVar25;
          if (uVar21 != 0) goto LAB_1407fcac2;
        }
        else {
LAB_1407fcac2:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar23;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407fcb22. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c580)[lVar6])(param_11 + uVar12 * 2,param_4,lVar15,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_1407fcb36:
              ...
              uVar7 = uVar17 & 0xf;
              if (uVar7 != 0) {
                if ((uVar17 & 1) != 0) goto LAB_1407fcb36;
                uVar7 = 0x10 - uVar7 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar7 + 8)) goto LAB_1407fcb36;
...
LAB_1407fc07d:
      if (uVar18 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_1407fc28d;
...
LAB_1407fcb98:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407fcb98;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1407fcb98;
          uVar11 = 0;
...
LAB_1407fcb3d:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407fcb3d;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1407fcb3d;
          uVar11 = 0;
          uVar9 = uVar12 - (uVar12 - uVar7 & 7);
          if (uVar7 != 0) {
            do {
...
LAB_1407fc28d:
      (*(code *)(&PTR_FUN_14308c580)[lVar6])(uVar17,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001407fcb95. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c580)[lVar6])(puVar22,param_4,lVar15);
    return;
  }
  if ((longlong)uVar12 < lVar15) {
    lVar15 = lVar15 - uVar12;
    (*(code *)(&PTR_FUN_14308c580)[lVar6])(puVar22,param_4,lVar15,param_9,param_10);
...
LAB_1407fcb45:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407fcb45;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_1407fcb45;
...
LAB_1407fc6dc:
  if (uVar18 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_1407fc97a;
...
LAB_1407fcb53:
          ...
          uVar17 = uVar19 & 0xf;
          if (uVar17 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_1407fcb53;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_1407fcb53;
          uVar7 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar12 < 1)) goto LAB_1407fc97a;
  if ((longlong)uVar12 < 8) {
LAB_1407fcb4c:
    uVar17 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar15 - 2U & 1) != 0) goto LAB_1407fcb4c;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar19 + 8)) goto LAB_1407fcb4c;
    uVar7 = 0;
...
LAB_1407fc97a:
                    /* WARNING: Could not recover jumptable at 0x0001407fc9b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c580)[lVar6])(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
