...
void FUN_1405d2ee0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1405d390e:
      uVar35 = 0;
      if (param_5 == 0) goto LAB_1405d313e;
      uVar44 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar33 = uVar44 & 0xf;
      if (uVar33 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_1405d390e;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar33 + 8)) goto LAB_1405d390e;
      ...
      if (param_5 < uVar35 + 1) goto LAB_1405d313e;
...
LAB_1405d33a4:
        ...
        uVar34 = uVar34 + 1;
        pfVar37 = pfVar37 + 1;
        if (iVar38 - 1U <= uVar34) goto LAB_1405d341b;
      }
      uVar34 = uVar34 + 1;
      pfVar37 = pfVar37 + 1;
...
LAB_1405d38f4:
      ...
      uVar40 = uVar43 & 0xf;
      if (uVar40 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_1405d38f4;
        uVar40 = 0x10 - uVar40 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar40 + 8)) goto LAB_1405d38f4;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar40 = uVar43 & 0xf;
      if (uVar40 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_1405d3902;
        uVar40 = 0x10 - uVar40 >> 2;
      }
      if ((longlong)(uVar40 + 4) <= (longlong)param_5) {
        uVar44 = 0;
        uVar33 = param_5 - (param_5 - uVar40 & 3);
        uVar34 = _UNK_14308b34c;
        uVar28 = _UNK_14308b348;
        uVar29 = _UNK_14308b344;
        uVar30 = _DAT_14308b340;
        if (uVar40 != 0) {
          do {
...
LAB_1405d388e:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar40 = uVar43 & 0xf;
    if (uVar40 != 0) {
      if ((uVar43 & 3) != 0) goto LAB_1405d38fb;
      uVar40 = 0x10 - uVar40 >> 2;
    }
