...
void FUN_1409cae00(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4,int param_5)

{
  ...
  if (0 < (longlong)param_3) {
    ...
    if ((longlong)param_3 < 0x10) {
      ...
      if ((longlong)param_3 < 0x86) {
        ...
        if (uVar27 != 0) {
          ...
          if (param_3 == uVar27) goto LAB_1409cb024;
        }
      }
    ...
    if (uVar26 + 1 <= param_3) {
      ...
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_14308e300);
      bVar18 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_14308e340);
      bVar17 = (byte)uVar16;
      uVar37 = CONCAT11(bVar17,bVar18);
          ...
          if ((longlong)param_3 < 0x10) {
            ...
            if ((longlong)param_3 < 0x53) {
              ...
              if (uVar32 != 0) {
                ...
                if (param_3 == uVar32) goto LAB_1409cb3ae;
              }
            }
        ...
        if ((longlong)param_3 < 0x10) {
          ...
          if ((longlong)param_3 < 0x47) {
            ...
            if (uVar27 != 0) {
              ...
              if (param_3 == uVar27) goto LAB_1409cb60c;
            }
          }
          if ((longlong)(uVar27 + 0x10) <= (longlong)uVar26) {
            auVar63 = vbroadcastss_avx512f(auVar69);
