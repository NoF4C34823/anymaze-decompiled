...
void FUN_1401aa700(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar10 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1401ac04a;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcStack_c8 = *(code **)(&UNK_143087f20 + (longlong)param_6 * 8);
            ...
            if (lStack_d0 < (longlong)(uStack_68 + uVar9)) {
              do {
                ...
                if (lVar14 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar3 == 6) {
                      if (uStack_c0 == 0) goto LAB_1401abfbd;
                    }
                    else {
                      if (uVar3 != 1) goto LAB_1401abf24;
LAB_1401ac0af:
                      lVar16 = 0;
                      if (uStack_c0 != 0) {
                        lVar16 = lVar14;
...
LAB_1401abf8f:
                  ...
                  if ((lVar14 < (longlong)uVar9) || (param_7 == 0xf0)) goto LAB_1401abf8f;
                  if (uVar3 != 6) {
                    if (uVar3 == 1) {
                      if (lVar14 < 0) goto LAB_1401ac0af;
                      if (uStack_b0 == 0) {
                        lVar16 = uVar9 - 1;
                      }
                    }
...
LAB_1401ac0c0:
                  ...
                  if (uStack_b0 != 0) goto LAB_1401abf8f;
LAB_1401abfbd:
      ...
      do {
        if (0 < (longlong)uVar15) {
          ...
          if (3 < (longlong)uVar15) {
            ...
            uVar5 = uVar4 & 0xf;
            if (uVar5 != 0) {
              if ((uVar4 & 3) != 0) goto LAB_1401aabd2;
              uVar5 = 0x10 - uVar5 >> 2;
            }
        ...
        do {
          if (0 < (longlong)uVar15) {
            ...
            if (3 < (longlong)uVar15) {
              ...
              uVar5 = uVar4 & 0xf;
              if (uVar5 != 0) {
                if ((uVar4 & 3) != 0) goto LAB_1401aaa51;
                uVar5 = 0x10 - uVar5 >> 2;
              }
              if ((longlong)(uVar5 + 4) <= (longlong)uVar15) {
