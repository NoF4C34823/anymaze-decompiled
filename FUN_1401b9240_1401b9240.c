...
void FUN_1401b9240(longlong param_1,ulonglong param_2,longlong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)uVar13) {
    uVar38 = param_2 & 0xf;
    if (uVar38 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401b948a;
    ...
    if ((longlong)(uVar38 + 4) <= (longlong)uVar13) {
      ...
      goto joined_r0x0001401b940c;
    }
  }
LAB_1401b948a:
  uVar36 = 0;
joined_r0x0001401b940c:
