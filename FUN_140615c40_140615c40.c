...
void FUN_140615c40(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1406164b6:
      uVar28 = 0;
      if (param_5 == 0) goto LAB_140615ebe;
      uVar39 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar33 = uVar39 & 0xf;
      if (uVar33 != 0) {
        if ((uVar39 & 3) != 0) goto LAB_1406164b6;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar33 + 8)) goto LAB_1406164b6;
      ...
      if (param_5 < uVar28 + 1) goto LAB_140615ebe;
...
LAB_140616124:
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar33 = param_4 & 0xf;
      if (uVar33 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406164d4;
        uVar33 = 0x10 - uVar33 >> 2;
      }
...
LAB_14061645c:
  ...
  if (7 < (longlong)param_5) {
    uVar33 = param_4 & 0xf;
    if (uVar33 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406164cd;
      uVar33 = 0x10 - uVar33 >> 2;
    }
