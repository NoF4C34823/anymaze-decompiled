...
void FUN_140067a20(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1400682e4:
      ...
      uVar83 = param_2 & 0xf;
      if (uVar83 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400682e4;
        uVar83 = 0x10 - uVar83 >> 2;
      }
      if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1400682e4;
...
LAB_1400682c6:
          uVar77 = 0;
          if (uVar88 == 0) goto LAB_1400680ea;
          uVar85 = 0;
          uVar83 = uVar88;
        }
        else {
          uVar83 = param_2 & 0xf;
          if (uVar83 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1400682c6;
            uVar83 = 0x10 - uVar83 >> 2;
          }
          if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1400682c6;
          uVar77 = uVar88 - (uVar88 - uVar83 & 7);
          ...
          if (uVar88 < uVar77 + 1) goto LAB_1400680ea;
...
LAB_1400682b3:
    ...
    uVar83 = param_2 & 0xf;
    if (uVar83 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400682b3;
      uVar83 = 0x10 - uVar83 >> 2;
    }
    if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1400682b3;
    uVar85 = 0;
    uVar77 = uVar88 - (uVar88 - uVar83 & 7);
    if (uVar83 != 0) {
      do {
