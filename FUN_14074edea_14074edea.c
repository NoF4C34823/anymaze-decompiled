...
void FUN_14074edea(longlong param_1,float param_2,ulonglong param_3,undefined8 param_4)

{
  ...
  do {
    ...
    auVar8 = pmovzxbw(ZEXT416(*(uint *)((longlong)puVar4 + 6)),
                      ZEXT416(*(uint *)((longlong)puVar4 + 6)));
  ...
  if (uVar3 < param_3) {
    ...
    do {
      *(float *)(in_R9 + unaff_RDI * 4 + uVar3 * 4) =
           ...
           param_2 + (float)((uint)*(byte *)((uVar3 - 3) + param_1) +
                            (uint)*(byte *)(uVar3 + 3 + param_1)) * in_XMM2_Da +
