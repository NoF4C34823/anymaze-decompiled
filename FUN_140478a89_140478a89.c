...
void FUN_140478a89(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_140d172c0(unaff_RSI,unaff_RBX);
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_140d172c0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,lStack0000000000000060,1);
