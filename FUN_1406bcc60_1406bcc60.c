...
void FUN_1406bcc60(longlong param_1,longlong param_2,longlong param_3,float *param_4)

{
  ...
  if (7 < (longlong)uVar29) {
    ...
    if (uVar27 != 0) {
      if ((param_1 + 0x18U & 3) != 0) goto LAB_1406bd052;
    ...
    if ((longlong)(uVar27 + 8) <= (longlong)uVar29) {
      ...
      if ((longlong)uVar29 < 4) {
        FUN_1406bcfe3(uVar27,fVar9,fVar8,0,CONCAT44(unaff_XMM9_Dd,unaff_XMM9_Dc),
