...
void FUN_1408128a0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140812dff:
      uVar35 = 0;
      if (param_5 == 0) goto LAB_140812b89;
      uVar37 = 0;
      uVar31 = param_5;
    }
    else {
      ...
      uVar31 = uVar38 & 0x1f;
      if (uVar31 != 0) {
        if ((uVar38 & 3) != 0) goto LAB_140812dff;
        uVar31 = 0x20 - uVar31 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar31 + 0x10)) goto LAB_140812dff;
      ...
      if (param_5 < uVar35 + 1) goto LAB_140812b89;
...
LAB_140812b89:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar31 = uVar38 & 0xf;
      if (uVar31 != 0) {
        if ((uVar38 & 3) != 0) goto LAB_140812e1e;
...
LAB_140812d97:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar31 = uVar38 & 0xf;
    if (uVar31 != 0) {
      if ((uVar38 & 3) != 0) goto LAB_140812e17;
      uVar31 = 0x10 - uVar31 >> 2;
    }
