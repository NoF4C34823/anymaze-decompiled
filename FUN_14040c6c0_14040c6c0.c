...
void FUN_14040c6c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar11 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_14036ade0(lVar13,lVar7,uVar2,(longlong)(int)param_6,3);
        lVar14 = lVar14 + 1;
        lVar13 = lVar13 + lVar4;
        lVar7 = lVar7 + uVar5;
      } while (lVar14 < lVar11);
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_14036ade0(lVar13,lVar7,uVar2,(longlong)(int)param_6,3);
        FUN_140374ca0(param_9,uVar5,param_3,uVar2,(longlong)param_6._4_4_);
        lVar11 = lVar11 + 1;
        lVar7 = lVar7 + uVar5;
              ...
              do {
                if (0 < (int)param_6) {
                  ...
                  if ((ulonglong)(longlong)(int)param_6 >> 1 != 0) {
                    do {
                      if ((*(char *)(param_7 + lVar14 + uVar6 * 2) != '\0') &&
                         (bVar1 = *(byte *)(uVar6 * 6 + uVar8 + ((lVar11 * -3 + param_1) - lVar7) +
                                           (uVar5 + uVar12) * lVar4), bVar9 < bVar1)) {
                        bVar9 = bVar1;
                      }
                      if ((*(char *)(param_7 + lVar14 + 1 + uVar6 * 2) != '\0') &&
                         (lVar10 = (uVar5 + uVar12) * lVar4,
                         lVar3 = uVar6 * 6 + uVar8 + 3 + ((lVar11 * -3 + param_1) - lVar7),
                  ...
                  if (((lVar3 - 1U < (ulonglong)(longlong)(int)param_6) &&
                     ...
                     lVar3 = ((lVar11 * -3 + param_1) - lVar7) + lVar3 * 3 + -3 + uVar8,
                     bVar9 < *(byte *)(lVar3 + lVar10))) {
                    bVar9 = *(byte *)(lVar3 + lVar10);
                  }
                }
