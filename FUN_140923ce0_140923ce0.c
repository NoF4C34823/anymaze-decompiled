...
void FUN_140923ce0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    if ((longlong)param_3 < 0x1d) {
      FUN_140923d9a(param_1,param_3 & 0xfffffffffffffff0);
      return;
    }
    uVar14 = param_2 & 0x1f;
    if (uVar14 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140923f49;
    ...
    if ((longlong)(uVar14 + 0x10) <= (longlong)param_3) {
      ...
      if (uVar14 != 0) {
        do {
          auVar15._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -2 + uVar12 * 2) +
                      (uint)*(ushort *)(param_1 + 2 + uVar12 * 2));
          auVar15._4_8_ = SUB128(ZEXT812(0),4);
          auVar15._12_4_ = 0;
          auVar15 = vfmadd231ss_fma(ZEXT416((uint)(fVar3 * (float)*(ushort *)(param_1 + uVar12 * 2))
      ...
      do {
        ...
        auVar10 = vpmovzxwd_avx2(auVar5._0_16_);
        auVar11 = vpmovzxwd_avx2(auVar4._0_16_);
        ...
        auVar5 = vpmovzxwd_avx2(auVar6._16_16_);
        auVar5 = vcvtdq2ps_avx(auVar5);
      ...
      do {
        auVar17._0_4_ =
             (float)((uint)*(ushort *)(param_1 + -2 + uVar14 * 2) +
                    (uint)*(ushort *)(param_1 + 2 + uVar14 * 2));
        auVar17._4_8_ = SUB128(ZEXT812(0),4);
        auVar17._12_4_ = 0;
        auVar15 = vfmadd231ss_fma(ZEXT416((uint)(fVar3 * (float)*(ushort *)(param_1 + uVar14 * 2))),
