...
void FUN_1401cb2c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401cc2b1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143088020 + lVar15 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
          ...
          if (uVar20 != 6) {
            if (uVar20 == 1) {
              ...
              if (lVar10 < 2) {
                ...
                if (lVar19 < 0) goto LAB_1401cc240;
                while (uStack_80 == 0) {
                  for (lVar7 = (lVar10 + -1) * 2 - lVar7; lVar7 < 0; lVar7 = -lVar7) {
LAB_1401cc240:
                    if (uVar8 != 0) goto LAB_1401cc12e;
                  }
...
LAB_1401cc12e:
        ...
        *(undefined1 *)(lVar23 + 2 + param_11) = uVar13;
        lVar23 = lVar23 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401cc1d1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143088020 + lVar15 * 8))(param_11 + lVar12 * 3,param_4,lVar10,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar23 = lVar12 * 3;
...
LAB_1401cc1d4:
            ...
            if ((longlong)uVar17 < (longlong)(uVar4 + 0x10)) goto LAB_1401cc1d4;
...
LAB_1401cb531:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_143088020 + lVar15 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401cc20d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_1401cbffd:
                    /* WARNING: Could not recover jumptable at 0x0001401cc02b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
