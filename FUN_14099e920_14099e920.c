...
void FUN_14099e920(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4,int param_5)
  ...
  if (0 < (longlong)param_3) {
    ...
    if ((longlong)param_3 < 0x20) {
      ...
      if ((longlong)param_3 < 0xa6) {
        ...
        if (uVar38 != 0) {
          uVar44 = 0;
          auVar74 = vmovdqu32_avx512f(_DAT_14308dfc0);
          auVar75 = vmovdqu32_avx512f(_DAT_14308e000);
          ...
          if (param_3 == uVar38) goto LAB_14099eb9e;
        }
      }
          ...
          if ((longlong)param_3 < 0x20) {
            ...
            if ((longlong)param_3 < 0x73) {
              ...
              if (uVar52 != 0) {
                ...
                if (param_3 == uVar52) goto LAB_14099efbe;
              }
            }
        ...
        if ((longlong)param_3 < 0x20) {
          ...
          if ((longlong)param_3 < 0x5a) {
            ...
            if (uVar38 != 0) {
              ...
              if (param_3 == uVar38) goto LAB_14099f286;
            }
          }
          if ((longlong)(uVar38 + 0x20) <= (longlong)uVar36) {
            auVar79 = vbroadcastss_avx512f(auVar56);
