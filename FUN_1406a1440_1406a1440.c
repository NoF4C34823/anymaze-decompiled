...
void FUN_1406a1440(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar38 = param_4 & 0xf;
      if (uVar38 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406a1c49;
...
LAB_1406a1c34:
    ...
    uVar38 = param_4 & 0xf;
    if (uVar38 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406a1c34;
      uVar38 = 0x10 - uVar38 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar38 + 8)) goto LAB_1406a1c34;
