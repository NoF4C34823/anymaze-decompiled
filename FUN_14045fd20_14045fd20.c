...
void FUN_14045fd20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  auVar3 = _DAT_143089f60;
  uVar2 = _DAT_143089f60;
  lVar5 = 0;
  lVar9 = 0;
  lVar6 = 0;
                    ...
                    do {
                      ...
                      if (uVar15 != 0) {
                        ...
                        do {
                          ...
                          ;
                          auVar25 = minps(auVar25,*(undefined1 (*) [16])(lVar18 + lVar19 * 4));
                          auVar26 = minps(auVar26,*(undefined1 (*) [16])(lVar18 + 0x10 + lVar19 * 4)
                                         );
                          auVar24 = minps(auVar24,*(undefined1 (*) [16])(lVar18 + 0x20 + lVar19 * 4)
                                         );
                          auVar27 = minps(auVar27,*(undefined1 (*) [16])(lVar18 + 0x30 + lVar19 * 4)
                                         );
                          lStack_458 = param_2;
                  ...
                  do {
                    ...
                    if (uVar15 != 0) {
                      do {
                        ...
                        auVar25 = minps(auVar25,*(undefined1 (*) [16])(lVar7 + lVar22 + lVar19 * 4))
                        ;
                        auVar24 = minps(auVar24,*(undefined1 (*) [16])
                  ...
                  do {
                    ...
                    if (uVar15 != 0) {
                      do {
                        lVar19 = lVar18 * 2;
                        lVar18 = lVar18 + 1;
                        auVar24 = minps(auVar24,ZEXT416(*(uint *)(lVar7 + lVar22 +
                                                                 (longlong)
                                                                 (int)((uint)*(ushort *)
                                                                              (param_9 + lVar21 + 2
                                                                              + lVar19) * param_11)
        ...
        do {
          ...
          if (0 < lVar5) {
            do {
              ...
              lVar17 = lVar17 + 1;
              auVar27 = minps(auVar27,*(undefined1 (*) [16])(lVar7 + lVar8 * 4));
              auVar25 = minps(auVar25,*(undefined1 (*) [16])(lVar7 + 0x10 + lVar8 * 4));
              auVar24 = minps(auVar24,*(undefined1 (*) [16])(lVar7 + 0x20 + lVar8 * 4));
              auVar26 = minps(auVar26,*(undefined1 (*) [16])(lVar7 + 0x30 + lVar8 * 4));
            } while (lVar17 < lVar5);
          }
          lVar22 = lVar22 + 0x10;
          *pauVar10 = auVar27;
      ...
      for (; lVar22 < (longlong)uVar16; lVar22 = lVar22 + 8) {
        ...
        if (0 < lVar5) {
          do {
            ...
            lVar17 = lVar17 + 1;
            auVar25 = minps(auVar25,*(undefined1 (*) [16])(lVar7 + *plVar1 * 4));
            auVar24 = minps(auVar24,*(undefined1 (*) [16])(lVar7 + 0x10 + *plVar1 * 4));
          } while (lVar17 < lVar5);
        }
        *pauVar10 = auVar25;
        lVar7 = lVar7 + 0x20;
      ...
      for (; lVar22 < (longlong)uVar13; lVar22 = lVar22 + 4) {
        ...
        if (0 < lVar5) {
          do {
            plVar1 = alStack_450 + lVar17;
            lVar17 = lVar17 + 1;
            auVar24 = minps(auVar24,*(undefined1 (*) [16])(lVar7 + *plVar1 * 4));
          } while (lVar17 < lVar5);
        }
        *pauVar10 = auVar24;
        lVar7 = lVar7 + 0x10;
      ...
      for (; lVar22 < (longlong)param_5; lVar22 = lVar22 + 1) {
        ...
        if (0 < lVar5) {
          do {
            plVar1 = alStack_450 + lVar17;
            lVar17 = lVar17 + 1;
            auVar24 = minps(auVar24,ZEXT416(*(uint *)(lVar7 + *plVar1 * 4)));
          } while (lVar17 < lVar5);
        }
        *(int *)*pauVar10 = auVar24._0_4_;
        lVar7 = lVar7 + 4;
