...
void FUN_140948ee0(longlong param_1,uint *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140949766:
      ...
      if ((longlong)param_3 < 0x1d) {
        ...
        if (uVar13 != 0) {
          if (((ulonglong)param_2 & 3) != 0) goto LAB_140949766;
          uVar13 = 0x20 - uVar13 >> 2;
        }
        if ((longlong)param_3 < (longlong)(uVar13 + 0x10)) goto LAB_140949766;
        lVar9 = lVar18 * -4 + param_1;
        uVar12 = 0;
...
LAB_140949748:
          ...
          if (uVar10 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140949748;
            uVar10 = 0x20 - uVar10 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar10 + 0x10)) goto LAB_140949748;
...
LAB_14094972e:
    ...
    if ((longlong)param_3 < 0xe1) {
      ...
      uVar13 = (ulonglong)param_2 & 0x1f;
      if (uVar13 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_14094972e;
        uVar13 = 0x20 - uVar13 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar13 + 8)) goto LAB_14094972e;
      uVar12 = 0;
