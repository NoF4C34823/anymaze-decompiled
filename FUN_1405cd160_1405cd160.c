...
void FUN_1405cd160(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1405cdad2:
      uVar37 = 0;
      if (uVar42 == 0) goto LAB_1405cd386;
      uVar39 = 0;
      uVar41 = uVar42;
    }
    else {
      uVar41 = param_2 & 0xf;
      if (uVar41 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1405cdad2;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405cdad2;
      ...
      if (uVar42 < uVar37 + 1) goto LAB_1405cd386;
...
LAB_1405cdaac:
          uVar37 = 0;
          if (uVar42 == 0) goto LAB_1405cd8ee;
          uVar39 = 0;
          uVar41 = uVar42;
        }
        else {
          uVar41 = param_2 & 0xf;
          if (uVar41 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1405cdaac;
            uVar41 = 0x10 - uVar41 >> 2;
          }
          if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405cdaac;
          uVar37 = uVar42 - (uVar42 - uVar41 & 7);
          ...
          if (uVar42 < uVar37 + 1) goto LAB_1405cd8ee;
          uVar41 = uVar42 - uVar37;
          if ((longlong)uVar41 < 4) {
            uVar39 = 0;
          }
...
LAB_1405cda98:
    ...
    uVar41 = param_2 & 0xf;
    if (uVar41 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1405cda98;
      uVar41 = 0x10 - uVar41 >> 2;
    }
    if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405cda98;
    uVar39 = 0;
    uVar37 = uVar42 - (uVar42 - uVar41 & 7);
    if (uVar41 != 0) {
      do {
