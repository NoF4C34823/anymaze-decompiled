...
void FUN_1406a91c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1c8 = param_10;
    (**(code **)(&DAT_14308ba80 + lVar17 * 8))(param_1,param_4,*param_5,param_9);
...
LAB_1406aa32c:
    ...
    iStack_1c8 = param_10;
    (**(code **)(&DAT_14308ba80 + lVar17 * 8))(param_11 + lVar14 * 0xc,param_4,lVar13,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_190 = lVar12 * 3;
      ...
      if (uVar8 != 0 && SCARRY8(lStack_190,-3) == (longlong)uVar8 < 0) {
        if (6 < (longlong)uVar8) {
          ...
          if ((lVar16 <= (longlong)(uStack_188 - param_1)) ||
            ...
            if (uVar10 == 0) {
LAB_1406a932a:
              if ((longlong)uVar8 < (longlong)(uVar10 + 4)) goto LAB_1406aa422;
...
LAB_1406a9b37:
      puStack_1b0 = puVar9;
      pcStack_1a8 = *(code **)(&DAT_14308ba80 + lVar17 * 8);
      uStack_1a0 = CONCAT44(uStack_1a0._4_4_,param_7);
      iStack_1c8 = param_10;
      lStack_178 = param_4;
