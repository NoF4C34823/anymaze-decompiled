...
longlong FUN_14051a320(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && 0 < lVar5) {
      do {
        FUN_140d27be0(param_1,lVar4,lVar1,(longlong)(int)param_6,1);
        lVar7 = lVar7 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_140d27be0(param_1,lVar4,(longlong)(int)param_5,(longlong)(int)param_6,1);
