...
void FUN_140676c39(undefined8 param_1,undefined8 param_2,undefined8 param_3,float param_4)

{
  ...
  if (in_R11 + 1U <= unaff_R12) {
    uVar25 = unaff_R12 - in_R11;
    if ((longlong)uVar25 < 4) {
      FUN_140676d03(param_1,in_RDX,param_3,0);
      return;
    }
    ...
    do {
      ...
      *pfVar2 = (*pfVar4 + *pfVar6) * (float)in_XMM2_Qa + (*pfVar3 + *pfVar5) * (float)param_2 +
                *pfVar1 * (float)in_XMM0_Qa;
      pfVar2[1] = (fVar10 + fVar19) * (float)((ulonglong)in_XMM2_Qa >> 0x20) +
                  (fVar7 + fVar13) * (float)((ulonglong)param_2 >> 0x20) +
                  fVar16 * (float)((ulonglong)in_XMM0_Qa >> 0x20);
      pfVar2[2] = (fVar11 + fVar20) * in_XMM2_Dc + (fVar8 + fVar14) * in_XMM1_Dc +
                  fVar17 * in_XMM0_Dc;
      pfVar2[3] = (fVar12 + fVar21) * in_XMM2_Dd + (fVar9 + fVar15) * in_XMM1_Dd +
                  fVar18 * in_XMM0_Dd;
      uVar22 = uVar22 + 4;
    } while (uVar22 < uVar23);
    if (uVar23 < uVar25) {
