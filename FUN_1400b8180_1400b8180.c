...
void FUN_1400b8180(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1400b86fb:
      uVar34 = 0;
      if (param_5 == 0) goto LAB_1400b8468;
      uVar31 = 0;
      uVar30 = param_5;
    }
    else {
      ...
      uVar30 = uVar37 & 0x1f;
      if (uVar30 != 0) {
        if ((uVar37 & 3) != 0) goto LAB_1400b86fb;
        uVar30 = 0x20 - uVar30 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar30 + 0x10)) goto LAB_1400b86fb;
      ...
      if (param_5 < uVar34 + 1) goto LAB_1400b8468;
...
LAB_1400b8468:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar30 = param_4 & 0x1f;
      if (uVar30 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1400b8719;
...
LAB_1400b868b:
  ...
  if (7 < (longlong)param_5) {
    uVar30 = param_4 & 0xf;
    if (uVar30 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1400b8712;
