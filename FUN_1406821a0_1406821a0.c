...
void FUN_1406821a0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140682a7e:
      uVar39 = 0;
      if (param_5 == 0) goto LAB_1406826c0;
      uVar32 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar32 = uVar30 & 0xf;
      if (uVar32 != 0) {
        if ((uVar30 & 3) != 0) goto LAB_140682a7e;
        uVar32 = 0x10 - uVar32 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar32 + 8)) goto LAB_140682a7e;
      ...
      if (param_5 < uVar39 + 1) goto LAB_1406826c0;
...
LAB_1406826c0:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar32 = uVar30 & 0xf;
      if (uVar32 != 0) {
        if ((uVar30 & 3) != 0) goto LAB_140682aa1;
        uVar32 = 0x10 - uVar32 >> 2;
      }
      if ((longlong)(uVar32 + 4) <= (longlong)param_5) {
        ...
        auVar27 = _DAT_14308b980;
        auVar26 = _DAT_14308b970;
        lVar31 = uVar32 * 2;
        do {
...
LAB_140682a08:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar32 = uVar30 & 0xf;
    if (uVar32 != 0) {
      if ((uVar30 & 3) != 0) goto LAB_140682a9a;
      uVar32 = 0x10 - uVar32 >> 2;
    }
