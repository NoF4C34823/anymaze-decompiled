...
void FUN_1400d3960(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (7 < (longlong)uVar9) {
    if ((longlong)uVar9 < 0x3fd) {
      FUN_1400d3a4c(param_1,param_2,param_3,0);
      return;
    }
    uVar13 = param_2 & 0x1f;
    if (uVar13 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400d3b59;
