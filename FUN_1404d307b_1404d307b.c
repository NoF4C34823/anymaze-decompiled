...
void FUN_1404d307b(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
                  longlong param_4)
    ...
    if (lVar9 != 0) {
      ...
      if (1 < lVar9) {
        do {
          ...
          auVar12 = vminps_avx(pauVar4[1],auVar12);
          ...
          pauVar4 = pauVar4 + 1;
          auVar12 = vminps_avx(auVar12,auVar15);
