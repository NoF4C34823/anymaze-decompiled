...
void FUN_140980120(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x27) {
        ...
        if (uVar24 != 0) {
          ...
          if (param_5 == uVar24) goto LAB_140980392;
        }
      }
    ...
    if (uVar26 + 1 <= param_5) {
      ...
      lVar21 = param_2 * lVar20 + param_1;
      uVar16 = vpcmpgtq_avx512f(auVar38,_DAT_14308dc80);
      bVar19 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar38,_DAT_14308dcc0);
      bVar18 = (byte)uVar16;
      uVar35 = CONCAT11(bVar18,bVar19);
...
LAB_140980550:
          ...
          if (uVar32 == 0) goto LAB_140980550;
          uVar34 = 0;
          ...
          if (param_5 != uVar32) goto LAB_140980550;
        }
        uVar27 = uVar27 + 1;
        puVar22 = puVar22 + 1;
        if (param_7 - 1U <= uVar27) goto LAB_140980608;
      }
      uVar27 = uVar27 + 1;
      puVar22 = puVar22 + 1;
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x7b) {
        ...
        if (uVar26 != 0) {
          ...
          if (param_5 == uVar26) goto LAB_1409807df;
        }
      }
