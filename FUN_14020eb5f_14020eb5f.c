...
void FUN_14020eb5f(longlong param_1,longlong param_2,ulonglong param_3,undefined4 param_4)

{
  ...
  do {
    auVar2._8_8_ = 0;
    auVar2._0_8_ = *(ulonglong *)(param_1 + param_2 * 2 + 4 + uVar10 * 2);
    auVar2 = vpmovsxwd_avx(auVar2);
    lVar1 = uVar10 + param_2;
    auVar3._8_8_ = 0;
    auVar3._0_8_ = *(ulonglong *)(param_1 + -4 + lVar1 * 2);
    ...
    auVar6._8_8_ = 0;
    auVar6._0_8_ = *(ulonglong *)(param_1 + lVar1 * 2);
    auVar2 = vpmovsxwd_avx(auVar6);
    auVar2 = vcvtdq2ps_avx(auVar2);
    auVar2 = vfmadd231ps_fma(auVar3,auVar2,auVar14);
    *(undefined1 (*) [16])(unaff_RDI + param_2 * 4 + uVar10 * 4) = auVar2;
    uVar10 = uVar10 + 4;
  } while (uVar10 < uVar9);
  if (uVar9 < param_3) {
    param_1 = param_1 + param_2 * 2;
    do {
      auVar11._0_4_ = (float)(int)*(short *)(param_1 + uVar9 * 2);
      ...
      *(int *)(unaff_RDI + param_2 * 4 + uVar9 * 4) = auVar12._0_4_;
      uVar9 = uVar9 + 1;
    } while (uVar9 < param_3);
  }
  return;
