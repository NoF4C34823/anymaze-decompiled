...
void FUN_1401731f7(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         (float)((uint)*(ushort *)(param_4 + -4 + in_RAX * 2) +
                (uint)*(ushort *)(param_4 + 4 + in_RAX * 2)) * param_2 +
         (float)((uint)*(ushort *)(param_4 + -2 + in_RAX * 2) +
                (uint)*(ushort *)(param_4 + 2 + in_RAX * 2)) * in_XMM4_Da +
  ...
  do {
    ...
    auVar14._8_2_ = (short)(uVar4 >> 0x20);
    auVar14._0_8_ = uVar4;
    ...
    auVar19._4_2_ = (short)(uVar6 >> 0x10);
    auVar19._0_4_ = (uint)uVar6;
    ...
    *pfVar1 = (float)(((uint)uVar6 & 0xffff) + ((uint)uVar5 & 0xffff)) * param_2 +
              (float)((uint)(ushort)uVar4 + ((uint)uVar2 & 0xffff)) * in_XMM4_Da +
              (float)((uint)uVar3 & 0xffff) * in_XMM0_Da;
    pfVar1[1] = (float)(auVar19._4_4_ + auVar20._4_4_) * param_2 +
                (float)((int)CONCAT82(SUB148(auVar23 << 0x40,6),(short)(uVar4 >> 0x10)) +
                       auVar17._4_4_) * in_XMM4_Da + (float)auVar18._4_4_ * in_XMM0_Da;
    pfVar1[2] = (float)(auVar15._8_4_ + auVar16._8_4_) * param_2 +
                (float)(auVar14._8_4_ + auVar12._8_4_) * in_XMM4_Da +
                (float)auVar13._8_4_ * in_XMM0_Da;
    pfVar1[3] = (float)((auVar10._10_4_ >> 0x10) + (auVar11._10_4_ >> 0x10)) * param_2 +
                (float)((auVar9._10_4_ >> 0x10) + (auVar7._10_4_ >> 0x10)) * in_XMM4_Da +
    ...
    do {
      *(float *)(in_R10 + param_1 * 4) =
           (float)((uint)*(ushort *)(param_4 + -4 + param_1 * 2) +
                  (uint)*(ushort *)(param_4 + 4 + param_1 * 2)) * param_2 +
           (float)((uint)*(ushort *)(param_4 + -2 + param_1 * 2) +
                  (uint)*(ushort *)(param_4 + 2 + param_1 * 2)) * in_XMM4_Da +
