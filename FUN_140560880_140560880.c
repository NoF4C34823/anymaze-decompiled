...
void FUN_140560880(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar8 != 0 && 0 < lVar6) {
      do {
        thunk_FUN_140d28c00(param_1,lVar4,lVar1,lVar2,3);
        lVar7 = lVar7 + 1;
