...
void FUN_1400b6760(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1400b6f4e:
      uVar57 = 0;
      if (param_5 == 0) goto LAB_1400b6cbd;
      uVar54 = 0;
      uVar50 = param_5;
    }
    else {
      ...
      uVar50 = uVar49 & 0x1f;
      if (uVar50 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_1400b6f4e;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar50 + 0x10)) goto LAB_1400b6f4e;
      ...
      if (param_5 < uVar57 + 1) goto LAB_1400b6cbd;
...
LAB_1400b6cbd:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar49 = uVar50 & 0xf;
      if (uVar49 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1400b6f6d;
...
LAB_1400b6ee2:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar49 = uVar50 & 0xf;
    if (uVar49 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_1400b6f66;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
      uVar54 = 0;
