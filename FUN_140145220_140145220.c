...
void FUN_140145220(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar26 != 0 && 0 < (longlong)uVar9) {
      do {
        FUN_140299b60(lVar11,lVar24,uVar7,(longlong)(int)param_6,3);
        lVar25 = lVar25 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_140299b60(lVar11,lVar24,uVar7,(longlong)(int)param_6,3);
        FUN_1402a53a0(param_9,uVar22,param_3,uVar7,uVar9);
        lVar26 = lVar26 + 1;
        lVar24 = lVar24 + uVar22;
...
LAB_140145993:
                    ...
                    if (lVar23 < (longlong)(uStack_60 + 0x10)) goto LAB_140145993;
                    uVar15 = 0;
                    uVar19 = lVar23 - (lVar23 - uStack_60 & 0xf);
                    if (uStack_60 != 0) {
                      do {
                        if ((*(char *)(uVar15 + uVar12) != '\0') &&
                           (bVar29 = *(byte *)(lVar1 + uVar15 * 3 + lVar25), bVar30 < bVar29)) {
                          bVar30 = bVar29;
                        }
                        uVar15 = uVar15 + 1;
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar27 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar30 = auVar32[9];
                        auVar28[9] = (bVar10 < bVar30) * bVar30 | (bVar10 >= bVar30) * bVar10;
                        bVar30 = auVar32[10];
                        auVar28[10] = (bVar17 < bVar30) * bVar30 | (bVar17 >= bVar30) * bVar17;
                        bVar30 = auVar32[0xb];
                        auVar28[0xb] = (bVar3 < bVar30) * bVar30 | (bVar3 >= bVar30) * bVar3;
                        bVar30 = auVar32[0xc];
                        auVar28[0xc] = (bVar4 < bVar30) * bVar30 | (bVar4 >= bVar30) * bVar4;
                        bVar30 = auVar32[0xd];
                        auVar28[0xd] = (bVar8 < bVar30) * bVar30 | (bVar8 >= bVar30) * bVar8;
                        bVar30 = auVar32[0xe];
                  ...
                  for (; uVar19 < (ulonglong)(longlong)(int)param_6; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar12) != '\0') &&
                       (bVar29 = *(byte *)(lVar1 + uVar19 * 3 + lVar25), bVar30 < bVar29)) {
                      bVar30 = bVar29;
                    }
                  }
                }
