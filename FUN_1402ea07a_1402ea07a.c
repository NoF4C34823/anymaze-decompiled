...
void FUN_1402ea07a(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_1402dd1e0(unaff_RSI,unaff_RBX,uStack0000000000000068,uStack0000000000000060,4);
    FUN_142d20530(in_stack_00000110,param_1,param_3,uStack0000000000000068);
