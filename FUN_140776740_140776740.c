...
void FUN_140776740(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_140776959:
    ...
    uVar4 = param_2 & 0xf;
    if (uVar4 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140776959;
      uVar4 = 0x10 - uVar4 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar4 + 8)) goto LAB_140776959;
    uVar5 = 0;
    uVar6 = param_3 - (param_3 - uVar4 & 7);
    if (uVar4 != 0) {
      do {
        *(float *)(param_2 + uVar5 * 4) =
             (float)((int)*(short *)(param_1 + -2 + uVar5 * 2) +
                    (int)*(short *)(param_1 + 2 + uVar5 * 2)) * fVar2 +
             (float)(int)*(short *)(param_1 + uVar5 * 2) * fVar3;
        uVar5 = uVar5 + 1;
      } while (uVar5 < uVar4);
    }
    do {
      auVar9 = pmovsxwd(in_XMM5,*(undefined8 *)(param_1 + -2 + uVar4 * 2));
      auVar7 = pmovsxwd(in_XMM4,*(undefined8 *)(param_1 + 2 + uVar4 * 2));
      auVar8 = pmovsxwd(auVar7,*(undefined8 *)(param_1 + uVar4 * 2));
      ...
      *(undefined1 (*) [16])(param_2 + uVar4 * 4) = auVar8;
      auVar7 = pmovsxwd(auVar10,*(undefined8 *)(param_1 + 6 + uVar4 * 2));
      auVar8 = pmovsxwd(auVar8,*(undefined8 *)(param_1 + 10 + uVar4 * 2));
      auVar10 = pmovsxwd(auVar8,*(undefined8 *)(param_1 + 8 + uVar4 * 2));
    ...
    if (3 < (longlong)param_3) {
      ...
      do {
        auVar7 = pmovsxwd(in_XMM4,*(undefined8 *)(lVar1 + -2 + uVar5 * 2));
        auVar8 = pmovsxwd(in_XMM5,*(undefined8 *)(lVar1 + 2 + uVar5 * 2));
        auVar10 = pmovsxwd(auVar8,*(undefined8 *)(lVar1 + uVar5 * 2));
        in_XMM5._0_4_ = (float)auVar10._0_4_ * fVar3;
        in_XMM5._4_4_ = (float)auVar10._4_4_ * fVar3;
        in_XMM5._8_4_ = (float)auVar10._8_4_ * fVar3;
        in_XMM5._12_4_ = (float)auVar10._12_4_ * fVar3;
  ...
  if (uVar4 < param_3) {
    ...
    do {
      *(float *)(param_2 + uVar6 * 4 + uVar4 * 4) =
           (float)((int)*(short *)(param_1 + -2 + uVar4 * 2) +
                  (int)*(short *)(param_1 + 2 + uVar4 * 2)) * fVar2 +
