...
void FUN_1406c1600(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1406c1ec4:
      ...
      uVar83 = param_2 & 0xf;
      if (uVar83 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1406c1ec4;
        uVar83 = 0x10 - uVar83 >> 2;
      }
      if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1406c1ec4;
...
LAB_1406c1ea6:
          uVar77 = 0;
          if (uVar88 == 0) goto LAB_1406c1cca;
          uVar85 = 0;
          uVar83 = uVar88;
        }
        else {
          uVar83 = param_2 & 0xf;
          if (uVar83 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1406c1ea6;
            uVar83 = 0x10 - uVar83 >> 2;
          }
          if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1406c1ea6;
          uVar77 = uVar88 - (uVar88 - uVar83 & 7);
          ...
          if (uVar88 < uVar77 + 1) goto LAB_1406c1cca;
...
LAB_1406c1e93:
    ...
    uVar83 = param_2 & 0xf;
    if (uVar83 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406c1e93;
      uVar83 = 0x10 - uVar83 >> 2;
    }
    if ((longlong)uVar88 < (longlong)(uVar83 + 8)) goto LAB_1406c1e93;
    uVar85 = 0;
    uVar77 = uVar88 - (uVar88 - uVar83 & 7);
    if (uVar83 != 0) {
      do {
