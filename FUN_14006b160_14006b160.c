...
void FUN_14006b160(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar45 = param_4 & 0xf;
      if (uVar45 != 0) {
        if ((param_4 & 3) != 0) goto LAB_14006ba20;
...
LAB_14006ba20:
  ...
  if (3 < (longlong)param_5) {
    uVar45 = param_4 & 0xf;
    if (uVar45 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14006b5c0;
      uVar45 = 0x10 - uVar45 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar45 + 4)) {
      uVar43 = 0;
