...
void FUN_1409dd960(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308e500)[lVar7])(pbVar9,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar16 == 6) {
    uVar22 = (uint)*param_8;
          ...
          if (uVar16 != 6) {
            if (uVar16 == 1) {
              ...
              if (lVar13 < 2) {
                ...
                if (lVar24 < 0) goto LAB_1409df000;
                while (uVar11 == 0) {
                  for (lVar21 = (lVar13 + -1) * 2 - lVar21; lVar21 < 0; lVar21 = -lVar21) {
LAB_1409df000:
                    if (uVar19 != 0) goto LAB_1409deea3;
                  }
          ...
          if (uVar17 != 0) goto LAB_1409deea3;
          bVar23 = (byte)uVar22;
        }
        else {
LAB_1409deea3:
    ...
    (*(code *)(&PTR_LAB_14308e500)[lVar7])(param_11 + uVar25,param_4,lVar13,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar25 == 1) {
          ...
          if ((lVar24 + -1 <= lVar8) || (lVar24 + -1 <= -lVar8)) {
            if ((longlong)uVar15 < 0x40) {
              ...
              if ((longlong)uVar15 < 0x116) {
                ...
                if (uVar18 != 0) {
                  uVar20 = 0;
                  auVar32 = vmovdqu32_avx512f(_DAT_14308e300);
                  auVar33 = vmovdqu32_avx512f(_DAT_14308e340);
                  ...
                  if (uVar15 == uVar18) goto LAB_1409dde87;
                }
              }
            ...
            if ((longlong)uVar25 < 0x40) {
              ...
              if ((longlong)uVar25 < 0x96) {
                ...
                if (uVar10 != 0) {
                  ...
                  if (uVar25 == uVar10) goto LAB_1409de2f6;
                }
              }
...
LAB_1409de2f6:
      (*(code *)(&PTR_LAB_14308e500)[lVar7])(lStack_60,param_4,uVar25,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_LAB_14308e500)[lVar7])(pbVar9,param_4,lVar13,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar15 < 0x40) {
          ...
          if ((longlong)uVar15 < 0xeb) {
            ...
            if (uVar10 != 0) {
              ...
              if (uVar15 == uVar10) goto LAB_1409de7e3;
            }
          }
          if ((longlong)(uVar10 + 0x40) <= (longlong)uVar12) {
            do {
...
LAB_1409de7e3:
    ...
    if (0 < (longlong)uVar25) {
      if ((longlong)uVar25 < 7) {
        ...
        if ((longlong)uVar25 < 0x40) {
          ...
          if ((longlong)uVar25 < 0xd6) {
            ...
            if (uVar12 != 0) {
              ...
              if (uVar25 == uVar12) goto LAB_1409ded5a;
            }
          }
        ...
        if (uVar15 + 1 <= uVar25) {
          ...
          auVar33 = vmovdqu32_avx512f(_DAT_14308e300);
          auVar34 = vmovdqu32_avx512f(_DAT_14308e340);
          do {
  ...
  if ((longlong)uVar25 < 1) goto LAB_1409ded5a;
...
LAB_1409def76:
    ...
    if ((longlong)uVar25 < 0x181) {
      ...
      if ((longlong)uVar25 < (longlong)(uVar15 + 0x10)) goto LAB_1409def76;
      uVar10 = 0;
      lVar8 = 0;
...
LAB_1409ded5a:
  (*(code *)(&PTR_LAB_14308e500)[lVar7])(param_11 + uVar25,param_4,uVar25,param_9,param_10);
  return;
}
