...
/* WARNING: Removing unreachable block (ram,0x0001400a9f36) */

ulonglong FUN_1400a8b40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
                       ulonglong *param_5,uint param_6,uint param_7,short *param_8,
...

{
  ...
  lStack_78 = param_2;
  if (iVar13 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1400aa2a1;
  }
  else {
    ...
    do {
      ...
      uStack_180 = param_10;
      lStack_178 = param_11;
      auVar28._0_8_ = FUN_1407a8de0(lStack_88,lStack_78,lVar11,lVar14);
      uVar12 = uStack_68;
    ...
    if ((param_7 & 0x10) != 0) {
      pcStack_d0 = *(code **)(&UNK_143086ac0 + (longlong)(int)param_6 * 8);
            ...
            if (lStack_c0 < (longlong)(uVar12 + uVar8)) {
              do {
                ...
                if (lVar9 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar10 == 6) {
                      if (uStack_d8 == 0) goto LAB_1400aa212;
                    }
                    else {
                      if (uVar10 != 1) goto LAB_1400aa184;
LAB_1400aa305:
                      lVar22 = 0;
                      if (uStack_d8 != 0) {
                        lVar22 = lVar9;
...
LAB_1400aa1f5:
                  sVar17 = *(short *)(lVar19 + lVar22 * 6);
                  sVar24 = *(short *)(lVar19 + 2 + lVar22 * 6);
                  sVar18 = *(short *)(lVar19 + 4 + lVar22 * 6);
                }
                else {
                  if ((lVar9 < (longlong)uVar8) || (param_7 == 0xf0)) goto LAB_1400aa1f5;
                  if (uVar10 != 6) {
                    if (uVar10 == 1) {
                      if (lVar9 < 0) goto LAB_1400aa305;
                      if (uStack_b8 == 0) {
                        lVar22 = uVar8 - 1;
                      }
                    }
...
LAB_1400aa318:
                  ...
                  if (uStack_b8 != 0) goto LAB_1400aa1f5;
LAB_1400aa212:
                  sVar17 = *psVar26;
                  sVar24 = psVar26[1];
                  sVar18 = psVar26[2];
                ...
                uVar21 = uVar21 + 1;
                *(short *)(lVar11 + param_11) = sVar17;
                lVar9 = lVar9 + 1;
                *(short *)(lVar11 + 2 + param_11) = sVar24;
                *(short *)(lVar11 + 4 + param_11) = sVar18;
                lVar11 = lVar11 + 6;
...
LAB_1400a95f5:
              if (uVar10 == 1) {
                ...
                if (6 < (longlong)uStack_158 / 3) {
                  ...
                  lVar9 = (longlong)psVar26 + (2 - param_11);
                  if (((lVar11 <= lVar9) || (3 < -lVar9)) &&
                     ((1 < param_11 - (longlong)psVar26 ||
                      (lVar11 <= -(param_11 - (longlong)psVar26))))) {
                    lVar11 = 1;
                    sVar17 = *psVar26;
                    sVar24 = psVar26[1];
                    lVar9 = 0;
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar15 = uVar21;
                        uVar21 = uVar15 + 1;
                        *(short *)(lVar9 + param_11) = sVar17;
                        *(short *)(lVar9 + 2 + param_11) = sVar24;
                        *(short *)(lVar9 + 4 + param_11) = sVar18;
                        *(short *)(lVar9 + 6 + param_11) = sVar17;
                        *(short *)(lVar9 + 8 + param_11) = sVar24;
                        *(short *)(lVar9 + 10 + param_11) = sVar18;
                        lVar9 = lVar9 + 0xc;
                      } while (uVar21 < uStack_140);
                      lVar11 = uVar15 + 2 + uVar21;
                    }
                    if (lVar11 - 1U < uStack_160) {
                      lVar11 = lVar11 * 3 + -3;
                      *(short *)(param_11 + lVar11 * 2) = sVar17;
                      *(short *)(param_11 + 2 + lVar11 * 2) = sVar24;
                      *(short *)(param_11 + 4 + lVar11 * 2) = sVar18;
                    }
                    goto LAB_1400a9b01;
                  }
                }
                ...
                if (uStack_140 != 0) {
                  do {
                    uVar15 = uVar21;
                    uVar21 = uVar15 + 1;
                    *(short *)(param_11 + uVar15 * 0xc) = *psVar26;
                    *(short *)(param_11 + 2 + uVar15 * 0xc) = psVar26[1];
                    *(short *)(param_11 + 4 + uVar15 * 0xc) = psVar26[2];
                    *(short *)(param_11 + 6 + uVar15 * 0xc) = *psVar26;
                    *(short *)(param_11 + 8 + uVar15 * 0xc) = psVar26[1];
                    *(short *)(param_11 + 10 + uVar15 * 0xc) = psVar26[2];
                  } while (uVar21 < uStack_140);
                  lVar11 = uVar15 + 2 + uVar21;
                }
                if (lVar11 - 1U < uStack_160) {
                  lVar11 = lVar11 * 3 + -3;
                  *(short *)(param_11 + lVar11 * 2) = *psVar26;
                  *(short *)(param_11 + 2 + lVar11 * 2) = psVar26[1];
                  *(short *)(param_11 + 4 + lVar11 * 2) = psVar26[2];
                }
              }
LAB_1400a9b01:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar25);
            ...
            if (uStack_b8 == 0) {
              ...
              if (uVar10 == 1) {
                ...
                if (6 < (longlong)uStack_158 / 3) {
                  lVar11 = ((longlong)uStack_158 / 3) * 6;
                  lVar19 = (longlong)psVar26 + (2 - (lStack_150 + -6));
                  if (((lVar11 <= lVar19) || (3 < -lVar19)) &&
                     ((lVar19 = (lStack_150 + -6) - (longlong)psVar26, 1 < lVar19 ||
                      (lVar11 <= -lVar19)))) {
                    lVar11 = 1;
                    sVar17 = *psVar26;
                    sVar24 = psVar26[1];
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar21 = uVar8;
                        uVar8 = uVar21 + 1;
                        *(short *)(lVar19 + -6 + lStack_150) = sVar17;
                        *(short *)(lVar19 + -4 + lStack_150) = sVar24;
                        *(short *)(lVar19 + -2 + lStack_150) = sVar18;
                        *(short *)(lVar19 + lStack_150) = sVar17;
                        *(short *)(lVar19 + 2 + lStack_150) = sVar24;
                        *(short *)(lVar19 + 4 + lStack_150) = sVar18;
                        lVar19 = lVar19 + 0xc;
                      } while (uVar8 < uStack_140);
                      lVar11 = uVar21 + 2 + uVar8;
                    }
                    if (lVar11 - 1U < uStack_160) {
                      lVar11 = lVar11 * 3 + -3;
                      *(short *)(lStack_150 + -6 + lVar11 * 2) = sVar17;
                      *(short *)(lStack_150 + -4 + lVar11 * 2) = sVar24;
                      *(short *)(lStack_150 + -2 + lVar11 * 2) = sVar18;
                    }
                    goto LAB_1400aa0a6;
                  }
                }
                ...
                if (lVar11 - 1U < uStack_160) {
                  lVar11 = lVar11 * 3 + -3;
                  *(short *)(lStack_150 + -6 + lVar11 * 2) = *psVar26;
                  *(short *)(lStack_150 + -4 + lVar11 * 2) = psVar26[1];
                  *(short *)(lStack_150 + -2 + lVar11 * 2) = psVar26[2];
                }
              }
LAB_1400aa0a6:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar25);
...
LAB_1400aa2a1:
  ...
  if (uVar10 == 6) {
    uVar12 = 0;
    lVar11 = 0;
    uVar8 = (ulonglong)(uint)(int)*param_8;
...
LAB_1400a9027:
            ...
            uVar16 = uVar20 & 0xf;
            if (uVar16 != 0) {
              if ((uVar20 & 3) != 0) goto LAB_1400a9027;
              uVar16 = 0x10 - uVar16 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar16 + 4)) goto LAB_1400a9027;
            uVar15 = 0;
    ...
    if (uVar10 == 3) {
      ...
      lStack_178 = param_11;
      uStack_180 = param_10;
      uVar8 = FUN_1407a8de0(param_1,lStack_78,(longlong)iVar13,param_3);
      lVar11 = 1;
      uVar12 = 0;
      if (1 < iVar13) {
        uVar8 = *param_5;
...
LAB_1400a8ea7:
              ...
              uVar21 = uVar20 & 0xf;
              if (uVar21 != 0) {
                if ((uVar20 & 3) != 0) goto LAB_1400a8ea7;
                uVar21 = 0x10 - uVar21 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar21 + 4)) goto LAB_1400a8ea7;
