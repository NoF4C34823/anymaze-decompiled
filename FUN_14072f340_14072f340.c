...
void FUN_14072f340(longlong param_1,ulonglong param_2,longlong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)uVar6) {
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14072f62e;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)(uVar8 + 4) <= (longlong)uVar6) {
      ...
      if (uVar8 != 0) {
        do {
          auVar14._0_4_ =
               (float)((int)*(short *)(param_1 + -0x12 + uVar9 * 2) +
                      (int)*(short *)(param_1 + 0x12 + uVar9 * 2));
          auVar14._4_4_ =
               (float)((int)*(short *)(param_1 + -0xc + uVar9 * 2) +
                      (int)*(short *)(param_1 + 0xc + uVar9 * 2));
          auVar14._12_4_ = (float)(int)*(short *)(param_1 + uVar9 * 2);
          auVar14._8_4_ =
               (float)((int)*(short *)(param_1 + -6 + uVar9 * 2) +
                      (int)*(short *)(param_1 + 6 + uVar9 * 2));
      ...
      do {
        auVar14 = pmovsxwd(in_XMM2,*(undefined8 *)(param_1 + -0x12 + uVar8 * 2));
        auVar13 = pmovsxwd(auVar13,*(undefined8 *)(param_1 + 0x12 + uVar8 * 2));
        auVar11 = pmovsxwd(in_XMM0,*(undefined8 *)(param_1 + 0xc + uVar8 * 2));
        ...
        auVar14 = pmovsxwd(auVar13,*(undefined8 *)(param_1 + -0xc + uVar8 * 2));
        ...
        auVar11 = pmovsxwd(auVar11,*(undefined8 *)(param_1 + -6 + uVar8 * 2));
        in_XMM2 = pmovsxwd(auVar15,*(undefined8 *)(param_1 + 6 + uVar8 * 2));
        ...
        in_XMM0 = pmovsxwd(auVar12,*(undefined8 *)(param_1 + uVar8 * 2));
      ...
      goto joined_r0x00014072f57b;
    }
  }
LAB_14072f62e:
  uVar10 = 0;
joined_r0x00014072f57b:
  for (; uVar10 < uVar6; uVar10 = uVar10 + 1) {
    auVar11._0_4_ =
         (float)((int)*(short *)(param_1 + -0x12 + uVar10 * 2) +
                (int)*(short *)(param_1 + 0x12 + uVar10 * 2));
    auVar11._4_4_ =
         (float)((int)*(short *)(param_1 + -0xc + uVar10 * 2) +
                (int)*(short *)(param_1 + 0xc + uVar10 * 2));
    auVar11._12_4_ = (float)(int)*(short *)(param_1 + uVar10 * 2);
    auVar11._8_4_ =
         (float)((int)*(short *)(param_1 + -6 + uVar10 * 2) +
                (int)*(short *)(param_1 + 6 + uVar10 * 2));
