...
void FUN_1401fe420(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401ff434. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088240 + lVar6 * 8))(puVar22,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_1401ff3c0;
                while (uVar13 == 0) {
                  for (lVar24 = (lVar15 + -1) * 2 - lVar24; lVar24 < 0; lVar24 = -lVar24) {
LAB_1401ff3c0:
                    if (uVar8 != 0) goto LAB_1401ff2c2;
                  }
          ...
          uVar23 = uVar25;
          if (uVar21 != 0) goto LAB_1401ff2c2;
        }
        else {
LAB_1401ff2c2:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar23;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401ff322. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088240 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,lVar15,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_1401ff336:
              ...
              uVar7 = uVar17 & 0xf;
              if (uVar7 != 0) {
                if ((uVar17 & 1) != 0) goto LAB_1401ff336;
                uVar7 = 0x10 - uVar7 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar7 + 8)) goto LAB_1401ff336;
...
LAB_1401fe87d:
      if (uVar18 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_1401fea8d;
...
LAB_1401ff398:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401ff398;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1401ff398;
          uVar11 = 0;
...
LAB_1401ff33d:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401ff33d;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_1401ff33d;
          uVar11 = 0;
          uVar9 = uVar12 - (uVar12 - uVar7 & 7);
          if (uVar7 != 0) {
            do {
...
LAB_1401fea8d:
      (**(code **)(&DAT_143088240 + lVar6 * 8))(uVar17,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401ff395. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088240 + lVar6 * 8))(puVar22,param_4,lVar15);
    return;
  }
  if ((longlong)uVar12 < lVar15) {
    lVar15 = lVar15 - uVar12;
    (**(code **)(&DAT_143088240 + lVar6 * 8))(puVar22,param_4,lVar15,param_9,param_10);
...
LAB_1401ff345:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401ff345;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_1401ff345;
...
LAB_1401feedc:
  if (uVar18 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_1401ff17a;
...
LAB_1401ff353:
          ...
          uVar17 = uVar19 & 0xf;
          if (uVar17 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_1401ff353;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_1401ff353;
          uVar7 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar12 < 1)) goto LAB_1401ff17a;
  if ((longlong)uVar12 < 8) {
LAB_1401ff34c:
    uVar17 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar15 - 2U & 1) != 0) goto LAB_1401ff34c;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar19 + 8)) goto LAB_1401ff34c;
    uVar7 = 0;
...
LAB_1401ff17a:
                    /* WARNING: Could not recover jumptable at 0x0001401ff1b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_143088240 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
