...
void FUN_1407b9554(longlong param_1,undefined8 param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    auVar7 = pmovzxbw(in_XMM1,*(undefined8 *)((in_RAX - 2) + param_1));
    auVar14 = pmovzxbw(unaff_XMM7,*(undefined8 *)(in_RAX + 2 + param_1));
    auVar10 = pmovzxbw(unaff_XMM6,*(undefined8 *)(in_RAX + 6 + param_1));
    ...
    auVar8 = pmovzxbw(in_XMM2,*(undefined8 *)(in_RAX + 10 + param_1));
    ...
    auVar9 = pmovzxbw(auVar8,*(undefined8 *)((in_RAX - 1) + param_1));
    auVar15 = pmovzxwd(auVar14,auVar12);
    auVar8 = pmovzxbw(auVar10,*(undefined8 *)(in_RAX + 1 + param_1));
    auVar11 = pmovzxwd(auVar12 >> 0x40,auVar12 >> 0x40);
    auVar6 = pmovzxbw(auVar7,*(undefined8 *)(in_RAX + 7 + param_1));
    auVar12 = pmovzxbw(auVar11,*(undefined8 *)(in_RAX + 9 + param_1));
  ...
  if (unaff_RDI + 1 <= param_3) {
    ...
    do {
      auVar7 = pmovzxbw(ZEXT416(*(uint *)((longlong)puVar4 + -2)),
      ...
      auVar8 = pmovzxbw(ZEXT416(*(uint *)((longlong)puVar4 + 1)),
                        ZEXT416(*(uint *)((longlong)puVar4 + 1)));
      auVar6 = pmovzxbw(ZEXT416(*(uint *)((longlong)puVar4 + -1)),
                        ZEXT416(*(uint *)((longlong)puVar4 + -1)));
      ...
      do {
        *(float *)(param_4 + unaff_RDI * 4 + uVar3 * 4) =
             ...
             * fStack00000000000000d0 +
             (float)((uint)*(byte *)((uVar3 - 1) + param_1) + (uint)*(byte *)(uVar3 + 1 + param_1))
