...
void FUN_1403d91e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  uVar11 = *param_6;
  uVar18 = param_6[1];
  uVar8 = *param_5 * 2 + *param_5;
  uVar13 = uVar8 + 7 & 0xfffffffffffffff8;
  param_1 = param_1 + ((longlong)(int)(uVar11 - 1 >> 1) * 3 + (int)(uVar18 - 1 >> 1) * param_2) * -4
  ;
  if (param_7 == 0) {
    lVar5 = 0;
    lVar6 = param_9;
    if (0 < (longlong)(uVar18 - 1)) {
      while( true ) {
        FUN_1403bffa0(param_1,lVar6,uVar8,uVar11,3);
        uVar18 = param_6[1];
        lVar5 = lVar5 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_1403bffa0(param_1,lVar6,uVar8,*param_6,3);
        thunk_FUN_142d25930(param_9,uVar13,param_3,uVar8,param_6[1]);
        lVar5 = lVar5 + 1;
        lVar15 = lVar15 + 1;
        lVar6 = lVar6 + uVar13 * 4;
              ...
              do {
                if (0 < (longlong)uVar11) {
                  ...
                  if (uVar11 >> 1 != 0) {
                    ...
                    do {
                      if ((*(char *)(param_7 + lVar16 + uVar7 * 2) != '\0') &&
                         (fVar2 = *(float *)(lVar3 + lVar9), fVar2 <= fVar19)) {
                        fVar19 = fVar2;
                      }
                      if ((*(char *)(param_7 + lVar16 + 1 + uVar7 * 2) != '\0') &&
                         (fVar2 = *(float *)(lVar3 + 0xc + lVar9), fVar2 <= fVar19)) {
                        fVar19 = fVar2;
                      }
                      uVar7 = uVar7 + 1;
                      lVar3 = lVar3 + 0x18;
                  ...
                  if (((lVar9 - 1U < uVar11) && (*(char *)(param_7 + -1 + lVar9 + lVar16) != '\0'))
                     && (fVar2 = *(float *)((lVar9 - 1U) * 0xc + lVar1 + lVar10 * 4),
                        fVar2 <= fVar19)) {
                    fVar19 = fVar2;
                  }
                }
