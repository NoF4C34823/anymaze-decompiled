...
void FUN_1405813c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar8 != 0 && 0 < lVar6) {
      do {
        thunk_FUN_140d353c0(param_1,lVar3,lVar5,lVar1,1);
        lVar7 = lVar7 + 1;
    ...
    if (0 < (longlong)param_5._4_4_) {
      do {
        thunk_FUN_140d353c0(param_1,lVar3,lVar5,lVar1,1);
        thunk_FUN_140d358e0(param_9,uVar4,param_3,lVar5,lVar6);
        lVar8 = lVar8 + 1;
        lVar7 = lVar7 + 1;
        lVar3 = lVar3 + uVar4 * 2;
        if (lVar6 <= lVar8) {
