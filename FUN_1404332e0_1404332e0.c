...
longlong FUN_1404332e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && SCARRY8(lVar5,-1) == lVar6 < 0) {
      do {
        FUN_140d11c00(param_1,lVar4,lVar1,(longlong)(int)param_6,1);
        lVar8 = lVar8 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_140d11c00(param_1,lVar4,(longlong)(int)param_5,(longlong)(int)param_6,1);
