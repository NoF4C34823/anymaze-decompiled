...
void FUN_1407bcc60(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (3 < (longlong)param_3) {
    uVar5 = param_2 & 0xf;
    if (uVar5 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407bce36;
      uVar5 = 0x10 - uVar5 >> 2;
    }
    uVar7 = uVar5 + 4;
...
LAB_1407bce36:
  FUN_1407bcdc4(fVar4,uVar7,fVar2,0);
  return;
}
