...
void FUN_1402beca4(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_1402dd1e0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,uStack0000000000000060,1);
      thunk_FUN_142d20530(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
