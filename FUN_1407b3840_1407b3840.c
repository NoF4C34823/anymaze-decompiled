...
void FUN_1407b3840(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407b48f5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c300)[lVar4])(psVar25,param_4,*param_5);
    return;
  }
  if (uVar14 == 6) {
    sVar19 = *param_8;
          ...
          if (uVar14 != 6) {
            if (uVar14 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar12 < 0) goto LAB_1407b4880;
                while (uVar8 == 0) {
                  for (lVar23 = (lVar20 + -1) * 2 - lVar23; lVar23 < 0; lVar23 = -lVar23) {
LAB_1407b4880:
                    if (uVar16 != 0) goto LAB_1407b4783;
                  }
...
LAB_1407b4783:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar22;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407b47e6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c300)[lVar4])(param_11 + uVar10 * 2,param_4,lVar20,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar10 == 1) {
...
LAB_1407b47fa:
              ...
              uVar17 = uVar7 & 0xf;
              if (uVar17 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_1407b47fa;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar17 + 8)) goto LAB_1407b47fa;
...
LAB_1407b3d1d:
      if (uVar14 == 1) {
        if ((longlong)uVar10 < 1) goto LAB_1407b3f2d;
...
LAB_1407b485a:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407b485a;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_1407b485a;
          uVar5 = 0;
...
LAB_1407b4801:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407b4801;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_1407b4801;
          uVar5 = 0;
          uVar21 = uVar10 - (uVar10 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_1407b3f2d:
      in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c300)[lVar4])(uVar7,param_4,uVar10,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001407b4857. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c300)[lVar4])(psVar25,param_4,lVar20);
    return;
  }
  if ((longlong)uVar10 < lVar20) {
    lVar20 = lVar20 - uVar10;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c300)[lVar4])(psVar25,param_4,lVar20,param_9,param_10);
...
LAB_1407b4808:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407b4808;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar7 + 8)) goto LAB_1407b4808;
...
LAB_1407b439c:
  if (uVar14 == 1) {
    if ((longlong)uVar10 < 1) goto LAB_1407b463b;
...
LAB_1407b4818:
          ...
          uVar7 = uVar18 & 0xf;
          if (uVar7 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_1407b4818;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar7 + 8)) goto LAB_1407b4818;
          uVar17 = 0;
  ...
  if ((uVar14 != 6) || ((longlong)uVar10 < 1)) goto LAB_1407b463b;
  if ((longlong)uVar10 < 8) {
LAB_1407b4810:
    uVar7 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar20 - 2U & 1) != 0) goto LAB_1407b4810;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar10 < (longlong)(uVar18 + 8)) goto LAB_1407b4810;
    uVar17 = 0;
...
LAB_1407b463b:
                    /* WARNING: Could not recover jumptable at 0x0001407b4674. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c300)[lVar4])(param_11 + uVar10 * 2,param_4,uVar10);
  return;
}
