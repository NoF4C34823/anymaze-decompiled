...
void FUN_14072d5c0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14072deac:
      uVar13 = 0;
      if (uVar16 == 0) goto LAB_14072d7e5;
      uVar15 = 0;
      uVar8 = uVar16;
    }
    else {
      uVar8 = param_2 & 0xf;
      if (uVar8 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14072deac;
        uVar8 = 0x10 - uVar8 >> 2;
      }
      if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14072deac;
      uVar15 = 0;
      ...
      if (uVar16 < uVar13 + 1) goto LAB_14072d7e5;
      uVar8 = uVar16 - uVar13;
      if ((longlong)uVar8 < 4) {
        uVar15 = 0;
      }
...
LAB_14072de86:
          uVar13 = 0;
          if (uVar16 == 0) goto LAB_14072dccd;
          uVar15 = 0;
          uVar8 = uVar16;
        }
        else {
          uVar8 = param_2 & 0xf;
          if (uVar8 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14072de86;
            uVar8 = 0x10 - uVar8 >> 2;
          }
          if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14072de86;
          uVar15 = 0;
          ...
          if (uVar16 < uVar13 + 1) goto LAB_14072dccd;
          uVar8 = uVar16 - uVar13;
          if ((longlong)uVar8 < 4) {
            uVar15 = 0;
          }
...
LAB_14072de73:
    ...
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14072de73;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)uVar16 < (longlong)(uVar8 + 8)) goto LAB_14072de73;
    uVar15 = 0;
    uVar13 = uVar16 - (uVar16 - uVar8 & 7);
    if (uVar8 != 0) {
      do {
