...
void FUN_1406a7ea0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1406a8785:
      ...
      uVar42 = uVar41 & 0xf;
      if (uVar42 != 0) {
        if ((uVar41 & 3) != 0) goto LAB_1406a8785;
        uVar42 = 0x10 - uVar42 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar42 + 4)) goto LAB_1406a8785;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar42 = param_4 & 0xf;
      if (uVar42 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1406a8793;
...
LAB_1406a86ff:
  ...
  if (7 < (longlong)param_5) {
    uVar42 = param_4 & 0xf;
    if (uVar42 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1406a878c;
      uVar42 = 0x10 - uVar42 >> 1;
    }
    if ((longlong)(uVar42 + 8) <= (longlong)param_5) {
      lVar44 = param_2 * 7 + param_1;
