...
void FUN_1401001c0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4,int param_5)
    ...
    if ((longlong)param_3 < 0x20) {
      ...
      if ((longlong)param_3 < 0xa6) {
        ...
        if (uVar38 != 0) {
          ...
          auVar75 = vmovdqu32_avx512f(_DAT_143087040);
          ...
          if (param_3 == uVar38) goto LAB_14010043e;
        }
      }
          ...
          if ((longlong)param_3 < 0x20) {
            ...
            if ((longlong)param_3 < 0x73) {
              ...
              if (uVar52 != 0) {
                ...
                if (param_3 == uVar52) goto LAB_14010085e;
              }
            }
        ...
        if ((longlong)param_3 < 0x20) {
          ...
          if ((longlong)param_3 < 0x5a) {
            ...
            if (uVar38 != 0) {
              ...
              if (param_3 == uVar38) goto LAB_140100b26;
            }
          }
          if ((longlong)(uVar38 + 0x20) <= (longlong)uVar36) {
            auVar79 = vbroadcastss_avx512f(auVar56);
