...
void FUN_14030a1fa(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    ...
    FUN_142d22130(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
