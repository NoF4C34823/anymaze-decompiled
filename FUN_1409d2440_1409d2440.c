...
void FUN_1409d2440(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x27) {
        ...
        if (uVar33 != 0) {
          ...
          if (param_5 == uVar33) goto LAB_1409d268d;
        }
      }
    ...
    if (uVar27 + 1 <= param_5) {
      ...
      lVar24 = param_2 * lVar30 + param_1;
      uVar16 = vpcmpgtq_avx512f(auVar37,_DAT_14308e300);
      bVar19 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar37,_DAT_14308e340);
      bVar18 = (byte)uVar16;
      uVar35 = CONCAT11(bVar18,bVar19);
...
LAB_1409d2832:
          ...
          if (uVar21 == 0) goto LAB_1409d2832;
          uVar34 = 0;
          ...
          if (param_5 != uVar21) goto LAB_1409d2832;
        }
        uVar26 = uVar26 + 1;
        puVar22 = puVar22 + 1;
        if (param_7 - 1U <= uVar26) goto LAB_1409d2907;
      }
      uVar26 = uVar26 + 1;
      puVar22 = puVar22 + 1;
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x7b) {
        ...
        if (uVar27 != 0) {
          ...
          if (param_5 == uVar27) goto LAB_1409d2adf;
        }
      }
    ...
    if ((longlong)param_5 < 0x20) {
      ...
      if ((longlong)param_5 < 0x121) {
        ...
        if (uVar27 != 0) {
          ...
          do {
            ...
            auVar36 = vpackssdw_avx512vl(auVar40._0_32_,auVar36);
      ...
      if ((longlong)(uVar27 + 0x20) <= (longlong)uVar31) {
        ...
        do {
          ...
          auVar42 = vpackssdw_avx512bw(auVar38,auVar42);
...
LAB_1409d2f2d:
    ...
    uVar31 = param_4 & 0x3f;
    if (uVar31 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1409d2f2d;
