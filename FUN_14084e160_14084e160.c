...
void FUN_14084e160(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014084f1b4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c900)[lVar5])(psVar23,param_4,*param_5);
    return;
  }
  if (uVar19 == 6) {
    uVar7 = (uint)*param_8;
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar14 < 0) goto LAB_14084f140;
                while (uVar13 == 0) {
                  for (lVar25 = (lVar16 + -1) * 2 - lVar25; lVar25 < 0; lVar25 = -lVar25) {
LAB_14084f140:
                    if (uVar7 != 0) goto LAB_14084f042;
                  }
...
LAB_14084f042:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar24;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014084f0a2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c900)[lVar5])(param_11 + uVar11 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar11 == 1) {
...
LAB_14084f0b6:
              ...
              uVar6 = uVar18 & 0xf;
              if (uVar6 != 0) {
                if ((uVar18 & 1) != 0) goto LAB_14084f0b6;
                uVar6 = 0x10 - uVar6 >> 1;
              }
              if ((longlong)uVar20 < (longlong)(uVar6 + 8)) goto LAB_14084f0b6;
...
LAB_14084e5fd:
      if (uVar19 == 1) {
        if ((longlong)uVar11 < 1) goto LAB_14084e80d;
...
LAB_14084f118:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14084f118;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_14084f118;
          uVar10 = 0;
...
LAB_14084f0bd:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14084f0bd;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_14084f0bd;
          uVar10 = 0;
          uVar8 = uVar11 - (uVar11 - uVar6 & 7);
          if (uVar6 != 0) {
            do {
...
LAB_14084e80d:
      (*(code *)(&PTR_FUN_14308c900)[lVar5])(uVar18,param_4,uVar11,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014084f115. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c900)[lVar5])(psVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar11 < lVar16) {
    lVar16 = lVar16 - uVar11;
    (*(code *)(&PTR_FUN_14308c900)[lVar5])(psVar23,param_4,lVar16,param_9,param_10);
...
LAB_14084f0c5:
          ...
          uVar18 = param_11 & 0xf;
          if (uVar18 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14084f0c5;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar20 < (longlong)(uVar18 + 8)) goto LAB_14084f0c5;
...
LAB_14084ec5c:
  if (uVar19 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_14084eefa;
...
LAB_14084f0d3:
          ...
          uVar18 = uVar20 & 0xf;
          if (uVar18 != 0) {
            if ((uVar20 & 1) != 0) goto LAB_14084f0d3;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar18 + 8)) goto LAB_14084f0d3;
          uVar6 = 0;
  ...
  if ((uVar19 != 6) || ((longlong)uVar11 < 1)) goto LAB_14084eefa;
  if ((longlong)uVar11 < 8) {
LAB_14084f0cc:
    uVar18 = 0;
  }
    ...
    if (uVar20 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_14084f0cc;
      uVar20 = 0x10 - uVar20 >> 1;
    }
    if ((longlong)uVar11 < (longlong)(uVar20 + 8)) goto LAB_14084f0cc;
    uVar6 = 0;
...
LAB_14084eefa:
                    /* WARNING: Could not recover jumptable at 0x00014084ef38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c900)[lVar5])(param_11 + uVar11 * 2,param_4,uVar11);
  return;
}
