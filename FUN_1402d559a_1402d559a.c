...
void FUN_1402d559a(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_1402fd0c0(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,uStack0000000000000060,1);
    thunk_FUN_142d22130(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
