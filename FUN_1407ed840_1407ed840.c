...
void FUN_1407ed840(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407eea35. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c560)[lVar30])(param_1,param_4,*param_5,param_9);
    return;
  }
...
LAB_1407ee890:
        ...
        *(byte *)(lVar28 + 2 + param_11) = bVar20;
        lVar28 = lVar28 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407ee92f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c560)[lVar30])(param_11 + lVar29 * 3,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar17 = lVar29 * 3;
...
LAB_1407ee932:
            ...
            if ((longlong)uVar13 < (longlong)(uVar10 + 0x10)) goto LAB_1407ee932;
            uVar21 = 0;
...
LAB_1407eda4f:
    ...
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308c560)[lVar30];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001407ee97a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (0 < lVar30) {
      ...
      if ((longlong)uVar13 < 7) {
        ...
        if ((longlong)uVar13 < 0x10) {
          ...
          auVar6 = vpshufb_avx(auVar6,_DAT_14308c660);
          auVar4 = vpshufb_avx(auVar5,_DAT_14308c670);
          auVar6 = vpor_avx(auVar6,auVar4);
          auVar4 = vpshufb_avx(auVar31,_DAT_14308c680);
          auVar32 = vpshufb_avx(auVar5,_DAT_14308c690);
          auVar5 = vpshufb_avx(auVar5,_DAT_14308c6c0);
          auVar31 = vpunpckhbw_avx(auVar31,auVar7);
          auVar4 = vpor_avx(auVar4,auVar32);
          auVar32 = vpshufb_avx(auVar7,_DAT_14308c6a0);
          auVar31 = vpshufb_avx(auVar31,_DAT_14308c6b0);
          auVar4 = vpor_avx(auVar4,auVar32);
...
LAB_1407ee754:
                    /* WARNING: Could not recover jumptable at 0x0001407ee782. Too many branches */
                    /* WARNING: Treating indirect jump as call */
