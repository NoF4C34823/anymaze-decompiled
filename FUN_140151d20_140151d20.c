...
void FUN_140151d20(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar23 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403db020(lVar10,lVar17,(longlong)(int)param_5,(longlong)(int)param_6,1);
        lVar25 = lVar25 + 1;
        lVar10 = lVar10 + lVar8;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403db020(lVar10,lVar17,(longlong)(int)param_5,(longlong)(int)param_6,1);
        FUN_1403e4f20(param_9,uVar13,param_3,(longlong)(int)param_5,(longlong)param_6._4_4_);
        lVar23 = lVar23 + 1;
        lVar17 = lVar17 + uVar13;
...
LAB_140152431:
                    ...
                    if (lVar24 < (longlong)(uVar15 + 0x10)) goto LAB_140152431;
                    uVar18 = 0;
                    uVar20 = lVar24 - (lVar24 - uVar15 & 0xf);
                    if (uVar15 != 0) {
                      do {
                        if ((*(char *)(uVar18 + uVar22) != '\0') &&
                           (*(byte *)(lVar1 + lVar14 + uVar18) < bVar29)) {
                    ...
                    do {
                      ...
                      uVar15 = uVar15 + 0x10;
                      bVar5 = auVar31[0];
                      auVar27[0] = (bVar5 < bVar29) * bVar5 | (bVar5 >= bVar29) * bVar29;
                      bVar29 = auVar31[1];
                      auVar27[1] = (bVar29 < bVar28) * bVar29 | (bVar29 >= bVar28) * bVar28;
                      bVar29 = auVar31[2];
                      auVar27[2] = (bVar29 < bVar32) * bVar29 | (bVar29 >= bVar32) * bVar32;
                      bVar29 = auVar31[3];
                      auVar27[3] = (bVar29 < bVar33) * bVar29 | (bVar29 >= bVar33) * bVar33;
                      bVar29 = auVar31[4];
                      auVar27[4] = (bVar29 < bVar34) * bVar29 | (bVar29 >= bVar34) * bVar34;
                      bVar29 = auVar31[5];
                      auVar27[5] = (bVar29 < bVar35) * bVar29 | (bVar29 >= bVar35) * bVar35;
                      bVar29 = auVar31[6];
                      auVar27[6] = (bVar29 < bVar36) * bVar29 | (bVar29 >= bVar36) * bVar36;
                      bVar29 = auVar31[7];
                      auVar27[7] = (bVar29 < bVar37) * bVar29 | (bVar29 >= bVar37) * bVar37;
                      bVar29 = auVar31[8];
                      auVar27[8] = (bVar29 < bVar38) * bVar29 | (bVar29 >= bVar38) * bVar38;
                      bVar29 = auVar31[9];
                      auVar27[9] = (bVar29 < bVar3) * bVar29 | (bVar29 >= bVar3) * bVar3;
                      bVar29 = auVar31[10];
                      auVar27[10] = (bVar29 < bVar4) * bVar29 | (bVar29 >= bVar4) * bVar4;
                      bVar29 = auVar31[0xb];
                      auVar27[0xb] = (bVar29 < bVar7) * bVar29 | (bVar29 >= bVar7) * bVar7;
                      bVar29 = auVar31[0xc];
                      auVar27[0xc] = (bVar29 < bVar12) * bVar29 | (bVar29 >= bVar12) * bVar12;
                      bVar29 = auVar31[0xd];
                      auVar27[0xd] = (bVar29 < bVar9) * bVar29 | (bVar29 >= bVar9) * bVar9;
                      bVar29 = auVar31[0xe];
                      auVar27[0xe] = (bVar29 < bVar16) * bVar29 | (bVar29 >= bVar16) * bVar16;
                      bVar29 = auVar31[0xf];
                      auVar27[0xf] = (bVar29 < bVar19) * bVar29 | (bVar29 >= bVar19) * bVar19;
                      auVar31 = auVar27 & auVar26 | ~auVar26 & auVar31;
                    } while (uVar15 < uVar20);
                    bVar29 = auVar31[8];
                    bVar28 = auVar31[0];
                    bVar28 = (bVar29 < bVar28) * bVar29 | (bVar29 >= bVar28) * bVar28;
                    bVar29 = auVar31[9];
                    bVar32 = auVar31[1];
                    bVar32 = (bVar29 < bVar32) * bVar29 | (bVar29 >= bVar32) * bVar32;
                    bVar29 = auVar31[10];
                    bVar33 = auVar31[2];
                    bVar33 = (bVar29 < bVar33) * bVar29 | (bVar29 >= bVar33) * bVar33;
                    bVar29 = auVar31[0xb];
                    bVar34 = auVar31[3];
                    bVar34 = (bVar29 < bVar34) * bVar29 | (bVar29 >= bVar34) * bVar34;
                    bVar29 = auVar31[0xc];
                    bVar35 = auVar31[4];
                    bVar35 = (bVar29 < bVar35) * bVar29 | (bVar29 >= bVar35) * bVar35;
                    bVar29 = auVar31[0xd];
                    bVar36 = auVar31[5];
                    bVar36 = (bVar29 < bVar36) * bVar29 | (bVar29 >= bVar36) * bVar36;
                    bVar29 = auVar31[0xe];
                    bVar37 = auVar31[6];
                    bVar37 = (bVar29 < bVar37) * bVar29 | (bVar29 >= bVar37) * bVar37;
                    bVar29 = auVar31[0xf];
                    bVar38 = auVar31[7];
                    bVar38 = (bVar29 < bVar38) * bVar29 | (bVar29 >= bVar38) * bVar38;
                    bVar29 = (bVar35 < bVar28) * bVar35 | (bVar35 >= bVar28) * bVar28;
                    bVar28 = (bVar36 < bVar32) * bVar36 | (bVar36 >= bVar32) * bVar32;
                    bVar32 = (bVar37 < bVar33) * bVar37 | (bVar37 >= bVar33) * bVar33;
                    bVar33 = (bVar38 < bVar34) * bVar38 | (bVar38 >= bVar34) * bVar34;
                    bVar29 = (bVar32 < bVar29) * bVar32 | (bVar32 >= bVar29) * bVar29;
                    bVar28 = (bVar33 < bVar28) * bVar33 | (bVar33 >= bVar28) * bVar28;
                  ...
                  for (; uVar20 < (ulonglong)(longlong)(int)param_6; uVar20 = uVar20 + 1) {
                    if ((*(char *)(uVar20 + uVar22) != '\0') &&
                       (*(byte *)(lVar1 + lVar14 + uVar20) < bVar29)) {
