...
void FUN_14036bc00(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar16 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (lVar16 = (lVar16 - 1U) * 3 + lVar8, bVar13 < *(byte *)(lVar16 + uVar19))) {
    ...
    if (0 < param_5._4_4_) {
      do {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar14 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (lVar14 = (lVar14 - 1U) * 3 + lVar8 + lVar5, bVar13 < *(byte *)(lVar14 + uVar19)))
              {
        ...
        FUN_140374ca0(param_9,uVar4,param_3,uVar3,(longlong)param_6._4_4_);
        uVar9 = uVar9 + 1;
        uVar12 = uVar12 + 1;
                  ...
                  do {
                    if ((*(char *)(param_7 + uVar10 + uVar19 * 2) != '\0') &&
                       (bVar1 = *(byte *)(uVar19 * 6 + uVar4 + ((lVar8 * -3 + param_1) - lVar18) +
                                         (uVar12 + uVar9) * lVar6), bVar13 < bVar1)) {
                      bVar13 = bVar1;
                    }
