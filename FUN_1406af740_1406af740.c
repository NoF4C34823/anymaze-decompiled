...
void FUN_1406af740(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar10 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1406b108a;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcStack_c8 = *(code **)(&DAT_14308ba80 + (longlong)param_6 * 8);
            ...
            if (lStack_d0 < (longlong)(uStack_68 + uVar9)) {
              do {
                ...
                if (lVar14 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar3 == 6) {
                      if (uStack_c0 == 0) goto LAB_1406b0ffd;
                    }
                    else {
                      if (uVar3 != 1) goto LAB_1406b0f64;
LAB_1406b10ef:
                      lVar16 = 0;
                      if (uStack_c0 != 0) {
                        lVar16 = lVar14;
...
LAB_1406b0fcf:
                  ...
                  if ((lVar14 < (longlong)uVar9) || (param_7 == 0xf0)) goto LAB_1406b0fcf;
                  if (uVar3 != 6) {
                    if (uVar3 == 1) {
                      if (lVar14 < 0) goto LAB_1406b10ef;
                      if (uStack_b0 == 0) {
                        lVar16 = uVar9 - 1;
                      }
                    }
...
LAB_1406b1100:
                  ...
                  if (uStack_b0 != 0) goto LAB_1406b0fcf;
LAB_1406b0ffd:
      ...
      do {
        if (0 < (longlong)uVar15) {
          ...
          if (3 < (longlong)uVar15) {
            ...
            uVar5 = uVar4 & 0xf;
            if (uVar5 != 0) {
              if ((uVar4 & 3) != 0) goto LAB_1406afc12;
              uVar5 = 0x10 - uVar5 >> 2;
            }
        ...
        do {
          if (0 < (longlong)uVar15) {
            ...
            if (3 < (longlong)uVar15) {
              ...
              uVar5 = uVar4 & 0xf;
              if (uVar5 != 0) {
                if ((uVar4 & 3) != 0) goto LAB_1406afa91;
                uVar5 = 0x10 - uVar5 >> 2;
              }
              if ((longlong)(uVar5 + 4) <= (longlong)uVar15) {
