...
void FUN_140795740(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])
...
LAB_140795d52:
    ...
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140795d52;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar8 + 0x10)) goto LAB_140795d52;
    uVar9 = 0;
