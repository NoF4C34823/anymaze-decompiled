...
/* WARNING: Removing unreachable block (ram,0x00014064d0b5) */

ulonglong FUN_14064bce0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  uStack_50 = uVar9;
  if (iVar16 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_14064d41a;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      lStack_138 = 0;
      uVar8 = param_7 & 0xf;
      pcStack_d0 = *(code **)(&DAT_14308b600 + (longlong)param_6 * 8);
            ...
            if (lStack_c0 < (longlong)(uVar12 + uVar9)) {
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar8 == 6) {
                      if (uStack_d8 == 0) goto LAB_14064d392;
                    }
                    else {
                      if (uVar8 != 1) goto LAB_14064d304;
LAB_14064d47a:
                      lVar22 = 0;
                      if (uStack_d8 != 0) {
                        lVar22 = lVar10;
...
LAB_14064d375:
                  ...
                  if ((lVar10 < (longlong)uVar9) || (param_7 == 0xf0)) goto LAB_14064d375;
                  if (uVar8 != 6) {
                    if (uVar8 == 1) {
                      if (lVar10 < 0) goto LAB_14064d47a;
                      if (uStack_b8 == 0) {
                        lVar22 = uVar9 - 1;
                      }
                    }
...
LAB_14064d48d:
                  ...
                  if (uStack_b8 != 0) goto LAB_14064d375;
LAB_14064d392:
                  uVar17 = *puVar26;
                  uVar24 = puVar26[1];
                  uVar20 = puVar26[2];
...
LAB_14064c1a5:
            ...
            uVar15 = uVar19 & 0xf;
            if (uVar15 != 0) {
              if ((uVar19 & 3) != 0) goto LAB_14064c1a5;
              uVar15 = 0x10 - uVar15 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar15 + 4)) goto LAB_14064c1a5;
            uVar14 = 0;
...
LAB_14064c044:
              ...
              uVar21 = uVar19 & 0xf;
              if (uVar21 != 0) {
                if ((uVar19 & 3) != 0) goto LAB_14064c044;
                uVar21 = 0x10 - uVar21 >> 2;
              }
              if ((longlong)uVar15 < (longlong)(uVar21 + 4)) goto LAB_14064c044;
