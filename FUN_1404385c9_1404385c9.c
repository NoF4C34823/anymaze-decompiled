...
void FUN_1404385c9(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < iStack00000000000000e4) {
    do {
      ...
      FUN_140d12240(in_stack_00000100,param_1,lVar4,(longlong)iStack00000000000000e0,lVar1);
      lVar3 = unaff_R12 + 1;
      lVar2 = lVar2 + 1;
