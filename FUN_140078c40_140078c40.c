...
void FUN_140078c40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014007991b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_1430869a0 + lVar13 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
  if (uVar18 == 6) {
    uVar22 = *param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar12 < 2) {
                ...
                if (lVar19 < 0) goto LAB_1400798a0;
                while (uVar8 == 0) {
                  for (lVar16 = (lVar12 + -1) * 2 - lVar16; lVar16 < 0; lVar16 = -lVar16) {
LAB_1400798a0:
                    if (uVar15 != 0) goto LAB_14007978f;
                  }
...
LAB_14007978f:
        ...
        *(undefined4 *)(param_11 + lVar10 * 4) = uVar21;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140079808. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_1430869a0 + lVar13 * 8))(param_11 + uVar11 * 4,param_4,lVar12,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar19 = uVar11 * 4;
    ...
    if (0 < (longlong)uVar14) {
      if (6 < (longlong)uVar14) {
        ...
        if ((lVar16 <= (longlong)(uVar17 - param_1)) || (lVar16 <= (longlong)-(uVar17 - param_1))) {
          ...
          if (uVar7 == 0) {
LAB_140078d56:
            if ((longlong)uVar14 < (longlong)(uVar7 + 4)) goto LAB_14007980b;
...
LAB_140078ebe:
    if (uVar18 == 1) {
      if ((longlong)uVar11 < 1) goto LAB_1400790ef;
...
LAB_14007986e:
        ...
        uVar7 = param_11 & 0xf;
        if (uVar7 != 0) {
          if ((param_11 & 3) != 0) goto LAB_14007986e;
          uVar7 = 0x10 - uVar7 >> 2;
        }
        if ((longlong)uVar11 < (longlong)(uVar7 + 8)) goto LAB_14007986e;
...
LAB_140079819:
        ...
        uVar7 = param_11 & 0xf;
        if (uVar7 != 0) {
          if ((param_11 & 3) != 0) goto LAB_140079819;
          uVar7 = 0x10 - uVar7 >> 2;
        }
        if ((longlong)uVar11 < (longlong)(uVar7 + 8)) goto LAB_140079819;
        uVar20 = uVar11 - (uVar11 - uVar7 & 7);
        if (uVar7 != 0) {
          uVar9 = 0;
          do {
...
LAB_1400790ef:
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_1430869a0 + lVar13 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014007986c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (0 < (longlong)uVar14) {
    if (6 < (longlong)uVar14) {
      ...
      if ((lVar13 <= lVar12) || (lVar13 <= -lVar12)) {
        ...
        if (uVar17 == 0) {
LAB_1400791eb:
          if ((longlong)uVar14 < (longlong)(uVar17 + 4)) goto LAB_140079820;
...
LAB_140079324:
  if (uVar18 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_14007965e;
...
LAB_140079830:
          ...
          uVar17 = uVar14 & 0xf;
          if (uVar17 != 0) {
            if ((uVar14 & 3) != 0) goto LAB_140079830;
            uVar17 = 0x10 - uVar17 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar17 + 8)) goto LAB_140079830;
          uVar7 = 0;
          lVar13 = param_11 + lVar10 * 4;
  ...
  if ((uVar18 != 6) || ((longlong)uVar11 < 1)) goto LAB_14007965e;
  if ((longlong)uVar11 < 8) {
LAB_140079828:
    uVar17 = 0;
  }
    ...
    if (uVar14 != 0) {
      if ((lVar13 - 4U & 3) != 0) goto LAB_140079828;
      uVar14 = 0x10 - uVar14 >> 2;
    }
    if ((longlong)uVar11 < (longlong)(uVar14 + 8)) goto LAB_140079828;
    uVar7 = 0;
...
LAB_14007965e:
                    /* WARNING: Could not recover jumptable at 0x000140079695. Too many branches */
                    /* WARNING: Treating indirect jump as call */
