...
void FUN_1409e2860(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308e540)[lVar8])(puVar26,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar17 == 6) {
    uVar25 = (uint)*param_8;
          ...
          if (uVar17 != 6) {
            if (uVar17 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar14 < 0) goto LAB_1409e3d40;
                while (uVar16 == 0) {
                  for (lVar10 = (lVar19 + -1) * 2 - lVar10; lVar10 < 0; lVar10 = -lVar10) {
LAB_1409e3d40:
                    if (uVar23 != 0) goto LAB_1409e3c03;
                  }
          ...
          if (uVar21 != 0) goto LAB_1409e3c03;
...
LAB_1409e3c03:
    ...
    (*(code *)(&PTR_LAB_14308e540)[lVar8])(param_11 + uVar15 * 2,param_4,lVar19,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar15 == 1) {
            ...
            if ((longlong)uVar18 < 0x20) {
              ...
              if ((longlong)uVar18 < 0x76) {
                ...
                if (uVar22 != 0) {
                  ...
                  if (uVar18 == uVar22) goto LAB_1409e2da3;
                }
              }
          ...
          if ((longlong)uVar15 < 0x20) {
            ...
            if ((longlong)uVar15 < 0x4b) {
              ...
              if (uVar22 != 0) {
                ...
                if (uVar15 == uVar22) goto LAB_1409e3140;
              }
            }
            if ((longlong)(uVar22 + 0x20) <= (longlong)uVar24) {
...
LAB_1409e3140:
      (*(code *)(&PTR_LAB_14308e540)[lVar8])(uVar9,param_4,uVar15,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_LAB_14308e540)[lVar8])(puVar26,param_4,lVar19,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar18 < 0x20) {
          ...
          if ((longlong)uVar18 < 0x76) {
            ...
            if (uVar24 != 0) {
              ...
              if (uVar18 == uVar24) goto LAB_1409e3644;
            }
          }
          ...
          if ((longlong)uVar15 < 0x20) {
            ...
            if ((longlong)uVar15 < 0x4b) {
              ...
              if (uVar9 != 0) {
                ...
                if (uVar15 == uVar9) goto LAB_1409e3aa3;
              }
            }
...
LAB_1409e3aa3:
  (*(code *)(&PTR_LAB_14308e540)[lVar8])(param_11 + uVar15 * 2,param_4,uVar15,param_9,param_10);
  return;
}
