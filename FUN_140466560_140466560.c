...
void FUN_140466560(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar4 - 1U)) {
      while( true ) {
        FUN_140d12e20(lVar2,lVar3,lVar1,lVar5,4);
        lVar4 = param_6[1];
        lVar6 = lVar6 + 1;
        lVar2 = lVar2 + param_2;
        lVar3 = lVar3 + uVar8;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_140d12e20(lVar2,lVar3,lVar1,*param_6,4);
