...
void FUN_140961ba0(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308da20)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_140961caf;
    if ((param_7 & 0xf) == 6) {
      uVar3 = param_7 & 0x10;
      goto joined_r0x000140961ece;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_140961caf;
    if ((param_7 & 0xf) == 6) {
      uVar3 = param_7 & 0x20;
joined_r0x000140961ece:
      if (uVar3 != 0) goto LAB_140961caf;
      uVar4 = *param_5;
      uVar2 = *param_8;
      if ((longlong)uVar4 < 1) {
        return;
...
LAB_140961e7b:
        ...
        if ((longlong)uVar4 < 0x1d) {
          ...
          uVar7 = param_4 & 0x1f;
          if (uVar7 != 0) {
            if ((param_4 & 3) != 0) goto LAB_140961e7b;
            uVar7 = 0x20 - uVar7 >> 2;
          }
          if ((longlong)uVar4 < (longlong)(uVar7 + 0x10)) goto LAB_140961e7b;
          uVar6 = 0;
...
LAB_140961caf:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_140963660(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
