...
void FUN_14065b8e0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar44 = param_4 & 0xf;
      if (uVar44 != 0) {
        if ((param_4 & 3) != 0) goto LAB_14065c268;
...
LAB_14065c187:
  ...
  if (3 < (longlong)param_5) {
    uVar44 = param_4 & 0xf;
    if (uVar44 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14065c260;
      uVar44 = 0x10 - uVar44 >> 2;
    }
    if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
      lVar45 = param_2 * lVar35 + param_1;
