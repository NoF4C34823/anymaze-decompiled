...
void FUN_1402342a0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4,int param_5)
  ...
  if (0 < (longlong)uVar17) {
    ...
    if ((longlong)uVar17 < 0x10) {
      ...
      if ((longlong)uVar17 < 0x7b) {
        ...
        if (uVar28 != 0) {
          auVar39 = vmovdqu32_avx512f(_DAT_143088940);
          auVar40 = vmovdqu32_avx512f(_DAT_143088980);
          ...
          if (uVar17 == uVar28) goto LAB_14023448e;
        }
      }
    ...
    if (uVar20 + 1 <= uVar17) {
      ...
      uVar16 = vpcmpgtq_avx512f(auVar44,_DAT_143088940);
      bVar19 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar44,_DAT_143088980);
      bVar18 = (byte)uVar16;
      uVar38 = CONCAT11(bVar18,bVar19);
          ...
          if ((longlong)uVar17 < 0x10) {
            ...
            if ((longlong)uVar17 < 0x4b) {
              ...
              if (uVar31 != 0) {
                ...
                if (uVar17 == uVar31) goto LAB_1402347ec;
              }
            }
        ...
        if ((longlong)uVar17 < 0x10) {
          ...
          if ((longlong)uVar17 < 0x41) {
            ...
            if (uVar28 != 0) {
              ...
              if (uVar17 == uVar28) goto LAB_140234a19;
            }
          }
          if ((longlong)(uVar28 + 0x10) <= (longlong)uVar20) {
            auVar44 = vbroadcastss_avx512f(auVar63);
