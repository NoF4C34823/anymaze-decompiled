...
void FUN_1407441e0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140745252. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bf60)[lVar7])(puVar23,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar15 < 0) goto LAB_1407451e0;
                while (uVar11 == 0) {
                  for (lVar22 = (lVar16 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_1407451e0:
                    if (uVar12 != 0) goto LAB_1407450e4;
                  }
...
LAB_1407450e4:
        ...
        *(ushort *)(param_11 + lVar13 * 2) = uVar21;
        lVar13 = lVar13 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140745148. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bf60)[lVar7])(param_11 + uVar14 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
...
LAB_14074515c:
              ...
              uVar17 = uVar10 & 0xf;
              if (uVar17 != 0) {
                if ((uVar10 & 1) != 0) goto LAB_14074515c;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_14074515c;
...
LAB_14074467f:
      if (uVar18 == 1) {
        if ((longlong)uVar14 < 1) goto LAB_14074488d;
...
LAB_1407451bb:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1407451bb;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_1407451bb;
          uVar8 = 0;
...
LAB_140745163:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140745163;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_140745163;
          uVar8 = 0;
          uVar20 = uVar14 - (uVar14 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_14074488d:
      in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308bf60)[lVar7])(uVar10,param_4,uVar14,param_9,param_10)
      ;
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001407451b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308bf60)[lVar7])(puVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar14 < lVar16) {
    lVar16 = lVar16 - uVar14;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308bf60)[lVar7])(puVar23,param_4,lVar16,param_9,param_10);
...
LAB_14074516a:
          ...
          uVar10 = param_11 & 0xf;
          if (uVar10 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14074516a;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar10 + 8)) goto LAB_14074516a;
...
LAB_140744cf9:
  if (uVar18 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_140744f9b;
...
LAB_140745179:
          ...
          uVar10 = uVar19 & 0xf;
          if (uVar10 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_140745179;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar10 + 8)) goto LAB_140745179;
          uVar17 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar14 < 1)) goto LAB_140744f9b;
  if ((longlong)uVar14 < 8) {
LAB_140745171:
    uVar10 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_140745171;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar14 < (longlong)(uVar19 + 8)) goto LAB_140745171;
    uVar17 = 0;
...
LAB_140744f9b:
                    /* WARNING: Could not recover jumptable at 0x000140744fd4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308bf60)[lVar7])(param_11 + uVar14 * 2,param_4,uVar14);
  return;
}
