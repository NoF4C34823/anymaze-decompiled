...
void FUN_1402f9c60(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar17 - 1)) {
      while( true ) {
        FUN_1402dd1e0(param_1,lVar21,uVar4,uVar22,1);
        uVar17 = param_6[1];
        lVar24 = lVar24 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_1402dd1e0(param_1,lVar21,uVar4,*param_6,1);
        thunk_FUN_142d20530(param_9,uVar28,param_3,uVar4,param_6[1]);
        lVar24 = lVar24 + 1;
        lVar25 = lVar25 + 1;
        param_1 = param_1 + param_2 * 4;
              ...
              do {
                if (0 < (longlong)uVar22) {
                  if ((longlong)uVar22 < 8) {
                    ...
                    auVar75 = maxps(auVar73,auVar65);
                    if (auVar75._0_4_ <= auVar75._4_4_) {
                  ...
                  if (uVar18 < uVar22) {
                    do {
                      if ((*(char *)(uVar18 + param_7 + lVar26) != '\0') &&
                         (fVar3 = *(float *)(lVar1 + lVar15 + uVar18 * 4), auVar75._0_4_ <= fVar3))
                      {
                        auVar75._0_4_ = fVar3;
                      }
                      uVar18 = uVar18 + 1;
