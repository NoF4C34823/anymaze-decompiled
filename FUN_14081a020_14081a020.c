...
void FUN_14081a020(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308c760)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_14081a12f;
    if ((param_7 & 0xf) == 6) {
      uVar1 = param_7 & 0x10;
      goto joined_r0x00014081a320;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
...
LAB_14081a12f:
    uStack_38 = *param_5;
    uStack_30 = param_5[1];
    FUN_140827120(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                  param_10,param_11);
    return;
  }
  if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_14081a12f;
  if ((param_7 & 0xf) != 6) {
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x20) == 0) {
        param_3 = param_5[1] - 1;
  ...
  uVar1 = param_7 & 0x20;
joined_r0x00014081a320:
  if (uVar1 != 0) goto LAB_14081a12f;
  uVar6 = *param_5;
...
LAB_14081a2d7:
    ...
    uVar5 = param_4 & 0x1f;
    if (uVar5 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14081a2d7;
      uVar5 = 0x20 - uVar5 >> 2;
    }
    if ((longlong)uVar6 < (longlong)(uVar5 + 0x10)) goto LAB_14081a2d7;
    uVar4 = 0;
