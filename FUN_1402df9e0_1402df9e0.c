...
void FUN_1402df9e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && 0 < lVar5) {
      do {
        FUN_142d203a0(param_1,lVar3,lVar1,(longlong)(int)param_6 * 4,4);
        lVar7 = lVar7 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_142d203a0(param_1,lVar3,lVar1,(longlong)(int)param_6 << 2,4);
        thunk_FUN_142d20530(param_9,uVar4,param_3,lVar1,lVar5);
        lVar6 = lVar6 + 1;
        lVar3 = lVar3 + uVar4 * 4;
        if (lVar5 <= lVar6) {
          lVar3 = param_9;
