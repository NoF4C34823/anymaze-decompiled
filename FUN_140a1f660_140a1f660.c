...
void FUN_140a1f660(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4,
...

{
  ...
  FUN_140a1dd20(param_1,param_2,param_3,lVar8,param_5,param_6,param_7,0);
  auVar16 = _DAT_14308e940;
  if (param_8 == 0) {
    ...
    if ((longlong)param_5 < 0x20) {
      ...
      if ((longlong)param_5 < 0xf6) {
        ...
        if (uVar7 != 0) {
          uVar9 = 0;
          lVar6 = 0;
          auVar12 = vmovdqu32_avx512f(_DAT_14308e980);
          auVar13 = vmovdqu32_avx512f(_DAT_14308e9c0);
...
LAB_140a1fab2:
    ...
    uVar5 = param_4 & 0x3f;
    if (uVar5 != 0) {
      if ((param_4 & 1) != 0) goto LAB_140a1fab2;
      uVar5 = 0x40 - uVar5 >> 1;
