...
void FUN_1401e1f80(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1401e2aea:
      uVar44 = 0;
      if (uVar40 == 0) goto LAB_1401e21c7;
      uVar41 = 0;
      uVar43 = uVar40;
    }
    else {
      uVar43 = param_2 & 0x1f;
      if (uVar43 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1401e2aea;
        uVar43 = 0x20 - uVar43 >> 2;
      }
      if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_1401e2aea;
      ...
      if (uVar40 < uVar44 + 1) goto LAB_1401e21c7;
...
LAB_1401e2aad:
          uVar44 = 0;
          if (uVar40 == 0) goto LAB_1401e28d2;
          uVar41 = 0;
          uVar43 = uVar40;
        }
        else {
          uVar43 = param_2 & 0x1f;
          if (uVar43 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1401e2aad;
            uVar43 = 0x20 - uVar43 >> 2;
          }
          if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_1401e2aad;
          ...
          if (uVar40 < uVar44 + 1) goto LAB_1401e28d2;
          uVar43 = uVar40 - uVar44;
          if ((longlong)uVar43 < 4) {
            uVar41 = 0;
          }
...
LAB_1401e2a9a:
    ...
    uVar43 = param_2 & 0x1f;
    if (uVar43 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401e2a9a;
      uVar43 = 0x20 - uVar43 >> 2;
    }
    if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_1401e2a9a;
    uVar41 = 0;
    uVar44 = uVar40 - (uVar40 - uVar43 & 0xf);
    if (uVar43 != 0) {
      do {
