...
void FUN_1407e8ea0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1407e9824:
      uVar20 = 0;
      if (param_5 == 0) goto LAB_1407e90fe;
      uVar31 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar31 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_1407e9824;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_1407e9824;
      ...
      if (param_5 < uVar20 + 1) goto LAB_1407e90fe;
...
LAB_1407e9325:
        ...
        uVar16 = uVar16 + 1;
        pfVar24 = pfVar24 + 1;
        if (param_7 - 1U <= uVar16) goto LAB_1407e939d;
      }
      uVar16 = uVar16 + 1;
      pfVar24 = pfVar24 + 1;
...
LAB_1407e97fb:
      uVar31 = 0;
      if (param_5 == 0) goto LAB_1407e9598;
      uVar20 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar28 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1407e97fb;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_1407e97fb;
      ...
      if (param_5 < uVar31 + 1) goto LAB_1407e9598;
...
LAB_1407e9598:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar19 = uVar28 & 0xf;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1407e9818;
...
LAB_1407e97a1:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar19 = uVar28 & 0xf;
    if (uVar19 != 0) {
      if ((uVar28 & 3) != 0) goto LAB_1407e9811;
      uVar19 = 0x10 - uVar19 >> 2;
    }
    if ((longlong)(uVar19 + 8) <= (longlong)param_5) {
      uVar20 = 0;
