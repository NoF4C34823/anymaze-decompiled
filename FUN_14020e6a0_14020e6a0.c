...
void FUN_14020e6a0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    if ((longlong)param_3 < 0x1d) {
      FUN_14020e75a(param_1,param_3 & 0xfffffffffffffff0);
      return;
    }
    uVar14 = param_2 & 0x1f;
    if (uVar14 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14020e909;
