...
void FUN_140706440(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140706d49:
      ...
      uVar81 = param_2 & 0xf;
      if (uVar81 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140706d49;
        uVar81 = 0x10 - uVar81 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_140706d49;
      uVar82 = 0;
...
LAB_140706d2a:
          uVar75 = 0;
          if (param_3 == 0) goto LAB_140706b4c;
          uVar82 = 0;
          uVar81 = param_3;
        }
        else {
          uVar81 = param_2 & 0xf;
          if (uVar81 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140706d2a;
            uVar81 = 0x10 - uVar81 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_140706d2a;
          ...
          if (param_3 < uVar75 + 1) goto LAB_140706b4c;
...
LAB_140706d16:
    ...
    uVar81 = param_2 & 0xf;
    if (uVar81 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140706d16;
      uVar81 = 0x10 - uVar81 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_140706d16;
    uVar82 = 0;
    uVar75 = param_3 - (param_3 - uVar81 & 7);
    if (uVar81 != 0) {
      do {
