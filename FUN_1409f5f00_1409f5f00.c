...
void FUN_1409f5f00(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4,
    ...
    if (0 < (longlong)param_5) {
      if ((longlong)param_5 < 0x40) {
        ...
        if ((longlong)param_5 < 0x396) {
          ...
          if (uVar7 != 0) {
            uVar5 = 0;
            auVar11 = vmovdqu32_avx512f(_DAT_14308e640);
            auVar12 = vmovdqu32_avx512f(_DAT_14308e680);
