...
/* WARNING: Removing unreachable block (ram,0x0001409d3e50) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_1409d2f60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_218 = param_10;
    (*(code *)(&PTR_LAB_14308e5e0)[lVar56])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar51 != 6) {
            if (uVar51 == 1) {
              ...
              if (lVar55 < 2) {
                ...
                if (lVar59 < 0) goto LAB_1409d42c0;
                while (uVar41 == 0) {
                  for (lVar46 = (lVar55 + -1) * 2 - lVar46; lVar46 < 0; lVar46 = -lVar46) {
LAB_1409d42c0:
                    if (uVar58 != 0) goto LAB_1409d414c;
                  }
          ...
          if (uVar66 != 0) goto LAB_1409d414c;
          uVar66 = *puStack_80;
          uVar68 = puStack_80[1];
          uVar69 = puStack_80[2];
        }
...
LAB_1409d414c:
    ...
    iStack_218 = param_10;
    (*(code *)(&PTR_LAB_14308e5e0)[lVar56])(param_11 + lVar50 * 0xc,param_4,lVar55,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar46 = lVar50 * 3;
          ...
          if ((lVar43 <= (longlong)(uStack_a8 - param_1)) ||
            ...
            if ((longlong)uVar42 < 0x10) {
              ...
              if ((longlong)uVar42 < 0x3b) {
                ...
                if (uVar53 != 0) {
                  uVar45 = 0;
                  auVar62 = vmovdqu32_avx512f(_DAT_14308e300);
                  auVar63 = vmovdqu32_avx512f(_DAT_14308e340);
                  ...
                  if (uVar42 == uVar53) goto LAB_1409d327c;
                }
              }
            ...
            if (uVar47 + 1 <= uVar42) {
              ...
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308e300);
              bVar22 = (byte)uVar20;
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308e340);
              bVar21 = (byte)uVar20;
              uVar61 = CONCAT11(bVar21,bVar22);
        ...
        if (0 < lVar46) {
          ...
          if (((longlong)uVar42 < 7) ||
            ...
            if ((longlong)uVar42 < 0x10) {
              ...
              auVar64 = vmovdqu32_avx512f(_DAT_14308e400);
              lVar46 = 0;
              do {
            ...
            if (uVar47 + 1 <= uVar42) {
              ...
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308e300);
              uVar18 = vpcmpgtq_avx512f(auVar65,_DAT_14308e340);
              auVar65 = vmovdqu32_avx512f(_DAT_14308e400);
...
LAB_1409d3944:
      uStack_c0 = (code *)(&PTR_LAB_14308e5e0)[lVar56];
      iStack_218 = param_10;
      lStack_c8 = lVar55;
      uStack_a0 = param_7;
