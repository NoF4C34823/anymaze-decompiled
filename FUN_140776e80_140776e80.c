...
void FUN_140776e80(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14077774c:
      uVar11 = 0;
      if (param_3 == 0) goto LAB_1407770a5;
      uVar13 = 0;
      uVar6 = param_3;
    }
    else {
      uVar6 = param_2 & 0xf;
      if (uVar6 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14077774c;
        uVar6 = 0x10 - uVar6 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_14077774c;
      ...
      if (param_3 < uVar11 + 1) goto LAB_1407770a5;
...
LAB_140777726:
          uVar11 = 0;
          if (param_3 == 0) goto LAB_14077756d;
          uVar13 = 0;
          uVar6 = param_3;
        }
        else {
          uVar6 = param_2 & 0xf;
          if (uVar6 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140777726;
            uVar6 = 0x10 - uVar6 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_140777726;
          uVar13 = 0;
          ...
          if (param_3 < uVar11 + 1) goto LAB_14077756d;
          uVar6 = param_3 - uVar11;
          if ((longlong)uVar6 < 4) {
            uVar13 = 0;
          }
...
LAB_140777713:
    ...
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140777713;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_140777713;
    uVar13 = 0;
    uVar11 = param_3 - (param_3 - uVar6 & 7);
    if (uVar6 != 0) {
      do {
