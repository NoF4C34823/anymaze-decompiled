...
void FUN_1409a8e80(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4,
...

{
  ...
  FUN_1409a7120(param_1,param_2,param_3,lVar8,param_5,param_6,param_7,0);
...
LAB_1409a92d2:
    ...
    uVar5 = param_4 & 0x3f;
    if (uVar5 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1409a92d2;
      uVar5 = 0x40 - uVar5 >> 1;
