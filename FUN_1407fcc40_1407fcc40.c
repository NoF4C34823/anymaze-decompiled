...
/* WARNING: Removing unreachable block (ram,0x0001407fe7e0) */

void FUN_1407fcc40(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar18 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1407fecbd;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      lStack_168 = 0;
      uStack_120 = 0;
      pcStack_f8 = (code *)(&PTR_FUN_14308c5a0)[(int)uStack_1a0];
            ...
            if (lStack_e8 < (longlong)(uVar19 + uVar22)) {
              ...
              do {
                ...
                if (lVar8 < 0) {
                  if (uStack_128 != 0xf0) {
                    if (iVar18 == 6) {
                      if (uStack_100 == 0) goto LAB_1407fec39;
                    }
                    else {
                      if (iVar18 != 1) goto LAB_1407feb8e;
LAB_1407fed54:
                      lVar10 = 0;
                      if (uStack_100 != 0) {
                        lVar10 = lVar8;
...
LAB_1407fec1c:
                  ...
                  if ((lVar8 < (longlong)uVar22) || (uStack_128 == 0xf0)) goto LAB_1407fec1c;
                  if (iVar18 != 6) {
                    if (iVar18 == 1) {
                      if (lVar8 < 0) goto LAB_1407fed54;
                      if (uStack_d8 == 0) {
                        lVar10 = lStack_168;
                      }
                    }
...
LAB_1407fed80:
                  ...
                  if (uStack_d8 != 0) goto LAB_1407fec1c;
LAB_1407fec39:
                  uVar6 = *puVar16;
                  uVar17 = puVar16[1];
                  uVar20 = puVar16[2];
...
LAB_1407fddd6:
                    ...
                    uVar6 = puStack_f0[2];
                    if ((longlong)uStack_198 < 0x10) goto LAB_1407fddd6;
                    uVar7 = 0;
                    auVar31 = vpunpcklwd_avx(ZEXT216(uVar6),ZEXT216(uVar6));
                    auVar31 = vpunpckldq_avx(auVar31,auVar31);
                    auVar31 = vpunpcklqdq_avx(auVar31,auVar31);
...
LAB_1407fd126:
            ...
            if (uVar22 != 0) {
              if (((ulonglong)puVar14 & 3) != 0) goto LAB_1407fd126;
              uVar22 = 0x20 - uVar22 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar22 + 8)) goto LAB_1407fd126;
            uVar15 = 0;
    ...
    if ((uStack_40 ^ (ulonglong)auStack_208) != DAT_1436b4680) goto LAB_1407fce2c;
  }
  else {
    if (uVar11 == 3) {
...
LAB_1407fcfc5:
              ...
              uVar22 = (ulonglong)puVar14 & 0x1f;
              if (uVar22 != 0) {
                if (((ulonglong)puVar14 & 3) != 0) goto LAB_1407fcfc5;
                uVar22 = 0x20 - uVar22 >> 2;
              }
              if ((longlong)uVar19 < (longlong)(uVar22 + 8)) goto LAB_1407fcfc5;
