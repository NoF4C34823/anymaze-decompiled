...
void FUN_1409f8180(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x27) {
        ...
        if (uVar33 != 0) {
          ...
          if (param_5 == uVar33) goto LAB_1409f83cd;
        }
      }
...
LAB_1409f8572:
          ...
          if (uVar21 == 0) goto LAB_1409f8572;
          uVar34 = 0;
          ...
          if (param_5 != uVar21) goto LAB_1409f8572;
        }
        uVar26 = uVar26 + 1;
        puVar22 = puVar22 + 1;
        if (param_7 - 1U <= uVar26) goto LAB_1409f8647;
      }
      uVar26 = uVar26 + 1;
      puVar22 = puVar22 + 1;
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x7b) {
        ...
        if (uVar27 != 0) {
          ...
          if (param_5 == uVar27) goto LAB_1409f881f;
        }
      }
...
LAB_1409f8c6d:
    ...
    uVar31 = param_4 & 0x3f;
    if (uVar31 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1409f8c6d;
