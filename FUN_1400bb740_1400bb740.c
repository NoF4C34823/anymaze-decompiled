...
void FUN_1400bb740(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1400bc0ed:
      uVar20 = 0;
      if (param_5 == 0) goto LAB_1400bb99e;
      uVar31 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar31 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_1400bc0ed;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_1400bc0ed;
      ...
      if (param_5 < uVar20 + 1) goto LAB_1400bb99e;
...
LAB_1400bbbc5:
        ...
        uVar16 = uVar16 + 1;
        pfVar24 = pfVar24 + 1;
        if (param_7 - 1U <= uVar16) goto LAB_1400bbc3d;
      }
      uVar16 = uVar16 + 1;
      pfVar24 = pfVar24 + 1;
...
LAB_1400bc0c1:
      uVar31 = 0;
      if (param_5 == 0) goto LAB_1400bbe38;
      uVar20 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar28 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1400bc0c1;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_1400bc0c1;
      ...
      if (param_5 < uVar31 + 1) goto LAB_1400bbe38;
...
LAB_1400bbe38:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar19 = uVar28 & 0xf;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1400bc0de;
...
LAB_1400bc057:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar19 = uVar28 & 0xf;
    if (uVar19 != 0) {
      if ((uVar28 & 3) != 0) goto LAB_1400bc0d7;
      uVar19 = 0x10 - uVar19 >> 2;
    }
