...
void FUN_1406c2680(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1406c2fa6:
      ...
      uVar30 = param_2 & 0xf;
      if (uVar30 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1406c2fa6;
        uVar30 = 0x10 - uVar30 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_1406c2fa6;
      uVar31 = 0;
...
LAB_1406c2f87:
          uVar24 = 0;
          if (param_3 == 0) goto LAB_1406c2d8c;
          uVar31 = 0;
          uVar30 = param_3;
        }
        else {
          uVar30 = param_2 & 0xf;
          if (uVar30 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1406c2f87;
            uVar30 = 0x10 - uVar30 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_1406c2f87;
          ...
          if (param_3 < uVar24 + 1) goto LAB_1406c2d8c;
...
LAB_1406c2f73:
    ...
    uVar30 = param_2 & 0xf;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406c2f73;
      uVar30 = 0x10 - uVar30 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_1406c2f73;
    uVar31 = 0;
    uVar24 = param_3 - (param_3 - uVar30 & 7);
    if (uVar30 != 0) {
      do {
