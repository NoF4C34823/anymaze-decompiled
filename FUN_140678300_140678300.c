...
void FUN_140678300(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140678af3:
      ...
      uVar130 = param_2 & 0xf;
      if (uVar130 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140678af3;
        uVar130 = 0x10 - uVar130 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_140678af3;
      uVar137 = 0;
...
LAB_140678ae3:
          ...
          uVar130 = param_2 & 0xf;
          if (uVar130 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140678ae3;
            uVar130 = 0x10 - uVar130 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_140678ae3;
...
LAB_140678ad7:
    ...
    uVar130 = param_2 & 0xf;
    if (uVar130 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140678ad7;
      uVar130 = 0x10 - uVar130 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_140678ad7;
    uVar137 = 0;
    uVar136 = param_3 - (param_3 - uVar130 & 7);
    if (uVar130 != 0) {
      do {
