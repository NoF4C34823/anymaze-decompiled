...
void FUN_1402a6ca0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar14 != 0 && 0 < (longlong)uVar24) {
      do {
        FUN_140299b60(lVar17,lVar23,uVar2,(longlong)(int)param_6,4);
        lVar25 = lVar25 + 1;
        ...
        if (0 < (longlong)uVar2) {
          do {
            ...
            if (0 < (longlong)uVar24) {
              ...
              if (uVar12 <= uVar24) {
                    /* WARNING: Could not recover jumptable at 0x0001402a70ac. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_1402a70ae +
                          (byte)(&UNK_143089b38)[(uint)(param_6._4_4_ - (int)uVar12)]))();
                return;
              }
            }
...
LAB_1402a772e:
                    ...
                    if (lVar8 < (longlong)(uVar18 + 0x10)) goto LAB_1402a772e;
                    uVar20 = 0;
                    uVar22 = lVar8 - (lVar8 - uVar18 & 0xf);
                    if (uVar18 != 0) {
                      do {
                        if ((*(char *)(uVar20 + uVar12) != '\0') &&
                           (bVar29 = *(byte *)(lVar15 + lVar25 + uVar20 * 4), bVar30 < bVar29)) {
                          bVar30 = bVar29;
                        }
                        uVar20 = uVar20 + 1;
                      } while (uVar20 < uVar18);
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar27 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar30 = auVar32[0xb];
                        auVar28[0xb] = (bVar7 < bVar30) * bVar30 | (bVar7 >= bVar30) * bVar7;
                        bVar30 = auVar32[0xc];
                        auVar28[0xc] = (bVar10 < bVar30) * bVar30 | (bVar10 >= bVar30) * bVar10;
                        bVar30 = auVar32[0xd];
                        auVar28[0xd] = (bVar9 < bVar30) * bVar30 | (bVar9 >= bVar30) * bVar9;
                        bVar30 = auVar32[0xe];
                        auVar28[0xe] = (bVar13 < bVar30) * bVar30 | (bVar13 >= bVar30) * bVar13;
                        bVar30 = auVar32[0xf];
                  ...
                  for (; uVar22 < (ulonglong)(longlong)(int)param_6; uVar22 = uVar22 + 1) {
                    if ((*(char *)(uVar22 + uVar12) != '\0') &&
                       (bVar29 = *(byte *)(lVar15 + lVar25 + uVar22 * 4), bVar30 < bVar29)) {
                      bVar30 = bVar29;
                    }
                  }
                }
