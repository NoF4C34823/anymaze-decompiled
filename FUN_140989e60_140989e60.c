...
void FUN_140989e60(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308df00)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_140989f6f;
    if ((param_7 & 0xf) == 6) {
      uVar11 = param_7 & 0x10;
      goto joined_r0x00014098a1c9;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_140989f6f;
    if ((param_7 & 0xf) == 6) {
      uVar11 = param_7 & 0x20;
joined_r0x00014098a1c9:
      if (uVar11 == 0) {
        uVar2 = *param_5;
...
LAB_140989f6f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_140998920(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
