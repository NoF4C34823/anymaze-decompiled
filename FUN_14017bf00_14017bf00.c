...
void FUN_14017bf00(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14017c784:
      ...
      uVar45 = uVar44 & 0xf;
      if (uVar45 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_14017c784;
        uVar45 = 0x10 - uVar45 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar45 + 4)) goto LAB_14017c784;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar45 & 0xf;
      if (uVar44 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_14017c792;
      ...
      if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
        ...
        uVar35 = _UNK_143087d88;
        uVar36 = _UNK_143087d84;
        uVar37 = _DAT_143087d80;
        if (uVar44 != 0) {
          do {
...
LAB_14017c70d:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar44 = uVar45 & 0xf;
    if (uVar44 != 0) {
      if ((uVar45 & 3) != 0) goto LAB_14017c78b;
      uVar44 = 0x10 - uVar44 >> 2;
    }
