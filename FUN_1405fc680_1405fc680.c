...
void FUN_1405fc680(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1405fc76f;
    if ((param_7 & 0xf) != 6) {
      if ((param_7 & 0xf) == 1) {
        if ((param_7 & 0x10) == 0) {
          param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_1405fc76f;
    if ((param_7 & 0xf) != 6) {
      if ((param_7 & 0xf) == 1) {
        if ((param_7 & 0x20) == 0) {
          param_3 = param_5[1] - 1;
...
LAB_1405fc76f:
    uStack_28 = *param_5;
    uStack_20 = param_5[1];
    FUN_1405fe180(param_1,param_2,param_3,param_4,&uStack_28,param_6,param_7,param_8,param_9,
                  param_10,param_11);
    return;
  }
  uVar3 = *param_5;
  ...
  if (7 < (longlong)uVar3) {
    uVar7 = param_4 & 0xf;
    if (uVar7 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1405fc8d7;
      uVar7 = 0x10 - uVar7 >> 2;
    }
    if ((longlong)(uVar7 + 8) <= (longlong)uVar3) {
      ...
      goto joined_r0x0001405fc877;
    }
  }
LAB_1405fc8d7:
  uVar5 = 0;
joined_r0x0001405fc877:
