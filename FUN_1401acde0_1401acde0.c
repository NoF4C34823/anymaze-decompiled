...
void FUN_1401acde0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401adf13. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087e40 + lVar18 * 8))(pbVar10,param_4,*param_5);
    return;
  }
  if (uVar5 == 6) {
    uVar12 = (uint)*param_8;
          ...
          if (uVar5 != 6) {
            if (uVar5 == 1) {
              ...
              if (lVar8 < 2) {
                ...
                if (lVar7 < 0) goto LAB_1401adea0;
                while (uStack_70 == 0) {
                  for (lVar14 = (lVar8 + -1) * 2 - lVar14; lVar14 < 0; lVar14 = -lVar14) {
LAB_1401adea0:
                    if (uVar12 != 0) goto LAB_1401adda4;
                  }
...
LAB_1401adda4:
        ...
        *(byte *)(lVar17 + param_11) = bVar20;
        lVar17 = lVar17 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401ade07. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087e40 + lVar18 * 8))(param_11 + uVar21,param_4,lVar8,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar21 == 1) {
...
LAB_1401ade1c:
              ...
              if ((longlong)uVar9 < (longlong)(uVar16 + 0x10)) goto LAB_1401ade1c;
...
LAB_1401ade2b:
              ...
              if ((longlong)uVar21 < (longlong)(uVar16 + 0x10)) goto LAB_1401ade2b;
...
LAB_1401ade24:
          ...
          if ((longlong)uVar21 < (longlong)(uVar16 + 0x10)) goto LAB_1401ade24;
          uVar19 = 0;
          uVar15 = uVar21 - (uVar21 - uVar16 & 0xf);
          if (uVar16 != 0) {
            do {
      ...
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143087e40 + lVar18 * 8))(lStack_68,param_4,uVar21,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401ade82. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087e40 + lVar18 * 8))(pbVar10,param_4,lVar8);
    return;
  }
  if ((longlong)uVar21 < lVar8) {
    lVar8 = lVar8 - uVar21;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143087e40 + lVar18 * 8))(pbVar10,param_4,lVar8,param_9,param_10);
...
LAB_1401ade32:
          ...
          if ((longlong)uVar9 < (longlong)(uVar16 + 0x10)) goto LAB_1401ade32;
          uVar19 = 0;
          uVar15 = uVar9 - (uVar9 - uVar16 & 0xf);
          if (uVar16 != 0) {
            do {
...
LAB_1401ad9a1:
  if (uVar5 == 1) {
    if ((longlong)uVar21 < 1) goto LAB_1401adc58;
    if ((longlong)uVar21 < 7) {
      lVar8 = 1;
      uVar9 = 0;
      if (uVar21 >> 1 != 0) {
...
LAB_1401ade42:
      ...
      if ((longlong)uVar21 < (longlong)(uVar9 + 0x10)) goto LAB_1401ade42;
      uVar15 = 0;
  ...
  if ((uVar5 != 6) || ((longlong)uVar21 < 1)) goto LAB_1401adc58;
  if ((longlong)uVar21 < 0x10) {
LAB_1401ade3a:
    uVar16 = 0;
  }
    ...
    if ((longlong)uVar21 < (longlong)(uVar9 + 0x10)) goto LAB_1401ade3a;
    uVar15 = 0;
    uVar16 = uVar21 - (uVar21 - uVar9 & 0xf);
    if (uVar9 != 0) {
      do {
...
LAB_1401adc58:
                    /* WARNING: Could not recover jumptable at 0x0001401adc94. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143087e40 + lVar18 * 8))(param_11 + uVar21,param_4,uVar21);
  return;
}
