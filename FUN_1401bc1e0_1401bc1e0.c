...
void FUN_1401bc1e0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar9) {
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401bc81e;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    if ((longlong)(uVar6 + 0x10) <= (longlong)uVar9) {
      ...
      uVar9 = uVar9 - uVar8;
      if ((longlong)uVar9 < 4) {
        FUN_1401bc7b3(param_1,0,uVar9,param_2,CONCAT44(unaff_XMM9_Dd,unaff_XMM9_Dc),
