...
void FUN_14067f420(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_14067fc4f:
      ...
      uVar38 = uVar39 & 0xf;
      if (uVar38 != 0) {
        if ((uVar39 & 3) != 0) goto LAB_14067fc4f;
        uVar38 = 0x10 - uVar38 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar38 + 8)) goto LAB_14067fc4f;
...
LAB_14067f8a4:
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar30 = param_4 & 0xf;
      if (uVar30 != 0) {
        if ((param_4 & 3) != 0) goto LAB_14067fc5e;
...
LAB_14067fbfc:
  ...
  if (7 < (longlong)param_5) {
    uVar30 = param_4 & 0xf;
    if (uVar30 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14067fc57;
      uVar30 = 0x10 - uVar30 >> 2;
    }
