...
void FUN_140798fa0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14079986c:
      uVar11 = 0;
      if (param_3 == 0) goto LAB_1407991c5;
      uVar13 = 0;
      uVar6 = param_3;
    }
    else {
      uVar6 = param_2 & 0xf;
      if (uVar6 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14079986c;
        uVar6 = 0x10 - uVar6 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_14079986c;
      ...
      if (param_3 < uVar11 + 1) goto LAB_1407991c5;
...
LAB_140799846:
          uVar11 = 0;
          if (param_3 == 0) goto LAB_14079968d;
          uVar13 = 0;
          uVar6 = param_3;
        }
        else {
          uVar6 = param_2 & 0xf;
          if (uVar6 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140799846;
            uVar6 = 0x10 - uVar6 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_140799846;
          uVar13 = 0;
          ...
          if (param_3 < uVar11 + 1) goto LAB_14079968d;
          uVar6 = param_3 - uVar11;
          if ((longlong)uVar6 < 4) {
            uVar13 = 0;
          }
...
LAB_140799833:
    ...
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140799833;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_140799833;
    uVar13 = 0;
    uVar11 = param_3 - (param_3 - uVar6 & 7);
    if (uVar6 != 0) {
      do {
