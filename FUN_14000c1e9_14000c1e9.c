...
void FUN_14000c1e9(longlong param_1,int param_2,longlong param_3,int param_4)

{
  ...
  do {
    ...
    FUN_140010f60(in_EAX + param_1,in_R10D + lStack0000000000000090,uVar1,&stack0x00000080,uVar2);
    in_R11D = in_R11D + 1;
