...
void FUN_140675d60(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1406767f4:
      ...
      if (uVar33 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_1406767f4;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar33 + 8)) goto LAB_1406767f4;
...
LAB_1406767be:
          uVar28 = 0;
          if (param_3 == 0) goto LAB_140676609;
          uVar33 = 0;
          uVar35 = param_3;
        }
        else {
          uVar33 = (ulonglong)param_2 & 0xf;
          if (uVar33 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_1406767be;
            uVar33 = 0x10 - uVar33 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar33 + 8)) goto LAB_1406767be;
          lVar36 = lVar34 * -4;
          ...
          if (param_3 < uVar28 + 1) goto LAB_140676609;
...
LAB_140676609:
  ...
  if (7 < (longlong)param_3) {
    uVar33 = (ulonglong)param_2 & 0xf;
    if (uVar33 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_1406767b2;
      uVar33 = 0x10 - uVar33 >> 2;
    }
