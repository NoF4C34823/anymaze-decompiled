...
void FUN_1403a7020(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar2 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_142d23ba0(param_1,lVar3,lVar5,(longlong)(int)param_6 * 4,4);
        lVar6 = lVar6 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_142d23ba0(param_1,lVar3,lVar5,(longlong)(int)param_6 * 4,4);
        thunk_FUN_142d23d30(param_9,uVar4,param_3,lVar5,(longlong)param_6._4_4_);
        lVar2 = lVar2 + 1;
        lVar6 = lVar6 + 1;
        lVar3 = lVar3 + uVar4 * 4;
    ...
    FUN_1403b64e0(param_1,lVar1,param_3,(longlong)param_4 >> 2,lVar5,(longlong)param_5._4_4_,
