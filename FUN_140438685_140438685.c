...
void FUN_140438685(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < iStack00000000000000e4) {
    do {
      ...
      FUN_140d12240(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
      lVar2 = unaff_R12 + 1;
      lVar1 = lVar1 + 1;
