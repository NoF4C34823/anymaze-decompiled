...
void FUN_14090c940(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308d3e0)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_14090ca4f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x00014090cc6e;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_14090ca4f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x00014090cc6e:
      if (uVar2 != 0) goto LAB_14090ca4f;
      uVar3 = *param_5;
      fVar7 = (float)*param_8;
      if ((longlong)uVar3 < 1) {
        return;
...
LAB_14090cc1b:
        ...
        if ((longlong)uVar3 < 0x1d) {
          ...
          uVar6 = param_4 & 0x1f;
          if (uVar6 != 0) {
            if ((param_4 & 3) != 0) goto LAB_14090cc1b;
            uVar6 = 0x20 - uVar6 >> 2;
          }
          if ((longlong)uVar3 < (longlong)(uVar6 + 0x10)) goto LAB_14090cc1b;
          uVar5 = 0;
...
LAB_14090ca4f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_140912560(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
