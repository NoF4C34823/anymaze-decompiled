...
void FUN_140756880(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140756fdb:
      uVar37 = 0;
      if (param_5 == 0) goto LAB_140756d7e;
      uVar36 = 0;
      uVar50 = param_5;
    }
    else {
      ...
      uVar50 = uVar49 & 0xf;
      if (uVar50 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_140756fdb;
        uVar50 = 0x10 - uVar50 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar50 + 8)) goto LAB_140756fdb;
      ...
      if (param_5 < uVar37 + 1) goto LAB_140756d7e;
...
LAB_140756d7e:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar49 = uVar50 & 0xf;
      if (uVar49 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_140756ff8;
...
LAB_140756f81:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar49 = uVar50 & 0xf;
    if (uVar49 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_140756ff1;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
      uVar36 = 0;
