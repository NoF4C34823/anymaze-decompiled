...
void FUN_14016ffe6(longlong param_1,undefined8 param_2,ulonglong param_3,undefined8 param_4)

{
  ...
  uVar15 = 0;
  puVar14 = (uint *)(param_1 + in_R9);
  uVar13 = param_3 & 0xfffffffffffffffc;
  do {
    uVar2 = *(uint *)((longlong)puVar14 + -1);
    uVar3 = *(uint *)((longlong)puVar14 + 1);
    ...
    pfVar1 = (float *)(in_R10 + in_R9 * 4 + uVar15 * 4);
    *pfVar1 = (float)CONCAT22(in_XMM4_Wa,CONCAT11(uVar16,(char)uVar2) + CONCAT11(uVar16,(char)uVar3)
                             ) * (float)param_2 +
              (float)CONCAT22(in_XMM4_Wa,uVar53) * (float)param_4;
  ...
  if (uVar13 < param_3) {
    ...
    do {
      *(float *)(in_R10 + in_R9 * 4 + uVar13 * 4) =
           (float)((uint)*(byte *)((uVar13 - 1) + param_1) + (uint)*(byte *)(uVar13 + 1 + param_1))
