...
void FUN_1405872a8(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    FUN_140d34600(unaff_RSI,unaff_RBX);
  ...
  if (0 < iStack00000000000000e4) {
    do {
      FUN_140d34600(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,lStack0000000000000060,1);
      thunk_FUN_140d34b40(in_stack_00000100,param_1,lVar3,(longlong)iStack00000000000000e0,lVar1);
