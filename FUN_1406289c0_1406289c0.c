...
longlong *
FUN_1406289c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,longlong *param_5,
             int param_6,uint param_7,ushort *param_8,undefined8 param_9,int param_10,
             undefined8 param_11)
...
LAB_140628a89:
    ...
    if ((param_5[1] <= (longlong)uVar25) && (param_7 != 0xf0)) {
      if (uVar20 == 6) {
        if (uStack_90 == 0) goto LAB_140628bad;
      }
      else {
        if (uVar20 != 1) goto LAB_140628ac3;
        if (uStack_90 == 0) {
          uVar14 = param_5[1] - 1;
        }
      }
...
LAB_140628b3a:
    do {
      ...
      lStack_60 = param_5[1];
      in_RAX = (longlong *)
               FUN_1406295a0(lStack_50,lStack_58,uVar14,lVar22,in_stack_ffffffffffffff18,param_6,
                             param_7,puVar13,param_9,param_10,param_11);
      while( true ) {
        while( true ) {
          uVar7 = param_11;
          uVar5 = param_9;
          ...
          if (uStack_48 <= uVar25) {
            ...
            if (uStack_78 != 0) {
              ...
              do {
                ...
                uStack_a0 = param_5[1];
                plVar9 = (longlong *)
                         FUN_1406295a0(lStack_50,lStack_58,lVar22,lVar11,&lStack_a8,param_6,param_7,
                                       puVar6,uVar5,param_10,uVar7);
                lVar16 = lVar16 + 1;
                lVar22 = lVar22 + 1;
...
LAB_140628dbf:
          ...
          (**(code **)(&DAT_14308b4e0 + (longlong)param_6 * 8))
        ...
        lVar18 = lStack_58;
        lVar8 = lStack_50;
        if (-1 < (longlong)uVar25) goto LAB_140628a89;
        uVar14 = uVar25;
        if (param_7 == 0xf0) goto LAB_140628b3a;
        if (uVar20 != 6) break;
        if (uStack_78 != 0) goto LAB_140628b3a;
LAB_140628bad:
        in_RAX = (longlong *)(ulonglong)*puVar13;
        fVar28 = (float)*puVar13;
        fVar27 = (float)puVar13[1];
        fVar26 = (float)puVar13[2];
        if (0 < *param_5 * 3) {
          uVar14 = *param_5 * 3 + 2;
          lVar22 = 1;
          lVar18 = 0;
...
LAB_1406292f1:
            ...
            uVar14 = uVar10 & 0xf;
            if (uVar14 != 0) {
              if ((uVar10 & 3) != 0) goto LAB_1406292f1;
              uVar14 = 0x10 - uVar14 >> 2;
            }
            if ((longlong)uVar25 < (longlong)(uVar14 + 4)) goto LAB_1406292f1;
            uVar15 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_a0 = param_5[1];
      in_RAX = (longlong *)
               FUN_1406295a0(param_1,param_2,lVar11,param_3,&lStack_a8,param_6,param_7,param_8,
...
LAB_140629105:
            ...
            if (plVar24 != (longlong *)0x0) {
              if ((uVar14 & 3) != 0) goto LAB_140629105;
              plVar24 = (longlong *)(0x10U - (longlong)plVar24 >> 2);
            }
            if ((longlong)plVar9 < (longlong)plVar24 + 4) goto LAB_140629105;
...
LAB_140628ac3:
  ...
  if (uVar20 == 3) {
    ...
    if (lVar16 < 2) {
      ...
      if ((longlong)uVar25 < 0) goto LAB_140628d60;
      while (uStack_90 == 0) {
