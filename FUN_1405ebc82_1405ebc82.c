...
void FUN_1405ebc82(longlong param_1,undefined8 param_2,longlong param_3,float param_4)

{
  ...
  if (param_1 + 1U <= in_R9) {
    ...
    uVar20 = 0;
    puVar19 = (undefined4 *)(param_3 + param_1);
    uVar18 = in_R9 & 0xfffffffffffffffc;
    do {
      uVar2 = *(undefined4 *)((longlong)puVar19 + -6);
      uVar3 = *(undefined4 *)((longlong)puVar19 + 6);
      ...
      uVar4 = *(undefined4 *)((longlong)puVar19 + 3);
      uVar5 = *(undefined4 *)((longlong)puVar19 + -3);
    ...
    if (uVar18 < in_R9) {
      ...
      do {
        *(float *)(in_R10 + param_1 * 4 + uVar18 * 4) =
             (float)((uint)*(byte *)((uVar18 - 6) + param_3) + (uint)*(byte *)(uVar18 + 6 + param_3)
                    ) * param_4 +
             (float)((uint)*(byte *)((uVar18 - 3) + param_3) + (uint)*(byte *)(uVar18 + 3 + param_3)
                    ) * in_XMM2_Da + (float)*(byte *)(uVar18 + param_3) * in_XMM0_Da;
        uVar18 = uVar18 + 1;
      } while (uVar18 < in_R9);
    }
  }
