...
void FUN_14006e8a0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14006f17e:
      uVar39 = 0;
      if (param_5 == 0) goto LAB_14006edc0;
      uVar32 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar32 = uVar30 & 0xf;
      if (uVar32 != 0) {
        if ((uVar30 & 3) != 0) goto LAB_14006f17e;
        uVar32 = 0x10 - uVar32 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar32 + 8)) goto LAB_14006f17e;
      ...
      if (param_5 < uVar39 + 1) goto LAB_14006edc0;
...
LAB_14006edc0:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar32 = uVar30 & 0xf;
      if (uVar32 != 0) {
        if ((uVar30 & 3) != 0) goto LAB_14006f1a1;
        uVar32 = 0x10 - uVar32 >> 2;
      }
      if ((longlong)(uVar32 + 4) <= (longlong)param_5) {
        ...
        auVar27 = _DAT_143086a00;
        auVar26 = _DAT_1430869f0;
        lVar31 = uVar32 * 2;
        do {
...
LAB_14006f108:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar32 = uVar30 & 0xf;
    if (uVar32 != 0) {
      if ((uVar30 & 3) != 0) goto LAB_14006f19a;
      uVar32 = 0x10 - uVar32 >> 2;
    }
