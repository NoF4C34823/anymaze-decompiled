...
void FUN_140314e60(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar19 != 0 && 0 < (longlong)uVar15) {
      do {
        FUN_1402fd0c0(lVar17,lVar8,uVar2,uVar5,4);
        lVar20 = lVar20 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1402fd0c0(lVar17,lVar8,uVar2,uVar5,4);
        thunk_FUN_142d22130(param_9,uVar6,param_3,uVar2,uVar15);
        lVar19 = lVar19 + 1;
        lVar8 = lVar8 + uVar6 * 4;
