...
void FUN_140819800(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308c700)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_14081990f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x000140819ca2;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_14081990f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x000140819ca2:
      if (uVar2 == 0) {
        auVar13._0_4_ = (float)*param_8;
        auVar13._4_8_ = SUB128(ZEXT812(0),4);
        auVar13._12_4_ = 0;
        auVar15._0_4_ = (float)param_8[1];
        auVar15._4_8_ = SUB128(ZEXT812(0),4);
        auVar15._12_4_ = 0;
        auVar14._0_4_ = (float)param_8[2];
...
LAB_14081990f:
  lStack_38 = *param_5;
  lStack_30 = param_5[1];
  FUN_1408213c0(lStack_38,param_2,param_3,param_4,&lStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
