...
void FUN_140708540(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140708e66:
      ...
      uVar30 = param_2 & 0xf;
      if (uVar30 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140708e66;
        uVar30 = 0x10 - uVar30 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_140708e66;
      uVar31 = 0;
...
LAB_140708e47:
          uVar24 = 0;
          if (param_3 == 0) goto LAB_140708c4c;
          uVar31 = 0;
          uVar30 = param_3;
        }
        else {
          uVar30 = param_2 & 0xf;
          if (uVar30 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140708e47;
            uVar30 = 0x10 - uVar30 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_140708e47;
          ...
          if (param_3 < uVar24 + 1) goto LAB_140708c4c;
...
LAB_140708e33:
    ...
    uVar30 = param_2 & 0xf;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140708e33;
      uVar30 = 0x10 - uVar30 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar30 + 8)) goto LAB_140708e33;
    uVar31 = 0;
    uVar24 = param_3 - (param_3 - uVar30 & 7);
    if (uVar30 != 0) {
      do {
