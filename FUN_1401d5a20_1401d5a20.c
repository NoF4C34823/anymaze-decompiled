...
void FUN_1401d5a20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < iVar8) {
    ...
    uVar5 = param_7 & 0x20;
    lVar18 = lVar10;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_1401d5e19;
    uVar12 = 0;
LAB_1401d5af0:
    uVar13 = uVar12;
    if (((longlong)param_5[1] <= (longlong)uVar12) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar5 == 0) goto LAB_1401d5c34;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_1401d5b2c;
        if (uVar5 == 0) {
          uVar13 = param_5[1] - 1;
        }
      }
...
LAB_1401d5bbb:
    do {
      FUN_1401d6620(param_1,param_2,uVar13);
      while( true ) {
        while( true ) {
          iVar11 = (int)uVar12;
          uVar12 = uVar12 + 1;
          ...
          if (uVar9 <= uVar12) {
            if (uVar16 != 0) {
              ...
              lVar19 = -uVar9;
              do {
                FUN_1401d6620(param_1,param_2,lVar19,param_3);
                lVar15 = lVar15 + 1;
...
LAB_1401d5e19:
        ...
        if (-1 < (longlong)uVar12) goto LAB_1401d5af0;
        uVar13 = uVar12;
        if (param_7 == 0xf0) goto LAB_1401d5bbb;
        if ((param_7 & 0xf) != 6) break;
        if (uVar16 != 0) goto LAB_1401d5bbb;
LAB_1401d5c34:
        uVar13 = *param_5;
...
LAB_1401d6580:
            ...
            uVar6 = uVar7 & 0xf;
            if (uVar6 != 0) {
              if ((uVar7 & 3) != 0) goto LAB_1401d6580;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar13 < (longlong)(uVar6 + 8)) goto LAB_1401d6580;
            uVar14 = 0;
...
LAB_1401d64af:
            ...
            uVar13 = uVar6 & 0xf;
            if (uVar13 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1401d64af;
              uVar13 = 0x10 - uVar13 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar13 + 8)) goto LAB_1401d64af;
            uVar17 = 0;
...
LAB_1401d6352:
            ...
            uVar13 = uVar6 & 0xf;
            if (uVar13 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1401d6352;
              uVar13 = 0x10 - uVar13 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar13 + 4)) goto LAB_1401d6352;
            uVar17 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      FUN_1401d6620(param_1,param_2,lVar15,param_3);
    }
    lVar15 = 1;
    uVar12 = 0;
    if (1 < iVar8) {
...
LAB_1401d6167:
            ...
            uVar6 = uVar13 & 0xf;
            if (uVar6 != 0) {
              if ((uVar13 & 3) != 0) goto LAB_1401d6167;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar6 + 4)) goto LAB_1401d6167;
...
LAB_1401d5b2c:
  ...
  if ((param_7 & 0xf) == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar12 < 0) goto LAB_1401d5dc0;
      while (uVar5 == 0) {
