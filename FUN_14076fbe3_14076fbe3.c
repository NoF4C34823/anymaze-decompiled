...
void FUN_14076fbe3(ulonglong param_1,float param_2,undefined8 param_3,undefined8 param_4)
  ...
  if (uVar6 < param_1) {
    ...
    do {
      *(float *)(unaff_RSI + in_RDX * 4 + uVar6 * 4) =
           (*(float *)(lVar1 + -0x18 + uVar6 * 4) + *(float *)(lVar1 + 0x18 + uVar6 * 4)) * param_2
           + (*(float *)(lVar1 + -0xc + uVar6 * 4) + *(float *)(lVar1 + 0xc + uVar6 * 4)) *
