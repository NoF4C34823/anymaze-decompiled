...
undefined8
FUN_1409737e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,ulonglong *param_5
...

{
  ...
  if ((0 < (longlong)param_5[1]) && (0 < (longlong)uVar1)) {
    ...
    if ((2 < (int)uVar3) && ((uVar3 & 1) != 0)) {
      ...
      pcStack_b0 = (code *)(&PTR_FUN_14308db80)[uVar7];
      if (0x7ffff < lVar8) {
        iStack_108 = 0;
        uStack_118 = uVar7;
        uStack_110 = lVar8;
      ...
      pcVar2 = *(code **)(&UNK_14308d960 + uVar7 * 8);
      ...
      if (param_6 == 0xf0) {
        ...
        lVar5 = param_7;
        FUN_140966a00(param_1,param_2,lStack_a8,uStack_80,&uStack_118,uVar7 & 0xffffffff,param_6,
        ...
        if ((param_6 & 0xc0) == 0xc0) {
          ...
          if (0 < (longlong)(uVar7 - uVar9)) {
            do {
              ...
              uStack_d0 = param_5[1];
              FUN_1409676e0(lStack_a0,lStack_70,uVar9,uStack_80 * lVar8 + lStack_a8,&pcStack_d8,
        ...
        if (lVar10 < (longlong)uVar7) {
          do {
            uStack_c8 = *param_5;
            uStack_c0 = param_5[1];
            FUN_140961f20(lStack_a0,lStack_70,uStack_68 + lVar10,uStack_80 * lVar5 + lStack_a8,
