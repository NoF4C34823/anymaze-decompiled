...
void FUN_140727720(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140728287:
      ...
      uVar36 = 0;
      uVar38 = uVar33;
      if (uVar33 == 0) goto LAB_14072795f;
    }
    else {
      uVar38 = (ulonglong)param_2 & 0xf;
      if (uVar38 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140728287;
        uVar38 = 0x10 - uVar38 >> 2;
      }
      if ((longlong)uVar33 < (longlong)(uVar38 + 8)) goto LAB_140728287;
      uVar36 = 0;
      ...
      if (uVar33 < uVar39 + 1) goto LAB_14072795f;
...
LAB_140728248:
          uVar36 = 0;
          if (uVar33 == 0) goto LAB_140728068;
          uVar39 = 0;
          uVar38 = uVar33;
        }
        else {
          uVar38 = (ulonglong)param_2 & 0xf;
          if (uVar38 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140728248;
            uVar38 = 0x10 - uVar38 >> 2;
          }
          if ((longlong)uVar33 < (longlong)(uVar38 + 8)) goto LAB_140728248;
          uVar39 = 0;
          lVar34 = lVar46 * -0xc;
          ...
          if (uVar33 < uVar36 + 1) goto LAB_140728068;
...
LAB_140728068:
  ...
  if (7 < (longlong)uVar33) {
    uVar38 = (ulonglong)param_2 & 0xf;
    if (uVar38 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_140728234;
      uVar38 = 0x10 - uVar38 >> 2;
    }
