...
void FUN_1405a171a(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  do {
    thunk_FUN_140d3ae60(unaff_RSI,unaff_RBX,(longlong)iStack00000000000000e0,uStack0000000000000060,
                        1);
    thunk_FUN_140d3b3a0(in_stack_00000100,param_1,param_3,(longlong)iStack00000000000000e0);
