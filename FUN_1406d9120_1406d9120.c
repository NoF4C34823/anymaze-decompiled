...
longlong *
FUN_1406d9120(longlong param_1,longlong param_2,longlong param_3,longlong param_4,longlong *param_5,
...

{
  ...
  if (0 < iVar10) {
    ...
    uVar18 = param_7 & 0x20;
    lVar15 = lVar20;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_1406d9560;
LAB_1406d91f6:
    uVar12 = uVar22;
    if ((param_5[1] <= (longlong)uVar22) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar18 == 0) goto LAB_1406d9336;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_1406d9231;
        if (uVar18 == 0) {
          uVar12 = param_5[1] - 1;
        }
      }
...
LAB_1406d92ba:
    do {
      FUN_1406d9da0(param_1,param_2,uVar12);
      while( true ) {
        while( true ) {
          iVar21 = (int)uVar22;
          uVar22 = uVar22 + 1;
          ...
          if (uVar11 <= uVar22) {
            if (uVar5 != 0) {
              ...
              lVar17 = -uVar11;
              do {
                plVar6 = (longlong *)FUN_1406d9da0(param_1,param_2,lVar17,param_3);
                lVar8 = lVar8 + 1;
                lVar17 = lVar17 + 1;
...
LAB_1406d9560:
          (*(code *)(&PTR_FUN_14308bb40)[param_6])
                    (param_2 * uVar22 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar22) goto LAB_1406d91f6;
        uVar12 = uVar22;
        if (param_7 == 0xf0) goto LAB_1406d92ba;
        if ((param_7 & 0xf) != 6) break;
        if (uVar5 != 0) goto LAB_1406d92ba;
LAB_1406d9336:
        lVar15 = *param_5 * 2 + *param_5;
        fVar25 = (float)*param_8;
        fVar24 = (float)param_8[1];
        fVar23 = (float)param_8[2];
        if (0 < lVar15) {
          uVar16 = lVar15 + 2;
          uVar13 = 0;
          lVar7 = 1;
...
LAB_1406d9600:
  ...
  if (uVar18 == 6) {
    fVar24 = (float)param_8[1];
    uVar22 = 0;
    plVar6 = (longlong *)(ulonglong)*param_8;
    lVar8 = 0;
    fVar25 = (float)*param_8;
    fVar23 = (float)param_8[2];
    if (0 < iVar10) {
...
LAB_1406d9af3:
            ...
            uVar12 = uVar13 & 0xf;
            if (uVar12 != 0) {
              if ((uVar13 & 3) != 0) goto LAB_1406d9af3;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar11 < (longlong)(uVar12 + 4)) goto LAB_1406d9af3;
            uVar14 = 0;
...
LAB_1406d9920:
      ...
      plVar6 = (longlong *)FUN_1406d9da0(param_1,param_2,lVar8,param_3);
    }
    lVar8 = 1;
    uVar22 = 0;
    if (1 < iVar10) {
...
LAB_1406d98e6:
            ...
            if (plVar6 != (longlong *)0x0) {
              if ((uVar11 & 3) != 0) goto LAB_1406d98e6;
              plVar6 = (longlong *)(0x10U - (longlong)plVar6 >> 2);
            }
            if ((longlong)plVar9 < (longlong)plVar6 + 4) goto LAB_1406d98e6;
...
LAB_1406d9231:
  ...
  if ((param_7 & 0xf) == 3) {
    if (param_5[1] < 2) {
      ...
      if ((longlong)uVar22 < 0) goto LAB_1406d9500;
      while (uVar18 == 0) {
