...
void FUN_14017d220(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_14017d79c:
      uVar26 = 0;
      if (param_5 == 0) goto LAB_14017d4c8;
      uVar22 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar18 & 0xf;
      if (uVar19 != 0) {
        if ((uVar18 & 3) != 0) goto LAB_14017d79c;
        uVar19 = 0x10 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 8)) goto LAB_14017d79c;
      ...
      if (param_5 < uVar26 + 1) goto LAB_14017d4c8;
...
LAB_14017d4c8:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar18 = param_4 & 0xf;
      if (uVar18 != 0) {
        if ((param_4 & 1) != 0) goto LAB_14017d7ba;
...
LAB_14017d73e:
  ...
  if (7 < (longlong)param_5) {
    uVar18 = param_4 & 0xf;
    if (uVar18 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14017d7b3;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)(uVar18 + 8) <= (longlong)param_5) {
      lVar21 = param_2 * 3 + param_1;
