...
void FUN_1404c70c0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6) {
    do {
      ...
      if (uVar6 != 0) {
        ...
        FUN_1404c7300(param_1,param_2,param_3,uVar6);
      ...
      if (lVar11 != 0) {
        ...
        auVar14 = vmaxps_avx(*pauVar5,*pauVar7);
        ...
        if (1 < lVar11) {
          do {
            ...
            auVar14 = vmaxps_avx(pauVar5[1],auVar14);
            ...
            auVar13 = vmaxps_avx(auVar3,auVar13);
            auVar15 = vpermilps_avx(auVar15,0x4e);
            auVar13 = vmaxps_avx(auVar15,auVar13);
        ...
        pauVar1 = pauVar5 + 1;
        pauVar5 = pauVar5 + 1;
        auVar13 = vmaxps_avx(ZEXT832(*(ulonglong *)*pauVar1),ZEXT832(*(ulonglong *)pauVar7[1]));
        auVar13 = vmaxps_avx(auVar13,ZEXT832(*(ulonglong *)pauVar12[2]));
      ...
      if ((uVar10 & 7) != 0) {
        FUN_1404c7300(pauVar5,param_2,pauVar9);
      }
      lVar8 = lVar8 + 1;
