...
void FUN_1408a9e00(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)uVar13) {
    if ((longlong)uVar13 < 0x1d) {
      FUN_1408a9ebd(uVar13 & 0xfffffffffffffff0,uVar13,param_2,0);
      return;
    }
    uVar14 = param_2 & 0x1f;
    if (uVar14 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408aa069;
    ...
    if ((longlong)(uVar14 + 0x10) <= (longlong)uVar13) {
      ...
      if (uVar14 != 0) {
        do {
          auVar15._0_4_ =
               (float)((int)*(short *)(param_1 + -6 + uVar11 * 2) +
                      (int)*(short *)(param_1 + 6 + uVar11 * 2));
          auVar15._4_8_ = SUB128(ZEXT812(0),4);
          auVar15._12_4_ = 0;
          auVar15 = vfmadd231ss_fma(ZEXT416((uint)(fVar2 * (float)(int)*(short *)(param_1 +
                                                                                 uVar11 * 2))),
      ...
      do {
        ...
        auVar9 = vpmovsxwd_avx2(auVar4._0_16_);
        auVar10 = vpmovsxwd_avx2(auVar3._0_16_);
        ...
        auVar4 = vpmovsxwd_avx2(auVar5._0_16_);
        ...
        auVar4 = vpmovsxwd_avx2(auVar5._16_16_);
        auVar4 = vcvtdq2ps_avx(auVar4);
      ...
      do {
        auVar17._0_4_ =
             (float)((int)*(short *)(param_1 + -6 + uVar14 * 2) +
                    (int)*(short *)(param_1 + 6 + uVar14 * 2));
        auVar17._4_12_ = SUB1612(ZEXT816(0) << 0x40,4);
        auVar15 = vfmadd231ss_fma(ZEXT416((uint)(fVar2 * (float)(int)*(short *)(param_1 + uVar14 * 2
                                                                               ))),auVar17,
                                  ZEXT416(uVar1));
