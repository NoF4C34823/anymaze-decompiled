...
void FUN_14063c4a0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14063cd24:
      ...
      uVar45 = uVar44 & 0xf;
      if (uVar45 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_14063cd24;
        uVar45 = 0x10 - uVar45 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar45 + 4)) goto LAB_14063cd24;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar45 & 0xf;
      if (uVar44 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_14063cd32;
      ...
      if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
        ...
        uVar35 = _UNK_14308b6a8;
        uVar36 = _UNK_14308b6a4;
        uVar37 = _DAT_14308b6a0;
        if (uVar44 != 0) {
          do {
...
LAB_14063ccad:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar44 = uVar45 & 0xf;
    if (uVar44 != 0) {
      if ((uVar45 & 3) != 0) goto LAB_14063cd2b;
      uVar44 = 0x10 - uVar44 >> 2;
    }
