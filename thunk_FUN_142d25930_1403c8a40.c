...
void thunk_FUN_142d25930(undefined1 (*param_1) [16],int param_2,undefined1 (*param_3) [16],
    ...
    if (7 < lVar7) {
      ...
      if (((ulonglong)param_3 & 0xf) == 0) {
        do {
          ...
          lVar7 = lVar10;
          do {
            auVar14 = minps(auVar14,*(undefined1 (*) [16])(*param_1 + lVar7));
            auVar15 = minps(auVar15,*(undefined1 (*) [16])(param_1[1] + lVar7));
            lVar7 = lVar7 + lVar10;
          } while (lVar7 < lVar6);
          *pauVar12 = auVar14;
          param_1 = param_1 + 2;
