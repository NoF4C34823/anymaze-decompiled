...
void FUN_140727120(longlong param_1,longlong param_2,longlong param_3,float *param_4)

{
  ...
  if (7 < (longlong)uVar31) {
    ...
    if (uVar33 != 0) {
      if ((param_1 + 0x18U & 3) != 0) goto LAB_14072748a;
