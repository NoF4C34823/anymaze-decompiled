...
void FUN_1409230a0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140923cc8:
      ...
      uVar28 = param_2 & 0x1f;
      if (uVar28 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140923cc8;
        uVar28 = 0x20 - uVar28 >> 2;
      }
      if ((longlong)uVar20 < (longlong)(uVar28 + 0x20)) goto LAB_140923cc8;
...
LAB_140923ca9:
          ...
          uVar28 = param_2 & 0x1f;
          if (uVar28 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140923ca9;
            uVar28 = 0x20 - uVar28 >> 2;
          }
          if ((longlong)uVar20 < (longlong)(uVar28 + 0x20)) goto LAB_140923ca9;
  ...
  if (0x1f < (longlong)uVar20) {
    uVar28 = param_2 & 0x1f;
    if (uVar28 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140923c9b;
      uVar28 = 0x20 - uVar28 >> 2;
    }
