...
void FUN_1409a5dc0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x27) {
        ...
        if (uVar27 != 0) {
          ...
          if (param_5 == uVar27) goto LAB_1409a6033;
        }
      }
    ...
    if (uVar28 + 1 <= param_5) {
      ...
      lVar25 = param_2 * lVar22 + param_1;
      uVar17 = vpcmpgtq_avx512f(auVar36,_DAT_14308dfc0);
      bVar19 = (byte)uVar17;
      uVar17 = vpcmpgtq_avx512f(auVar36,_DAT_14308e000);
      bVar18 = (byte)uVar17;
      uVar35 = CONCAT11(bVar18,bVar19);
        ...
        if (0xf < (longlong)param_5) {
          if ((longlong)param_5 < 0x41) {
            ...
            if (uVar24 != 0) {
              ...
              if (param_5 == uVar24) goto LAB_1409a6296;
            }
          }
...
LAB_1409a6696:
    ...
    uVar23 = param_4 & 0x3f;
    if (uVar23 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1409a6696;
