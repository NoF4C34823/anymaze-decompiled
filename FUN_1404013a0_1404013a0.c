...
void FUN_1404013a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar41 - 1)) {
      while( true ) {
        FUN_1403ef6e0(param_1,lVar24,uVar8,uVar34,1);
        uVar41 = param_6[1];
        lVar27 = lVar27 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        FUN_1403ef6e0(param_1,lVar24,uVar8,*param_6,1);
        uVar41 = param_6[1];
        if (0 < (longlong)uVar8) {
          uVar34 = 0;
          do {
            ...
            if (0 < (longlong)uVar41) {
              ...
              if (uVar41 >> 3 != 0) {
                ...
                do {
                  if (*(short *)(lVar42 + lVar11 + param_9) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar11 + param_9);
                  }
                  if (*(short *)(lVar42 + lVar6) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar6);
                  }
                  if (*(short *)(lVar42 + lVar5) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar5);
                  }
                  if (*(short *)(lVar42 + lVar4) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar4);
                  }
                  if (*(short *)(lVar42 + lVar25) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar25);
                  }
                  if (*(short *)(lVar42 + lVar3) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar3);
                  }
                  if (*(short *)(lVar42 + lVar2) < sVar40) {
                    sVar40 = *(short *)(lVar42 + lVar2);
                  }
                  uVar29 = uVar29 + 1;
                  if (*(short *)(lVar42 + lVar1) < sVar40) {
                ...
                if (0 < (longlong)uVar34) {
                  if ((longlong)uVar34 < 8) {
                    ...
                    do {
                      ...
                      sVar9 = auVar49._0_2_;
                      auVar53._0_2_ =
                           (ushort)(sVar9 < sVar40) * sVar9 | (ushort)(sVar9 >= sVar40) * sVar40;
                      sVar40 = auVar49._2_2_;
                      auVar53._2_2_ =
                           (ushort)(sVar40 < sVar48) * sVar40 | (ushort)(sVar40 >= sVar48) * sVar48;
                      sVar40 = auVar49._4_2_;
                      auVar53._4_2_ =
                           (ushort)(sVar40 < sVar31) * sVar40 | (ushort)(sVar40 >= sVar31) * sVar31;
                      sVar40 = auVar49._6_2_;
                      auVar53._6_2_ =
                           (ushort)(sVar40 < sVar33) * sVar40 | (ushort)(sVar40 >= sVar33) * sVar33;
                      sVar40 = auVar49._8_2_;
                      auVar53._8_2_ =
                           (ushort)(sVar40 < sVar35) * sVar40 | (ushort)(sVar40 >= sVar35) * sVar35;
                      sVar40 = auVar49._10_2_;
                      auVar53._10_2_ =
                           (ushort)(sVar40 < sVar37) * sVar40 | (ushort)(sVar40 >= sVar37) * sVar37;
                      sVar40 = auVar49._12_2_;
                      auVar53._12_2_ =
                           (ushort)(sVar40 < sVar39) * sVar40 | (ushort)(sVar40 >= sVar39) * sVar39;
                      sVar40 = auVar49._14_2_;
                      auVar53._14_2_ =
                           (ushort)(sVar40 < sVar44) * sVar40 | (ushort)(sVar40 >= sVar44) * sVar44;
                      auVar49 = auVar53 & auVar45 | ~auVar45 & auVar49;
                    } while (uVar30 < uVar32);
                    sVar40 = auVar49._8_2_;
                    sVar48 = auVar49._0_2_;
                    uVar47 = (ushort)(sVar40 < sVar48) * sVar40 |
                             (ushort)(sVar40 >= sVar48) * sVar48;
                    sVar40 = auVar49._10_2_;
                    sVar48 = auVar49._2_2_;
                    uVar50 = (ushort)(sVar40 < sVar48) * sVar40 |
                             (ushort)(sVar40 >= sVar48) * sVar48;
                    sVar40 = auVar49._12_2_;
                    sVar48 = auVar49._4_2_;
                    uVar51 = (ushort)(sVar40 < sVar48) * sVar40 |
                             (ushort)(sVar40 >= sVar48) * sVar48;
                    sVar40 = auVar49._14_2_;
                    sVar48 = auVar49._6_2_;
                    uVar52 = (ushort)(sVar40 < sVar48) * sVar40 |
                             (ushort)(sVar40 >= sVar48) * sVar48;
                    uVar47 = ((short)uVar51 < (short)uVar47) * uVar51 |
                             ((short)uVar51 >= (short)uVar47) * uVar47;
                    uVar50 = ((short)uVar52 < (short)uVar50) * uVar52 |
                             ((short)uVar52 >= (short)uVar50) * uVar50;
                    uVar47 = ((short)uVar50 < (short)uVar47) * uVar50 |
                             ((short)uVar50 >= (short)uVar47) * uVar47;
                  }
                  if (uVar32 < uVar34) {
                    lVar1 = lVar42 + lVar28;
                    do {
                      if ((*(char *)(uVar32 + param_7 + lVar25) != '\0') &&
                         (*(short *)(lVar1 + uVar32 * 2) < (short)uVar47)) {
