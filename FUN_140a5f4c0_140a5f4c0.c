...
uint FUN_140a5f4c0(undefined1 *param_1,ulonglong param_2,uint param_3,undefined8 param_4,
...
LAB_140a624bc:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a624bc;
            uVar20 = 0;
...
LAB_140a61fec:
    ...
    if (lVar21 < 1) {
      uVar5 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a62316;
LAB_140a62208:
      if ((int)uVar5 < 1) {
        return param_5;
      }
...
LAB_140a624ca:
        ...
        if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a624ca;
...
LAB_140a6211b:
        ...
        if (((longlong)(uVar14 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar14 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a6211b;
        if (uVar5 < 0x10) {
LAB_140a624c3:
          uVar9 = 0;
        }
          ...
          iVar6 = (int)uVar7;
          if (uVar5 < iVar6 + 0x10U) goto LAB_140a624c3;
          uVar9 = 0;
      ...
      if (lVar21 < 5) {
        uVar5 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a62208;
LAB_140a62316:
        if ((int)uVar5 < 1) {
          return param_5;
        }
        ...
        *(undefined1 *)(lVar16 + 3 + param_2) = param_1[lVar21 + -1];
        ...
        lVar16 = (longlong)(int)uVar4;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar5 < 1) goto LAB_140a5fa2c;
          goto LAB_140a62210;
        }
        if ((int)uVar5 < 1) goto LAB_140a5fa2c;
      }
...
LAB_140a624d1:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a624d1;
            uVar13 = 0;
...
LAB_140a61d0a:
          ...
          if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a61d0a;
          uVar9 = 0;
      ...
      uVar4 = 0;
      if ((int)param_5 < 1) goto LAB_140a6188c;
      if (6 < (int)param_5) {
        uVar7 = (ulonglong)(int)param_5;
        if (((longlong)uVar7 <= (longlong)(param_2 - (longlong)(param_1 + (int)-param_5))) ||
           ((longlong)uVar7 <= (longlong)-(param_2 - (longlong)(param_1 + (int)-param_5)))) {
...
LAB_140a61d11:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a61d11;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar14 & 0xf));
            if (uVar14 != 0) {
              do {
...
LAB_140a619bc:
        ...
        uVar14 = param_2 + lVar16;
        if (((longlong)(uVar14 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar14 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a619bc;
        if (uVar5 < 0x10) {
LAB_140a61d18:
          uVar9 = 0;
        }
          ...
          iVar6 = (int)uVar7;
          if (uVar5 < iVar6 + 0x10U) goto LAB_140a61d18;
          uVar9 = 0;
          iVar11 = uVar5 - (uVar5 - iVar6 & 0xf);
          if (iVar6 != 0) {
            do {
    ...
    iVar6 = (int)lVar16;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar5 < 1) goto LAB_140a61ce2;
      if (6 < (int)uVar5) {
        uVar7 = param_2 + lVar16;
        uVar14 = 4 - (longlong)(int)param_5;
...
LAB_140a61d26:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a61d26;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a61d1f:
      ...
      if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a61d1f;
...
LAB_140a5ff9c:
        ...
        if ((param_6 & 0x40) != 0) {
          if (-1 < lVar8) {
            if ((longlong)uVar14 < lVar21) goto LAB_140a60547;
            bVar22 = -1 < lVar8;
...
LAB_140a605c9:
            ...
            else if (-1 < lVar8) goto LAB_140a605c9;
          }
LAB_140a60007:
          if (4 < lVar21) goto LAB_140a60112;
          goto LAB_140a60011;
        }
        if (-1 < (int)(param_5 - 1)) {
          uVar7 = 0;
        ...
        if (lVar21 < 5) goto LAB_140a6036d;
      }
      else {
        uVar10 = (uint)uVar7;
        if (uVar10 < 7) {
LAB_140a5fbc0:
          ...
          if (((longlong)(uVar9 - (longlong)param_1) < (longlong)uVar7) &&
             ((longlong)-(uVar9 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a5fbc0;
          if (uVar10 < 0x10) {
LAB_140a60596:
            uVar20 = 0;
          }
            ...
            iVar6 = (int)uVar7;
            if (uVar10 < iVar6 + 0x10U) goto LAB_140a60596;
            uVar20 = 0;
        ...
        if (lVar21 < 5) goto LAB_140a5ff9c;
        if ((param_6 & 0x40) == 0) {
          if (-1 < (int)(param_5 - 1)) {
            uVar7 = 0;
            iVar6 = 1;
...
LAB_140a6059d:
              ...
              if ((longlong)uVar7 < (longlong)(uVar9 + 0x10)) goto LAB_140a6059d;
              uVar20 = 0;
...
LAB_140a6036d:
          uVar5 = -param_5 + 4;
          if ((int)uVar5 < 1) goto LAB_140a6050c;
          iVar6 = (int)lVar17;
          if (6 < (int)uVar5) {
...
LAB_140a605f1:
                ...
                if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a605f1;
                uVar13 = 0;
                uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
                if (uVar9 != 0) {
                  do {
...
LAB_140a60112:
      ...
      *(undefined1 *)(lVar17 + 3 + param_2) = param_1[-1];
      ...
      if ((int)uVar10 < 1) goto LAB_140a6050c;
      if (6 < (int)uVar10) {
        uVar7 = param_2 + lVar16;
...
LAB_140a605ea:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a605ea;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a5fa71:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a5fa71;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar14 & 0xf));
            if (uVar14 != 0) {
              do {
...
LAB_140a5fa78:
          ...
          iVar6 = (int)uVar14;
          if (param_3 < iVar6 + 0x10U) goto LAB_140a5fa78;
          uVar9 = 0;
      ...
      uVar4 = uVar5;
      lVar16 = (longlong)(int)uVar4;
      if (lVar21 < 5) goto LAB_140a5f8a7;
      uVar4 = uVar4 + 4;
      *(undefined1 *)(lVar16 + param_2) = param_1[lVar21 + -4];
      uVar5 = 4 - param_5;
      *(undefined1 *)(lVar16 + 1 + param_2) = param_1[lVar21 + -3];
...
LAB_140a5fa7f:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a5fa7f;
          uVar13 = 0;
          uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
          if (uVar9 != 0) {
            do {
...
LAB_140a615c4:
              ...
              if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a615c4;
              uVar20 = 0;
              lVar8 = lVar19 - lVar17;
      ...
      if ((int)(param_5 - 1) < 0) goto LAB_140a60ef0;
      if (6 < (int)param_5) {
...
LAB_140a615cb:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a615cb;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
            if (uVar14 != 0) {
              do {
      ...
      if (iVar6 - 1U < param_5) goto LAB_140a60ed3;
    }
  }
  else {
    if (param_3 < 7) {
...
LAB_140a615af:
        ...
        iVar6 = (int)uVar14;
        if (param_3 < iVar6 + 0x10U) goto LAB_140a615af;
        uVar9 = 0;
        iVar11 = param_3 - (param_3 - iVar6 & 0xf);
        if (iVar6 != 0) {
          do {
    ...
    lVar16 = (longlong)(int)uVar5;
    if (lVar21 < 5) goto LAB_140a60b84;
    if ((param_6 & 0x40) == 0) {
      if ((int)(param_5 - 1) < 0) goto LAB_140a60ef0;
      if (6 < (int)param_5) {
        lVar8 = (longlong)(int)param_5;
...
LAB_140a615b6:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a615b6;
            uVar20 = 0;
            lVar17 = lVar21 - lVar8;
            uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
            if (uVar14 != 0) {
...
LAB_140a615bd:
          ...
          if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a615bd;
          uVar20 = 0;
          uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
          if (uVar14 != 0) {
            do {
    ...
    if (param_5 <= iVar6 - 1U) goto LAB_140a60ef0;
LAB_140a60ed3:
    *(undefined1 *)(((longlong)(int)param_5 + param_2) - (longlong)iVar6) =
...
LAB_140a60ef0:
  ...
  if (lVar21 < 5) {
    ...
    uVar4 = iVar11 + 4;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar4 < 1) goto LAB_140a61587;
      if (6 < (int)uVar4) {
        uVar7 = param_2 + lVar16;
        puVar2 = param_1 + lVar21;
        uVar14 = 4 - (longlong)(int)param_5;
...
LAB_140a615e8:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a615e8;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a615e0:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a615e0;
  ...
  *(undefined1 *)(lVar16 + 3 + param_2) = puVar2[-1];
  ...
  if ((param_6 & 0x80) != 0) {
    lVar16 = (longlong)(int)uVar4;
    if ((int)uVar10 < 1) goto LAB_140a61587;
    if (6 < (int)uVar10) {
      uVar7 = param_2 + lVar16;
      uVar14 = 4 - (longlong)(int)param_5;
      if (((longlong)uVar14 <= (longlong)(uVar7 - (longlong)puVar2)) ||
...
LAB_140a615d9:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a615d9;
          uVar13 = 0;
          uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
          if (uVar9 != 0) {
            do {
...
LAB_140a615d2:
        ...
        if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a615d2;
        uVar13 = 0;
        uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
        if (uVar9 != 0) {
          do {
