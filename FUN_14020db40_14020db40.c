...
void FUN_14020db40(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14020e667:
      ...
      if ((longlong)uVar23 < 0x1d) {
        ...
        uVar28 = param_2 & 0x1f;
        if (uVar28 != 0) {
          if ((param_2 & 3) != 0) goto LAB_14020e667;
          uVar28 = 0x20 - uVar28 >> 2;
        }
        if ((longlong)uVar23 < (longlong)(uVar28 + 0x10)) goto LAB_14020e667;
        lVar18 = lVar33 * -6 + param_1;
...
LAB_14020e649:
          ...
          uVar21 = param_2 & 0x1f;
          if (uVar21 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14020e649;
            uVar21 = 0x20 - uVar21 >> 2;
          }
          if ((longlong)uVar23 < (longlong)(uVar21 + 0x10)) goto LAB_14020e649;
  ...
  if (0xf < (longlong)uVar23) {
    uVar21 = param_2 & 0x1f;
    if (uVar21 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14020e63b;
      uVar21 = 0x20 - uVar21 >> 2;
    }
