...
void FUN_1403b1540(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar20 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403ef6e0(lVar24,lVar19,(longlong)(int)param_5,(longlong)(int)param_6,1);
        lVar35 = lVar35 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403ef6e0(lVar24,lVar19,(longlong)(int)param_5,(longlong)(int)param_6,1);
        FUN_1403f8d00(param_9,uVar16,param_3,(longlong)(int)param_5,(longlong)param_6._4_4_);
        lVar20 = lVar20 + 1;
        lVar35 = lVar35 + 1;
        lVar19 = lVar19 + uVar16 * 2;
                ...
                if (0 < (longlong)uVar17) {
                  if ((longlong)uVar17 < 8) {
                    ...
                    do {
                      ...
                      sVar2 = auVar41._0_2_;
                      auVar45._0_2_ =
                           (ushort)(sVar2 < sVar33) * sVar2 | (ushort)(sVar2 >= sVar33) * sVar33;
                      sVar33 = auVar41._2_2_;
                      auVar45._2_2_ =
                           (ushort)(sVar33 < sVar40) * sVar33 | (ushort)(sVar33 >= sVar40) * sVar40;
                      sVar33 = auVar41._4_2_;
                      auVar45._4_2_ =
                           (ushort)(sVar33 < sVar18) * sVar33 | (ushort)(sVar33 >= sVar18) * sVar18;
                      sVar33 = auVar41._6_2_;
                      auVar45._6_2_ =
                           (ushort)(sVar33 < sVar23) * sVar33 | (ushort)(sVar33 >= sVar23) * sVar23;
                      sVar33 = auVar41._8_2_;
                      auVar45._8_2_ =
                           (ushort)(sVar33 < sVar27) * sVar33 | (ushort)(sVar33 >= sVar27) * sVar27;
                      sVar33 = auVar41._10_2_;
                      auVar45._10_2_ =
                           (ushort)(sVar33 < sVar29) * sVar33 | (ushort)(sVar33 >= sVar29) * sVar29;
                      sVar33 = auVar41._12_2_;
                      auVar45._12_2_ =
                           (ushort)(sVar33 < sVar31) * sVar33 | (ushort)(sVar33 >= sVar31) * sVar31;
                      sVar33 = auVar41._14_2_;
                      auVar45._14_2_ =
                           (ushort)(sVar33 < sVar34) * sVar33 | (ushort)(sVar33 >= sVar34) * sVar34;
                      auVar41 = auVar45 & auVar37 | ~auVar37 & auVar41;
                    } while (uVar22 < uVar17);
                    sVar33 = auVar41._8_2_;
                    sVar40 = auVar41._0_2_;
                    uVar39 = (ushort)(sVar33 < sVar40) * sVar33 |
                             (ushort)(sVar33 >= sVar40) * sVar40;
                    sVar33 = auVar41._10_2_;
                    sVar40 = auVar41._2_2_;
                    uVar42 = (ushort)(sVar33 < sVar40) * sVar33 |
                             (ushort)(sVar33 >= sVar40) * sVar40;
                    sVar33 = auVar41._12_2_;
                    sVar40 = auVar41._4_2_;
                    uVar43 = (ushort)(sVar33 < sVar40) * sVar33 |
                             (ushort)(sVar33 >= sVar40) * sVar40;
                    sVar33 = auVar41._14_2_;
                    sVar40 = auVar41._6_2_;
                    uVar44 = (ushort)(sVar33 < sVar40) * sVar33 |
                             (ushort)(sVar33 >= sVar40) * sVar40;
                    uVar39 = ((short)uVar43 < (short)uVar39) * uVar43 |
                             ((short)uVar43 >= (short)uVar39) * uVar39;
                    uVar42 = ((short)uVar44 < (short)uVar42) * uVar44 |
                             ((short)uVar44 >= (short)uVar42) * uVar42;
                    uVar39 = ((short)uVar42 < (short)uVar39) * uVar42 |
                             ((short)uVar42 >= (short)uVar39) * uVar39;
                  }
                  if (uVar17 < (ulonglong)(longlong)(int)param_6) {
                    lVar36 = lVar21 + lVar26;
                    do {
                      if ((*(char *)(uVar17 + param_7 + lVar28) != '\0') &&
                         (*(short *)(lVar36 + uVar17 * 2) < (short)uVar39)) {
