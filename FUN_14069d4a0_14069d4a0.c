...
void FUN_14069d4a0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14069dda9:
      ...
      uVar81 = param_2 & 0xf;
      if (uVar81 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14069dda9;
        uVar81 = 0x10 - uVar81 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_14069dda9;
      uVar82 = 0;
...
LAB_14069dd8a:
          uVar75 = 0;
          if (param_3 == 0) goto LAB_14069dbac;
          uVar82 = 0;
          uVar81 = param_3;
        }
        else {
          uVar81 = param_2 & 0xf;
          if (uVar81 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14069dd8a;
            uVar81 = 0x10 - uVar81 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_14069dd8a;
          ...
          if (param_3 < uVar75 + 1) goto LAB_14069dbac;
...
LAB_14069dd76:
    ...
    uVar81 = param_2 & 0xf;
    if (uVar81 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14069dd76;
      uVar81 = 0x10 - uVar81 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar81 + 8)) goto LAB_14069dd76;
    uVar82 = 0;
    uVar75 = param_3 - (param_3 - uVar81 & 7);
    if (uVar81 != 0) {
      do {
