...
void FUN_14080ae80(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14080b833:
      uVar49 = 0;
      if (param_3 == 0) goto LAB_14080b0c7;
      uVar47 = 0;
      uVar50 = param_3;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14080b833;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_14080b833;
      ...
      if (param_3 < uVar49 + 1) goto LAB_14080b0c7;
...
LAB_14080b80d:
          uVar49 = 0;
          if (param_3 == 0) goto LAB_14080b632;
          uVar47 = 0;
          uVar50 = param_3;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14080b80d;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_14080b80d;
          ...
          if (param_3 < uVar49 + 1) goto LAB_14080b632;
          uVar50 = param_3 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar47 = 0;
          }
...
LAB_14080b7fa:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14080b7fa;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_14080b7fa;
    uVar47 = 0;
    uVar49 = param_3 - (param_3 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
