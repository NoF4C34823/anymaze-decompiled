...
void FUN_1405b92a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar2 - 1U)) {
      while( true ) {
        FUN_140d3bc20(param_1,lVar6,lVar1,lVar5,1);
        lVar2 = param_6[1];
        lVar4 = lVar4 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_140d3bc20(param_1,lVar6,lVar1,*param_6,1);
