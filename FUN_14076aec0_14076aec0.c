...
void FUN_14076aec0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < iVar8) {
    ...
    uVar5 = param_7 & 0x20;
    lVar18 = lVar10;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_14076b2b9;
    uVar12 = 0;
LAB_14076af90:
    uVar13 = uVar12;
    if (((longlong)param_5[1] <= (longlong)uVar12) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar5 == 0) goto LAB_14076b0d4;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_14076afcc;
        if (uVar5 == 0) {
          uVar13 = param_5[1] - 1;
        }
      }
...
LAB_14076b05b:
    do {
      FUN_14076bac0(param_1,param_2,uVar13);
      while( true ) {
        while( true ) {
          iVar11 = (int)uVar12;
          uVar12 = uVar12 + 1;
          ...
          if (uVar9 <= uVar12) {
            if (uVar16 != 0) {
              ...
              lVar19 = -uVar9;
              do {
                FUN_14076bac0(param_1,param_2,lVar19,param_3);
                lVar15 = lVar15 + 1;
...
LAB_14076b2b9:
          (*(code *)(&PTR_FUN_14308c0c0)[param_6])
                    (param_2 * uVar12 + param_1,lVar18,*param_5,param_9);
        }
        if (-1 < (longlong)uVar12) goto LAB_14076af90;
        uVar13 = uVar12;
        if (param_7 == 0xf0) goto LAB_14076b05b;
        if ((param_7 & 0xf) != 6) break;
        if (uVar16 != 0) goto LAB_14076b05b;
LAB_14076b0d4:
        uVar13 = *param_5;
...
LAB_14076ba20:
            ...
            uVar6 = uVar7 & 0xf;
            if (uVar6 != 0) {
              if ((uVar7 & 3) != 0) goto LAB_14076ba20;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar13 < (longlong)(uVar6 + 8)) goto LAB_14076ba20;
            uVar14 = 0;
...
LAB_14076b94f:
            ...
            uVar13 = uVar6 & 0xf;
            if (uVar13 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_14076b94f;
              uVar13 = 0x10 - uVar13 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar13 + 8)) goto LAB_14076b94f;
            uVar17 = 0;
...
LAB_14076b7f2:
            ...
            uVar13 = uVar6 & 0xf;
            if (uVar13 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_14076b7f2;
              uVar13 = 0x10 - uVar13 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar13 + 4)) goto LAB_14076b7f2;
            uVar17 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      (*(code *)(&PTR_FUN_14308c0c0)[param_6])(param_1 + param_2 * lVar15,param_3,*param_5,param_9);
    }
    else {
      ...
      FUN_14076bac0(param_1,param_2,lVar15,param_3);
    }
    lVar15 = 1;
    uVar12 = 0;
    if (1 < iVar8) {
...
LAB_14076b607:
            ...
            uVar6 = uVar13 & 0xf;
            if (uVar6 != 0) {
              if ((uVar13 & 3) != 0) goto LAB_14076b607;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar9 < (longlong)(uVar6 + 4)) goto LAB_14076b607;
...
LAB_14076afcc:
  ...
  if ((param_7 & 0xf) == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar12 < 0) goto LAB_14076b260;
      while (uVar5 == 0) {
