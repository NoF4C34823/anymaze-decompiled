...
ulonglong FUN_140a00200(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    uVar6 = (*(code *)(&PTR_LAB_14308e8e0)[param_6])
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return uVar6;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_140a0030f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x000140a0051b;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_140a0030f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x000140a0051b:
      if (uVar2 == 0) {
        auVar11 = vxorps_avx512vl(in_ZMM16._0_16_,in_ZMM16._0_16_);
        auVar11 = vcvtsi2ss_avx512f(auVar11,(int)*param_8);
        lVar7 = *param_5 * 3;
        auVar18._0_4_ = (float)(int)param_8[1];
        auVar18._4_8_ = SUB128(ZEXT812(0),4);
        auVar18._12_4_ = 0;
        auVar17._0_4_ = (float)(int)param_8[2];
        ...
        if ((longlong)uVar6 < 0x10) {
          ...
          auVar15 = vmovdqu32_avx512f(_DAT_14308e740);
          lVar7 = 0;
          do {
        ...
        uVar3 = vpcmpgtq_avx512f(auVar12,_DAT_14308e640);
        uVar4 = vpcmpgtq_avx512f(auVar12,_DAT_14308e680);
        auVar12 = vmovdqu32_avx512f(_DAT_14308e740);
...
LAB_140a0030f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  uVar6 = FUN_140a10b40(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9
                        ,param_10,param_11);
  return uVar6;
}
