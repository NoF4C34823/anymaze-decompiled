...
ulonglong FUN_14059ec20(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
  ...
  if (0 < param_6) {
    ...
    do {
      ...
      if (uVar5 != 0) {
        ...
        FUN_14059ef80(param_1,param_2,param_3,uVar5);
      ...
      if (uVar5 != 0) {
        ...
        auVar18 = vminps_avx512f(*pauVar3,*pauVar11);
        pauVar4 = (undefined1 (*) [64])(*pauVar3 + param_2 * 8);
        auVar19 = vminps_avx512f(auVar18,*pauVar4);
        lVar6 = 0;
        auVar18 = auVar19;
        if (1 < (longlong)uVar5) {
          do {
            lVar6 = lVar6 + 1;
            auVar19 = vminps_avx512f(pauVar3[1],*(undefined1 (*) [64])(pauVar3[1] + param_2 * 4));
            auVar19 = vminps_avx512f(auVar19,*(undefined1 (*) [64])(pauVar3[1] + param_2 * 8));
            pauVar3 = pauVar3 + 1;
            auVar20 = valignd_avx512f(auVar19,auVar18,3);
            auVar21 = valignd_avx512f(auVar19,auVar18,6);
            auVar18 = vminps_avx512f(auVar20,auVar18);
            auVar18 = vminps_avx512f(auVar21,auVar18);
            *pauVar9 = auVar18;
            pauVar9 = pauVar9 + 1;
            auVar18 = auVar19;
        ...
        pauVar1 = pauVar3 + 1;
        pauVar3 = pauVar3 + 1;
        auVar18 = vminps_avx512f(ZEXT2464(SUB3224(*(undefined1 (*) [32])*pauVar1,0)),
                                 ZEXT2464(SUB3224(*(undefined1 (*) [32])pauVar11[1],0)));
        auVar18 = vminps_avx512f(auVar18,ZEXT2464(SUB3224(*(undefined1 (*) [32])pauVar4[1],0)));
        auVar20 = valignd_avx512f(auVar18,auVar19,3);
        auVar18 = valignd_avx512f(auVar18,auVar19,6);
        auVar19 = vminps_avx512f(auVar20,auVar19);
        auVar18 = vminps_avx512f(auVar18,auVar19);
        *pauVar9 = auVar18;
        pauVar9 = pauVar9 + 1;
      }
      ...
      if (lVar6 != 0) {
        ...
        auVar15 = vminps_avx(*(undefined1 (*) [32])*pauVar3,*pauVar7);
        pauVar12 = (undefined1 (*) [32])(*pauVar3 + param_2 * 8);
        auVar15 = vminps_avx(auVar15,*pauVar12);
        uVar5 = 0;
        auVar17 = auVar15;
        if (1 < lVar6) {
          do {
            uVar5 = uVar5 + 1;
            auVar15 = vminps_avx(*(undefined1 (*) [32])(*pauVar3 + 0x20),
                                 *(undefined1 (*) [32])(*pauVar3 + param_2 * 4 + 0x20));
            auVar15 = vminps_avx512vl(auVar15,*(undefined1 (*) [32])(*pauVar3 + param_2 * 8 + 0x20))
            ;
            puVar2 = *pauVar3 + 0x20;
            ...
            auVar17 = vminps_avx512vl(auVar16,auVar17);
        ...
        auVar17 = vminps_avx512vl(auVar17,auVar16);
        ...
        uVar5 = uVar5 | 0x62;
        param_4 = (ulonglong)(uint)((int)param_4 + Rsrc_FILE_ENGLANG_809._85978215_4_);
        auVar15 = vminps_avx512vl(auVar17,auVar15);
        auVar15 = vminps_avx512vl(in_YMM27,auVar15);
        *(undefined1 (*) [32])*pauVar9 = auVar15;
        pauVar9 = (undefined1 (*) [64])(*pauVar9 + 0x20);
      }
      if ((uVar10 & 7) != 0) {
        uVar5 = FUN_14059ef80(pauVar3,param_2,pauVar9);
      }
      uVar8 = uVar8 + 1;
