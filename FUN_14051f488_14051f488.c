...
void FUN_14051f488(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < iStack00000000000000e4) {
    do {
      ...
      FUN_140d280c0(in_stack_00000100,param_1,lVar3,(longlong)iStack00000000000000e0,lVar1);
