...
void FUN_1406d0a60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1406d0b41:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar17) && (param_7 != 0xf0)) {
      if (uVar19 == 6) {
        if (uVar13 == 0) goto LAB_1406d0c98;
      }
      else {
        if (uVar19 != 1) goto LAB_1406d0b7c;
        if (uVar13 == 0) {
          uVar10 = param_5[1] - 1;
        }
      }
...
LAB_1406d0bfb:
    do {
      FUN_1406d1700(param_1,param_2,uVar10);
      while( true ) {
        while( true ) {
          iVar16 = (int)uVar17;
          uVar17 = uVar17 + 1;
          ...
          if (uVar21 <= uVar17) {
            if (uVar7 != 0) {
              ...
              lVar18 = -uVar21;
              do {
                FUN_1406d1700(param_1,param_2,lVar18,param_3);
                lVar12 = lVar12 + 1;
                lVar18 = lVar18 + 1;
            ...
            if (uVar19 != 1) goto LAB_1406d0f39;
            uVar10 = 0;
            uVar17 = *param_5;
            goto LAB_1406d12c0;
          }
...
LAB_1406d0e81:
          (*(code *)(&PTR_FUN_14308bba0)[param_6])
                    (param_2 * uVar17 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar17) goto LAB_1406d0b41;
        uVar10 = uVar17;
        if (param_7 == 0xf0) goto LAB_1406d0bfb;
        if (uVar19 != 6) break;
        if (uVar7 != 0) goto LAB_1406d0bfb;
LAB_1406d0c98:
        uVar10 = *param_5;
        uVar4 = *param_8;
...
LAB_1406d1644:
            ...
            uVar11 = uVar8 & 0xf;
            if (uVar11 != 0) {
              if ((uVar8 & 3) != 0) goto LAB_1406d1644;
              uVar11 = 0x10 - uVar11 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar11 + 8)) goto LAB_1406d1644;
            uVar9 = 0;
...
LAB_1406d0f39:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308bba0)[param_6])(param_1 + param_2 * lVar12,param_3,*param_5,param_9);
  }
  else {
    if (((lVar12 < 0) || ((longlong)param_5[1] <= lVar12)) && (param_7 != 0xf0)) {
      if ((longlong)param_5[1] < 2) {
        ...
        if (lVar12 < 0) goto LAB_1406d1240;
...
LAB_1406d1240:
    ...
    FUN_1406d1700(param_1,param_2,lVar12,param_3);
  }
  lVar12 = 1;
  uVar17 = 0;
  if (iVar20 < 2) {
...
LAB_1406d1206:
        ...
        uVar10 = uVar11 & 0xf;
        if (uVar10 != 0) {
          if ((uVar11 & 3) != 0) goto LAB_1406d1206;
          uVar10 = 0x10 - uVar10 >> 2;
        }
        if ((longlong)uVar21 < (longlong)(uVar10 + 4)) goto LAB_1406d1206;
...
LAB_1406d156f:
      ...
      uVar11 = uVar8 & 0xf;
      if (uVar11 != 0) {
        if ((uVar8 & 3) != 0) goto LAB_1406d156f;
        uVar11 = 0x10 - uVar11 >> 2;
      }
      if ((longlong)uVar17 < (longlong)(uVar11 + 8)) goto LAB_1406d156f;
      uVar9 = 0;
...
LAB_1406d1413:
      ...
      uVar11 = uVar8 & 0xf;
      if (uVar11 != 0) {
        if ((uVar8 & 3) != 0) goto LAB_1406d1413;
        uVar11 = 0x10 - uVar11 >> 2;
      }
      if ((longlong)uVar17 < (longlong)(uVar11 + 4)) goto LAB_1406d1413;
      uVar9 = 0;
...
LAB_1406d0b7c:
  ...
  if (uVar19 == 3) {
    if ((longlong)param_5[1] < 2) {
      ...
      if ((longlong)uVar17 < 0) goto LAB_1406d0e20;
      while (uVar13 == 0) {
