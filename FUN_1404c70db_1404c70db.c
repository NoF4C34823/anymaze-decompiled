...
void FUN_1404c70db(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
                  longlong param_4)

{
  ...
  do {
    ...
    if (lVar10 != 0) {
      ...
      auVar13 = vmaxps_avx(*pauVar5,*pauVar7);
      ...
      if (1 < lVar10) {
        do {
          ...
          auVar13 = vmaxps_avx(pauVar5[1],auVar13);
          ...
          auVar12 = vmaxps_avx(auVar3,auVar12);
      ...
      pauVar1 = pauVar5 + 1;
      pauVar5 = pauVar5 + 1;
      auVar12 = vmaxps_avx(ZEXT832(*(ulonglong *)*pauVar1),ZEXT832(*(ulonglong *)pauVar7[1]));
      auVar12 = vmaxps_avx(auVar12,ZEXT832(*(ulonglong *)pauVar11[2]));
