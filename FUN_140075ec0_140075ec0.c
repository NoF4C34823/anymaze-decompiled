...
void FUN_140075ec0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (**(code **)(&UNK_143086980 + lVar9 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar13 < 2) {
                ...
                if (lVar17 < 0) goto LAB_140077280;
                while (uVar10 == 0) {
                  for (lVar22 = (lVar13 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_140077280:
                    if ((uint)uStack_148 != 0) goto LAB_14007712e;
                  }
...
LAB_14007712e:
    ...
    iStack_158 = param_10;
    (**(code **)(&UNK_143086980 + lVar9 * 8))(param_11 + lVar27 * 6,param_4,lVar13,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar17 = uVar15 * 3;
...
LAB_14007720f:
              ...
              if (uVar18 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_14007720f;
                uVar18 = 0x10 - uVar18 >> 1;
              }
              if ((longlong)uVar8 < (longlong)(uVar18 + 8)) goto LAB_14007720f;
...
LAB_14007691b:
      uStack_140 = uVar8;
      lStack_108 = lVar27 * 2;
      pcStack_138 = *(code **)(&UNK_143086980 + lVar9 * 8);
      uStack_128 = CONCAT44(uStack_128._4_4_,param_7);
      iStack_158 = param_10;
      lStack_110 = param_1;
