...
void FUN_140750a20(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1407512ec:
      uVar11 = 0;
      if (param_3 == 0) goto LAB_140750c45;
      uVar13 = 0;
      uVar6 = param_3;
    }
    else {
      uVar6 = param_2 & 0xf;
      if (uVar6 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1407512ec;
        uVar6 = 0x10 - uVar6 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_1407512ec;
      ...
      if (param_3 < uVar11 + 1) goto LAB_140750c45;
...
LAB_1407512c6:
          uVar11 = 0;
          if (param_3 == 0) goto LAB_14075110d;
          uVar13 = 0;
          uVar6 = param_3;
        }
        else {
          uVar6 = param_2 & 0xf;
          if (uVar6 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1407512c6;
            uVar6 = 0x10 - uVar6 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_1407512c6;
          uVar13 = 0;
          ...
          if (param_3 < uVar11 + 1) goto LAB_14075110d;
          uVar6 = param_3 - uVar11;
          if ((longlong)uVar6 < 4) {
            uVar13 = 0;
          }
...
LAB_1407512b3:
    ...
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407512b3;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar6 + 8)) goto LAB_1407512b3;
    uVar13 = 0;
    uVar11 = param_3 - (param_3 - uVar6 & 7);
    if (uVar6 != 0) {
      do {
