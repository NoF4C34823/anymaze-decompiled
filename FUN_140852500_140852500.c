...
void FUN_140852500(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar32) {
    uVar30 = param_2 & 0x1f;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408526f4;
...
LAB_1408526fd:
  FUN_1408526b3(fVar6,fVar5,param_3,0);
  return;
}
