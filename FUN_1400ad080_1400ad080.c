...
void FUN_1400ad080(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)
...
LAB_1400ad5cf:
    ...
    uVar18 = param_2 & 0x1f;
    if (uVar18 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400ad5cf;
      uVar18 = 0x20 - uVar18 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar18 + 0x10)) goto LAB_1400ad5cf;
    uVar16 = 0;
