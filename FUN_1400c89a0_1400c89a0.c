...
void FUN_1400c89a0(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  if (iVar34 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcVar7 = *(code **)(&UNK_143086b60 + (longlong)param_6 * 8);
      lVar12 = lVar37 * 3;
      uVar16 = param_7 & 0xf;
            ...
            if (lVar19 < (longlong)(uVar49 + lVar35)) {
              ...
              do {
                ...
                if (lVar43 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar16 == 6) {
                      if (uVar23 == 0) goto LAB_1400ca3d5;
                    }
                    else {
                      if (uVar16 != 1) goto LAB_1400ca34c;
LAB_1400ca4be:
                      lVar30 = 0;
                      if (uVar23 != 0) {
                        lVar30 = lVar43;
...
LAB_1400ca3bc:
                  ...
                  if ((lVar43 < lVar35) || (param_7 == 0xf0)) goto LAB_1400ca3bc;
                  if (uVar16 != 6) {
                    if (uVar16 == 1) {
                      if (lVar43 < 0) goto LAB_1400ca4be;
                      if (uVar17 == 0) {
                        lVar30 = lVar35 + -1;
                      }
                    }
...
LAB_1400ca34c:
                      if (uVar16 == 3) {
                        if (lVar35 < 2) {
                          ...
                          if (lVar43 < 0) goto LAB_1400ca4e0;
                          if (lVar35 <= lVar43) {
                            while (uVar17 == 0) {
                              for (lVar30 = (lVar35 + -1) * 2 - lVar30; lVar30 < 0; lVar30 = -lVar30
                                  ) {
LAB_1400ca4e0:
                                if (uVar23 != 0) goto LAB_1400ca3bc;
                              }
                  ...
                  if (uVar17 != 0) goto LAB_1400ca3bc;
LAB_1400ca3d5:
                  bVar22 = *pbVar46;
                  bVar31 = pbVar46[1];
                  bVar39 = pbVar46[2];
...
LAB_1400ca479:
                      ...
                      if ((longlong)uVar1 < (longlong)(uVar21 + 0x10)) goto LAB_1400ca479;
                ...
                if (0 < lVar14) {
                  if ((longlong)uVar13 < 7) {
                    ...
                    if ((longlong)uVar13 < 0x10) {
                      ...
                      auVar55 = vpshufb_avx(auVar55,_DAT_143086c60);
                      auVar56 = vpshufb_avx(auVar51,_DAT_143086c70);
                      auVar52 = vpshufb_avx(auVar11,_DAT_143086c80);
                      auVar10 = vpshufb_avx(auVar51,_DAT_143086c90);
                      auVar51 = vpshufb_avx(auVar51,_DAT_143086cc0);
                      auVar8 = vpunpckhbw_avx(auVar11,auVar9);
                      auVar55 = vpor_avx(auVar55,auVar56);
                      auVar11 = vpshufb_avx(auVar9,_DAT_143086ca0);
                      auVar8 = vpshufb_avx(auVar8,_DAT_143086cb0);
...
LAB_1400c8e24:
            ...
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_1400c8e24;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_1400c8e24;
            uVar40 = 0;
...
LAB_1400c8cc5:
            ...
            uVar44 = (ulonglong)puVar32 & 0x1f;
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_1400c8cc5;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_1400c8cc5;
