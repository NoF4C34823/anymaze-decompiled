...
/* WARNING: Removing unreachable block (ram,0x00014084ced1) */

void FUN_14084bda0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c8e0)[lStack_e0])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar25 != 6) {
            if (uVar25 == 1) {
              ...
              if (lVar17 < 2) {
                ...
                if (lVar18 < 0) goto LAB_14084d420;
                while (uVar9 == 0) {
                  for (lVar13 = (lVar17 + -1) * 2 - lVar13; lVar13 < 0; lVar13 = -lVar13) {
LAB_14084d420:
                    if (uVar21 != 0) goto LAB_14084d2cf;
                  }
...
LAB_14084d2cf:
    ...
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c8e0)[lStack_e0])(param_11 + lVar28 * 6,param_4,lVar17,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar22 = lVar18 * 3;
...
LAB_14084d3a2:
              ...
              if (uVar12 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_14084d3a2;
                uVar12 = 0x10 - uVar12 >> 1;
              }
              if ((longlong)uVar14 < (longlong)(uVar12 + 8)) goto LAB_14084d3a2;
              uVar20 = 0;
...
LAB_14084c901:
      pcStack_148 = (code *)(&PTR_FUN_14308c8e0)[lStack_e0];
      iStack_158 = param_10;
      uStack_110 = param_7;
      lStack_108 = param_1;
