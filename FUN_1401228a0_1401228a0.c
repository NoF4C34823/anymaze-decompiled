...
void FUN_1401228a0(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (**(code **)(&UNK_143087280 + lVar6 * 8))(psVar28,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar17 == 6) {
    sVar27 = *param_8;
          ...
          if (uVar17 != 6) {
            if (uVar17 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar13 < 0) goto LAB_140123da0;
                while (uVar16 == 0) {
                  for (lVar8 = (lVar20 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_140123da0:
                    if (uVar25 != 0) goto LAB_140123c63;
                  }
...
LAB_140123c63:
    ...
    (**(code **)(&UNK_143087280 + lVar6 * 8))(param_11 + uVar14 * 2,param_4,lVar20,param_9,param_10)
    ;
    return;
  }
  if ((param_7 & 0x40) == 0) {
        ...
        if (6 < (longlong)uVar18) {
          ...
          if ((lVar10 <= (longlong)(uVar7 - (longlong)psVar28)) ||
            ...
            if ((longlong)uVar18 < 0x20) {
              ...
              if ((longlong)uVar18 < 0x76) {
                ...
                if (uVar24 != 0) {
                  ...
                  if (uVar18 == uVar24) goto LAB_140122de3;
                }
              }
            ...
            if (uVar26 + 1 <= uVar18) {
              ...
              auVar38 = vmovdqu32_avx512f(_DAT_143087000);
              auVar39 = vmovdqu32_avx512f(_DAT_143087040);
              lVar10 = 0;
              do {
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar24 != 0) {
                ...
                if (uVar14 == uVar24) goto LAB_140123180;
              }
            }
            if ((longlong)(uVar24 + 0x20) <= (longlong)uVar26) {
...
LAB_140123180:
      (**(code **)(&UNK_143087280 + lVar6 * 8))(uVar7,param_4,uVar14,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (**(code **)(&UNK_143087280 + lVar6 * 8))(psVar28,param_4,lVar20,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar18 < 0x20) {
          ...
          if ((longlong)uVar18 < 0x76) {
            ...
            if (uVar26 != 0) {
              ...
              if (uVar18 == uVar26) goto LAB_1401236a4;
            }
          }
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar7 != 0) {
                ...
                if (uVar14 == uVar7) goto LAB_140123b03;
              }
            }
...
LAB_140123b03:
  (**(code **)(&UNK_143087280 + lVar6 * 8))(param_11 + uVar14 * 2,param_4,uVar14,param_9,param_10);
  return;
}
