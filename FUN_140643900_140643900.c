...
longlong FUN_140643900(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    lVar3 = (**(code **)(&DAT_14308b640 + (longlong)param_6 * 8))
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return lVar3;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1406439f0;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x000140643bb6;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_1406439f0;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x000140643bb6:
      if (uVar2 == 0) {
        lVar3 = *param_5;
        fVar8 = (float)(int)param_8[2];
        fVar10 = (float)(int)*param_8;
        fVar9 = (float)(int)param_8[1];
        if (0 < lVar3 * 3) {
          uVar5 = lVar3 * 3 + 2;
          lVar4 = 1;
          lVar3 = 0;
...
LAB_1406439f0:
  lStack_28 = *param_5;
  lStack_20 = param_5[1];
  lVar3 = FUN_14064fdc0(param_1,param_2,param_3,param_4,&lStack_28,param_6,param_7,param_8,param_9,
                        param_10,param_11);
  return lVar3;
}
