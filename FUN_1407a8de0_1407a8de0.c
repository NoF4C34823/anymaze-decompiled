...
longlong FUN_1407a8de0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    lVar3 = (*(code *)(&PTR_FUN_14308c320)[param_6])
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return lVar3;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1407a8ed0;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x0001407a9096;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_1407a8ed0;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x0001407a9096:
      if (uVar2 == 0) {
        lVar3 = *param_5;
...
LAB_1407a8ed0:
  ...
  lVar3 = FUN_1407b5500(uStack_28,param_2,param_3,param_4,&uStack_28,param_6,param_7,param_8,param_9
                        ,param_10,param_11);
  return lVar3;
}
