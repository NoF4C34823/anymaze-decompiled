...
void FUN_1406c5700(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1406c5f2f:
      ...
      uVar38 = uVar39 & 0xf;
      if (uVar38 != 0) {
        if ((uVar39 & 3) != 0) goto LAB_1406c5f2f;
        uVar38 = 0x10 - uVar38 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar38 + 8)) goto LAB_1406c5f2f;
...
LAB_1406c5b84:
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar30 = param_4 & 0xf;
      if (uVar30 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406c5f3e;
...
LAB_1406c5edc:
  ...
  if (7 < (longlong)param_5) {
    uVar30 = param_4 & 0xf;
    if (uVar30 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406c5f37;
      uVar30 = 0x10 - uVar30 >> 2;
    }
