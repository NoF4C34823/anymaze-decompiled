...
void FUN_140a0e6a0(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308e8c0)[lVar6])(psVar28,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar17 == 6) {
    sVar27 = *param_8;
          ...
          if (uVar17 != 6) {
            if (uVar17 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar13 < 0) goto LAB_140a0fba0;
                while (uVar16 == 0) {
                  for (lVar8 = (lVar20 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_140a0fba0:
                    if (uVar25 != 0) goto LAB_140a0fa63;
                  }
...
LAB_140a0fa63:
    ...
    (*(code *)(&PTR_LAB_14308e8c0)[lVar6])(param_11 + uVar14 * 2,param_4,lVar20,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
            ...
            if ((longlong)uVar18 < 0x20) {
              ...
              if ((longlong)uVar18 < 0x76) {
                ...
                if (uVar24 != 0) {
                  ...
                  if (uVar18 == uVar24) goto LAB_140a0ebe3;
                }
              }
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar24 != 0) {
                ...
                if (uVar14 == uVar24) goto LAB_140a0ef80;
              }
            }
            if ((longlong)(uVar24 + 0x20) <= (longlong)uVar26) {
...
LAB_140a0ef80:
      (*(code *)(&PTR_LAB_14308e8c0)[lVar6])(uVar7,param_4,uVar14,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_LAB_14308e8c0)[lVar6])(psVar28,param_4,lVar20,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar18 < 0x20) {
          ...
          if ((longlong)uVar18 < 0x76) {
            ...
            if (uVar26 != 0) {
              ...
              if (uVar18 == uVar26) goto LAB_140a0f4a4;
            }
          }
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar7 != 0) {
                ...
                if (uVar14 == uVar7) goto LAB_140a0f903;
              }
            }
...
LAB_140a0f903:
  (*(code *)(&PTR_LAB_14308e8c0)[lVar6])(param_11 + uVar14 * 2,param_4,uVar14,param_9,param_10);
  return;
}
