...
void FUN_14072ff80(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar18 = param_4 & 0xf;
      if (uVar18 != 0) {
        if ((param_4 & 3) != 0) goto LAB_140730407;
...
LAB_1407303f8:
    ...
    uVar18 = param_4 & 0xf;
    if (uVar18 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1407303f8;
      uVar18 = 0x10 - uVar18 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar18 + 8)) goto LAB_1407303f8;
