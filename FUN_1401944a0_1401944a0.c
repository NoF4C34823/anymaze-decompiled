...
void FUN_1401944a0(longlong param_1,float *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140194ff4:
      ...
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140194ff4;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)uVar8 < (longlong)(uVar35 + 8)) goto LAB_140194ff4;
...
LAB_140194fbe:
          ...
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140194fbe;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)uVar8 < (longlong)(uVar35 + 8)) goto LAB_140194fbe;
          lVar37 = lVar40 * 0xc;
          lVar38 = lVar33 * -0xc;
          uVar29 = uVar8 - (uVar8 - uVar35 & 7);
          ...
          if (uVar8 < uVar29 + 1) goto LAB_140194e0a;
          uVar36 = uVar8 - uVar29;
...
LAB_140194e0a:
  ...
  if (7 < (longlong)uVar8) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_140194fb2;
      uVar35 = 0x10 - uVar35 >> 2;
    }
