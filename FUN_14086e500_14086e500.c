...
void FUN_14086e500(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  if (iVar34 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcVar7 = (code *)(&PTR_FUN_14308ca40)[param_6];
      lVar12 = lVar37 * 3;
      uVar16 = param_7 & 0xf;
            ...
            if (lVar19 < (longlong)(uVar49 + lVar35)) {
              ...
              do {
                ...
                if (lVar43 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar16 == 6) {
                      if (uVar23 == 0) goto LAB_14086ff35;
                    }
                    else {
                      if (uVar16 != 1) goto LAB_14086feac;
LAB_14087001e:
                      lVar30 = 0;
                      if (uVar23 != 0) {
                        lVar30 = lVar43;
...
LAB_14086ff1c:
                  ...
                  if ((lVar43 < lVar35) || (param_7 == 0xf0)) goto LAB_14086ff1c;
                  if (uVar16 != 6) {
                    if (uVar16 == 1) {
                      if (lVar43 < 0) goto LAB_14087001e;
                      if (uVar17 == 0) {
                        lVar30 = lVar35 + -1;
                      }
                    }
...
LAB_14086feac:
                      if (uVar16 == 3) {
                        if (lVar35 < 2) {
                          ...
                          if (lVar43 < 0) goto LAB_140870040;
                          if (lVar35 <= lVar43) {
                            while (uVar17 == 0) {
                              for (lVar30 = (lVar35 + -1) * 2 - lVar30; lVar30 < 0; lVar30 = -lVar30
                                  ) {
LAB_140870040:
                                if (uVar23 != 0) goto LAB_14086ff1c;
                              }
                  ...
                  if (uVar17 != 0) goto LAB_14086ff1c;
LAB_14086ff35:
                  bVar22 = *pbVar46;
                  bVar31 = pbVar46[1];
                  bVar39 = pbVar46[2];
...
LAB_14086ffd9:
                      ...
                      if ((longlong)uVar1 < (longlong)(uVar21 + 0x10)) goto LAB_14086ffd9;
                ...
                if (0 < lVar14) {
                  if ((longlong)uVar13 < 7) {
                    ...
                    if ((longlong)uVar13 < 0x10) {
                      ...
                      auVar55 = vpshufb_avx(auVar55,_DAT_14308cb40);
                      auVar56 = vpshufb_avx(auVar51,_DAT_14308cb50);
                      auVar52 = vpshufb_avx(auVar11,_DAT_14308cb60);
                      auVar10 = vpshufb_avx(auVar51,_DAT_14308cb70);
                      auVar51 = vpshufb_avx(auVar51,_DAT_14308cba0);
                      auVar8 = vpunpckhbw_avx(auVar11,auVar9);
                      auVar55 = vpor_avx(auVar55,auVar56);
                      auVar11 = vpshufb_avx(auVar9,_DAT_14308cb80);
                      auVar8 = vpshufb_avx(auVar8,_DAT_14308cb90);
...
LAB_14086e984:
            ...
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_14086e984;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_14086e984;
            uVar40 = 0;
...
LAB_14086e825:
            ...
            uVar44 = (ulonglong)puVar32 & 0x1f;
            if (uVar44 != 0) {
              if (((ulonglong)puVar32 & 3) != 0) goto LAB_14086e825;
              uVar44 = 0x20 - uVar44 >> 2;
            }
            if ((longlong)uVar1 < (longlong)(uVar44 + 8)) goto LAB_14086e825;
