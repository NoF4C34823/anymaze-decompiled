...
void FUN_1405f0720(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1405f1092:
      uVar37 = 0;
      if (uVar42 == 0) goto LAB_1405f0946;
      uVar39 = 0;
      uVar41 = uVar42;
    }
    else {
      uVar41 = param_2 & 0xf;
      if (uVar41 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1405f1092;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405f1092;
      ...
      if (uVar42 < uVar37 + 1) goto LAB_1405f0946;
...
LAB_1405f106c:
          uVar37 = 0;
          if (uVar42 == 0) goto LAB_1405f0eae;
          uVar39 = 0;
          uVar41 = uVar42;
        }
        else {
          uVar41 = param_2 & 0xf;
          if (uVar41 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1405f106c;
            uVar41 = 0x10 - uVar41 >> 2;
          }
          if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405f106c;
          uVar37 = uVar42 - (uVar42 - uVar41 & 7);
          ...
          if (uVar42 < uVar37 + 1) goto LAB_1405f0eae;
          uVar41 = uVar42 - uVar37;
          if ((longlong)uVar41 < 4) {
            uVar39 = 0;
          }
...
LAB_1405f1058:
    ...
    uVar41 = param_2 & 0xf;
    if (uVar41 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1405f1058;
      uVar41 = 0x10 - uVar41 >> 2;
    }
    if ((longlong)uVar42 < (longlong)(uVar41 + 8)) goto LAB_1405f1058;
    uVar39 = 0;
    uVar37 = uVar42 - (uVar42 - uVar41 & 7);
    if (uVar41 != 0) {
      do {
