...
void FUN_1409eaec0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4,int param_5)

{
  ...
  if (0 < (longlong)param_3) {
    ...
    if ((longlong)param_3 < 0x10) {
      ...
      if ((longlong)param_3 < 0x7b) {
        ...
        if (uVar19 != 0) {
          ...
          if (param_3 == uVar19) goto LAB_1409eb0aa;
        }
      }
    ...
    if (uVar26 + 1 <= param_3) {
      ...
      uVar16 = vpcmpgtq_avx512f(auVar43,_DAT_14308e640);
      bVar18 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar43,_DAT_14308e680);
      bVar17 = (byte)uVar16;
      uVar37 = CONCAT11(bVar17,bVar18);
          ...
          if ((longlong)param_3 < 0x10) {
            ...
            if ((longlong)param_3 < 0x4b) {
              ...
              if (uVar36 != 0) {
                ...
                if (param_3 == uVar36) goto LAB_1409eb3ca;
              }
            }
        ...
        if ((longlong)param_3 < 0x10) {
          ...
          if ((longlong)param_3 < 0x41) {
            ...
            if (uVar19 != 0) {
              ...
              if (param_3 == uVar19) goto LAB_1409eb5f1;
            }
          }
          if ((longlong)(uVar19 + 0x10) <= (longlong)uVar26) {
            auVar43 = vbroadcastss_avx512f(auVar62);
