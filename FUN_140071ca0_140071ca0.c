...
void FUN_140071ca0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_14007268a:
      ...
      uVar34 = uVar38 & 0xf;
      if (uVar34 != 0) {
        if ((uVar38 & 3) != 0) goto LAB_14007268a;
        uVar34 = 0x10 - uVar34 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar34 + 8)) goto LAB_14007268a;
...
LAB_140072124:
        ...
        uVar37 = uVar37 + 1;
        pfVar35 = pfVar35 + 1;
        if (iVar29 - 1U <= uVar37) goto LAB_1400721a3;
      }
      uVar37 = uVar37 + 1;
      pfVar35 = pfVar35 + 1;
...
LAB_140072678:
      ...
      uVar41 = uVar30 & 0xf;
      if (uVar41 != 0) {
        if ((uVar30 & 3) != 0) goto LAB_140072678;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar41 + 8)) goto LAB_140072678;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar41 = param_4 & 0xf;
      if (uVar41 != 0) {
        if ((param_4 & 1) != 0) goto LAB_140072686;
...
LAB_14007261d:
  ...
  if (7 < (longlong)param_5) {
    uVar41 = param_4 & 0xf;
    if (uVar41 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14007267f;
      uVar41 = 0x10 - uVar41 >> 1;
    }
    if ((longlong)(uVar41 + 8) <= (longlong)param_5) {
      lVar42 = lVar43 * param_2 + param_1;
