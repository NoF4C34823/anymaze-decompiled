...
void FUN_1408a5f40(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    if ((longlong)param_3 < 0x1d) {
      FUN_1408a6019(param_1,param_3 & 0xfffffffffffffff0,param_3,0);
      return;
    }
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408a62a5;
