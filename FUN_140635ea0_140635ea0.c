...
void FUN_140635ea0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1406367ae:
      uVar40 = 0;
      if (param_3 == 0) goto LAB_1406360a6;
      uVar38 = 0;
      uVar42 = param_3;
    }
    else {
      uVar42 = param_2 & 0xf;
      if (uVar42 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1406367ae;
        uVar42 = 0x10 - uVar42 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_1406367ae;
      ...
      if (param_3 < uVar40 + 1) goto LAB_1406360a6;
...
LAB_140636788:
          uVar40 = 0;
          if (param_3 == 0) goto LAB_1406365d1;
          uVar38 = 0;
          uVar42 = param_3;
        }
        else {
          uVar42 = param_2 & 0xf;
          if (uVar42 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140636788;
            uVar42 = 0x10 - uVar42 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_140636788;
          ...
          if (param_3 < uVar40 + 1) goto LAB_1406365d1;
          uVar42 = param_3 - uVar40;
          if ((longlong)uVar42 < 4) {
            uVar38 = 0;
          }
...
LAB_140636775:
    ...
    uVar42 = param_2 & 0xf;
    if (uVar42 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140636775;
      uVar42 = 0x10 - uVar42 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar42 + 8)) goto LAB_140636775;
    uVar38 = 0;
    uVar40 = param_3 - (param_3 - uVar42 & 7);
    if (uVar42 != 0) {
      do {
