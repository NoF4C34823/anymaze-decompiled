...
void FUN_14080a5e0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_14080a888:
    ...
    uVar22 = param_2 & 0x1f;
    if (uVar22 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14080a888;
      uVar22 = 0x20 - uVar22 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar22 + 0x10)) goto LAB_14080a888;
    uVar20 = 0;
    uVar21 = param_3 - (param_3 - uVar22 & 0xf);
    if (uVar22 != 0) {
      do {
        *(float *)(param_2 + uVar20 * 4) =
             fVar3 * (float)((int)*(short *)(param_1 + -2 + uVar20 * 2) +
                            (int)*(short *)(param_1 + 2 + uVar20 * 2)) +
  ...
  if (uVar22 < param_3) {
    ...
    do {
      *(float *)(param_2 + uVar21 * 4 + uVar22 * 4) =
           fVar3 * (float)((int)*(short *)(param_1 + -2 + uVar22 * 2) +
                          (int)*(short *)(param_1 + 2 + uVar22 * 2)) +
           fVar4 * (float)(int)*(short *)(param_1 + uVar22 * 2);
      uVar22 = uVar22 + 1;
