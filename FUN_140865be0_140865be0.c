...
/* WARNING: Removing unreachable block (ram,0x000140866d11) */

void FUN_140865be0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308ca80)[lStack_e0])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar25 != 6) {
            if (uVar25 == 1) {
              ...
              if (lVar17 < 2) {
                ...
                if (lVar18 < 0) goto LAB_140867260;
                while (uVar9 == 0) {
                  for (lVar13 = (lVar17 + -1) * 2 - lVar13; lVar13 < 0; lVar13 = -lVar13) {
LAB_140867260:
                    if (uVar21 != 0) goto LAB_14086710f;
                  }
...
LAB_14086710f:
    ...
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308ca80)[lStack_e0])(param_11 + lVar28 * 6,param_4,lVar17,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar22 = lVar18 * 3;
...
LAB_1408671e2:
              ...
              if (uVar12 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_1408671e2;
                uVar12 = 0x10 - uVar12 >> 1;
              }
              if ((longlong)uVar14 < (longlong)(uVar12 + 8)) goto LAB_1408671e2;
              uVar20 = 0;
...
LAB_140866741:
      pcStack_148 = (code *)(&PTR_FUN_14308ca80)[lStack_e0];
      iStack_158 = param_10;
      uStack_110 = param_7;
      lStack_108 = param_1;
