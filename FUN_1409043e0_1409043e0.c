...
void FUN_1409043e0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140904be1:
      ...
      if ((longlong)param_5 < 0x3fd) {
        ...
        uVar11 = uVar10 & 0x1f;
        if (uVar11 != 0) {
          if ((uVar10 & 3) != 0) goto LAB_140904be1;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 8)) goto LAB_140904be1;
        lStack_78 = param_2 * lVar12 + param_1;
        lStack_58 = param_2 * lVar15 + param_1;
        lStack_50 = param_2 * lVar21 + param_1;
        lStack_60 = param_2 * lVar16 + param_1;
...
LAB_140904c7b:
      ...
      if ((longlong)param_5 < 0x7b9) {
        ...
        uVar11 = param_4 & 0x1f;
        if (uVar11 != 0) {
          if ((param_4 & 1) != 0) goto LAB_140904c7b;
          uVar11 = 0x20 - uVar11 >> 1;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 0x10)) goto LAB_140904c7b;
        lVar12 = param_2 * 7 + param_1;
        uVar13 = 0;
  ...
  if (0xf < (longlong)param_5) {
    uVar10 = param_4 & 0x1f;
    if (uVar10 != 0) {
      if ((param_4 & 1) != 0) goto LAB_140904ca6;
