...
void FUN_14009d340(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_14009d411:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar16) && (param_7 != 0xf0)) {
      if (uVar18 == 6) {
        if (uStack_90 == 0) goto LAB_14009d54b;
      }
      else {
        if (uVar18 != 1) goto LAB_14009d44c;
        if (uStack_90 == 0) {
          uVar10 = param_5[1] - 1;
        }
      }
...
LAB_14009d4da:
    do {
      ...
      FUN_14009df40(lStack_50,lStack_58,uVar10,lVar17,in_stack_ffffffffffffff18,param_6,param_7,
          ...
          if (uStack_48 <= uVar16) {
            if (uStack_78 != 0) {
              ...
              do {
                uStack_a8 = *param_5;
                uStack_a0 = param_5[1];
                FUN_14009df40(lStack_50,lStack_58,lVar15,lVar6,&uStack_a8,param_6,param_7,param_8,
            ...
            param_3 = lStack_80;
            iVar19 = iStack_88;
            if (uVar18 != 1) goto LAB_14009d7f7;
            uVar16 = 0;
            uVar9 = *param_5;
            goto LAB_14009db40;
          }
...
LAB_14009d740:
          ...
          (**(code **)(&UNK_143086ae0 + (longlong)param_6 * 8))
        ...
        lVar15 = lStack_58;
        lVar5 = lStack_50;
        if (-1 < (longlong)uVar16) goto LAB_14009d411;
        uVar10 = uVar16;
        if (param_7 == 0xf0) goto LAB_14009d4da;
        if (uVar18 != 6) break;
        if (uStack_78 != 0) goto LAB_14009d4da;
LAB_14009d54b:
        uVar10 = *param_5;
        uVar20 = *param_8;
...
LAB_14009de80:
            ...
            uVar11 = uVar13 & 0xf;
            if (uVar11 != 0) {
              if ((uVar13 & 3) != 0) goto LAB_14009de80;
              uVar11 = 0x10 - uVar11 >> 2;
            }
            if ((longlong)uVar10 < (longlong)(uVar11 + 8)) goto LAB_14009de80;
            uVar8 = 0;
...
LAB_14009d7f7:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_a8 = *param_5;
    uStack_a0 = param_5[1];
    FUN_14009df40(param_1,param_2,lVar6,param_3,&uStack_a8,param_6,param_7,param_8,param_9,param_10,
                  param_11);
  }
  lVar6 = 1;
  uVar9 = 0;
...
LAB_14009da87:
        ...
        uVar10 = uVar12 & 0xf;
        if (uVar10 != 0) {
          if ((uVar12 & 3) != 0) goto LAB_14009da87;
          uVar10 = 0x10 - uVar10 >> 2;
        }
        if ((longlong)uVar16 < (longlong)(uVar10 + 4)) goto LAB_14009da87;
...
LAB_14009ddaf:
      ...
      uVar12 = uVar10 & 0xf;
      if (uVar12 != 0) {
        if ((uVar10 & 3) != 0) goto LAB_14009ddaf;
        uVar12 = 0x10 - uVar12 >> 2;
      }
      if ((longlong)uVar9 < (longlong)(uVar12 + 8)) goto LAB_14009ddaf;
      uVar13 = 0;
...
LAB_14009dc73:
      ...
      uVar10 = uVar11 & 0xf;
      if (uVar10 != 0) {
        if ((uVar11 & 3) != 0) goto LAB_14009dc73;
        uVar10 = 0x10 - uVar10 >> 2;
      }
      if ((longlong)uVar9 < (longlong)(uVar10 + 4)) goto LAB_14009dc73;
      uVar7 = 0;
...
LAB_14009d44c:
  ...
  if (uVar18 == 3) {
    ...
    if ((longlong)uVar11 < 2) {
      ...
      if ((longlong)uVar16 < 0) goto LAB_14009d6e0;
      while (uStack_90 == 0) {
