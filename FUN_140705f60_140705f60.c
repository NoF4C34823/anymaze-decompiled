...
void FUN_140705f60(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (3 < (longlong)param_3) {
    uVar31 = param_2 & 0xf;
    if (uVar31 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140706177;
      uVar31 = 0x10 - uVar31 >> 2;
    }
    if ((longlong)(uVar31 + 4) <= (longlong)param_3) {
      uVar29 = 0;
      uVar32 = param_3 - (param_3 - uVar31 & 3);
      if (uVar31 != 0) {
        do {
      ...
      puVar30 = (ulonglong *)(uVar31 * 2 + param_1);
      do {
        uVar29 = *(ulonglong *)((longlong)puVar30 + -4);
        uVar5 = *(ulonglong *)((longlong)puVar30 + 4);
        auVar9._8_4_ = 0;
        auVar9._0_8_ = uVar29;
        auVar9._12_2_ = (short)(uVar29 >> 0x30);
        auVar14._8_2_ = (short)(uVar29 >> 0x20);
        auVar14._0_8_ = uVar29;
        auVar14._10_4_ = auVar9._10_4_;
        auVar24._6_8_ = 0;
        auVar24._0_6_ = auVar14._8_6_;
        auVar19._4_2_ = (short)(uVar29 >> 0x10);
        auVar19._0_4_ = (uint)uVar29;
        ...
        uVar6 = *(ulonglong *)((longlong)puVar30 + 2);
        uVar7 = *(ulonglong *)((longlong)puVar30 + -2);
        auVar11._8_4_ = 0;
        auVar11._0_8_ = uVar7;
        auVar11._12_2_ = (short)(uVar7 >> 0x30);
        auVar16._8_2_ = (short)(uVar7 >> 0x20);
        auVar16._0_8_ = uVar7;
        auVar16._10_4_ = auVar11._10_4_;
        auVar26._6_8_ = 0;
        auVar26._0_6_ = auVar16._8_6_;
        auVar21._4_2_ = (short)(uVar7 >> 0x10);
        auVar21._0_4_ = (uint)uVar7;
        auVar21._6_8_ = SUB148(auVar26 << 0x40,6);
        auVar12._8_4_ = 0;
        auVar12._0_8_ = uVar6;
        auVar12._12_2_ = (short)(uVar6 >> 0x30);
        auVar17._8_2_ = (short)(uVar6 >> 0x20);
        auVar17._0_8_ = uVar6;
        auVar17._10_4_ = auVar12._10_4_;
        auVar27._6_8_ = 0;
        auVar27._0_6_ = auVar17._8_6_;
        auVar22._4_2_ = (short)(uVar6 >> 0x10);
        auVar22._0_4_ = (uint)uVar6;
        ...
        *pfVar1 = (float)(((uint)uVar29 & 0xffff) + ((uint)uVar5 & 0xffff)) * fVar2 +
                  (float)(((uint)uVar7 & 0xffff) + ((uint)uVar6 & 0xffff)) * fVar3 +
                  (float)((uint)uVar8 & 0xffff) * fVar4;
        pfVar1[1] = (float)(auVar19._4_4_ + auVar20._4_4_) * fVar2 +
                    (float)(auVar21._4_4_ + auVar22._4_4_) * fVar3 + (float)auVar23._4_4_ * fVar4;
        pfVar1[2] = (float)(auVar14._8_4_ + auVar15._8_4_) * fVar2 +
      ...
      for (; uVar32 < param_3; uVar32 = uVar32 + 1) {
        *(float *)(param_2 + uVar32 * 4) =
             (float)((uint)*(ushort *)(param_1 + -4 + uVar32 * 2) +
                    (uint)*(ushort *)(param_1 + 4 + uVar32 * 2)) * fVar2 +
             (float)((uint)*(ushort *)(param_1 + -2 + uVar32 * 2) +
                    (uint)*(ushort *)(param_1 + 2 + uVar32 * 2)) * fVar3 +
             (float)*(ushort *)(param_1 + uVar32 * 2) * fVar4;
      }
      return;
    }
  }
LAB_140706177:
  FUN_140706107(fVar4,0);
  return;
}
