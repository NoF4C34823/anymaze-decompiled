...
void FUN_140064733(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         ...
         unaff_XMM9_Da + (float)*(byte *)(in_RAX + param_4) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < param_1);
  puVar123 = (ulonglong *)(param_4 + param_1);
  do {
    uVar2 = *(ulonglong *)((longlong)puVar123 + -3);
    uVar3 = *(ulonglong *)((longlong)puVar123 + 3);
    auVar9._8_6_ = 0;
    auVar9._0_8_ = uVar2;
    ...
    uVar4 = *(ulonglong *)((longlong)puVar123 + -2);
    uVar5 = *(ulonglong *)((longlong)puVar123 + 2);
    auVar12._8_6_ = 0;
    auVar12._0_8_ = uVar4;
    ...
    uVar6 = *(ulonglong *)((longlong)puVar123 + -1);
    uVar7 = *(ulonglong *)((longlong)puVar123 + 1);
    auVar16._8_6_ = 0;
    auVar16._0_8_ = uVar6;
    ...
    *pfVar1 = (float)(ushort)(((ushort)uVar2 & 0xff) + ((ushort)uVar3 & 0xff)) * param_2 +
              ...
              (float)(ushort)(((ushort)uVar6 & 0xff) + ((ushort)uVar7 & 0xff)) * unaff_XMM9_Da +
  ...
  if (in_RDX < param_3) {
    do {
      *(float *)(in_R10 + in_RDX * 4) =
           ...
           * unaff_XMM9_Da + (float)*(byte *)(in_RDX + param_4) * in_XMM0_Da;
      in_RDX = in_RDX + 1;
