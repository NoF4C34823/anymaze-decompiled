...
void FUN_14067d237(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         ...
         (float)((int)*(short *)(param_4 + -6 + in_RAX * 2) +
                (int)*(short *)(param_4 + 6 + in_RAX * 2)) * unaff_XMM13_Da +
         (float)(int)*(short *)(param_4 + in_RAX * 2) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < param_1);
  puVar16 = (ulonglong *)(param_1 * 2 + param_4);
  do {
    uVar2 = *(ulonglong *)((longlong)puVar16 + -0x12);
    uVar3 = *(ulonglong *)((longlong)puVar16 + 0x12);
    ...
    uVar4 = *(ulonglong *)((longlong)puVar16 + 0xc);
    ...
    *pfVar1 = (float)((int)(short)uVar2 + (int)(short)uVar3) * param_2 +
              ...
              (float)((int)(short)uVar7 + (int)(short)uVar6) * unaff_XMM13_Da +
    ...
    pfVar1[1] = (float)((auVar9._0_4_ >> 0x10) + (auVar10._0_4_ >> 0x10)) * param_2 +
                ...
                (float)((auVar13._0_4_ >> 0x10) + (auVar14._0_4_ >> 0x10)) * unaff_XMM13_Da +
    ...
    pfVar1[2] = (float)((auVar30._8_4_ >> 0x10) + (auVar17._8_4_ >> 0x10)) * param_2 +
                ...
                (float)((auVar23._8_4_ >> 0x10) + (auVar36._8_4_ >> 0x10)) * unaff_XMM13_Da +
    ...
    pfVar1[3] = (float)((auVar31._12_4_ >> 0x10) + (auVar18._12_4_ >> 0x10)) * param_2 +
                ...
                (float)((auVar24._12_4_ >> 0x10) + (auVar37._12_4_ >> 0x10)) * unaff_XMM13_Da +
  ...
  if (in_RDX < param_3) {
    do {
      *(float *)(in_R10 + in_RDX * 4) =
           (float)((int)*(short *)(param_4 + -0x12 + in_RDX * 2) +
                  (int)*(short *)(param_4 + 0x12 + in_RDX * 2)) * param_2 +
           (float)((int)*(short *)(param_4 + -0xc + in_RDX * 2) +
                  (int)*(short *)(param_4 + 0xc + in_RDX * 2)) * in_XMM2_Da +
           (float)((int)*(short *)(param_4 + -6 + in_RDX * 2) +
                  (int)*(short *)(param_4 + 6 + in_RDX * 2)) * unaff_XMM13_Da +
