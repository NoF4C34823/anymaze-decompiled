...
void FUN_1405860c0(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
  ...
  if (0 < param_6 + -1) {
    ...
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        *(undefined8 *)(puVar12 + -8) = 0x140586154;
        param_6 = param_2;
        FUN_140586460(param_1,param_2,param_3,uVar16);
      ...
      if (lVar17 != 0) {
        lVar15 = 0;
        auVar23 = vpmaxub_avx512bw(*pauVar9,*(undefined1 (*) [64])(*pauVar9 + param_2));
        auVar23 = vpmaxub_avx512bw(auVar23,*(undefined1 (*) [64])(*pauVar9 + param_2 * 2));
        if (0 < lVar17) {
          do {
            lVar15 = lVar15 + 1;
            auVar24 = vpmaxub_avx512bw(pauVar9[1],*(undefined1 (*) [64])(pauVar9[1] + param_2));
            auVar24 = vpmaxub_avx512bw(auVar24,*(undefined1 (*) [64])(pauVar9[1] + param_2 * 2));
            pauVar9 = pauVar9 + 1;
            ...
            auVar23 = vpmaxub_avx512bw(auVar25,auVar23);
            auVar23 = vpmaxub_avx512bw(in_ZMM5,auVar23);
            *pauVar14 = auVar23;
            pauVar14 = pauVar14 + 1;
            auVar23 = auVar24;
          } while (lVar15 < lVar17);
      ...
      if (lVar17 != 0) {
        lVar15 = 0;
        auVar21 = vpmaxub_avx2(*(undefined1 (*) [32])*pauVar9,
                               *(undefined1 (*) [32])(*pauVar9 + param_2));
        auVar21 = vpmaxub_avx2(auVar21,*(undefined1 (*) [32])(*pauVar9 + param_2 * 2));
        if (0 < lVar17) {
          do {
            lVar15 = lVar15 + 1;
            auVar22 = vpmaxub_avx2(*(undefined1 (*) [32])(*pauVar9 + 0x20),
                                   *(undefined1 (*) [32])(*pauVar9 + param_2 + 0x20));
            auVar19 = vpmaxub_avx512vl(auVar22,*(undefined1 (*) [32])(*pauVar9 + param_2 * 2 + 0x20)
                                      );
            ...
            auVar21 = vpmaxub_avx2(auVar22,auVar21);
            auVar21 = vpmaxub_avx512vl(auVar20,auVar21);
      ...
      if ((uVar8 & 0x1f) != 0) {
        in_ZMM5 = ZEXT1664(in_ZMM5._0_16_);
        *(undefined8 *)(puVar12 + -8) = 0x14058627c;
        param_6 = param_2;
        FUN_140586460();
      }
      lVar11 = lVar11 + 1;
    ...
    *(longlong *)(puVar13 + 0x20) = param_2 * 2;
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        *(undefined8 *)(puVar13 + -8) = 0x140586314;
        FUN_140586460(param_1,param_2,param_3,uVar16);
        pauVar9 = (undefined1 (*) [64])(*param_1 + uVar16);
        uVar8 = param_5 - uVar16;
        pauVar14 = (undefined1 (*) [64])(*param_3 + uVar16);
      ...
      if (lVar17 != 0) {
        ...
        auVar21 = vpmaxub_avx2(*(undefined1 (*) [32])*pauVar9,*pauVar18);
        pauVar10 = (undefined1 (*) [32])(*pauVar9 + param_2 * 2);
        auVar21 = vpmaxub_avx2(auVar21,*pauVar10);
        lVar11 = 0;
        if (1 < lVar17) {
          ...
          do {
            ...
            auVar22 = vpmaxub_avx2(*(undefined1 (*) [32])(*pauVar9 + 0x20),
                                   *(undefined1 (*) [32])(*pauVar9 + param_2 + 0x20));
            auVar19 = vpmaxub_avx512vl(auVar22,*(undefined1 (*) [32])(*pauVar9 + lVar15 + 0x20));
            pauVar9 = (undefined1 (*) [64])(*pauVar9 + 0x20);
            auVar20 = vshufi32x4_avx512vl(auVar21,auVar19,1);
            auVar22 = vpalignr_avx2(auVar20,auVar21,3);
            auVar20 = vpalignr_avx2(auVar20,auVar21,6);
        ...
        auVar22 = vpmaxub_avx512vl(auVar22,auVar20);
      ...
      if ((uVar8 & 0x1f) != 0) {
        *(undefined8 *)(puVar13 + -8) = 0x14058643a;
        FUN_140586460(pauVar9,param_2);
      }
      lVar11 = lVar11 + 1;
      param_1 = (undefined1 (*) [64])(*param_1 + param_2);
