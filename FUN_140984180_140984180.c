...
void FUN_140984180(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308dea0)[lVar6])(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
          ...
          if (uVar13 != 6) {
            if (uVar13 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar20 < 0) goto LAB_140986049;
                while (uVar7 == 0) {
                  for (lVar14 = (lVar15 + -1) * 2 - lVar14; lVar14 < 0; lVar14 = -lVar14) {
LAB_140986049:
                    if ((uint)lStack_98 != 0) goto LAB_140985f31;
                  }
...
LAB_140985f31:
    ...
    (*(code *)(&PTR_LAB_14308dea0)[lVar6])(param_11 + lVar25 * 3,param_4,lVar15,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar20 = lVar22 * 3;
          ...
          if ((longlong)uVar17 < 0x40) {
            ...
            if ((longlong)uVar17 < 0x116) {
              ...
              if (uVar10 != 0) {
                ...
                if (uVar17 == uVar10) goto LAB_140984479;
              }
            }
...
LAB_140984479:
    ...
    pcStack_60 = (code *)(&PTR_LAB_14308dea0)[lVar6];
