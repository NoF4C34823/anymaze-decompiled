...
/* WARNING: Removing unreachable block (ram,0x0001401872a2) */

void FUN_140185e20(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  lStack_78 = param_2;
  if (iVar12 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1401875d9;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      lStack_138 = 0;
      uVar4 = param_7 & 0xf;
      pcStack_d0 = *(code **)(&DAT_143087d60 + (longlong)param_6 * 8);
            ...
            if (lStack_c0 < (longlong)(uVar15 + uVar11)) {
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar4 == 6) {
                      if (uStack_d8 == 0) goto LAB_14018754b;
                    }
                    else {
                      if (uVar4 != 1) goto LAB_1401874c3;
LAB_140187639:
                      lVar16 = 0;
                      if (uStack_d8 != 0) {
                        lVar16 = lVar10;
...
LAB_14018752c:
                  ...
                  if ((lVar10 < (longlong)uVar11) || (param_7 == 0xf0)) goto LAB_14018752c;
                  if (uVar4 != 6) {
                    if (uVar4 == 1) {
                      if (lVar10 < 0) goto LAB_140187639;
                      if (uStack_b8 == 0) {
                        lVar16 = uVar11 - 1;
                      }
                    }
...
LAB_140187660:
                  ...
                  if (uStack_b8 != 0) goto LAB_14018752c;
LAB_14018754b:
      ...
      do {
        if (0 < (longlong)uVar14) {
          ...
          if (3 < (longlong)uVar14) {
            ...
            uVar13 = uVar5 & 0xf;
            if (uVar13 != 0) {
              if ((uVar5 & 3) != 0) goto LAB_140186292;
        ...
        do {
          if (0 < (longlong)uVar14) {
            ...
            if (3 < (longlong)uVar14) {
              ...
              uVar5 = uVar13 & 0xf;
              if (uVar5 != 0) {
                if ((uVar13 & 3) != 0) goto LAB_140186131;
                uVar5 = 0x10 - uVar5 >> 2;
              }
