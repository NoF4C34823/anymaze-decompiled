...
void FUN_140249de0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_140249f54:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar47) && (param_7 != 0xf0)) {
      if (uStack_90 == 6) {
        if (uStack_b0 == 0) goto LAB_14024a0ac;
      }
      else {
        if (uStack_90 != 1) goto LAB_140249f9a;
        if (uStack_b0 == 0) {
          uVar51 = param_5[1] - 1;
        }
      }
...
LAB_14024a040:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_14024ad00(lStack_68,lStack_70,uVar51,param_3,in_stack_fffffffffffffe48,(int)lStack_48,
                  param_7,param_8,uStack_50,iStack_58,uStack_60);
LAB_14024a200:
    do {
      while( true ) {
        uVar19 = uStack_60;
        auVar56 = _DAT_143088b00;
        auVar58 = _DAT_143088900;
        uVar62 = (undefined4)((ulonglong)in_stack_fffffffffffffe48 >> 0x20);
        iVar46 = (int)uVar47;
        uVar47 = uVar47 + 1;
        ...
        if (uStack_40 <= uVar47) {
          ...
          if (uStack_a8 != 0) {
            ...
            do {
              ...
              FUN_14024ad00(lStack_68,lStack_70,lVar49,lVar42,&uStack_178,(int)lStack_48,param_7,
          ...
          uVar43 = uStack_90;
          if (uStack_90 != 1) goto LAB_14024a417;
          uVar50 = *param_5;
          uVar47 = 0;
          auVar56 = vmovdqu32_avx512f(_DAT_143088980);
          goto LAB_14024a7e0;
        }
...
LAB_14024a32f:
        ...
        (**(code **)(&UNK_143088c00 + lStack_48 * 8))
      ...
      if (-1 < (longlong)uVar47) goto LAB_140249f54;
      uVar51 = uVar47;
      if (param_7 == 0xf0) goto LAB_14024a040;
      if (uStack_90 != 6) {
        if (uStack_90 != 1) goto LAB_140249f9a;
        uVar51 = 0;
        if (uStack_a8 != 0) {
      ...
      if (uStack_a8 != 0) goto LAB_14024a040;
LAB_14024a0ac:
      auVar58 = _DAT_143088b00;
      uVar51 = *param_5;
      uVar43 = *param_8;
    ...
    if ((longlong)uVar51 < 0x10) {
      ...
      if ((longlong)uVar51 < 0x26) {
        ...
        if (uVar44 != 0) {
          auVar56 = vmovdqu32_avx512f(_DAT_143088940);
          uVar53 = 0;
          ...
          if (uVar51 == uVar44) goto LAB_14024a200;
        }
      }
...
LAB_14024a417:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_178 = *param_5;
    uStack_170 = param_5[1];
    FUN_14024ad00(lStack_68,lStack_70,lVar42,lStack_98,&uStack_178,(int)lStack_48,param_7,param_8,
  ...
  auVar56 = vmovdqu32_avx512f(_DAT_143088940);
  auVar57 = vmovdqu32_avx512f(_DAT_143088980);
  uVar47 = *param_5;
    ...
    if (0 < (longlong)uVar47) {
      if ((longlong)uVar47 < 0x10) {
        ...
        while (0x3a < (longlong)uVar47) {
          ...
          if (uVar52 == 0) goto LAB_14024a65c;
          uVar44 = 0;
          ...
          if (uVar47 != uVar52) goto LAB_14024a65c;
          lVar42 = uVar50 + 2;
          uVar50 = uVar50 + 1;
  ...
  if (0 < (longlong)uVar50) {
    if ((longlong)uVar50 < 0x10) {
      ...
      while (0x25 < (longlong)uVar50) {
        ...
        if (uVar51 == 0) goto LAB_14024aa65;
        uVar44 = 0;
        ...
        if (uVar50 != uVar51) goto LAB_14024aa65;
        uVar47 = uVar47 + 1;
        if (uStack_40 <= uVar47) {
          return;
        }
  ...
  if (0 < (longlong)uVar50) {
    if ((longlong)uVar50 < 0x10) {
      ...
      while (0x3a < (longlong)uVar50) {
        ...
        if (uVar52 == 0) goto LAB_14024a8bd;
        uVar54 = 0;
        auVar59 = vpbroadcastq_avx512f();
        auVar61 = auVar56;
        auVar60 = auVar57;
        ...
        if (uVar50 != uVar52) goto LAB_14024a8bd;
        uVar47 = uVar47 + 1;
        if (uStack_40 <= uVar47) {
          return;
        }
...
LAB_140249f9a:
  ...
  if (uStack_90 == 3) {
    ...
    if ((longlong)uVar52 < 2) {
      ...
      if ((longlong)uVar47 < 0) goto LAB_14024a2c0;
      while (uStack_b0 == 0) {
