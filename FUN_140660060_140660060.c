...
void FUN_140660060(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140660a8e:
      uVar35 = 0;
      if (param_5 == 0) goto LAB_1406602be;
      uVar44 = 0;
      uVar33 = param_5;
    }
    else {
      ...
      uVar33 = uVar44 & 0xf;
      if (uVar33 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_140660a8e;
        uVar33 = 0x10 - uVar33 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar33 + 8)) goto LAB_140660a8e;
      ...
      if (param_5 < uVar35 + 1) goto LAB_1406602be;
...
LAB_140660524:
        ...
        uVar34 = uVar34 + 1;
        pfVar37 = pfVar37 + 1;
        if (iVar38 - 1U <= uVar34) goto LAB_14066059b;
      }
      uVar34 = uVar34 + 1;
      pfVar37 = pfVar37 + 1;
...
LAB_140660a74:
      ...
      uVar40 = uVar43 & 0xf;
      if (uVar40 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_140660a74;
        uVar40 = 0x10 - uVar40 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar40 + 8)) goto LAB_140660a74;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar40 = uVar43 & 0xf;
      if (uVar40 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_140660a82;
        uVar40 = 0x10 - uVar40 >> 2;
      }
      if ((longlong)(uVar40 + 4) <= (longlong)param_5) {
        uVar44 = 0;
        uVar33 = param_5 - (param_5 - uVar40 & 3);
        uVar34 = _UNK_14308b84c;
        uVar28 = _UNK_14308b848;
        uVar29 = _UNK_14308b844;
        uVar30 = _DAT_14308b840;
        if (uVar40 != 0) {
          do {
...
LAB_140660a0e:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar40 = uVar43 & 0xf;
    if (uVar40 != 0) {
      if ((uVar43 & 3) != 0) goto LAB_140660a7b;
      uVar40 = 0x10 - uVar40 >> 2;
    }
