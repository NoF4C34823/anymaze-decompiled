...
void FUN_1407ffae0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140800b34. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(psVar23,param_4,*param_5);
    return;
  }
  if (uVar19 == 6) {
    uVar7 = (uint)*param_8;
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140800ac0;
                while (uVar13 == 0) {
                  for (lVar25 = (lVar16 + -1) * 2 - lVar25; lVar25 < 0; lVar25 = -lVar25) {
LAB_140800ac0:
                    if (uVar7 != 0) goto LAB_1408009c2;
                  }
...
LAB_1408009c2:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar24;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140800a22. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(param_11 + uVar11 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar11 == 1) {
...
LAB_140800a36:
              ...
              uVar6 = uVar18 & 0xf;
              if (uVar6 != 0) {
                if ((uVar18 & 1) != 0) goto LAB_140800a36;
                uVar6 = 0x10 - uVar6 >> 1;
              }
              if ((longlong)uVar20 < (longlong)(uVar6 + 8)) goto LAB_140800a36;
...
LAB_1407fff7d:
      if (uVar19 == 1) {
        if ((longlong)uVar11 < 1) goto LAB_14080018d;
...
LAB_140800a98:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140800a98;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_140800a98;
          uVar10 = 0;
...
LAB_140800a3d:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140800a3d;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_140800a3d;
          uVar10 = 0;
          uVar8 = uVar11 - (uVar11 - uVar6 & 7);
          if (uVar6 != 0) {
            do {
...
LAB_14080018d:
      (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(uVar18,param_4,uVar11,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140800a95. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(psVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar11 < lVar16) {
    lVar16 = lVar16 - uVar11;
    (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(psVar23,param_4,lVar16,param_9,param_10);
...
LAB_140800a45:
          ...
          uVar18 = param_11 & 0xf;
          if (uVar18 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140800a45;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar20 < (longlong)(uVar18 + 8)) goto LAB_140800a45;
...
LAB_1408005dc:
  if (uVar19 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_14080087a;
...
LAB_140800a53:
          ...
          uVar18 = uVar20 & 0xf;
          if (uVar18 != 0) {
            if ((uVar20 & 1) != 0) goto LAB_140800a53;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar18 + 8)) goto LAB_140800a53;
          uVar6 = 0;
  ...
  if ((uVar19 != 6) || ((longlong)uVar11 < 1)) goto LAB_14080087a;
  if ((longlong)uVar11 < 8) {
LAB_140800a4c:
    uVar18 = 0;
  }
    ...
    if (uVar20 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_140800a4c;
      uVar20 = 0x10 - uVar20 >> 1;
    }
    if ((longlong)uVar11 < (longlong)(uVar20 + 8)) goto LAB_140800a4c;
    uVar6 = 0;
...
LAB_14080087a:
                    /* WARNING: Could not recover jumptable at 0x0001408008b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c5c0)[lVar5])(param_11 + uVar11 * 2,param_4,uVar11);
  return;
}
