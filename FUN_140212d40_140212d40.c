...
void FUN_140212d40(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140213359:
      ...
      if ((longlong)param_5 < 0x1d) {
        ...
        uVar18 = uVar17 & 0x1f;
        if (uVar18 != 0) {
          if ((uVar17 & 3) != 0) goto LAB_140213359;
          uVar18 = 0x20 - uVar18 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar18 + 0x10)) goto LAB_140213359;
        lVar7 = param_2 * lVar11 + param_1;
        lVar16 = param_2 * lVar8 + param_1;
        lVar9 = param_2 * lVar10 + param_1;
...
LAB_140213395:
      ...
      if ((longlong)param_5 < 0x12c0) {
        ...
        if ((longlong)param_5 < (longlong)(uVar17 + 0x20)) goto LAB_140213395;
        lVar11 = param_2 * 3 + param_1;
        uVar18 = 0;
...
LAB_1402133b2:
    ...
    if ((longlong)param_5 < (longlong)(uVar17 + 0x20)) goto LAB_1402133b2;
    lVar11 = param_2 * 3 + param_1;
    uVar18 = 0;
    uVar14 = param_5 - (param_5 - uVar17 & 0x1f);
    if (uVar17 != 0) {
