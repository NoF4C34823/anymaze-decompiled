...
void FUN_140777780(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_140777999:
    ...
    uVar4 = param_2 & 0xf;
    if (uVar4 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140777999;
      uVar4 = 0x10 - uVar4 >> 2;
    }
    if ((longlong)uVar7 < (longlong)(uVar4 + 8)) goto LAB_140777999;
    uVar5 = 0;
