...
void FUN_140813e60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14081480d:
      uVar20 = 0;
      if (param_5 == 0) goto LAB_1408140be;
      uVar31 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar31 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_14081480d;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_14081480d;
      ...
      if (param_5 < uVar20 + 1) goto LAB_1408140be;
...
LAB_1408142e5:
        ...
        uVar16 = uVar16 + 1;
        pfVar24 = pfVar24 + 1;
        if (param_7 - 1U <= uVar16) goto LAB_14081435d;
      }
      uVar16 = uVar16 + 1;
      pfVar24 = pfVar24 + 1;
...
LAB_1408147e1:
      uVar31 = 0;
      if (param_5 == 0) goto LAB_140814558;
      uVar20 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar28 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1408147e1;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_1408147e1;
      ...
      if (param_5 < uVar31 + 1) goto LAB_140814558;
...
LAB_140814558:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar19 = uVar28 & 0xf;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1408147fe;
...
LAB_140814777:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar19 = uVar28 & 0xf;
    if (uVar19 != 0) {
      if ((uVar28 & 3) != 0) goto LAB_1408147f7;
      uVar19 = 0x10 - uVar19 >> 2;
    }
