...
undefined8
FUN_14057b740(undefined8 param_1,ulonglong param_2,int param_3,int param_4,int *param_5,int *param_6
             )

{
  ...
  if (param_6 != (int *)0x0) {
    ...
    iVar1 = FUN_140d087e0(param_1,param_2 | 0x100000001,param_3,param_4);
