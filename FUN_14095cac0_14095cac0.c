...
void FUN_14095cac0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308d980)[lVar10])(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar18 < 0) goto LAB_14095e324;
                while (uVar12 == 0) {
                  for (lVar20 = (lVar19 + -1) * 2 - lVar20; lVar20 < 0; lVar20 = -lVar20) {
LAB_14095e324:
                    if ((uint)uStack_a8 != 0) goto LAB_14095e1d1;
                  }
...
LAB_14095e1d1:
    ...
    (*(code *)(&PTR_FUN_14308d980)[lVar10])(param_11 + lVar29 * 3,param_4,lVar19,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar18 = lVar27 * 3;
...
LAB_14095e286:
            ...
            if ((longlong)uVar14 < 0xa91) {
              ...
              if ((longlong)uVar14 < (longlong)(uStack_a8 + 0x20)) goto LAB_14095e286;
...
LAB_14095cdd1:
    ...
    pcStack_68 = (code *)(&PTR_FUN_14308d980)[lVar10];
    ...
    if (0 < lVar10) {
      ...
      if ((longlong)uVar14 < 7) {
        ...
        if ((longlong)uVar14 < 0x20) {
          ...
          auVar46[0x1e] = uVar28;
          auVar46[0x1f] = uVar28;
          auVar5 = vpshufb_avx2(auVar41,_DAT_14308da60);
          uVar22 = 0;
          auVar41 = vpshufb_avx2(auVar41,_DAT_14308db20);
          auVar34 = vpshufb_avx2(auVar46,_DAT_14308da80);
          auVar37 = vpshufb_avx2(auVar46,_DAT_14308db40);
          ...
          auVar37[0x1f] = bVar4;
          uVar11 = uVar14 & 0xffffffffffffffe0;
          auVar46 = vpshufb_avx2(auVar37,_DAT_14308daa0);
          lVar19 = 0;
          auVar37 = vpshufb_avx2(auVar37,_DAT_14308db60);
          auVar37 = vpor_avx2(auVar41,auVar37);
          auVar41 = vpblendvb_avx2(auVar5,auVar34,_DAT_14308dac0);
          auVar5 = vpblendvb_avx2(auVar34,auVar5,_DAT_14308dac0);
          auVar41 = vpblendvb_avx2(auVar41,auVar46,_DAT_14308dae0);
          auVar5 = vpblendvb_avx2(auVar5,auVar46,_DAT_14308db00);
    ...
    if (6 < (longlong)uVar14) {
      ...
      if ((2 < lVar18) || ((longlong)(uVar14 * 3) <= -lVar18)) {
        ...
        if ((longlong)uVar14 < 0x20) {
          ...
          auVar38[0x1f] = uVar26;
          uVar22 = 0;
          auVar5 = vpshufb_avx2(auVar45,_DAT_14308da80);
          uVar11 = uVar14 & 0xffffffffffffffe0;
          auVar41 = vpshufb_avx2(auVar38,_DAT_14308db20);
          auVar37 = vpshufb_avx2(auVar45,_DAT_14308db40);
          auVar34 = vpshufb_avx2(auVar38,_DAT_14308da60);
          auVar41 = vpor_avx2(auVar41,auVar37);
          auVar40[1] = bVar4;
          auVar40[0] = bVar4;
          auVar40[2] = bVar4;
          ...
          auVar40[0x1f] = bVar4;
          lVar27 = 0;
          auVar46 = vpshufb_avx2(auVar40,_DAT_14308daa0);
          auVar37 = vpshufb_avx2(auVar40,_DAT_14308db60);
          auVar37 = vpor_avx2(auVar41,auVar37);
          auVar41 = vpblendvb_avx2(auVar34,auVar5,_DAT_14308dac0);
          auVar5 = vpblendvb_avx2(auVar5,auVar34,_DAT_14308dac0);
          auVar41 = vpblendvb_avx2(auVar41,auVar46,_DAT_14308dae0);
          auVar5 = vpblendvb_avx2(auVar5,auVar46,_DAT_14308db00);
