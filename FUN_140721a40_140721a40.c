...
void FUN_140721a40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < iVar18) {
    ...
    uVar16 = param_7 & 0x20;
    lVar15 = lVar10;
    if ((param_7 & 0xf0) == 0xf0) goto LAB_140721e61;
    uVar9 = 0;
LAB_140721b20:
    uVar12 = uVar9;
    if (((longlong)param_5[1] <= (longlong)uVar9) && (param_7 != 0xf0)) {
      if ((param_7 & 0xf) == 6) {
        if (uVar16 == 0) goto LAB_140721c77;
      }
      else {
        if ((param_7 & 0xf) != 1) goto LAB_140721b5a;
        if (uVar16 == 0) {
          uVar12 = param_5[1] - 1;
        }
      }
...
LAB_140721bdb:
    do {
      FUN_1407226c0(param_1,param_2,uVar12);
      while( true ) {
        while( true ) {
          iVar8 = (int)uVar9;
          uVar9 = uVar9 + 1;
          ...
          if (uVar19 <= uVar9) {
            if (uVar5 != 0) {
              ...
              lVar14 = -uVar19;
              do {
                FUN_1407226c0(param_1,param_2,lVar14,param_3);
                lVar11 = lVar11 + 1;
                lVar14 = lVar14 + 1;
...
LAB_140721e61:
          (*(code *)(&PTR_FUN_14308bde0)[param_6])
                    (param_2 * uVar9 + param_1,lVar15,*param_5,param_9);
        }
        if (-1 < (longlong)uVar9) goto LAB_140721b20;
        uVar12 = uVar9;
        if (param_7 == 0xf0) goto LAB_140721bdb;
        if ((param_7 & 0xf) != 6) break;
        if (uVar5 != 0) goto LAB_140721bdb;
LAB_140721c77:
        uVar12 = *param_5;
...
LAB_140722624:
            ...
            uVar6 = uVar7 & 0xf;
            if (uVar6 != 0) {
              if ((uVar7 & 3) != 0) goto LAB_140722624;
              uVar6 = 0x10 - uVar6 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar6 + 8)) goto LAB_140722624;
            uVar13 = 0;
...
LAB_140722550:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_140722550;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 8)) goto LAB_140722550;
            uVar17 = 0;
...
LAB_1407223f3:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1407223f3;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1407223f3;
            uVar17 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      (*(code *)(&PTR_FUN_14308bde0)[param_6])(param_1 + param_2 * lVar11,param_3,*param_5,param_9);
    }
    else {
      if (((lVar11 < 0) || ((longlong)param_5[1] <= lVar11)) && (param_7 != 0xf0)) {
        if ((longlong)param_5[1] < 2) {
          ...
          if (lVar11 < 0) goto LAB_140722220;
...
LAB_140722220:
      ...
      FUN_1407226c0(param_1,param_2,lVar11,param_3);
    }
    lVar11 = 1;
    uVar9 = 0;
    if (1 < iVar18) {
...
LAB_1407221e6:
            ...
            uVar12 = uVar6 & 0xf;
            if (uVar12 != 0) {
              if ((uVar6 & 3) != 0) goto LAB_1407221e6;
              uVar12 = 0x10 - uVar12 >> 2;
            }
            if ((longlong)uVar19 < (longlong)(uVar12 + 4)) goto LAB_1407221e6;
...
LAB_140721b5a:
  ...
  if ((param_7 & 0xf) == 3) {
    if ((longlong)param_5[1] < 2) {
      ...
      if ((longlong)uVar9 < 0) goto LAB_140721e00;
      while (uVar16 == 0) {
