...
void FUN_1400c35c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (**(code **)(&UNK_143086c00 + lVar8 * 8))(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar12 == 6) {
          ...
          if (uVar12 != 6) {
            if (uVar12 == 1) {
              ...
              if (lVar13 < 2) {
                ...
                if (lVar19 < 0) goto LAB_1400c44c0;
                while (uVar14 == 0) {
                  for (lVar9 = (lVar13 + -1) * 2 - lVar9; lVar9 < 0; lVar9 = -lVar9) {
LAB_1400c44c0:
                    if ((uint)pcStack_80 != 0) goto LAB_1400c432f;
                  }
...
LAB_1400c432f:
    ...
    (**(code **)(&UNK_143086c00 + lVar8 * 8))(param_11 + uVar16 * 4,param_4,lVar13,param_9,param_10)
    ;
    return;
  }
  if ((param_7 & 0x40) == 0) {
...
LAB_1400c43b1:
            ...
            uVar11 = uVar10 & 0x1f;
            if (uVar11 != 0) {
              if ((uVar10 & 3) != 0) goto LAB_1400c43b1;
              uVar11 = 0x20 - uVar11 >> 2;
            }
            if ((longlong)uVar15 < (longlong)(uVar11 + 8)) goto LAB_1400c43b1;
...
LAB_1400c37f6:
    uStack_78 = uVar16;
    if (uVar12 == 1) {
      if ((longlong)uVar16 < 1) goto LAB_1400c3c53;
      uVar14 = *(uint *)(param_11 + uVar16 * 4);
      if ((longlong)uVar16 < 0x10) {
LAB_1400c445a:
        pcStack_80 = (code *)0x0;
        if (uVar16 == 0) goto LAB_1400c3c53;
        uStack_70 = 0;
      }
      else {
        uVar11 = param_11 & 0x1f;
        if (uVar11 != 0) {
          if ((param_11 & 3) != 0) goto LAB_1400c445a;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)uVar16 < (longlong)(uVar11 + 0x10)) goto LAB_1400c445a;
        ...
        if (uVar16 < (longlong)pcStack_80 + 1U) goto LAB_1400c3c53;
...
LAB_1400c43cd:
        ...
        uVar11 = param_11 & 0x1f;
        if (uVar11 != 0) {
          if ((param_11 & 3) != 0) goto LAB_1400c43cd;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)uVar16 < (longlong)(uVar11 + 0x10)) goto LAB_1400c43cd;
        pcStack_80 = (code *)(uVar16 - (uVar16 - uVar11 & 0xf));
        uVar17 = 0;
        if (uVar11 != 0) {
          do {
...
LAB_1400c3c53:
    pcStack_80 = *(code **)(&UNK_143086c00 + lVar8 * 8);
...
LAB_1400c43f1:
          ...
          if (uVar10 != 0) {
            if ((param_11 & 3) != 0) goto LAB_1400c43f1;
            uVar10 = 0x20 - uVar10 >> 2;
          }
          if ((longlong)uVar15 < (longlong)(uVar10 + 8)) goto LAB_1400c43f1;
          uVar17 = 0;
...
LAB_1400c3e88:
  if (uVar12 == 1) {
    if ((longlong)uVar16 < 1) goto LAB_1400c41fc;
...
LAB_1400c441c:
          uVar15 = 0;
          if (uVar16 == 0) goto LAB_1400c41fc;
          uVar11 = 0;
          uVar10 = uVar16;
        }
        else {
          uVar10 = uVar15 & 0x1f;
          if (uVar10 != 0) {
            if ((uVar15 & 3) != 0) goto LAB_1400c441c;
            uVar10 = 0x20 - uVar10 >> 2;
          }
          if ((longlong)uVar16 < (longlong)(uVar10 + 0x10)) goto LAB_1400c441c;
          uVar11 = 0;
          ...
          if (uVar16 < uVar15 + 1) goto LAB_1400c41fc;
  ...
  if ((uVar12 != 6) || ((longlong)uVar16 < 1)) goto LAB_1400c41fc;
  if ((longlong)uVar16 < 0x10) {
LAB_1400c43ff:
    uVar10 = 0;
    if (uVar16 == 0) goto LAB_1400c41fc;
    ...
    if (uVar15 != 0) {
      if ((lVar8 - 4U & 3) != 0) goto LAB_1400c43ff;
      uVar15 = 0x20 - uVar15 >> 2;
    }
    if ((longlong)uVar16 < (longlong)(uVar15 + 0x10)) goto LAB_1400c43ff;
    uVar11 = 0;
    ...
    if (uVar16 < uVar10 + 1) goto LAB_1400c41fc;
