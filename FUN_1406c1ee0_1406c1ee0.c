...
void FUN_1406c1ee0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_1406c2157:
    ...
    uVar20 = param_2 & 0xf;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406c2157;
      uVar20 = 0x10 - uVar20 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar20 + 8)) goto LAB_1406c2157;
    uVar17 = 0;
