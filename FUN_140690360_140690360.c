...
ulonglong *
FUN_140690360(longlong param_1,longlong param_2,longlong param_3,longlong param_4,ulonglong *param_5
...

{
  ...
  if (iVar27 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcStack_a0 = *(code **)(&DAT_14308b880 + (longlong)param_6 * 8);
            ...
            if (lStack_a8 < (longlong)(uStack_50 + uVar25)) {
              ...
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar7 == 6) {
                      if (uStack_b0 == 0) goto LAB_14069196d;
                    }
                    else {
                      if (uVar7 != 1) goto LAB_1406918e6;
LAB_140691a2f:
                      lVar23 = 0;
                      if (uStack_b0 != 0) {
                        lVar23 = lVar10;
...
LAB_140691954:
                  ...
                  if ((lVar10 < (longlong)uVar25) || (param_7 == 0xf0)) goto LAB_140691954;
                  if (uVar7 != 6) {
                    if (uVar7 == 1) {
                      if (lVar10 < 0) goto LAB_140691a2f;
                      if (uStack_90 == 0) {
                        lVar23 = uVar25 - 1;
                      }
                    }
...
LAB_1406918e6:
                      if (uVar7 == 3) {
                        if ((longlong)uVar25 < 2) {
                          ...
                          if (lVar10 < 0) goto LAB_140691a42;
...
LAB_140691a42:
                  ...
                  if (uStack_90 != 0) goto LAB_140691954;
LAB_14069196d:
                  bVar12 = (byte)*puVar28;
...
LAB_140691a03:
                      ...
                      if ((longlong)uStack_b8 < (longlong)(uVar17 + 0x10)) goto LAB_140691a03;
                      uVar22 = 0;
...
LAB_140690852:
            ...
            uVar17 = uVar20 & 0xf;
            if (uVar17 != 0) {
              if ((uVar20 & 3) != 0) goto LAB_140690852;
              uVar17 = 0x10 - uVar17 >> 2;
            }
            if ((longlong)uVar25 < (longlong)(uVar17 + 4)) goto LAB_140690852;
            uVar14 = 0;
...
LAB_1406906c6:
            ...
            if (puVar8 != (ulonglong *)0x0) {
              if ((uVar25 & 3) != 0) goto LAB_1406906c6;
              puVar8 = (ulonglong *)(0x10U - (longlong)puVar8 >> 2);
            }
            if ((longlong)puVar16 < (longlong)puVar8 + 4) goto LAB_1406906c6;
