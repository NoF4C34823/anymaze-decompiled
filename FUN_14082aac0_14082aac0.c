...
void FUN_14082aac0(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14082b49c:
      uVar32 = 0;
      if (param_3 == 0) goto LAB_14082acdc;
      uVar29 = 0;
      uVar30 = param_3;
    }
    else {
      ...
      if (uVar30 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_14082b49c;
        uVar30 = 0x20 - uVar30 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar30 + 0x10)) goto LAB_14082b49c;
      ...
      if (param_3 < uVar32 + 1) goto LAB_14082acdc;
...
LAB_14082b460:
          uVar32 = 0;
          if (param_3 == 0) goto LAB_14082b2a4;
          uVar29 = 0;
          uVar30 = param_3;
        }
        else {
          uVar30 = (ulonglong)param_2 & 0x1f;
          if (uVar30 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_14082b460;
            uVar30 = 0x20 - uVar30 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar30 + 0x10)) goto LAB_14082b460;
          ...
          if (param_3 < uVar32 + 1) goto LAB_14082b2a4;
          uVar30 = param_3 - uVar32;
          if ((longlong)uVar30 < 4) {
            uVar29 = 0;
          }
...
LAB_14082b44d:
    ...
    uVar30 = (ulonglong)param_2 & 0x1f;
    if (uVar30 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_14082b44d;
      uVar30 = 0x20 - uVar30 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar30 + 0x10)) goto LAB_14082b44d;
    uVar29 = 0;
    uVar32 = param_3 - (param_3 - uVar30 & 0xf);
    if (uVar30 != 0) {
      do {
