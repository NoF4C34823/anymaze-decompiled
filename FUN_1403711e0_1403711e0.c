...
void FUN_1403711e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)uVar7) {
          ...
          do {
            ...
            if (0 < (longlong)uVar19) {
              ...
              if ((lVar10 - 1U < uVar19) &&
                 (lVar10 = (lVar10 - 1U) * 4 + lVar12 + lVar5, bVar4 < *(byte *)(lVar10 + uVar17)))
              {
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        if (0 < (longlong)uVar19) {
          ...
          do {
            ...
            if (0 < (longlong)uVar9) {
              ...
              if ((lVar16 - 1U < uVar9) &&
                 (lVar16 = (lVar16 - 1U) * 4 + lVar13, bVar4 < *(byte *)(lVar16 + uVar7))) {
        ...
        FUN_140374ca0(param_9,uVar15,param_3,uVar19,uVar3);
        uVar8 = uVar8 + 1;
