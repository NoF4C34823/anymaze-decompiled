...
void FUN_1409bfa20(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308e240)[lVar6])(psVar28,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar17 == 6) {
    sVar27 = *param_8;
          ...
          if (uVar17 != 6) {
            if (uVar17 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar13 < 0) goto LAB_1409c0f20;
                while (uVar16 == 0) {
                  for (lVar8 = (lVar20 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_1409c0f20:
                    if (uVar25 != 0) goto LAB_1409c0de3;
                  }
...
LAB_1409c0de3:
    ...
    (*(code *)(&PTR_LAB_14308e240)[lVar6])(param_11 + uVar14 * 2,param_4,lVar20,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
        ...
        if (6 < (longlong)uVar18) {
          ...
          if ((lVar10 <= (longlong)(uVar7 - (longlong)psVar28)) ||
            ...
            if ((longlong)uVar18 < 0x20) {
              ...
              if ((longlong)uVar18 < 0x76) {
                ...
                if (uVar24 != 0) {
                  ...
                  if (uVar18 == uVar24) goto LAB_1409bff63;
                }
              }
            ...
            if (uVar26 + 1 <= uVar18) {
              ...
              auVar38 = vmovdqu32_avx512f(_DAT_14308dfc0);
              auVar39 = vmovdqu32_avx512f(_DAT_14308e000);
              lVar10 = 0;
              do {
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar24 != 0) {
                ...
                if (uVar14 == uVar24) goto LAB_1409c0300;
              }
            }
            if ((longlong)(uVar24 + 0x20) <= (longlong)uVar26) {
...
LAB_1409c0300:
      (*(code *)(&PTR_LAB_14308e240)[lVar6])(uVar7,param_4,uVar14,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (*(code *)(&PTR_LAB_14308e240)[lVar6])(psVar28,param_4,lVar20,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar18 < 0x20) {
          ...
          if ((longlong)uVar18 < 0x76) {
            ...
            if (uVar26 != 0) {
              ...
              if (uVar18 == uVar26) goto LAB_1409c0824;
            }
          }
          ...
          if ((longlong)uVar14 < 0x20) {
            ...
            if ((longlong)uVar14 < 0x4b) {
              ...
              if (uVar7 != 0) {
                ...
                if (uVar14 == uVar7) goto LAB_1409c0c83;
              }
            }
...
LAB_1409c0c83:
  (*(code *)(&PTR_LAB_14308e240)[lVar6])(param_11 + uVar14 * 2,param_4,uVar14,param_9,param_10);
  return;
}
