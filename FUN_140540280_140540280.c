...
void FUN_140540280(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar4 - 1U)) {
      while( true ) {
        FUN_140d29540(param_1,lVar3,lVar1,lVar5,1);
        lVar4 = param_6[1];
        lVar6 = lVar6 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_140d29540(param_1,lVar3,lVar1,*param_6,1);
