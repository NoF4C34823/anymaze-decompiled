...
void FUN_1408d43c0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)uVar19) {
    if ((longlong)uVar19 < 0x1d) {
      FUN_1408d44ba(uVar19 & 0xfffffffffffffff0,uVar19,param_2,0);
      return;
    }
    uVar20 = param_2 & 0x1f;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408d4749;
