...
void FUN_1405f5c00(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1405f6484:
      ...
      uVar45 = uVar44 & 0xf;
      if (uVar45 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_1405f6484;
        uVar45 = 0x10 - uVar45 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar45 + 4)) goto LAB_1405f6484;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar45 & 0xf;
      if (uVar44 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_1405f6492;
      ...
      if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
        ...
        uVar35 = _UNK_14308b468;
        uVar36 = _UNK_14308b464;
        uVar37 = _DAT_14308b460;
        if (uVar44 != 0) {
          do {
...
LAB_1405f640d:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar44 = uVar45 & 0xf;
    if (uVar44 != 0) {
      if ((uVar45 & 3) != 0) goto LAB_1405f648b;
      uVar44 = 0x10 - uVar44 >> 2;
    }
