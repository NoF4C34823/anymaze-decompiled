...
void FUN_14087c5e0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)
...
LAB_14087cb4f:
    ...
    uVar18 = param_2 & 0x1f;
    if (uVar18 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14087cb4f;
      uVar18 = 0x20 - uVar18 >> 2;
    }
    if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_14087cb4f;
    uVar16 = 0;
