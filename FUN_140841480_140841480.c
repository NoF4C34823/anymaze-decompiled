...
void FUN_140841480(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_140841587:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar15) && (param_7 != 0xf0)) {
      if (uVar13 == 6) {
        if (uStack_b0 == 0) goto LAB_1408416ca;
      }
      else {
        if (uVar13 != 1) goto LAB_1408415c4;
        if (uStack_b0 == 0) {
          uVar7 = param_5[1] - 1;
        }
      }
...
LAB_140841660:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_1408420e0(lStack_78,lStack_70,uVar7,param_3,in_stack_fffffffffffffee8,(int)lStack_50,param_7
        ...
        if (uStack_48 <= uVar15) {
          if (uStack_a0 != 0) {
            ...
            do {
              uStack_d8 = *param_5;
              uStack_d0 = param_5[1];
              FUN_1408420e0(lStack_78,lStack_70,lVar9,lVar3,&uStack_d8,(int)lStack_50,param_7,
          ...
          param_10 = iStack_a8;
          if (uVar13 != 1) goto LAB_1408419ab;
          uVar12 = *param_5;
          uVar15 = 0;
          goto LAB_140841ca0;
        }
...
LAB_14084192e:
        ...
        (*(code *)(&PTR_FUN_14308c940)[lStack_50])
      ...
      if (-1 < (longlong)uVar15) goto LAB_140841587;
      uVar7 = uVar15;
      if (param_7 == 0xf0) goto LAB_140841660;
      if (uVar13 != 6) {
        if (uVar13 != 1) goto LAB_1408415c4;
        uVar7 = 0;
        if (uStack_a0 != 0) {
      ...
      if (uStack_a0 != 0) goto LAB_140841660;
LAB_1408416ca:
      uVar7 = *param_5;
      uVar5 = *param_8;
...
LAB_140842030:
      ...
      uVar11 = uVar6 & 0x1f;
      if (uVar11 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_140842023;
        uVar11 = 0x20 - uVar11 >> 2;
      }
      if ((longlong)uVar7 < (longlong)(uVar11 + 0x10)) goto LAB_140842023;
      uVar10 = 0;
      ...
      if (uVar7 < uVar8 + 1) goto LAB_140841800;
      uVar7 = uVar7 - uVar8;
      if ((longlong)uVar7 < 4) goto LAB_140842030;
...
LAB_1408419ab:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_d8 = *param_5;
    uStack_d0 = param_5[1];
    FUN_1408420e0(lStack_78,lStack_70,lVar3,lStack_98,&uStack_d8,(int)lStack_50,param_7,param_8,
...
LAB_140841be5:
        ...
        uVar6 = uVar7 & 0x1f;
        if (uVar6 != 0) {
          if ((uVar7 & 3) != 0) goto LAB_140841be5;
          uVar6 = 0x20 - uVar6 >> 2;
        }
        if ((longlong)uVar15 < (longlong)(uVar6 + 8)) goto LAB_140841be5;
...
LAB_140841db0:
      ...
      uVar7 = uVar6 & 0x1f;
      if (uVar7 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_140841db0;
        uVar7 = 0x20 - uVar7 >> 2;
      }
      if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_140841db0;
      uVar8 = 0;
...
LAB_1408415c4:
  ...
  if (uVar13 == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar15 < 0) goto LAB_1408418c0;
      while (uStack_b0 == 0) {
