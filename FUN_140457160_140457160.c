...
void FUN_140457160(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar6 != 0 && SCARRY8(lVar8,-1) == lVar6 < 0) {
      do {
        FUN_142d28fa0(param_1,lVar4,lVar1,lVar5 * 4,4);
        lVar9 = lVar9 + 1;
    ...
    if (0 < (longlong)param_5._4_4_) {
      do {
        FUN_142d28fa0(param_1,lVar4,lVar1,lVar5 << 2,4);
        thunk_FUN_142d29130(param_9,uVar3,param_3,lVar1,lVar8);
        lVar7 = lVar6 + 1;
        lVar9 = lVar9 + 1;
        lVar6 = lVar7;
        if (lVar8 <= lVar7) {
