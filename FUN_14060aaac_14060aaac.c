...
void FUN_14060aaac(undefined8 param_1,undefined8 param_2,ulonglong param_3,float param_4)

{
  ...
  do {
    ...
    *pfVar3 = (*pfVar5 + *pfVar4) * (float)param_2 + *pfVar2 * (float)param_1;
  ...
  if (uVar16 < param_3) {
    ...
    do {
      *(float *)(in_RDX + in_R10 * 4 + uVar16 * 4) =
           (*(float *)(lVar1 + -4 + uVar16 * 4) + *(float *)(lVar1 + 4 + uVar16 * 4)) * param_4 +
           *(float *)(lVar1 + uVar16 * 4) * in_XMM2_Da;
      uVar16 = uVar16 + 1;
