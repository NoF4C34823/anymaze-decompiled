...
void FUN_1408fec00(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1408ff727:
      ...
      if ((longlong)uVar23 < 0x1d) {
        ...
        uVar28 = param_2 & 0x1f;
        if (uVar28 != 0) {
          if ((param_2 & 3) != 0) goto LAB_1408ff727;
          uVar28 = 0x20 - uVar28 >> 2;
        }
        if ((longlong)uVar23 < (longlong)(uVar28 + 0x10)) goto LAB_1408ff727;
        lVar18 = lVar33 * -6 + param_1;
...
LAB_1408ff709:
          ...
          uVar21 = param_2 & 0x1f;
          if (uVar21 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1408ff709;
            uVar21 = 0x20 - uVar21 >> 2;
          }
          if ((longlong)uVar23 < (longlong)(uVar21 + 0x10)) goto LAB_1408ff709;
  ...
  if (0xf < (longlong)uVar23) {
    uVar21 = param_2 & 0x1f;
    if (uVar21 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408ff6fb;
      uVar21 = 0x20 - uVar21 >> 2;
    }
