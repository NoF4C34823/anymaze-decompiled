...
/* WARNING: Removing unreachable block (ram,0x0001401f0735) */

void FUN_1401ef320(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_248 = param_10;
    (**(code **)(&DAT_1430882e0 + lVar25 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar27 != 6) {
            if (uVar27 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar23 < 0) goto LAB_1401f0d80;
                while (uVar11 == 0) {
                  for (lVar28 = (lVar20 + -1) * 2 - lVar28; lVar28 < 0; lVar28 = -lVar28) {
LAB_1401f0d80:
                    if (uVar22 != 0) goto LAB_1401f0bcc;
                  }
          ...
          if (uVar30 != 0) goto LAB_1401f0bcc;
          uVar30 = *puStack_88;
          uVar35 = puStack_88[1];
          uVar37 = puStack_88[2];
        }
...
LAB_1401f0cd3:
              ...
              if (uVar15 != 0) {
                if ((uStack_f8 & 3) != 0) goto LAB_1401f0cd3;
                uVar15 = 0x20 - uVar15 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_1401f0cd3;
              uVar21 = 0;
...
LAB_1401f00c4:
      uStack_108 = puVar1;
      uStack_110 = *(code **)(&DAT_1430882e0 + lVar25 * 8);
      iStack_248 = param_10;
      uStack_100 = param_7;
      lStack_e8 = param_1;
