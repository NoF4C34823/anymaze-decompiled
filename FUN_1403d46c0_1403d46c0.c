...
void FUN_1403d46c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar17 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403bffa0(lVar5,lVar14,uVar2,(longlong)(int)param_6,3);
        lVar19 = lVar19 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403bffa0(lVar5,lVar14,uVar2,(longlong)(int)param_6,3);
        thunk_FUN_142d25930(param_9,uVar3,param_3,uVar2,(longlong)param_6._4_4_);
        lVar17 = lVar17 + 1;
        lVar19 = lVar19 + 1;
        lVar14 = lVar14 + uVar3 * 4;
