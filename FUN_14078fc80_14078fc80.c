...
void FUN_14078fc80(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140790d35. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(psVar25,param_4,*param_5);
    return;
  }
  if (uVar14 == 6) {
    sVar19 = *param_8;
          ...
          if (uVar14 != 6) {
            if (uVar14 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar12 < 0) goto LAB_140790cc0;
                while (uVar8 == 0) {
                  for (lVar23 = (lVar20 + -1) * 2 - lVar23; lVar23 < 0; lVar23 = -lVar23) {
LAB_140790cc0:
                    if (uVar16 != 0) goto LAB_140790bc3;
                  }
...
LAB_140790bc3:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar22;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140790c26. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(param_11 + uVar10 * 2,param_4,lVar20,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar10 == 1) {
...
LAB_140790c3a:
              ...
              uVar17 = uVar7 & 0xf;
              if (uVar17 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_140790c3a;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar17 + 8)) goto LAB_140790c3a;
...
LAB_14079015d:
      if (uVar14 == 1) {
        if ((longlong)uVar10 < 1) goto LAB_14079036d;
...
LAB_140790c9a:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140790c9a;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_140790c9a;
          uVar5 = 0;
...
LAB_140790c41:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140790c41;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_140790c41;
          uVar5 = 0;
          uVar21 = uVar10 - (uVar10 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_14079036d:
      in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(uVar7,param_4,uVar10,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140790c97. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(psVar25,param_4,lVar20);
    return;
  }
  if ((longlong)uVar10 < lVar20) {
    lVar20 = lVar20 - uVar10;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(psVar25,param_4,lVar20,param_9,param_10);
...
LAB_140790c48:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140790c48;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar7 + 8)) goto LAB_140790c48;
...
LAB_1407907dc:
  if (uVar14 == 1) {
    if ((longlong)uVar10 < 1) goto LAB_140790a7b;
...
LAB_140790c58:
          ...
          uVar7 = uVar18 & 0xf;
          if (uVar7 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_140790c58;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar7 + 8)) goto LAB_140790c58;
          uVar17 = 0;
  ...
  if ((uVar14 != 6) || ((longlong)uVar10 < 1)) goto LAB_140790a7b;
  if ((longlong)uVar10 < 8) {
LAB_140790c50:
    uVar7 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar20 - 2U & 1) != 0) goto LAB_140790c50;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar10 < (longlong)(uVar18 + 8)) goto LAB_140790c50;
    uVar17 = 0;
...
LAB_140790a7b:
                    /* WARNING: Could not recover jumptable at 0x000140790ab4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c1e0)[lVar4])(param_11 + uVar10 * 2,param_4,uVar10);
  return;
}
