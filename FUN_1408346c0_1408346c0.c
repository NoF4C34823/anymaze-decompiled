...
void FUN_1408346c0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar54 = param_4 & 0x1f;
      if (uVar54 != 0) {
        if ((param_4 & 3) != 0) goto LAB_140834ddf;
...
LAB_140834dcf:
    ...
    uVar54 = param_4 & 0x1f;
    if (uVar54 != 0) {
      if ((param_4 & 3) != 0) goto LAB_140834dcf;
      uVar54 = 0x20 - uVar54 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar54 + 0x10)) goto LAB_140834dcf;
