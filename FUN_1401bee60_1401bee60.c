...
void FUN_1401bee60(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (3 < (longlong)uVar5) {
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401bf036;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    uVar8 = uVar6 + 4;
    if ((longlong)uVar8 <= (longlong)uVar5) {
      ...
      if (uVar6 != 0) {
        do {
          *(float *)(param_2 + uVar7 * 4) =
               (float)((uint)*(ushort *)(param_1 + -0xc + uVar7 * 2) +
                      (uint)*(ushort *)(param_1 + 0xc + uVar7 * 2)) * fVar2 +
               (float)((uint)*(ushort *)(param_1 + -6 + uVar7 * 2) +
                      (uint)*(ushort *)(param_1 + 6 + uVar7 * 2)) * fVar3 +
               (float)*(ushort *)(param_1 + uVar7 * 2) * fVar4;
          uVar7 = uVar7 + 1;
        } while (uVar7 < uVar6);
      }
      do {
        auVar10 = pmovzxwd(unaff_XMM7,*(undefined8 *)(param_1 + -0xc + uVar6 * 2));
        auVar9 = pmovzxwd(unaff_XMM6,*(undefined8 *)(param_1 + 0xc + uVar6 * 2));
        ...
        auVar9 = pmovzxwd(auVar9,*(undefined8 *)(param_1 + 6 + uVar6 * 2));
        auVar10 = pmovzxwd(auVar11,*(undefined8 *)(param_1 + -6 + uVar6 * 2));
        ...
        unaff_XMM7 = pmovzxwd(auVar12,*(undefined8 *)(param_1 + uVar6 * 2));
      ...
      for (; uVar8 < uVar5; uVar8 = uVar8 + 1) {
        *(float *)(param_2 + uVar8 * 4) =
             (float)((uint)*(ushort *)(param_1 + -0xc + uVar8 * 2) +
                    (uint)*(ushort *)(param_1 + 0xc + uVar8 * 2)) * fVar2 +
             (float)((uint)*(ushort *)(param_1 + -6 + uVar8 * 2) +
                    (uint)*(ushort *)(param_1 + 6 + uVar8 * 2)) * fVar3 +
             (float)*(ushort *)(param_1 + uVar8 * 2) * fVar4;
      }
      return;
    }
  }
LAB_1401bf036:
  FUN_1401befc4(fVar4,uVar8,0);
  return;
}
