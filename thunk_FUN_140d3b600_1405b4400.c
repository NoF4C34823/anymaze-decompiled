...
void thunk_FUN_140d3b600(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (0 < param_6) {
    lVar11 = 0;
    lVar1 = param_7 * 2 + 2;
    auVar18 = vmovdqu32_avx512f(_DAT_1430926c0);
    lVar7 = 0;
    do {
            ...
            do {
              ...
              if (0 < lVar17) {
                ...
                do {
                  ...
                  lVar15 = lVar15 + 1;
                  auVar19 = vpminsw_avx512bw(auVar19,*(undefined1 (*) [64])(lVar13 + lVar12 * 2));
                  auVar20 = vpminsw_avx512bw(auVar20,*(undefined1 (*) [64])
                                                      (lVar13 + 0x40 + lVar12 * 2));
                  auVar21 = vpminsw_avx512bw(auVar21,*(undefined1 (*) [64])
                                                      (lVar13 + 0x80 + lVar12 * 2));
                  auVar22 = vpminsw_avx512bw(auVar22,*(undefined1 (*) [64])
          ...
          do {
            ...
            if (0 < lVar15) {
              do {
                ...
                auVar22 = vpminsw_avx512bw(auVar22,auVar20);
              } while (lVar14 < lVar15);
            }
            lVar9 = lVar9 + 1;
            lVar4 = lVar4 + lVar1;
