...
void FUN_14098b140(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308df40)[lVar55])(param_1,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar57 == 6) {
          ...
          if (uVar57 != 6) {
            if (uVar57 == 1) {
              ...
              if (lVar48 < 2) {
                ...
                if (lVar56 < 0) goto LAB_14098bfc0;
                while (uVar51 == 0) {
                  for (lVar54 = (lVar48 + -1) * 2 - lVar54; lVar54 < 0; lVar54 = -lVar54) {
LAB_14098bfc0:
                    if (uVar45 != 0) goto LAB_14098be6f;
                  }
          ...
          iVar63 = iVar64;
          if (uVar43 != 0) goto LAB_14098be6f;
        }
        else {
LAB_14098be6f:
    ...
    (*(code *)(&PTR_LAB_14308df40)[lVar55])(param_11 + uVar49 * 4,param_4,lVar48,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
      ...
      if (6 < (longlong)uVar50) {
        ...
        if ((lVar52 <= (longlong)(uVar44 - param_1)) || (lVar52 <= (longlong)-(uVar44 - param_1))) {
          if ((longlong)uVar50 < 0x10) {
            ...
            if ((longlong)uVar50 < 0x3b) {
              ...
              if (uVar47 != 0) {
                ...
                auVar60 = vmovdqu32_avx512f(_DAT_14308dcc0);
                ...
                if (uVar50 == uVar47) goto LAB_14098b3da;
              }
            }
          ...
          if (uVar53 + 1 <= uVar50) {
            ...
            uVar19 = vpcmpgtq_avx512f(auVar62,_DAT_14308dc80);
            bVar22 = (byte)uVar19;
            uVar19 = vpcmpgtq_avx512f(auVar62,_DAT_14308dcc0);
            bVar21 = (byte)uVar19;
            uVar58 = CONCAT11(bVar21,bVar22);
        ...
        if ((longlong)uVar49 < 0x10) {
          ...
          if ((longlong)uVar49 < 0x26) {
            ...
            if (uVar47 != 0) {
              ...
              if (uVar49 == uVar47) goto LAB_14098b71c;
            }
          }
          if ((longlong)(uVar47 + 0x10) <= (longlong)uVar53) {
...
LAB_14098b71c:
    pcStack_68 = (code *)(&PTR_LAB_14308df40)[lVar55];
        ...
        if ((longlong)uVar50 < 0x10) {
          ...
          if ((longlong)uVar50 < 0x3b) {
            ...
            if (uVar53 != 0) {
              ...
              if (uVar50 == uVar53) goto LAB_14098b99f;
            }
          }
          ...
          if ((longlong)uVar49 < 0x10) {
            ...
            if ((longlong)uVar49 < 0x26) {
              ...
              if (uVar44 != 0) {
                ...
                if (uVar49 == uVar44) goto LAB_14098bd54;
              }
            }
