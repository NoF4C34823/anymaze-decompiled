...
void FUN_1402c3360(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar19 - 1)) {
      while( true ) {
        FUN_1402b1140(param_1,lVar21,uVar3,uVar29,1);
        uVar19 = param_6[1];
        lVar38 = lVar38 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        FUN_1402b1140(param_1,lVar21,uVar3,*param_6,1);
        uVar19 = param_6[1];
        if (0 < (longlong)uVar3) {
          uVar29 = 0;
          do {
                ...
                if (0 < (longlong)uVar29) {
                  if ((longlong)uVar29 < 8) {
                    ...
                    do {
                      ...
                      sVar4 = auVar47._0_2_;
                      auVar51._0_2_ =
                           (ushort)(sVar37 < sVar4) * sVar4 | (ushort)(sVar37 >= sVar4) * sVar37;
                      sVar37 = auVar47._2_2_;
                      auVar51._2_2_ =
                           (ushort)(sVar44 < sVar37) * sVar37 | (ushort)(sVar44 >= sVar37) * sVar44;
                      sVar37 = auVar47._4_2_;
                      auVar51._4_2_ =
                           (ushort)(sVar18 < sVar37) * sVar37 | (ushort)(sVar18 >= sVar37) * sVar18;
                      sVar37 = auVar47._6_2_;
                      auVar51._6_2_ =
                           (ushort)(sVar17 < sVar37) * sVar37 | (ushort)(sVar17 >= sVar37) * sVar17;
                      sVar37 = auVar47._8_2_;
                      auVar51._8_2_ =
                           (ushort)(sVar26 < sVar37) * sVar37 | (ushort)(sVar26 >= sVar37) * sVar26;
                      sVar37 = auVar47._10_2_;
                      auVar51._10_2_ =
                           (ushort)(sVar35 < sVar37) * sVar37 | (ushort)(sVar35 >= sVar37) * sVar35;
                      sVar37 = auVar47._12_2_;
                      auVar51._12_2_ =
                           (ushort)(sVar25 < sVar37) * sVar37 | (ushort)(sVar25 >= sVar37) * sVar25;
                      sVar37 = auVar47._14_2_;
                      auVar51._14_2_ =
                           (ushort)(sVar24 < sVar37) * sVar37 | (ushort)(sVar24 >= sVar37) * sVar24;
                      auVar47 = auVar51 & auVar41 | ~auVar41 & auVar47;
                    } while (uVar28 < uVar30);
                    sVar37 = auVar47._8_2_;
                    sVar44 = auVar47._0_2_;
                    uVar43 = (ushort)(sVar44 < sVar37) * sVar37 |
                             (ushort)(sVar44 >= sVar37) * sVar44;
                    sVar37 = auVar47._10_2_;
                    sVar44 = auVar47._2_2_;
                    uVar48 = (ushort)(sVar44 < sVar37) * sVar37 |
                             (ushort)(sVar44 >= sVar37) * sVar44;
                    sVar37 = auVar47._12_2_;
                    sVar44 = auVar47._4_2_;
                    uVar49 = (ushort)(sVar44 < sVar37) * sVar37 |
                             (ushort)(sVar44 >= sVar37) * sVar44;
                    sVar37 = auVar47._14_2_;
                    sVar44 = auVar47._6_2_;
                    uVar50 = (ushort)(sVar44 < sVar37) * sVar37 |
                             (ushort)(sVar44 >= sVar37) * sVar44;
