...
void FUN_1408074c0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14080802a:
      uVar44 = 0;
      if (uVar40 == 0) goto LAB_140807707;
      uVar41 = 0;
      uVar43 = uVar40;
    }
    else {
      uVar43 = param_2 & 0x1f;
      if (uVar43 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14080802a;
        uVar43 = 0x20 - uVar43 >> 2;
      }
      if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_14080802a;
      ...
      if (uVar40 < uVar44 + 1) goto LAB_140807707;
...
LAB_140807fed:
          uVar44 = 0;
          if (uVar40 == 0) goto LAB_140807e12;
          uVar41 = 0;
          uVar43 = uVar40;
        }
        else {
          uVar43 = param_2 & 0x1f;
          if (uVar43 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140807fed;
            uVar43 = 0x20 - uVar43 >> 2;
          }
          if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_140807fed;
          ...
          if (uVar40 < uVar44 + 1) goto LAB_140807e12;
          uVar43 = uVar40 - uVar44;
          if ((longlong)uVar43 < 4) {
            uVar41 = 0;
          }
...
LAB_140807fda:
    ...
    uVar43 = param_2 & 0x1f;
    if (uVar43 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140807fda;
      uVar43 = 0x20 - uVar43 >> 2;
    }
    if ((longlong)uVar40 < (longlong)(uVar43 + 0x10)) goto LAB_140807fda;
    uVar41 = 0;
    uVar44 = uVar40 - (uVar40 - uVar43 & 0xf);
    if (uVar43 != 0) {
      do {
