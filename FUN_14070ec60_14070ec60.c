...
void FUN_14070ec60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14070f582:
      ...
      uVar41 = uVar40 & 0xf;
      if (uVar41 != 0) {
        if ((uVar40 & 3) != 0) goto LAB_14070f582;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar41 + 4)) goto LAB_14070f582;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar41 = uVar40 & 0xf;
      if (uVar41 != 0) {
        if ((uVar40 & 3) != 0) goto LAB_14070f590;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)(uVar41 + 4) <= (longlong)param_5) {
        ...
        auVar35 = _DAT_14308bf00;
        auVar34 = _DAT_14308bef0;
        lVar39 = uVar41 * 2;
        do {
...
LAB_14070f510:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar41 = uVar40 & 0xf;
    if (uVar41 != 0) {
      if ((uVar40 & 3) != 0) goto LAB_14070f589;
      uVar41 = 0x10 - uVar41 >> 2;
    }
