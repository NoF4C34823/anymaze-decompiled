...
void FUN_1409f63e0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0xf < (longlong)param_5) {
    uVar24 = param_4 & 0x3f;
    if (uVar24 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1409f6734;
    ...
    if (uVar24 != 0) {
      auVar40 = vmovdqu32_avx512f(_DAT_14308e640);
      auVar41 = vmovdqu32_avx512f(_DAT_14308e680);
