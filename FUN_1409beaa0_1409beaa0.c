...
void FUN_1409beaa0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1409bec14:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar48) && (param_7 != 0xf0)) {
      if (uStack_90 == 6) {
        if (uStack_b0 == 0) goto LAB_1409bed6c;
      }
      else {
        if (uStack_90 != 1) goto LAB_1409bec5a;
        if (uStack_b0 == 0) {
          uVar52 = param_5[1] - 1;
        }
      }
...
LAB_1409bed00:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_1409bfa20(lStack_68,lStack_70,uVar52,param_3,in_stack_fffffffffffffe48,(int)lStack_50,
        ...
        if (uStack_40 <= uVar48) {
          ...
          if (uStack_a8 != 0) {
            ...
            do {
              ...
              FUN_1409bfa20(lStack_68,lStack_70,lVar50,lVar43,&uStack_178,(int)lStack_50,param_7,
...
LAB_1409bf00f:
        ...
        (*(code *)(&PTR_LAB_14308e240)[lStack_50])
      ...
      if (-1 < (longlong)uVar48) goto LAB_1409bec14;
      uVar52 = uVar48;
      if (param_7 == 0xf0) goto LAB_1409bed00;
      if (uStack_90 != 6) {
        if (uStack_90 != 1) goto LAB_1409bec5a;
        uVar52 = 0;
        if (uStack_a8 != 0) {
      ...
      if (uStack_a8 != 0) goto LAB_1409bed00;
LAB_1409bed6c:
    ...
    if ((longlong)uVar52 < 0x10) {
      ...
      if ((longlong)uVar52 < 0x26) {
        ...
        if (uVar45 != 0) {
          ...
          if (uVar52 == uVar45) goto LAB_1409beee0;
        }
      }
        ...
        if (0 < (longlong)uVar48) {
          if ((longlong)uVar48 < 0x10) {
            ...
            while (0x25 < (longlong)uVar48) {
              ...
              if (uVar52 == 0) goto LAB_1409bf7a5;
              uVar45 = 0;
              ...
              if (uVar48 != uVar52) goto LAB_1409bf7a5;
              uVar51 = uVar51 + 1;
        ...
        if (0 < (longlong)uVar48) {
          if ((longlong)uVar48 < 0x10) {
            ...
            while (0x3a < (longlong)uVar48) {
              ...
              if (uVar53 == 0) goto LAB_1409bf5bc;
              uVar55 = 0;
              ...
              if (uVar48 != uVar53) goto LAB_1409bf5bc;
              uVar51 = uVar51 + 1;
              if (uVar46 <= uVar51) {
                return;
              }
...
LAB_1409bf5bc:
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_178 = *param_5;
      uStack_170 = param_5[1];
      FUN_1409bfa20(lStack_68,lStack_70,lVar43,lStack_98,&uStack_178,(int)lStack_50,param_7,param_8,
        ...
        if (0 < (longlong)uVar48) {
          if ((longlong)uVar48 < 0x10) {
            ...
            while (0x3a < (longlong)uVar48) {
              ...
              if (uVar53 == 0) goto LAB_1409bf33c;
              uVar45 = 0;
              auVar60 = vpbroadcastq_avx512f();
              auVar62 = auVar58;
              auVar61 = auVar57;
              ...
              if (uVar48 != uVar53) goto LAB_1409bf33c;
              lVar43 = uVar51 + 2;
              uVar51 = uVar51 + 1;
...
LAB_1409bec5a:
  ...
  if (uStack_90 == 3) {
    ...
    if ((longlong)uVar53 < 2) {
      ...
      if ((longlong)uVar48 < 0) goto LAB_1409befa0;
      while (uStack_b0 == 0) {
