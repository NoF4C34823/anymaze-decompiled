...
void FUN_14059e8fa(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
                  longlong param_4)

{
  ...
  do {
    ...
    if (lVar8 != 0) {
      ...
      auVar14 = vminps_avx512f(*pauVar5,*pauVar10);
      pauVar11 = (undefined1 (*) [64])(*pauVar5 + in_R10 * 8);
      auVar15 = vminps_avx512f(auVar14,*pauVar11);
      lVar6 = 0;
      auVar14 = auVar15;
      if (1 < lVar8) {
        do {
          lVar6 = lVar6 + 1;
          auVar15 = vminps_avx512f(pauVar5[1],*(undefined1 (*) [64])(pauVar5[1] + lVar2));
          auVar15 = vminps_avx512f(auVar15,*(undefined1 (*) [64])(pauVar5[1] + in_R10 * 8));
          pauVar5 = pauVar5 + 1;
          auVar16 = valignd_avx512f(auVar15,auVar14,4);
          auVar17 = valignd_avx512f(auVar15,auVar14,8);
          auVar14 = vminps_avx512f(auVar16,auVar14);
          auVar14 = vminps_avx512f(auVar17,auVar14);
          *pauVar9 = auVar14;
          pauVar9 = pauVar9 + 1;
          auVar14 = auVar15;
        } while (lVar6 < lVar8 + -1);
      ...
      pauVar1 = pauVar5 + 1;
      pauVar5 = pauVar5 + 1;
      auVar14 = vminps_avx512f(ZEXT3264(*(undefined1 (*) [32])*pauVar1),
                               ZEXT3264(*(undefined1 (*) [32])pauVar10[1]));
      auVar14 = vminps_avx512f(auVar14,ZEXT3264(*(undefined1 (*) [32])pauVar11[1]));
      auVar16 = valignd_avx512f(auVar14,auVar15,4);
      auVar14 = valignd_avx512f(auVar14,auVar15,8);
      auVar15 = vminps_avx512f(auVar16,auVar15);
      auVar14 = vminps_avx512f(auVar14,auVar15);
      *pauVar9 = auVar14;
      pauVar9 = pauVar9 + 1;
    }
    ...
    if (lVar8 != 0) {
      lVar6 = 0;
      auVar13 = vminps_avx(*(undefined1 (*) [32])*pauVar5,*(undefined1 (*) [32])(*pauVar5 + lVar2));
      auVar13 = vminps_avx(auVar13,*(undefined1 (*) [32])(*pauVar5 + in_R10 * 8));
      if (0 < lVar8) {
        do {
          lVar6 = lVar6 + 1;
          auVar3 = vminps_avx(*(undefined1 (*) [32])(*pauVar5 + 0x20),
                              *(undefined1 (*) [32])(*pauVar5 + lVar2 + 0x20));
          auVar3 = vminps_avx(auVar3,*(undefined1 (*) [32])(*pauVar5 + in_R10 * 8 + 0x20));
          ...
          auVar13 = vminps_avx512vl(auVar12,auVar13);
