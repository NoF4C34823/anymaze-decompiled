...
longlong *
FUN_14064f1e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,longlong *param_5,
...
LAB_14064f2a9:
    ...
    if ((param_5[1] <= (longlong)uVar25) && (param_7 != 0xf0)) {
      if (uVar20 == 6) {
        if (uStack_90 == 0) goto LAB_14064f3cd;
      }
      else {
        if (uVar20 != 1) goto LAB_14064f2e3;
        if (uStack_90 == 0) {
          uVar14 = param_5[1] - 1;
        }
      }
...
LAB_14064f35a:
    do {
      ...
      lStack_60 = param_5[1];
      in_RAX = (longlong *)
               FUN_14064fdc0(lStack_50,lStack_58,uVar14,lVar22,in_stack_ffffffffffffff18,param_6,
                             param_7,psVar13,param_9,param_10,param_11);
      while( true ) {
        while( true ) {
          uVar7 = param_11;
          uVar5 = param_9;
          ...
          if (uStack_48 <= uVar25) {
            ...
            if (uStack_78 != 0) {
              ...
              do {
                ...
                uStack_a0 = param_5[1];
                plVar9 = (longlong *)
                         FUN_14064fdc0(lStack_50,lStack_58,lVar22,lVar11,&lStack_a8,param_6,param_7,
                                       psVar6,uVar5,param_10,uVar7);
                lVar16 = lVar16 + 1;
                lVar22 = lVar22 + 1;
...
LAB_14064f5df:
          ...
          (**(code **)(&DAT_14308b640 + (longlong)param_6 * 8))
        ...
        lVar18 = lStack_58;
        lVar8 = lStack_50;
        if (-1 < (longlong)uVar25) goto LAB_14064f2a9;
        uVar14 = uVar25;
        if (param_7 == 0xf0) goto LAB_14064f35a;
        if (uVar20 != 6) break;
        if (uStack_78 != 0) goto LAB_14064f35a;
LAB_14064f3cd:
        in_RAX = (longlong *)(ulonglong)(uint)(int)*psVar13;
        fVar28 = (float)(int)*psVar13;
        fVar27 = (float)(int)psVar13[1];
        fVar26 = (float)(int)psVar13[2];
        if (0 < *param_5 * 3) {
          uVar14 = *param_5 * 3 + 2;
          lVar22 = 1;
          lVar18 = 0;
...
LAB_14064f682:
  if (uVar20 == 6) {
    uVar25 = 0;
    plVar9 = (longlong *)(ulonglong)(uint)(int)*param_8;
    fVar28 = (float)(int)*param_8;
    fVar27 = (float)(int)param_8[1];
...
LAB_14064fb11:
            ...
            uVar14 = uVar10 & 0xf;
            if (uVar14 != 0) {
              if ((uVar10 & 3) != 0) goto LAB_14064fb11;
              uVar14 = 0x10 - uVar14 >> 2;
            }
            if ((longlong)uVar25 < (longlong)(uVar14 + 4)) goto LAB_14064fb11;
            uVar15 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_a0 = param_5[1];
      in_RAX = (longlong *)
               FUN_14064fdc0(param_1,param_2,lVar11,param_3,&lStack_a8,param_6,param_7,param_8,
...
LAB_14064f925:
            ...
            if (plVar24 != (longlong *)0x0) {
              if ((uVar14 & 3) != 0) goto LAB_14064f925;
              plVar24 = (longlong *)(0x10U - (longlong)plVar24 >> 2);
            }
            if ((longlong)plVar9 < (longlong)plVar24 + 4) goto LAB_14064f925;
...
LAB_14064f2e3:
  ...
  if (uVar20 == 3) {
    ...
    if (lVar16 < 2) {
      ...
      if ((longlong)uVar25 < 0) goto LAB_14064f580;
      while (uStack_90 == 0) {
