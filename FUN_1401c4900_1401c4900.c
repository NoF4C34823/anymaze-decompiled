...
void FUN_1401c4900(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar51 = uVar50 & 0xf;
      if (uVar51 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1401c4dc5;
...
LAB_1401c4dc5:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar46 = uVar50 & 0xf;
      if (uVar46 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1401c5138;
...
LAB_1401c50a4:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar46 = uVar50 & 0xf;
    if (uVar46 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_1401c5131;
      uVar46 = 0x10 - uVar46 >> 2;
    }
    if ((longlong)(uVar46 + 8) <= (longlong)param_5) {
      uVar45 = 0;
