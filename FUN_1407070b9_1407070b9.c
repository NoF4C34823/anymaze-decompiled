...
void FUN_1407070b9(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)

{
  ...
  do {
    uVar2 = *(ulonglong *)((longlong)puVar27 + -0xc);
    uVar3 = *(ulonglong *)((longlong)puVar27 + 0xc);
    auVar7._8_4_ = 0;
    auVar7._0_8_ = uVar2;
    ...
    uVar4 = *(ulonglong *)((longlong)puVar27 + 6);
    uVar5 = *(ulonglong *)((longlong)puVar27 + -6);
    auVar9._8_4_ = 0;
    auVar9._0_8_ = uVar5;
    ...
    do {
      *(float *)(in_R10 + in_RDX * 4) =
           (float)((uint)*(ushort *)(param_4 + -0xc + in_RDX * 2) +
                  (uint)*(ushort *)(param_4 + 0xc + in_RDX * 2)) * param_2 +
           (float)((uint)*(ushort *)(param_4 + -6 + in_RDX * 2) +
                  (uint)*(ushort *)(param_4 + 6 + in_RDX * 2)) * in_XMM4_Da +
