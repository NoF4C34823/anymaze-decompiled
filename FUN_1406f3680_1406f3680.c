...
ulonglong FUN_1406f3680(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    uVar3 = (*(code *)(&PTR_FUN_14308bcc0)[param_6])
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return uVar3;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1406f3796;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x0001406f395c;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_1406f3796;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x0001406f395c:
      if (uVar2 == 0) {
        fVar7 = (float)(int)param_8[2];
        lVar5 = *param_5 * 2 + *param_5;
        uVar3 = (ulonglong)(uint)(int)*param_8;
...
LAB_1406f3796:
  lStack_28 = *param_5;
  lStack_20 = param_5[1];
  uVar3 = FUN_1407003c0(param_1,param_2,param_3,param_4,&lStack_28,param_6,param_7,param_8,param_9,
                        param_10,param_11);
  return uVar3;
}
