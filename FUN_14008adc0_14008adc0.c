...
void FUN_14008adc0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14008bb18:
      ...
      uVar23 = param_2 & 0xf;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14008bb18;
        uVar23 = 0x10 - uVar23 >> 2;
      }
      if ((longlong)uVar11 < (longlong)(uVar23 + 8)) goto LAB_14008bb18;
...
LAB_14008bae1:
          uVar32 = 0;
          if (uVar11 == 0) goto LAB_14008b8ad;
          uVar34 = 0;
          uVar23 = uVar11;
        }
        else {
          uVar23 = param_2 & 0xf;
          if (uVar23 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14008bae1;
            uVar23 = 0x10 - uVar23 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar23 + 0x10)) goto LAB_14008bae1;
          uVar34 = 0;
          ...
          if (uVar11 < uVar32 + 1) goto LAB_14008b8ad;
...
LAB_14008b8ad:
  ...
  if (0xf < (longlong)uVar11) {
    uVar23 = param_2 & 0xf;
    if (uVar23 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14008bad6;
      uVar23 = 0x10 - uVar23 >> 2;
    }
    if ((longlong)(uVar23 + 0x10) <= (longlong)uVar11) {
      ...
      goto joined_r0x00014008ba7f;
    }
  }
LAB_14008bad6:
  uVar32 = 0;
joined_r0x00014008ba7f:
