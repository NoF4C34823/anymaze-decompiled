...
void FUN_1408b98c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1408b99c6:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar15) && (uStack_c0 != 0xf0)) {
      if (uStack_90 != 6) goto joined_r0x0001408b99f6;
      if ((param_7 & 0x20) == 0) goto LAB_1408b9b0c;
    }
LAB_1408b9aa0:
    do {
      FUN_1408ba580(param_1,param_2);
      while( true ) {
        while( true ) {
          uStack_90 = param_7 & 0xf;
          iVar14 = (int)uVar15;
          ...
          if (uVar17 <= uVar15) {
            if (uVar10 != 0) {
              ...
              lVar16 = -uVar17;
              do {
                FUN_1408ba580(param_1,param_2,lVar16,param_3);
                lVar8 = lVar8 + 1;
                lVar16 = lVar16 + 1;
            ...
            if (uStack_90 != 1) goto LAB_1408b9de9;
            uVar15 = *param_5;
            uVar11 = 0;
            goto LAB_1408ba100;
          }
...
LAB_1408b9d6f:
          (*(code *)(&PTR_FUN_14308cfe0)[param_6])(param_2 * uVar15 + param_1,lVar9);
        }
        param_8 = puStack_c8;
        if (-1 < (longlong)uVar15) goto LAB_1408b99c6;
...
LAB_1408ba4af:
            ...
            if ((longlong)uVar11 < 0x1d) {
              ...
              uVar20 = uVar18 & 0x1f;
              if (uVar20 != 0) {
                if ((uVar18 & 3) != 0) goto LAB_1408ba4af;
                uVar20 = 0x20 - uVar20 >> 2;
              }
              if ((longlong)uVar11 < (longlong)(uVar20 + 0x10)) goto LAB_1408ba4af;
              uVar13 = 0;
...
LAB_1408b9de9:
  ...
  if ((uStack_c0 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_FUN_14308cfe0)[param_6])(param_1 + param_2 * lVar8,param_3,*param_5,param_9);
  }
  else {
    ...
    FUN_1408ba580(param_1,param_2,lVar8,param_3);
  }
  lVar8 = 1;
  uVar15 = 0;
  if (iVar12 < 2) {
...
LAB_1408ba044:
        ...
        if ((longlong)uVar17 < 0xbd) {
          ...
          uVar19 = uVar11 & 0x1f;
          if (uVar19 != 0) {
            if ((uVar11 & 3) != 0) goto LAB_1408ba044;
            uVar19 = 0x20 - uVar19 >> 2;
          }
          if ((longlong)uVar17 < (longlong)(uVar19 + 8)) goto LAB_1408ba044;
          lVar9 = lVar16 - lVar9;
          uVar20 = 0;
...
LAB_1408ba3d4:
      ...
      if ((longlong)uVar15 < 0x1d) {
        ...
        uVar20 = uVar18 & 0x1f;
        if (uVar20 != 0) {
          if ((uVar18 & 3) != 0) goto LAB_1408ba3d4;
          uVar20 = 0x20 - uVar20 >> 2;
        }
        if ((longlong)uVar15 < (longlong)(uVar20 + 0x10)) goto LAB_1408ba3d4;
        uVar13 = 0;
...
LAB_1408ba211:
      ...
      if ((longlong)uVar15 < 0xbd) {
        ...
        uVar20 = uVar18 & 0x1f;
        if (uVar20 != 0) {
          if ((uVar18 & 3) != 0) goto LAB_1408ba211;
          uVar20 = 0x20 - uVar20 >> 2;
        }
        if ((longlong)uVar15 < (longlong)(uVar20 + 8)) goto LAB_1408ba211;
        uVar13 = 0;
