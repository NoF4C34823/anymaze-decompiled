...
void FUN_1408c6a60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1408c6b66:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar14) && (uStack_c0 != 0xf0)) {
      if (uStack_90 != 6) goto joined_r0x0001408c6b96;
      if ((param_7 & 0x20) == 0) goto LAB_1408c6cac;
    }
LAB_1408c6c40:
    do {
      FUN_1408c7740(param_1,param_2);
      while( true ) {
        while( true ) {
          uStack_90 = param_7 & 0xf;
          iVar13 = (int)uVar14;
          ...
          if (uVar16 <= uVar14) {
            if (uVar9 != 0) {
              ...
              lVar15 = -uVar16;
              do {
                FUN_1408c7740(param_1,param_2,lVar15,param_3);
                lVar7 = lVar7 + 1;
                lVar15 = lVar15 + 1;
...
LAB_1408c6f2f:
          (*(code *)(&PTR_FUN_14308cfa0)[param_6])(param_2 * uVar14 + param_1,lVar8);
        }
        param_8 = psStack_c8;
        if (-1 < (longlong)uVar14) goto LAB_1408c6b66;
...
LAB_1408c768c:
            ...
            if ((longlong)uVar10 < 0x1d) {
              ...
              uVar19 = uVar17 & 0x1f;
              if (uVar19 != 0) {
                if ((uVar17 & 3) != 0) goto LAB_1408c768c;
                uVar19 = 0x20 - uVar19 >> 2;
              }
              if ((longlong)uVar10 < (longlong)(uVar19 + 0x10)) goto LAB_1408c768c;
              uVar12 = 0;
...
LAB_1408c75b4:
            ...
            if ((longlong)uVar16 < 0x1d) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_1408c75b4;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 0x10)) goto LAB_1408c75b4;
              uVar19 = 0;
...
LAB_1408c73f1:
            ...
            if ((longlong)uVar16 < 0xbd) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_1408c73f1;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 8)) goto LAB_1408c73f1;
              uVar19 = 0;
    ...
    if ((uStack_c0 & 0xf0) == 0xf0) {
      (*(code *)(&PTR_FUN_14308cfa0)[param_6])(param_1 + param_2 * lVar7,param_3,*param_5,param_9);
    }
    else {
      ...
      FUN_1408c7740(param_1,param_2,lVar7,param_3);
    }
    lVar7 = 1;
    uVar14 = 0;
    if (1 < iVar11) {
...
LAB_1408c7204:
            ...
            if ((longlong)uVar16 < 0xbd) {
              ...
              uVar18 = uVar10 & 0x1f;
              if (uVar18 != 0) {
                if ((uVar10 & 3) != 0) goto LAB_1408c7204;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              if ((longlong)uVar16 < (longlong)(uVar18 + 8)) goto LAB_1408c7204;
              lVar8 = lVar15 - lVar8;
              uVar19 = 0;
              uVar17 = uVar16 - (uVar16 - uVar18 & 7);
              if (uVar18 != 0) {
