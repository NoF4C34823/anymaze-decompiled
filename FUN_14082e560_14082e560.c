...
void FUN_14082e560(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)
...
LAB_14082eacf:
    ...
    uVar18 = param_2 & 0x1f;
    if (uVar18 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14082eacf;
      uVar18 = 0x20 - uVar18 >> 2;
    }
    if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_14082eacf;
    uVar16 = 0;
