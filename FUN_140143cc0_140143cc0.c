...
ulonglong FUN_140143cc0(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  plStack_98 = param_5;
  plStack_90 = param_6;
  uVar1 = FUN_1401927a0(param_1,param_2,param_3,param_4);
  if ((int)uVar1 < 0) {
    ...
    lStack_58 = lStack_88;
    lStack_50 = lStack_80;
    uVar2 = FUN_140b31060(&lStack_88,param_2,param_3,0xf0);
    if ((int)uVar2 < 0) {
      if ((uStack_48 ^ (ulonglong)auStack_b8) == DAT_1436b4680) {
        return uVar2;
      }
      ...
      plStack_98 = (longlong *)CONCAT44(plStack_98._4_4_,param_4);
      plStack_90 = &lStack_78;
      uVar2 = FUN_140b31060(&lStack_88,param_2,param_3,6);
      if ((int)uVar2 < 0) {
        if ((uStack_48 ^ (ulonglong)auStack_b8) == DAT_1436b4680) {
          return uVar2;
        }
        ...
        plStack_98 = (longlong *)CONCAT44(plStack_98._4_4_,param_4);
        plStack_90 = &lStack_78;
        uVar2 = FUN_140b31060(&lStack_88,param_2,param_3,1);
        if ((int)uVar2 < 0) {
          if ((uStack_48 ^ (ulonglong)auStack_b8) == DAT_1436b4680) {
            return uVar2;
          }
          ...
          plStack_98 = (longlong *)CONCAT44(plStack_98._4_4_,param_4);
          plStack_90 = &lStack_78;
          uVar2 = FUN_140b31060(&lStack_88,param_2,param_3,3);
          if ((int)uVar2 < 0) {
            if ((uStack_48 ^ (ulonglong)auStack_b8) == DAT_1436b4680) {
              return uVar2;
            }
            ...
            uVar2 = FUN_140b54a40(param_2,param_3,param_4,&uStack_70);
            if (-1 < (int)uVar2) {
