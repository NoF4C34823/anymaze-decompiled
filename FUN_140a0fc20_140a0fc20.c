...
void FUN_140a0fc20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_140a0fd3a:
    ...
    if ((param_5[1] <= (longlong)uVar49) && (param_7 != 0xf0)) {
      if (uStack_90 == 6) {
        if (uStack_b0 == 0) goto LAB_140a0fe8c;
      }
      else {
        if (uStack_90 != 1) goto LAB_140a0fd80;
        if (uStack_b0 == 0) {
          uVar50 = param_5[1] - 1;
        }
      }
...
LAB_140a0fe20:
    do {
      ...
      lStack_88 = *param_5;
      lStack_80 = param_5[1];
      FUN_140a10b40(lStack_50,lStack_48,uVar50,param_3,in_stack_fffffffffffffe48,(int)lStack_58,
          ...
          if (uStack_40 <= uVar49) {
            ...
            if (uStack_a8 != 0) {
              ...
              do {
                ...
                FUN_140a10b40(lStack_50,lStack_48,lVar47,lVar46,&lStack_178,(int)lStack_58,param_7,
...
LAB_140a1016c:
          ...
          (*(code *)(&PTR_LAB_14308e8e0)[lStack_58])
        ...
        if (-1 < (longlong)uVar49) goto LAB_140a0fd3a;
        uVar50 = uVar49;
        if (param_7 == 0xf0) goto LAB_140a0fe20;
        if (uStack_90 != 6) break;
        if (uStack_a8 != 0) goto LAB_140a0fe20;
LAB_140a0fe8c:
        auVar56 = vxorps_avx512vl(auVar56,auVar56);
        auVar64._0_4_ = (float)(int)param_8[2];
        auVar64._4_8_ = SUB128(ZEXT812(0),4);
        auVar64._12_4_ = 0;
        auVar56 = vcvtsi2ss_avx512f(auVar56,(int)*param_8);
        in_ZMM16 = ZEXT1664(auVar56);
        auVar65._0_4_ = (float)(int)param_8[1];
        ...
        if (0 < *param_5 * 3) {
          ...
          if ((longlong)uVar50 < 0x10) {
            ...
            auVar57 = vmovdqu32_avx512f(_DAT_14308e740);
          ...
          if (uVar42 + 1 <= uVar50) {
            ...
            uVar18 = vpcmpgtq_avx512f(auVar61,_DAT_14308e640);
            uVar19 = vpcmpgtq_avx512f(auVar61,_DAT_14308e680);
  ...
  uVar45 = param_7 & 0xf;
LAB_140a10234:
  auVar57 = _DAT_14308e600;
  if (uVar45 == 6) {
    uVar49 = 0;
    lVar46 = 0;
    auVar56._0_4_ = (float)(int)*param_8;
    auVar56._4_8_ = SUB128(ZEXT812(0),4);
    auVar56._12_4_ = 0;
    auVar63._0_4_ = (float)(int)param_8[1];
    auVar63._4_8_ = SUB128(ZEXT812(0),4);
    auVar63._12_4_ = 0;
    auVar66._0_4_ = (float)(int)param_8[2];
        ...
        if (0 < (longlong)uVar50) {
          if ((longlong)uVar50 < 0x10) {
            ...
            while (0x3a < (longlong)uVar50) {
              ...
              if (uVar43 == 0) goto LAB_140a1071c;
              uVar52 = 0;
              auVar62 = vpbroadcastq_avx512f();
              auVar60 = auVar59;
              auVar61 = auVar58;
              ...
              if (uVar50 != uVar43) goto LAB_140a1071c;
              uVar49 = uVar49 + 1;
              if (uVar42 <= uVar49) {
                return;
              }
...
LAB_140a1071c:
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      lStack_178 = *param_5;
      lStack_170 = param_5[1];
      FUN_140a10b40(lStack_50,lStack_48,lVar46,lStack_a0,&lStack_178,(int)lStack_58,param_7,param_8,
        ...
        if (0 < (longlong)uVar50) {
          if ((longlong)uVar50 < 0x10) {
            ...
            while (0x3a < (longlong)uVar50) {
              ...
              if (uVar43 == 0) goto LAB_140a1049c;
              uVar54 = 0;
              auVar62 = vpbroadcastq_avx512f();
              auVar60 = auVar59;
              auVar61 = auVar58;
              ...
              if (uVar50 != uVar43) goto LAB_140a1049c;
              lVar46 = uVar49 + 2;
              uVar49 = uVar49 + 1;
...
LAB_140a0fd80:
  ...
  if (uStack_90 == 3) {
    ...
    if (lVar44 < 2) {
      ...
      if ((longlong)uVar49 < 0) goto LAB_140a100a0;
      while (uStack_b0 == 0) {
