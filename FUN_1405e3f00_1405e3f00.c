...
void FUN_1405e3f00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_1405e3fcf:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar8) && (param_7 != 0xf0)) {
      if (uVar17 == 6) {
        if (uStack_90 == 0) goto LAB_1405e4113;
      }
      else {
        if (uVar17 != 1) goto LAB_1405e4008;
        if (uStack_90 == 0) {
          uVar9 = param_5[1] - 1;
        }
      }
...
LAB_1405e409b:
    do {
      ...
      uStack_68 = *param_5;
      uStack_60 = param_5[1];
      FUN_1405e4ae0(lStack_50,lStack_58,uVar9,uVar7,in_stack_ffffffffffffff18,param_6,param_7,
          ...
          if (uStack_48 <= uVar8) {
            ...
            if (uStack_78 != 0) {
              ...
              do {
                uStack_a8 = *param_5;
                uStack_a0 = param_5[1];
                FUN_1405e4ae0(lStack_50,lStack_58,lVar15,lVar12,&uStack_a8,param_6,param_7,param_8,
...
LAB_1405e42f9:
          ...
          (**(code **)(&DAT_14308b2c0 + (longlong)param_6 * 8))
        ...
        if (-1 < (longlong)uVar8) goto LAB_1405e3fcf;
        uVar9 = uVar8;
        if (param_7 == 0xf0) goto LAB_1405e409b;
        if (uVar17 != 6) break;
        if (uStack_78 != 0) goto LAB_1405e409b;
LAB_1405e4113:
        uVar7 = *param_5;
...
LAB_1405e4a3b:
            ...
            uVar9 = uVar5 & 0xf;
            if (uVar9 != 0) {
              if ((uVar5 & 3) != 0) goto LAB_1405e4a3b;
              uVar9 = 0x10 - uVar9 >> 2;
            }
            if ((longlong)uVar7 < (longlong)(uVar9 + 8)) goto LAB_1405e4a3b;
            uVar11 = 0;
...
LAB_1405e496d:
            ...
            uVar10 = uVar9 & 0xf;
            if (uVar10 != 0) {
              if ((uVar9 & 3) != 0) goto LAB_1405e496d;
              uVar10 = 0x10 - uVar10 >> 2;
            }
            if ((longlong)uVar7 < (longlong)(uVar10 + 8)) goto LAB_1405e496d;
            uVar14 = 0;
...
LAB_1405e4810:
            ...
            uVar10 = uVar9 & 0xf;
            if (uVar10 != 0) {
              if ((uVar9 & 3) != 0) goto LAB_1405e4810;
              uVar10 = 0x10 - uVar10 >> 2;
            }
            if ((longlong)uVar7 < (longlong)(uVar10 + 4)) goto LAB_1405e4810;
            uVar14 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      ...
      uStack_a8 = *param_5;
      uStack_a0 = param_5[1];
      FUN_1405e4ae0(param_1,param_2,lVar12,param_3,&uStack_a8,param_6,param_7,param_8,param_9,
                    param_10,param_11);
    }
    lVar12 = 1;
    uVar8 = 0;
...
LAB_1405e4625:
            ...
            uVar9 = uVar10 & 0xf;
            if (uVar9 != 0) {
              if ((uVar10 & 3) != 0) goto LAB_1405e4625;
              uVar9 = 0x10 - uVar9 >> 2;
            }
            if ((longlong)uVar7 < (longlong)(uVar9 + 4)) goto LAB_1405e4625;
...
LAB_1405e4008:
  ...
  if (uVar17 == 3) {
    ...
    if ((longlong)uVar5 < 2) {
      ...
      if ((longlong)uVar8 < 0) goto LAB_1405e42a0;
      while (uStack_90 == 0) {
