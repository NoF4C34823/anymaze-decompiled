...
void FUN_140209580(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14020a147:
      ...
      uVar19 = param_2 & 0x1f;
      if (uVar19 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14020a147;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar19 + 0x20)) goto LAB_14020a147;
      uVar18 = 0;
...
LAB_14020a129:
          ...
          uVar19 = param_2 & 0x1f;
          if (uVar19 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14020a129;
            uVar19 = 0x20 - uVar19 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar19 + 0x20)) goto LAB_14020a129;
  ...
  if (0x1f < (longlong)param_3) {
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14020a11b;
      uVar19 = 0x20 - uVar19 >> 2;
    }
