...
void FUN_140774ac0(longlong param_1,ulonglong param_2,ulonglong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)param_3) {
    uVar7 = param_2 & 0xf;
    if (uVar7 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140774dae;
      uVar7 = 0x10 - uVar7 >> 2;
    }
    if ((longlong)(uVar7 + 4) <= (longlong)param_3) {
      ...
      goto joined_r0x000140774cfb;
    }
  }
LAB_140774dae:
  uVar9 = 0;
joined_r0x000140774cfb:
