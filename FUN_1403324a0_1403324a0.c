...
void FUN_1403324a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  uVar23 = param_6[1];
  uVar6 = *param_5 * 3;
  uVar25 = uVar6 + 0x1f & 0xffffffffffffffe0;
  lVar17 = (param_1 + (longlong)(int)(uVar22 - 1 >> 1) * -3) - (int)(uVar23 - 1 >> 1) * param_2;
  if (param_7 == 0) {
    lVar26 = 0;
    lVar13 = param_9;
    if (0 < (longlong)(uVar23 - 1)) {
      while( true ) {
        FUN_14031cfa0(lVar17,lVar13,uVar6,uVar22,3);
        uVar23 = param_6[1];
        lVar26 = lVar26 + 1;
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        FUN_14031cfa0(lVar17,lVar13,uVar6,*param_6,3);
        uVar23 = param_6[1];
        if (0 < (longlong)uVar6) {
          uVar22 = 0;
          do {
            ...
            if (0 < (longlong)uVar23) {
              ...
              if (uVar10 <= uVar23) {
                    /* WARNING: Could not recover jumptable at 0x0001403328ec. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_1403328ee +
                          (byte)(&DAT_143089c90)[(uint)((int)uVar23 - (int)uVar10)]))();
                return;
              }
            }
...
LAB_140332f93:
                    ...
                    uStack_98 = uVar8 & 0xf;
                    if (uStack_98 != 0) {
                      uStack_98 = 0x10 - uStack_98;
                    }
                    if ((longlong)uVar22 < (longlong)(uStack_98 + 0x10)) goto LAB_140332f93;
                    uVar11 = 0;
                    uVar15 = uVar22 - (uVar22 - uStack_98 & 0xf);
                    if (uStack_98 != 0) {
                      do {
                        if ((*(char *)(uVar11 + uVar8) != '\0') &&
                           (bVar30 = *(byte *)(lVar24 + uVar11 * 3 + lVar27), bVar30 < bVar31)) {
                          bVar31 = bVar30;
                        }
                        uVar11 = uVar11 + 1;
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar28 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar31 = auVar33[9];
                        auVar29[9] = (bVar31 < bVar14) * bVar31 | (bVar31 >= bVar14) * bVar14;
                        bVar31 = auVar33[10];
                        auVar29[10] = (bVar31 < bVar16) * bVar31 | (bVar31 >= bVar16) * bVar16;
                        bVar31 = auVar33[0xb];
                        auVar29[0xb] = (bVar31 < bVar2) * bVar31 | (bVar31 >= bVar2) * bVar2;
                        bVar31 = auVar33[0xc];
                        auVar29[0xc] = (bVar31 < bVar3) * bVar31 | (bVar31 >= bVar3) * bVar3;
                        bVar31 = auVar33[0xd];
                        auVar29[0xd] = (bVar31 < bVar7) * bVar31 | (bVar31 >= bVar7) * bVar7;
                        bVar31 = auVar33[0xe];
                        auVar29[0xe] = (bVar31 < bVar9) * bVar31 | (bVar31 >= bVar9) * bVar9;
                        bVar31 = auVar33[0xf];
                        auVar29[0xf] = (bVar31 < bVar20) * bVar31 | (bVar31 >= bVar20) * bVar20;
                        auVar33 = auVar29 & auVar28 | ~auVar28 & auVar33;
                      }
                      lVar12 = lVar12 + 0x30;
                      uStack_98 = uStack_98 + 0x10;
                    } while (uStack_98 < uVar15);
                    bVar31 = auVar33[8];
                    bVar30 = auVar33[0];
                  ...
                  for (; uVar15 < uVar22; uVar15 = uVar15 + 1) {
                    if ((*(char *)(uVar15 + uVar8) != '\0') &&
                       (bVar30 = *(byte *)(lVar24 + uVar15 * 3 + lVar27), bVar30 < bVar31)) {
                      bVar31 = bVar30;
                    }
                  }
                }
