...
void FUN_14067b0fa(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         ...
         (float)((uint)*(ushort *)(param_4 + -6 + in_RAX * 2) +
                (uint)*(ushort *)(param_4 + 6 + in_RAX * 2)) * unaff_XMM13_Da +
         (float)*(ushort *)(param_4 + in_RAX * 2) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < param_1);
  puVar37 = (ulonglong *)(param_1 * 2 + param_4);
  do {
    uVar2 = *(ulonglong *)((longlong)puVar37 + -0x12);
    uVar3 = *(ulonglong *)((longlong)puVar37 + 0x12);
    auVar9._8_4_ = 0;
    auVar9._0_8_ = uVar2;
    ...
    uVar4 = *(ulonglong *)((longlong)puVar37 + 0xc);
    uVar5 = *(ulonglong *)((longlong)puVar37 + -0xc);
    auVar11._8_4_ = 0;
    auVar11._0_8_ = uVar5;
    ...
    uVar6 = *(ulonglong *)((longlong)puVar37 + 6);
    uVar7 = *(ulonglong *)((longlong)puVar37 + -6);
    auVar13._8_4_ = 0;
    auVar13._0_8_ = uVar7;
    ...
    *pfVar1 = (float)(((uint)uVar2 & 0xffff) + ((uint)uVar3 & 0xffff)) * param_2 +
              ...
              (float)(((uint)uVar7 & 0xffff) + ((uint)uVar6 & 0xffff)) * unaff_XMM13_Da +
    ...
    pfVar1[1] = (float)(auVar23._4_4_ + auVar24._4_4_) * param_2 +
                ...
                (float)(auVar27._4_4_ + auVar28._4_4_) * unaff_XMM13_Da +
    ...
    pfVar1[2] = (float)(auVar16._8_4_ + auVar17._8_4_) * param_2 +
                ...
                (float)(auVar20._8_4_ + auVar21._8_4_) * unaff_XMM13_Da +
    ...
    pfVar1[3] = (float)((auVar9._10_4_ >> 0x10) + (auVar10._10_4_ >> 0x10)) * param_2 +
                ...
                (float)((auVar13._10_4_ >> 0x10) + (auVar14._10_4_ >> 0x10)) * unaff_XMM13_Da +
