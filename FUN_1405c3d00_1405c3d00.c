...
undefined8
FUN_1405c3d00(undefined8 param_1,ulonglong param_2,int param_3,int param_4,int *param_5,int *param_6
             )

{
  ...
  if (param_6 != (int *)0x0) {
    ...
    iVar1 = FUN_140d0d900(param_1,param_2 | 0x100000001,param_3,param_4);
