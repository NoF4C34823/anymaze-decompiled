...
void FUN_140250240(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (iVar47 < 1) {
    ...
    if ((param_7 & 0x10) != 0) {
      uStack_c0 = param_9;
      pcStack_d8 = *(code **)(&UNK_143088b60 + (longlong)(int)uStack_220 * 8);
      lStack_138 = 0;
      uStack_f0 = 0;
            ...
            if (lStack_c8 < (longlong)(uStack_60 + uVar42)) {
              ...
              do {
                ...
                if (lVar45 < 0) {
                  if (uStack_f8 != 0xf0) {
                    if (iVar47 == 6) {
                      if (uStack_e0 == 0) goto LAB_140252854;
                    }
                    else {
                      if (iVar47 != 1) goto LAB_1402527cc;
LAB_140252997:
                      lVar51 = 0;
                      if (uStack_e0 != 0) {
                        lVar51 = lVar45;
...
LAB_14025283c:
                  ...
                  if ((lVar45 < (longlong)uVar42) || (uStack_f8 == 0xf0)) goto LAB_14025283c;
                  if (iVar47 != 6) {
                    if (iVar47 == 1) {
                      if (lVar45 < 0) goto LAB_140252997;
                      if (uStack_b8 == 0) {
                        lVar51 = lStack_e8;
                      }
                    }
...
LAB_1402529c0:
                  ...
                  if (uStack_b8 != 0) goto LAB_14025283c;
LAB_140252854:
                  bVar46 = *pbVar58;
                  bVar56 = pbVar58[1];
                  bVar52 = pbVar58[2];
                  ...
                  if ((lStack_158 + -3 <= (longlong)puStack_d0 - lVar44) ||
                    ...
                    if ((longlong)uVar50 < 0x40) {
                      ...
                      if ((longlong)uVar50 < 0x116) {
                        ...
                        if (uVar55 != 0) {
                          auVar69 = vmovdqu32_avx512f(_DAT_143088940);
                          uVar53 = 0;
                          auVar70 = vmovdqu32_avx512f(_DAT_143088980);
                          ...
                          if (uVar50 == uVar55) goto LAB_140250f2d;
                        }
                      }
...
LAB_14025147b:
  ...
  if (uVar54 == 6) {
    ...
    auVar64._12_4_ = 0;
    if (0 < iVar47) {
      auVar74 = vmovdqu32_avx512f(_DAT_143088940);
      auVar69 = vmovdqu32_avx512f(_DAT_143088980);
      ...
      do {
        if (0 < (longlong)(*param_5 * 3)) {
          if ((longlong)uVar49 < 0x10) {
            ...
            uVar42 = 0;
            auVar71 = vmovdqu32_avx512f(_DAT_143088a40);
            lVar57 = 0;
            do {
        ...
        if (0 < (longlong)uVar49) {
          if ((longlong)uVar49 < 0x10) {
            ...
            while (0x3a < (longlong)uVar49) {
              ...
              if (uVar41 == 0) goto LAB_14025073c;
              uVar53 = 0;
              auVar71 = vpbroadcastq_avx512f();
              auVar73 = auVar70;
              auVar72 = auVar69;
              ...
              if (uVar49 != uVar41) goto LAB_14025073c;
              uVar50 = uVar50 + 1;
              if (uVar43 <= uVar50) {
                return;
              }
        ...
        if (0 < (longlong)uVar49) {
          if ((longlong)uVar49 < 0x10) {
            ...
            while (0x3a < (longlong)uVar49) {
              ...
              if (uVar41 == 0) goto LAB_14025055c;
              uVar55 = 0;
              auVar71 = vpbroadcastq_avx512f();
              auVar73 = auVar70;
              auVar72 = auVar69;
              ...
              if (uVar49 != uVar41) goto LAB_14025055c;
              lVar45 = uVar50 + 2;
              uVar50 = uVar50 + 1;
