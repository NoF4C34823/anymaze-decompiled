...
void FUN_1400b2180(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400b23c0;
    ...
    if ((longlong)(uVar19 + 8) <= (longlong)param_3) {
      ...
      if (uVar19 != 0) {
        do {
          *(float *)(param_2 + uVar17 * 4) =
               fVar2 * (float)((int)*(short *)(param_1 + -4 + uVar17 * 2) +
                              (int)*(short *)(param_1 + 4 + uVar17 * 2)) +
               fVar3 * (float)((int)*(short *)(param_1 + -2 + uVar17 * 2) +
                              (int)*(short *)(param_1 + 2 + uVar17 * 2)) +
               fVar4 * (float)(int)*(short *)(param_1 + uVar17 * 2);
          uVar17 = uVar17 + 1;
        } while (uVar17 < uVar19);
      }
      ...
      for (; uVar18 < param_3; uVar18 = uVar18 + 1) {
        *(float *)(param_2 + uVar18 * 4) =
             fVar2 * (float)((int)*(short *)(param_1 + -4 + uVar18 * 2) +
                            (int)*(short *)(param_1 + 4 + uVar18 * 2)) +
             fVar3 * (float)((int)*(short *)(param_1 + -2 + uVar18 * 2) +
                            (int)*(short *)(param_1 + 2 + uVar18 * 2)) +
             fVar4 * (float)(int)*(short *)(param_1 + uVar18 * 2);
      }
      return;
    }
  }
