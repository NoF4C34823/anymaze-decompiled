...
void FUN_1409018e0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_14090211c:
      ...
      if ((longlong)param_5 < 0x1d) {
        ...
        uVar11 = uVar12 & 0x1f;
        if (uVar11 != 0) {
          if ((uVar12 & 3) != 0) goto LAB_14090211c;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 0x10)) goto LAB_14090211c;
        lStack_58 = param_2 * lVar9 + param_1;
        lStack_60 = param_2 * uVar18 + param_1;
        lStack_50 = param_2 * uVar10 + param_1;
        lStack_68 = param_2 * uVar17 + param_1;
...
LAB_140902188:
      ...
      if ((longlong)param_5 < 0x12c0) {
        ...
        if ((longlong)param_5 < (longlong)(uVar11 + 0x20)) goto LAB_140902188;
        lVar9 = param_2 * 5 + param_1;
        uVar13 = 0;
...
LAB_1409021a4:
    ...
    if ((longlong)param_5 < (longlong)(uVar11 + 0x20)) goto LAB_1409021a4;
    lVar9 = param_2 * 5 + param_1;
    uVar13 = 0;
    uVar10 = param_5 - (param_5 - uVar11 & 0x1f);
    if (uVar11 != 0) {
