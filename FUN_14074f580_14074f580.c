...
void FUN_14074f580(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1407502d8:
      ...
      uVar23 = param_2 & 0xf;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1407502d8;
        uVar23 = 0x10 - uVar23 >> 2;
      }
      if ((longlong)uVar11 < (longlong)(uVar23 + 8)) goto LAB_1407502d8;
...
LAB_1407502a1:
          uVar32 = 0;
          if (uVar11 == 0) goto LAB_14075006d;
          uVar34 = 0;
          uVar23 = uVar11;
        }
        else {
          uVar23 = param_2 & 0xf;
          if (uVar23 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1407502a1;
            uVar23 = 0x10 - uVar23 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar23 + 0x10)) goto LAB_1407502a1;
          uVar34 = 0;
          ...
          if (uVar11 < uVar32 + 1) goto LAB_14075006d;
...
LAB_14075006d:
  ...
  if (0xf < (longlong)uVar11) {
    uVar23 = param_2 & 0xf;
    if (uVar23 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140750296;
      uVar23 = 0x10 - uVar23 >> 2;
    }
    if ((longlong)(uVar23 + 0x10) <= (longlong)uVar11) {
      ...
      goto joined_r0x00014075023f;
    }
  }
LAB_140750296:
  uVar32 = 0;
joined_r0x00014075023f:
