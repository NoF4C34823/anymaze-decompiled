...
void FUN_1400a4560(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001400a55d2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086a60 + lVar7 * 8))(puVar23,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar15 < 0) goto LAB_1400a5560;
                while (uVar11 == 0) {
                  for (lVar22 = (lVar16 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_1400a5560:
                    if (uVar12 != 0) goto LAB_1400a5464;
                  }
...
LAB_1400a5464:
        ...
        *(ushort *)(param_11 + lVar13 * 2) = uVar21;
        lVar13 = lVar13 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001400a54c8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086a60 + lVar7 * 8))(param_11 + uVar14 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
...
LAB_1400a54dc:
              ...
              uVar17 = uVar10 & 0xf;
              if (uVar17 != 0) {
                if ((uVar10 & 1) != 0) goto LAB_1400a54dc;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_1400a54dc;
...
LAB_1400a49ff:
      if (uVar18 == 1) {
        if ((longlong)uVar14 < 1) goto LAB_1400a4c0d;
...
LAB_1400a553b:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a553b;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_1400a553b;
          uVar8 = 0;
...
LAB_1400a54e3:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a54e3;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_1400a54e3;
          uVar8 = 0;
          uVar20 = uVar14 - (uVar14 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_1400a4c0d:
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143086a60 + lVar7 * 8))(uVar10,param_4,uVar14,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001400a5538. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086a60 + lVar7 * 8))(puVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar14 < lVar16) {
    lVar16 = lVar16 - uVar14;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143086a60 + lVar7 * 8))(puVar23,param_4,lVar16,param_9,param_10);
...
LAB_1400a54ea:
          ...
          uVar10 = param_11 & 0xf;
          if (uVar10 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a54ea;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar10 + 8)) goto LAB_1400a54ea;
...
LAB_1400a5079:
  if (uVar18 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_1400a531b;
...
LAB_1400a54f9:
          ...
          uVar10 = uVar19 & 0xf;
          if (uVar10 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_1400a54f9;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar10 + 8)) goto LAB_1400a54f9;
          uVar17 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar14 < 1)) goto LAB_1400a531b;
  if ((longlong)uVar14 < 8) {
LAB_1400a54f1:
    uVar10 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_1400a54f1;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar14 < (longlong)(uVar19 + 8)) goto LAB_1400a54f1;
    uVar17 = 0;
...
LAB_1400a531b:
                    /* WARNING: Could not recover jumptable at 0x0001400a5354. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143086a60 + lVar7 * 8))(param_11 + uVar14 * 2,param_4,uVar14);
  return;
}
