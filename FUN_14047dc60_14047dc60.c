...
longlong FUN_14047dc60(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
    ...
    if (0 < param_5._4_4_) {
      do {
        ...
        FUN_140d177a0(param_9,uVar2,param_3,(longlong)(int)param_5,lVar5);
        lVar7 = lVar6 + 1;
        lVar8 = lVar8 + 1;
        param_1 = param_1 + lVar3 * 2;
        lVar6 = lVar7;
