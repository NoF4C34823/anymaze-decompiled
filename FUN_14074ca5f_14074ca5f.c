...
void FUN_14074ca5f(longlong param_1,undefined8 param_2,ulonglong param_3,undefined8 param_4)
  ...
  if (unaff_RBP + 1U <= param_3) {
    ...
    if ((longlong)param_3 < 4) {
      ...
      do {
        ...
        pfVar1 = (float *)(in_R9 + unaff_RBP * 4 + uVar5 * 4);
    ...
    if (uVar3 < param_3) {
      ...
      do {
        *(float *)(in_R9 + unaff_RBP * 4 + uVar3 * 4) =
