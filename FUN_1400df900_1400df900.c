...
void FUN_1400df900(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  uVar5 = param_6[2];
  uVar6 = param_6[3];
  lVar20 = (longlong)(int)lVar21 + 1;
  if (6 < lVar20) {
    lVar20 = lVar9;
  }
  lVar17 = (longlong)(int)lVar20 + 1;
  if (6 < lVar17) {
    lVar17 = lVar9;
  }
...
LAB_1400e0141:
      ...
      if ((longlong)param_5 < 0x3fd) {
        ...
        lStack_70 = param_2 * lVar15 + param_1;
        uVar11 = 0;
        lStack_60 = param_2 * lVar21 + param_1;
        lStack_50 = param_2 * lVar16 + param_1;
        lStack_58 = param_2 * lVar20 + param_1;
        lStack_48 = param_2 * lVar14 + param_1;
        lStack_68 = param_2 * lVar17 + param_1;
      }
      else {
        uVar11 = uVar10 & 0x1f;
        if (uVar11 != 0) {
          if ((uVar10 & 3) != 0) goto LAB_1400e0141;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 8)) goto LAB_1400e0141;
        lStack_78 = param_2 * lVar12 + param_1;
        lStack_70 = param_2 * lVar15 + param_1;
        lStack_60 = param_2 * lVar21 + param_1;
        lStack_50 = param_2 * lVar16 + param_1;
        ...
        if (uVar11 != 0) {
          uVar22 = 0;
          do {
            auVar8 = vfmadd231ss_fma(ZEXT416((uint)(fVar4 * (*(float *)(lStack_60 + uVar22 * 4) +
                                                            *(float *)(lStack_50 + uVar22 * 4)))),
                                     ZEXT416((uint)(*(float *)(lStack_78 + uVar22 * 4) +
                                                   *(float *)(lStack_70 + uVar22 * 4))),
                                     ZEXT416(uVar3));
            auVar8 = vfmadd231ss_fma(auVar8,ZEXT416((uint)(*(float *)(lStack_58 + uVar22 * 4) +
                                                          *(float *)(lStack_48 + uVar22 * 4))),
                                     ZEXT416(uVar5));
            auVar8 = vfmadd231ss_fma(auVar8,ZEXT416(uVar6),
                                     ZEXT416(*(uint *)(lStack_68 + uVar22 * 4)));
            *(int *)(uVar10 + uVar22 * 4) = auVar8._0_4_;
            uVar22 = uVar22 + 1;
          } while (uVar22 < uVar11);
        }
      }
      ...
      do {
        ...
        pfVar2 = (float *)(lStack_50 + uVar11 * 4);
        ...
        auVar8 = vfmadd231ps_fma(auVar7,auVar26,auVar23);
        ...
        auVar8 = vfmadd231ps_fma(ZEXT1632(auVar8),auVar27,auVar25);
        auVar8 = vfmadd231ps_fma(ZEXT1632(auVar8),auVar24,
                                 *(undefined1 (*) [32])(lStack_68 + uVar11 * 4));
        *(undefined1 (*) [32])(uVar10 + uVar11 * 4) = ZEXT1632(auVar8);
        uVar11 = uVar11 + 8;
      } while (uVar11 < uVar13);
    }
    if (uVar13 < param_5) {
      do {
        auVar8 = vfmadd231ss_fma(ZEXT416((uint)(fVar4 * (*(float *)(lVar21 * param_2 + param_1 +
                                                                   uVar13 * 4) +
        ...
        auVar8 = vfmadd231ss_fma(auVar8,ZEXT416((uint)(*(float *)(lVar20 * param_2 + param_1 +
                                                                 uVar13 * 4) +
                                                      *(float *)(lVar14 * param_2 + param_1 +
                                                                uVar13 * 4))),ZEXT416(uVar5));
        auVar8 = vfmadd231ss_fma(auVar8,ZEXT416(uVar6),
                                 ZEXT416(*(uint *)(lVar17 * param_2 + param_1 + uVar13 * 4)));
        *(int *)(param_2 * 7 + param_1 + uVar13 * 4) = auVar8._0_4_;
        uVar13 = uVar13 + 1;
...
LAB_1400e01db:
      ...
      if ((longlong)param_5 < 0x12c0) {
        uVar11 = param_5 & 0xffffffffffffffe0;
        uVar10 = 0;
        ...
        if ((longlong)param_5 < (longlong)(uVar10 + 0x20)) goto LAB_1400e01db;
        lVar12 = param_2 * 7 + param_1;
        uVar13 = 0;
        uVar11 = param_5 - (param_5 - uVar10 & 0x1f);
        if (uVar10 != 0) {
          do {
            ...
            uVar18 = (undefined1)iVar19;
            if (iVar19 < 1) {
              uVar18 = 0;
            }
            *(undefined1 *)(uVar13 + param_4) = uVar18;
            uVar13 = uVar13 + 1;
          } while (uVar13 < uVar10);
        }
      }
      do {
        ...
        auVar25 = vcvtps2dq_avx(*(undefined1 (*) [32])(lVar12 + 0x40 + uVar10 * 4));
        auVar7 = vcvtps2dq_avx(*(undefined1 (*) [32])(lVar12 + 0x60 + uVar10 * 4));
        auVar23 = vpackssdw_avx2(auVar23,auVar24);
        auVar24 = vpackssdw_avx2(auVar25,auVar7);
        auVar23 = vpermq_avx2(auVar23,0xd8);
        auVar24 = vpermq_avx2(auVar24,0xd8);
        auVar23 = vpackuswb_avx2(auVar23,auVar24);
        auVar23 = vpermq_avx2(auVar23,0xd8);
        *(undefined1 (*) [32])(uVar10 + param_4) = auVar23;
        uVar10 = uVar10 + 0x20;
      } while (uVar10 < uVar11);
    }
    if (param_5 < uVar11 + 1) {
    ...
    do {
      ...
      *(undefined1 *)(uVar10 + param_4 + uVar11) = uVar18;
      uVar10 = uVar10 + 1;
...
LAB_1400e01ff:
    ...
    if ((longlong)param_5 < (longlong)(uVar10 + 0x20)) goto LAB_1400e01ff;
    lVar12 = param_2 * 7 + param_1;
    uVar13 = 0;
    uVar11 = param_5 - (param_5 - uVar10 & 0x1f);
    if (uVar10 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar10 = param_5 & 0xfffffffffffffffc;
      do {
        auVar8 = vcvtps2dq_avx(*(undefined1 (*) [16])(lVar12 + uVar11 * 4 + uVar13 * 4));
        auVar8 = vpackssdw_avx(auVar8,auVar8);
        auVar8 = vpackuswb_avx(auVar8,auVar8);
        *(int *)(uVar13 + param_4 + uVar11) = auVar8._0_4_;
        uVar13 = uVar13 + 4;
