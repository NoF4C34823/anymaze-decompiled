...
void FUN_1401882e0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401893b7. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087c80 + lVar5 * 8))(pbVar20,param_4,*param_5);
    return;
  }
  if (uVar21 == 6) {
    uVar9 = (uint)*param_8;
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar22 < 2) {
                ...
                if (lVar12 < 0) goto LAB_140189340;
                while (uVar11 == 0) {
                  for (lVar6 = (lVar22 + -1) * 2 - lVar6; lVar6 < 0; lVar6 = -lVar6) {
LAB_140189340:
                    if (uVar9 != 0) goto LAB_140189243;
                  }
          ...
          bVar16 = bVar13;
          if (uVar17 != 0) goto LAB_140189243;
        }
        else {
LAB_140189243:
        ...
        *(byte *)(lVar14 + param_11) = bVar16;
        lVar14 = lVar14 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401892a3. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087c80 + lVar5 * 8))(param_11 + uVar19,param_4,lVar22,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar19 == 1) {
...
LAB_1401892b7:
              ...
              if ((longlong)uVar18 < (longlong)(uVar8 + 0x10)) goto LAB_1401892b7;
...
LAB_1401892c6:
              ...
              if ((longlong)uVar19 < (longlong)(uVar7 + 0x10)) goto LAB_1401892c6;
              uVar23 = 0;
...
LAB_1401892be:
          ...
          if ((longlong)uVar19 < (longlong)(uVar7 + 0x10)) goto LAB_1401892be;
          uVar23 = 0;
          uVar8 = uVar19 - (uVar19 - uVar7 & 0xf);
          if (uVar7 != 0) {
            do {
      ...
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143087c80 + lVar5 * 8))(lStack_78,param_4,uVar19,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014018931f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143087c80 + lVar5 * 8))(pbVar20,param_4,lVar22);
    return;
  }
  if ((longlong)uVar19 < lVar22) {
    lVar22 = lVar22 - uVar19;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143087c80 + lVar5 * 8))(pbVar20,param_4,lVar22,param_9,param_10);
...
LAB_1401892cd:
          ...
          if ((longlong)uVar18 < (longlong)(uVar7 + 0x10)) goto LAB_1401892cd;
...
LAB_140188e3d:
  if (uVar21 == 1) {
    if ((longlong)uVar19 < 1) goto LAB_1401890f1;
    if ((longlong)uVar19 < 7) {
      lVar22 = 1;
      if (uVar19 >> 1 != 0) {
...
LAB_1401892dd:
      ...
      if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_1401892dd;
      uVar8 = 0;
  ...
  if ((uVar21 != 6) || ((longlong)uVar19 < 1)) goto LAB_1401890f1;
  if ((longlong)uVar19 < 0x10) {
LAB_1401892d5:
    uVar7 = 0;
  }
    ...
    if ((longlong)uVar19 < (longlong)(uVar18 + 0x10)) goto LAB_1401892d5;
    uVar8 = 0;
    uVar7 = uVar19 - (uVar19 - uVar18 & 0xf);
    if (uVar18 != 0) {
      do {
...
LAB_1401890f1:
                    /* WARNING: Could not recover jumptable at 0x000140189131. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143087c80 + lVar5 * 8))(param_11 + uVar19,param_4,uVar19);
  return;
}
