...
void FUN_1407beac0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_1407becd9:
    ...
    uVar4 = param_2 & 0xf;
    if (uVar4 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407becd9;
      uVar4 = 0x10 - uVar4 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar4 + 8)) goto LAB_1407becd9;
    uVar5 = 0;
