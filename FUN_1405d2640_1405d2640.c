...
void FUN_1405d2640(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1405d2ec4:
      ...
      uVar45 = uVar44 & 0xf;
      if (uVar45 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_1405d2ec4;
        uVar45 = 0x10 - uVar45 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar45 + 4)) goto LAB_1405d2ec4;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar45 & 0xf;
      if (uVar44 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_1405d2ed2;
      ...
      if ((longlong)(uVar44 + 4) <= (longlong)param_5) {
        ...
        uVar35 = _UNK_14308b348;
        uVar36 = _UNK_14308b344;
        uVar37 = _DAT_14308b340;
        if (uVar44 != 0) {
          do {
...
LAB_1405d2e4d:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar44 = uVar45 & 0xf;
    if (uVar44 != 0) {
      if ((uVar45 & 3) != 0) goto LAB_1405d2ecb;
      uVar44 = 0x10 - uVar44 >> 2;
    }
