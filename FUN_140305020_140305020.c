...
void FUN_140305020(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar4 - 1U)) {
      while( true ) {
        FUN_142d21fa0(param_1,lVar2,lVar1,lVar6 << 2,4);
        lVar4 = param_6[1];
        lVar5 = lVar5 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_142d21fa0(param_1,lVar2,lVar1,*param_6 << 2,4);
