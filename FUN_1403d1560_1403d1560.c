...
void FUN_1403d1560(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
              ...
              if (0 < (longlong)param_7) {
                ...
                if (((lVar5 - 1U < param_7) && (*(char *)(param_9 + -1 + lVar5 + lVar9) != '\0')) &&
                   (fVar2 = *(float *)((lVar5 - 1U) * (longlong)param_11 * 4 +
                                       param_1 + lVar3 + lVar1 + lVar8 * 4), fVar2 <= fVar14)) {
                  fVar14 = fVar2;
                }
              }
              uVar10 = uVar10 + 1;
