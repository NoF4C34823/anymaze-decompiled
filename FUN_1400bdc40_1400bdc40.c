...
void FUN_1400bdc40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001400bee35. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086b60 + lVar30 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
...
LAB_1400bec90:
        ...
        *(byte *)(lVar28 + 2 + param_11) = bVar20;
        lVar28 = lVar28 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001400bed2f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086b60 + lVar30 * 8))(param_11 + lVar29 * 3,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar17 = lVar29 * 3;
...
LAB_1400bed32:
            ...
            if ((longlong)uVar13 < (longlong)(uVar10 + 0x10)) goto LAB_1400bed32;
            uVar21 = 0;
...
LAB_1400bde4f:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_143086b60 + lVar30 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001400bed7a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (0 < lVar30) {
      ...
      if ((longlong)uVar13 < 7) {
        ...
        if ((longlong)uVar13 < 0x10) {
          ...
          auVar6 = vpshufb_avx(auVar6,_DAT_143086c60);
          auVar4 = vpshufb_avx(auVar5,_DAT_143086c70);
          auVar6 = vpor_avx(auVar6,auVar4);
          auVar4 = vpshufb_avx(auVar31,_DAT_143086c80);
          auVar32 = vpshufb_avx(auVar5,_DAT_143086c90);
          auVar5 = vpshufb_avx(auVar5,_DAT_143086cc0);
          auVar31 = vpunpckhbw_avx(auVar31,auVar7);
          auVar4 = vpor_avx(auVar4,auVar32);
          auVar32 = vpshufb_avx(auVar7,_DAT_143086ca0);
          auVar31 = vpshufb_avx(auVar31,_DAT_143086cb0);
          auVar4 = vpor_avx(auVar4,auVar32);
...
LAB_1400beb54:
                    /* WARNING: Could not recover jumptable at 0x0001400beb82. Too many branches */
                    /* WARNING: Treating indirect jump as call */
