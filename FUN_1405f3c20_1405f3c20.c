...
void FUN_1405f3c20(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1405f43e3:
      ...
      uVar49 = uVar48 & 0xf;
      if (uVar49 != 0) {
        if ((uVar48 & 3) != 0) goto LAB_1405f43e3;
        uVar49 = 0x10 - uVar49 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar49 + 4)) goto LAB_1405f43e3;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar48 = uVar49 & 0xf;
      if (uVar48 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_1405f43f1;
...
LAB_1405f4382:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar48 = uVar49 & 0xf;
    if (uVar48 != 0) {
      if ((uVar49 & 3) != 0) goto LAB_1405f43ea;
      uVar48 = 0x10 - uVar48 >> 2;
    }
    if ((longlong)(uVar48 + 8) <= (longlong)param_5) {
      uVar46 = 0;
