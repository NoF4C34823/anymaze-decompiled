...
void FUN_1408ff760(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1408ffbbb:
      ...
      if ((longlong)param_5 < 0x1d) {
        ...
        uVar10 = param_4 & 0x1f;
        if (uVar10 != 0) {
          if ((param_4 & 3) != 0) goto LAB_1408ffbbb;
          uVar10 = 0x20 - uVar10 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar10 + 0x10)) goto LAB_1408ffbbb;
        lVar11 = param_2 * lVar12 + param_1;
        lVar13 = param_2 * uVar8 + param_1;
        lVar14 = param_2 * uVar9 + param_1;
  ...
  if (7 < (longlong)param_5) {
    uVar10 = param_4 & 0x1f;
    if (uVar10 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1408ffbf5;
      uVar10 = 0x20 - uVar10 >> 2;
    }
