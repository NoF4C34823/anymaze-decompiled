...
void FUN_1403978a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar3 - 1)) {
      while( true ) {
        FUN_14036ade0(lVar15,lVar13,uVar9,uVar6,3);
        uVar3 = param_6[1];
        lVar11 = lVar11 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_14036ade0(lVar15,lVar13,uVar9,*param_6,3);
                  ...
                  if (uVar6 >> 1 != 0) {
                    do {
                      ...
                      if ((*(char *)(param_7 + lVar11 + 1 + uVar2 * 2) != '\0') &&
                         ...
                         lVar12 = uVar2 * 6 + uVar4 + 3 + lVar15, bVar5 < *(byte *)(lVar12 + lVar10)
                         )) {
