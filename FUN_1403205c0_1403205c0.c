...
void FUN_1403205c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)(int)param_5) {
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              for (; uVar21 < uVar31; uVar21 = uVar21 + 1) {
                bVar42 = *(byte *)(uVar21 + uVar32);
                if (bVar41 <= *(byte *)(uVar21 + uVar32)) {
                  bVar42 = bVar41;
                }
                bVar41 = bVar42;
              }
    ...
    if (0 < param_5._4_4_) {
      ...
      do {
        ...
        if (0 < (longlong)uVar32) {
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              for (; uVar37 < uVar31; uVar37 = uVar37 + 1) {
                bVar42 = *(byte *)(uVar37 + uVar24);
                if (bVar41 <= *(byte *)(uVar37 + uVar24)) {
                  bVar42 = bVar41;
                }
                bVar41 = bVar42;
              }
        ...
        FUN_140328840(param_9,uVar20,param_3,uVar32,lVar28);
        uVar26 = uVar26 + 1;
        uVar36 = uVar36 + 1;
                    ...
                    if (uVar21 != 0) {
                      do {
                        if ((*(char *)(uVar33 + uVar32) != '\0') &&
                           (bVar42 = *(byte *)(lVar29 + uVar36 + uVar33), bVar42 < bVar41)) {
                          bVar41 = bVar42;
                        }
                        uVar33 = uVar33 + 1;
                      } while (uVar33 < uVar21);
