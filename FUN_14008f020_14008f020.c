...
void FUN_14008f020(longlong param_1,ulonglong param_2,longlong param_3,undefined1 (*param_4) [16])

{
  ...
  if (3 < (longlong)uVar6) {
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14008f30e;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)(uVar8 + 4) <= (longlong)uVar6) {
      ...
      goto joined_r0x00014008f25b;
    }
  }
LAB_14008f30e:
  uVar10 = 0;
joined_r0x00014008f25b:
