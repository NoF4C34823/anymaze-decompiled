...
void FUN_1403d4220(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  uVar5 = (longlong)(int)param_5 * 4;
  uVar2 = uVar5 + 7 & 0xfffffffffffffff8;
  lVar4 = (lVar17 * 4 + lVar13 * lVar14) * -4 + param_1;
  if (param_7 == 0) {
    lVar19 = 0;
    ...
    if (lVar17 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403bffa0(lVar4,lVar14,uVar5,(longlong)(int)param_6,4);
        lVar19 = lVar19 + 1;
        lVar4 = lVar4 + lVar13 * 4;
        lVar14 = lVar14 + uVar2 * 4;
      } while (lVar19 < lVar17);
    }
    lVar19 = 0;
    if (0 < param_5._4_4_) {
      do {
        FUN_1403bffa0(lVar4,lVar14,uVar5,(longlong)(int)param_6,4);
        thunk_FUN_142d25930(param_9,uVar2,param_3,uVar5,(longlong)param_6._4_4_);
        lVar17 = lVar17 + 1;
        lVar19 = lVar19 + 1;
        lVar14 = lVar14 + uVar2 * 4;
    ...
    if (0 < param_5._4_4_) {
      ...
      do {
        uVar7 = 0;
        if (0 < (longlong)uVar5) {
          uVar3 = (ulonglong)(int)param_6;
          do {
            uVar11 = 0;
            lVar12 = 0;
            lVar15 = 0;
            lVar16 = 0;
            fVar20 = DAT_143089e30;
            if (0 < param_6._4_4_) {
              lVar8 = uVar7 * 4 + param_1 + lVar4 + lVar17 + lVar14 + lVar18;
              do {
                if (0 < (longlong)uVar3) {
                  uVar9 = 0;
                  lVar10 = 1;
                  ...
                  if ((ulonglong)(longlong)(int)param_6 >> 1 != 0) {
                    do {
                      if ((*(char *)(param_7 + lVar12 + uVar9 * 2) != '\0') &&
                         (fVar1 = *(float *)(lVar6 + lVar8 + lVar16), fVar1 <= fVar20)) {
                        fVar20 = fVar1;
                      }
                      if ((*(char *)(param_7 + lVar12 + 1 + uVar9 * 2) != '\0') &&
                         (fVar1 = *(float *)(lVar6 + 0x10 +
                                            uVar7 * 4 + lVar17 + lVar4 + param_1 + lVar14 + lVar18 +
                                            lVar16), fVar1 <= fVar20)) {
                        fVar20 = fVar1;
                      }
                      uVar9 = uVar9 + 1;
                  ...
                  if (((lVar10 - 1U < uVar3) && (*(char *)(param_7 + -1 + lVar10 + lVar12) != '\0'))
                     && (fVar1 = *(float *)((lVar10 - 1U) * 0x10 + lVar8 + lVar15 * 4),
                        fVar1 <= fVar20)) {
                    fVar20 = fVar1;
                  }
                }
        ...
        lVar18 = lVar18 + lVar4;
      } while (uVar2 < (ulonglong)(longlong)param_5._4_4_);
    }
  }
  return;
}
