...
void FUN_1406c5f60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1406c642d:
      ...
      uVar30 = uVar28 & 0xf;
      if (uVar30 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1406c642d;
        uVar30 = 0x10 - uVar30 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar30 + 8)) goto LAB_1406c642d;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar30 = uVar28 & 0xf;
      if (uVar30 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_1406c643c;
        uVar30 = 0x10 - uVar30 >> 2;
      }
...
LAB_1406c63e4:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar30 = uVar28 & 0xf;
    if (uVar30 != 0) {
      if ((uVar28 & 3) != 0) goto LAB_1406c6435;
      uVar30 = 0x10 - uVar30 >> 2;
    }
    if ((longlong)(uVar30 + 8) <= (longlong)param_5) {
      uVar29 = 0;
