...
void FUN_14087f260(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_14087fc74:
      uVar49 = 0;
      if (uVar51 == 0) goto LAB_14087f4a7;
      uVar48 = 0;
      uVar50 = uVar51;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14087fc74;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_14087fc74;
      uVar48 = 0;
      ...
      if (uVar50 != 0) {
        do {
          *(float *)(param_2 + uVar48 * 4) =
               fVar6 * (float)((uint)*(ushort *)(lVar45 + uVar48 * 2) +
                              (uint)*(ushort *)(lVar57 + uVar48 * 2));
          uVar48 = uVar48 + 1;
        } while (uVar48 < uVar50);
      }
      ...
      if (uVar51 < uVar49 + 1) goto LAB_14087f4a7;
    ...
    if (uVar48 < uVar50) {
      do {
        *(float *)(param_2 + uVar49 * 4 + uVar48 * 4) =
             fVar6 * (float)((uint)*(ushort *)(lVar44 * -6 + param_1 + uVar49 * 2 + uVar48 * 2) +
                            (uint)*(ushort *)(param_1 + lVar44 * 6 + uVar49 * 2 + uVar48 * 2));
        uVar48 = uVar48 + 1;
      } while (uVar48 < uVar50);
    }
  }
      ...
      do {
        ...
        if (0 < (longlong)uVar51) {
            ...
            if (uVar50 != 0) {
              do {
                *(float *)(param_2 + uVar53 * 4) =
                     fVar6 * (float)((uint)*(ushort *)(lVar55 + 6) + (uint)*(ushort *)(lVar54 + -6))
                     + *(float *)(param_2 + uVar53 * 4) +
                     fVar69 * (float)((uint)*(ushort *)(lVar55 + 0xc) +
                                     (uint)*(ushort *)(lVar54 + -0xc));
                uVar53 = uVar53 + 1;
                lVar54 = lVar54 + 2;
                lVar55 = lVar55 + 2;
              } while (uVar53 < uVar50);
          ...
          if (uVar56 < uVar51) {
            ...
            do {
              puVar1 = (ushort *)(lVar54 + 6);
              puVar2 = (ushort *)(lVar55 + -6);
              puVar3 = (ushort *)(lVar55 + -0xc);
              puVar4 = (ushort *)(lVar54 + 0xc);
              lVar54 = lVar54 + 2;
              lVar55 = lVar55 + 2;
              *(float *)(param_2 + uVar56 * 4) =
                   fVar6 * (float)((uint)*puVar1 + (uint)*puVar2) + *(float *)(param_2 + uVar56 * 4)
...
LAB_14087fc4e:
          uVar49 = 0;
          if (uVar51 == 0) goto LAB_14087fa6f;
          uVar48 = 0;
          uVar50 = uVar51;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14087fc4e;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_14087fc4e;
          uVar49 = uVar51 - (uVar51 - uVar50 & 0xf);
          ...
          if (uVar50 != 0) {
            do {
              *(float *)(param_2 + uVar48 * 4) =
                   fVar6 * (float)((uint)*(ushort *)(lStack_70 + uVar48 * 2) +
                                  (uint)*(ushort *)(lVar46 + uVar48 * 2)) +
                   *(float *)(param_2 + uVar48 * 4);
              uVar48 = uVar48 + 1;
            } while (uVar48 < uVar50);
          }
          ...
          if (uVar51 < uVar49 + 1) goto LAB_14087fa6f;
          uVar50 = uVar51 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar48 = 0;
          }
        ...
        if (uVar48 < uVar50) {
          ...
          do {
            ...
            lVar54 = uVar48 * 2;
            uVar48 = uVar48 + 1;
            *pfVar47 = fVar6 * (float)((uint)*(ushort *)
                                              (lVar45 + lVar57 * 6 + param_1 + uVar49 * 2 + lVar46)
                                      + (uint)*(ushort *)
                                               (param_1 + lVar57 * -6 + lVar44 * 6 + uVar49 * 2 +
                                               lVar54)) + *pfVar47;
            pfVar47 = pfVar47 + 1;
          } while (uVar48 < uVar50);
        }
...
LAB_14087fc3a:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14087fc3a;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)uVar51 < (longlong)(uVar50 + 0x10)) goto LAB_14087fc3a;
    uVar48 = 0;
    uVar49 = uVar51 - (uVar51 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
        *(float *)(param_2 + uVar48 * 4) =
             fVar6 * (float)*(ushort *)(lStack_70 + 6 + uVar48 * 2) +
             *(float *)(param_2 + uVar48 * 4);
        uVar48 = uVar48 + 1;
      } while (uVar48 < uVar50);
    }
...
LAB_14087fbe4:
  if (uVar50 < uVar51) {
    ...
    do {
      lVar44 = uVar50 * 2;
      uVar50 = uVar50 + 1;
      *pfVar47 = fVar6 * (float)*(ushort *)(lStack_70 + uVar49 * 2 + 6 + lVar44) + *pfVar47;
      pfVar47 = pfVar47 + 1;
    } while (uVar50 < uVar51);
  }
  return;
