...
void FUN_140547c7b(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
                  longlong param_4)

{
  ...
  do {
    ...
    if (lVar9 != 0) {
      ...
      auVar11 = vminps_avx(*pauVar4,*pauVar6);
      pauVar10 = (undefined1 (*) [32])(*pauVar4 + in_R10 * 8);
      auVar11 = vminps_avx(auVar11,*pauVar10);
      lVar3 = 0;
      auVar12 = auVar11;
      if (1 < lVar9) {
        do {
          lVar3 = lVar3 + 1;
          auVar11 = vminps_avx(pauVar4[1],
                               *(undefined1 (*) [32])(pauVar4[1] + lStack0000000000000058));
          auVar11 = vminps_avx(auVar11,*(undefined1 (*) [32])(pauVar4[1] + lStack0000000000000050));
          pauVar4 = pauVar4 + 1;
      ...
      auVar11 = vminps_avx(auVar14,auVar11);
      auVar11 = vminps_avx(auVar12,auVar11);
      *pauVar7 = auVar11;
    }
    if ((uVar8 & 7) != 0) {
      FUN_140547e80(pauVar4);
    }
    in_RAX = in_RAX + 1;
