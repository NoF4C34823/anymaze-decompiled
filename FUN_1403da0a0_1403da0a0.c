...
void FUN_1403da0a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar3 - 1)) {
      while( true ) {
        FUN_1403db020(lVar15,lVar13,uVar9,uVar6,4);
        uVar3 = param_6[1];
        lVar11 = lVar11 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_1403db020(lVar15,lVar13,uVar9,*param_6,4);
                  ...
                  if (uVar6 >> 1 != 0) {
                    do {
                      ...
                      if ((*(char *)(param_7 + lVar11 + 1 + uVar2 * 2) != '\0') &&
                         ...
                         lVar12 = uVar4 + uVar2 * 8 + 4 + lVar15, *(byte *)(lVar12 + lVar10) < bVar5
                         )) {
