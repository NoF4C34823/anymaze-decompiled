...
void FUN_14094f425(longlong param_1,ulonglong param_2,longlong param_3,undefined4 param_4)

{
  ...
  if (param_1 + 1U <= param_2) {
    ...
    if (uVar9 < param_2) {
      ...
      do {
        auVar11._0_4_ = (float)*(ushort *)(lVar1 + uVar9 * 2);
        auVar11._4_8_ = SUB128(ZEXT812(0),4);
        auVar11._12_4_ = 0;
        auVar13._0_4_ =
             (float)((uint)*(ushort *)(lVar1 + -0xc + uVar9 * 2) +
                    (uint)*(ushort *)(lVar1 + 0xc + uVar9 * 2));
        ...
        auVar12 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM5_Da *
                                                (float)((uint)*(ushort *)(lVar1 + -6 + uVar9 * 2) +
                                                       (uint)*(ushort *)(lVar1 + 6 + uVar9 * 2)))),
                                  auVar13,auVar8);
