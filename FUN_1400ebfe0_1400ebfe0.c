...
void FUN_1400ebfe0(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1400ec0ef;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x0001400ec30e;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_1400ec0ef;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x0001400ec30e:
      if (uVar2 != 0) goto LAB_1400ec0ef;
      uVar3 = *param_5;
      fVar7 = (float)*param_8;
      if ((longlong)uVar3 < 1) {
        return;
...
LAB_1400ec2bb:
        ...
        if ((longlong)uVar3 < 0x1d) {
          ...
          uVar6 = param_4 & 0x1f;
          if (uVar6 != 0) {
            if ((param_4 & 3) != 0) goto LAB_1400ec2bb;
            uVar6 = 0x20 - uVar6 >> 2;
          }
          if ((longlong)uVar3 < (longlong)(uVar6 + 0x10)) goto LAB_1400ec2bb;
          uVar5 = 0;
...
LAB_1400ec0ef:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_1400f59c0(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
