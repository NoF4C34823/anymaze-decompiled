...
void FUN_1407b9f40(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1407babf6:
      ...
      uVar24 = param_2 & 0xf;
      if (uVar24 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1407babf6;
        uVar24 = 0x10 - uVar24 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar24 + 8)) goto LAB_1407babf6;
      uVar28 = 0;
...
LAB_1407babc0:
          uVar26 = 0;
          if (param_3 == 0) goto LAB_1407ba9ad;
          uVar28 = 0;
          uVar24 = param_3;
        }
        else {
          uVar24 = param_2 & 0xf;
          if (uVar24 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1407babc0;
            uVar24 = 0x10 - uVar24 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar24 + 0x10)) goto LAB_1407babc0;
          ...
          if (param_3 < uVar26 + 1) goto LAB_1407ba9ad;
...
LAB_1407ba9ad:
  ...
  if (0xf < (longlong)param_3) {
    uVar24 = param_2 & 0xf;
    if (uVar24 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407babb5;
      uVar24 = 0x10 - uVar24 >> 2;
    }
    if ((longlong)(uVar24 + 0x10) <= (longlong)param_3) {
      ...
      goto joined_r0x0001407bab78;
    }
  }
LAB_1407babb5:
  uVar26 = 0;
joined_r0x0001407bab78:
