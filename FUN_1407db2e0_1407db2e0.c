...
undefined8
FUN_1407db2e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,ulonglong *param_5
...

{
  ...
  if ((0 < (longlong)param_5[1]) && (0 < (longlong)uVar1)) {
    ...
    if ((2 < (int)uVar3) && ((uVar3 & 1) != 0)) {
      ...
      pcStack_b0 = (code *)(&PTR_FUN_14308c4a0)[uVar7];
      if (0x7ffff < lVar8) {
        aiStack_108[0] = 0;
        uStack_118 = uVar7;
        uStack_110 = lVar8;
        FUN_1420dd400(aiStack_108);
        uStack_60 = (uint)((longlong)aiStack_108[0] <= (longlong)uStack_110);
        uVar7 = uStack_118;
      }
      lVar8 = (longlong)(int)uVar3;
      pcVar2 = (code *)(&PTR_FUN_14308c3a0)[uVar7];
      ...
      if (param_6 == 0xf0) {
        ...
        lVar5 = param_7;
        FUN_1407d1380(param_1,param_2,lStack_a8,uStack_80,&uStack_118,uVar7 & 0xffffffff,param_6,
        ...
        if ((param_6 & 0xc0) == 0xc0) {
          ...
          if (0 < (longlong)(uVar7 - uVar9)) {
            do {
              ...
              uStack_d0 = (undefined4)param_5[1];
              uStack_cc = *(undefined4 *)((longlong)param_5 + 0xc);
              FUN_1407d1f80(lStack_a0,lStack_70,uVar9,uStack_80 * lVar8 + lStack_a8,&pcStack_d8,
        ...
        if (lVar10 < (longlong)uVar7) {
          do {
            uStack_c8 = (undefined4)*param_5;
            uStack_c4 = *(undefined4 *)((longlong)param_5 + 4);
            uStack_c0 = (undefined4)param_5[1];
            uStack_bc = *(undefined4 *)((longlong)param_5 + 0xc);
            FUN_1407cd940(lStack_a0,lStack_70,uStack_68 + lVar10,uStack_80 * lVar5 + lStack_a8,
