...
/* WARNING: Removing unreachable block (ram,0x0001400a0003) */

void FUN_14009eb60(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  lStack_78 = param_2;
  if (iVar12 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1400a0360;
  }
  else {
    ...
    lStack_70 = param_4;
    do {
      puStack_1a8 = (ulonglong *)&uStack_98;
      uStack_98 = (undefined4)*puStack_88;
      uStack_94 = *(undefined4 *)((longlong)puStack_88 + 4);
      uStack_90 = (undefined4)puStack_88[1];
      uStack_8c = *(undefined4 *)((longlong)puStack_88 + 0xc);
      iStack_1a0 = param_6;
      uStack_198 = param_7;
      puStack_190 = param_8;
      uStack_188 = param_9;
      uStack_180 = param_10;
      lStack_178 = param_11;
      FUN_14073bb00(lStack_80,lStack_78,lVar10,lVar8);
      uVar15 = uStack_68;
      lVar10 = lVar10 + 1;
    ...
    if ((param_7 & 0x10) != 0) {
      pcStack_d0 = *(code **)(&UNK_143086b00 + (longlong)param_6 * 8);
      uVar9 = (ulonglong)(int)param_10;
      uVar4 = param_7 & 0xf;
      lStack_108 = uStack_68 * 3;
      lStack_138 = 0;
      lStack_80 = lStack_80 - lStack_78 * uStack_68;
      lStack_b0 = uVar9 - 1;
      lStack_148 = uVar9 * 3;
      ...
      do {
        uStack_58 = 0;
        uStack_50 = 0;
        lVar7 = lStack_70 * uVar14 + uStack_a0;
        lVar8 = lStack_78 * uVar14 + lStack_80;
        uVar19 = (undefined4)uVar9;
        if (uStack_a8 == 0xf0) {
          puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar19);
          (*pcStack_d0)(lVar8,lVar7,*puStack_88,param_9);
        }
        else {
          uVar11 = *puStack_88;
          puVar18 = &uStack_58;
            ...
            if (lStack_c0 < (longlong)(uVar15 + uVar11)) {
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar4 == 6) {
                      if (uStack_d8 == 0) goto LAB_1400a02cb;
                    }
                    else {
                      if (uVar4 != 1) goto LAB_1400a0243;
LAB_1400a03c4:
                      lVar16 = 0;
                      if (uStack_d8 != 0) {
                        lVar16 = lVar10;
...
LAB_1400a02ac:
                  uVar19 = *(undefined4 *)(lVar8 + lVar16 * 0xc);
                  uVar20 = *(undefined4 *)(lVar8 + 4 + lVar16 * 0xc);
                  uVar21 = *(undefined4 *)(lVar8 + 8 + lVar16 * 0xc);
                }
                else {
                  if ((lVar10 < (longlong)uVar11) || (param_7 == 0xf0)) goto LAB_1400a02ac;
                  if (uVar4 != 6) {
                    if (uVar4 == 1) {
                      if (lVar10 < 0) goto LAB_1400a03c4;
                      if (uStack_b8 == 0) {
                        lVar16 = uVar11 - 1;
                      }
                    }
...
LAB_1400a03e0:
                  ...
                  if (uStack_b8 != 0) goto LAB_1400a02ac;
LAB_1400a02cb:
            ...
            (*pcStack_d0)(puStack_c8,lVar7,uVar11,param_9);
          }
          else {
            if (uStack_d8 == 0) {
              if (0 < (longlong)uStack_f0) {
                if (6 < (longlong)uStack_f0) {
                  ...
                  lVar16 = lStack_78 * lVar10 + lStack_80;
                ...
                lVar6 = 1;
                if (uStack_118 != 0) {
                  lVar6 = lStack_78 * lVar10 + lStack_80;
                  uVar13 = 0;
                  do {
                    uVar5 = uVar13;
                ...
                if (uVar13 < uStack_110) {
                  puStack_c8[uVar13] = *(undefined4 *)(lVar10 * lStack_78 + lStack_80 + uVar13 * 4);
                }
              }
LAB_14009f72f:
              if (uVar4 == 1) {
                ...
                if (0 < lStack_108) {
                  ...
                  if (lVar10 - 1U < uStack_160) {
                    lVar6 = -((lVar10 - 1U) * 8 + -4 + lVar10 * 4);
                    lVar10 = lVar10 * 3 + -3;
                    *(undefined4 *)(param_11 + lVar10 * 4) =
                         *(undefined4 *)(lVar6 + -0xc + lStack_150);
...
LAB_14009fbd2:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar19);
              (*pcStack_d0)(puStack_c8,lVar7,uVar15);
              ...
              if (0 < (longlong)uStack_f0) {
                ...
                if (uStack_e8 != 0) {
                  ...
                  do {
                    ...
                    *(undefined4 *)(param_11 + uVar13 * 8) =
                         *(undefined4 *)(lStack_100 + lVar8 + uVar13 * 8);
                    *(undefined4 *)(param_11 + 4 + uVar13 * 8) =
                         *(undefined4 *)(lStack_100 + lVar8 + 4 + uVar13 * 8);
                    uVar11 = uVar13 + 1;
                ...
                if (uVar11 < uStack_e0) {
                  *(undefined4 *)(param_11 + uVar11 * 4) =
                       *(undefined4 *)(lVar8 + lStack_100 + uVar11 * 4);
                }
              }
              if (uVar4 == 1) {
                if (0 < lStack_108) {
                  if ((longlong)uStack_158 / 3 < 7) {
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar13 = uVar11;
                        uVar11 = uVar13 + 1;
                        *(undefined4 *)(lVar8 + -0xc + lStack_150) =
                             *(undefined4 *)(lStack_150 + -0x18);
                        *(undefined4 *)(lVar8 + -8 + lStack_150) =
                             *(undefined4 *)(lStack_150 + -0x14);
                        *(undefined4 *)(lVar8 + -4 + lStack_150) =
                             *(undefined4 *)(lStack_150 + -0x10);
                        *(undefined4 *)(lVar8 + lStack_150) = *(undefined4 *)(lStack_150 + -0x18);
                        *(undefined4 *)(lVar8 + 4 + lStack_150) =
                             *(undefined4 *)(lStack_150 + -0x14);
                        *(undefined4 *)(lVar8 + 8 + lStack_150) =
                             *(undefined4 *)(lStack_150 + -0x10);
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar13 = uVar11;
                        uVar11 = uVar13 + 1;
                        *(undefined4 *)(lVar8 + -0xc + lStack_150) = uVar20;
                        *(undefined4 *)(lVar8 + -8 + lStack_150) = uVar21;
                        *(undefined4 *)(lVar8 + -4 + lStack_150) = uVar3;
                        *(undefined4 *)(lVar8 + lStack_150) = uVar20;
                        *(undefined4 *)(lVar8 + 4 + lStack_150) = uVar21;
                        *(undefined4 *)(lVar8 + 8 + lStack_150) = uVar3;
                        lVar8 = lVar8 + 0x18;
                      } while (uVar11 < uStack_140);
                      lVar10 = uVar13 + 2 + uVar11;
                    }
                ...
                if (0 < lStack_108) {
                  ...
                  if (uStack_140 != 0) {
                    do {
                      ...
                      uVar11 = uVar13 + 1;
                      *(undefined4 *)(lVar6 + -0xc + lStack_150) =
                           *(undefined4 *)(lVar8 + -0x24 + lStack_150);
                      *(undefined4 *)(lVar6 + -8 + lStack_150) =
                           *(undefined4 *)(lVar8 + -0x20 + lStack_150);
                      *(undefined4 *)(lVar6 + -4 + lStack_150) =
                           *(undefined4 *)(lVar8 + -0x1c + lStack_150);
                      *(undefined4 *)(lVar6 + lStack_150) =
                           *(undefined4 *)(lVar8 + -0x30 + lStack_150);
                      *(undefined4 *)(lVar6 + 4 + lStack_150) =
                           *(undefined4 *)(lVar8 + -0x2c + lStack_150);
                      lVar10 = lVar8 + -0x28;
                      lVar8 = lVar8 + -0x18;
                ...
                if (6 < (longlong)uStack_158 / 3) {
                  lVar10 = ((longlong)uStack_158 / 3) * 0xc;
                  lVar8 = (longlong)puVar18 + (4 - (lStack_150 + -0xc));
                  if (((lVar10 <= lVar8) || (7 < -lVar8)) &&
                     ((lVar8 = (lStack_150 + -0xc) - (longlong)puVar18, 3 < lVar8 ||
                      (lVar10 <= -lVar8)))) {
                    lVar10 = 1;
                    uVar20 = *(undefined4 *)puVar18;
                    uVar21 = *(undefined4 *)((longlong)puVar18 + 4);
                ...
                if (uStack_140 != 0) {
                  do {
                    uVar13 = uVar11;
                    uVar11 = uVar13 + 1;
                    *(undefined4 *)(lVar8 + -0xc + lStack_150) = *(undefined4 *)puVar18;
                    *(undefined4 *)(lVar8 + -8 + lStack_150) =
                         *(undefined4 *)((longlong)puVar18 + 4);
                    *(undefined4 *)(lVar8 + -4 + lStack_150) = *(undefined4 *)(puVar18 + 1);
                    *(undefined4 *)(lVar8 + lStack_150) = *(undefined4 *)puVar18;
                    *(undefined4 *)(lVar8 + 4 + lStack_150) = *(undefined4 *)((longlong)puVar18 + 4)
                    ;
                    *(undefined4 *)(lVar8 + 8 + lStack_150) = *(undefined4 *)(puVar18 + 1);
                    lVar8 = lVar8 + 0x18;
                  } while (uVar11 < uStack_140);
                  lVar10 = uVar13 + 2 + uVar11;
                }
...
LAB_1400a0174:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar19);
              (*pcStack_d0)(puStack_c8,lVar7,uVar15,param_9);
            }
            else {
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar19);
              (*pcStack_d0)(lVar8,lVar7,uVar11,param_9);
            }
          }
        }
        iVar12 = (int)uVar14;
      ...
      do {
        if (0 < (longlong)uVar14) {
          ...
          if (3 < (longlong)uVar14) {
            ...
            uVar13 = uVar5 & 0xf;
            if (uVar13 != 0) {
              if ((uVar5 & 3) != 0) goto LAB_14009efd2;
...
LAB_14009efd2:
    ...
    if (uVar4 == 3) {
      uStack_168 = *puStack_88;
      uStack_160 = puStack_88[1];
      ...
      lStack_178 = param_11;
      uStack_180 = param_10;
      FUN_14073bb00((int)*puStack_88,lStack_78,(longlong)iVar12,param_3);
      lVar10 = 1;
      uVar15 = 0;
      if (1 < iVar12) {
        uVar9 = 0;
        ...
        do {
          if (0 < (longlong)uVar14) {
            ...
            if (3 < (longlong)uVar14) {
              ...
              uVar5 = uVar13 & 0xf;
              if (uVar5 != 0) {
                if ((uVar13 & 3) != 0) goto LAB_14009ee71;
                uVar5 = 0x10 - uVar5 >> 2;
              }
