...
void FUN_14020c560(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14020d028:
      ...
      if ((longlong)param_3 < 0x1d) {
        ...
        uVar25 = param_2 & 0x1f;
        if (uVar25 != 0) {
          if ((param_2 & 3) != 0) goto LAB_14020d028;
          uVar25 = 0x20 - uVar25 >> 2;
        }
        if ((longlong)param_3 < (longlong)(uVar25 + 0x10)) goto LAB_14020d028;
        lVar18 = lVar29 * -2 + param_1;
        uVar22 = 0;
        ...
        if (uVar25 != 0) {
          do {
            *(float *)(param_2 + uVar22 * 4) =
                 fVar5 * (float)((uint)*(ushort *)(lVar18 + uVar22 * 2) +
                                (uint)*(ushort *)(lVar28 + uVar22 * 2));
            uVar22 = uVar22 + 1;
          } while (uVar22 < uVar25);
        }
      }
      do {
        ...
        auVar16 = vpmovzxwd_avx2(auVar46._0_16_);
        auVar47 = vpmovzxwd_avx2(auVar50._0_16_);
        auVar16 = vpaddd_avx2(auVar16,auVar47);
        auVar16 = vcvtdq2ps_avx(auVar16);
        auVar46 = vpmovzxwd_avx2(auVar46._16_16_);
        auVar50 = vpmovzxwd_avx2(auVar50._16_16_);
      ...
      if (uVar22 < uVar25) {
        do {
          *(float *)(param_2 + uVar20 * 4 + uVar22 * 4) =
               fVar5 * (float)((uint)*(ushort *)(lVar29 * -2 + param_1 + uVar20 * 2 + uVar22 * 2) +
                              (uint)*(ushort *)(param_1 + lVar29 * 2 + uVar20 * 2 + uVar22 * 2));
          uVar22 = uVar22 + 1;
        } while (uVar22 < uVar25);
      }
    }
        ...
        if (0 < (longlong)param_3) {
          if (((longlong)param_3 < 0x10) ||
            ...
            if (uVar20 != 0) {
              do {
                auVar34._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 4) + (uint)*(ushort *)(lVar32 + -4));
                auVar34._4_8_ = SUB128(ZEXT812(0),4);
                auVar34._12_4_ = 0;
                auVar40._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 2) + (uint)*(ushort *)(lVar32 + -2));
            ...
            do {
              ...
              auVar47 = vpmovzxwd_avx2(auVar16._0_16_);
              auVar48 = vpmovzxwd_avx2(SUB3216(*(undefined1 (*) [32])(lVar31 + 2),0));
              auVar17 = vpmovzxwd_avx2(SUB3216(*(undefined1 (*) [32])(lVar31 + 2),0x10));
              auVar16 = vpmovzxwd_avx2(auVar16._16_16_);
              ...
              auVar47 = vpmovzxwd_avx2(SUB3216(*pauVar1,0));
              auVar48 = vpmovzxwd_avx2(SUB3216(*pauVar1,0x10));
              auVar17 = vpmovzxwd_avx2(auVar16._0_16_);
          ...
          if (uVar33 + 1 <= param_3) {
            ...
            if (uVar30 < uVar20) {
              ...
              do {
                lVar4 = uVar30 * 2;
                auVar36._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 4 + uVar30 * 2) +
                            (uint)*(ushort *)(lVar32 + -4 + uVar30 * 2));
                auVar36._4_8_ = SUB128(ZEXT812(0),4);
                auVar36._12_4_ = 0;
                lVar3 = uVar30 * 2;
                uVar30 = uVar30 + 1;
                auVar42._0_4_ =
                     (float)((uint)*(ushort *)(lVar31 + 2 + lVar3) +
                            (uint)*(ushort *)(lVar32 + -2 + lVar4));
...
LAB_14020d00a:
          ...
          uVar20 = param_2 & 0x1f;
          if (uVar20 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14020d00a;
            uVar20 = 0x20 - uVar20 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar20 + 0x10)) goto LAB_14020d00a;
          ...
          if (uVar20 != 0) {
            do {
              auVar43._0_4_ =
                   (float)((uint)*(ushort *)(lVar26 + uVar22 * 2) +
                          (uint)*(ushort *)(lVar19 + uVar22 * 2));
          ...
          do {
            ...
            auVar16 = vpmovzxwd_avx2(auVar46._0_16_);
            auVar48 = vpmovzxwd_avx2(auVar50._0_16_);
        ...
        if (uVar25 + 1 <= param_3) {
          ...
          if (uVar22 < uVar20) {
            ...
            do {
              auVar45._0_4_ =
                   (float)((uint)*(ushort *)
                                  (lVar18 + lVar28 * 2 + param_1 + uVar25 * 2 + uVar22 * 2) +
                          (uint)*(ushort *)
                                 (param_1 + lVar28 * -2 + lVar29 * 2 + uVar25 * 2 + uVar22 * 2));
  ...
  if (0xf < (longlong)param_3) {
    uVar20 = param_2 & 0x1f;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14020cffb;
      uVar20 = 0x20 - uVar20 >> 2;
    }
    if ((longlong)(uVar20 + 0x10) <= (longlong)param_3) {
      ...
      if (uVar20 != 0) {
        do {
          auVar37._0_4_ = (float)*(ushort *)(lVar27 + 2 + uVar22 * 2);
      ...
      do {
        ...
        auVar50 = vpmovzxwd_avx2(auVar46._0_16_);
        auVar16 = vpmovzxwd_avx2(auVar46._16_16_);
        auVar46 = vcvtdq2ps_avx(auVar50);
  ...
  if (uVar25 + 1 <= param_3) {
    ...
    if (uVar20 < param_3) {
      ...
      do {
        lVar29 = uVar20 * 2;
        uVar20 = uVar20 + 1;
        auVar39._0_4_ = (float)*(ushort *)(lVar27 + uVar25 * 2 + 2 + lVar29);
