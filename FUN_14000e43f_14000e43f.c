...
void FUN_14000e43f(int param_1,int param_2,longlong param_3,int param_4)

{
  ...
  do {
    FUN_140014400(unaff_EBX + in_R11,in_EAX + param_3,in_stack_000000a0,in_stack_000000a8);
    param_1 = param_1 + 1;
