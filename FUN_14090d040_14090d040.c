...
void FUN_14090d040(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_14090d14f;
    if ((param_7 & 0xf) == 6) {
      uVar1 = param_7 & 0x10;
      goto joined_r0x00014090d462;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < param_5[1]) || (param_7 == 0xf0)) goto LAB_14090d14f;
    if ((param_7 & 0xf) == 6) {
      uVar1 = param_7 & 0x20;
joined_r0x00014090d462:
      if (uVar1 == 0) {
        fVar9 = (float)*param_8;
...
LAB_14090d14f:
  lStack_38 = *param_5;
  lStack_30 = param_5[1];
  FUN_140918b60(lStack_38,param_2,param_3,param_4,&lStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
