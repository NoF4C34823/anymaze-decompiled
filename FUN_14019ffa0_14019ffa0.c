...
void FUN_14019ffa0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1401a08c2:
      ...
      uVar41 = uVar40 & 0xf;
      if (uVar41 != 0) {
        if ((uVar40 & 3) != 0) goto LAB_1401a08c2;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar41 + 4)) goto LAB_1401a08c2;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar41 = uVar40 & 0xf;
      if (uVar41 != 0) {
        if ((uVar40 & 3) != 0) goto LAB_1401a08d0;
        uVar41 = 0x10 - uVar41 >> 2;
      }
      if ((longlong)(uVar41 + 4) <= (longlong)param_5) {
        ...
        auVar35 = _DAT_143087f60;
        auVar34 = _DAT_143087f50;
        lVar39 = uVar41 * 2;
        do {
...
LAB_1401a0850:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar41 = uVar40 & 0xf;
    if (uVar41 != 0) {
      if ((uVar40 & 3) != 0) goto LAB_1401a08c9;
      uVar41 = 0x10 - uVar41 >> 2;
    }
