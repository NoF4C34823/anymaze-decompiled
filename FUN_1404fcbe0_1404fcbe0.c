...
void FUN_1404fcbe0(ulonglong *param_1,longlong param_2,undefined8 *param_3,ulonglong param_4)

{
  ...
  auVar6 = vpminuw_avx(auStack_318,auStack_2e8);
  auVar8 = vpminuw_avx(auStack_288,auStack_258);
  auVar6 = vpminuw_avx(auVar6,auStack_2b8);
  auVar8 = vpminuw_avx(auVar8,auStack_228);
  auVar9 = vpminuw_avx(auStack_1f8,auStack_1c8);
  auVar6 = vpminuw_avx(auVar6,auVar8);
  auVar8 = vpminuw_avx(auVar9,auStack_198);
  auVar6 = vpminuw_avx(auVar6,auVar8);
  if (3 < (longlong)param_4) {
