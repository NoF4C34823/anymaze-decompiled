...
/* WARNING: Removing unreachable block (ram,0x000140224482) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_140222780(longlong param_1,longlong param_2,undefined4 *param_3,longlong param_4,
...

{
  ...
  lStack_68 = param_2;
  if (iVar22 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_140224968;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      lStack_1b8 = 0;
      uStack_110 = 0;
      pcStack_e0 = *(code **)(&DAT_143088600 + (longlong)(int)uStack_1b0 * 8);
            ...
            if (lStack_d0 < (longlong)(uVar8 + lVar25)) {
              ...
              do {
                ...
                if (lVar13 < 0) {
                  if (uStack_118 != 0xf0) {
                    if (iVar22 == 6) {
                      if (uStack_e8 == 0) goto LAB_1402248d2;
                    }
                    else {
                      if (iVar22 != 1) goto LAB_140224843;
LAB_140224a1d:
                      lVar28 = 0;
                      if (uStack_e8 != 0) {
                        lVar28 = lVar13;
...
LAB_1402248b4:
                  ...
                  if ((lVar13 < lVar25) || (uStack_118 == 0xf0)) goto LAB_1402248b4;
                  if (iVar22 != 6) {
                    if (iVar22 == 1) {
                      if (lVar13 < 0) goto LAB_140224a1d;
                      if (uStack_c0 == 0) {
                        lVar28 = lVar25 + -1;
                      }
                    }
...
LAB_140224843:
                      if (iVar22 == 3) {
                        if (lVar25 < 2) {
                          ...
                          if (lVar13 < 0) goto LAB_140224a31;
                          if (lVar25 <= lVar13) {
                            while (uStack_c0 == 0) {
                              for (lVar28 = (lVar25 + -1) * 2 - lVar28; lVar28 < 0; lVar28 = -lVar28
                                  ) {
LAB_140224a31:
                                if (uStack_e8 != 0) goto LAB_1402248b4;
                              }
                  ...
                  if (uStack_c0 != 0) goto LAB_1402248b4;
LAB_1402248d2:
...
LAB_14022499e:
                      ...
                      if ((longlong)uStack_100 < 0xbd) {
                        ...
                        if (((uStack_150 != 0) && (uVar29 = uStack_190, uStack_158 != 0)) ||
                           ((longlong)uStack_100 < (longlong)(uVar29 + 8))) goto LAB_14022499e;
...
LAB_140223a99:
                    ...
                    uVar30 = puStack_d8[2];
                    if ((longlong)uStack_180 < 0x10) goto LAB_140223a99;
                    uVar12 = 0;
                    pauVar9 = pauStack_120;
                    do {
                      uVar3 = *puStack_d8;
                ...
                if (6 < (longlong)uStack_180) {
                  ...
                  if ((((longlong)(uStack_180 * 0xc) <= lVar17) || (7 < -lVar17)) &&
                    ...
                    if ((longlong)uStack_180 < 0x10) {
                      ...
                      auVar35 = vpermd_avx2(_DAT_1430884c0,auVar34);
                      auVar34 = vpermd_avx2(_DAT_1430884e0,auVar37);
                      auVar37 = vpermd_avx2(_DAT_143088500,auVar31);
                ...
                if (0 < lStack_130) {
                  if ((longlong)uStack_180 < 7) {
                    ...
                    if ((longlong)uStack_180 < 0x10) {
                      ...
                      auVar35 = vpermd_avx2(_DAT_1430884c0,auVar35);
                      auVar34 = vpermd_avx2(_DAT_1430884e0,auVar39);
                      auVar37 = vpermd_avx2(_DAT_143088500,auVar33);
                      auVar31 = vpblendd_avx2(auVar35,auVar34,0x92);
                      auVar34 = vpblendd_avx2(auVar34,auVar37,0x92);
                      auVar35 = vpblendd_avx2(auVar37,auVar35,0x92);
                      auVar37 = vpblendd_avx2(auVar31,auVar35,0x24);
                ...
                if (6 < (longlong)uStack_180) {
                  ...
                  if ((((longlong)(uStack_180 * 0xc) <= lVar17) || (7 < -lVar17)) &&
                    ...
                    if ((longlong)uStack_180 < 0x10) {
                      ...
                      auVar35 = vpermd_avx2(_DAT_1430884c0,auVar36);
                      auVar34 = vpermd_avx2(_DAT_1430884e0,auVar38);
                      auVar37 = vpermd_avx2(_DAT_143088500,auVar32);
                      auVar31 = vpblendd_avx2(auVar35,auVar34,0x92);
                      auVar34 = vpblendd_avx2(auVar34,auVar37,0x92);
                      auVar35 = vpblendd_avx2(auVar37,auVar35,0x92);
                      auVar37 = vpblendd_avx2(auVar31,auVar35,0x24);
        ...
        if (0 < (longlong)uVar8) {
          ...
          if (7 < (longlong)uVar8) {
            ...
            if (0xbc < (longlong)uVar8) {
              ...
              if (uVar18 != 0) {
                uVar29 = uVar12;
                if (((ulonglong)puVar19 & 3) != 0) goto LAB_140222bf5;
                uVar18 = 0x20 - uVar18 >> 2;
              }
              uVar29 = uVar12;
              if ((longlong)uVar8 < (longlong)(uVar18 + 8)) goto LAB_140222bf5;
...
LAB_140222bf5:
    ...
    if ((uStack_48 ^ (ulonglong)auStack_218) != DAT_1436b4680) goto LAB_14022295a;
  }
  else {
    if (uVar15 == 3) {
          ...
          if (0 < (longlong)uVar8) {
            ...
            if (7 < (longlong)uVar8) {
              ...
              if ((longlong)uVar8 < 0xbd) {
                ...
                uVar18 = (ulonglong)puVar19 & 0x1f;
                if (uVar18 != 0) {
                  if (((ulonglong)puVar19 & 3) != 0) goto LAB_140222a95;
                  uVar18 = 0x20 - uVar18 >> 2;
                }
                if ((longlong)uVar8 < (longlong)(uVar18 + 8)) goto LAB_140222a95;
                lVar25 = (longlong)param_3 + (lVar26 - lVar25);
                uVar29 = uVar8 - (uVar8 - uVar18 & 7);
                uVar20 = uVar12;
                if (uVar18 != 0) {
