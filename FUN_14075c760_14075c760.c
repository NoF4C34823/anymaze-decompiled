...
/* WARNING: Removing unreachable block (ram,0x00014075d513) */

void FUN_14075c760(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1d8 = param_10;
    (*(code *)(&PTR_FUN_14308c120)[lVar14])(param_1,param_4,*param_5,param_9);
...
LAB_14075d7cb:
    ...
    iStack_1d8 = param_10;
    (*(code *)(&PTR_FUN_14308c120)[lVar14])(param_11 + lVar19 * 0xc,param_4,lVar11,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_190 = lVar19 * 3;
      ...
      if (uVar4 != 0 && SCARRY8(uVar9,-3) == (longlong)uVar4 < 0) {
        if (6 < (longlong)uVar4) {
          ...
          if ((lVar16 <= (longlong)(uStack_198 - param_1)) ||
            ...
            if (uVar5 == 0) {
LAB_14075c8b8:
              if ((longlong)uVar4 < (longlong)(uVar5 + 4)) goto LAB_14075d8a8;
...
LAB_14075d09f:
      uStack_1b0 = uVar9;
      pcStack_1b8 = (code *)(&PTR_FUN_14308c120)[lVar14];
      iStack_1d8 = param_10;
      lStack_188 = param_1;
      uStack_180 = param_7;
