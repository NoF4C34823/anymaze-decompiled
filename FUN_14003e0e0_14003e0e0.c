...
void FUN_14003e0e0(longlong param_1,longlong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    ...
    if (uVar27 != 0) {
      if ((param_1 + 8U & 3) != 0) goto LAB_14003e450;
