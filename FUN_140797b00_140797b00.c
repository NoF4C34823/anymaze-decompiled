...
void FUN_140797b00(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_140798858:
      ...
      uVar23 = param_2 & 0xf;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140798858;
        uVar23 = 0x10 - uVar23 >> 2;
      }
      if ((longlong)uVar11 < (longlong)(uVar23 + 8)) goto LAB_140798858;
...
LAB_140798821:
          uVar32 = 0;
          if (uVar11 == 0) goto LAB_1407985ed;
          uVar34 = 0;
          uVar23 = uVar11;
        }
        else {
          uVar23 = param_2 & 0xf;
          if (uVar23 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140798821;
            uVar23 = 0x10 - uVar23 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar23 + 0x10)) goto LAB_140798821;
          uVar34 = 0;
          ...
          if (uVar11 < uVar32 + 1) goto LAB_1407985ed;
...
LAB_1407985ed:
  ...
  if (0xf < (longlong)uVar11) {
    uVar23 = param_2 & 0xf;
    if (uVar23 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140798816;
      uVar23 = 0x10 - uVar23 >> 2;
    }
    if ((longlong)(uVar23 + 0x10) <= (longlong)uVar11) {
      ...
      goto joined_r0x0001407987bf;
    }
  }
LAB_140798816:
  uVar32 = 0;
joined_r0x0001407987bf:
