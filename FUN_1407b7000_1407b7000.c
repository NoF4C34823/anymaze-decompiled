...
void FUN_1407b7000(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1407b7aa1:
      ...
      uVar32 = 0;
      uVar35 = param_3;
      if (param_3 == 0) goto LAB_1407b721c;
    }
    else {
      uVar35 = (ulonglong)param_2 & 0xf;
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_1407b7aa1;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_1407b7aa1;
      uVar32 = 0;
      ...
      if (param_3 < uVar33 + 1) goto LAB_1407b721c;
...
LAB_1407b7a65:
          uVar32 = 0;
          if (param_3 == 0) goto LAB_1407b7884;
          uVar33 = 0;
          uVar35 = param_3;
        }
        else {
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_1407b7a65;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_1407b7a65;
          ...
          if (param_3 < uVar32 + 1) goto LAB_1407b7884;
...
LAB_1407b7884:
  ...
  if (7 < (longlong)param_3) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_1407b7a52;
      uVar35 = 0x10 - uVar35 >> 2;
    }
