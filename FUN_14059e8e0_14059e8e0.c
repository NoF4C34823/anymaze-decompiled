...
void FUN_14059e8e0(undefined1 (*param_1) [64],longlong param_2,undefined1 (*param_3) [64],
  ...
  if (0 < param_6) {
    ...
    do {
      ...
      if (uVar7 != 0) {
        ...
        FUN_14059eb60(param_1,param_2,param_3,uVar7);
      ...
      if (lVar8 != 0) {
        ...
        auVar15 = vminps_avx512f(*pauVar5,*pauVar10);
        pauVar11 = (undefined1 (*) [64])(*pauVar5 + param_2 * 8);
        auVar16 = vminps_avx512f(auVar15,*pauVar11);
        lVar6 = 0;
        auVar15 = auVar16;
        if (1 < lVar8) {
          do {
            lVar6 = lVar6 + 1;
            auVar16 = vminps_avx512f(pauVar5[1],*(undefined1 (*) [64])(pauVar5[1] + lVar2));
            auVar16 = vminps_avx512f(auVar16,*(undefined1 (*) [64])(pauVar5[1] + param_2 * 8));
            pauVar5 = pauVar5 + 1;
            auVar17 = valignd_avx512f(auVar16,auVar15,4);
            auVar18 = valignd_avx512f(auVar16,auVar15,8);
            auVar15 = vminps_avx512f(auVar17,auVar15);
            auVar15 = vminps_avx512f(auVar18,auVar15);
            *pauVar9 = auVar15;
            pauVar9 = pauVar9 + 1;
            auVar15 = auVar16;
          } while (lVar6 < lVar8 + -1);
        ...
        pauVar1 = pauVar5 + 1;
        pauVar5 = pauVar5 + 1;
        auVar15 = vminps_avx512f(ZEXT3264(*(undefined1 (*) [32])*pauVar1),
                                 ZEXT3264(*(undefined1 (*) [32])pauVar10[1]));
        auVar15 = vminps_avx512f(auVar15,ZEXT3264(*(undefined1 (*) [32])pauVar11[1]));
        auVar17 = valignd_avx512f(auVar15,auVar16,4);
        auVar15 = valignd_avx512f(auVar15,auVar16,8);
        auVar16 = vminps_avx512f(auVar17,auVar16);
        auVar15 = vminps_avx512f(auVar15,auVar16);
        *pauVar9 = auVar15;
        pauVar9 = pauVar9 + 1;
      }
      ...
      if (lVar8 != 0) {
        lVar6 = 0;
        auVar14 = vminps_avx(*(undefined1 (*) [32])*pauVar5,*(undefined1 (*) [32])(*pauVar5 + lVar2)
                            );
        auVar14 = vminps_avx(auVar14,*(undefined1 (*) [32])(*pauVar5 + param_2 * 8));
        if (0 < lVar8) {
          do {
            lVar6 = lVar6 + 1;
            auVar3 = vminps_avx(*(undefined1 (*) [32])(*pauVar5 + 0x20),
                                *(undefined1 (*) [32])(*pauVar5 + lVar2 + 0x20));
            auVar3 = vminps_avx(auVar3,*(undefined1 (*) [32])(*pauVar5 + param_2 * 8 + 0x20));
            ...
            auVar14 = vminps_avx512vl(auVar13,auVar14);
