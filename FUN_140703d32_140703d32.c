...
void FUN_140703d32(ulonglong param_1,ulonglong param_2,ulonglong param_3,float param_4)

{
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         (float)((uint)*(byte *)((in_RAX - 1) + in_R9) + (uint)*(byte *)(in_RAX + 1 + in_R9)) *
         param_4 + (float)*(byte *)(in_RAX + in_R9) * in_XMM0_Da;
    in_RAX = in_RAX + 1;
  } while (in_RAX < param_1);
  puVar59 = (ulonglong *)(in_R9 + param_1);
  do {
    uVar2 = *(ulonglong *)((longlong)puVar59 + -1);
    uVar3 = *(ulonglong *)((longlong)puVar59 + 1);
    auVar5._8_6_ = 0;
    auVar5._0_8_ = uVar2;
