...
void FUN_1403f7d80(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
          ...
          do {
            ...
            if (0 < (longlong)uVar20) {
              ...
              if (7 < (longlong)uVar20) {
                ...
                uVar18 = uVar26 & 0xf;
                if (uVar18 != 0) {
                  if ((uVar26 & 1) != 0) goto LAB_1403f7fd1;
                ...
                if ((longlong)(uVar18 + 8) <= (longlong)uVar20) {
                  ...
                  do {
                    ...
                    sVar40 = psVar1[6];
                    sVar43 = psVar1[7];
                    uVar45 = (ushort)(sVar42 < (short)uVar45) * sVar42 |
                             (sVar42 >= (short)uVar45) * uVar45;
                    uVar46 = (ushort)(sVar55 < (short)uVar46) * sVar55 |
                             (sVar55 >= (short)uVar46) * uVar46;
                    uVar47 = (ushort)(sVar27 < (short)uVar47) * sVar27 |
                             (sVar27 >= (short)uVar47) * uVar47;
                    uVar48 = (ushort)(sVar30 < (short)uVar48) * sVar30 |
                             (sVar30 >= (short)uVar48) * uVar48;
                    uVar49 = (ushort)(sVar33 < (short)uVar49) * sVar33 |
                             (sVar33 >= (short)uVar49) * uVar49;
                    uVar50 = (ushort)(sVar38 < (short)uVar50) * sVar38 |
                             (sVar38 >= (short)uVar50) * uVar50;
                    uVar51 = (ushort)(sVar40 < (short)uVar51) * sVar40 |
                             (sVar40 >= (short)uVar51) * uVar51;
                    uVar52 = (ushort)(sVar43 < (short)uVar52) * sVar43 |
                             (sVar43 >= (short)uVar52) * uVar52;
                    uVar18 = uVar18 + 8;
                  } while (uVar18 < uVar22);
                  uVar49 = ((short)uVar49 < (short)uVar45) * uVar49 |
                           ((short)uVar49 >= (short)uVar45) * uVar45;
                  uVar50 = ((short)uVar50 < (short)uVar46) * uVar50 |
                           ((short)uVar50 >= (short)uVar46) * uVar46;
                  uVar46 = ((short)uVar51 < (short)uVar47) * uVar51 |
                           ((short)uVar51 >= (short)uVar47) * uVar47;
                  uVar47 = ((short)uVar52 < (short)uVar48) * uVar52 |
                           ((short)uVar52 >= (short)uVar48) * uVar48;
                  uVar46 = ((short)uVar46 < (short)uVar49) * uVar46 |
                           ((short)uVar46 >= (short)uVar49) * uVar49;
                  uVar47 = ((short)uVar47 < (short)uVar50) * uVar47 |
                           ((short)uVar47 >= (short)uVar50) * uVar50;
                  uVar28 = (uint)(ushort)(((short)uVar47 < (short)uVar46) * uVar47 |
                                         ((short)uVar47 >= (short)uVar46) * uVar46);
                }
              }
LAB_1403f7fd1:
              if (uVar22 < uVar20) {
                ...
                do {
                  sVar42 = (short)uVar28;
                  if (*(short *)(lVar19 + uVar22 * 2) < (short)uVar28) {
          ...
          do {
            ...
            if (0 < (longlong)uVar23) {
              ...
              if (7 < (longlong)uVar23) {
                ...
                uVar24 = uVar22 & 0xf;
                if (uVar24 != 0) {
                  if ((uVar22 & 1) != 0) goto LAB_1403f8211;
...
LAB_1403f8211:
              if (uVar36 < uVar23) {
                ...
                do {
                  sVar42 = (short)uVar28;
                  if (*(short *)(lVar25 + uVar36 * 2) < (short)uVar28) {
        ...
        FUN_1403f8d00(param_9,uVar21,param_3,uVar3,uVar35);
        uVar31 = uVar31 + 1;
        uVar35 = param_6[1];
                ...
                if (0 < (longlong)uVar20) {
                  if (7 < (longlong)uVar20) {
                    ...
                    do {
                      ...
                      sVar4 = auVar56._0_2_;
                      auVar57._0_2_ =
                           (ushort)(sVar4 < sVar42) * sVar4 | (ushort)(sVar4 >= sVar42) * sVar42;
                      sVar42 = auVar56._2_2_;
                      auVar57._2_2_ =
                           (ushort)(sVar42 < sVar55) * sVar42 | (ushort)(sVar42 >= sVar55) * sVar55;
                      sVar42 = auVar56._4_2_;
                      auVar57._4_2_ =
                           (ushort)(sVar42 < sVar27) * sVar42 | (ushort)(sVar42 >= sVar27) * sVar27;
                      sVar42 = auVar56._6_2_;
                      auVar57._6_2_ =
                           (ushort)(sVar42 < sVar30) * sVar42 | (ushort)(sVar42 >= sVar30) * sVar30;
                      sVar42 = auVar56._8_2_;
                      auVar57._8_2_ =
                           (ushort)(sVar42 < sVar33) * sVar42 | (ushort)(sVar42 >= sVar33) * sVar33;
                      sVar42 = auVar56._10_2_;
                      auVar57._10_2_ =
                           (ushort)(sVar42 < sVar38) * sVar42 | (ushort)(sVar42 >= sVar38) * sVar38;
                      sVar42 = auVar56._12_2_;
                      auVar57._12_2_ =
                           (ushort)(sVar42 < sVar40) * sVar42 | (ushort)(sVar42 >= sVar40) * sVar40;
                      sVar42 = auVar56._14_2_;
                      auVar57._14_2_ =
                           (ushort)(sVar42 < sVar43) * sVar42 | (ushort)(sVar42 >= sVar43) * sVar43;
                      auVar56 = auVar57 & auVar53 | ~auVar53 & auVar56;
                    } while (uVar18 < (uVar20 & 0xfffffffffffffff8));
                    sVar42 = auVar56._8_2_;
                    sVar55 = auVar56._0_2_;
                    uVar46 = (ushort)(sVar42 < sVar55) * sVar42 |
                             (ushort)(sVar42 >= sVar55) * sVar55;
                    sVar42 = auVar56._10_2_;
                    sVar55 = auVar56._2_2_;
                    uVar47 = (ushort)(sVar42 < sVar55) * sVar42 |
                             (ushort)(sVar42 >= sVar55) * sVar55;
                    sVar42 = auVar56._12_2_;
                    sVar55 = auVar56._4_2_;
                    uVar48 = (ushort)(sVar42 < sVar55) * sVar42 |
                             (ushort)(sVar42 >= sVar55) * sVar55;
                    sVar42 = auVar56._14_2_;
                    sVar55 = auVar56._6_2_;
                    uVar49 = (ushort)(sVar42 < sVar55) * sVar42 |
                             (ushort)(sVar42 >= sVar55) * sVar55;
                    uVar46 = ((short)uVar48 < (short)uVar46) * uVar48 |
                             ((short)uVar48 >= (short)uVar46) * uVar46;
                    uVar47 = ((short)uVar49 < (short)uVar47) * uVar49 |
                             ((short)uVar49 >= (short)uVar47) * uVar47;
                    uVar46 = ((short)uVar47 < (short)uVar46) * uVar47 |
                             ((short)uVar47 >= (short)uVar46) * uVar46;
                  ...
                  if (uVar18 < uVar20) {
                    ...
                    do {
                      if ((*(char *)(uVar18 + param_7 + uVar24) != '\0') &&
                         (*(short *)(lVar2 + uVar18 * 2) < (short)uVar46)) {
