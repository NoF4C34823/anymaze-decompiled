...
void FUN_14046099a(longlong param_1,longlong param_2,undefined1 (*param_3) [16],longlong param_4)

{
  ...
  do {
    ...
    if (uVar13 != 0) {
      ...
      FUN_140460c00(in_R10,param_2,param_3,uVar13,1);
    ...
    if ((longlong)uVar12 >> 2 != 0) {
      ...
      lVar16 = 0;
      auVar18 = minps(*pauVar11,*(undefined1 (*) [16])(*pauVar11 + lVar1));
      uVar14 = uVar13 & 0xfffffffffffffffe;
      auVar18 = minps(auVar18,*(undefined1 (*) [16])(*pauVar11 + param_2 * 8));
      if (0 < (longlong)uVar14) {
        do {
          lVar16 = lVar16 + 2;
          auVar17 = minps(pauVar11[1],*(undefined1 (*) [16])(pauVar11[1] + lVar1));
          auVar17 = minps(auVar17,*(undefined1 (*) [16])(pauVar11[1] + param_2 * 8));
          auVar2._16_16_ = auVar17;
          auVar2._0_16_ = auVar18;
          auVar3._16_16_ = auVar17;
          auVar3._0_16_ = auVar18;
          auVar18 = minps(auVar2._4_16_,auVar18);
          auVar18 = minps(auVar3._8_16_,auVar18);
          *pauVar15 = auVar18;
          auVar18 = minps(pauVar11[2],*(undefined1 (*) [16])(pauVar11[2] + lVar1));
          pauVar10 = pauVar11 + 2;
          pauVar11 = pauVar11 + 2;
          ...
          auVar17 = minps(auVar4._4_16_,auVar17);
          auVar17 = minps(auVar5._8_16_,auVar17);
          pauVar15[1] = auVar17;
          pauVar15 = pauVar15 + 2;
      ...
      while (lVar16 < (longlong)uVar13) {
        ...
        pauVar10 = pauVar11 + 1;
        pauVar11 = pauVar11 + 1;
        auVar17 = minps(auVar17,*(undefined1 (*) [16])(*pauVar10 + param_2 * 8));
        auVar6._16_16_ = auVar17;
        auVar6._0_16_ = auVar18;
        auVar7._16_16_ = auVar17;
        auVar7._0_16_ = auVar18;
        auVar18 = minps(auVar6._4_16_,auVar18);
        auVar18 = minps(auVar7._8_16_,auVar18);
        *pauVar15 = auVar18;
        pauVar15 = pauVar15 + 1;
        auVar18 = auVar17;
      }
      ...
      auVar17 = minps(auVar20,auVar17);
      auVar19._8_8_ = 0;
      auVar19._0_8_ = *(ulonglong *)(pauVar11[1] + param_2 * 8);
      pauVar11 = pauVar11 + 1;
      auVar17 = minps(auVar17,auVar19);
      auVar8._16_16_ = auVar17;
      auVar8._0_16_ = auVar18;
      auVar9._16_16_ = auVar17;
      auVar9._0_16_ = auVar18;
      auVar18 = minps(auVar9._4_16_,auVar18);
      auVar18 = minps(auVar8._8_16_,auVar18);
      *pauVar15 = auVar18;
      pauVar15 = pauVar15 + 1;
    }
    if ((uVar12 & 3) != 0) {
      FUN_140460c00(pauVar11,param_2,pauVar15,uVar12 & 3,1);
      in_R11 = in_stack_000000a8;
    }
    param_1 = param_1 + 1;
