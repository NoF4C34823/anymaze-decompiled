...
void FUN_140945e20(longlong param_1,longlong param_2,float *param_3,longlong param_4,
...
LAB_140945f33:
    ...
    if ((param_5[1] <= (longlong)uVar10) && (param_7 != 0xf0)) {
      if (uStack_a8 != 6) goto joined_r0x000140945f67;
      if ((param_7 & 0x20) == 0) goto LAB_140946056;
    }
LAB_140945ffa:
    do {
      FUN_140946c80(param_1,param_2);
      while( true ) {
        while( true ) {
          uStack_a8 = param_7 & 0xf;
          iVar9 = (int)uVar10;
          ...
          if (uVar18 <= uVar10) {
            if (uVar15 != 0) {
              ...
              lVar8 = -uVar18;
              do {
                FUN_140946c80(param_1,param_2,lVar8,param_3);
                lVar6 = lVar6 + 1;
                lVar8 = lVar8 + 1;
...
LAB_1409463d5:
        ...
        param_8 = psStack_d0;
        if (-1 < (longlong)uVar10) goto LAB_140945f33;
        if (param_7 == 0xf0) break;
        if (uStack_a8 != 6) goto joined_r0x000140945f67;
        if (uVar15 != 0) break;
LAB_140946056:
        fVar21 = (float)(int)psStack_d0[2];
        fVar19 = (float)(int)*psStack_d0;
        fVar20 = (float)(int)psStack_d0[1];
        if (0 < *param_5 * 3) {
...
LAB_140946434:
  ...
  if (uVar15 == 6) {
    uVar10 = 0;
    fVar21 = (float)(int)*psStack_d0;
    fVar20 = (float)(int)psStack_d0[1];
    fVar19 = (float)(int)psStack_d0[2];
    if (0 < iVar17) {
      lVar6 = *param_5;
      uVar18 = (lVar6 * 3 + 2) / 3;
      do {
...
LAB_140946891:
            ...
            if ((longlong)uVar18 < 0xbd) {
              ...
              if (uVar13 != 0) {
                if (((ulonglong)pfVar5 & 3) != 0) goto LAB_140946891;
                uVar13 = 0x20 - uVar13 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar13 + 8)) goto LAB_140946891;
              uVar16 = 0;
    ...
    if ((param_7 & 0xf0) == 0xf0) {
      (*(code *)(&PTR_FUN_14308d740)[param_6])(param_1 + param_2 * lVar6,param_3,*param_5,param_9);
    }
    else {
      ...
      FUN_140946c80(param_1,param_2,lVar6,param_3);
    }
    lVar6 = 1;
    uVar10 = 0;
    if (1 < iVar17) {
...
LAB_1409466a4:
            ...
            if ((longlong)uVar18 < 0xbd) {
              ...
              uVar13 = (ulonglong)pfVar5 & 0x1f;
              if (uVar13 != 0) {
                if (((ulonglong)pfVar5 & 3) != 0) goto LAB_1409466a4;
                uVar13 = 0x20 - uVar13 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar13 + 8)) goto LAB_1409466a4;
              lVar14 = (longlong)param_3 + (lVar8 - lVar14);
              uVar16 = 0;
              uVar12 = uVar18 - (uVar18 - uVar13 & 7);
              if (uVar13 != 0) {
