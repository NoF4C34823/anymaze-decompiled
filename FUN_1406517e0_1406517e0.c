...
void FUN_1406517e0(longlong param_1,float *param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140652239:
      ...
      if (uVar35 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_140652239;
        uVar35 = 0x10 - uVar35 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140652239;
...
LAB_140652204:
          uVar30 = 0;
          if (param_3 == 0) goto LAB_140652024;
          uVar32 = 0;
          uVar35 = param_3;
        }
        else {
          uVar35 = (ulonglong)param_2 & 0xf;
          if (uVar35 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_140652204;
            uVar35 = 0x10 - uVar35 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar35 + 8)) goto LAB_140652204;
          ...
          if (param_3 < uVar30 + 1) goto LAB_140652024;
...
LAB_140652024:
  ...
  if (7 < (longlong)param_3) {
    uVar35 = (ulonglong)param_2 & 0xf;
    if (uVar35 != 0) {
      if (((ulonglong)param_2 & 3) != 0) goto LAB_1406521f1;
      uVar35 = 0x10 - uVar35 >> 2;
    }
