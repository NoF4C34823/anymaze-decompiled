...
void FUN_14082c6c0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_14082c9a9:
    ...
    uVar12 = param_2 & 0x1f;
    if (uVar12 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14082c9a9;
      uVar12 = 0x20 - uVar12 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar12 + 0x10)) goto LAB_14082c9a9;
    uVar11 = 0;
