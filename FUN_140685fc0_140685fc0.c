...
void FUN_140685fc0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140686fdb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b880 + lVar17 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar12 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140686f60;
                while (uVar8 == 0) {
                  for (lVar22 = (lVar12 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_140686f60:
                    if (uVar7 != 0) goto LAB_140686e4e;
                  }
...
LAB_140686e4e:
        ...
        *(undefined1 *)(lVar19 + 2 + param_11) = uVar15;
        lVar19 = lVar19 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140686ef4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b880 + lVar17 * 8))(param_11 + lVar20 * 3,param_4,lVar12,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar19 = lVar20 * 3;
...
LAB_140686ef6:
            ...
            if ((longlong)uVar18 < (longlong)(uVar5 + 0x10)) goto LAB_140686ef6;
...
LAB_140686259:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&DAT_14308b880 + lVar17 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140686f32. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_140686d27:
                    /* WARNING: Could not recover jumptable at 0x000140686d58. Too many branches */
                    /* WARNING: Treating indirect jump as call */
