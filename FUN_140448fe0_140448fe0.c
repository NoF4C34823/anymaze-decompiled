...
void FUN_140448fe0(uint *param_1,longlong param_2,ushort *param_3,ulonglong param_4)

{
  ...
  uVar2 = auVar14._0_2_;
  uVar13 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._2_2_;
  uVar2 = auVar14._2_2_;
  uVar18 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._4_2_;
  uVar2 = auVar14._4_2_;
  uVar19 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._6_2_;
  uVar2 = auVar14._6_2_;
  uVar20 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._8_2_;
  uVar2 = auVar14._8_2_;
  uVar21 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._10_2_;
  uVar2 = auVar14._10_2_;
  uVar22 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar48._12_2_;
  uVar2 = auVar14._12_2_;
  uVar23 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar44._0_2_;
  uVar2 = auVar3._0_2_;
  uVar2 = (uVar2 < uVar38) * uVar38 | (uVar2 >= uVar38) * uVar2;
  uVar38 = auVar44._2_2_;
  uVar7 = auVar3._2_2_;
  uVar7 = (uVar7 < uVar38) * uVar38 | (uVar7 >= uVar38) * uVar7;
  uVar38 = auVar44._4_2_;
  uVar8 = auVar3._4_2_;
  uVar8 = (uVar8 < uVar38) * uVar38 | (uVar8 >= uVar38) * uVar8;
  uVar38 = auVar44._6_2_;
  uVar9 = auVar3._6_2_;
  uVar9 = (uVar9 < uVar38) * uVar38 | (uVar9 >= uVar38) * uVar9;
  uVar38 = auVar44._8_2_;
  uVar10 = auVar3._8_2_;
  uVar10 = (uVar10 < uVar38) * uVar38 | (uVar10 >= uVar38) * uVar10;
  uVar38 = auVar44._10_2_;
  uVar11 = auVar3._10_2_;
  uVar11 = (uVar11 < uVar38) * uVar38 | (uVar11 >= uVar38) * uVar11;
  uVar38 = auVar44._12_2_;
  uVar12 = auVar3._12_2_;
  uVar12 = (uVar12 < uVar38) * uVar38 | (uVar12 >= uVar38) * uVar12;
  uVar13 = (ushort)(uVar13 < (ushort)auStack_18._0_2_) * auStack_18._0_2_ |
           (uVar13 >= (ushort)auStack_18._0_2_) * uVar13;
  uVar18 = (ushort)(uVar18 < (ushort)auStack_18._2_2_) * auStack_18._2_2_ |
           (uVar18 >= (ushort)auStack_18._2_2_) * uVar18;
  uVar19 = (ushort)(uVar19 < (ushort)auStack_18._4_2_) * auStack_18._4_2_ |
           (uVar19 >= (ushort)auStack_18._4_2_) * uVar19;
  uVar20 = (ushort)(uVar20 < (ushort)auStack_18._6_2_) * auStack_18._6_2_ |
           (uVar20 >= (ushort)auStack_18._6_2_) * uVar20;
  uVar21 = (ushort)(uVar21 < (ushort)auStack_18._8_2_) * auStack_18._8_2_ |
           (uVar21 >= (ushort)auStack_18._8_2_) * uVar21;
  uVar22 = (uVar22 < uStack_e) * uStack_e | (uVar22 >= uStack_e) * uVar22;
  uVar23 = (uVar23 < (ushort)uStack_c) * (ushort)uStack_c | (uVar23 >= (ushort)uStack_c) * uVar23;
  ...
  uVar28 = (uVar28 < uVar38) * uVar38 | (uVar28 >= uVar38) * uVar28;
  uVar38 = auVar24._2_2_;
  uVar33 = auVar29._2_2_;
  uVar33 = (uVar33 < uVar38) * uVar38 | (uVar33 >= uVar38) * uVar33;
  uVar38 = auVar24._4_2_;
  uVar34 = auVar29._4_2_;
  uVar34 = (uVar34 < uVar38) * uVar38 | (uVar34 >= uVar38) * uVar34;
  uVar38 = auVar24._6_2_;
  uVar35 = auVar29._6_2_;
  uVar35 = (uVar35 < uVar38) * uVar38 | (uVar35 >= uVar38) * uVar35;
  uVar38 = auVar24._8_2_;
  uVar36 = auVar29._8_2_;
  uVar36 = (uVar36 < uVar38) * uVar38 | (uVar36 >= uVar38) * uVar36;
  uVar38 = auVar24._10_2_;
  uVar37 = auVar29._10_2_;
  uVar37 = (uVar37 < uVar38) * uVar38 | (uVar37 >= uVar38) * uVar37;
  uVar38 = auVar24._12_2_;
  uVar39 = auVar29._12_2_;
  uVar38 = (uVar39 < uVar38) * uVar38 | (uVar39 >= uVar38) * uVar39;
  uVar28 = (ushort)(uVar28 < (ushort)auStack_28._0_2_) * auStack_28._0_2_ |
           (uVar28 >= (ushort)auStack_28._0_2_) * uVar28;
  uVar33 = (ushort)(uVar33 < (ushort)auStack_28._2_2_) * auStack_28._2_2_ |
           (uVar33 >= (ushort)auStack_28._2_2_) * uVar33;
  uVar34 = (ushort)(uVar34 < (ushort)auStack_28._4_2_) * auStack_28._4_2_ |
           (uVar34 >= (ushort)auStack_28._4_2_) * uVar34;
  uVar35 = (ushort)(uVar35 < (ushort)auStack_28._6_2_) * auStack_28._6_2_ |
           (uVar35 >= (ushort)auStack_28._6_2_) * uVar35;
  uVar36 = (ushort)(uVar36 < (ushort)auStack_28._8_2_) * auStack_28._8_2_ |
           (uVar36 >= (ushort)auStack_28._8_2_) * uVar36;
  uVar37 = (uVar37 < uStack_1e) * uStack_1e | (uVar37 >= uStack_1e) * uVar37;
  uVar39 = (uVar38 < (ushort)uStack_1c) * (ushort)uStack_1c | (uVar38 >= (ushort)uStack_1c) * uVar38
  ;
  uVar38 = (uVar13 < uVar2) * uVar2 | (uVar13 >= uVar2) * uVar13;
  uVar2 = (uVar18 < uVar7) * uVar7 | (uVar18 >= uVar7) * uVar18;
  uVar7 = (uVar19 < uVar8) * uVar8 | (uVar19 >= uVar8) * uVar19;
  uVar8 = (uVar20 < uVar9) * uVar9 | (uVar20 >= uVar9) * uVar20;
  uVar9 = (uVar21 < uVar10) * uVar10 | (uVar21 >= uVar10) * uVar21;
  uVar10 = (uVar22 < uVar11) * uVar11 | (uVar22 >= uVar11) * uVar22;
  uVar11 = (uVar23 < uVar12) * uVar12 | (uVar23 >= uVar12) * uVar23;
  uVar38 = (uVar38 < uVar28) * uVar28 | (uVar38 >= uVar28) * uVar38;
  uVar2 = (uVar2 < uVar33) * uVar33 | (uVar2 >= uVar33) * uVar2;
  uVar7 = (uVar7 < uVar34) * uVar34 | (uVar7 >= uVar34) * uVar7;
  if (3 < (longlong)param_4) {
    *param_3 = uVar38;
    param_3[1] = uVar2;
    param_3[2] = uVar7;
    param_3[3] = (uVar8 < uVar35) * uVar35 | (uVar8 >= uVar35) * uVar8;
    param_3 = param_3 + 4;
    param_4 = param_4 - 4;
    uVar38 = (uVar9 < uVar36) * uVar36 | (uVar9 >= uVar36) * uVar9;
    uVar2 = (uVar10 < uVar37) * uVar37 | (uVar10 >= uVar37) * uVar10;
    uVar7 = (uVar11 < uVar39) * uVar39 | (uVar11 >= uVar39) * uVar11;
    if (param_4 == 0) {
      return;
    }
  }
