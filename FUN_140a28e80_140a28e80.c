...
void FUN_140a28e80(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
...

{
  ...
  auVar18 = _DAT_14308eb40;
  if ((param_7 & 0xf0) == 0xf0) {
    (*(code *)(&PTR_LAB_14308ec00)[param_6])
              (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_140a28f8f;
    if ((param_7 & 0xf) == 6) {
      uVar11 = param_7 & 0x10;
      goto joined_r0x000140a291e9;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_140a28f8f;
    if ((param_7 & 0xf) == 6) {
      uVar11 = param_7 & 0x20;
joined_r0x000140a291e9:
      if (uVar11 == 0) {
        uVar2 = *param_5;
        ...
        if ((longlong)uVar2 < 0x10) {
          ...
          if ((longlong)uVar2 < 0x26) {
            ...
            if (uVar14 != 0) {
              uVar15 = 0;
              auVar16 = vmovdqu32_avx512f(_DAT_14308e980);
...
LAB_140a28f8f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  FUN_140a37380(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9,
                param_10,param_11);
  return;
}
