...
/* WARNING: Removing unreachable block (ram,0x00014021a555) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_140219260(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_208 = param_10;
    (**(code **)(&DAT_143088600 + lVar20 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar11 != 6) {
            if (uVar11 == 1) {
              ...
              if (lVar22 < 2) {
                ...
                if (lVar17 < 0) goto LAB_14021ab20;
                while (uVar3 == 0) {
                  for (lVar12 = (lVar22 + -1) * 2 - lVar12; lVar12 < 0; lVar12 = -lVar12) {
LAB_14021ab20:
                    if (uVar16 != 0) goto LAB_14021a96c;
                  }
...
LAB_14021a96c:
    ...
    iStack_208 = param_10;
    (**(code **)(&DAT_143088600 + lVar20 * 8))(*param_11 + lVar13 * 0xc,param_4,lVar22,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
...
LAB_14021aa57:
              ...
              if ((longlong)uVar9 < 0xbd) {
                ...
                if (uVar5 != 0) {
                  if (((ulonglong)puStack_b8 & 3) != 0) goto LAB_14021aa57;
                  uVar5 = 0x20 - uVar5 >> 2;
                }
                if ((longlong)uVar9 < (longlong)(uVar5 + 8)) goto LAB_14021aa57;
                uVar14 = 0;
        ...
        if (6 < (longlong)uVar9) {
          ...
          if ((((longlong)(uVar9 * 0xc) <= lVar17) || (7 < -lVar17)) &&
            ...
            if ((longlong)uVar9 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_1430884c0,auVar24);
              auVar24 = vpermd_avx2(_DAT_1430884e0,auVar33);
              auVar29 = vpermd_avx2(_DAT_143088500,auVar29);
...
LAB_140219f63:
      uStack_c8 = pauVar1;
      uStack_d0 = *(code **)(&DAT_143088600 + lVar20 * 8);
      iStack_208 = param_10;
      uStack_a8 = param_7;
      lStack_a0 = param_4;
        ...
        if (0 < lVar22) {
          ...
          if ((longlong)uVar4 < 7) {
            ...
            if ((longlong)uVar4 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_1430884c0,auVar27);
              uVar9 = uVar4 & 0xfffffffffffffff0;
              uVar5 = 0;
              auVar24 = vpermd_avx2(_DAT_1430884e0,auVar35);
              auVar29 = vpermd_avx2(_DAT_143088500,auVar31);
              auVar25 = vpblendd_avx2(auVar27,auVar24,0x92);
              auVar24 = vpblendd_avx2(auVar24,auVar29,0x92);
              auVar27 = vpblendd_avx2(auVar29,auVar27,0x92);
              auVar29 = vpblendd_avx2(auVar25,auVar27,0x24);
        ...
        if (6 < (longlong)uVar4) {
          ...
          if ((((longlong)(uVar4 * 0xc) <= lVar20) || (7 < -lVar20)) &&
            ...
            if ((longlong)uVar4 < 0x10) {
              ...
              auVar27 = vpermd_avx2(_DAT_1430884c0,auVar26);
              uVar9 = uVar4 & 0xfffffffffffffff0;
              uVar5 = 0;
              auVar24 = vpermd_avx2(_DAT_1430884e0,auVar34);
              auVar29 = vpermd_avx2(_DAT_143088500,auVar30);
              auVar25 = vpblendd_avx2(auVar27,auVar24,0x92);
              auVar24 = vpblendd_avx2(auVar24,auVar29,0x92);
              auVar27 = vpblendd_avx2(auVar29,auVar27,0x92);
              auVar29 = vpblendd_avx2(auVar25,auVar27,0x24);
