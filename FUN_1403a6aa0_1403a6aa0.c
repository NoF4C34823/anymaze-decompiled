...
void FUN_1403a6aa0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar4 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_142d23ba0(param_1,lVar3,lVar5,(longlong)(int)param_6,1);
        lVar6 = lVar6 + 1;
