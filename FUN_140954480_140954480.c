...
void FUN_140954480(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_140954bf7:
      ...
      uVar30 = uVar31 & 0x1f;
      if (uVar30 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_140954bf7;
        uVar30 = 0x20 - uVar30 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar30 + 0x10)) goto LAB_140954bf7;
...
LAB_140954bfe:
      ...
      if ((longlong)param_5 < 0x15d) {
        ...
        uVar29 = param_4 & 0x1f;
        if (uVar29 != 0) {
          if ((param_4 & 3) != 0) goto LAB_140954bfe;
          uVar29 = 0x20 - uVar29 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar29 + 8)) goto LAB_140954bfe;
        lVar20 = param_2 * lVar25 + param_1;
        lVar24 = param_2 * lVar27 + param_1;
        uVar30 = 0;
  ...
  if (7 < (longlong)param_5) {
    uVar21 = param_4 & 0x1f;
    if (uVar21 != 0) {
      if ((param_4 & 3) != 0) goto LAB_140954c2a;
