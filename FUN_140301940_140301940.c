...
void FUN_140301940(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar37 != 0 && 0 < (longlong)uVar16) {
      do {
        FUN_140334640(lVar18,lVar33,(longlong)(int)param_5,uVar27,1);
        lVar38 = lVar38 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_140334640(lVar18,lVar33,(longlong)(int)param_5,uVar27,1);
        FUN_14033f6c0(param_9,uVar19,param_3,(longlong)(int)param_5,uVar16);
        lVar37 = lVar37 + 1;
        lVar33 = lVar33 + uVar19 * 2;
                ...
                if (0 < (longlong)uVar27) {
                  if ((longlong)uVar27 < 8) {
                    ...
                    do {
                      ...
                      sVar3 = auVar47._0_2_;
                      auVar51._0_2_ =
                           (ushort)(sVar3 < sVar36) * sVar3 | (ushort)(sVar3 >= sVar36) * sVar36;
                      sVar36 = auVar47._2_2_;
                      auVar51._2_2_ =
                           (ushort)(sVar36 < sVar44) * sVar36 | (ushort)(sVar36 >= sVar44) * sVar44;
                      sVar36 = auVar47._4_2_;
                      auVar51._4_2_ =
                           (ushort)(sVar36 < sVar17) * sVar36 | (ushort)(sVar36 >= sVar17) * sVar17;
                      sVar36 = auVar47._6_2_;
                      auVar51._6_2_ =
                           (ushort)(sVar36 < sVar21) * sVar36 | (ushort)(sVar36 >= sVar21) * sVar21;
                      sVar36 = auVar47._8_2_;
                      auVar51._8_2_ =
                           (ushort)(sVar36 < sVar24) * sVar36 | (ushort)(sVar36 >= sVar24) * sVar24;
                      sVar36 = auVar47._10_2_;
                      auVar51._10_2_ =
                           (ushort)(sVar36 < sVar26) * sVar36 | (ushort)(sVar36 >= sVar26) * sVar26;
                      sVar36 = auVar47._12_2_;
                      auVar51._12_2_ =
                           (ushort)(sVar36 < sVar29) * sVar36 | (ushort)(sVar36 >= sVar29) * sVar29;
                      sVar36 = auVar47._14_2_;
                      auVar51._14_2_ =
                           (ushort)(sVar36 < sVar32) * sVar36 | (ushort)(sVar36 >= sVar32) * sVar32;
