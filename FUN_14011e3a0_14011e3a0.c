...
void FUN_14011e3a0(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (**(code **)(&UNK_143087240 + lVar8 * 8))(puVar26,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar17 == 6) {
    uVar25 = (uint)*param_8;
          ...
          if (uVar17 != 6) {
            if (uVar17 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar14 < 0) goto LAB_14011f880;
                while (uVar16 == 0) {
                  for (lVar10 = (lVar19 + -1) * 2 - lVar10; lVar10 < 0; lVar10 = -lVar10) {
LAB_14011f880:
                    if (uVar23 != 0) goto LAB_14011f743;
                  }
          ...
          if (uVar21 != 0) goto LAB_14011f743;
...
LAB_14011f743:
    ...
    (**(code **)(&UNK_143087240 + lVar8 * 8))(param_11 + uVar15 * 2,param_4,lVar19,param_9,param_10)
    ;
    return;
  }
  if ((param_7 & 0x40) == 0) {
        ...
        if (6 < (longlong)uVar18) {
          ...
          if ((lVar12 <= (longlong)(uVar9 - (longlong)puVar26)) ||
            ...
            if ((longlong)uVar18 < 0x20) {
              ...
              if ((longlong)uVar18 < 0x76) {
                ...
                if (uVar22 != 0) {
                  uVar13 = 0;
                  lVar12 = 0;
                  auVar36 = vmovdqu32_avx512f(_DAT_143087000);
                  auVar37 = vmovdqu32_avx512f(_DAT_143087040);
                  ...
                  if (uVar18 == uVar22) goto LAB_14011e8e3;
                }
              }
            ...
            if (uVar24 + 1 <= uVar18) {
              ...
              auVar37 = vmovdqu32_avx512f(_DAT_143087000);
              auVar38 = vmovdqu32_avx512f(_DAT_143087040);
              lVar12 = 0;
              do {
          ...
          if ((longlong)uVar15 < 0x20) {
            ...
            if ((longlong)uVar15 < 0x4b) {
              ...
              if (uVar22 != 0) {
                ...
                if (uVar15 == uVar22) goto LAB_14011ec80;
              }
            }
            if ((longlong)(uVar22 + 0x20) <= (longlong)uVar24) {
...
LAB_14011ec80:
      (**(code **)(&UNK_143087240 + lVar8 * 8))(uVar9,param_4,uVar15,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (**(code **)(&UNK_143087240 + lVar8 * 8))(puVar26,param_4,lVar19,param_9,param_10);
    return;
  }
        ...
        if ((longlong)uVar18 < 0x20) {
          ...
          if ((longlong)uVar18 < 0x76) {
            ...
            if (uVar24 != 0) {
              ...
              if (uVar18 == uVar24) goto LAB_14011f184;
            }
          }
          ...
          if ((longlong)uVar15 < 0x20) {
            ...
            if ((longlong)uVar15 < 0x4b) {
              ...
              if (uVar9 != 0) {
                ...
                if (uVar15 == uVar9) goto LAB_14011f5e3;
              }
            }
...
LAB_14011f5e3:
  (**(code **)(&UNK_143087240 + lVar8 * 8))(param_11 + uVar15 * 2,param_4,uVar15,param_9,param_10);
  return;
}
