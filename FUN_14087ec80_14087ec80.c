...
void FUN_14087ec80(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (7 < (longlong)uVar18) {
    uVar21 = param_2 & 0x1f;
    if (uVar21 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14087eec0;
    ...
    if ((longlong)(uVar21 + 8) <= (longlong)uVar18) {
      ...
      if (uVar21 != 0) {
        do {
          *(float *)(param_2 + uVar19 * 4) =
               fVar2 * (float)((uint)*(ushort *)(param_1 + -0xc + uVar19 * 2) +
                              (uint)*(ushort *)(param_1 + 0xc + uVar19 * 2)) +
               fVar3 * (float)((uint)*(ushort *)(param_1 + -6 + uVar19 * 2) +
                              (uint)*(ushort *)(param_1 + 6 + uVar19 * 2)) +
               fVar4 * (float)*(ushort *)(param_1 + uVar19 * 2);
          uVar19 = uVar19 + 1;
        } while (uVar19 < uVar21);
      }
      ...
      do {
        ...
        auVar6 = vpmovzxwd_avx(auVar11);
        auVar12._8_8_ = 0;
        auVar12._0_8_ = *(ulonglong *)(param_1 + 0xe + uVar21 * 2);
        auVar7 = vpmovzxwd_avx(auVar12);
        ...
        auVar5 = vpmovzxwd_avx(auVar13);
        auVar14._8_8_ = 0;
        auVar14._0_8_ = *(ulonglong *)(param_1 + 8 + uVar21 * 2);
        auVar7 = vpmovzxwd_avx(auVar14);
      ...
      for (; uVar20 < uVar18; uVar20 = uVar20 + 1) {
        *(float *)(param_2 + uVar20 * 4) =
             fVar2 * (float)((uint)*(ushort *)(param_1 + -0xc + uVar20 * 2) +
                            (uint)*(ushort *)(param_1 + 0xc + uVar20 * 2)) +
             fVar3 * (float)((uint)*(ushort *)(param_1 + -6 + uVar20 * 2) +
                            (uint)*(ushort *)(param_1 + 6 + uVar20 * 2)) +
