...
void FUN_1407186e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407193bb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308be20)[lVar13])(param_1,param_4,*param_5,param_9);
    return;
  }
  if (uVar18 == 6) {
    uVar22 = *param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar12 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140719340;
                while (uVar8 == 0) {
                  for (lVar16 = (lVar12 + -1) * 2 - lVar16; lVar16 < 0; lVar16 = -lVar16) {
LAB_140719340:
                    if (uVar15 != 0) goto LAB_14071922f;
                  }
...
LAB_14071922f:
        ...
        *(undefined4 *)(param_11 + lVar10 * 4) = uVar21;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407192a8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308be20)[lVar13])(param_11 + uVar11 * 4,param_4,lVar12,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar19 = uVar11 * 4;
    ...
    if (0 < (longlong)uVar14) {
      if (6 < (longlong)uVar14) {
        ...
        if ((lVar16 <= (longlong)(uVar17 - param_1)) || (lVar16 <= (longlong)-(uVar17 - param_1))) {
          ...
          if (uVar7 == 0) {
LAB_1407187f6:
            if ((longlong)uVar14 < (longlong)(uVar7 + 4)) goto LAB_1407192ab;
...
LAB_14071895e:
    if (uVar18 == 1) {
      if ((longlong)uVar11 < 1) goto LAB_140718b8f;
...
LAB_14071930e:
        ...
        uVar7 = param_11 & 0xf;
        if (uVar7 != 0) {
          if ((param_11 & 3) != 0) goto LAB_14071930e;
          uVar7 = 0x10 - uVar7 >> 2;
        }
        if ((longlong)uVar11 < (longlong)(uVar7 + 8)) goto LAB_14071930e;
...
LAB_1407192b9:
        ...
        uVar7 = param_11 & 0xf;
        if (uVar7 != 0) {
          if ((param_11 & 3) != 0) goto LAB_1407192b9;
          uVar7 = 0x10 - uVar7 >> 2;
        }
        if ((longlong)uVar11 < (longlong)(uVar7 + 8)) goto LAB_1407192b9;
        uVar20 = uVar11 - (uVar11 - uVar7 & 7);
        if (uVar7 != 0) {
          uVar9 = 0;
          do {
...
LAB_140718b8f:
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308be20)[lVar13];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014071930c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (0 < (longlong)uVar14) {
    if (6 < (longlong)uVar14) {
      ...
      if ((lVar13 <= lVar12) || (lVar13 <= -lVar12)) {
        ...
        if (uVar17 == 0) {
LAB_140718c8b:
          if ((longlong)uVar14 < (longlong)(uVar17 + 4)) goto LAB_1407192c0;
...
LAB_140718dc4:
  if (uVar18 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_1407190fe;
...
LAB_1407192d0:
          ...
          uVar17 = uVar14 & 0xf;
          if (uVar17 != 0) {
            if ((uVar14 & 3) != 0) goto LAB_1407192d0;
            uVar17 = 0x10 - uVar17 >> 2;
          }
          if ((longlong)uVar11 < (longlong)(uVar17 + 8)) goto LAB_1407192d0;
          uVar7 = 0;
          lVar13 = param_11 + lVar10 * 4;
  ...
  if ((uVar18 != 6) || ((longlong)uVar11 < 1)) goto LAB_1407190fe;
  if ((longlong)uVar11 < 8) {
LAB_1407192c8:
    uVar17 = 0;
  }
    ...
    if (uVar14 != 0) {
      if ((lVar13 - 4U & 3) != 0) goto LAB_1407192c8;
      uVar14 = 0x10 - uVar14 >> 2;
    }
    if ((longlong)uVar11 < (longlong)(uVar14 + 8)) goto LAB_1407192c8;
    uVar7 = 0;
...
LAB_1407190fe:
                    /* WARNING: Could not recover jumptable at 0x000140719135. Too many branches */
                    /* WARNING: Treating indirect jump as call */
