...
void FUN_14007f580(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140080652. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086920 + lVar7 * 8))(puVar15,param_4,*param_5);
    return;
  }
  if (uVar21 == 6) {
    uVar17 = (uint)*param_8;
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar23 < 0) goto LAB_1400805e0;
                while (uStack_78 == 0) {
                  for (lVar14 = (lVar19 + -1) * 2 - lVar14; lVar14 < 0; lVar14 = -lVar14) {
LAB_1400805e0:
                    if (uVar17 != 0) goto LAB_1400804e4;
                  }
...
LAB_1400804e4:
        ...
        *(ushort *)(param_11 + lVar16 * 2) = uVar13;
        lVar16 = lVar16 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140080548. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086920 + lVar7 * 8))(param_11 + uVar12 * 2,param_4,lVar19,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_14008055d:
              ...
              uVar11 = uVar20 & 0xf;
              if (uVar11 != 0) {
                if ((uVar20 & 1) != 0) goto LAB_14008055d;
                uVar11 = 0x10 - uVar11 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar11 + 8)) goto LAB_14008055d;
              uVar8 = 0;
...
LAB_14007fa03:
      if (uVar21 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_14007fc2e;
...
LAB_1400805bd:
          ...
          uVar11 = param_11 & 0xf;
          if (uVar11 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400805bd;
            uVar11 = 0x10 - uVar11 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar11 + 8)) goto LAB_1400805bd;
...
LAB_140080564:
          ...
          uVar11 = param_11 & 0xf;
          if (uVar11 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140080564;
            uVar11 = 0x10 - uVar11 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar11 + 8)) goto LAB_140080564;
          uVar8 = 0;
          uVar10 = uVar12 - (uVar12 - uVar11 & 7);
          if (uVar11 != 0) {
            do {
...
LAB_14007fc2e:
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143086920 + lVar7 * 8))(uVar20,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001400805ba. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086920 + lVar7 * 8))(puVar15,param_4,lVar19);
    return;
  }
  if ((longlong)uVar12 < lVar19) {
    lVar19 = lVar19 - uVar12;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143086920 + lVar7 * 8))(puVar15,param_4,lVar19,param_9,param_10);
...
LAB_14008056b:
          ...
          uVar20 = param_11 & 0xf;
          if (uVar20 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14008056b;
            uVar20 = 0x10 - uVar20 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar20 + 8)) goto LAB_14008056b;
          uVar10 = 0;
...
LAB_1400800a0:
  if (uVar21 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_140080386;
...
LAB_14008057a:
          ...
          uVar20 = uVar18 & 0xf;
          if (uVar20 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_14008057a;
            uVar20 = 0x10 - uVar20 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar20 + 8)) goto LAB_14008057a;
          uVar11 = 0;
          lVar19 = param_11 + lVar23 * 2;
  ...
  if ((uVar21 != 6) || ((longlong)uVar12 < 1)) goto LAB_140080386;
  if ((longlong)uVar12 < 8) {
LAB_140080572:
    uVar20 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar19 - 2U & 1) != 0) goto LAB_140080572;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar18 + 8)) goto LAB_140080572;
    uVar11 = 0;
...
LAB_140080386:
                    /* WARNING: Could not recover jumptable at 0x0001400803c1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143086920 + lVar7 * 8))(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
