...
void FUN_140878600(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_14087889e:
    ...
    uVar49 = param_2 & 0x1f;
    if (uVar49 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14087889e;
      uVar49 = 0x20 - uVar49 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar49 + 0x10)) goto LAB_14087889e;
    uVar48 = 0;
