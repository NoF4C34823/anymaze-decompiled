...
void FUN_1401e33c0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1401e3d73:
      uVar49 = 0;
      if (param_3 == 0) goto LAB_1401e3607;
      uVar47 = 0;
      uVar50 = param_3;
    }
    else {
      uVar50 = param_2 & 0x1f;
      if (uVar50 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1401e3d73;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1401e3d73;
      ...
      if (param_3 < uVar49 + 1) goto LAB_1401e3607;
...
LAB_1401e3d4d:
          uVar49 = 0;
          if (param_3 == 0) goto LAB_1401e3b72;
          uVar47 = 0;
          uVar50 = param_3;
        }
        else {
          uVar50 = param_2 & 0x1f;
          if (uVar50 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1401e3d4d;
            uVar50 = 0x20 - uVar50 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1401e3d4d;
          ...
          if (param_3 < uVar49 + 1) goto LAB_1401e3b72;
          uVar50 = param_3 - uVar49;
          if ((longlong)uVar50 < 4) {
            uVar47 = 0;
          }
...
LAB_1401e3d3a:
    ...
    uVar50 = param_2 & 0x1f;
    if (uVar50 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1401e3d3a;
      uVar50 = 0x20 - uVar50 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar50 + 0x10)) goto LAB_1401e3d3a;
    uVar47 = 0;
    uVar49 = param_3 - (param_3 - uVar50 & 0xf);
    if (uVar50 != 0) {
      do {
