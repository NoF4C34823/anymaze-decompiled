...
void FUN_1401c9560(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1401ca00d:
      uVar37 = 0;
      if (param_5 == 0) goto LAB_1401c97df;
      uVar47 = 0;
      uVar44 = param_5;
    }
    else {
      ...
      uVar44 = uVar47 & 0xf;
      if (uVar44 != 0) {
        if ((uVar47 & 3) != 0) goto LAB_1401ca00d;
        uVar44 = 0x10 - uVar44 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar44 + 8)) goto LAB_1401ca00d;
      ...
      if (param_5 < uVar37 + 1) goto LAB_1401c97df;
...
LAB_1401c9a4e:
        ...
        uVar32 = uVar32 + 1;
        pfVar38 = pfVar38 + 1;
        if (iVar39 - 1U <= uVar32) goto LAB_1401c9ae0;
      }
      uVar32 = uVar32 + 1;
      pfVar38 = pfVar38 + 1;
...
LAB_1401c9fe1:
      uVar47 = 0;
      if (param_5 == 0) goto LAB_1401c9cfd;
      uVar37 = 0;
      uVar43 = param_5;
    }
    else {
      ...
      uVar43 = uVar44 & 0xf;
      if (uVar43 != 0) {
        if ((uVar44 & 3) != 0) goto LAB_1401c9fe1;
        uVar43 = 0x10 - uVar43 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar43 + 8)) goto LAB_1401c9fe1;
      ...
      in_XMM0._8_4_ = fVar6;
      in_XMM0._12_4_ = fVar6;
      if (param_5 < uVar47 + 1) goto LAB_1401c9cfd;
...
LAB_1401c9cfd:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar44 = param_4 & 0xf;
      if (uVar44 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1401c9ffe;
      ...
      if ((longlong)(uVar44 + 8) <= (longlong)param_5) {
        ...
        if ((lVar33 + uVar44 * 4 & 0xf) == 0) {
          do {
            ...
            auVar51 = packssdw(auVar54,auVar51);
          ...
          do {
            ...
            auVar54 = packssdw(auVar55,auVar11);
...
LAB_1401c9f7d:
  ...
  if (7 < (longlong)param_5) {
    uVar44 = param_4 & 0xf;
    if (uVar44 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1401c9ff7;
      uVar44 = 0x10 - uVar44 >> 1;
    }
    if ((longlong)(uVar44 + 8) <= (longlong)param_5) {
      uVar43 = param_5 - (param_5 - uVar44 & 7);
      ...
      if ((lVar33 + uVar44 * 4 & 0xf) == 0) {
        do {
          ...
          auVar51 = packssdw(auVar52,auVar50);
          *(undefined1 (*) [16])(param_4 + uVar44 * 2) = auVar51;
          uVar44 = uVar44 + 8;
        } while (uVar44 < uVar43);
      }
        ...
        do {
          ...
          auVar54 = packssdw(auVar53,auVar10);
          *(undefined1 (*) [16])(param_4 + uVar44 * 2) = auVar54;
          uVar44 = uVar44 + 8;
        } while (uVar44 < uVar43);
      }
