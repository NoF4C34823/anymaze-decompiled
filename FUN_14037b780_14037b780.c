...
void FUN_14037b780(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar11 - 1)) {
      while( true ) {
        FUN_14036ade0(lVar12,lVar20,uVar23,uVar18,4);
        uVar11 = param_6[1];
        lVar15 = lVar15 + 1;
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        FUN_14036ade0(lVar12,lVar20,uVar23,*param_6,4);
        uVar11 = param_6[1];
          ...
          do {
            ...
            if (0 < (longlong)uVar11) {
              ...
              if (uVar11 >> 3 != 0) {
                ...
                bVar10 = 0;
                do {
                  if (bVar10 < *(byte *)(param_9 + uVar18 + lVar9 * 8)) {
                    bVar10 = *(byte *)(param_9 + uVar18 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar7 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar7 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar4 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar4 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar6 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar6 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar2 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar2 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar5 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar5 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar3 + lVar9 * 8)) {
                    bVar10 = *(byte *)(lVar3 + lVar9 * 8);
                  }
                  if (bVar10 < *(byte *)(lVar1 + lVar9 * 8)) {
              ...
              if (uVar13 <= uVar11) {
                    /* WARNING: Could not recover jumptable at 0x00014037bc0e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_14037bc10 +
                          (byte)(&DAT_143089d50)[(uint)((int)uVar11 - (int)uVar13)]))
                          (param_9 - uVar14);
                return;
              }
            }
                    ...
                    do {
                      if ((*(char *)(param_7 + lVar15 + uVar17 * 2) != '\0') &&
                         (bVar8 = *(byte *)(uVar21 + uVar17 * 8 + lVar12 +
                                           (uVar13 + uVar22) * param_2), bVar10 < bVar8)) {
                        bVar10 = bVar8;
                      }
