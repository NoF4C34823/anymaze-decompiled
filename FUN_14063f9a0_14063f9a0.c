...
/* WARNING: Removing unreachable block (ram,0x0001406406b3) */

void FUN_14063f9a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b680 + lVar18 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar11 < 2) {
                ...
                if (lVar16 < 0) goto LAB_140640a80;
                while (uVar14 == 0) {
                  for (lVar5 = (lVar11 + -1) * 2 - lVar5; lVar5 < 0; lVar5 = -lVar5) {
LAB_140640a80:
                    if (uVar7 != 0) goto LAB_14064094c;
                  }
...
LAB_14064094c:
    ...
    iStack_1d8 = param_10;
    (**(code **)(&DAT_14308b680 + lVar18 * 8))(param_11 + uVar21 * 0xc,param_4,lVar11,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_198 = uVar21 * 3;
      ...
      if (uVar15 != 0 && SCARRY8(uVar10,-3) == (longlong)uVar15 < 0) {
        if (6 < (longlong)uVar15) {
          ...
          if ((lVar16 <= (longlong)(uStack_1a0 - param_1)) ||
            ...
            if (uVar6 == 0) {
LAB_14063fb03:
              if ((longlong)uVar15 < (longlong)(uVar6 + 4)) goto LAB_140640a1c;
              uVar8 = 0;
...
LAB_140640254:
      uStack_1c0 = uVar10;
      pcStack_1b8 = *(code **)(&DAT_14308b680 + lVar18 * 8);
      iStack_1d8 = param_10;
      uStack_190 = param_7;
