...
void FUN_1401f0e20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401f2015. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088220 + lVar30 * 8))(param_1,param_4,*param_5,param_9);
    return;
  }
...
LAB_1401f1e70:
        ...
        *(byte *)(lVar28 + 2 + param_11) = bVar20;
        lVar28 = lVar28 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401f1f0f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088220 + lVar30 * 8))(param_11 + lVar29 * 3,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar17 = lVar29 * 3;
...
LAB_1401f1f12:
            ...
            if ((longlong)uVar13 < (longlong)(uVar10 + 0x10)) goto LAB_1401f1f12;
            uVar21 = 0;
...
LAB_1401f102f:
    ...
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&DAT_143088220 + lVar30 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401f1f5a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (0 < lVar30) {
      ...
      if ((longlong)uVar13 < 7) {
        ...
        if ((longlong)uVar13 < 0x10) {
          ...
          auVar6 = vpshufb_avx(auVar6,_DAT_143088320);
          auVar4 = vpshufb_avx(auVar5,_DAT_143088330);
          auVar6 = vpor_avx(auVar6,auVar4);
          auVar4 = vpshufb_avx(auVar31,_DAT_143088340);
          auVar32 = vpshufb_avx(auVar5,_DAT_143088350);
          auVar5 = vpshufb_avx(auVar5,_DAT_143088380);
          auVar31 = vpunpckhbw_avx(auVar31,auVar7);
          auVar4 = vpor_avx(auVar4,auVar32);
          auVar32 = vpshufb_avx(auVar7,_DAT_143088360);
          auVar31 = vpshufb_avx(auVar31,_DAT_143088370);
          auVar4 = vpor_avx(auVar4,auVar32);
...
LAB_1401f1d34:
                    /* WARNING: Could not recover jumptable at 0x0001401f1d62. Too many branches */
                    /* WARNING: Treating indirect jump as call */
