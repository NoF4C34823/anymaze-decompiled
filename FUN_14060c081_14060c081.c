...
void FUN_14060c081(float param_1,float param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uVar23 = 0;
  uVar24 = in_R11 & 0xfffffffffffffffc;
  do {
    lVar1 = uVar23 + in_R9;
    ...
    *pfVar3 = (*pfVar5 + *pfVar7) * (float)param_4 + (*pfVar4 + *pfVar6) * (float)param_3 +
    ...
    pfVar3[2] = (fVar12 + fVar18) * in_XMM3_Dc + (fVar9 + fVar15) * in_XMM2_Dc + fVar21 * in_XMM5_Dc
    ;
    ...
    do {
      *(float *)(in_RDX + in_R9 * 4 + uVar24 * 4) =
           ...
           param_2 + (*(float *)(lVar1 + -0xc + uVar24 * 4) + *(float *)(lVar1 + 0xc + uVar24 * 4))
                     * in_XMM4_Da + *(float *)(lVar1 + uVar24 * 4) * param_1;
      uVar24 = uVar24 + 1;
    } while (uVar24 < in_R11);
  }
  return;
