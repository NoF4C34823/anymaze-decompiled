...
void FUN_140011afb(ulonglong *param_1,undefined8 param_2,int param_3,undefined8 param_4)

{
  ...
  do {
    ...
    uVar54 = CONCAT11(0,(byte)uVar1);
    auVar26._2_13_ = auVar30;
    auVar26._0_2_ = uVar54;
    auVar8._8_6_ = 0;
    auVar8._0_8_ = uVar2;
    ...
    auVar91._0_10_ = auVar26._0_10_;
    auVar91._10_2_ = auVar33._0_2_;
    uVar41 = CONCAT62(auVar91._10_6_,auVar29._0_2_);
    auVar34._4_8_ = uVar41;
    auVar34._2_2_ = auVar25._2_2_;
    auVar34._0_2_ = auVar30._0_2_;
    uVar55 = CONCAT22(auVar23._8_2_,auVar24._8_2_);
    auVar56._0_8_ = CONCAT26(auVar18._10_2_,CONCAT24(auVar20._10_2_,uVar55));
    auVar56._8_2_ = auVar14._12_2_;
    auVar56._10_2_ = auVar11._12_2_;
    uVar50 = (uint)((ulonglong)auVar56._0_8_ >> 0x20);
    auVar59._12_4_ = uVar50;
    auVar59._8_4_ = auVar34._0_4_;
    auVar59._0_8_ = CONCAT44(uVar55,CONCAT22((short)uVar2,uVar54)) & 0xffffffff00ffffff;
    auVar12._10_2_ = 0;
    ...
    uVar57 = CONCAT24(auVar25._2_2_,auVar34._0_4_) & 0xffff0000ffff;
    auVar89._4_4_ = fVar62;
    auVar89._0_4_ = fVar61;
    auVar89._8_4_ = fVar63;
    auVar89._12_4_ = fVar64;
    auVar98._0_4_ = (float)(int)uVar57;
    auVar98._4_4_ = (float)(ushort)(uVar57 >> 0x20);
    auVar98._8_4_ = (float)(uVar50 & 0xffff);
    auVar98._12_4_ = (float)auVar18._10_2_;
    uVar50 = (uint)uVar41;
    auVar47._0_8_ = CONCAT44(auVar56._8_4_,uVar50);
    auVar47._8_4_ = auVar91._12_4_;
    ...
    auVar53._0_4_ = (int)fVar66;
    fVar69 = auVar91._4_4_;
    auVar53._4_4_ = (int)fVar69;
    fVar71 = auVar91._8_4_;
    auVar53._8_4_ = (int)fVar71;
    fVar73 = auVar91._12_4_;
    auVar53._12_4_ = (int)fVar73;
    fVar65 = fVar66 - auVar81._0_4_;
    fVar68 = fVar69 - auVar81._4_4_;
    fVar70 = fVar71 - auVar81._8_4_;
    fVar72 = fVar73 - auVar81._12_4_;
    uVar50 = -(uint)(in_XMM5_Da == fVar66 || in_XMM5_Da == fVar65);
    uVar48 = -(uint)(in_XMM5_Db == fVar69 || in_XMM5_Db == fVar68);
    uVar51 = -(uint)(in_XMM5_Dc == fVar71 || in_XMM5_Dc == fVar70);
    uVar52 = -(uint)(in_XMM5_Dd == fVar73 || in_XMM5_Dd == fVar72);
    auVar81 = packssdw(auVar53,auVar53);
    auVar92._0_4_ = fVar66 + (float)((uint)in_XMM4_Da & uVar50);
    auVar92._4_4_ = fVar69 + (float)((uint)in_XMM4_Db & uVar48);
    auVar92._8_4_ = fVar71 + (float)((uint)in_XMM4_Dc & uVar51);
    auVar92._12_4_ = fVar73 + (float)((uint)in_XMM4_Dd & uVar52);
    auVar82._0_4_ = (float)((uint)in_XMM4_Da & uVar50) + fVar65;
    auVar82._4_4_ = (float)((uint)in_XMM4_Db & uVar48) + fVar68;
    auVar82._8_4_ = (float)((uint)in_XMM4_Dc & uVar51) + fVar70;
    auVar82._12_4_ = (float)((uint)in_XMM4_Dd & uVar52) + fVar72;
    ...
    *(char *)(in_RDX + 1) = (0 < sVar3) * (sVar3 < 0x100) * auVar81[0] - (0xff < sVar3);
    ...
    iVar46 = (int)(float)(~uVar50 &
                         (uint)((float)(~-(uint)(fVar42 < in_XMM5_Da) & (uint)fVar42) +
                               (float)(-(uint)(fVar42 < in_XMM5_Da) & (uint)(in_XMM4_Da + fVar42))))
    ;
    iVar49 = (int)(float)(~uVar48 &
                         (uint)((float)(~-(uint)(fVar43 < in_XMM5_Db) & (uint)fVar43) +
                               (float)(-(uint)(fVar43 < in_XMM5_Db) & (uint)(in_XMM4_Db + fVar43))))
    ;
    auVar94._4_4_ = iVar49;
    auVar94._0_4_ = iVar46;
    auVar94._8_4_ = iVar49;
    auVar94._12_4_ = (int)(float)(~uVar48 & (uint)(auVar90._4_4_ * auVar82._4_4_ * in_XMM4_Db));
    auVar93._8_8_ = auVar94._8_8_;
    auVar93._4_4_ = (int)(float)(~uVar50 & (uint)(auVar90._0_4_ * auVar82._0_4_ * in_XMM4_Da));
    auVar93._0_4_ = iVar46;
    auVar80._4_4_ = (int)(float)(~uVar51 & (uint)(auVar90._8_4_ * auVar82._8_4_ * in_XMM4_Dc));
    auVar80._0_4_ =
         (int)(float)(~uVar51 &
    ...
    auVar80._12_4_ = (int)(float)(~uVar52 & (uint)(auVar90._12_4_ * auVar82._12_4_ * in_XMM4_Dd));
    ...
    sVar3 = auVar90._4_2_;
    sVar5 = auVar90._6_2_;
    uVar55 = CONCAT13((0 < sVar5) * (sVar5 < 0x100) * auVar90[6] - (0xff < sVar5),
    ...
    uVar88 = CONCAT15((0 < sVar5) * (sVar5 < 0x100) * auVar90[10] - (0xff < sVar5),
                      CONCAT14((0 < sVar3) * (sVar3 < 0x100) * auVar90[8] - (0xff < sVar3),uVar55));
    ...
    *(char *)(in_RDX + 3) = (0 < sVar6) * (sVar6 < 0x100) * auVar81[4] - (0xff < sVar6);
    in_RDX[4] = (short)((uint)uVar55 >> 0x10);
    ...
    *(char *)(in_RDX + 1) = (char)(int)ROUND(fVar65);
    ...
    if ((fVar65 == 0.0) || ((auVar67._0_4_ == 0.0 && (!NAN(auVar67._0_4_))))) {
      ...
      *(char *)((longlong)in_RDX + 1) = (char)(int)ROUND(auVar90._0_4_ * auVar67._0_4_ * in_XMM4_Da)
      ...
      fVar72 = (fVar65 - fVar44) * fVar70;
      fVar68 = (fVar65 - fVar43) * fVar70;
      fVar70 = (fVar65 - fVar42) * fVar70;
      fVar45 = in_XMM5_Da;
      if ((fVar65 == fVar44) && (!NAN(fVar65) && !NAN(fVar44))) {
        fVar45 = fVar68 - fVar70;
      }
      if ((fVar65 == fVar42) && (!NAN(fVar65) && !NAN(fVar42))) {
        fVar45 = (fVar72 - fVar68) + (float)in_XMM2_Qa;
      }
      if ((fVar65 == fVar43) && (!NAN(fVar65) && !NAN(fVar43))) {
        fVar45 = (fVar70 - fVar72) + (float)param_2;
      }
