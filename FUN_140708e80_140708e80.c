...
void FUN_140708e80(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_1407090db:
    ...
    uVar20 = param_2 & 0xf;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407090db;
      uVar20 = 0x10 - uVar20 >> 2;
    }
    if ((longlong)uVar21 < (longlong)(uVar20 + 8)) goto LAB_1407090db;
    uVar17 = 0;
