...
void FUN_1406e4e40(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)
...
LAB_1406e50b7:
    ...
    uVar20 = param_2 & 0xf;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406e50b7;
      uVar20 = 0x10 - uVar20 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar20 + 8)) goto LAB_1406e50b7;
    uVar17 = 0;
