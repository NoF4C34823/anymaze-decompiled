...
void FUN_1406c242b(ulonglong param_1,float param_2,ulonglong param_3,longlong param_4)
  ...
  do {
    *(float *)(in_R10 + in_RAX * 4) =
         (float)((int)*(short *)(param_4 + -6 + in_RAX * 2) +
                (int)*(short *)(param_4 + 6 + in_RAX * 2)) * param_2 +
         (float)((int)*(short *)(param_4 + -4 + in_RAX * 2) +
                (int)*(short *)(param_4 + 4 + in_RAX * 2)) * in_XMM2_Da +
         (float)((int)*(short *)(param_4 + -2 + in_RAX * 2) +
                (int)*(short *)(param_4 + 2 + in_RAX * 2)) * unaff_XMM6_Da +
