...
void FUN_140569a40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  auVar4 = _DAT_14308b020;
  auVar3 = _DAT_14308b000;
            ...
            do {
              ...
              if (uVar17 != 0) {
                ...
                do {
                  ...
                  lVar10 = lVar10 + 1;
                  auVar26 = vpminsw_avx2(auVar27._0_32_,*(undefined1 (*) [32])(lVar1 + uVar11 * 2));
                  auVar27 = ZEXT3264(auVar26);
                  auVar26 = vpminsw_avx2(auVar25._0_32_,
                                         *(undefined1 (*) [32])(lVar1 + 0x20 + uVar11 * 2));
                  auVar25 = ZEXT3264(auVar26);
                  auVar26 = vpminsw_avx2(auVar23._0_32_,
                                         *(undefined1 (*) [32])(lVar1 + 0x40 + uVar11 * 2));
                  auVar23 = ZEXT3264(auVar26);
                  auVar26 = vpminsw_avx2(auVar21._0_32_,
          ...
          do {
            ...
            if (uVar17 != 0) {
              do {
                lVar1 = lVar10 * 2;
                lVar10 = lVar10 + 1;
                auVar19 = vpminsw_avx(auVar21._0_16_,
                                      *(undefined1 (*) [16])
                                       (lVar8 + lVar5 +
                                       (ulonglong)*(ushort *)(param_9 + lVar6 + 2 + lVar1) * 2));
          ...
          do {
            ...
            if (uVar17 != 0) {
              do {
                ...
                auVar19 = vpminsw_avx(auVar21._0_16_,auVar19);
                auVar21 = ZEXT1664(auVar19);
              } while (lVar10 < (longlong)uVar17);
            }
