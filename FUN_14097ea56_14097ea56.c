...
void FUN_14097ea56(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4)

{
  ...
  do {
    auVar27 = vmulps_avx512f(in_ZMM0,*(undefined1 (*) [64])(in_R10 + param_3 * 4));
    auVar28 = vaddps_avx512f(*(undefined1 (*) [64])(param_2 + param_3 * 4),
                             *(undefined1 (*) [64])(param_1 + param_3 * 4));
    auVar27 = vfmadd231ps_avx512f(auVar27,auVar28,in_ZMM1);
    *(undefined1 (*) [64])(unaff_RDI + param_3 * 4) = auVar27;
    param_3 = param_3 + 0x10;
  } while (param_3 < in_R11);
  uVar24 = 0xffff >> (((int)param_3 - (int)in_RAX) + 0x10U & 0x1f);
  if (uVar24 != 0) {
    uVar23 = (ushort)uVar24;
    piVar1 = (int *)(in_R10 + param_3 * 4);
    bVar3 = (byte)uVar24;
    auVar27._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
    auVar27._0_4_ = (uint)(bVar3 & 1) * *piVar1;
    auVar27._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
    auVar27._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
    auVar27._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
    auVar27._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
    auVar27._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
    auVar27._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
    bVar11 = (byte)(uVar24 >> 8);
    ...
    auVar27._60_4_ = (uVar24 >> 0xf & 1) * piVar1[0xf];
    piVar1 = (int *)(param_2 + param_3 * 4);
    auVar28._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
    auVar28._0_4_ = (uint)(bVar3 & 1) * *piVar1;
    auVar28._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
    auVar28._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
    auVar28._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
    auVar28._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
    auVar28._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
    auVar28._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
    ...
    auVar28._60_4_ = (uVar24 >> 0xf & 1) * piVar1[0xf];
    piVar1 = (int *)(param_1 + param_3 * 4);
    auVar29._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
    auVar29._0_4_ = (uint)(bVar3 & 1) * *piVar1;
    auVar29._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
    auVar29._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
    auVar29._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
    auVar29._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
    auVar29._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
    auVar29._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
    ...
    auVar29._60_4_ = (uVar24 >> 0xf & 1) * piVar1[0xf];
    ...
    puVar2 = (uint *)(unaff_RDI + param_3 * 4);
  ...
  auVar27 = _DAT_14308dc40;
  if (in_stack_00000078 == 0) {
    if (0 < (longlong)in_RAX) {
      if ((longlong)in_RAX < 0x40) {
        uVar20 = 0;
      }
      else {
        if ((longlong)in_RAX < 0x396) {
          uVar21 = 0;
          uVar20 = in_RAX & 0xffffffffffffffc0;
        }
        else {
          uVar20 = param_4 & 0x3f;
          uVar21 = uVar20;
          if ((uVar20 != 0) &&
             (uVar21 = 0x40 - uVar20, (longlong)in_RAX < (longlong)(0x40 - uVar20))) {
            uVar21 = in_RAX;
          }
          uVar20 = in_RAX - (in_RAX - uVar21 & 0x3f);
          if (uVar21 != 0) {
            uVar22 = 0;
            auVar28 = vmovdqu32_avx512f(_DAT_14308dc80);
            auVar29 = vmovdqu32_avx512f(_DAT_14308dcc0);
            ...
            do {
              ...
              uVar23 = CONCAT11(bVar3,(byte)uVar18);
              piVar1 = (int *)(unaff_RDI + uVar22 * 4);
              auVar31._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
              auVar31._0_4_ = (uint)((byte)uVar18 & 1) * *piVar1;
              auVar31._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
              auVar31._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
              auVar31._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
              auVar31._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
              auVar31._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
              auVar31._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
              ...
              auVar32 = vcvtps2dq_avx512f(auVar31);
              auVar26 = vextractf64x4_avx512f(auVar32,1);
              auVar26 = vpackssdw_avx512vl(auVar32._0_32_,auVar26);
              auVar26 = vpermq_avx512vl(auVar26,0xd8);
              auVar25 = vextracti32x4_avx512vl(auVar26,1);
              auVar25 = vpackuswb_avx512vl(auVar26._0_16_,auVar25);
              auVar25 = vmovdqu8_avx512vl(auVar25);
              *(undefined1 (*) [16])(uVar22 + param_4) = auVar25;
              uVar22 = uVar22 + 0x10;
            } while (uVar22 < uVar21);
            if (in_RAX == uVar21) {
              return;
        ...
        if ((longlong)(uVar21 + 0x40) <= (longlong)uVar20) {
          do {
            auVar27 = vcvtps2dq_avx512f(*(undefined1 (*) [64])(unaff_RDI + uVar21 * 4));
            auVar28 = vcvtps2dq_avx512f(*(undefined1 (*) [64])(unaff_RDI + 0x40 + uVar21 * 4));
            auVar29 = vcvtps2dq_avx512f(*(undefined1 (*) [64])(unaff_RDI + 0x80 + uVar21 * 4));
            auVar30 = vcvtps2dq_avx512f(*(undefined1 (*) [64])(unaff_RDI + 0xc0 + uVar21 * 4));
            auVar32 = vshuff32x4_avx512f(auVar27,auVar28,0x88);
            auVar27 = vshuff32x4_avx512f(auVar27,auVar28,0xdd);
            auVar28 = vshuff32x4_avx512f(auVar29,auVar30,0x88);
            auVar29 = vshuff32x4_avx512f(auVar29,auVar30,0xdd);
            auVar27 = vpackssdw_avx512bw(auVar32,auVar27);
            auVar28 = vpackssdw_avx512bw(auVar28,auVar29);
            auVar29 = vshuff32x4_avx512f(auVar27,auVar28,0x88);
            auVar27 = vshuff32x4_avx512f(auVar27,auVar28,0xdd);
            auVar27 = vpackuswb_avx512bw(auVar29,auVar27);
            auVar27 = vmovdqu32_avx512f(auVar27);
            *(undefined1 (*) [64])(uVar21 + param_4) = auVar27;
            uVar21 = uVar21 + 0x40;
          } while (uVar21 < uVar20);
        }
      }
      ...
      if (uVar20 + 1 <= in_RAX) {
        ...
        do {
          ...
          auVar29 = vpaddq_avx512f(auVar29,auVar27);
          uVar23 = CONCAT11(bVar3,(byte)uVar18);
          piVar1 = (int *)(unaff_RDI + uVar20 * 4 + uVar21 * 4);
          auVar33._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
          auVar33._0_4_ = (uint)((byte)uVar18 & 1) * *piVar1;
          auVar33._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
          auVar33._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
          auVar33._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
          auVar33._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
          auVar33._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
          auVar33._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
          ...
          auVar32 = vcvtps2dq_avx512f(auVar33);
          auVar26 = vextractf64x4_avx512f(auVar32,1);
          auVar26 = vpackssdw_avx512vl(auVar32._0_32_,auVar26);
          auVar26 = vpermq_avx512vl(auVar26,0xd8);
          auVar25 = vextracti32x4_avx512vl(auVar26,1);
          auVar25 = vpackuswb_avx512vl(auVar26._0_16_,auVar25);
          auVar25 = vmovdqu8_avx512vl(auVar25);
          *(undefined1 (*) [16])(uVar21 + param_4 + uVar20) = auVar25;
          uVar21 = uVar21 + 0x10;
        } while (uVar21 < in_RAX - uVar20);
      }
    }
  }
  else if (0 < (longlong)in_RAX) {
    if ((longlong)in_RAX < 0x40) {
      uVar20 = 0;
    }
    else {
      uVar20 = param_4 & 0x3f;
      uVar21 = uVar20;
      if ((uVar20 != 0) && (uVar21 = 0x40 - uVar20, (longlong)in_RAX < (longlong)(0x40 - uVar20))) {
        uVar21 = in_RAX;
      }
      uVar20 = in_RAX - (in_RAX - uVar21 & 0x3f);
      if (uVar21 != 0) {
        ...
        do {
          ...
          uVar23 = CONCAT11(bVar3,(byte)uVar18);
          piVar1 = (int *)(unaff_RDI + uVar22 * 4);
          auVar32._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
          auVar32._0_4_ = (uint)((byte)uVar18 & 1) * *piVar1;
          auVar32._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
          auVar32._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
          auVar32._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
          auVar32._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
          auVar32._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
          auVar32._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
          ...
          auVar32 = vcvtps2dq_avx512f(auVar32);
          auVar26 = vextractf64x4_avx512f(auVar32,1);
          auVar26 = vpackssdw_avx512vl(auVar32._0_32_,auVar26);
          auVar26 = vpermq_avx512vl(auVar26,0xd8);
          auVar25 = vextracti32x4_avx512vl(auVar26,1);
    ...
    if (uVar20 + 1 <= in_RAX) {
      ...
      do {
        ...
        uVar23 = CONCAT11(bVar3,(byte)uVar18);
        piVar1 = (int *)(unaff_RDI + uVar20 * 4 + uVar21 * 4);
        auVar34._4_4_ = (uint)((byte)(uVar23 >> 1) & 1) * piVar1[1];
        auVar34._0_4_ = (uint)((byte)uVar18 & 1) * *piVar1;
        auVar34._8_4_ = (uint)((byte)(uVar23 >> 2) & 1) * piVar1[2];
        auVar34._12_4_ = (uint)((byte)(uVar23 >> 3) & 1) * piVar1[3];
        auVar34._16_4_ = (uint)((byte)(uVar23 >> 4) & 1) * piVar1[4];
        auVar34._20_4_ = (uint)((byte)(uVar23 >> 5) & 1) * piVar1[5];
        auVar34._24_4_ = (uint)((byte)(uVar23 >> 6) & 1) * piVar1[6];
        auVar34._28_4_ = (uint)((byte)(uVar23 >> 7) & 1) * piVar1[7];
        ...
        auVar32 = vcvtps2dq_avx512f(auVar34);
        auVar26 = vextractf64x4_avx512f(auVar32,1);
        auVar26 = vpackssdw_avx512vl(auVar32._0_32_,auVar26);
        auVar26 = vpermq_avx512vl(auVar26,0xd8);
        auVar25 = vextracti32x4_avx512vl(auVar26,1);
