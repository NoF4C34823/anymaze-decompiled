...
void FUN_14029a980(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
  ...
  if (param_7 == 0) {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar30 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (bVar34 = *(byte *)(lVar30 * 3 + -3 + lVar10 + uVar23), bVar35 < bVar34)) {
                bVar35 = bVar34;
              }
            }
    ...
    if (0 < param_5._4_4_) {
      ...
      do {
          ...
          do {
            ...
            if (0 < (int)param_6) {
              ...
              if ((lVar14 - 1U < (ulonglong)(longlong)(int)param_6) &&
                 (bVar34 = *(byte *)(lVar14 * 3 + -3 + lVar10 + lVar11 + uVar23), bVar35 < bVar34))
              {
                bVar35 = bVar34;
              }
            }
        ...
        FUN_1402a53a0(param_9,uVar8,param_3,uVar6,lVar16);
        uVar25 = uVar25 + 1;
        uVar31 = uVar31 + 1;
                  ...
                  if ((longlong)(uStack_68 + 0x10) <= (longlong)uVar8) {
                    ...
                    if (uStack_68 != 0) {
                      do {
                        if ((*(char *)(uVar9 + uVar22) != '\0') &&
                           (bVar34 = *(byte *)(lVar14 + uVar9 * 3 + uVar12), bVar35 < bVar34)) {
                          bVar35 = bVar34;
                        }
                        uVar9 = uVar9 + 1;
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar32 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar4 = auVar37[0];
                        auVar33[0] = (bVar35 < bVar4) * bVar4 | (bVar35 >= bVar4) * bVar35;
                        bVar35 = auVar37[1];
                        auVar33[1] = (bVar34 < bVar35) * bVar35 | (bVar34 >= bVar35) * bVar34;
                        bVar35 = auVar37[2];
                        auVar33[2] = (bVar38 < bVar35) * bVar35 | (bVar38 >= bVar35) * bVar38;
                        bVar35 = auVar37[3];
                        auVar33[3] = (bVar39 < bVar35) * bVar35 | (bVar39 >= bVar35) * bVar39;
                        bVar35 = auVar37[4];
                        auVar33[4] = (bVar40 < bVar35) * bVar35 | (bVar40 >= bVar35) * bVar40;
                        bVar35 = auVar37[5];
                        auVar33[5] = (bVar41 < bVar35) * bVar35 | (bVar41 >= bVar35) * bVar41;
                        bVar35 = auVar37[6];
                        auVar33[6] = (bVar42 < bVar35) * bVar35 | (bVar42 >= bVar35) * bVar42;
                        bVar35 = auVar37[7];
                        auVar33[7] = (bVar43 < bVar35) * bVar35 | (bVar43 >= bVar35) * bVar43;
                        bVar35 = auVar37[8];
                        auVar33[8] = (bVar44 < bVar35) * bVar35 | (bVar44 >= bVar35) * bVar44;
                        bVar35 = auVar37[9];
                        auVar33[9] = (bVar15 < bVar35) * bVar35 | (bVar15 >= bVar35) * bVar15;
                        bVar35 = auVar37[10];
                        auVar33[10] = (bVar20 < bVar35) * bVar35 | (bVar20 >= bVar35) * bVar20;
                        bVar35 = auVar37[0xb];
                        auVar33[0xb] = (bVar2 < bVar35) * bVar35 | (bVar2 >= bVar35) * bVar2;
                        bVar35 = auVar37[0xc];
                        auVar33[0xc] = (bVar3 < bVar35) * bVar35 | (bVar3 >= bVar35) * bVar3;
                        bVar35 = auVar37[0xd];
                        auVar33[0xd] = (bVar7 < bVar35) * bVar35 | (bVar7 >= bVar35) * bVar7;
                        bVar35 = auVar37[0xe];
                        auVar33[0xe] = (bVar13 < bVar35) * bVar35 | (bVar13 >= bVar35) * bVar13;
                        bVar35 = auVar37[0xf];
                        auVar33[0xf] = (bVar21 < bVar35) * bVar35 | (bVar21 >= bVar35) * bVar21;
                    ...
                    bVar35 = auVar37[8];
                    bVar34 = auVar37[0];
                    bVar34 = (bVar34 < bVar35) * bVar35 | (bVar34 >= bVar35) * bVar34;
                    bVar35 = auVar37[9];
                    bVar38 = auVar37[1];
                    bVar38 = (bVar38 < bVar35) * bVar35 | (bVar38 >= bVar35) * bVar38;
                    bVar35 = auVar37[10];
                    bVar39 = auVar37[2];
                    bVar39 = (bVar39 < bVar35) * bVar35 | (bVar39 >= bVar35) * bVar39;
                    bVar35 = auVar37[0xb];
                    bVar40 = auVar37[3];
                    bVar40 = (bVar40 < bVar35) * bVar35 | (bVar40 >= bVar35) * bVar40;
                    bVar35 = auVar37[0xc];
                    bVar41 = auVar37[4];
                    bVar41 = (bVar41 < bVar35) * bVar35 | (bVar41 >= bVar35) * bVar41;
                    bVar35 = auVar37[0xd];
                    bVar42 = auVar37[5];
                    bVar42 = (bVar42 < bVar35) * bVar35 | (bVar42 >= bVar35) * bVar42;
                    bVar35 = auVar37[0xe];
                    bVar43 = auVar37[6];
                    bVar43 = (bVar43 < bVar35) * bVar35 | (bVar43 >= bVar35) * bVar43;
                    bVar35 = auVar37[0xf];
                    bVar44 = auVar37[7];
                    bVar44 = (bVar44 < bVar35) * bVar35 | (bVar44 >= bVar35) * bVar44;
                    bVar35 = (bVar34 < bVar41) * bVar41 | (bVar34 >= bVar41) * bVar34;
                    bVar34 = (bVar38 < bVar42) * bVar42 | (bVar38 >= bVar42) * bVar38;
                    bVar38 = (bVar39 < bVar43) * bVar43 | (bVar39 >= bVar43) * bVar39;
                    bVar39 = (bVar40 < bVar44) * bVar44 | (bVar40 >= bVar44) * bVar40;
                    bVar35 = (bVar35 < bVar38) * bVar38 | (bVar35 >= bVar38) * bVar35;
                    bVar34 = (bVar34 < bVar39) * bVar39 | (bVar34 >= bVar39) * bVar34;
