...
ulonglong FUN_1409d8500(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    uVar6 = (*(code *)(&PTR_LAB_14308e560)[param_6])
                      (param_1 + param_2 * param_3,param_4,*param_5,param_9,param_10);
    return uVar6;
  }
  if (param_3 < 0) {
    if (param_7 == 0xf0) goto LAB_1409d860f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x10;
      goto joined_r0x0001409d881b;
    }
    if ((param_7 & 0xf) == 1) {
      if ((param_7 & 0x10) == 0) {
        param_3 = 0;
    ...
    if ((param_3 < (longlong)param_5[1]) || (param_7 == 0xf0)) goto LAB_1409d860f;
    if ((param_7 & 0xf) == 6) {
      uVar2 = param_7 & 0x20;
joined_r0x0001409d881b:
      if (uVar2 == 0) {
        ...
        if ((longlong)uVar6 < 0x10) {
          ...
          auVar15 = vmovdqu32_avx512f(_DAT_14308e400);
          lVar7 = 0;
          do {
        ...
        uVar3 = vpcmpgtq_avx512f(auVar12,_DAT_14308e300);
        uVar4 = vpcmpgtq_avx512f(auVar12,_DAT_14308e340);
        auVar12 = vmovdqu32_avx512f(_DAT_14308e400);
...
LAB_1409d860f:
  uStack_38 = *param_5;
  uStack_30 = param_5[1];
  uVar6 = FUN_1409e4ce0(uStack_38,param_2,param_3,param_4,&uStack_38,param_6,param_7,param_8,param_9
                        ,param_10,param_11);
  return uVar6;
}
