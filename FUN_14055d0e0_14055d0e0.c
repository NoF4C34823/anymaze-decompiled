...
void FUN_14055d0e0(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
  ...
  if (0 < param_6 + -1) {
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        uVar26 = uVar29 & 0x1f;
        iVar24 = (int)uVar26 + 6;
        uVar33 = FUN_14055e040(param_1);
        uVar34 = FUN_14055e040(*param_1 + param_2,iVar24);
        uVar35 = FUN_14055e040(*param_1 + param_2 * 2,iVar24);
        iVar24 = (int)uVar26 + -0x1a;
        uVar36 = FUN_14055e040(param_1 + 1);
        uVar37 = FUN_14055e040(param_1[1] + param_2,iVar24);
        auVar39._0_8_ = FUN_14055e040((longlong)(*param_1 + param_2 * 2) + 0x20,iVar24);
        ...
        auVar45 = vpminub_avx2(auVar6,auVar45);
        ...
        auVar7 = vpminub_avx2(auVar45,auVar7);
        auVar45 = vpminub_avx2(auVar5,auVar39._0_32_);
        auVar6 = vperm2i128_avx2(auVar7,auVar45,0x21);
        auVar45 = vpalignr_avx2(auVar6,auVar7,3);
        auVar5 = vpminub_avx2(auVar7,auVar45);
        auVar45 = vpalignr_avx2(auVar6,auVar7,6);
        auVar45 = vpminub_avx2(auVar5,auVar45);
...
LAB_14055d2e7:
          if (7 < (longlong)uVar26) {
            *(longlong *)*pauStack_68 = auVar43._0_8_;
            ...
            uVar26 = uVar26 - 8;
            if (uVar26 == 0) goto LAB_14055d373;
          }
          ...
          if (1 < (longlong)uVar26) {
            ...
            *(short *)*pauStack_68 = auVar43._0_2_;
            ...
            if (uVar26 == 2) goto LAB_14055d373;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar43;
          ...
          uVar26 = uVar26 - 0x10;
          if (uVar26 != 0) goto LAB_14055d2e7;
        }
LAB_14055d373:
      ...
      if (lVar25 != 0) {
        auVar45 = vpminub_avx2(*pauVar32,*(undefined1 (*) [32])(*pauVar32 + param_2));
        auVar45 = vpminub_avx2(auVar45,*(undefined1 (*) [32])(*pauVar32 + param_2 * 2));
        lVar23 = 0;
        if (0 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            ...
            auVar45 = vpminub_avx2(auVar5,auVar45);
            auVar45 = vpminub_avx2(auVar7,auVar45);
            *pauVar27 = auVar45;
            pauVar27 = pauVar27 + 1;
            auVar45 = auVar6;
          } while (lVar23 < lVar25);
      ...
      if (uVar29 != 0) {
        iVar24 = (int)uVar29 + 6;
        uVar33 = FUN_14055e040(pauVar32);
        uVar34 = FUN_14055e040(*pauVar32 + param_2,iVar24);
        uVar35 = FUN_14055e040(*pauVar32 + param_2 * 2,iVar24);
        iVar24 = (int)uVar29 + -0x1a;
        uVar36 = FUN_14055e040(pauVar32 + 1);
        uVar37 = FUN_14055e040(pauVar32[1] + param_2,iVar24);
        auVar40._0_8_ = FUN_14055e040((longlong)(*pauVar32 + param_2 * 2) + 0x20,iVar24);
        ...
        auVar45 = vpminub_avx2(auVar17,auVar12);
        ...
        auVar7 = vpminub_avx2(auVar45,auVar15);
        auVar45 = vpminub_avx2(auVar5,auVar40._0_32_);
        auVar6 = vperm2i128_avx2(auVar7,auVar45,0x21);
        auVar45 = vpalignr_avx2(auVar6,auVar7,3);
        auVar5 = vpminub_avx2(auVar7,auVar45);
        auVar45 = vpalignr_avx2(auVar6,auVar7,6);
        ...
        if (0xf < uVar29) {
          *(undefined1 (*) [16])*pauVar27 = auVar43;
          ...
          uVar29 = uVar29 - 0x10;
          if (uVar29 == 0) goto LAB_14055d57b;
        }
        ...
        if (1 < (longlong)uVar29) {
          ...
          *(short *)*pauVar27 = auVar43._0_2_;
          ...
          if (uVar29 == 2) goto LAB_14055d57b;
        }
  ...
  if (lVar28 < param_6) {
    do {
      ...
      if (((ulonglong)param_3 & 0x1f) != 0) {
        ...
        uVar35 = FUN_14055e040(puVar2,iVar24);
        uVar36 = FUN_14055e040(param_1 + 1);
        auVar41._0_8_ = FUN_14055e040(param_1[1] + param_2,uVar26 - 0x1a & 0xffffffff);
...
LAB_14055dcf2:
          if (7 < (longlong)uVar26) {
            *(longlong *)*pauStack_60 = auVar43._0_8_;
            ...
            auVar43 = vpsrldq_avx(auVar43,8);
            uVar26 = uVar26 - 8;
            if (uVar26 == 0) goto LAB_14055dd7e;
          }
          if (3 < (longlong)uVar26) {
          ...
          if (1 < (longlong)uVar26) {
            ...
            *(short *)*pauStack_60 = auVar43._0_2_;
            ...
            if (uVar26 == 2) goto LAB_14055dd7e;
          }
          ...
          *(undefined1 (*) [16])*param_3 = auVar43;
          ...
          uVar26 = uVar26 - 0x10;
          if (uVar26 != 0) goto LAB_14055dcf2;
        }
LAB_14055dd7e:
        uVar26 = param_5 - uVar29;
        pauVar27 = (undefined1 (*) [32])(*param_3 + uVar29);
      ...
      if (lVar25 != 0) {
        ...
        auVar45 = vpminub_avx2(*pauVar32,*pauVar30);
        pauVar31 = (undefined1 (*) [32])(*pauVar32 + param_2 * 2);
        auVar45 = vpminub_avx2(auVar45,*pauVar31);
        lVar23 = 0;
        auVar5 = auVar45;
        if (1 < lVar25) {
          do {
            lVar23 = lVar23 + 1;
            auVar45 = vpminub_avx2(pauVar32[1],*(undefined1 (*) [32])(pauVar32[1] + param_2));
            auVar45 = vpminub_avx2(auVar45,*(undefined1 (*) [32])(pauVar32[1] + param_2 * 2));
            pauVar32 = pauVar32 + 1;
      ...
      if (uVar29 != 0) {
        ...
        uVar36 = FUN_14055e040(pauVar32 + 1);
        uVar37 = FUN_14055e040(pauVar32[1] + param_2,iVar24);
        auVar42._0_8_ = FUN_14055e040((longlong)(*pauVar32 + param_2 * 2) + 0x20,iVar24);
        ...
        if (0xf < uVar29) {
          *(undefined1 (*) [16])*pauVar27 = auVar43;
          ...
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 0x10);
          uVar29 = uVar29 - 0x10;
          if (uVar29 == 0) goto LAB_14055dffe;
        }
        if (7 < (longlong)uVar29) {
          *(longlong *)*pauVar27 = auVar43._0_8_;
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 8);
        ...
        if (1 < (longlong)uVar29) {
          ...
          *(short *)*pauVar27 = auVar43._0_2_;
          pauVar27 = (undefined1 (*) [32])(*pauVar27 + 2);
          if (uVar29 == 2) goto LAB_14055dffe;
        }
        (*pauVar27)[0] = auVar44[0];
      }
LAB_14055dffe:
