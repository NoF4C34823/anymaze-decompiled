...
void FUN_1407bb680(longlong param_1,ulonglong param_2,longlong param_3,undefined1 (*param_4) [16])
...
LAB_1407bbc92:
    ...
    uVar8 = param_2 & 0xf;
    if (uVar8 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407bbc92;
      uVar8 = 0x10 - uVar8 >> 2;
    }
    if ((longlong)uVar11 < (longlong)(uVar8 + 0x10)) goto LAB_1407bbc92;
    uVar9 = 0;
