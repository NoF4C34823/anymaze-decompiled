...
void FUN_1404a5a80(undefined1 (*param_1) [16],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6 + -1) {
    do {
      ...
      if (((ulonglong)param_3 & 0xf) != 0) {
        ...
        FUN_1404a5de0(param_1,param_2,param_3,uVar10);
      ...
      if (uVar10 != 0) {
        lVar2 = 0;
        auVar12 = vpmaxub_avx(*pauVar3,*(undefined1 (*) [16])(*pauVar3 + param_2));
        auVar12 = vpmaxub_avx(auVar12,*(undefined1 (*) [16])(*pauVar3 + param_2 * 2));
        auVar13 = ZEXT1664(auVar12);
        if (0 < (longlong)(uVar10 & 0xfffffffffffffffe)) {
          do {
            auVar12 = vpmaxub_avx(pauVar3[1],*(undefined1 (*) [16])(pauVar3[1] + param_2));
            lVar2 = lVar2 + 2;
            auVar15 = vpmaxub_avx(auVar12,*(undefined1 (*) [16])(pauVar3[1] + param_2 * 2));
            ...
            auVar12 = vpmaxub_avx(auVar14,auVar12);
            *pauVar7 = auVar12;
            auVar12 = vpmaxub_avx(pauVar3[2],*(undefined1 (*) [16])(pauVar3[2] + param_2));
            auVar14 = vpmaxub_avx(auVar12,*(undefined1 (*) [16])(pauVar3[2] + param_2 * 2));
  ...
  if (lVar6 < param_6) {
    do {
      ...
      if (lVar2 != 0) {
        ...
        auVar12 = vpmaxub_avx(*pauVar3,*pauVar5);
        pauVar8 = (undefined1 (*) [16])(*pauVar3 + param_2 * 2);
        auVar12 = vpmaxub_avx(auVar12,*pauVar8);
        auVar14 = auVar12;
        if (1 < lVar2) {
          do {
            auVar12 = vpmaxub_avx(pauVar3[1],*(undefined1 (*) [16])(pauVar3[1] + param_2));
            lVar9 = lVar9 + 1;
            auVar12 = vpmaxub_avx(auVar12,*(undefined1 (*) [16])(pauVar3[1] + param_2 * 2));
            pauVar3 = pauVar3 + 1;
            auVar15 = vpalignr_avx(auVar12,auVar14,4);
            auVar11 = vpalignr_avx(auVar12,auVar14,8);
            auVar14 = vpmaxub_avx(auVar15,auVar14);
            auVar14 = vpmaxub_avx(auVar11,auVar14);
            *pauVar7 = auVar14;
            pauVar7 = pauVar7 + 1;
            auVar14 = auVar12;
          } while (lVar9 < lVar2 + -1);
        ...
        auVar14 = vpmaxub_avx(auVar14,auVar15);
        auVar11._8_8_ = 0;
        auVar11._0_8_ = *(ulonglong *)pauVar8[1];
        auVar15 = vpmaxub_avx(auVar14,auVar11);
        auVar14 = vpalignr_avx(auVar15,auVar12,8);
        auVar15 = vpalignr_avx(auVar15,auVar12,4);
        auVar12 = vpmaxub_avx(auVar15,auVar12);
        auVar12 = vpmaxub_avx(auVar14,auVar12);
        *pauVar7 = auVar12;
        pauVar7 = pauVar7 + 1;
      }
      if ((uVar4 & 0xf) != 0) {
        FUN_1404a5de0(pauVar3,param_2,pauVar7);
      }
      lVar6 = lVar6 + 1;
      param_1 = (undefined1 (*) [16])(*param_1 + param_2);
      param_3 = (undefined1 (*) [16])(*param_3 + param_4);
