...
void FUN_140656f80(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14065784e:
      uVar97 = 0;
      if (param_3 == 0) goto LAB_140657186;
      uVar95 = 0;
      uVar99 = param_3;
    }
    else {
      uVar99 = param_2 & 0xf;
      if (uVar99 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14065784e;
        uVar99 = 0x10 - uVar99 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_14065784e;
      ...
      if (param_3 < uVar97 + 1) goto LAB_140657186;
...
LAB_140657828:
          uVar97 = 0;
          if (param_3 == 0) goto LAB_140657671;
          uVar95 = 0;
          uVar99 = param_3;
        }
        else {
          uVar99 = param_2 & 0xf;
          if (uVar99 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140657828;
            uVar99 = 0x10 - uVar99 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_140657828;
          ...
          if (param_3 < uVar97 + 1) goto LAB_140657671;
          uVar99 = param_3 - uVar97;
          if ((longlong)uVar99 < 4) {
            uVar95 = 0;
          }
...
LAB_140657815:
    ...
    uVar99 = param_2 & 0xf;
    if (uVar99 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140657815;
      uVar99 = 0x10 - uVar99 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_140657815;
    uVar95 = 0;
    uVar97 = param_3 - (param_3 - uVar99 & 7);
    if (uVar99 != 0) {
      do {
