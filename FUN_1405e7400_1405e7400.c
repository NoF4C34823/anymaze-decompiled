...
void FUN_1405e7400(ulonglong param_1,float param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    uVar18 = in_RDX & 0xf;
    if (uVar18 != 0) {
      if ((in_RDX & 3) != 0) goto LAB_1405e75f3;
...
LAB_1405e75fc:
  FUN_1405e7598(uVar18,param_2,fVar7,0);
  return;
}
