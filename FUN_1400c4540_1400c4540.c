...
/* WARNING: Removing unreachable block (ram,0x0001400c6462) */

ulonglong FUN_1400c4540(ulonglong param_1,longlong param_2,uint *param_3,longlong param_4,
...

{
  ...
  lStack_68 = param_2;
  if (iVar16 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1400c69e3;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      uStack_1e0 = 0;
      uStack_128 = 0;
      pcStack_e8 = *(code **)(&UNK_143086c20 + lVar13 * 8);
            ...
            if (lStack_d8 < (longlong)(uVar7 + uVar20)) {
              ...
              do {
                ...
                if (lVar8 < 0) {
                  if (uStack_118 != 0xf0) {
                    if (iVar16 == 6) {
                      if (uStack_f0 == 0) goto LAB_1400c6932;
                    }
                    else {
                      if (iVar16 != 1) goto LAB_1400c68a3;
LAB_1400c6a89:
                      lVar22 = 0;
                      if (uStack_f0 != 0) {
                        lVar22 = lVar8;
...
LAB_1400c6914:
                  ...
                  if ((lVar8 < (longlong)uVar20) || (uStack_118 == 0xf0)) goto LAB_1400c6914;
                  if (iVar16 != 6) {
                    if (iVar16 == 1) {
                      if (lVar8 < 0) goto LAB_1400c6a89;
                      if (uStack_c8 == 0) {
                        lVar22 = uVar20 - 1;
                      }
                    }
...
LAB_1400c6a9d:
                  ...
                  if (uStack_c8 != 0) goto LAB_1400c6914;
LAB_1400c6932:
                  uVar11 = *puVar6;
                  uVar3 = puVar6[1];
                  uVar1 = puVar6[2];
...
LAB_1400c5939:
                    ...
                    uVar11 = puStack_e0[2];
                    if ((longlong)uStack_180 < 0x10) goto LAB_1400c5939;
                    uVar18 = 0;
                    auVar25 = vshufps_avx(ZEXT416(uVar11),ZEXT416(uVar11),0);
                    puVar5 = puStack_120;
                    do {
      ...
      do {
        if (0 < (longlong)param_1) {
          ...
          if (7 < (longlong)param_1) {
            ...
            if (uVar18 != 0) {
              if (((ulonglong)puVar15 & 3) != 0) goto LAB_1400c499d;
...
LAB_1400c499d:
    ...
    if ((uStack_48 ^ (ulonglong)auStack_248) != DAT_1436b4680) goto LAB_1400c471a;
  }
  else {
    if (uVar11 == 3) {
        ...
        do {
          if (0 < (longlong)uVar7) {
            ...
            if (7 < (longlong)uVar7) {
              ...
              if (uVar14 != 0) {
                if (((ulonglong)puVar15 & 3) != 0) goto LAB_1400c485b;
