...
void FUN_140884d60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14088554c:
      ...
      uVar48 = uVar47 & 0x1f;
      if (uVar48 != 0) {
        if ((uVar47 & 3) != 0) goto LAB_14088554c;
        uVar48 = 0x20 - uVar48 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar48 + 8)) goto LAB_14088554c;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar47 = uVar48 & 0xf;
      if (uVar47 != 0) {
        if ((uVar48 & 3) != 0) goto LAB_14088555a;
...
LAB_1408854c3:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar47 = uVar48 & 0xf;
    if (uVar47 != 0) {
      if ((uVar48 & 3) != 0) goto LAB_140885553;
      uVar47 = 0x10 - uVar47 >> 2;
    }
    if ((longlong)(uVar47 + 8) <= (longlong)param_5) {
      uVar46 = 0;
