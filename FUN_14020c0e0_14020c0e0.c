...
void FUN_14020c0e0(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)
...
LAB_14020c536:
    ...
    if ((longlong)param_3 < 0x1d) {
      ...
      uVar23 = param_2 & 0x1f;
      if (uVar23 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14020c536;
        uVar23 = 0x20 - uVar23 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar23 + 0x10)) goto LAB_14020c536;
      uVar21 = 0;
      uVar22 = param_3 - (param_3 - uVar23 & 0xf);
      if (uVar23 != 0) {
        do {
          auVar27._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -4 + uVar21 * 2) +
                      (uint)*(ushort *)(param_1 + 4 + uVar21 * 2));
          auVar27._4_12_ = in_ZMM2._4_12_;
          auVar27 = vfmadd231ss_fma(ZEXT416((uint)(fVar4 * (float)((uint)*(ushort *)
                                                                          (param_1 + -2 + uVar21 * 2
                                                                          ) +
                                                                  (uint)*(ushort *)
                                                                         (param_1 + 2 + uVar21 * 2))
                                                  )),auVar27,ZEXT416((uint)fVar3));
          auVar24 = vfmadd231ss_fma(ZEXT416((uint)(fVar5 * (float)*(ushort *)(param_1 + uVar21 * 2))
                                           ),ZEXT416((uint)(float)((uint)*(ushort *)
                                                                          (param_1 + -6 + uVar21 * 2
                                                                          ) +
                                                                  (uint)*(ushort *)
                                                                         (param_1 + 6 + uVar21 * 2))
    ...
    do {
      ...
      auVar33 = vpmovzxwd_avx2(auVar6._0_16_);
      ...
      auVar20 = vpmovzxwd_avx2(auVar9._0_16_);
      auVar33 = vpmovzxwd_avx2(auVar8._0_16_);
      auVar20 = vpaddd_avx2(auVar20,auVar33);
      ...
      auVar7 = vpmovzxwd_avx2(auVar10._0_16_);
      auVar6 = vpaddd_avx2(auVar6,auVar7);
      auVar6 = vcvtdq2ps_avx(auVar6);
      auVar7 = vpmovzxwd_avx2(auVar11._16_16_);
      auVar8 = vpmovzxwd_avx2(auVar10._16_16_);
      ...
      auVar6 = vpmovzxwd_avx2(auVar12._0_16_);
      auVar6 = vcvtdq2ps_avx(auVar6);
  ...
  if (uVar22 + 1 <= param_3) {
    ...
    if (uVar23 < param_3) {
      ...
      do {
        auVar28._0_4_ =
             (float)((uint)*(ushort *)(param_1 + -4 + uVar23 * 2) +
                    (uint)*(ushort *)(param_1 + 4 + uVar23 * 2));
        ...
        auVar24 = vfmadd231ss_fma(ZEXT416((uint)(fVar5 * (float)*(ushort *)(param_1 + uVar23 * 2))),
                                  ZEXT416((uint)(float)((uint)*(ushort *)(param_1 + -6 + uVar23 * 2)
                                                       + (uint)*(ushort *)(param_1 + 6 + uVar23 * 2)
                                                       )),ZEXT416(uVar2));
        in_ZMM2 = ZEXT1664(auVar24);
