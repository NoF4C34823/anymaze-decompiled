...
void FUN_1401d6620(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001401d7692. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088040 + lVar7 * 8))(puVar23,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar15 < 0) goto LAB_1401d7620;
                while (uVar11 == 0) {
                  for (lVar22 = (lVar16 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_1401d7620:
                    if (uVar12 != 0) goto LAB_1401d7524;
                  }
...
LAB_1401d7524:
        ...
        *(ushort *)(param_11 + lVar13 * 2) = uVar21;
        lVar13 = lVar13 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401d7588. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088040 + lVar7 * 8))(param_11 + uVar14 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
...
LAB_1401d759c:
              ...
              uVar17 = uVar10 & 0xf;
              if (uVar17 != 0) {
                if ((uVar10 & 1) != 0) goto LAB_1401d759c;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_1401d759c;
...
LAB_1401d6abf:
      if (uVar18 == 1) {
        if ((longlong)uVar14 < 1) goto LAB_1401d6ccd;
...
LAB_1401d75fb:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401d75fb;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_1401d75fb;
          uVar8 = 0;
...
LAB_1401d75a3:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401d75a3;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_1401d75a3;
          uVar8 = 0;
          uVar20 = uVar14 - (uVar14 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_1401d6ccd:
      in_XMM0._0_8_ =
           (**(code **)(&DAT_143088040 + lVar7 * 8))(uVar10,param_4,uVar14,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001401d75f8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_143088040 + lVar7 * 8))(puVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar14 < lVar16) {
    lVar16 = lVar16 - uVar14;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_143088040 + lVar7 * 8))(puVar23,param_4,lVar16,param_9,param_10);
...
LAB_1401d75aa:
          ...
          uVar10 = param_11 & 0xf;
          if (uVar10 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1401d75aa;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar10 + 8)) goto LAB_1401d75aa;
...
LAB_1401d7139:
  if (uVar18 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_1401d73db;
...
LAB_1401d75b9:
          ...
          uVar10 = uVar19 & 0xf;
          if (uVar10 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_1401d75b9;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar10 + 8)) goto LAB_1401d75b9;
          uVar17 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar14 < 1)) goto LAB_1401d73db;
  if ((longlong)uVar14 < 8) {
LAB_1401d75b1:
    uVar10 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_1401d75b1;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar14 < (longlong)(uVar19 + 8)) goto LAB_1401d75b1;
    uVar17 = 0;
...
LAB_1401d73db:
                    /* WARNING: Could not recover jumptable at 0x0001401d7414. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_143088040 + lVar7 * 8))(param_11 + uVar14 * 2,param_4,uVar14);
  return;
}
