...
void FUN_14070dd60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14070e30e:
      ...
      uVar21 = uVar23 & 0xf;
      if (uVar21 != 0) {
        if ((uVar23 & 3) != 0) goto LAB_14070e30e;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar21 + 8)) goto LAB_14070e30e;
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar23 & 0xf;
      if (uVar21 != 0) {
        if ((uVar23 & 3) != 0) goto LAB_14070e31d;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)(uVar21 + 4) <= (longlong)param_5) {
        ...
        auVar17 = _DAT_14308bf00;
        auVar16 = _DAT_14308bef0;
        lVar24 = uVar21 * 2;
        do {
...
LAB_14070e2ab:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar21 = uVar23 & 0xf;
    if (uVar21 != 0) {
      if ((uVar23 & 3) != 0) goto LAB_14070e316;
      uVar21 = 0x10 - uVar21 >> 2;
    }
