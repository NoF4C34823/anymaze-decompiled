...
void FUN_1405e4ae0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001405e5b99. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(psVar20,param_4,*param_5);
    return;
  }
  if (uVar12 == 6) {
    sVar24 = *param_8;
          ...
          if (uVar12 != 6) {
            if (uVar12 == 1) {
              ...
              if (lVar14 < 2) {
                ...
                if (lVar26 < 0) goto LAB_1405e5b20;
                while (uVar22 == 0) {
                  for (lVar8 = (lVar14 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_1405e5b20:
                    if (uVar7 != 0) goto LAB_1405e5a25;
                  }
...
LAB_1405e5a25:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar25;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001405e5a86. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,lVar14,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar11 == 1) {
...
LAB_1405e5a9a:
              ...
              uVar16 = uVar6 & 0xf;
              if (uVar16 != 0) {
                if ((uVar6 & 1) != 0) goto LAB_1405e5a9a;
                uVar16 = 0x10 - uVar16 >> 1;
              }
              if ((longlong)uVar17 < (longlong)(uVar16 + 8)) goto LAB_1405e5a9a;
...
LAB_1405e4f9b:
      if (uVar12 == 1) {
        if ((longlong)uVar11 < 1) goto LAB_1405e51ae;
...
LAB_1405e5afe:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1405e5afe;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar16 + 8)) goto LAB_1405e5afe;
          uVar10 = 0;
...
LAB_1405e5aa1:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1405e5aa1;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar16 + 8)) goto LAB_1405e5aa1;
          uVar10 = 0;
          uVar23 = uVar11 - (uVar11 - uVar16 & 7);
          if (uVar16 != 0) {
            do {
...
LAB_1405e51ae:
      in_XMM0._0_8_ =
           (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(uVar6,param_4,uVar11,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001405e5afb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(psVar20,param_4,lVar14);
    return;
  }
  if ((longlong)uVar11 < lVar14) {
    lVar14 = lVar14 - uVar11;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(psVar20,param_4,lVar14,param_9,param_10);
...
LAB_1405e5aa9:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1405e5aa9;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar17 < (longlong)(uVar6 + 8)) goto LAB_1405e5aa9;
...
LAB_1405e563c:
  if (uVar12 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_1405e58d8;
...
LAB_1405e5ab7:
          ...
          uVar6 = uVar17 & 0xf;
          if (uVar6 != 0) {
            if ((uVar17 & 1) != 0) goto LAB_1405e5ab7;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_1405e5ab7;
          uVar16 = 0;
  ...
  if ((uVar12 != 6) || ((longlong)uVar11 < 1)) goto LAB_1405e58d8;
  if ((longlong)uVar11 < 8) {
LAB_1405e5ab0:
    uVar6 = 0;
  }
    ...
    if (uVar17 != 0) {
      if ((lVar14 - 2U & 1) != 0) goto LAB_1405e5ab0;
      uVar17 = 0x10 - uVar17 >> 1;
    }
    if ((longlong)uVar11 < (longlong)(uVar17 + 8)) goto LAB_1405e5ab0;
    uVar16 = 0;
...
LAB_1405e58d8:
                    /* WARNING: Could not recover jumptable at 0x0001405e5915. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_14308b2c0 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,uVar11);
  return;
}
