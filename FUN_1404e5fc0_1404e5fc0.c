...
void FUN_1404e5fc0(ulonglong *param_1,longlong param_2,undefined8 *param_3,ulonglong param_4)

{
  ...
  if (param_4 == 1) {
    ...
    auVar16 = vpinsrb_avx((undefined1  [16])0x0,(uint)*(byte *)((longlong)param_1 + param_2 * 2 + 2)
                          ,0);
    auVar6 = vpminub_avx(auVar6,auVar12);
    auVar12 = vpminub_avx(auVar7,auVar18);
    auVar10 = vpminub_avx(auVar10,auVar19);
    auVar7 = vpminub_avx(auVar6,auVar14);
    auVar12 = vpminub_avx(auVar12,auVar15);
    auVar6 = vpminub_avx(auVar10,auVar16);
  }
  else {
    ...
    auVar10 = vpminub_avx(auVar10,auVar18);
    auVar12 = vpminub_avx(auVar12,auVar19);
    auVar7 = vpminub_avx(auVar10,auVar7);
    auVar6 = vpminub_avx(auVar12,auVar6);
    auVar10 = vpsrldq_avx(auVar7,1);
    auVar12 = vpslldq_avx(auVar6,1);
    auVar12 = vpor_avx(auVar10,auVar12);
  }
  auVar7 = vpminub_avx(auVar7,auVar12);
  auVar6 = vpminub_avx(auVar7,auVar6);
  if (7 < (longlong)param_4) {
