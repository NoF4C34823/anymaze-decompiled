...
void FUN_1409a7120(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0xf < (longlong)param_5) {
    uVar26 = param_4 & 0x3f;
    if (uVar26 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1409a73e0;
    ...
    if (uVar26 != 0) {
      auVar34 = vmovdqu32_avx512f(_DAT_14308dfc0);
      auVar35 = vmovdqu32_avx512f(_DAT_14308e000);
