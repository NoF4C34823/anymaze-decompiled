...
void FUN_1408fe1dd(ulonglong param_1,ulonglong param_2,longlong param_3,ulonglong param_4)

{
  ...
  if (param_1 + 1 <= param_2) {
    ...
    if (uVar11 < param_2) {
      ...
      do {
        auVar14._0_4_ =
             (float)((int)*(short *)(lVar1 + -6 + uVar11 * 2) +
                    (int)*(short *)(lVar1 + 6 + uVar11 * 2));
        ...
        auVar16 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM2_Da *
                                                (float)(int)*(short *)(lVar1 + uVar11 * 2))),auVar14
                                  ,auVar10);
