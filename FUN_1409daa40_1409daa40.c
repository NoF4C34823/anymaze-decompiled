...
/* WARNING: Removing unreachable block (ram,0x0001409dc3f4) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong FUN_1409daa40(ulonglong param_1,longlong param_2,ulonglong param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar48 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_1409dc860;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      lStack_170 = 0;
      uStack_108 = 0;
      pcStack_e8 = (code *)(&PTR_LAB_14308e5e0)[(int)uStack_230];
      uVar44 = param_7 & 0xf;
            ...
            if (lStack_e0 < (longlong)(uStack_70 + uVar49)) {
              do {
                ...
                if (lVar43 < 0) {
                  if (uStack_118 != 0xf0) {
                    if (uVar44 == 6) {
                      if (uStack_f0 == 0) goto LAB_1409dc775;
                    }
                    else {
                      if (uVar44 != 1) goto LAB_1409dc6e4;
LAB_1409dc8f5:
                      lVar52 = 0;
                      if (uStack_f0 != 0) {
                        lVar52 = lVar43;
...
LAB_1409dc755:
                  ...
                  if ((lVar43 < (longlong)uVar49) || (uStack_118 == 0xf0)) goto LAB_1409dc755;
                  if (uVar44 != 6) {
                    if (uVar44 == 1) {
                      if (lVar43 < 0) goto LAB_1409dc8f5;
                      if (uStack_d0 == 0) {
                        lVar52 = uVar49 - 1;
                      }
                    }
...
LAB_1409dc909:
                  ...
                  if (uStack_d0 != 0) goto LAB_1409dc755;
LAB_1409dc775:
                  uVar66 = *puVar56;
                  uVar65 = puVar56[1];
                  uVar67 = puVar56[2];
                ...
                if (6 < (longlong)uVar50) {
                  ...
                  if ((lVar43 <= (longlong)puStack_a0 - lVar52) ||
                    ...
                    if ((longlong)uVar50 < 0x10) {
                      ...
                      if ((longlong)uVar50 < 0x3b) {
                        ...
                        if (uVar51 != 0) {
                          ...
                          if (uVar50 == uVar51) goto LAB_1409db8ed;
                        }
                      }
                    ...
                    if (uVar42 + 1 <= uVar50) {
                      ...
                      uVar20 = vpcmpgtq_avx512f(auVar63,_DAT_14308e300);
                      bVar22 = (byte)uVar20;
                      uVar20 = vpcmpgtq_avx512f(auVar63,_DAT_14308e340);
                      bVar21 = (byte)uVar20;
                      uVar57 = CONCAT11(bVar21,bVar22);
...
LAB_1409dbc8d:
                    ...
                    if ((0xb < lStack_110 - (longlong)puStack_a0) ||
                      ...
                      if (uVar42 + 1 <= uStack_140) {
                        ...
                        uVar20 = vpcmpgtq_avx512f(auVar58,_DAT_14308e300);
                        uVar18 = vpcmpgtq_avx512f(auVar58,_DAT_14308e340);
                        auVar58 = vmovdqu32_avx512f(_DAT_14308e400);
                    ...
                    uVar66 = puStack_a0[2];
                    if ((longlong)uStack_140 < 0x10) goto LAB_1409dbc8d;
                    uVar42 = 0;
                    lVar45 = 0;
  ...
  if (uVar44 == 6) {
    ...
    if (0 < (longlong)uVar50) {
      ...
      if (((param_4 < (longlong)uVar49) ||
        ...
        uVar42 = 0;
        auVar63 = vmovdqu32_avx512f(_DAT_14308e300);
        ...
        do {
          if (0 < (longlong)uStack_238) {
            ...
            if (0xf < (longlong)uVar49) {
              auVar59 = vmovdqu32_avx512f(_DAT_14308e400);
              uVar55 = uVar54;
              uVar53 = uVar54;
              do {
                auVar64 = auVar58._0_16_;
            ...
            if (uVar51 + 1 <= uVar49) {
              ...
              auVar62 = vbroadcastss_avx512f(ZEXT416(*param_8));
              auVar61 = vmovdqu32_avx512f(_DAT_14308e400);
        ...
        if (0 < (longlong)uVar54) {
          ...
          if (0xf < (longlong)uVar54) {
            while (uVar42 = uVar54 & 0xfffffffffffffff0, uVar51 = param_1, 0x3a < (longlong)uVar54)
            {
              ...
              uVar50 = uVar50 + 1;
              if (uVar49 <= uVar50) goto LAB_1409db000;
            }
            if ((longlong)(uVar51 + 0x10) <= (longlong)uVar42) {
              do {
          ...
          if (0 < (longlong)uVar54) {
            ...
            if (0xf < (longlong)uVar54) {
              while (param_1 = uVar49, uVar42 = uVar54 & 0xfffffffffffffff0, 0x3a < (longlong)uVar54
                ...
                lVar45 = uVar50 + 2;
                uVar50 = uVar50 + 1;
                if ((ulonglong)(longlong)(iVar48 + -1) <= uVar50) goto LAB_1409dabe5;
              }
