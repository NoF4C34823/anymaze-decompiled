...
void FUN_1403b8380(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar17 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403a4f20(lVar8,lVar6,(longlong)(int)param_5,(longlong)(int)param_6,1);
        lVar21 = lVar21 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1403a4f20(lVar8,lVar6,(longlong)(int)param_5,(longlong)(int)param_6,1);
        thunk_FUN_142d23d30(param_9,uVar11,param_3,(longlong)(int)param_5,(longlong)param_6._4_4_);
        lVar17 = lVar17 + 1;
        lVar21 = lVar21 + 1;
        lVar6 = lVar6 + uVar11 * 4;
              ...
              do {
                if (0 < (longlong)uVar9) {
                  if ((longlong)uVar9 < 8) {
                    ...
                    auVar25 = maxps(auVar36,auVar32);
                    if (auVar25._0_4_ <= auVar25._4_4_) {
                  ...
                  if (uVar22 < uVar9) {
                    do {
                      if ((*(char *)(uVar22 + param_7 + lVar18) != '\0') &&
                         (fVar1 = *(float *)(lVar14 + lVar7 + uVar22 * 4), auVar25._0_4_ <= fVar1))
                      {
                        auVar25._0_4_ = fVar1;
                      }
                      uVar22 = uVar22 + 1;
