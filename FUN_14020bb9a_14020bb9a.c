...
void FUN_14020bb9a(longlong param_1,ulonglong param_2,longlong param_3,ulonglong param_4)

{
  ...
  if (param_2 + 1 <= param_4) {
    ...
    if (uVar11 < param_4) {
      ...
      do {
        auVar14._0_4_ =
             (float)((uint)*(ushort *)(param_1 + -2 + uVar11 * 2) +
                    (uint)*(ushort *)(param_1 + 2 + uVar11 * 2));
        ...
        auVar16 = vfmadd231ss_fma(ZEXT416((uint)(in_XMM2_Da *
                                                (float)*(ushort *)(param_1 + uVar11 * 2))),auVar14,
                                  auVar10);
