...
void FUN_140016580(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...
LAB_140016cd1:
                    ...
                    if ((longlong)uVar22 < (longlong)(uVar14 + 0x10)) goto LAB_140016cd1;
                    uVar24 = 0;
