...
void FUN_140757860(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_140758284:
      uVar45 = 0;
      if (param_5 == 0) goto LAB_140757adf;
      uVar55 = 0;
      uVar52 = param_5;
    }
    else {
      ...
      uVar52 = uVar55 & 0xf;
      if (uVar52 != 0) {
        if ((uVar55 & 3) != 0) goto LAB_140758284;
        uVar52 = 0x10 - uVar52 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar52 + 8)) goto LAB_140758284;
      ...
      if (param_5 < uVar45 + 1) goto LAB_140757adf;
...
LAB_140757d4e:
        ...
        uVar40 = uVar40 + 1;
        pfVar46 = pfVar46 + 1;
        if (iVar47 - 1U <= uVar40) goto LAB_140757de0;
      }
      uVar40 = uVar40 + 1;
      pfVar46 = pfVar46 + 1;
...
LAB_14075825b:
      uVar55 = 0;
      if (param_5 == 0) goto LAB_140757ffd;
      uVar45 = 0;
      uVar51 = param_5;
    }
    else {
      ...
      uVar51 = uVar52 & 0xf;
      if (uVar51 != 0) {
        if ((uVar52 & 3) != 0) goto LAB_14075825b;
        uVar51 = 0x10 - uVar51 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar51 + 8)) goto LAB_14075825b;
      ...
      if (param_5 < uVar55 + 1) goto LAB_140757ffd;
...
LAB_140757ffd:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar52 = uVar51 & 0xf;
      if (uVar52 != 0) {
        if ((uVar51 & 3) != 0) goto LAB_140758278;
        uVar52 = 0x10 - uVar52 >> 2;
      }
...
LAB_140758202:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar52 = uVar51 & 0xf;
    if (uVar52 != 0) {
      if ((uVar51 & 3) != 0) goto LAB_140758271;
      uVar52 = 0x10 - uVar52 >> 2;
    }
    if ((longlong)(uVar52 + 8) <= (longlong)param_5) {
      uVar45 = 0;
