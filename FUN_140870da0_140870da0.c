...
void FUN_140870da0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140871db4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca60)[lVar6])(puVar22,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140871d40;
                while (uVar13 == 0) {
                  for (lVar24 = (lVar15 + -1) * 2 - lVar24; lVar24 < 0; lVar24 = -lVar24) {
LAB_140871d40:
                    if (uVar8 != 0) goto LAB_140871c42;
                  }
          ...
          uVar23 = uVar25;
          if (uVar21 != 0) goto LAB_140871c42;
        }
        else {
LAB_140871c42:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar23;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140871ca2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca60)[lVar6])(param_11 + uVar12 * 2,param_4,lVar15,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_140871cb6:
              ...
              uVar7 = uVar17 & 0xf;
              if (uVar7 != 0) {
                if ((uVar17 & 1) != 0) goto LAB_140871cb6;
                uVar7 = 0x10 - uVar7 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar7 + 8)) goto LAB_140871cb6;
...
LAB_1408711fd:
      if (uVar18 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_14087140d;
...
LAB_140871d18:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140871d18;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_140871d18;
          uVar11 = 0;
...
LAB_140871cbd:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140871cbd;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_140871cbd;
          uVar11 = 0;
          uVar9 = uVar12 - (uVar12 - uVar7 & 7);
          if (uVar7 != 0) {
            do {
...
LAB_14087140d:
      (*(code *)(&PTR_FUN_14308ca60)[lVar6])(uVar17,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140871d15. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308ca60)[lVar6])(puVar22,param_4,lVar15);
    return;
  }
  if ((longlong)uVar12 < lVar15) {
    lVar15 = lVar15 - uVar12;
    (*(code *)(&PTR_FUN_14308ca60)[lVar6])(puVar22,param_4,lVar15,param_9,param_10);
...
LAB_140871cc5:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140871cc5;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_140871cc5;
...
LAB_14087185c:
  if (uVar18 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_140871afa;
...
LAB_140871cd3:
          ...
          uVar17 = uVar19 & 0xf;
          if (uVar17 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_140871cd3;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_140871cd3;
          uVar7 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar12 < 1)) goto LAB_140871afa;
  if ((longlong)uVar12 < 8) {
LAB_140871ccc:
    uVar17 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar15 - 2U & 1) != 0) goto LAB_140871ccc;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar19 + 8)) goto LAB_140871ccc;
    uVar7 = 0;
...
LAB_140871afa:
                    /* WARNING: Could not recover jumptable at 0x000140871b38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308ca60)[lVar6])(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
