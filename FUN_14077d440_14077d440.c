...
void FUN_14077d440(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar44 = uVar43 & 0xf;
      if (uVar44 != 0) {
        if ((uVar43 & 3) != 0) goto LAB_14077d905;
...
LAB_14077d905:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar37 = param_4 & 0xf;
      if (uVar37 != 0) {
        if ((param_4 & 1) != 0) goto LAB_14077dcf8;
...
LAB_14077dc60:
  ...
  if (7 < (longlong)param_5) {
    uVar37 = param_4 & 0xf;
    if (uVar37 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14077dcf1;
      uVar37 = 0x10 - uVar37 >> 1;
    }
    if ((longlong)(uVar37 + 8) <= (longlong)param_5) {
      uVar44 = 0;
