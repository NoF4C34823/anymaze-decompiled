...
void FUN_1404763c0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar8 != 0 && SCARRY8(lVar7,-1) == lVar8 < 0) {
      do {
        thunk_FUN_140d0d960(lVar4,lVar3,lVar5,lVar6,1);
        lVar9 = lVar9 + 1;
        lVar4 = lVar4 + lVar2;
        lVar3 = lVar3 + uVar1;
      } while (lVar9 < lVar8);
    ...
    if (0 < (longlong)param_5._4_4_) {
      do {
        thunk_FUN_140d0d960(lVar4,lVar3,lVar5,lVar6,1);
        thunk_FUN_140d0df20(param_9,uVar1,param_3,lVar5,lVar7);
        lVar8 = lVar8 + 1;
        lVar9 = lVar9 + 1;
        lVar4 = lVar4 + lVar2;
