...
void FUN_1404d1da0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
                  ...
                  do {
                    ...
                    if (uVar13 != 0) {
                      do {
                        ...
                        auVar25 = vminps_avx(auVar26._0_16_,auVar25);
                        auVar26 = ZEXT1664(auVar25);
                        lStack_458 = param_2;
                      } while (lVar17 < (longlong)uVar13);
                    }
        ...
        do {
          ...
          if (0 < lVar4) {
            do {
              ...
              lVar16 = lVar16 + 1;
              auVar25 = vminps_avx(auVar30._0_16_,*(undefined1 (*) [16])(lVar6 + lVar8 * 4));
              auVar30 = ZEXT1664(auVar25);
              auVar24 = vminps_avx(auVar29._0_16_,*(undefined1 (*) [16])(lVar6 + 0x10 + lVar8 * 4));
              auVar29 = ZEXT1664(auVar24);
              auVar27 = vminps_avx(auVar28._0_16_,*(undefined1 (*) [16])(lVar6 + 0x20 + lVar8 * 4));
              auVar28 = ZEXT1664(auVar27);
              auVar23 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + 0x30 + lVar8 * 4));
      ...
      for (; lVar21 < (longlong)uVar15; lVar21 = lVar21 + 8) {
        ...
        if (0 < lVar4) {
          do {
            ...
            lVar16 = lVar16 + 1;
            auVar25 = vminps_avx(auVar28._0_16_,*(undefined1 (*) [16])(lVar6 + *plVar1 * 4));
            auVar28 = ZEXT1664(auVar25);
            auVar24 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + 0x10 + *plVar1 * 4));
      ...
      for (; lVar21 < (longlong)uVar11; lVar21 = lVar21 + 4) {
        ...
        if (0 < lVar4) {
          do {
            plVar1 = alStack_450 + lVar16;
            lVar16 = lVar16 + 1;
            auVar25 = vminps_avx(auVar26._0_16_,*(undefined1 (*) [16])(lVar6 + *plVar1 * 4));
            auVar26 = ZEXT1664(auVar25);
          } while (lVar16 < lVar4);
        }
        lVar6 = lVar6 + 0x10;
      ...
      for (; lVar21 < (longlong)uVar19; lVar21 = lVar21 + 2) {
        ...
        if (0 < lVar4) {
          do {
            ...
            auVar25 = vminps_avx(auVar26._0_16_,auVar24);
            auVar26 = ZEXT1664(auVar25);
      ...
      for (; lVar21 < (longlong)param_5; lVar21 = lVar21 + 1) {
        ...
        if (0 < lVar4) {
          do {
            plVar1 = alStack_450 + lVar16;
            lVar16 = lVar16 + 1;
            auVar25 = vminps_avx(auVar26._0_16_,ZEXT416(*(uint *)(lVar6 + *plVar1 * 4)));
            auVar26 = ZEXT1664(auVar25);
          } while (lVar16 < lVar4);
        }
        lVar6 = lVar6 + 4;
