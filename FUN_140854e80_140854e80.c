...
void FUN_140854e80(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_140855169:
    ...
    uVar12 = param_2 & 0x1f;
    if (uVar12 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140855169;
      uVar12 = 0x20 - uVar12 >> 2;
    }
    if ((longlong)uVar14 < (longlong)(uVar12 + 0x10)) goto LAB_140855169;
    uVar11 = 0;
