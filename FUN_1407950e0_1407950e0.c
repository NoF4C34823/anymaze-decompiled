...
void FUN_1407950e0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    uVar6 = param_2 & 0xf;
    if (uVar6 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14079571e;
      uVar6 = 0x10 - uVar6 >> 2;
    }
    if ((longlong)(uVar6 + 0x10) <= (longlong)param_3) {
      ...
      if ((longlong)param_3 < 4) {
        FUN_1407956b3(param_1,0,param_3,param_2,CONCAT44(unaff_XMM9_Dd,unaff_XMM9_Dc),
