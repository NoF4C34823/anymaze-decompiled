...
void FUN_1406927a0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140693872. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(puVar15,param_4,*param_5);
    return;
  }
  if (uVar21 == 6) {
    uVar17 = (uint)*param_8;
          ...
          if (uVar21 != 6) {
            if (uVar21 == 1) {
              ...
              if (lVar19 < 2) {
                ...
                if (lVar23 < 0) goto LAB_140693800;
                while (uStack_78 == 0) {
                  for (lVar14 = (lVar19 + -1) * 2 - lVar14; lVar14 < 0; lVar14 = -lVar14) {
LAB_140693800:
                    if (uVar17 != 0) goto LAB_140693704;
                  }
...
LAB_140693704:
        ...
        *(ushort *)(param_11 + lVar16 * 2) = uVar13;
        lVar16 = lVar16 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140693768. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(param_11 + uVar12 * 2,param_4,lVar19,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_14069377d:
              ...
              uVar11 = uVar20 & 0xf;
              if (uVar11 != 0) {
                if ((uVar20 & 1) != 0) goto LAB_14069377d;
                uVar11 = 0x10 - uVar11 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar11 + 8)) goto LAB_14069377d;
              uVar8 = 0;
...
LAB_140692c23:
      if (uVar21 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_140692e4e;
...
LAB_1406937dd:
          ...
          uVar11 = param_11 & 0xf;
          if (uVar11 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1406937dd;
            uVar11 = 0x10 - uVar11 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar11 + 8)) goto LAB_1406937dd;
...
LAB_140693784:
          ...
          uVar11 = param_11 & 0xf;
          if (uVar11 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140693784;
            uVar11 = 0x10 - uVar11 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar11 + 8)) goto LAB_140693784;
          uVar8 = 0;
          uVar10 = uVar12 - (uVar12 - uVar11 & 7);
          if (uVar11 != 0) {
            do {
...
LAB_140692e4e:
      in_XMM0._0_8_ =
           (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(uVar20,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001406937da. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(puVar15,param_4,lVar19);
    return;
  }
  if ((longlong)uVar12 < lVar19) {
    lVar19 = lVar19 - uVar12;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(puVar15,param_4,lVar19,param_9,param_10);
...
LAB_14069378b:
          ...
          uVar20 = param_11 & 0xf;
          if (uVar20 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14069378b;
            uVar20 = 0x10 - uVar20 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar20 + 8)) goto LAB_14069378b;
          uVar10 = 0;
...
LAB_1406932c0:
  if (uVar21 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_1406935a6;
...
LAB_14069379a:
          ...
          uVar20 = uVar18 & 0xf;
          if (uVar20 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_14069379a;
            uVar20 = 0x10 - uVar20 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar20 + 8)) goto LAB_14069379a;
          uVar11 = 0;
          lVar19 = param_11 + lVar23 * 2;
  ...
  if ((uVar21 != 6) || ((longlong)uVar12 < 1)) goto LAB_1406935a6;
  if ((longlong)uVar12 < 8) {
LAB_140693792:
    uVar20 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar19 - 2U & 1) != 0) goto LAB_140693792;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar18 + 8)) goto LAB_140693792;
    uVar11 = 0;
...
LAB_1406935a6:
                    /* WARNING: Could not recover jumptable at 0x0001406935e1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_14308b8a0 + lVar7 * 8))(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
