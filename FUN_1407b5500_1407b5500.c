...
/* WARNING: Removing unreachable block (ram,0x0001407b62de) */

void FUN_1407b5500(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c320)[lVar20])(param_1,param_4,*param_5,param_9);
...
LAB_1407b65af:
    ...
    iStack_158 = param_10;
    (*(code *)(&PTR_FUN_14308c320)[lVar20])(param_11 + lVar24 * 6,param_4,lVar14,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lStack_118 = lVar24 * 3;
...
LAB_1407b6686:
              ...
              if (uVar13 != 0) {
                if ((uStack_120 & 1) != 0) goto LAB_1407b6686;
                uVar13 = 0x10 - uVar13 >> 1;
              }
              if ((longlong)uVar9 < (longlong)(uVar13 + 8)) goto LAB_1407b6686;
...
LAB_1407b5e6b:
      uStack_140 = uVar9;
      pcStack_138 = (code *)(&PTR_FUN_14308c320)[lVar20];
      iStack_158 = param_10;
      lStack_110 = param_1;
      uStack_108 = param_7;
