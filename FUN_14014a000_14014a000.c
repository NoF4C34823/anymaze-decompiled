...
void FUN_14014a000(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar26 - 1)) {
      while( true ) {
        FUN_140299b60(lVar27,lVar15,uVar6,uVar21,1);
        uVar26 = param_6[1];
        lVar23 = lVar23 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_140299b60(lVar27,lVar15,uVar6,*param_6,1);
        FUN_1402a53a0(param_9,uVar11,param_3,uVar6,param_6[1]);
        lVar23 = lVar23 + 1;
        lVar24 = lVar24 + 1;
        lVar15 = lVar15 + uVar11;
...
LAB_14014a711:
                    ...
                    if ((longlong)uVar21 < (longlong)(uVar13 + 0x10)) goto LAB_14014a711;
                    uVar17 = 0;
                    uVar19 = uVar21 - (uVar21 - uVar13 & 0xf);
                    if (uVar13 != 0) {
                      do {
                        if ((*(char *)(uVar17 + uVar22) != '\0') &&
                           (bVar30 = *(byte *)(lVar1 + lVar24 + uVar17), bVar31 < bVar30)) {
                          bVar31 = bVar30;
                        }
                        uVar17 = uVar17 + 1;
                      } while (uVar17 < uVar13);
                  ...
                  for (; uVar19 < uVar21; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar22) != '\0') &&
                       (bVar30 = *(byte *)(lVar1 + lVar24 + uVar19), bVar31 < bVar30)) {
                      bVar31 = bVar30;
                    }
                  }
                }
