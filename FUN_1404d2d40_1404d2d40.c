...
void FUN_1404d2d40(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6) {
    ...
    do {
      ...
      if (uVar6 != 0) {
        ...
        FUN_1404d2f00(param_1,param_2,param_3);
      ...
      if (lVar3 != 0) {
        ...
        auVar11 = vminps_avx(*pauVar4,auVar11);
        ...
        if (0 < lVar3) {
          do {
            ...
            auVar9 = vminps_avx(pauVar4[1],auVar12);
            ...
            auVar11 = vminps_avx(auVar9,auVar11);
