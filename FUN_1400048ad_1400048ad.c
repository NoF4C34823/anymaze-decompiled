...
undefined8 FUN_1400048ad(undefined8 param_1,undefined8 param_2,byte *param_3,byte *param_4)

{
  ...
  do {
    ...
    if (0 < (int)uVar8) {
      ...
      if (((longlong)param_3 - (longlong)param_4 < lVar12 * 6) &&
         (-((longlong)param_3 - (longlong)param_4) < lVar12 * 4)) {
        unaff_R14D = uStack00000000000000b0;
        if ((param_4 + lVar12 * 6 + -1 < param_3) || (param_3 + lVar12 * 4 + -1 < param_4)) {
          uVar13 = 0;
          do {
            uVar13 = uVar13 + 1;
        ...
        pbVar9 = param_3 + uVar13 * 4;
        pbVar11 = param_4 + (longlong)(iVar6 + 1) * 6 + -6;
        iVar7 = (int)uVar13 * 2;
      }
    }
    if (iVar7 < (int)unaff_R14D) {
      bVar3 = *pbVar11;
      bVar4 = pbVar11[1];
      bVar5 = pbVar11[2];
      *pbVar9 = (byte)((uint)bVar3 * 0x41cb + (uint)bVar4 * 0x8106 + 0x108000 + (uint)bVar5 * 0x1917
                      >> 0x10);
  ...
  } while (uVar10 < uStack00000000000000b4);
  return 0;
}
