...
void FUN_14065235f(undefined8 param_1,undefined8 param_2,undefined8 param_3,float param_4)

{
  ...
  if (3 < (longlong)uVar17) {
    ...
    do {
      ...
      *pfVar2 = (*pfVar5 + *pfVar4) * (float)param_2 + *pfVar1 * (float)in_XMM0_Qa;
    ...
    if (uVar16 < uVar17) {
      ...
      do {
        *(float *)(in_RDX + in_R10 * 4 + uVar16 * 4) =
             ...
             param_4 + *(float *)(lVar3 + uVar16 * 4) * in_XMM2_Da;
        uVar16 = uVar16 + 1;
      } while (uVar16 < uVar17);
    }
    return;
  }
  FUN_1406523d8(param_1,in_RDX,param_3,0);
  return;
}
