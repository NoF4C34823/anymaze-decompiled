...
void FUN_14017b0c0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14017b659:
      uVar28 = 0;
      if (param_5 == 0) goto LAB_14017b368;
      uVar24 = 0;
      uVar22 = param_5;
    }
    else {
      ...
      uVar22 = uVar21 & 0xf;
      if (uVar22 != 0) {
        if ((uVar21 & 3) != 0) goto LAB_14017b659;
        uVar22 = 0x10 - uVar22 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar22 + 8)) goto LAB_14017b659;
      ...
      if (param_5 < uVar28 + 1) goto LAB_14017b368;
...
LAB_14017b368:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar22 & 0xf;
      if (uVar21 != 0) {
        if ((uVar22 & 3) != 0) goto LAB_14017b676;
        uVar21 = 0x10 - uVar21 >> 2;
      }
      if ((longlong)(uVar21 + 4) <= (longlong)param_5) {
        uVar24 = 0;
        uVar28 = param_5 - (param_5 - uVar21 & 3);
        uVar16 = _UNK_143087d8c;
        uVar17 = _UNK_143087d88;
        uVar18 = _UNK_143087d84;
        uVar19 = _DAT_143087d80;
        if (uVar21 != 0) {
          do {
...
LAB_14017b60f:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar21 = uVar22 & 0xf;
    if (uVar21 != 0) {
      if ((uVar22 & 3) != 0) goto LAB_14017b66f;
      uVar21 = 0x10 - uVar21 >> 2;
    }
