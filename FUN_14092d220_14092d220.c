...
void FUN_14092d220(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_14092d7f9:
      ...
      if ((longlong)param_5 < 0x1d) {
        ...
        uVar18 = uVar17 & 0x1f;
        if (uVar18 != 0) {
          if ((uVar17 & 3) != 0) goto LAB_14092d7f9;
          uVar18 = 0x20 - uVar18 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar18 + 0x10)) goto LAB_14092d7f9;
        lVar7 = param_2 * lVar11 + param_1;
        lVar16 = param_2 * lVar14 + param_1;
        lVar8 = param_2 * lVar9 + param_1;
...
LAB_14092d834:
      ...
      if ((longlong)param_5 < 0x7b9) {
        ...
        uVar10 = param_4 & 0x1f;
        if (uVar10 != 0) {
          if ((param_4 & 1) != 0) goto LAB_14092d834;
          uVar10 = 0x20 - uVar10 >> 1;
        }
        if ((longlong)param_5 < (longlong)(uVar10 + 0x10)) goto LAB_14092d834;
        lVar11 = param_2 * 3 + param_1;
        uVar18 = 0;
  ...
  if (0xf < (longlong)param_5) {
    uVar17 = param_4 & 0x1f;
    if (uVar17 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14092d858;
