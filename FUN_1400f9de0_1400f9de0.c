...
void FUN_1400f9de0(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (**(code **)(&UNK_143086de0 + lVar8 * 8))(psVar22,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar23 == 6) {
    sVar30 = *param_8;
          ...
          if (uVar23 != 6) {
            if (uVar23 == 1) {
              ...
              if (lVar17 < 2) {
                ...
                if (lVar28 < 0) goto LAB_1400faf60;
                while (uVar11 == 0) {
                  for (lVar29 = (lVar17 + -1) * 2 - lVar29; lVar29 < 0; lVar29 = -lVar29) {
LAB_1400faf60:
                    if (uVar14 != 0) goto LAB_1400fae02;
                  }
...
LAB_1400fae02:
    ...
    (**(code **)(&UNK_143086de0 + lVar8 * 8))(param_11 + uVar15 * 2,param_4,lVar17,param_9,param_10)
    ;
    return;
  }
  if ((param_7 & 0x40) == 0) {
...
LAB_1400fae71:
              ...
              if ((longlong)uVar10 < 0x2b9) {
                ...
                uVar12 = uVar9 & 0x1f;
                if (uVar12 != 0) {
                  if ((uVar9 & 1) != 0) goto LAB_1400fae71;
                  uVar12 = 0x20 - uVar12 >> 1;
                }
                if ((longlong)uVar10 < (longlong)(uVar12 + 0x10)) goto LAB_1400fae71;
...
LAB_1400faf24:
            ...
            if ((longlong)uVar15 < 0x1b9) {
              ...
              if (uVar19 != 0) {
                if ((param_11 & 1) != 0) goto LAB_1400faf24;
                uVar19 = 0x20 - uVar19 >> 1;
              }
              if ((longlong)uVar15 < (longlong)(uVar19 + 0x10)) goto LAB_1400faf24;
              uVar26 = 0;
...
LAB_1400fae8a:
          ...
          if ((longlong)uVar15 < 0x1b9) {
            ...
            uVar19 = param_11 & 0x1f;
            if (uVar19 != 0) {
              if ((param_11 & 1) != 0) goto LAB_1400fae8a;
              uVar19 = 0x20 - uVar19 >> 1;
            }
            if ((longlong)uVar15 < (longlong)(uVar19 + 0x10)) goto LAB_1400fae8a;
            uVar26 = 0;
            uVar12 = uVar15 - (uVar15 - uVar19 & 0xf);
            if (uVar19 != 0) {
              do {
      ...
      (**(code **)(&UNK_143086de0 + lVar8 * 8))(uVar9,param_4,uVar15,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (**(code **)(&UNK_143086de0 + lVar8 * 8))(psVar22,param_4,lVar17,param_9,param_10);
    return;
  }
...
LAB_1400faea8:
          ...
          if ((longlong)uVar10 < 0x2b9) {
            ...
            uVar9 = param_11 & 0x1f;
            if (uVar9 != 0) {
              if ((param_11 & 1) != 0) goto LAB_1400faea8;
              uVar9 = 0x20 - uVar9 >> 1;
            }
            if ((longlong)uVar10 < (longlong)(uVar9 + 0x10)) goto LAB_1400faea8;
...
LAB_1400fa9c3:
  if (uVar23 == 1) {
    if ((longlong)uVar15 < 1) goto LAB_1400facbf;
...
LAB_1400faed4:
          ...
          if ((longlong)uVar15 < 0x1b9) {
            ...
            uVar9 = uVar10 & 0x1f;
            if (uVar9 != 0) {
              if ((uVar10 & 1) != 0) goto LAB_1400faed4;
              uVar9 = 0x20 - uVar9 >> 1;
            }
            if ((longlong)uVar15 < (longlong)(uVar9 + 0x10)) goto LAB_1400faed4;
            uVar12 = 0;
  ...
  if ((uVar23 != 6) || ((longlong)uVar15 < 1)) goto LAB_1400facbf;
  if ((longlong)uVar15 < 0x10) {
LAB_1400faebf:
    uVar9 = 0;
  }
    ...
    if ((longlong)uVar15 < 0x1b9) {
      ...
      if (uVar10 != 0) {
        if ((lVar17 - 2U & 1) != 0) goto LAB_1400faebf;
        uVar10 = 0x20 - uVar10 >> 1;
      }
      if ((longlong)uVar15 < (longlong)(uVar10 + 0x10)) goto LAB_1400faebf;
      uVar12 = 0;
...
LAB_1400facbf:
  (**(code **)(&UNK_143086de0 + lVar8 * 8))(param_11 + uVar15 * 2,param_4,uVar15,param_9,param_10);
  return;
}
