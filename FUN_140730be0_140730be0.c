...
void FUN_140730be0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar49 = param_4 & 0xf;
      if (uVar49 != 0) {
        if ((param_4 & 3) != 0) goto LAB_140731546;
...
LAB_140731478:
  ...
  if (3 < (longlong)param_5) {
    uVar49 = param_4 & 0xf;
    if (uVar49 != 0) {
      if ((param_4 & 3) != 0) goto LAB_14073153f;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 4) <= (longlong)param_5) {
      lVar50 = param_2 * lVar47 + param_1;
