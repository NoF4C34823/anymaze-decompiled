...
void FUN_1406bf620(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1406bfe33:
      ...
      uVar139 = param_2 & 0xf;
      if (uVar139 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1406bfe33;
        uVar139 = 0x10 - uVar139 >> 2;
      }
      if ((longlong)uVar134 < (longlong)(uVar139 + 8)) goto LAB_1406bfe33;
...
LAB_1406bfe24:
          ...
          uVar139 = param_2 & 0xf;
          if (uVar139 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1406bfe24;
            uVar139 = 0x10 - uVar139 >> 2;
          }
          if ((longlong)uVar134 < (longlong)(uVar139 + 8)) goto LAB_1406bfe24;
          uVar133 = uVar134 - (uVar134 - uVar139 & 7);
...
LAB_1406bfe18:
    ...
    uVar139 = param_2 & 0xf;
    if (uVar139 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406bfe18;
      uVar139 = 0x10 - uVar139 >> 2;
    }
    if ((longlong)uVar134 < (longlong)(uVar139 + 8)) goto LAB_1406bfe18;
    uVar140 = 0;
    uVar133 = uVar134 - (uVar134 - uVar139 & 7);
    if (uVar139 != 0) {
      do {
