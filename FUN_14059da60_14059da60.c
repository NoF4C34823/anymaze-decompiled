...
void FUN_14059da60(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
                    ...
                    do {
                      ...
                      if (uVar40 != 0) {
                        ...
                        do {
                          ...
                          auVar52 = vminps_avx512f(auVar52,*(undefined1 (*) [64])
                                                            (lVar50 + lVar44 * 4));
                          auVar53 = vminps_avx512f(auVar53,*(undefined1 (*) [64])
                                                            (lVar50 + 0x40 + lVar44 * 4));
                          auVar54 = vminps_avx512f(auVar54,*(undefined1 (*) [64])
                                                            (lVar50 + 0x80 + lVar44 * 4));
                          auVar55 = vminps_avx512f(auVar55,*(undefined1 (*) [64])
                  ...
                  do {
                    ...
                    if (uVar40 != 0) {
                      do {
                        ...
                        auVar55 = vminps_avx512f(auVar55,auVar54);
                      } while (lVar41 < (longlong)uVar40);
                    }
                    lVar46 = lVar46 + 1;
                    lVar37 = lVar37 + lVar39;
        ...
        do {
          ...
          if (0 < lVar35) {
            do {
              ...
              lVar43 = lVar43 + 1;
              auVar52 = vminps_avx512f(auVar52,*(undefined1 (*) [64])(lVar47 + lVar37 * 4));
              auVar53 = vminps_avx512f(auVar53,*(undefined1 (*) [64])(lVar47 + 0x40 + lVar37 * 4));
              auVar54 = vminps_avx512f(auVar54,*(undefined1 (*) [64])(lVar47 + 0x80 + lVar37 * 4));
              auVar55 = vminps_avx512f(auVar55,*(undefined1 (*) [64])(lVar47 + 0xc0 + lVar37 * 4));
            } while (lVar43 < lVar35);
          }
          lVar49 = lVar49 + 0x40;
          lVar47 = lVar47 + 0x100;
      ...
      for (; lVar49 < (longlong)uStack_480; lVar49 = lVar49 + 0x20) {
        ...
        if (0 < lVar35) {
          do {
            ...
            lVar43 = lVar43 + 1;
            auVar54 = vminps_avx512f(auVar54,*(undefined1 (*) [64])(lVar47 + *plVar2 * 4));
            auVar55 = vminps_avx512f(auVar55,*(undefined1 (*) [64])(lVar47 + 0x40 + *plVar2 * 4));
          } while (lVar43 < lVar35);
        }
        lVar47 = lVar47 + 0x80;
        *pauVar45 = auVar54;
      ...
      for (; lVar49 < (longlong)uVar42; lVar49 = lVar49 + 0x10) {
        ...
        if (0 < lVar35) {
          do {
            plVar2 = alStack_448 + lVar43;
            lVar43 = lVar43 + 1;
            auVar55 = vminps_avx512f(auVar55,*(undefined1 (*) [64])(lVar47 + *plVar2 * 4));
          } while (lVar43 < lVar35);
        }
        lVar47 = lVar47 + 0x40;
        *pauVar45 = auVar55;
      ...
      if (lVar49 < (longlong)param_5) {
        ...
        if (0 < lVar35) {
          do {
            ...
            auVar55 = vminps_avx512f(auVar55,auVar53);
          } while (lVar49 < lVar35);
        }
        iVar18 = *(int *)(*pauVar45 + 4);
        iVar19 = *(int *)(*pauVar45 + 8);
