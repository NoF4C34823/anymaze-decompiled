...
void FUN_140064a00(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1400651f3:
      ...
      uVar130 = param_2 & 0xf;
      if (uVar130 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400651f3;
        uVar130 = 0x10 - uVar130 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_1400651f3;
      uVar137 = 0;
...
LAB_1400651e3:
          ...
          uVar130 = param_2 & 0xf;
          if (uVar130 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1400651e3;
            uVar130 = 0x10 - uVar130 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_1400651e3;
...
LAB_1400651d7:
    ...
    uVar130 = param_2 & 0xf;
    if (uVar130 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400651d7;
      uVar130 = 0x10 - uVar130 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_1400651d7;
    uVar137 = 0;
    uVar136 = param_3 - (param_3 - uVar130 & 7);
    if (uVar130 != 0) {
      do {
