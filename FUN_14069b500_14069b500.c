...
void FUN_14069b500(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14069bcf3:
      ...
      uVar130 = param_2 & 0xf;
      if (uVar130 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14069bcf3;
        uVar130 = 0x10 - uVar130 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_14069bcf3;
      uVar137 = 0;
...
LAB_14069bce3:
          ...
          uVar130 = param_2 & 0xf;
          if (uVar130 != 0) {
            if ((param_2 & 3) != 0) goto LAB_14069bce3;
            uVar130 = 0x10 - uVar130 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_14069bce3;
...
LAB_14069bcd7:
    ...
    uVar130 = param_2 & 0xf;
    if (uVar130 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14069bcd7;
      uVar130 = 0x10 - uVar130 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar130 + 8)) goto LAB_14069bcd7;
    uVar137 = 0;
    uVar136 = param_3 - (param_3 - uVar130 & 7);
    if (uVar130 != 0) {
      do {
