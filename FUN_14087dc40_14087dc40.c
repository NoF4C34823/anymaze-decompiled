...
void FUN_14087dc40(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    uVar18 = param_2 & 0x1f;
    if (uVar18 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14087df94;
    ...
    if ((longlong)(uVar18 + 8) <= (longlong)param_3) {
      ...
      if (uVar18 != 0) {
        ...
        do {
          auVar29._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -6 + uVar16 * 2) +
                      (uint)*(ushort *)(param_1 + 6 + uVar16 * 2));
          auVar29._4_12_ = auVar28._4_12_;
          auVar28._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -4 + uVar16 * 2) +
                      (uint)*(ushort *)(param_1 + 4 + uVar16 * 2));
          auVar28._4_8_ = SUB128(ZEXT812(0),4);
          auVar28._12_4_ = 0;
          auVar29 = vunpcklps_avx(auVar29,auVar28);
          auVar24._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -2 + uVar16 * 2) +
                      (uint)*(ushort *)(param_1 + 2 + uVar16 * 2));
          auVar24._4_8_ = SUB128(ZEXT812(0),4);
          auVar24._12_4_ = 0;
          auVar28 = ZEXT416((uint)(float)*(ushort *)(param_1 + uVar16 * 2));
...
LAB_14087deeb:
  if (uVar17 < param_3) {
    ...
    do {
      ...
      auVar21._12_4_ = 0;
      auVar22._0_4_ =
           (float)((uint)*(ushort *)(param_1 + -2 + uVar17 * 2) +
                  (uint)*(ushort *)(param_1 + 2 + uVar17 * 2));
      auVar22._4_8_ = SUB128(ZEXT812(0),4);
      auVar22._12_4_ = 0;
      auVar23._0_4_ = (float)*(ushort *)(param_1 + uVar17 * 2);
