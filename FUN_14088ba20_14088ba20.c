...
void FUN_14088ba20(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014088cc15. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308cbe0)[lVar30])(param_1,param_4,*param_5,param_9);
    return;
  }
...
LAB_14088ca70:
        ...
        *(byte *)(lVar28 + 2 + param_11) = bVar20;
        lVar28 = lVar28 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014088cb0f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308cbe0)[lVar30])(param_11 + lVar29 * 3,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar17 = lVar29 * 3;
...
LAB_14088cb12:
            ...
            if ((longlong)uVar13 < (longlong)(uVar10 + 0x10)) goto LAB_14088cb12;
            uVar21 = 0;
...
LAB_14088bc2f:
    ...
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308cbe0)[lVar30];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014088cb5a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (0 < lVar30) {
      ...
      if ((longlong)uVar13 < 7) {
        ...
        if ((longlong)uVar13 < 0x10) {
          ...
          auVar6 = vpshufb_avx(auVar6,_DAT_14308cd60);
          auVar4 = vpshufb_avx(auVar5,_DAT_14308cd70);
          auVar6 = vpor_avx(auVar6,auVar4);
          auVar4 = vpshufb_avx(auVar31,_DAT_14308cd80);
          auVar32 = vpshufb_avx(auVar5,_DAT_14308cd90);
          auVar5 = vpshufb_avx(auVar5,_DAT_14308cdc0);
          auVar31 = vpunpckhbw_avx(auVar31,auVar7);
          auVar4 = vpor_avx(auVar4,auVar32);
          auVar32 = vpshufb_avx(auVar7,_DAT_14308cda0);
          auVar31 = vpshufb_avx(auVar31,_DAT_14308cdb0);
          auVar4 = vpor_avx(auVar4,auVar32);
...
LAB_14088c934:
                    /* WARNING: Could not recover jumptable at 0x00014088c962. Too many branches */
                    /* WARNING: Treating indirect jump as call */
