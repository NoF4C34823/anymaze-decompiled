...
void FUN_14005bd60(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014005cdd9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086800 + lVar6 * 8))(puVar18,param_4,*param_5);
    return;
  }
  if (uVar13 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar13 != 6) {
            if (uVar13 == 1) {
              ...
              if (lVar14 < 2) {
                ...
                if (lVar25 < 0) goto LAB_14005cd60;
                while (uVar20 == 0) {
                  for (lVar9 = (lVar14 + -1) * 2 - lVar9; lVar9 < 0; lVar9 = -lVar9) {
LAB_14005cd60:
                    if (uVar8 != 0) goto LAB_14005cc65;
                  }
          ...
          uVar24 = uVar23;
          if (uVar21 != 0) goto LAB_14005cc65;
        }
        else {
LAB_14005cc65:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar24;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014005ccc6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086800 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,lVar14,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_14005ccda:
              ...
              uVar16 = uVar7 & 0xf;
              if (uVar16 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_14005ccda;
                uVar16 = 0x10 - uVar16 >> 1;
              }
              if ((longlong)uVar17 < (longlong)(uVar16 + 8)) goto LAB_14005ccda;
...
LAB_14005c1fb:
      if (uVar13 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_14005c40e;
...
LAB_14005cd3e:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14005cd3e;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar16 + 8)) goto LAB_14005cd3e;
          uVar11 = 0;
...
LAB_14005cce1:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14005cce1;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar16 + 8)) goto LAB_14005cce1;
          uVar11 = 0;
          uVar22 = uVar12 - (uVar12 - uVar16 & 7);
          if (uVar16 != 0) {
            do {
...
LAB_14005c40e:
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143086800 + lVar6 * 8))(uVar7,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014005cd3b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086800 + lVar6 * 8))(puVar18,param_4,lVar14);
    return;
  }
  if ((longlong)uVar12 < lVar14) {
    lVar14 = lVar14 - uVar12;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143086800 + lVar6 * 8))(puVar18,param_4,lVar14,param_9,param_10);
...
LAB_14005cce9:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14005cce9;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar17 < (longlong)(uVar7 + 8)) goto LAB_14005cce9;
...
LAB_14005c87c:
  if (uVar13 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_14005cb18;
...
LAB_14005ccf7:
          ...
          uVar7 = uVar17 & 0xf;
          if (uVar7 != 0) {
            if ((uVar17 & 1) != 0) goto LAB_14005ccf7;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_14005ccf7;
          uVar16 = 0;
  ...
  if ((uVar13 != 6) || ((longlong)uVar12 < 1)) goto LAB_14005cb18;
  if ((longlong)uVar12 < 8) {
LAB_14005ccf0:
    uVar7 = 0;
  }
    ...
    if (uVar17 != 0) {
      if ((lVar14 - 2U & 1) != 0) goto LAB_14005ccf0;
      uVar17 = 0x10 - uVar17 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_14005ccf0;
    uVar16 = 0;
...
LAB_14005cb18:
                    /* WARNING: Could not recover jumptable at 0x00014005cb55. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143086800 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
