...
void FUN_14069ced2(longlong param_1,undefined4 param_2,ulonglong param_3,float param_4)

{
  ...
  uVar10 = 0;
  do {
    uVar3 = *(ulonglong *)(lVar1 + -2 + uVar10 * 2);
    uVar4 = *(ulonglong *)(lVar1 + 2 + uVar10 * 2);
    auVar15._8_4_ = 0;
    auVar15._0_8_ = uVar3;
