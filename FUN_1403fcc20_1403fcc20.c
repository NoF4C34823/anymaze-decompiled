...
void FUN_1403fcc20(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar27 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403ef6e0(lVar31,lVar24,(longlong)(int)param_5,(longlong)(int)param_6,1);
        lVar28 = lVar28 + 1;
          ...
          do {
            ...
            if (0 < param_6._4_4_) {
              ...
              if ((ulonglong)(longlong)param_6._4_4_ >> 3 != 0) {
                ...
                do {
                  if (*(short *)(lVar40 + lVar8 + param_9) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar8 + param_9);
                  }
                  if (*(short *)(lVar40 + lVar4) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar4);
                  }
                  if (*(short *)(lVar40 + lVar3) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar3);
                  }
                  if (*(short *)(lVar40 + lVar2) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar2);
                  }
                  if (*(short *)(lVar40 + lVar25) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar25);
                  }
                  if (*(short *)(lVar40 + lVar1) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar1);
                  }
                  if (*(short *)(lVar40 + lVar41) < sVar38) {
                    sVar38 = *(short *)(lVar40 + lVar41);
                  }
                  uVar36 = uVar36 + 1;
                  if (*(short *)(lVar40 + lVar37) < sVar38) {
                ...
                if (0 < (longlong)uVar36) {
                  if ((longlong)uVar36 < 8) {
                    ...
                    do {
                      ...
                      sVar6 = auVar46._0_2_;
                      auVar50._0_2_ =
                           (ushort)(sVar6 < sVar38) * sVar6 | (ushort)(sVar6 >= sVar38) * sVar38;
                      sVar38 = auVar46._2_2_;
                      auVar50._2_2_ =
                           (ushort)(sVar38 < sVar45) * sVar38 | (ushort)(sVar38 >= sVar45) * sVar45;
                      sVar38 = auVar46._4_2_;
                      auVar50._4_2_ =
                           (ushort)(sVar38 < sVar23) * sVar38 | (ushort)(sVar38 >= sVar23) * sVar23;
                      sVar38 = auVar46._6_2_;
                      auVar50._6_2_ =
                           (ushort)(sVar38 < sVar22) * sVar38 | (ushort)(sVar38 >= sVar22) * sVar22;
                      sVar38 = auVar46._8_2_;
                      auVar50._8_2_ =
                           (ushort)(sVar38 < sVar30) * sVar38 | (ushort)(sVar38 >= sVar30) * sVar30;
                      sVar38 = auVar46._10_2_;
                      auVar50._10_2_ =
                           (ushort)(sVar38 < sVar32) * sVar38 | (ushort)(sVar38 >= sVar32) * sVar32;
                      sVar38 = auVar46._12_2_;
                      auVar50._12_2_ =
                           (ushort)(sVar38 < sVar34) * sVar38 | (ushort)(sVar38 >= sVar34) * sVar34;
                      sVar38 = auVar46._14_2_;
                      auVar50._14_2_ =
                           (ushort)(sVar38 < sVar39) * sVar38 | (ushort)(sVar38 >= sVar39) * sVar39;
                      auVar46 = auVar50 & auVar42 | ~auVar42 & auVar46;
                    } while (uVar29 < uVar36);
                    sVar38 = auVar46._8_2_;
                    sVar45 = auVar46._0_2_;
                    uVar44 = (ushort)(sVar38 < sVar45) * sVar38 |
                             (ushort)(sVar38 >= sVar45) * sVar45;
                    sVar38 = auVar46._10_2_;
                    sVar45 = auVar46._2_2_;
                    uVar47 = (ushort)(sVar38 < sVar45) * sVar38 |
                             (ushort)(sVar38 >= sVar45) * sVar45;
                    sVar38 = auVar46._12_2_;
                    sVar45 = auVar46._4_2_;
                    uVar48 = (ushort)(sVar38 < sVar45) * sVar38 |
                             (ushort)(sVar38 >= sVar45) * sVar45;
                    sVar38 = auVar46._14_2_;
                    sVar45 = auVar46._6_2_;
                    uVar49 = (ushort)(sVar38 < sVar45) * sVar38 |
                             (ushort)(sVar38 >= sVar45) * sVar45;
                    uVar44 = ((short)uVar48 < (short)uVar44) * uVar48 |
                             ((short)uVar48 >= (short)uVar44) * uVar44;
                    uVar47 = ((short)uVar49 < (short)uVar47) * uVar49 |
                             ((short)uVar49 >= (short)uVar47) * uVar47;
                    uVar44 = ((short)uVar47 < (short)uVar44) * uVar47 |
                  ...
                  if (uVar36 < (ulonglong)(longlong)(int)param_6) {
                    ...
                    do {
                      if ((*(char *)(uVar36 + param_7 + lVar40) != '\0') &&
                         (*(short *)(lVar41 + uVar36 * 2) < (short)uVar44)) {
