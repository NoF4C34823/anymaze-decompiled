...
void FUN_140983660(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x27) {
        ...
        if (uVar33 != 0) {
          ...
          if (param_5 == uVar33) goto LAB_1409838ad;
        }
      }
    ...
    if (uVar27 + 1 <= param_5) {
      ...
      lVar24 = param_2 * lVar30 + param_1;
      uVar16 = vpcmpgtq_avx512f(auVar37,_DAT_14308dc80);
      bVar19 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar37,_DAT_14308dcc0);
      bVar18 = (byte)uVar16;
      uVar35 = CONCAT11(bVar18,bVar19);
...
LAB_140983a52:
          ...
          if (uVar21 == 0) goto LAB_140983a52;
          uVar34 = 0;
          ...
          if (param_5 != uVar21) goto LAB_140983a52;
        }
        uVar26 = uVar26 + 1;
        puVar22 = puVar22 + 1;
        if (param_7 - 1U <= uVar26) goto LAB_140983b27;
      }
      uVar26 = uVar26 + 1;
      puVar22 = puVar22 + 1;
    ...
    if ((longlong)param_5 < 0x10) {
      ...
      if ((longlong)param_5 < 0x7b) {
        ...
        if (uVar27 != 0) {
          ...
          if (param_5 == uVar27) goto LAB_140983cff;
        }
      }
...
LAB_14098414d:
    ...
    uVar31 = param_4 & 0x3f;
    if (uVar31 != 0) {
      if ((param_4 & 1) != 0) goto LAB_14098414d;
