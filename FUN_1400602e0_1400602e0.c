...
/* WARNING: Removing unreachable block (ram,0x0001400616b5) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong FUN_1400602e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  lVar13 = 0;
  uVar9 = _DAT_1436b4680 ^ (ulonglong)auStack_1c8;
  lStack_78 = param_2;
  uStack_50 = uVar9;
  if (iVar16 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_140061a1a;
  }
  else {
    ...
    do {
      ...
      uStack_180 = param_10;
      lStack_178 = param_11;
      auVar28._0_8_ = FUN_140643900(lStack_90,lStack_78,lVar13,lVar11);
      uVar12 = uStack_68;
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      lStack_138 = 0;
      uVar8 = param_7 & 0xf;
      pcStack_d0 = *(code **)(&UNK_143086860 + (longlong)param_6 * 8);
            ...
            if (lStack_c0 < (longlong)(uVar12 + uVar9)) {
              do {
                ...
                if (lVar10 < 0) {
                  if (param_7 != 0xf0) {
                    if (uVar8 == 6) {
                      if (uStack_d8 == 0) goto LAB_140061992;
                    }
                    else {
                      if (uVar8 != 1) goto LAB_140061904;
LAB_140061a7a:
                      lVar22 = 0;
                      if (uStack_d8 != 0) {
                        lVar22 = lVar10;
...
LAB_140061975:
                  sVar17 = *(short *)(lVar18 + lVar22 * 6);
                  sVar24 = *(short *)(lVar18 + 2 + lVar22 * 6);
                  sVar20 = *(short *)(lVar18 + 4 + lVar22 * 6);
                }
                else {
                  if ((lVar10 < (longlong)uVar9) || (param_7 == 0xf0)) goto LAB_140061975;
                  if (uVar8 != 6) {
                    if (uVar8 == 1) {
                      if (lVar10 < 0) goto LAB_140061a7a;
                      if (uStack_b8 == 0) {
                        lVar22 = uVar9 - 1;
                      }
                    }
...
LAB_140061a8d:
                  ...
                  if (uStack_b8 != 0) goto LAB_140061975;
LAB_140061992:
                  sVar17 = *psVar26;
                  sVar24 = psVar26[1];
                  sVar20 = psVar26[2];
                ...
                uVar21 = uVar21 + 1;
                lVar10 = lVar10 + 1;
                *(short *)(lVar13 + param_11) = sVar17;
                *(short *)(lVar13 + 2 + param_11) = sVar24;
                *(short *)(lVar13 + 4 + param_11) = sVar20;
                lVar13 = lVar13 + 6;
...
LAB_140060d73:
              if (uVar8 == 1) {
                ...
                if (6 < (longlong)uStack_158 / 3) {
                  ...
                  lVar10 = (longlong)psVar26 + (2 - param_11);
                  if (((lVar13 <= lVar10) || (3 < -lVar10)) &&
                     ((1 < param_11 - (longlong)psVar26 ||
                      (lVar13 <= -(param_11 - (longlong)psVar26))))) {
                    lVar13 = 1;
                    sVar17 = *psVar26;
                    lVar10 = 0;
                    sVar24 = psVar26[1];
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar14 = uVar21;
                        uVar21 = uVar14 + 1;
                        *(short *)(lVar10 + param_11) = sVar17;
                        *(short *)(lVar10 + 2 + param_11) = sVar24;
                        *(short *)(lVar10 + 4 + param_11) = sVar20;
                        *(short *)(lVar10 + 6 + param_11) = sVar17;
                        *(short *)(lVar10 + 8 + param_11) = sVar24;
                        *(short *)(lVar10 + 10 + param_11) = sVar20;
                        lVar10 = lVar10 + 0xc;
                      } while (uVar21 < uStack_140);
                      lVar13 = uVar14 + 2 + uVar21;
                    }
                    if (lVar13 - 1U < uStack_160) {
                      lVar13 = lVar13 * 3 + -3;
                      *(short *)(param_11 + lVar13 * 2) = sVar17;
                      *(short *)(param_11 + 2 + lVar13 * 2) = sVar24;
                      *(short *)(param_11 + 4 + lVar13 * 2) = sVar20;
                    }
                    goto LAB_140061280;
                  }
                }
                ...
                if (uStack_140 != 0) {
                  do {
                    uVar14 = uVar21;
                    *(short *)(param_11 + uVar14 * 0xc) = *psVar26;
                    uVar21 = uVar14 + 1;
                    *(short *)(param_11 + 2 + uVar14 * 0xc) = psVar26[1];
                    *(short *)(param_11 + 4 + uVar14 * 0xc) = psVar26[2];
                    *(short *)(param_11 + 6 + uVar14 * 0xc) = *psVar26;
                    *(short *)(param_11 + 8 + uVar14 * 0xc) = psVar26[1];
                    *(short *)(param_11 + 10 + uVar14 * 0xc) = psVar26[2];
                  } while (uVar21 < uStack_140);
                  lVar13 = uVar14 + 2 + uVar21;
                }
                if (lVar13 - 1U < uStack_160) {
                  lVar13 = lVar13 * 3 + -3;
                  *(short *)(param_11 + lVar13 * 2) = *psVar26;
                  *(short *)(param_11 + 2 + lVar13 * 2) = psVar26[1];
                  *(short *)(param_11 + 4 + lVar13 * 2) = psVar26[2];
                }
              }
LAB_140061280:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar25);
            ...
            if (uStack_b8 == 0) {
              ...
              if (uVar8 == 1) {
                ...
                if (6 < (longlong)uStack_158 / 3) {
                  lVar13 = ((longlong)uStack_158 / 3) * 6;
                  lVar18 = (longlong)psVar26 + (2 - (lStack_150 + -6));
                  if (((lVar13 <= lVar18) || (3 < -lVar18)) &&
                     ((lVar18 = (lStack_150 + -6) - (longlong)psVar26, 1 < lVar18 ||
                      (lVar13 <= -lVar18)))) {
                    lVar13 = 1;
                    sVar17 = *psVar26;
                    lVar18 = 0;
                    ...
                    if (uStack_140 != 0) {
                      do {
                        uVar21 = uVar9;
                        uVar9 = uVar21 + 1;
                        *(short *)(lVar18 + -6 + lStack_150) = sVar17;
                        *(short *)(lVar18 + -4 + lStack_150) = sVar24;
                        *(short *)(lVar18 + -2 + lStack_150) = sVar20;
                        *(short *)(lVar18 + lStack_150) = sVar17;
                        *(short *)(lVar18 + 2 + lStack_150) = sVar24;
                        *(short *)(lVar18 + 4 + lStack_150) = sVar20;
                        lVar18 = lVar18 + 0xc;
                      } while (uVar9 < uStack_140);
                      lVar13 = uVar21 + 2 + uVar9;
                    }
                    if (lVar13 - 1U < uStack_160) {
                      lVar13 = lVar13 * 3 + -3;
                      *(short *)(lStack_150 + -6 + lVar13 * 2) = sVar17;
                      *(short *)(lStack_150 + -4 + lVar13 * 2) = sVar24;
                      *(short *)(lStack_150 + -2 + lVar13 * 2) = sVar20;
                    }
                    goto LAB_140061825;
                  }
                }
                ...
                if (uStack_140 != 0) {
                  do {
                    uVar21 = uVar9;
                    *(short *)(lStack_150 + -6 + uVar21 * 0xc) = *psVar26;
                    uVar9 = uVar21 + 1;
                    *(short *)(lStack_150 + -4 + uVar21 * 0xc) = psVar26[1];
                    *(short *)(lStack_150 + -2 + uVar21 * 0xc) = psVar26[2];
                    *(short *)(lStack_150 + uVar21 * 0xc) = *psVar26;
                    *(short *)(lStack_150 + 2 + uVar21 * 0xc) = psVar26[1];
                    *(short *)(lStack_150 + 4 + uVar21 * 0xc) = psVar26[2];
                  } while (uVar9 < uStack_140);
                  lVar13 = uVar21 + 2 + uVar9;
                }
                if (lVar13 - 1U < uStack_160) {
                  lVar13 = lVar13 * 3 + -3;
                  *(short *)(lStack_150 + -6 + lVar13 * 2) = *psVar26;
                  *(short *)(lStack_150 + -4 + lVar13 * 2) = psVar26[1];
                  *(short *)(lStack_150 + -2 + lVar13 * 2) = psVar26[2];
                }
              }
LAB_140061825:
              puStack_1a8 = (ulonglong *)CONCAT44(puStack_1a8._4_4_,uVar25);
...
LAB_140061a1a:
      if ((uStack_50 ^ (ulonglong)auStack_1c8) == _DAT_1436b4680) {
        return uVar9;
      }
      goto LAB_14006047c;
    }
  ...
  if (uVar8 == 6) {
    uVar12 = 0;
    lVar13 = 0;
    uVar9 = (ulonglong)(uint)(int)*param_8;
    fVar30 = (float)(int)*param_8;
    fVar29 = (float)(int)param_8[1];
...
LAB_1400607a5:
            ...
            uVar15 = uVar19 & 0xf;
            if (uVar15 != 0) {
              if ((uVar19 & 3) != 0) goto LAB_1400607a5;
              uVar15 = 0x10 - uVar15 >> 2;
            }
            if ((longlong)uVar12 < (longlong)(uVar15 + 4)) goto LAB_1400607a5;
            uVar14 = 0;
    ...
    if (uVar8 == 3) {
      ...
      uStack_180 = param_10;
      uStack_198 = param_7;
      uVar9 = FUN_140643900(param_1,lStack_78,(longlong)iVar16,param_3);
      lVar13 = 1;
      uVar12 = 0;
      if (1 < iVar16) {
        uVar9 = *param_5;
...
LAB_140060644:
              ...
              uVar21 = uVar19 & 0xf;
              if (uVar21 != 0) {
                if ((uVar19 & 3) != 0) goto LAB_140060644;
                uVar21 = 0x10 - uVar21 >> 2;
              }
              if ((longlong)uVar15 < (longlong)(uVar21 + 4)) goto LAB_140060644;
