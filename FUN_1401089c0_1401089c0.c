...
void FUN_1401089c0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0xf < (longlong)param_5) {
    uVar26 = param_4 & 0x3f;
    if (uVar26 != 0) {
      if ((param_4 & 3) != 0) goto LAB_140108c80;
    ...
    if (uVar26 != 0) {
      auVar34 = vmovdqu32_avx512f(_DAT_143087000);
      auVar35 = vmovdqu32_avx512f(_DAT_143087040);
