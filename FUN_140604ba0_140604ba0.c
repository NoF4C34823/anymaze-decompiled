...
void FUN_140604ba0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140605c19. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(puVar18,param_4,*param_5);
    return;
  }
  if (uVar13 == 6) {
    uVar8 = (uint)*param_8;
          ...
          if (uVar13 != 6) {
            if (uVar13 == 1) {
              ...
              if (lVar14 < 2) {
                ...
                if (lVar25 < 0) goto LAB_140605ba0;
                while (uVar20 == 0) {
                  for (lVar9 = (lVar14 + -1) * 2 - lVar9; lVar9 < 0; lVar9 = -lVar9) {
LAB_140605ba0:
                    if (uVar8 != 0) goto LAB_140605aa5;
                  }
          ...
          uVar24 = uVar23;
          if (uVar21 != 0) goto LAB_140605aa5;
        }
        else {
LAB_140605aa5:
        ...
        *(ushort *)(param_11 + lVar10 * 2) = uVar24;
        lVar10 = lVar10 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140605b06. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,lVar14,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar12 == 1) {
...
LAB_140605b1a:
              ...
              uVar16 = uVar7 & 0xf;
              if (uVar16 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_140605b1a;
                uVar16 = 0x10 - uVar16 >> 1;
              }
              if ((longlong)uVar17 < (longlong)(uVar16 + 8)) goto LAB_140605b1a;
...
LAB_14060503b:
      if (uVar13 == 1) {
        if ((longlong)uVar12 < 1) goto LAB_14060524e;
...
LAB_140605b7e:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140605b7e;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar16 + 8)) goto LAB_140605b7e;
          uVar11 = 0;
...
LAB_140605b21:
          ...
          uVar16 = param_11 & 0xf;
          if (uVar16 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140605b21;
            uVar16 = 0x10 - uVar16 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar16 + 8)) goto LAB_140605b21;
          uVar11 = 0;
          uVar22 = uVar12 - (uVar12 - uVar16 & 7);
          if (uVar16 != 0) {
            do {
...
LAB_14060524e:
      in_XMM0._0_8_ =
           (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(uVar7,param_4,uVar12,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140605b7b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(puVar18,param_4,lVar14);
    return;
  }
  if ((longlong)uVar12 < lVar14) {
    lVar14 = lVar14 - uVar12;
    in_XMM0._0_8_ =
         (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(puVar18,param_4,lVar14,param_9,param_10);
...
LAB_140605b29:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140605b29;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar17 < (longlong)(uVar7 + 8)) goto LAB_140605b29;
...
LAB_1406056bc:
  if (uVar13 == 1) {
    if ((longlong)uVar12 < 1) goto LAB_140605958;
...
LAB_140605b37:
          ...
          uVar7 = uVar17 & 0xf;
          if (uVar7 != 0) {
            if ((uVar17 & 1) != 0) goto LAB_140605b37;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_140605b37;
          uVar16 = 0;
  ...
  if ((uVar13 != 6) || ((longlong)uVar12 < 1)) goto LAB_140605958;
  if ((longlong)uVar12 < 8) {
LAB_140605b30:
    uVar7 = 0;
  }
    ...
    if (uVar17 != 0) {
      if ((lVar14 - 2U & 1) != 0) goto LAB_140605b30;
      uVar17 = 0x10 - uVar17 >> 1;
    }
    if ((longlong)uVar12 < (longlong)(uVar17 + 8)) goto LAB_140605b30;
    uVar16 = 0;
...
LAB_140605958:
                    /* WARNING: Could not recover jumptable at 0x000140605995. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_14308b3a0 + lVar6 * 8))(param_11 + uVar12 * 2,param_4,uVar12);
  return;
}
