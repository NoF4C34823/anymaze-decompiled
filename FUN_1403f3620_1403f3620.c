...
void FUN_1403f3620(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
          ...
          do {
            ...
            if (0 < (longlong)uVar40) {
              ...
              if (7 < (longlong)uVar40) {
                ...
                uVar18 = uVar24 & 0xf;
                if (uVar18 != 0) {
                  if ((uVar24 & 1) != 0) goto LAB_1403f38b1;
                ...
                if ((longlong)(uVar18 + 8) <= (longlong)uVar40) {
                  ...
                  do {
                    ...
                    sVar36 = psVar1[6];
                    sVar42 = psVar1[7];
                    uVar46 = (ushort)(sVar39 < (short)uVar46) * sVar39 |
                             (sVar39 >= (short)uVar46) * uVar46;
                    uVar47 = (ushort)(sVar56 < (short)uVar47) * sVar56 |
                             (sVar56 >= (short)uVar47) * uVar47;
                    uVar48 = (ushort)(sVar17 < (short)uVar48) * sVar17 |
                             (sVar17 >= (short)uVar48) * uVar48;
                    uVar49 = (ushort)(sVar21 < (short)uVar49) * sVar21 |
                             (sVar21 >= (short)uVar49) * uVar49;
                    uVar50 = (ushort)(sVar25 < (short)uVar50) * sVar25 |
                             (sVar25 >= (short)uVar50) * uVar50;
                    uVar51 = (ushort)(sVar29 < (short)uVar51) * sVar29 |
                             (sVar29 >= (short)uVar51) * uVar51;
                    uVar52 = (ushort)(sVar36 < (short)uVar52) * sVar36 |
                             (sVar36 >= (short)uVar52) * uVar52;
                    uVar53 = (ushort)(sVar42 < (short)uVar53) * sVar42 |
                             (sVar42 >= (short)uVar53) * uVar53;
                    uVar18 = uVar18 + 8;
                  } while (uVar18 < uVar27);
                  uVar50 = ((short)uVar50 < (short)uVar46) * uVar50 |
                           ((short)uVar50 >= (short)uVar46) * uVar46;
                  uVar51 = ((short)uVar51 < (short)uVar47) * uVar51 |
                           ((short)uVar51 >= (short)uVar47) * uVar47;
                  uVar47 = ((short)uVar52 < (short)uVar48) * uVar52 |
                           ((short)uVar52 >= (short)uVar48) * uVar48;
                  uVar48 = ((short)uVar53 < (short)uVar49) * uVar53 |
                           ((short)uVar53 >= (short)uVar49) * uVar49;
                  uVar47 = ((short)uVar47 < (short)uVar50) * uVar47 |
                           ((short)uVar47 >= (short)uVar50) * uVar50;
                  uVar48 = ((short)uVar48 < (short)uVar51) * uVar48 |
                           ((short)uVar48 >= (short)uVar51) * uVar51;
                  uVar31 = (uint)(ushort)(((short)uVar48 < (short)uVar47) * uVar48 |
...
LAB_1403f38b1:
              if (uVar27 < uVar40) {
                ...
                do {
                  sVar39 = (short)uVar31;
                  if (*(short *)(lVar20 + uVar27 * 2) < (short)uVar31) {
          ...
          do {
            ...
            if (0 < (longlong)uVar40) {
              ...
              if (7 < (longlong)uVar40) {
                ...
                uVar18 = uVar24 & 0xf;
                if (uVar18 != 0) {
                  if ((uVar24 & 1) != 0) goto LAB_1403f3b12;
                  uVar18 = 0x10 - uVar18 >> 1;
                }
                if ((longlong)(uVar18 + 8) <= (longlong)uVar40) {
                  uVar27 = uVar40 - (uVar40 - uVar18 & 7);
...
LAB_1403f3b12:
              if (uVar27 < uVar40) {
                ...
                do {
                  sVar39 = (short)uVar31;
                  if (*(short *)(lVar37 + uVar27 * 2) < (short)uVar31) {
        ...
        FUN_1403f8d00(param_9,uVar16,param_3,uVar41,(longlong)param_6._4_4_);
        uVar26 = uVar26 + 1;
        uVar30 = uVar30 + 1;
              ...
              if (0 < (longlong)uVar38) {
                if ((longlong)uVar38 < 8) {
                  ...
                  do {
                    ...
                    sVar2 = auVar57._0_2_;
                    auVar58._0_2_ =
                         (ushort)(sVar2 < sVar39) * sVar2 | (ushort)(sVar2 >= sVar39) * sVar39;
                    sVar39 = auVar57._2_2_;
                    auVar58._2_2_ =
                         (ushort)(sVar39 < sVar56) * sVar39 | (ushort)(sVar39 >= sVar56) * sVar56;
                    sVar39 = auVar57._4_2_;
                    auVar58._4_2_ =
                         (ushort)(sVar39 < sVar17) * sVar39 | (ushort)(sVar39 >= sVar17) * sVar17;
                    sVar39 = auVar57._6_2_;
                    auVar58._6_2_ =
                         (ushort)(sVar39 < sVar21) * sVar39 | (ushort)(sVar39 >= sVar21) * sVar21;
                    sVar39 = auVar57._8_2_;
                    auVar58._8_2_ =
                         (ushort)(sVar39 < sVar25) * sVar39 | (ushort)(sVar39 >= sVar25) * sVar25;
                    sVar39 = auVar57._10_2_;
                    auVar58._10_2_ =
                         (ushort)(sVar39 < sVar29) * sVar39 | (ushort)(sVar39 >= sVar29) * sVar29;
                    sVar39 = auVar57._12_2_;
                    auVar58._12_2_ =
                         (ushort)(sVar39 < sVar36) * sVar39 | (ushort)(sVar39 >= sVar36) * sVar36;
                    sVar39 = auVar57._14_2_;
                    auVar58._14_2_ =
                         (ushort)(sVar39 < sVar42) * sVar39 | (ushort)(sVar39 >= sVar42) * sVar42;
                    auVar57 = auVar58 & auVar54 | ~auVar54 & auVar57;
                  } while (uVar40 < uVar38);
                  sVar39 = auVar57._8_2_;
                  sVar56 = auVar57._0_2_;
                  uVar47 = (ushort)(sVar39 < sVar56) * sVar39 | (ushort)(sVar39 >= sVar56) * sVar56;
                  sVar39 = auVar57._10_2_;
                  sVar56 = auVar57._2_2_;
                  uVar48 = (ushort)(sVar39 < sVar56) * sVar39 | (ushort)(sVar39 >= sVar56) * sVar56;
                  sVar39 = auVar57._12_2_;
                  sVar56 = auVar57._4_2_;
                  uVar49 = (ushort)(sVar39 < sVar56) * sVar39 | (ushort)(sVar39 >= sVar56) * sVar56;
                  sVar39 = auVar57._14_2_;
                  sVar56 = auVar57._6_2_;
                  uVar50 = (ushort)(sVar39 < sVar56) * sVar39 | (ushort)(sVar39 >= sVar56) * sVar56;
                  uVar47 = ((short)uVar49 < (short)uVar47) * uVar49 |
                           ((short)uVar49 >= (short)uVar47) * uVar47;
                  uVar48 = ((short)uVar50 < (short)uVar48) * uVar50 |
                           ((short)uVar50 >= (short)uVar48) * uVar48;
                  uVar47 = ((short)uVar48 < (short)uVar47) * uVar48 |
                           ((short)uVar48 >= (short)uVar47) * uVar47;
                }
                if (uVar38 < (ulonglong)(longlong)(int)param_6) {
                  ...
                  do {
                    if ((*(char *)(uVar38 + param_7 + uVar22) != '\0') &&
                       (*(short *)(lVar45 + uVar38 * 2) < (short)uVar47)) {
