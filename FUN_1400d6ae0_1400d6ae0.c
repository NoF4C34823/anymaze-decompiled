...
void FUN_1400d6ae0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1400d7708:
      ...
      uVar28 = param_2 & 0x1f;
      if (uVar28 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1400d7708;
        uVar28 = 0x20 - uVar28 >> 2;
      }
      if ((longlong)uVar20 < (longlong)(uVar28 + 0x20)) goto LAB_1400d7708;
...
LAB_1400d76e9:
          ...
          uVar28 = param_2 & 0x1f;
          if (uVar28 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1400d76e9;
            uVar28 = 0x20 - uVar28 >> 2;
          }
          if ((longlong)uVar20 < (longlong)(uVar28 + 0x20)) goto LAB_1400d76e9;
  ...
  if (0x1f < (longlong)uVar20) {
    uVar28 = param_2 & 0x1f;
    if (uVar28 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400d76db;
      uVar28 = 0x20 - uVar28 >> 2;
    }
