...
void FUN_140950820(longlong param_1,ulonglong param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    if ((longlong)param_3 < 0x1d) {
      FUN_1409508f9(param_1,param_3 & 0xfffffffffffffff0,param_3,0);
      return;
    }
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140950b85;
    ...
    if ((longlong)(uVar19 + 0x10) <= (longlong)param_3) {
      ...
      if (uVar19 != 0) {
        do {
          auVar20._0_4_ = (float)(int)*(short *)(param_1 + uVar17 * 2);
          ...
          auVar22._12_4_ = 0;
          auVar22 = vfmadd231ss_fma(ZEXT416((uint)(fVar3 * (float)((int)*(short *)(param_1 + -2 +
                                                                                  uVar17 * 2) +
                                                                  (int)*(short *)(param_1 + 2 +
                                                                                 uVar17 * 2)))),
      ...
      do {
        auVar21._0_4_ = (float)(int)*(short *)(param_1 + uVar19 * 2);
        auVar21._4_8_ = SUB128(ZEXT812(0),4);
        auVar21._12_4_ = 0;
        auVar24._0_4_ =
             (float)((int)*(short *)(param_1 + -4 + uVar19 * 2) +
                    (int)*(short *)(param_1 + 4 + uVar19 * 2));
