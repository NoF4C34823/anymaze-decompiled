...
void FUN_1400b0bc0(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar20) {
    uVar22 = param_2 & 0x1f;
    if (uVar22 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400b0e89;
      ...
      if (uVar22 != 0) {
        do {
          *(float *)(param_2 + uVar19 * 4) =
               fVar2 * (float)((uint)*(ushort *)(param_1 + -6 + uVar19 * 2) +
                              (uint)*(ushort *)(param_1 + 6 + uVar19 * 2)) +
               fVar3 * (float)*(ushort *)(param_1 + uVar19 * 2);
          uVar19 = uVar19 + 1;
        } while (uVar19 < uVar22);
      }
      ...
      if (3 < (longlong)uVar20) {
        ...
        do {
          *(float *)(param_2 + uVar21 * 4 + uVar22 * 4) =
               fVar2 * (float)((uint)*(ushort *)(param_1 + -6 + uVar22 * 2) +
                              (uint)*(ushort *)(param_1 + 6 + uVar22 * 2)) +
               fVar3 * (float)*(ushort *)(param_1 + uVar22 * 2);
          uVar22 = uVar22 + 1;
        } while (uVar22 < uVar20);
        return;
      }
