...
void FUN_1402ca1d8(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < in_stack_000000f0._4_4_) {
    do {
      FUN_1402dd1e0(unaff_RSI,unaff_RBX,lStack0000000000000068,lStack0000000000000060,4);
