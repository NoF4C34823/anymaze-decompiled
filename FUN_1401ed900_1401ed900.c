...
void FUN_1401ed900(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar32 = param_4 & 0x1f;
      if (uVar32 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1401ee100;
...
LAB_1401ee0f0:
    ...
    uVar32 = param_4 & 0x1f;
    if (uVar32 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1401ee0f0;
      uVar32 = 0x20 - uVar32 >> 1;
    }
    if ((longlong)param_5 < (longlong)(uVar32 + 0x10)) goto LAB_1401ee0f0;
    lVar20 = param_2 * lVar25 + param_1;
    lVar21 = param_2 * lVar24 + param_1;
    lVar31 = param_2 * lVar29 + param_1;
    lVar27 = param_2 * lVar28 + param_1;
