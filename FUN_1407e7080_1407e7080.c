...
void FUN_1407e7080(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1407e78b5:
      uVar27 = 0;
      if (param_5 == 0) goto LAB_1407e72de;
      uVar26 = 0;
      uVar25 = param_5;
    }
    else {
      ...
      uVar25 = uVar26 & 0x1f;
      if (uVar25 != 0) {
        if ((uVar26 & 3) != 0) goto LAB_1407e78b5;
        uVar25 = 0x20 - uVar25 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar25 + 0x10)) goto LAB_1407e78b5;
      ...
      if (param_5 < uVar27 + 1) goto LAB_1407e72de;
...
LAB_1407e7505:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar16 = param_4 & 0x1f;
      if (uVar16 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1407e78dc;
...
LAB_1407e78cd:
    ...
    uVar16 = param_4 & 0x1f;
    if (uVar16 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1407e78cd;
      uVar16 = 0x20 - uVar16 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar16 + 0x10)) goto LAB_1407e78cd;
    lVar28 = param_2 * lVar20 + param_1;
    lVar18 = param_2 * lVar24 + param_1;
    uVar25 = 0;
