...
undefined8
FUN_1400d2360(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if ((((param_1 == 0) || (param_3 == 0)) || (param_8 == (undefined4 *)0x0)) || (param_9 == 0)) {
    ...
    uVar1 = FUN_1401dd420(param_5,*param_8,1,1);
    if ((int)uVar1 < 0) {
      if ((uStack_40 ^ (ulonglong)auStack_a8) == DAT_1436b4680) {
        return uVar1;
      }
      ...
      uVar1 = FUN_1408a0140(param_1,(longlong)param_2,param_3,(longlong)param_4);
      if ((uStack_40 ^ (ulonglong)auStack_a8) == DAT_1436b4680) {
        return uVar1;
      }
    }
