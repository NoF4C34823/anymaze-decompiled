...
/* WARNING: Removing unreachable block (ram,0x0001400bd555) */

void FUN_1400bc140(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_248 = param_10;
    (**(code **)(&UNK_143086c20 + lVar25 * 8))(param_1,param_4,*param_5,param_9);
          ...
          if (uVar27 != 6) {
            if (uVar27 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar23 < 0) goto LAB_1400bdba0;
                while (uVar11 == 0) {
                  for (lVar28 = (lVar20 + -1) * 2 - lVar28; lVar28 < 0; lVar28 = -lVar28) {
LAB_1400bdba0:
                    if (uVar22 != 0) goto LAB_1400bd9ec;
                  }
          ...
          if (uVar30 != 0) goto LAB_1400bd9ec;
          uVar30 = *puStack_88;
          uVar35 = puStack_88[1];
          uVar37 = puStack_88[2];
        }
...
LAB_1400bdaf3:
              ...
              if (uVar15 != 0) {
                if ((uStack_f8 & 3) != 0) goto LAB_1400bdaf3;
                uVar15 = 0x20 - uVar15 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_1400bdaf3;
              uVar21 = 0;
...
LAB_1400bcee4:
      uStack_108 = puVar1;
      uStack_110 = *(code **)(&UNK_143086c20 + lVar25 * 8);
      iStack_248 = param_10;
      uStack_100 = param_7;
      lStack_e8 = param_1;
