...
void FUN_1403e4300(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar37 - 1)) {
      while( true ) {
        FUN_1403ef6e0(param_1,lVar33,uVar4,uVar28,1);
        uVar37 = param_6[1];
        lVar21 = lVar21 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      do {
        FUN_1403ef6e0(param_1,lVar33,uVar4,*param_6,1);
        FUN_1403f8d00(param_9,uVar29,param_3,uVar4,param_6[1]);
        lVar21 = lVar21 + 1;
        lVar22 = lVar22 + 1;
        lVar33 = lVar33 + uVar29 * 2;
                ...
                if (0 < (longlong)uVar28) {
                  if ((longlong)uVar28 < 8) {
                    ...
                    do {
                      ...
                      sVar5 = auVar43._0_2_;
                      auVar47._0_2_ =
                           (ushort)(sVar5 < sVar36) * sVar5 | (ushort)(sVar5 >= sVar36) * sVar36;
                      sVar36 = auVar43._2_2_;
                      auVar47._2_2_ =
                           (ushort)(sVar36 < sVar42) * sVar36 | (ushort)(sVar36 >= sVar42) * sVar42;
                      sVar36 = auVar43._4_2_;
                      auVar47._4_2_ =
                           (ushort)(sVar36 < sVar19) * sVar36 | (ushort)(sVar36 >= sVar19) * sVar19;
                      sVar36 = auVar43._6_2_;
                      auVar47._6_2_ =
                           (ushort)(sVar36 < sVar20) * sVar36 | (ushort)(sVar36 >= sVar20) * sVar20;
                      sVar36 = auVar43._8_2_;
                      auVar47._8_2_ =
                           (ushort)(sVar36 < sVar26) * sVar36 | (ushort)(sVar36 >= sVar26) * sVar26;
                      sVar36 = auVar43._10_2_;
                      auVar47._10_2_ =
                           (ushort)(sVar36 < sVar31) * sVar36 | (ushort)(sVar36 >= sVar31) * sVar31;
                      sVar36 = auVar43._12_2_;
                      auVar47._12_2_ =
                           (ushort)(sVar36 < sVar35) * sVar36 | (ushort)(sVar36 >= sVar35) * sVar35;
                      sVar36 = auVar43._14_2_;
                      auVar47._14_2_ =
                           (ushort)(sVar36 < sVar38) * sVar36 | (ushort)(sVar36 >= sVar38) * sVar38;
                      auVar43 = auVar47 & auVar39 | ~auVar39 & auVar43;
                    } while (uVar24 < uVar25);
                    sVar36 = auVar43._8_2_;
                    sVar42 = auVar43._0_2_;
                    uVar41 = (ushort)(sVar36 < sVar42) * sVar36 |
                             (ushort)(sVar36 >= sVar42) * sVar42;
                    sVar36 = auVar43._10_2_;
                    sVar42 = auVar43._2_2_;
                    uVar44 = (ushort)(sVar36 < sVar42) * sVar36 |
                             (ushort)(sVar36 >= sVar42) * sVar42;
                    sVar36 = auVar43._12_2_;
                    sVar42 = auVar43._4_2_;
                    uVar45 = (ushort)(sVar36 < sVar42) * sVar36 |
                             (ushort)(sVar36 >= sVar42) * sVar42;
                    sVar36 = auVar43._14_2_;
                    sVar42 = auVar43._6_2_;
                    uVar46 = (ushort)(sVar36 < sVar42) * sVar36 |
                             (ushort)(sVar36 >= sVar42) * sVar42;
                    uVar41 = ((short)uVar45 < (short)uVar41) * uVar45 |
                             ((short)uVar45 >= (short)uVar41) * uVar41;
                    uVar44 = ((short)uVar46 < (short)uVar44) * uVar46 |
                             ((short)uVar46 >= (short)uVar44) * uVar44;
                    uVar41 = ((short)uVar44 < (short)uVar41) * uVar44 |
                             ((short)uVar44 >= (short)uVar41) * uVar41;
                  }
                  if (uVar25 < uVar28) {
                    lVar2 = lVar1 + lVar30;
                    do {
                      if ((*(char *)(uVar25 + param_7 + lVar34) != '\0') &&
                         (*(short *)(lVar2 + uVar25 * 2) < (short)uVar41)) {
