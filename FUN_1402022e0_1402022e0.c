...
void FUN_1402022e0(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140203334. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143088280 + lVar5 * 8))(psVar23,param_4,*param_5);
    return;
  }
  if (uVar19 == 6) {
    uVar7 = (uint)*param_8;
          ...
          if (uVar19 != 6) {
            if (uVar19 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar14 < 0) goto LAB_1402032c0;
                while (uVar13 == 0) {
                  for (lVar25 = (lVar16 + -1) * 2 - lVar25; lVar25 < 0; lVar25 = -lVar25) {
LAB_1402032c0:
                    if (uVar7 != 0) goto LAB_1402031c2;
                  }
...
LAB_1402031c2:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar24;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140203222. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143088280 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar11 == 1) {
...
LAB_140203236:
              ...
              uVar6 = uVar18 & 0xf;
              if (uVar6 != 0) {
                if ((uVar18 & 1) != 0) goto LAB_140203236;
                uVar6 = 0x10 - uVar6 >> 1;
              }
              if ((longlong)uVar20 < (longlong)(uVar6 + 8)) goto LAB_140203236;
...
LAB_14020277d:
      if (uVar19 == 1) {
        if ((longlong)uVar11 < 1) goto LAB_14020298d;
...
LAB_140203298:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140203298;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_140203298;
          uVar10 = 0;
...
LAB_14020323d:
          ...
          uVar6 = param_11 & 0xf;
          if (uVar6 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14020323d;
            uVar6 = 0x10 - uVar6 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar6 + 8)) goto LAB_14020323d;
          uVar10 = 0;
          uVar8 = uVar11 - (uVar11 - uVar6 & 7);
          if (uVar6 != 0) {
            do {
...
LAB_14020298d:
      (**(code **)(&UNK_143088280 + lVar5 * 8))(uVar18,param_4,uVar11,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140203295. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143088280 + lVar5 * 8))(psVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar11 < lVar16) {
    lVar16 = lVar16 - uVar11;
    (**(code **)(&UNK_143088280 + lVar5 * 8))(psVar23,param_4,lVar16,param_9,param_10);
...
LAB_140203245:
          ...
          uVar18 = param_11 & 0xf;
          if (uVar18 != 0) {
            if ((param_11 & 1) != 0) goto LAB_140203245;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar20 < (longlong)(uVar18 + 8)) goto LAB_140203245;
...
LAB_140202ddc:
  if (uVar19 == 1) {
    if ((longlong)uVar11 < 1) goto LAB_14020307a;
...
LAB_140203253:
          ...
          uVar18 = uVar20 & 0xf;
          if (uVar18 != 0) {
            if ((uVar20 & 1) != 0) goto LAB_140203253;
            uVar18 = 0x10 - uVar18 >> 1;
          }
          if ((longlong)uVar11 < (longlong)(uVar18 + 8)) goto LAB_140203253;
          uVar6 = 0;
  ...
  if ((uVar19 != 6) || ((longlong)uVar11 < 1)) goto LAB_14020307a;
  if ((longlong)uVar11 < 8) {
LAB_14020324c:
    uVar18 = 0;
  }
    ...
    if (uVar20 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_14020324c;
      uVar20 = 0x10 - uVar20 >> 1;
    }
    if ((longlong)uVar11 < (longlong)(uVar20 + 8)) goto LAB_14020324c;
    uVar6 = 0;
...
LAB_14020307a:
                    /* WARNING: Could not recover jumptable at 0x0001402030b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143088280 + lVar5 * 8))(param_11 + uVar11 * 2,param_4,uVar11);
  return;
}
