...
void FUN_14026b7a0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar4 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403a4f20(param_1,lVar3,lVar1,(longlong)(int)param_6,3);
        lVar6 = lVar6 + 1;
