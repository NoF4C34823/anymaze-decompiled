...
void FUN_1407c3740(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar51 = uVar50 & 0xf;
      if (uVar51 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1407c3c05;
...
LAB_1407c3c05:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar46 = uVar50 & 0xf;
      if (uVar46 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1407c3f78;
...
LAB_1407c3ee4:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar46 = uVar50 & 0xf;
    if (uVar46 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_1407c3f71;
      uVar46 = 0x10 - uVar46 >> 2;
    }
    if ((longlong)(uVar46 + 8) <= (longlong)param_5) {
      uVar45 = 0;
