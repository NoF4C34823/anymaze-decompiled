...
void FUN_1407a0e00(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1407a15db:
      uVar29 = 0;
      if (param_5 == 0) goto LAB_1407a12fe;
      uVar28 = 0;
      uVar42 = param_5;
    }
    else {
      ...
      uVar42 = uVar41 & 0xf;
      if (uVar42 != 0) {
        if ((uVar41 & 3) != 0) goto LAB_1407a15db;
        uVar42 = 0x10 - uVar42 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar42 + 8)) goto LAB_1407a15db;
      ...
      if (param_5 < uVar29 + 1) goto LAB_1407a12fe;
...
LAB_1407a12fe:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar41 = param_4 & 0xf;
      if (uVar41 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1407a15f8;
...
LAB_1407a157e:
  ...
  if (7 < (longlong)param_5) {
    uVar41 = param_4 & 0xf;
    if (uVar41 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1407a15f1;
      uVar41 = 0x10 - uVar41 >> 1;
    }
    if ((longlong)(uVar41 + 8) <= (longlong)param_5) {
      uVar29 = 0;
