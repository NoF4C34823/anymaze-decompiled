...
void FUN_14030a724(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if (0 < in_stack_000000f0._4_4_) {
    do {
      ...
      FUN_142d22130(in_stack_00000110,param_1,param_3,uStack0000000000000068);
