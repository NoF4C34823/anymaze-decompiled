...
void FUN_1405c9660(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (7 < (longlong)param_3) {
    uVar46 = param_2 & 0xf;
    if (uVar46 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1405c98a3;
      uVar46 = 0x10 - uVar46 >> 2;
    }
    if ((longlong)(uVar46 + 8) <= (longlong)param_3) {
      uVar44 = 0;
      uVar45 = param_3 - (param_3 - uVar46 & 7);
      if (uVar46 != 0) {
        do {
          *(float *)(param_2 + uVar44 * 4) =
               (float)((uint)*(ushort *)(param_1 + -2 + uVar44 * 2) +
                      (uint)*(ushort *)(param_1 + 2 + uVar44 * 2)) * fVar3 +
               (float)*(ushort *)(param_1 + uVar44 * 2) * fVar4;
          uVar44 = uVar44 + 1;
        } while (uVar44 < uVar46);
      }
      do {
        uVar44 = *(ulonglong *)(param_1 + uVar46 * 2);
        auVar8._8_4_ = 0;
        auVar8._0_8_ = uVar44;
        auVar8._12_2_ = (short)(uVar44 >> 0x30);
        auVar17._8_2_ = (short)(uVar44 >> 0x20);
        auVar17._0_8_ = uVar44;
        auVar17._10_4_ = auVar8._10_4_;
        auVar35._6_8_ = 0;
        auVar35._0_6_ = auVar17._8_6_;
        auVar26._4_2_ = (short)(uVar44 >> 0x10);
        auVar26._0_4_ = (uint)uVar44;
        auVar26._6_8_ = SUB148(auVar35 << 0x40,6);
        uVar5 = *(ulonglong *)(param_1 + 2 + uVar46 * 2);
        uVar6 = *(ulonglong *)(param_1 + -2 + uVar46 * 2);
        auVar9._8_4_ = 0;
        auVar9._0_8_ = uVar5;
        ...
        *pfVar1 = (float)(((uint)uVar6 & 0xffff) + ((uint)uVar5 & 0xffff)) * fVar3 +
                  (float)((uint)uVar44 & 0xffff) * fVar4;
        pfVar1[1] = (float)(auVar28._4_4_ + auVar27._4_4_) * fVar3 + (float)auVar26._4_4_ * fVar4;
        pfVar1[2] = (float)(auVar19._8_4_ + auVar18._8_4_) * fVar3 + (float)auVar17._8_4_ * fVar4;
        pfVar1[3] = (float)((auVar10._10_4_ >> 0x10) + (auVar9._10_4_ >> 0x10)) * fVar3 +
                    (float)(auVar8._10_4_ >> 0x10) * fVar4;
        uVar44 = *(ulonglong *)(param_1 + 8 + uVar46 * 2);
        auVar11._8_4_ = 0;
        auVar11._0_8_ = uVar44;
        auVar11._12_2_ = (short)(uVar44 >> 0x30);
        auVar20._8_2_ = (short)(uVar44 >> 0x20);
        auVar20._0_8_ = uVar44;
        auVar20._10_4_ = auVar11._10_4_;
        auVar38._6_8_ = 0;
        auVar38._0_6_ = auVar20._8_6_;
        auVar29._4_2_ = (short)(uVar44 >> 0x10);
        auVar29._0_4_ = (uint)uVar44;
        auVar29._6_8_ = SUB148(auVar38 << 0x40,6);
        uVar5 = *(ulonglong *)(param_1 + 10 + uVar46 * 2);
        uVar6 = *(ulonglong *)(param_1 + 6 + uVar46 * 2);
        auVar12._8_4_ = 0;
        auVar12._0_8_ = uVar5;
        ...
        *pfVar1 = (float)(((uint)uVar6 & 0xffff) + ((uint)uVar5 & 0xffff)) * fVar3 +
                  (float)((uint)uVar44 & 0xffff) * fVar4;
        pfVar1[1] = (float)(auVar31._4_4_ + auVar30._4_4_) * fVar3 + (float)auVar29._4_4_ * fVar4;
        pfVar1[2] = (float)(auVar22._8_4_ + auVar21._8_4_) * fVar3 + (float)auVar20._8_4_ * fVar4;
        pfVar1[3] = (float)((auVar13._10_4_ >> 0x10) + (auVar12._10_4_ >> 0x10)) * fVar3 +
                    (float)(auVar11._10_4_ >> 0x10) * fVar4;
        uVar46 = uVar46 + 8;
      } while (uVar46 < uVar45);
      if (param_3 < uVar45 + 1) {
        return;
      }
      param_3 = param_3 - uVar45;
      if (3 < (longlong)param_3) {
        uVar44 = 0;
        uVar46 = param_3 & 0xfffffffffffffffc;
        do {
          lVar2 = uVar44 + uVar45;
          ...
          pfVar1 = (float *)(param_2 + uVar45 * 4 + uVar44 * 4);
          *pfVar1 = (float)(((uint)uVar7 & 0xffff) + ((uint)uVar6 & 0xffff)) * fVar3 +
                    (float)((uint)uVar5 & 0xffff) * fVar4;
          pfVar1[1] = (float)(auVar34._4_4_ + auVar33._4_4_) * fVar3 + (float)auVar32._4_4_ * fVar4;
          pfVar1[2] = (float)(auVar25._8_4_ + auVar24._8_4_) * fVar3 + (float)auVar23._8_4_ * fVar4;
          pfVar1[3] = (float)((auVar16._10_4_ >> 0x10) + (auVar15._10_4_ >> 0x10)) * fVar3 +
                      (float)(auVar14._10_4_ >> 0x10) * fVar4;
          uVar44 = uVar44 + 4;
        } while (uVar44 < uVar46);
        if (param_3 <= uVar46) {
          return;
        ...
        do {
          *(float *)(param_2 + uVar45 * 4 + uVar46 * 4) =
               (float)((uint)*(ushort *)(param_1 + -2 + uVar46 * 2) +
                      (uint)*(ushort *)(param_1 + 2 + uVar46 * 2)) * fVar3 +
               (float)*(ushort *)(param_1 + uVar46 * 2) * fVar4;
          uVar46 = uVar46 + 1;
        } while (uVar46 < param_3);
        return;
      }
      goto LAB_1405c98ab;
    }
