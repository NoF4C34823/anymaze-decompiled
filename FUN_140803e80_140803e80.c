...
void FUN_140803e80(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)uVar32) {
    uVar30 = param_2 & 0x1f;
    if (uVar30 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140804074;
...
LAB_14080407d:
  FUN_140804033(fVar6,fVar5,param_3,0);
  return;
}
