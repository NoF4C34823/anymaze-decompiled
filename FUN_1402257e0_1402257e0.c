...
void FUN_1402257e0(longlong param_1,longlong param_2,longlong param_3,undefined4 *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    (**(code **)(&UNK_143088520 + lVar10 * 8))(pbVar27,param_4,*param_5,param_9,param_10);
    return;
  }
  if (uVar26 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar26 != 6) {
            if (uVar26 == 1) {
              ...
              if (lVar15 < 2) {
                ...
                if (lVar14 < 0) goto LAB_140226dc0;
                while (uVar11 == 0) {
                  for (lVar25 = (lVar15 + -1) * 2 - lVar25; lVar25 < 0; lVar25 = -lVar25) {
LAB_140226dc0:
                    if (uVar13 != 0) goto LAB_140226c22;
                  }
          ...
          bVar28 = bVar17;
          if (uVar24 != 0) goto LAB_140226c22;
        }
        else {
LAB_140226c22:
    ...
    (**(code **)(&UNK_143088520 + lVar10 * 8))(param_11 + uVar19,param_4,lVar15,param_9,param_10);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar19 == 1) {
...
LAB_140226ce4:
              ...
              if ((longlong)uVar19 < 0x671) {
                ...
                if ((longlong)uVar19 < (longlong)(uVar16 + 0x20)) goto LAB_140226ce4;
                uVar23 = 0;
...
LAB_140226cc5:
          ...
          if ((longlong)uVar19 < 0x671) {
            ...
            if ((longlong)uVar19 < (longlong)(uVar16 + 0x20)) goto LAB_140226cc5;
            uVar23 = 0;
            uVar18 = uVar19 - (uVar19 - uVar16 & 0x1f);
            if (uVar16 != 0) {
              do {
      ...
      (**(code **)(&UNK_143088520 + lVar10 * 8))(param_11 + uVar19,param_4,uVar19,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
    (**(code **)(&UNK_143088520 + lVar10 * 8))(pbVar27,param_4,lVar15,param_9,param_10);
    return;
  }
...
LAB_140226d02:
          ...
          if ((longlong)uVar22 < 0xa71) {
            ...
            if ((longlong)uVar22 < (longlong)(uVar16 + 0x20)) goto LAB_140226d02;
...
LAB_140226524:
  if (uVar26 == 1) {
    if ((longlong)uVar19 < 1) goto LAB_140226ad5;
    if ((longlong)uVar19 < 7) {
      lVar15 = 1;
      if (uVar19 >> 1 != 0) {
...
LAB_140226d5b:
      ...
      if ((longlong)uVar19 < 0x6a1) {
        ...
        if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140226d5b;
        uVar18 = 0;
  ...
  if (uVar26 != 3) {
    if ((uVar26 != 6) || ((longlong)uVar19 < 1)) goto LAB_140226ad5;
    if ((longlong)uVar19 < 0x20) {
LAB_140226d3d:
      uVar16 = 0;
    }
      ...
      if ((longlong)uVar19 < 0x6a1) {
        ...
        if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140226d3d;
        uVar18 = 0;
        uVar16 = uVar19 - (uVar19 - uVar22 & 0x1f);
        if (uVar22 != 0) {
          do {
...
LAB_140226d20:
    ...
    if ((longlong)uVar19 < 0xaa1) {
      ...
      if ((longlong)uVar19 < (longlong)(uVar22 + 0x20)) goto LAB_140226d20;
      uVar18 = 0;
      lVar12 = 0;
      uVar16 = uVar19 - (uVar19 - uVar22 & 0x1f);
      if (uVar22 != 0) {
