...
void FUN_1403c6da0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar3 - 1U)) {
      while( true ) {
        FUN_142d257a0(param_1,lVar6,lVar4,lVar1 * 2 + *param_6,3);
        lVar3 = param_6[1];
        lVar2 = lVar2 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_142d257a0(param_1,lVar6,lVar4,*param_6 * 2 + *param_6,3);
