...
ulonglong FUN_140696f40(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  iVar16 = param_10 >> 1;
  lVar15 = 0;
  uVar9 = DAT_1436b4680 ^ (ulonglong)auStack_1e8;
  lStack_70 = param_2;
  uStack_50 = uVar9;
  if (iVar16 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_140698738;
  }
  else {
    ...
    do {
      ...
      iStack_1a0 = param_10;
      lStack_198 = param_11;
      auVar27._0_8_ = FUN_1406f3680(lStack_78,lStack_70,lVar15,lVar13);
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      pcStack_c8 = *(code **)(&DAT_14308b900 + (longlong)param_6 * 8);
            ...
            if (lStack_d8 < (longlong)(uStack_68 + uVar14)) {
              do {
                ...
                if (lVar15 < 0) {
                  if (param_7 != 0xf0) {
                    if (iVar16 == 6) {
                      if (uStack_c0 == 0) goto LAB_1406986b1;
                    }
                    else {
                      if (iVar16 != 1) goto LAB_140698624;
LAB_14069879d:
                      lVar21 = 0;
                      if (uStack_c0 != 0) {
                        lVar21 = lVar15;
...
LAB_140698695:
                  sVar10 = *(short *)(lVar13 + lVar21 * 6);
                  sVar23 = *(short *)(lVar13 + 2 + lVar21 * 6);
                  sVar17 = *(short *)(lVar13 + 4 + lVar21 * 6);
                }
                else {
                  if ((lVar15 < (longlong)uVar14) || (param_7 == 0xf0)) goto LAB_140698695;
                  if (iVar16 != 6) {
                    if (iVar16 == 1) {
                      if (lVar15 < 0) goto LAB_14069879d;
                      if (uStack_b8 == 0) {
                        lVar21 = uVar14 - 1;
                      }
                    }
...
LAB_1406987b0:
                  ...
                  if (uStack_b8 != 0) goto LAB_140698695;
LAB_1406986b1:
                  sVar10 = *psVar25;
                  sVar23 = psVar25[1];
                  sVar17 = psVar25[2];
                ...
                uVar20 = uVar20 + 1;
                lVar15 = lVar15 + 1;
                *(short *)(lVar18 + param_11) = sVar10;
                *(short *)(lVar18 + 2 + param_11) = sVar23;
                *(short *)(lVar18 + 4 + param_11) = sVar17;
                lVar18 = lVar18 + 6;
                uStack_148 = uVar9;
                uStack_f8 = uVar11;
...
LAB_140697a98:
              if (iVar16 == 1) {
                ...
                if (6 < (longlong)uStack_188 / 3) {
                  ...
                  lVar15 = (longlong)psVar25 + (2 - param_11);
                  if (((lVar18 <= lVar15) || (3 < -lVar15)) &&
                     ((1 < param_11 - (longlong)psVar25 ||
                      (lVar18 <= -(param_11 - (longlong)psVar25))))) {
                    uVar20 = 0;
                    lVar18 = 1;
                    sVar10 = *psVar25;
                    lVar15 = 0;
                    ...
                    if (uStack_150 != 0) {
                      do {
                        uVar20 = uVar20 + 1;
                        *(short *)(lVar15 + param_11) = sVar10;
                        *(short *)(lVar15 + 2 + param_11) = sVar23;
                        *(short *)(lVar15 + 4 + param_11) = sVar17;
                        *(short *)(lVar15 + 6 + param_11) = sVar10;
                        *(short *)(lVar15 + 8 + param_11) = sVar23;
                        *(short *)(lVar15 + 10 + param_11) = sVar17;
                        lVar15 = lVar15 + 0xc;
                      } while (uVar20 < uStack_150);
                      lVar18 = uVar20 * 2 + 1;
                    }
                    uVar20 = lVar18 - 1;
                    if (uVar20 < uStack_170) {
                      *(short *)(param_11 + uVar20 * 6) = sVar10;
                      *(short *)(param_11 + 2 + uVar20 * 6) = sVar23;
                      *(short *)(param_11 + 4 + uVar20 * 6) = sVar17;
                    }
                    goto LAB_140697f62;
                  }
                }
                ...
                if (uStack_150 != 0) {
                  do {
                    uVar22 = uVar20 + 1;
                    lVar15 = uVar20 * 0xc;
                    *(short *)(param_11 + lVar15) = *psVar25;
                    *(short *)(param_11 + 2 + lVar15) = psVar25[1];
                    *(short *)(param_11 + 4 + lVar15) = psVar25[2];
                    *(short *)(param_11 + 6 + lVar15) = *psVar25;
                    *(short *)(param_11 + 8 + lVar15) = psVar25[1];
                    *(short *)(param_11 + 10 + lVar15) = psVar25[2];
                    uVar20 = uVar22;
                ...
                uVar20 = lVar15 - 1;
                if (uVar20 < uStack_170) {
                  *(short *)(param_11 + uVar20 * 6) = *psVar25;
                  *(short *)(param_11 + 2 + uVar20 * 6) = psVar25[1];
                  *(short *)(param_11 + 4 + uVar20 * 6) = psVar25[2];
                }
              }
LAB_140697f62:
              puStack_1c8 = (ulonglong *)CONCAT44(puStack_1c8._4_4_,param_10);
            ...
            if (uStack_b8 == 0) {
              ...
              if (iVar16 == 1) {
                ...
                if (6 < (longlong)uStack_188 / 3) {
                  ...
                  lVar13 = (longlong)psVar25 + (2 - lVar15);
                  if (((lVar18 <= lVar13) || (3 < -lVar13)) &&
                     ((lVar15 = lVar15 - (longlong)psVar25, 1 < lVar15 || (lVar18 <= -lVar15)))) {
                    uVar14 = 0;
                    lVar13 = 1;
                    sVar10 = *psVar25;
                    lVar15 = 0;
                    ...
                    if (uStack_150 != 0) {
                      do {
                        uVar14 = uVar14 + 1;
                        *(short *)(lVar15 + -6 + lStack_158) = sVar10;
                        *(short *)(lVar15 + -4 + lStack_158) = sVar23;
                        *(short *)(lVar15 + -2 + lStack_158) = sVar17;
                        *(short *)(lVar15 + lStack_158) = sVar10;
                        *(short *)(lVar15 + 2 + lStack_158) = sVar23;
                        *(short *)(lVar15 + 4 + lStack_158) = sVar17;
                        lVar15 = lVar15 + 0xc;
                      } while (uVar14 < uStack_150);
                      lVar13 = uVar14 * 2 + 1;
                    }
                    uVar14 = lVar13 - 1;
                    if (uVar14 < uStack_170) {
                      *(short *)(lStack_158 + -6 + uVar14 * 6) = sVar10;
                      *(short *)(lStack_158 + -4 + uVar14 * 6) = sVar23;
                      *(short *)(lStack_158 + -2 + uVar14 * 6) = sVar17;
                    }
                    goto LAB_140698545;
                  }
                }
                ...
                if (uStack_150 != 0) {
                  do {
                    uVar20 = uVar14 + 1;
                    lVar15 = uVar14 * 0xc;
                    *(short *)(lStack_158 + -6 + lVar15) = *psVar25;
                    *(short *)(lStack_158 + -4 + lVar15) = psVar25[1];
                    *(short *)(lStack_158 + -2 + lVar15) = psVar25[2];
                    *(short *)(lStack_158 + lVar15) = *psVar25;
                    *(short *)(lStack_158 + 2 + lVar15) = psVar25[1];
                    *(short *)(lStack_158 + 4 + lVar15) = psVar25[2];
                    uVar14 = uVar20;
                  } while (uVar20 < uStack_150);
                  lVar15 = uVar20 * 2 + 1;
                }
                uVar14 = lVar15 - 1;
                if (uVar14 < uStack_170) {
                  *(short *)(lStack_158 + -6 + uVar14 * 6) = *psVar25;
                  *(short *)(lStack_158 + -4 + uVar14 * 6) = psVar25[1];
                  *(short *)(lStack_158 + -2 + uVar14 * 6) = psVar25[2];
                }
              }
LAB_140698545:
              puStack_1c8 = (ulonglong *)CONCAT44(puStack_1c8._4_4_,param_10);
...
LAB_140698738:
      if ((uStack_50 ^ (ulonglong)auStack_1e8) == DAT_1436b4680) {
        return uVar9;
      }
      goto LAB_1406970d9;
    }
...
LAB_140697446:
            ...
            uVar20 = uVar22 & 0xf;
            if (uVar20 != 0) {
              if ((uVar22 & 3) != 0) goto LAB_140697446;
              uVar20 = 0x10 - uVar20 >> 2;
            }
            if ((longlong)uVar14 < (longlong)(uVar20 + 4)) goto LAB_140697446;
            uVar12 = 0;
    ...
    if (uVar8 == 3) {
      ...
      uStack_1a8 = param_9;
      lStack_198 = param_11;
      uVar9 = FUN_1406f3680(param_1,lStack_70,(longlong)iVar16,param_3);
      lVar15 = 1;
      uVar11 = 0;
      if (1 < iVar16) {
...
LAB_1406972c6:
              ...
              uVar20 = uVar22 & 0xf;
              if (uVar20 != 0) {
                if ((uVar22 & 3) != 0) goto LAB_1406972c6;
                uVar20 = 0x10 - uVar20 >> 2;
              }
              if ((longlong)uVar14 < (longlong)(uVar20 + 4)) goto LAB_1406972c6;
