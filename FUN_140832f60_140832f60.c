...
void FUN_140832f60(ulonglong param_1,float param_2,longlong param_3,longlong param_4)
    ...
    if (uVar21 < param_1) {
      ...
      do {
        *(float *)(param_4 + in_RDX * 4 + uVar21 * 4) =
             param_2 * (float)((int)*(short *)(param_3 + -6 + uVar21 * 2) +
                              (int)*(short *)(param_3 + 6 + uVar21 * 2)) +
             in_XMM0_Da * (float)(int)*(short *)(param_3 + uVar21 * 2);
        uVar21 = uVar21 + 1;
