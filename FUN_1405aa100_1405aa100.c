...
void FUN_1405aa100(undefined1 (*param_1) [32],longlong param_2,undefined8 param_3,uint param_4)

{
  ...
  auVar10 = vpminub_avx2(auVar10,auVar11);
  auVar9 = vpminub_avx2(auVar13,auVar9);
  auVar10 = vpminub_avx2(auVar10,auVar12);
  auVar9 = vpminub_avx2(auVar9,auVar14);
