...
void FUN_1401736c0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140173f8e:
      uVar97 = 0;
      if (param_3 == 0) goto LAB_1401738c6;
      uVar95 = 0;
      uVar99 = param_3;
    }
    else {
      uVar99 = param_2 & 0xf;
      if (uVar99 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140173f8e;
        uVar99 = 0x10 - uVar99 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_140173f8e;
      ...
      if (param_3 < uVar97 + 1) goto LAB_1401738c6;
...
LAB_140173f68:
          uVar97 = 0;
          if (param_3 == 0) goto LAB_140173db1;
          uVar95 = 0;
          uVar99 = param_3;
        }
        else {
          uVar99 = param_2 & 0xf;
          if (uVar99 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140173f68;
            uVar99 = 0x10 - uVar99 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_140173f68;
          ...
          if (param_3 < uVar97 + 1) goto LAB_140173db1;
          uVar99 = param_3 - uVar97;
          if ((longlong)uVar99 < 4) {
            uVar95 = 0;
          }
...
LAB_140173f55:
    ...
    uVar99 = param_2 & 0xf;
    if (uVar99 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140173f55;
      uVar99 = 0x10 - uVar99 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_140173f55;
    uVar95 = 0;
    uVar97 = param_3 - (param_3 - uVar99 & 7);
    if (uVar99 != 0) {
      do {
