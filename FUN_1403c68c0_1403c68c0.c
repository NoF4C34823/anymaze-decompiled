...
void FUN_1403c68c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(lVar3 - 1U)) {
      while( true ) {
        FUN_142d257a0(param_1,lVar4,lVar1,lVar2,1);
        lVar3 = param_6[1];
        lVar6 = lVar6 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_142d257a0(param_1,lVar4,lVar1,*param_6,1);
