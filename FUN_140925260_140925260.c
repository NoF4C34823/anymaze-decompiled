...
void FUN_140925260(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)uVar13) {
    if ((longlong)uVar13 < 0x1d) {
      FUN_14092531d(uVar13 & 0xfffffffffffffff0,uVar13,param_2,0);
      return;
    }
    uVar14 = param_2 & 0x1f;
    if (uVar14 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1409254c9;
