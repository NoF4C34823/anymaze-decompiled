...
void FUN_1403ed060(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar24 - 1)) {
      while( true ) {
        FUN_1403db020(lVar30,lVar19,uVar11,uVar29,1);
        uVar24 = param_6[1];
        lVar32 = lVar32 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        FUN_1403db020(lVar30,lVar19,uVar11,*param_6,1);
        uVar24 = param_6[1];
          ...
          do {
            ...
            if (0 < (longlong)uVar24) {
              ...
              if (uVar24 >> 3 != 0) {
                ...
                bVar38 = 0xff;
                do {
                  if (*(byte *)(param_9 + uVar29 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(param_9 + uVar29 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar8 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar8 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar5 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar5 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar7 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar7 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar3 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar3 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar2 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar2 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar4 + lVar15 * 8) < bVar38) {
                    bVar38 = *(byte *)(lVar4 + lVar15 * 8);
                  }
                  if (*(byte *)(lVar1 + lVar15 * 8) < bVar38) {
              ...
              if (uVar22 <= uVar24) {
                    /* WARNING: Could not recover jumptable at 0x0001403ed4ed. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_1403ed4ef +
                          (byte)(&DAT_143089e98)[(uint)((int)uVar24 - (int)uVar22)]))
                          (param_9 - uVar31);
                return;
              }
            }
...
LAB_1403edb4e:
                    ...
                    if ((longlong)uVar29 < (longlong)(uVar18 + 0x10)) goto LAB_1403edb4e;
                    uVar20 = 0;
                    uVar28 = uVar29 - (uVar29 - uVar18 & 0xf);
                    if (uVar18 != 0) {
                      do {
                        if ((*(char *)(uVar20 + uVar27) != '\0') &&
                           (*(byte *)(lVar26 + lVar33 + uVar20) < bVar38)) {
                    ...
                    do {
                      ...
                      uVar18 = uVar18 + 0x10;
                      bVar12 = auVar40[0];
                      auVar36[0] = (bVar12 < bVar38) * bVar12 | (bVar12 >= bVar38) * bVar38;
                      bVar38 = auVar40[1];
                      auVar36[1] = (bVar38 < bVar37) * bVar38 | (bVar38 >= bVar37) * bVar37;
                      bVar38 = auVar40[2];
                      auVar36[2] = (bVar38 < bVar41) * bVar38 | (bVar38 >= bVar41) * bVar41;
                      bVar38 = auVar40[3];
                      auVar36[3] = (bVar38 < bVar42) * bVar38 | (bVar38 >= bVar42) * bVar42;
                      bVar38 = auVar40[4];
                      auVar36[4] = (bVar38 < bVar43) * bVar38 | (bVar38 >= bVar43) * bVar43;
                      bVar38 = auVar40[5];
                      auVar36[5] = (bVar38 < bVar44) * bVar38 | (bVar38 >= bVar44) * bVar44;
                      bVar38 = auVar40[6];
                      auVar36[6] = (bVar38 < bVar45) * bVar38 | (bVar38 >= bVar45) * bVar45;
                      bVar38 = auVar40[7];
                      auVar36[7] = (bVar38 < bVar46) * bVar38 | (bVar38 >= bVar46) * bVar46;
                      bVar38 = auVar40[8];
                      auVar36[8] = (bVar38 < bVar47) * bVar38 | (bVar38 >= bVar47) * bVar47;
                      bVar38 = auVar40[9];
                      auVar36[9] = (bVar38 < bVar9) * bVar38 | (bVar38 >= bVar9) * bVar9;
                      bVar38 = auVar40[10];
                      auVar36[10] = (bVar38 < bVar10) * bVar38 | (bVar38 >= bVar10) * bVar10;
                      bVar38 = auVar40[0xb];
                      auVar36[0xb] = (bVar38 < bVar14) * bVar38 | (bVar38 >= bVar14) * bVar14;
                      bVar38 = auVar40[0xc];
                      auVar36[0xc] = (bVar38 < bVar16) * bVar38 | (bVar38 >= bVar16) * bVar16;
                      bVar38 = auVar40[0xd];
                      auVar36[0xd] = (bVar38 < bVar21) * bVar38 | (bVar38 >= bVar21) * bVar21;
                      bVar38 = auVar40[0xe];
                      auVar36[0xe] = (bVar38 < bVar23) * bVar38 | (bVar38 >= bVar23) * bVar23;
                      bVar38 = auVar40[0xf];
                      auVar36[0xf] = (bVar38 < bVar25) * bVar38 | (bVar38 >= bVar25) * bVar25;
                      auVar40 = auVar36 & auVar35 | ~auVar35 & auVar40;
                    } while (uVar18 < uVar28);
                    bVar38 = auVar40[8];
                    bVar37 = auVar40[0];
                    bVar37 = (bVar38 < bVar37) * bVar38 | (bVar38 >= bVar37) * bVar37;
                    bVar38 = auVar40[9];
                    bVar41 = auVar40[1];
                    bVar41 = (bVar38 < bVar41) * bVar38 | (bVar38 >= bVar41) * bVar41;
                    bVar38 = auVar40[10];
                    bVar42 = auVar40[2];
                    bVar42 = (bVar38 < bVar42) * bVar38 | (bVar38 >= bVar42) * bVar42;
                    bVar38 = auVar40[0xb];
                    bVar43 = auVar40[3];
                    bVar43 = (bVar38 < bVar43) * bVar38 | (bVar38 >= bVar43) * bVar43;
                    bVar38 = auVar40[0xc];
                    bVar44 = auVar40[4];
                    bVar44 = (bVar38 < bVar44) * bVar38 | (bVar38 >= bVar44) * bVar44;
                    bVar38 = auVar40[0xd];
                    bVar45 = auVar40[5];
                    bVar45 = (bVar38 < bVar45) * bVar38 | (bVar38 >= bVar45) * bVar45;
                    bVar38 = auVar40[0xe];
                    bVar46 = auVar40[6];
                    bVar46 = (bVar38 < bVar46) * bVar38 | (bVar38 >= bVar46) * bVar46;
                    bVar38 = auVar40[0xf];
                    bVar47 = auVar40[7];
                    bVar47 = (bVar38 < bVar47) * bVar38 | (bVar38 >= bVar47) * bVar47;
                    bVar38 = (bVar44 < bVar37) * bVar44 | (bVar44 >= bVar37) * bVar37;
                    bVar37 = (bVar45 < bVar41) * bVar45 | (bVar45 >= bVar41) * bVar41;
                    bVar41 = (bVar46 < bVar42) * bVar46 | (bVar46 >= bVar42) * bVar42;
                    bVar42 = (bVar47 < bVar43) * bVar47 | (bVar47 >= bVar43) * bVar43;
                    bVar38 = (bVar41 < bVar38) * bVar41 | (bVar41 >= bVar38) * bVar38;
                    bVar37 = (bVar42 < bVar37) * bVar42 | (bVar42 >= bVar37) * bVar37;
                    bVar38 = (bVar37 < bVar38) * bVar37 | (bVar37 >= bVar38) * bVar38;
                  }
                  for (; uVar28 < uVar29; uVar28 = uVar28 + 1) {
                    if ((*(char *)(uVar28 + uVar27) != '\0') &&
                       (*(byte *)(lVar26 + lVar33 + uVar28) < bVar38)) {
