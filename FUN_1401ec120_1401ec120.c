...
void FUN_1401ec120(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  lVar57 = (longlong)(int)lVar52 + 1;
  if (6 < lVar57) {
    lVar57 = lVar58;
  }
  lVar49 = (longlong)(int)lVar57 + 1;
  if (6 < lVar49) {
    lVar49 = lVar58;
  }
  lVar53 = (longlong)(int)lVar49 + 1;
  if (6 < lVar53) {
    lVar53 = lVar58;
  }
  ...
  if (0 < (longlong)param_5) {
    ...
    auVar68 = ZEXT416(*param_6);
    auVar69 = ZEXT416(param_6[3]);
    auVar70 = ZEXT416(param_6[2]);
...
LAB_1401ec90c:
      ...
      uVar47 = uVar46 & 0x1f;
      if (uVar47 != 0) {
        if ((uVar46 & 3) != 0) goto LAB_1401ec90c;
        uVar47 = 0x20 - uVar47 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar47 + 8)) goto LAB_1401ec90c;
      lVar58 = param_2 * lVar52 + param_1;
      ...
      lVar63 = param_2 * lVar56 + param_1;
      lVar64 = param_2 * lVar53 + param_1;
      if (uVar47 != 0) {
        auVar14 = vunpcklps_avx(auVar68,auVar65);
        auVar15 = vunpcklps_avx(auVar70,auVar69);
      ...
      auVar16 = vshufps_avx(auVar70,auVar70,0);
      auVar13 = vshufps_avx(auVar69,auVar69,0);
      do {
    ...
    if (uVar48 < param_5) {
      auVar65 = vunpcklps_avx(auVar68,auVar65);
      auVar68 = vunpcklps_avx(auVar70,auVar69);
      auVar65 = vmovlhps_avx(auVar65,auVar68);
      do {
        auVar69 = vunpcklps_avx(ZEXT416((uint)(*(float *)(lVar52 * param_2 + param_1 + uVar48 * 4) +
                                              *(float *)(lVar50 * param_2 + param_1 + uVar48 * 4))),
                                ZEXT416((uint)(*(float *)(lVar57 * param_2 + param_1 + uVar48 * 4) +
                                              *(float *)(lVar51 * param_2 + param_1 + uVar48 * 4))))
        ;
        auVar68 = vinsertps_avx(ZEXT416((uint)(*(float *)(lVar49 * param_2 + param_1 + uVar48 * 4) +
                                              *(float *)(lVar56 * param_2 + param_1 + uVar48 * 4))),
                                ZEXT416(*(uint *)(lVar53 * param_2 + param_1 + uVar48 * 4)),0x10);
        auVar68 = vmovlhps_avx(auVar69,auVar68);
        auVar68 = vdpps_avx(auVar65,auVar68,0xf1);
        *(int *)(param_2 * 7 + param_1 + uVar48 * 4) = auVar68._0_4_;
        uVar48 = uVar48 + 1;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar46 = param_4 & 0x1f;
      if (uVar46 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1401ec91a;
        uVar46 = 0x20 - uVar46 >> 1;
      }
      if ((longlong)(uVar46 + 8) <= (longlong)param_5) {
        lVar52 = param_2 * 7 + param_1;
        uVar48 = 0;
        uVar47 = param_5 - (param_5 - uVar46 & 7);
        if (uVar46 != 0) {
          do {
            iVar55 = (int)ROUND(*(float *)(lVar52 + uVar48 * 4));
            if (0xfffe < iVar55) {
              iVar55 = 0xffff;
            }
            ...
            *(undefined2 *)(param_4 + uVar48 * 2) = uVar54;
            uVar48 = uVar48 + 1;
          } while (uVar48 < uVar46);
        }
        do {
          auVar67._16_16_ = *(undefined1 (*) [16])(lVar52 + 0x10 + uVar46 * 4);
          auVar67._0_16_ = *(undefined1 (*) [16])(lVar52 + uVar46 * 4);
          auVar67 = vcvtps2dq_avx(auVar67);
          auVar65 = vpackusdw_avx(auVar67._0_16_,auVar67._16_16_);
          auVar65 = vmovntdq_avx(auVar65);
          *(undefined1 (*) [16])(param_4 + uVar46 * 2) = auVar65;
          uVar46 = uVar46 + 8;
        } while (uVar46 < uVar47);
        goto LAB_1401ec88d;
      }
...
LAB_1401ec88d:
    ...
    do {
      iVar55 = (int)ROUND(*(float *)(param_1 + param_2 * 7 + uVar47 * 4));
      if (0xfffe < iVar55) {
        iVar55 = 0xffff;
      }
      uVar54 = (undefined2)iVar55;
      ...
      *(undefined2 *)(param_4 + uVar47 * 2) = uVar54;
      uVar47 = uVar47 + 1;
  ...
  if (7 < (longlong)param_5) {
    uVar46 = param_4 & 0xf;
    if (uVar46 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1401ec913;
      uVar46 = 0x10 - uVar46 >> 1;
    }
    if ((longlong)(uVar46 + 8) <= (longlong)param_5) {
      lVar52 = param_2 * 7 + param_1;
      uVar48 = 0;
      ...
      do {
        auVar66._16_16_ = *(undefined1 (*) [16])(lVar52 + 0x10 + uVar46 * 4);
        auVar66._0_16_ = *(undefined1 (*) [16])(lVar52 + uVar46 * 4);
        auVar67 = vcvtps2dq_avx(auVar66);
        auVar65 = vpackusdw_avx(auVar67._0_16_,auVar67._16_16_);
        *(undefined1 (*) [16])(param_4 + uVar46 * 2) = auVar65;
        uVar46 = uVar46 + 8;
      } while (uVar46 < uVar47);
