...
void FUN_140374ca0(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4,
                  ulonglong param_5)
    ...
    do {
      ...
      if (0 < (longlong)param_5) {
        ...
        if (uVar10 <= param_5) {
          ...
          (*(code *)(&UNK_140374f93 + (byte)(&DAT_143089d10)[(uint)((int)param_5 - (int)uVar10)]))()
          ;
          return;
        }
      }
