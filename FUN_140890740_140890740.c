...
void FUN_140890740(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...
LAB_140890847:
    ...
    if (((longlong)param_5[1] <= (longlong)uVar15) && (param_7 != 0xf0)) {
      if (uVar13 == 6) {
        if (uStack_b0 == 0) goto LAB_14089098a;
      }
      else {
        if (uVar13 != 1) goto LAB_140890884;
        if (uStack_b0 == 0) {
          uVar7 = param_5[1] - 1;
        }
      }
...
LAB_140890920:
    ...
    uStack_88 = *param_5;
    uStack_80 = param_5[1];
    FUN_1408913a0(lStack_78,lStack_70,uVar7,param_3,in_stack_fffffffffffffee8,(int)lStack_50,param_7
        ...
        if (uStack_48 <= uVar15) {
          if (uStack_a0 != 0) {
            ...
            do {
              uStack_d8 = *param_5;
              uStack_d0 = param_5[1];
              FUN_1408913a0(lStack_78,lStack_70,lVar9,lVar3,&uStack_d8,(int)lStack_50,param_7,
          ...
          param_10 = iStack_a8;
          if (uVar13 != 1) goto LAB_140890c6b;
          uVar12 = *param_5;
          uVar15 = 0;
          goto LAB_140890f60;
        }
...
LAB_140890bee:
        ...
        (*(code *)(&PTR_FUN_14308cc80)[lStack_50])
      ...
      if (-1 < (longlong)uVar15) goto LAB_140890847;
      uVar7 = uVar15;
      if (param_7 == 0xf0) goto LAB_140890920;
      if (uVar13 != 6) {
        if (uVar13 != 1) goto LAB_140890884;
        uVar7 = 0;
        if (uStack_a0 != 0) {
      ...
      if (uStack_a0 != 0) goto LAB_140890920;
LAB_14089098a:
      uVar7 = *param_5;
      uVar5 = *param_8;
...
LAB_1408912f0:
      ...
      uVar11 = uVar6 & 0x1f;
      if (uVar11 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_1408912e3;
        uVar11 = 0x20 - uVar11 >> 2;
      }
      if ((longlong)uVar7 < (longlong)(uVar11 + 0x10)) goto LAB_1408912e3;
      uVar10 = 0;
      ...
      if (uVar7 < uVar8 + 1) goto LAB_140890ac0;
      uVar7 = uVar7 - uVar8;
      if ((longlong)uVar7 < 4) goto LAB_1408912f0;
...
LAB_140890c6b:
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    ...
    uStack_d8 = *param_5;
    uStack_d0 = param_5[1];
    FUN_1408913a0(lStack_78,lStack_70,lVar3,lStack_98,&uStack_d8,(int)lStack_50,param_7,param_8,
...
LAB_140890ea5:
        ...
        uVar6 = uVar7 & 0x1f;
        if (uVar6 != 0) {
          if ((uVar7 & 3) != 0) goto LAB_140890ea5;
          uVar6 = 0x20 - uVar6 >> 2;
        }
        if ((longlong)uVar15 < (longlong)(uVar6 + 8)) goto LAB_140890ea5;
...
LAB_140891070:
      ...
      uVar7 = uVar6 & 0x1f;
      if (uVar7 != 0) {
        if ((uVar6 & 3) != 0) goto LAB_140891070;
        uVar7 = 0x20 - uVar7 >> 2;
      }
      if ((longlong)uVar12 < (longlong)(uVar7 + 8)) goto LAB_140891070;
      uVar8 = 0;
...
LAB_140890884:
  ...
  if (uVar13 == 3) {
    ...
    if ((longlong)uVar6 < 2) {
      ...
      if ((longlong)uVar15 < 0) goto LAB_140890b80;
      while (uStack_b0 == 0) {
