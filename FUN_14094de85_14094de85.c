...
void FUN_14094de85(longlong param_1,longlong param_2,ulonglong param_3,undefined4 param_4)

{
  ...
  if (param_2 + 1U <= param_3) {
    ...
    if (uVar9 < param_3) {
      ...
      do {
        auVar11._0_4_ = (float)*(ushort *)(param_1 + uVar9 * 2);
