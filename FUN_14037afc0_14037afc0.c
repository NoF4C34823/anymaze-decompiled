...
void FUN_14037afc0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar23 - 1)) {
      while( true ) {
        FUN_14036ade0(lVar12,lVar20,uVar21,uVar19,3);
        uVar23 = param_6[1];
        lVar14 = lVar14 + 1;
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        FUN_14036ade0(lVar12,lVar20,uVar23,*param_6,3);
        uVar19 = param_6[1];
          ...
          do {
            ...
            if (0 < (longlong)uVar19) {
              ...
              if (uVar19 >> 3 != 0) {
                ...
                bVar11 = 0;
                do {
                  if (bVar11 < *(byte *)(param_9 + uVar21 + lVar10 * 8)) {
                    bVar11 = *(byte *)(param_9 + uVar21 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar6 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar6 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar5 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar5 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar3 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar3 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar2 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar2 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar7 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar7 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar4 + lVar10 * 8)) {
                    bVar11 = *(byte *)(lVar4 + lVar10 * 8);
                  }
                  if (bVar11 < *(byte *)(lVar1 + lVar10 * 8)) {
              ...
              if (uVar16 <= uVar19) {
                    /* WARNING: Could not recover jumptable at 0x00014037b48e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_14037b490 +
                          (byte)(&DAT_143089d48)[(uint)((int)uVar19 - (int)uVar16)]))
                          (param_9 - uVar13);
                return;
              }
            }
