...
void FUN_1401c3c60(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1401c4154:
      uVar33 = 0;
      if (param_5 == 0) goto LAB_1401c3f09;
      uVar29 = 0;
      uVar27 = param_5;
    }
    else {
      ...
      uVar27 = uVar26 & 0xf;
      if (uVar27 != 0) {
        if ((uVar26 & 3) != 0) goto LAB_1401c4154;
        uVar27 = 0x10 - uVar27 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar27 + 8)) goto LAB_1401c4154;
      ...
      if (param_5 < uVar33 + 1) goto LAB_1401c3f09;
...
LAB_1401c3f09:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar26 = uVar27 & 0xf;
      if (uVar26 != 0) {
        if ((uVar27 & 3) != 0) goto LAB_1401c4172;
...
LAB_1401c4103:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar26 = uVar27 & 0xf;
    if (uVar26 != 0) {
      if ((uVar27 & 3) != 0) goto LAB_1401c416b;
      uVar26 = 0x10 - uVar26 >> 2;
    }
    if ((longlong)(uVar26 + 8) <= (longlong)param_5) {
      uVar29 = 0;
