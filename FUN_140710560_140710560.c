...
void FUN_140710560(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar21 = uVar22 & 0xf;
      if (uVar21 != 0) {
        if ((uVar22 & 3) != 0) goto LAB_140710e38;
...
LAB_140710e22:
    ...
    uVar22 = uVar21 & 0xf;
    if (uVar22 != 0) {
      if ((uVar21 & 3) != 0) goto LAB_140710e22;
      uVar22 = 0x10 - uVar22 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar22 + 8)) goto LAB_140710e22;
