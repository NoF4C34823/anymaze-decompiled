...
void FUN_14083b4a0(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_14083be4d:
      uVar20 = 0;
      if (param_5 == 0) goto LAB_14083b6fe;
      uVar31 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar31 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar31 & 3) != 0) goto LAB_14083be4d;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_14083be4d;
      ...
      if (param_5 < uVar20 + 1) goto LAB_14083b6fe;
...
LAB_14083b925:
        ...
        uVar16 = uVar16 + 1;
        pfVar24 = pfVar24 + 1;
        if (param_7 - 1U <= uVar16) goto LAB_14083b99d;
      }
      uVar16 = uVar16 + 1;
      pfVar24 = pfVar24 + 1;
...
LAB_14083be21:
      uVar31 = 0;
      if (param_5 == 0) goto LAB_14083bb98;
      uVar20 = 0;
      uVar19 = param_5;
    }
    else {
      ...
      uVar19 = uVar28 & 0x1f;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_14083be21;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 0x10)) goto LAB_14083be21;
      ...
      if (param_5 < uVar31 + 1) goto LAB_14083bb98;
...
LAB_14083bb98:
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      ...
      uVar19 = uVar28 & 0xf;
      if (uVar19 != 0) {
        if ((uVar28 & 3) != 0) goto LAB_14083be3e;
...
LAB_14083bdb7:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar19 = uVar28 & 0xf;
    if (uVar19 != 0) {
      if ((uVar28 & 3) != 0) goto LAB_14083be37;
      uVar19 = 0x10 - uVar19 >> 2;
    }
