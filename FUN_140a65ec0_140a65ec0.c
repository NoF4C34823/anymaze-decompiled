...
uint FUN_140a65ec0(undefined1 *param_1,ulonglong param_2,uint param_3,undefined8 param_4,
...
LAB_140a68ebc:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a68ebc;
            uVar20 = 0;
...
LAB_140a689ec:
    ...
    if (lVar21 < 1) {
      uVar5 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a68d16;
LAB_140a68c08:
      if ((int)uVar5 < 1) {
        return param_5;
      }
...
LAB_140a68eca:
        ...
        if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a68eca;
...
LAB_140a68b1b:
        ...
        if (((longlong)(uVar14 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar14 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a68b1b;
        if (uVar5 < 0x10) {
LAB_140a68ec3:
          uVar9 = 0;
        }
          ...
          iVar6 = (int)uVar7;
          if (uVar5 < iVar6 + 0x10U) goto LAB_140a68ec3;
          uVar9 = 0;
      ...
      if (lVar21 < 5) {
        uVar5 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a68c08;
LAB_140a68d16:
        if ((int)uVar5 < 1) {
          return param_5;
        }
        ...
        *(undefined1 *)(lVar16 + 3 + param_2) = param_1[lVar21 + -1];
        ...
        lVar16 = (longlong)(int)uVar4;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar5 < 1) goto LAB_140a6642c;
          goto LAB_140a68c10;
        }
        if ((int)uVar5 < 1) goto LAB_140a6642c;
      }
...
LAB_140a68ed1:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a68ed1;
            uVar13 = 0;
...
LAB_140a6870a:
          ...
          if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a6870a;
          uVar9 = 0;
      ...
      uVar4 = 0;
      if ((int)param_5 < 1) goto LAB_140a6828c;
      if (6 < (int)param_5) {
        uVar7 = (ulonglong)(int)param_5;
        if (((longlong)uVar7 <= (longlong)(param_2 - (longlong)(param_1 + (int)-param_5))) ||
           ((longlong)uVar7 <= (longlong)-(param_2 - (longlong)(param_1 + (int)-param_5)))) {
...
LAB_140a68711:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a68711;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar14 & 0xf));
            if (uVar14 != 0) {
              do {
...
LAB_140a683bc:
        ...
        uVar14 = param_2 + lVar16;
        if (((longlong)(uVar14 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar14 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a683bc;
        if (uVar5 < 0x10) {
LAB_140a68718:
          uVar9 = 0;
        }
          ...
          iVar6 = (int)uVar7;
          if (uVar5 < iVar6 + 0x10U) goto LAB_140a68718;
          uVar9 = 0;
          iVar11 = uVar5 - (uVar5 - iVar6 & 0xf);
          if (iVar6 != 0) {
            do {
    ...
    iVar6 = (int)lVar16;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar5 < 1) goto LAB_140a686e2;
      if (6 < (int)uVar5) {
        uVar7 = param_2 + lVar16;
        uVar14 = 4 - (longlong)(int)param_5;
...
LAB_140a68726:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a68726;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a6871f:
      ...
      if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a6871f;
...
LAB_140a6699c:
        ...
        if ((param_6 & 0x40) != 0) {
          if (-1 < lVar8) {
            if ((longlong)uVar14 < lVar21) goto LAB_140a66f47;
            bVar22 = -1 < lVar8;
...
LAB_140a66fc9:
            ...
            else if (-1 < lVar8) goto LAB_140a66fc9;
          }
LAB_140a66a07:
          if (4 < lVar21) goto LAB_140a66b12;
          goto LAB_140a66a11;
        }
        if (-1 < (int)(param_5 - 1)) {
          uVar7 = 0;
        ...
        if (lVar21 < 5) goto LAB_140a66d6d;
      }
      else {
        uVar10 = (uint)uVar7;
        if (uVar10 < 7) {
LAB_140a665c0:
          ...
          if (((longlong)(uVar9 - (longlong)param_1) < (longlong)uVar7) &&
             ((longlong)-(uVar9 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a665c0;
          if (uVar10 < 0x10) {
LAB_140a66f96:
            uVar20 = 0;
          }
            ...
            iVar6 = (int)uVar7;
            if (uVar10 < iVar6 + 0x10U) goto LAB_140a66f96;
            uVar20 = 0;
        ...
        if (lVar21 < 5) goto LAB_140a6699c;
        if ((param_6 & 0x40) == 0) {
          if (-1 < (int)(param_5 - 1)) {
            uVar7 = 0;
            iVar6 = 1;
...
LAB_140a66f9d:
              ...
              if ((longlong)uVar7 < (longlong)(uVar9 + 0x10)) goto LAB_140a66f9d;
              uVar20 = 0;
...
LAB_140a66d6d:
          uVar5 = -param_5 + 4;
          if ((int)uVar5 < 1) goto LAB_140a66f0c;
          iVar6 = (int)lVar17;
          if (6 < (int)uVar5) {
...
LAB_140a66ff1:
                ...
                if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a66ff1;
                uVar13 = 0;
                uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
                if (uVar9 != 0) {
                  do {
...
LAB_140a66b12:
      ...
      *(undefined1 *)(lVar17 + 3 + param_2) = param_1[-1];
      ...
      if ((int)uVar10 < 1) goto LAB_140a66f0c;
      if (6 < (int)uVar10) {
        uVar7 = param_2 + lVar16;
...
LAB_140a66fea:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a66fea;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a66471:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a66471;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar14 & 0xf));
            if (uVar14 != 0) {
              do {
...
LAB_140a66478:
          ...
          iVar6 = (int)uVar14;
          if (param_3 < iVar6 + 0x10U) goto LAB_140a66478;
          uVar9 = 0;
      ...
      uVar4 = uVar5;
      lVar16 = (longlong)(int)uVar4;
      if (lVar21 < 5) goto LAB_140a662a7;
      uVar4 = uVar4 + 4;
      *(undefined1 *)(lVar16 + param_2) = param_1[lVar21 + -4];
      uVar5 = 4 - param_5;
      *(undefined1 *)(lVar16 + 1 + param_2) = param_1[lVar21 + -3];
...
LAB_140a6647f:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a6647f;
          uVar13 = 0;
          uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
          if (uVar9 != 0) {
            do {
...
LAB_140a67fc4:
              ...
              if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a67fc4;
              uVar20 = 0;
              lVar8 = lVar19 - lVar17;
      ...
      if ((int)(param_5 - 1) < 0) goto LAB_140a678f0;
      if (6 < (int)param_5) {
...
LAB_140a67fcb:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a67fcb;
            uVar20 = 0;
            uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
            if (uVar14 != 0) {
              do {
      ...
      if (iVar6 - 1U < param_5) goto LAB_140a678d3;
    }
  }
  else {
    if (param_3 < 7) {
...
LAB_140a67faf:
        ...
        iVar6 = (int)uVar14;
        if (param_3 < iVar6 + 0x10U) goto LAB_140a67faf;
        uVar9 = 0;
        iVar11 = param_3 - (param_3 - iVar6 & 0xf);
        if (iVar6 != 0) {
          do {
    ...
    lVar16 = (longlong)(int)uVar5;
    if (lVar21 < 5) goto LAB_140a67584;
    if ((param_6 & 0x40) == 0) {
      if ((int)(param_5 - 1) < 0) goto LAB_140a678f0;
      if (6 < (int)param_5) {
        lVar8 = (longlong)(int)param_5;
...
LAB_140a67fb6:
            ...
            if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a67fb6;
            uVar20 = 0;
            lVar17 = lVar21 - lVar8;
            uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
            if (uVar14 != 0) {
...
LAB_140a67fbd:
          ...
          if ((longlong)uVar7 < (longlong)(uVar14 + 0x10)) goto LAB_140a67fbd;
          uVar20 = 0;
          uVar9 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar14 & 0xfU));
          if (uVar14 != 0) {
            do {
    ...
    if (param_5 <= iVar6 - 1U) goto LAB_140a678f0;
LAB_140a678d3:
    *(undefined1 *)(((longlong)(int)param_5 + param_2) - (longlong)iVar6) =
...
LAB_140a678f0:
  ...
  if (lVar21 < 5) {
    ...
    uVar4 = iVar11 + 4;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar4 < 1) goto LAB_140a67f87;
      if (6 < (int)uVar4) {
        uVar7 = param_2 + lVar16;
        puVar2 = param_1 + lVar21;
        uVar14 = 4 - (longlong)(int)param_5;
...
LAB_140a67fe8:
            ...
            if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a67fe8;
            uVar13 = 0;
            uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
            if (uVar9 != 0) {
              do {
...
LAB_140a67fe0:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a67fe0;
  ...
  *(undefined1 *)(lVar16 + 3 + param_2) = puVar2[-1];
  ...
  if ((param_6 & 0x80) != 0) {
    lVar16 = (longlong)(int)uVar4;
    if ((int)uVar10 < 1) goto LAB_140a67f87;
    if (6 < (int)uVar10) {
      uVar7 = param_2 + lVar16;
      uVar14 = 4 - (longlong)(int)param_5;
      if (((longlong)uVar14 <= (longlong)(uVar7 - (longlong)puVar2)) ||
...
LAB_140a67fd9:
          ...
          if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a67fd9;
          uVar13 = 0;
          uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
          if (uVar9 != 0) {
            do {
...
LAB_140a67fd2:
        ...
        if ((longlong)uVar14 < (longlong)(uVar9 + 0x10)) goto LAB_140a67fd2;
        uVar13 = 0;
        uVar20 = (ulonglong)(int)((int)uVar14 - ((int)uVar14 - (int)uVar9 & 0xfU));
        if (uVar9 != 0) {
          do {
