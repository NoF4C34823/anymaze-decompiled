...
void FUN_1406a0fc0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar22 = param_4 & 0xf;
      if (uVar22 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406a1426;
...
LAB_1406a13a9:
  ...
  if (7 < (longlong)param_5) {
    uVar22 = param_4 & 0xf;
    if (uVar22 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406a141e;
      uVar22 = 0x10 - uVar22 >> 2;
    }
