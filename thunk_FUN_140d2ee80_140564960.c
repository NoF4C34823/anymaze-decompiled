...
void thunk_FUN_140d2ee80(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [32],
...

{
  ...
  if (0 < (longlong)(param_4 & 0xffffffffffffffc0)) {
    do {
      ...
      if (0 < param_5) {
        do {
          lVar6 = lVar6 + 1;
          auVar15 = vpminsw_avx2(auVar15,*pauVar5);
          auVar14 = vpminsw_avx2(auVar14,pauVar5[1]);
          auVar12 = vpminsw_avx2(auVar12,pauVar5[2]);
          auVar10 = vpminsw_avx2(auVar11._0_32_,pauVar5[3]);
  ...
  auVar15 = _DAT_1430922e0;
  auVar13 = _DAT_1430922e0;
  for (; _DAT_1430922e0 = auVar13, lVar4 < (longlong)(param_4 & 0xffffffffffffffe0);
      lVar4 = lVar4 + 0x20) {
    lVar6 = 0;
    pauVar5 = param_1;
    auVar13 = auVar15;
    ...
    if (0 < param_5) {
      do {
        lVar6 = lVar6 + 1;
        auVar13 = vpminsw_avx2(auVar13,*pauVar5);
        auVar14 = vpminsw_avx2(auVar14,pauVar5[1]);
        pauVar5 = (undefined1 (*) [32])(*pauVar5 + param_2 * 2);
      } while (lVar6 < param_5);
    }
  ...
  for (; lVar4 < (longlong)(param_4 & 0xfffffffffffffff0); lVar4 = lVar4 + 0x10) {
    ...
    if (0 < param_5) {
      do {
        lVar7 = lVar7 + 1;
        auVar15 = vpminsw_avx2(auVar15,*(undefined1 (*) [32])(*param_1 + lVar6 * 2));
        lVar6 = lVar6 + param_2;
      } while (lVar7 < param_5);
    }
    param_1 = param_1 + 1;
    _DAT_143092300 = auVar9;
    *param_3 = auVar15;
    param_3 = param_3 + 1;
    auVar9 = _DAT_143092300;
  }
  ...
  for (; lVar4 < (longlong)(param_4 & 0xfffffffffffffff8); lVar4 = lVar4 + 8) {
    ...
    if (0 < param_5) {
      do {
        lVar7 = lVar7 + 1;
        auVar8 = vpminsw_avx(auVar8,*(undefined1 (*) [16])(*param_1 + lVar6 * 2));
        lVar6 = lVar6 + param_2;
      } while (lVar7 < param_5);
    }
    param_1 = (undefined1 (*) [32])(*param_1 + 0x10);
    _DAT_143092300 = auVar3;
    *(undefined1 (*) [16])*param_3 = auVar8;
    param_3 = (undefined1 (*) [32])(*param_3 + 0x10);
    auVar3 = _DAT_143092300;
  }
  auVar9 = auVar3;
  while (_DAT_143092300 = auVar9, lVar4 < (longlong)(param_4 & 0xfffffffffffffffc)) {
    lVar7 = 0;
    lVar6 = 0;
    auVar9 = auVar3;
    if (0 < param_5) {
      do {
        ...
        auVar8._8_8_ = 0;
        auVar8._0_8_ = *puVar1;
        auVar9 = vpminsw_avx(auVar9,auVar8);
      } while (lVar7 < param_5);
    }
    lVar4 = lVar4 + 4;
  ...
  for (; lVar4 < (longlong)(param_4 & 0xfffffffffffffffe); lVar4 = lVar4 + 2) {
    ...
    if (0 < param_5) {
      do {
        ...
        lVar7 = lVar7 + 1;
        lVar6 = lVar6 + param_2;
        auVar3 = vpminsw_avx(auVar11._0_16_,auVar3);
  ...
  while (lVar4 < (longlong)param_4) {
    ...
    if (0 < param_5) {
      do {
        ...
        lVar6 = lVar6 + param_2;
        auVar9 = vpminsw_avx(auVar9,auVar3);
      } while (lVar7 < param_5);
    }
    lVar4 = lVar4 + 1;
