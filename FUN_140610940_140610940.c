...
void FUN_140610940(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_14061120e:
      uVar97 = 0;
      if (param_3 == 0) goto LAB_140610b46;
      uVar95 = 0;
      uVar99 = param_3;
    }
    else {
      uVar99 = param_2 & 0xf;
      if (uVar99 != 0) {
        if ((param_2 & 3) != 0) goto LAB_14061120e;
        uVar99 = 0x10 - uVar99 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_14061120e;
      ...
      if (param_3 < uVar97 + 1) goto LAB_140610b46;
...
LAB_1406111e8:
          uVar97 = 0;
          if (param_3 == 0) goto LAB_140611031;
          uVar95 = 0;
          uVar99 = param_3;
        }
        else {
          uVar99 = param_2 & 0xf;
          if (uVar99 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1406111e8;
            uVar99 = 0x10 - uVar99 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_1406111e8;
          ...
          if (param_3 < uVar97 + 1) goto LAB_140611031;
          uVar99 = param_3 - uVar97;
          if ((longlong)uVar99 < 4) {
            uVar95 = 0;
          }
...
LAB_1406111d5:
    ...
    uVar99 = param_2 & 0xf;
    if (uVar99 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1406111d5;
      uVar99 = 0x10 - uVar99 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar99 + 8)) goto LAB_1406111d5;
    uVar95 = 0;
    uVar97 = param_3 - (param_3 - uVar99 & 7);
    if (uVar99 != 0) {
      do {
