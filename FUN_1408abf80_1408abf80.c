...
void FUN_1408abf80(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar19 = param_4 & 0x1f;
      if (uVar19 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1408ac5f2;
...
LAB_1408ac5f2:
  ...
  if (7 < (longlong)param_5) {
    if ((longlong)param_5 < 0x3fd) {
      ...
      uVar19 = param_4 & 0x1f;
      if (uVar19 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1408ac2d2;
        uVar19 = 0x20 - uVar19 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar19 + 8)) {
        uVar18 = 0;
