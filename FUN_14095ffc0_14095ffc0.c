...
/* WARNING: Removing unreachable block (ram,0x0001409614be) */

void FUN_14095ffc0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_178 = param_10;
    (*(code *)(&PTR_FUN_14308da00)[lVar20])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar23 != 6) {
            if (uVar23 == 1) {
              ...
              if ((longlong)psVar13 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140961ac1;
                while (uVar14 == 0) {
                  for (lVar18 = ((longlong)psVar13 - 1U) * 2 - lVar18; lVar18 < 0; lVar18 = -lVar18)
                  {
LAB_140961ac1:
                    if ((uint)uStack_168 != 0) goto LAB_140961951;
                  }
...
LAB_140961951:
    ...
    iStack_178 = param_10;
    (*(code *)(&PTR_FUN_14308da00)[lVar20])(param_11 + lVar27 * 3,param_4,psVar13,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar19 = lVar15 * 3;
...
LAB_140961a35:
              ...
              if ((longlong)uVar12 < 0x2b9) {
                ...
                if (uVar9 != 0) {
                  if (((ulonglong)psStack_a0 & 1) != 0) goto LAB_140961a35;
                  uVar9 = 0x20 - uVar9 >> 1;
                }
                if ((longlong)uVar12 < (longlong)(uVar9 + 0x10)) goto LAB_140961a35;
                uVar17 = 0;
...
LAB_140960e26:
      pcStack_160 = (code *)(&PTR_FUN_14308da00)[lVar20];
      iStack_178 = param_10;
      uStack_90 = param_7;
      lStack_88 = param_4;
