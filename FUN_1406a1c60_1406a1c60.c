...
void FUN_1406a1c60(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar45 = param_4 & 0xf;
      if (uVar45 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1406a2520;
...
LAB_1406a2520:
  ...
  if (3 < (longlong)param_5) {
    uVar45 = param_4 & 0xf;
    if (uVar45 != 0) {
      if ((param_4 & 3) != 0) goto LAB_1406a20c0;
      uVar45 = 0x10 - uVar45 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar45 + 4)) {
      uVar43 = 0;
