...
void FUN_1408a74c0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (0xf < (longlong)uVar19) {
    if ((longlong)uVar19 < 0x1d) {
      FUN_1408a75ba(uVar19 & 0xfffffffffffffff0,uVar19,param_2,0);
      return;
    }
    uVar20 = param_2 & 0x1f;
    if (uVar20 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408a7849;
    ...
    if ((longlong)(uVar20 + 0x10) <= (longlong)uVar19) {
      ...
      if (uVar20 != 0) {
        do {
          auVar21._0_4_ = (float)*(ushort *)(param_1 + uVar17 * 2);
          ...
          auVar23._12_4_ = 0;
          auVar23 = vfmadd231ss_fma(ZEXT416((uint)(fVar3 * (float)((uint)*(ushort *)
                                                                          (param_1 + -6 + uVar17 * 2
                                                                          ) +
                                                                  (uint)*(ushort *)
                                                                         (param_1 + 6 + uVar17 * 2))
      ...
      do {
        auVar22._0_4_ = (float)*(ushort *)(param_1 + uVar20 * 2);
        auVar22._4_8_ = SUB128(ZEXT812(0),4);
        auVar22._12_4_ = 0;
        auVar25._0_4_ =
             (float)((uint)*(ushort *)(param_1 + -0xc + uVar20 * 2) +
