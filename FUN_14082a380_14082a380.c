...
void FUN_14082a380(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    uVar31 = param_2 & 0x1f;
    if (uVar31 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14082a572;
...
LAB_14082a57b:
  FUN_14082a533(fVar7,fVar6,param_3,0);
  return;
}
