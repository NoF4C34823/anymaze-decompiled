...
void FUN_1401068e0(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4,int param_5)

{
  ...
  if (0 < (longlong)uVar17) {
    ...
    if ((longlong)uVar17 < 0x10) {
      ...
      if ((longlong)uVar17 < 0x86) {
        ...
        if (uVar27 != 0) {
          uVar32 = 0;
          lVar28 = 0;
          auVar57 = vmovdqu32_avx512f(_DAT_143087000);
          auVar58 = vmovdqu32_avx512f(_DAT_143087040);
          ...
          if (uVar17 == uVar27) goto LAB_140106b08;
        }
      }
      if ((longlong)(uVar27 + 0x10) <= (longlong)uVar23) {
        auVar63 = vbroadcastss_avx512f(auVar69);
        do {
          auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar25 * -6 + param_1 + uVar27 * 2));
          auVar58 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(param_1 + lVar25 * 6 + uVar27 * 2));
    ...
    if (uVar23 + 1 <= uVar17) {
      ...
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_143087000);
      bVar19 = (byte)uVar16;
      uVar16 = vpcmpgtq_avx512f(auVar63,_DAT_143087040);
      bVar18 = (byte)uVar16;
      uVar37 = CONCAT11(bVar18,bVar19);
          ...
          if ((longlong)uVar17 < 0x10) {
            ...
            if ((longlong)uVar17 < 0x53) {
              ...
              if (uVar22 != 0) {
                ...
                if (uVar17 == uVar22) goto LAB_140106ea9;
              }
            }
            if ((longlong)(uVar22 + 0x10) <= (longlong)uVar27) {
              ...
              do {
                auVar61 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar33 + 6 + lVar24));
                auVar62 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar34 + -6 + lVar28));
                auVar64 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar34 + -0xc + lVar28));
                auVar67 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar33 + 0xc + lVar24));
                auVar61 = vpaddd_avx512f(auVar61,auVar62);
        ...
        if ((longlong)uVar17 < 0x10) {
          ...
          if ((longlong)uVar17 < 0x47) {
            ...
            if (uVar27 != 0) {
              ...
              if (uVar17 == uVar27) goto LAB_140107110;
            }
          }
          if ((longlong)(uVar27 + 0x10) <= (longlong)uVar23) {
            auVar63 = vbroadcastss_avx512f(auVar69);
            do {
              auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar20 + uVar27 * 2));
  ...
  if (0 < (longlong)uVar17) {
    ...
    if ((longlong)uVar17 < 0x10) {
      ...
      if ((longlong)(uVar27 + 0x10) <= (longlong)uVar23) {
        auVar63 = vbroadcastss_avx512f(auVar69);
        do {
          auVar57 = vpmovsxwd_avx512f(*(undefined1 (*) [32])(lVar20 + 6 + uVar27 * 2));
          auVar57 = vcvtdq2ps_avx512f(auVar57);
