...
/* WARNING: Removing unreachable block (ram,0x00014098e090) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_14098d1a0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
    iStack_218 = param_10;
    (*(code *)(&PTR_LAB_14308df60)[lVar56])(param_1,param_4,*param_5,param_9);
          ...
          if (uVar51 != 6) {
            if (uVar51 == 1) {
              ...
              if (lVar55 < 2) {
                ...
                if (lVar59 < 0) goto LAB_14098e500;
                while (uVar41 == 0) {
                  for (lVar46 = (lVar55 + -1) * 2 - lVar46; lVar46 < 0; lVar46 = -lVar46) {
LAB_14098e500:
                    if (uVar58 != 0) goto LAB_14098e38c;
                  }
          ...
          if (uVar66 != 0) goto LAB_14098e38c;
          uVar66 = *puStack_80;
          uVar68 = puStack_80[1];
          uVar69 = puStack_80[2];
        }
...
LAB_14098e38c:
    ...
    iStack_218 = param_10;
    (*(code *)(&PTR_LAB_14308df60)[lVar56])(param_11 + lVar50 * 0xc,param_4,lVar55,param_9);
  }
  else {
    if ((param_7 & 0x40) == 0) {
      lVar46 = lVar50 * 3;
          ...
          if ((lVar43 <= (longlong)(uStack_a8 - param_1)) ||
            ...
            if ((longlong)uVar42 < 0x10) {
              ...
              if ((longlong)uVar42 < 0x3b) {
                ...
                if (uVar53 != 0) {
                  uVar45 = 0;
                  auVar62 = vmovdqu32_avx512f(_DAT_14308dc80);
                  auVar63 = vmovdqu32_avx512f(_DAT_14308dcc0);
                  ...
                  if (uVar42 == uVar53) goto LAB_14098d4bc;
                }
              }
            ...
            if (uVar47 + 1 <= uVar42) {
              ...
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308dc80);
              bVar22 = (byte)uVar20;
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308dcc0);
              bVar21 = (byte)uVar20;
              uVar61 = CONCAT11(bVar21,bVar22);
        ...
        if (0 < lVar46) {
          ...
          if (((longlong)uVar42 < 7) ||
            ...
            if ((longlong)uVar42 < 0x10) {
              ...
              auVar64 = vmovdqu32_avx512f(_DAT_14308de40);
              lVar46 = 0;
              do {
            ...
            if (uVar47 + 1 <= uVar42) {
              ...
              uVar20 = vpcmpgtq_avx512f(auVar65,_DAT_14308dc80);
              uVar18 = vpcmpgtq_avx512f(auVar65,_DAT_14308dcc0);
              auVar65 = vmovdqu32_avx512f(_DAT_14308de40);
...
LAB_14098db84:
      uStack_c0 = (code *)(&PTR_LAB_14308df60)[lVar56];
      iStack_218 = param_10;
      lStack_c8 = lVar55;
      uStack_a0 = param_7;
