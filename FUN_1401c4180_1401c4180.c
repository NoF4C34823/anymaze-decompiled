...
void FUN_1401c4180(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1401c48db:
      uVar37 = 0;
      if (param_5 == 0) goto LAB_1401c467e;
      uVar36 = 0;
      uVar50 = param_5;
    }
    else {
      ...
      uVar50 = uVar49 & 0xf;
      if (uVar50 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_1401c48db;
        uVar50 = 0x10 - uVar50 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar50 + 8)) goto LAB_1401c48db;
      ...
      if (param_5 < uVar37 + 1) goto LAB_1401c467e;
...
LAB_1401c467e:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar49 = uVar50 & 0xf;
      if (uVar49 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1401c48f8;
...
LAB_1401c4881:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar49 = uVar50 & 0xf;
    if (uVar49 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_1401c48f1;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
      uVar36 = 0;
