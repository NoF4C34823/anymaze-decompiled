...
void FUN_140781d80(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x000140782d71. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c180)[lVar15])(param_1,param_4,*param_5,param_9);
    return;
  }
          ...
          if (uVar20 != 6) {
            if (uVar20 == 1) {
              ...
              if (lVar10 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140782d00;
                while (uStack_80 == 0) {
                  for (lVar7 = (lVar10 + -1) * 2 - lVar7; lVar7 < 0; lVar7 = -lVar7) {
LAB_140782d00:
                    if (uVar8 != 0) goto LAB_140782bee;
                  }
...
LAB_140782bee:
        ...
        *(undefined1 *)(lVar23 + 2 + param_11) = uVar13;
        lVar23 = lVar23 + 3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000140782c91. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c180)[lVar15])(param_11 + lVar12 * 3,param_4,lVar10,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    lVar23 = lVar12 * 3;
...
LAB_140782c94:
            ...
            if ((longlong)uVar17 < (longlong)(uVar4 + 0x10)) goto LAB_140782c94;
...
LAB_140781ff1:
    ...
    UNRECOVERED_JUMPTABLE_00 = (code *)(&PTR_FUN_14308c180)[lVar15];
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140782ccd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_140782abd:
                    /* WARNING: Could not recover jumptable at 0x000140782aeb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
