...
void FUN_14037f400(longlong param_1,longlong param_2,ulonglong param_3,ulonglong param_4,int param_5
                  )
    ...
    do {
      ...
      if (0 < (longlong)param_4) {
        ...
        if (param_4 >> 3 != 0) {
          ...
          do {
            if (sVar14 < *(short *)(lVar13 + lVar8 + param_1)) {
              sVar14 = *(short *)(lVar13 + lVar8 + param_1);
            }
            if (sVar14 < *(short *)(lVar13 + lVar6)) {
              sVar14 = *(short *)(lVar13 + lVar6);
            }
            if (sVar14 < *(short *)(lVar13 + lVar5)) {
              sVar14 = *(short *)(lVar13 + lVar5);
            }
            if (sVar14 < *(short *)(lVar13 + lVar4)) {
              sVar14 = *(short *)(lVar13 + lVar4);
            }
            if (sVar14 < *(short *)(lVar13 + lVar9)) {
              sVar14 = *(short *)(lVar13 + lVar9);
            }
            if (sVar14 < *(short *)(lVar13 + lVar3)) {
              sVar14 = *(short *)(lVar13 + lVar3);
            }
            if (sVar14 < *(short *)(lVar13 + lVar2)) {
              sVar14 = *(short *)(lVar13 + lVar2);
            }
            uVar12 = uVar12 + 1;
            if (sVar14 < *(short *)(lVar13 + lVar1)) {
