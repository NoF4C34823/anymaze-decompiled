...
void FUN_140055900(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001400565d7. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086880 + lVar7 * 8))(param_1,param_4,*param_5);
    return;
  }
  if (uVar13 == 6) {
    uVar21 = *param_8;
          ...
          if (uVar13 != 6) {
            if (uVar13 == 1) {
              ...
              if (lVar11 < 2) {
                ...
                if (lVar19 < 0) goto LAB_140056560;
                while (uVar9 == 0) {
                  for (lVar8 = (lVar11 + -1) * 2 - lVar8; lVar8 < 0; lVar8 = -lVar8) {
LAB_140056560:
                    if ((uint)uStack_88 != 0) goto LAB_140056430;
                  }
...
LAB_140056430:
        ...
        *(undefined4 *)(param_11 + lVar16 * 4) = uVar20;
        lVar16 = lVar16 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001400564a7. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086880 + lVar7 * 8))(param_11 + uVar14 * 4,param_4,lVar11,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    ...
    if (0 < (longlong)uVar18) {
      if (6 < (longlong)uVar18) {
        ...
        if ((lVar16 <= (longlong)(uVar12 - param_1)) || (lVar16 <= (longlong)-(uVar12 - param_1))) {
          ...
          if (uVar15 == 0) {
LAB_140055a03:
            if ((longlong)uVar18 < (longlong)(uVar15 + 4)) goto LAB_1400564aa;
...
LAB_140055b64:
    if (uVar13 == 1) {
      if ((longlong)uVar14 < 1) goto LAB_140055e0e;
...
LAB_14005650b:
        ...
        uVar15 = param_11 & 0xf;
        if (uVar15 != 0) {
          if ((param_11 & 3) != 0) goto LAB_14005650b;
          uVar15 = 0x10 - uVar15 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar15 + 8)) goto LAB_14005650b;
...
LAB_1400564b8:
        ...
        uVar15 = param_11 & 0xf;
        if (uVar15 != 0) {
          if ((param_11 & 3) != 0) goto LAB_1400564b8;
          uVar15 = 0x10 - uVar15 >> 2;
        }
        if ((longlong)uVar14 < (longlong)(uVar15 + 8)) goto LAB_1400564b8;
        uStack_88 = uVar14 - (uVar14 - uVar15 & 7);
        uVar10 = 0;
        if (uVar15 != 0) {
          do {
...
LAB_140055e0e:
    UNRECOVERED_JUMPTABLE_00 = *(code **)(&UNK_143086880 + lVar7 * 8);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x000140056509. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (0 < (longlong)uVar18) {
    if (6 < (longlong)uVar18) {
      ...
      if ((lVar7 <= (longlong)(param_11 - lVar11)) || (lVar7 <= (longlong)-(param_11 - lVar11))) {
        ...
        if (uVar12 == 0) {
LAB_140055f11:
          if ((longlong)uVar18 < (longlong)(uVar12 + 4)) goto LAB_1400564c6;
          uVar10 = 0;
...
LAB_14005603e:
  if (uVar13 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_1400562f6;
...
LAB_1400564d6:
          ...
          uVar12 = uVar18 & 0xf;
          if (uVar12 != 0) {
            if ((uVar18 & 3) != 0) goto LAB_1400564d6;
            uVar12 = 0x10 - uVar12 >> 2;
          }
          if ((longlong)uVar14 < (longlong)(uVar12 + 8)) goto LAB_1400564d6;
          uVar15 = 0;
  ...
  if ((uVar13 != 6) || ((longlong)uVar14 < 1)) goto LAB_1400562f6;
  if ((longlong)uVar14 < 8) {
LAB_1400564ce:
    uVar12 = 0;
  }
    ...
    uVar18 = lVar7 - 4U & 0xf;
    if (uVar18 != 0) {
      if ((lVar7 - 4U & 3) != 0) goto LAB_1400564ce;
      uVar18 = 0x10 - uVar18 >> 2;
    }
    if ((longlong)uVar14 < (longlong)(uVar18 + 8)) goto LAB_1400564ce;
    uVar15 = 0;
...
LAB_1400562f6:
                    /* WARNING: Could not recover jumptable at 0x000140056325. Too many branches */
                    /* WARNING: Treating indirect jump as call */
