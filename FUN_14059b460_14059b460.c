...
void FUN_14059b460(undefined1 (*param_1) [64],undefined1 (*param_2) [64],ulonglong param_3,
...

{
  ...
  if (param_4 == 3) {
    if (0 < (longlong)uVar34) {
      do {
        lVar38 = lVar38 + 0x40;
        auVar45 = vmaxps_avx512f(*param_1,*(undefined1 (*) [64])(*param_1 + lVar39 * 4));
        auVar44 = vmaxps_avx512f(param_1[1],*(undefined1 (*) [64])(param_1[1] + lVar39 * 4));
        auVar43 = vmaxps_avx512f(param_1[2],*(undefined1 (*) [64])(param_1[2] + lVar39 * 4));
        auVar42 = vmaxps_avx512f(param_1[3],*(undefined1 (*) [64])(param_1[3] + lVar39 * 4));
        auVar45 = vmaxps_avx512f(auVar45,*(undefined1 (*) [64])(*param_1 + lVar39 * 8));
        auVar44 = vmaxps_avx512f(auVar44,*(undefined1 (*) [64])(param_1[1] + lVar39 * 8));
        auVar43 = vmaxps_avx512f(auVar43,*(undefined1 (*) [64])(param_1[2] + lVar39 * 8));
        auVar42 = vmaxps_avx512f(auVar42,*(undefined1 (*) [64])(param_1[3] + lVar39 * 8));
        *param_2 = auVar45;
        param_2[1] = auVar44;
        param_2[2] = auVar43;
        param_2[3] = auVar42;
    ...
    auVar45 = _DAT_14308b0c0;
    while (_DAT_14308b0c0 = auVar45, lVar38 < (longlong)(param_3 & 0xffffffffffffffe0)) {
      lVar38 = lVar38 + 0x20;
      auVar45 = vmaxps_avx512f(*param_1,*(undefined1 (*) [64])(*param_1 + lVar39 * 4));
      auVar44 = vmaxps_avx512f(param_1[1],*(undefined1 (*) [64])(param_1[1] + lVar39 * 4));
      auVar45 = vmaxps_avx512f(auVar45,*(undefined1 (*) [64])(*param_1 + lVar39 * 8));
    ...
    if (lVar38 < (longlong)(param_3 & 0xfffffffffffffff0)) {
      ...
      lVar40 = 0;
      do {
        auVar44 = vmaxps_avx512f(auVar45,*(undefined1 (*) [64])(*param_1 + lVar40));
        lVar37 = lVar37 + 1;
        auVar44 = vmaxps_avx512f(auVar44,*(undefined1 (*) [64])(*param_1 + lVar40 + lVar39 * 4));
        auVar44 = vmaxps_avx512f(auVar44,*(undefined1 (*) [64])(*param_1 + lVar40 + lVar39 * 8));
      ...
      do {
        ...
        if (0 < param_4) {
          do {
            ...
            auVar43 = vmaxps_avx512f(auVar43,pauVar36[2]);
            auVar44 = vmaxps_avx512f(auVar44,pauVar36[3]);
    ...
    for (; lVar38 < (longlong)(param_3 & 0xffffffffffffffe0); lVar38 = lVar38 + 0x20) {
      ...
      if (0 < param_4) {
        do {
          lVar35 = lVar35 + 1;
          auVar42 = vmaxps_avx512f(auVar42,*pauVar36);
          auVar43 = vmaxps_avx512f(auVar43,pauVar36[1]);
          pauVar36 = (undefined1 (*) [64])(*pauVar36 + lVar39 * 4);
        } while (lVar35 < param_4);
      }
      param_1 = param_1 + 2;
      _DAT_14308b0c0 = auVar45;
      *param_2 = auVar42;
      param_2[1] = auVar43;
      param_2 = param_2 + 2;
      auVar45 = _DAT_14308b0c0;
    ...
    auVar44 = auVar45;
    for (; _DAT_14308b0c0 = auVar44, lVar38 < (longlong)(param_3 & 0xfffffffffffffff0);
        lVar38 = lVar38 + 0x10) {
      lVar35 = 0;
      lVar37 = 0;
      auVar44 = auVar45;
      if (0 < param_4) {
        do {
          lVar35 = lVar35 + 1;
          auVar44 = vmaxps_avx512f(auVar44,*(undefined1 (*) [64])(*param_1 + lVar37 * 4));
    ...
    if (param_4 < 1) goto LAB_14059b67d;
  }
  uVar32 = (ushort)uVar33;
  lVar35 = 0;
  lVar38 = 0;
  ...
  do {
    ...
    auVar44 = vmaxps_avx512f(auVar44,auVar45);
  } while (lVar35 < param_4);
LAB_14059b67d:
