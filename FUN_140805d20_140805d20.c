...
void FUN_140805d20(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_1408067e9:
      uVar42 = 0;
      if (param_3 == 0) goto LAB_140805f48;
      uVar39 = 0;
      uVar40 = param_3;
    }
    else {
      uVar40 = param_2 & 0x1f;
      if (uVar40 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1408067e9;
        uVar40 = 0x20 - uVar40 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_1408067e9;
      uVar39 = 0;
      ...
      if (param_3 < uVar42 + 1) goto LAB_140805f48;
...
LAB_1408067ad:
          uVar42 = 0;
          if (param_3 == 0) goto LAB_1408065d1;
          uVar39 = 0;
          uVar40 = param_3;
        }
        else {
          uVar40 = param_2 & 0x1f;
          if (uVar40 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1408067ad;
            uVar40 = 0x20 - uVar40 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_1408067ad;
          ...
          if (param_3 < uVar42 + 1) goto LAB_1408065d1;
          uVar40 = param_3 - uVar42;
          if ((longlong)uVar40 < 4) {
            uVar39 = 0;
          }
...
LAB_14080679a:
    ...
    uVar40 = param_2 & 0x1f;
    if (uVar40 != 0) {
      if ((param_2 & 3) != 0) goto LAB_14080679a;
      uVar40 = 0x20 - uVar40 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_14080679a;
    uVar39 = 0;
    uVar42 = param_3 - (param_3 - uVar40 & 0xf);
    if (uVar40 != 0) {
      do {
