...
void FUN_14078c160(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x00014078d1d2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(puVar23,param_4,*param_5);
    return;
  }
  if (uVar18 == 6) {
    uVar11 = (uint)*param_8;
          ...
          if (uVar18 != 6) {
            if (uVar18 == 1) {
              ...
              if (lVar16 < 2) {
                ...
                if (lVar15 < 0) goto LAB_14078d160;
                while (uVar11 == 0) {
                  for (lVar22 = (lVar16 + -1) * 2 - lVar22; lVar22 < 0; lVar22 = -lVar22) {
LAB_14078d160:
                    if (uVar12 != 0) goto LAB_14078d064;
                  }
...
LAB_14078d064:
        ...
        *(ushort *)(param_11 + lVar13 * 2) = uVar21;
        lVar13 = lVar13 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00014078d0c8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(param_11 + uVar14 * 2,param_4,lVar16,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar14 == 1) {
...
LAB_14078d0dc:
              ...
              uVar17 = uVar10 & 0xf;
              if (uVar17 != 0) {
                if ((uVar10 & 1) != 0) goto LAB_14078d0dc;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar19 < (longlong)(uVar17 + 8)) goto LAB_14078d0dc;
...
LAB_14078c5ff:
      if (uVar18 == 1) {
        if ((longlong)uVar14 < 1) goto LAB_14078c80d;
...
LAB_14078d13b:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14078d13b;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_14078d13b;
          uVar8 = 0;
...
LAB_14078d0e3:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14078d0e3;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar17 + 8)) goto LAB_14078d0e3;
          uVar8 = 0;
          uVar20 = uVar14 - (uVar14 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_14078c80d:
      in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(uVar10,param_4,uVar14,param_9,param_10)
      ;
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00014078d138. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(puVar23,param_4,lVar16);
    return;
  }
  if ((longlong)uVar14 < lVar16) {
    lVar16 = lVar16 - uVar14;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(puVar23,param_4,lVar16,param_9,param_10);
...
LAB_14078d0ea:
          ...
          uVar10 = param_11 & 0xf;
          if (uVar10 != 0) {
            if ((param_11 & 1) != 0) goto LAB_14078d0ea;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar19 < (longlong)(uVar10 + 8)) goto LAB_14078d0ea;
...
LAB_14078cc79:
  if (uVar18 == 1) {
    if ((longlong)uVar14 < 1) goto LAB_14078cf1b;
...
LAB_14078d0f9:
          ...
          uVar10 = uVar19 & 0xf;
          if (uVar10 != 0) {
            if ((uVar19 & 1) != 0) goto LAB_14078d0f9;
            uVar10 = 0x10 - uVar10 >> 1;
          }
          if ((longlong)uVar14 < (longlong)(uVar10 + 8)) goto LAB_14078d0f9;
          uVar17 = 0;
  ...
  if ((uVar18 != 6) || ((longlong)uVar14 < 1)) goto LAB_14078cf1b;
  if ((longlong)uVar14 < 8) {
LAB_14078d0f1:
    uVar10 = 0;
  }
    ...
    if (uVar19 != 0) {
      if ((lVar16 - 2U & 1) != 0) goto LAB_14078d0f1;
      uVar19 = 0x10 - uVar19 >> 1;
    }
    if ((longlong)uVar14 < (longlong)(uVar19 + 8)) goto LAB_14078d0f1;
    uVar17 = 0;
...
LAB_14078cf1b:
                    /* WARNING: Could not recover jumptable at 0x00014078cf54. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c1a0)[lVar7])(param_11 + uVar14 * 2,param_4,uVar14);
  return;
}
