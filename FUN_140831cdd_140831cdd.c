...
void FUN_140831cdd(longlong param_1,float param_2,longlong param_3,ulonglong param_4)
    ...
    if (uVar22 < param_4) {
      ...
      do {
        *(float *)(param_3 + in_RDX * 4 + uVar22 * 4) =
             param_2 * (float)((int)*(short *)(param_1 + -2 + uVar22 * 2) +
                              (int)*(short *)(param_1 + 2 + uVar22 * 2)) +
             in_XMM0_Da * (float)(int)*(short *)(param_1 + uVar22 * 2);
        uVar22 = uVar22 + 1;
