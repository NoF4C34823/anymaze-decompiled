...
void FUN_1408543a0(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4,int param_5)
...
LAB_140854e69:
      uVar42 = 0;
      if (param_3 == 0) goto LAB_1408545c8;
      uVar39 = 0;
      uVar40 = param_3;
    }
    else {
      uVar40 = param_2 & 0x1f;
      if (uVar40 != 0) {
        if ((param_2 & 3) != 0) goto LAB_140854e69;
        uVar40 = 0x20 - uVar40 >> 2;
      }
      if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_140854e69;
      uVar39 = 0;
      ...
      if (param_3 < uVar42 + 1) goto LAB_1408545c8;
...
LAB_140854e2d:
          uVar42 = 0;
          if (param_3 == 0) goto LAB_140854c51;
          uVar39 = 0;
          uVar40 = param_3;
        }
        else {
          uVar40 = param_2 & 0x1f;
          if (uVar40 != 0) {
            if ((param_2 & 3) != 0) goto LAB_140854e2d;
            uVar40 = 0x20 - uVar40 >> 2;
          }
          if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_140854e2d;
          ...
          if (param_3 < uVar42 + 1) goto LAB_140854c51;
          uVar40 = param_3 - uVar42;
          if ((longlong)uVar40 < 4) {
            uVar39 = 0;
          }
...
LAB_140854e1a:
    ...
    uVar40 = param_2 & 0x1f;
    if (uVar40 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140854e1a;
      uVar40 = 0x20 - uVar40 >> 2;
    }
    if ((longlong)param_3 < (longlong)(uVar40 + 0x10)) goto LAB_140854e1a;
    uVar39 = 0;
    uVar42 = param_3 - (param_3 - uVar40 & 0xf);
    if (uVar40 != 0) {
      do {
