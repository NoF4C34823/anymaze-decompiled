...
void FUN_1403e92e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar18 != 0 && 0 < (longlong)param_6._4_4_) {
      do {
        FUN_1403db020(lVar11,lVar15,uVar17,(longlong)(int)param_6,4);
        lVar19 = lVar19 + 1;
          ...
          do {
            ...
            if (0 < param_6._4_4_) {
              ...
              if (uVar16 != 0) {
                ...
                bVar9 = 0xff;
                do {
                  if (*(byte *)(param_9 + uVar14 + lVar8 * 8) < bVar9) {
              ...
              if (uVar12 <= (ulonglong)(longlong)param_6._4_4_) {
                    /* WARNING: Could not recover jumptable at 0x0001403e976f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_1403e9771 +
                          (byte)(&DAT_143089e90)[(uint)(param_6._4_4_ - (int)uVar12)]))
