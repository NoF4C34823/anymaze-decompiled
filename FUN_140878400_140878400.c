...
void FUN_140878400(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (0xf < (longlong)param_3) {
    uVar31 = param_2 & 0x1f;
    if (uVar31 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408785f2;
...
LAB_1408785fb:
  FUN_1408785b3(fVar7,fVar6,param_3,0);
  return;
}
