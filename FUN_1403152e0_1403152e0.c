...
void FUN_1403152e0(longlong param_1,int param_2,longlong param_3,int param_4,undefined8 param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (lVar19 != 0 && 0 < (longlong)uVar16) {
      do {
        FUN_1402fd0c0(lVar18,lVar11,uVar3,uVar5,3);
        lVar20 = lVar20 + 1;
    ...
    if (0 < param_5._4_4_) {
      do {
        FUN_1402fd0c0(lVar18,lVar11,uVar3,uVar5,3);
        thunk_FUN_142d22130(param_9,uVar7,param_3,uVar3,uVar16);
        lVar19 = lVar19 + 1;
        lVar11 = lVar11 + uVar7 * 4;
