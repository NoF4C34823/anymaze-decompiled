...
void FUN_14023d656(longlong param_1,longlong param_2,longlong param_3,ulonglong param_4)
    ...
    if (0 < (longlong)in_RAX) {
      if ((longlong)in_RAX < 0x40) {
        ...
        if ((longlong)in_RAX < 0x396) {
          ...
          if (uVar21 != 0) {
            uVar22 = 0;
            auVar28 = vmovdqu32_avx512f(_DAT_143088940);
            auVar29 = vmovdqu32_avx512f(_DAT_143088980);
