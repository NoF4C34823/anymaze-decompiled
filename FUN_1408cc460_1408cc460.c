...
void FUN_1408cc460(longlong param_1,uint *param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1408ccd43:
      ...
      if ((longlong)uVar6 < 0x1d) {
        ...
        if (uVar12 != 0) {
          if (((ulonglong)param_2 & 3) != 0) goto LAB_1408ccd43;
          uVar12 = 0x20 - uVar12 >> 2;
        }
        if ((longlong)uVar6 < (longlong)(uVar12 + 0x10)) goto LAB_1408ccd43;
        lVar8 = lVar19 * -0xc + param_1;
...
LAB_1408ccd27:
          ...
          uVar12 = (ulonglong)param_2 & 0x1f;
          if (uVar12 != 0) {
            if (((ulonglong)param_2 & 3) != 0) goto LAB_1408ccd27;
            uVar12 = 0x20 - uVar12 >> 2;
          }
          if ((longlong)uVar6 < (longlong)(uVar12 + 0x10)) goto LAB_1408ccd27;
          uVar14 = uVar6 - (uVar6 - uVar12 & 0xf);
...
LAB_1408ccd0e:
    ...
    if ((longlong)uVar6 < 0xe1) {
      ...
      if (uVar14 != 0) {
        if (((ulonglong)param_2 & 3) != 0) goto LAB_1408ccd0e;
        uVar14 = 0x20 - uVar14 >> 2;
      }
      if ((longlong)uVar6 < (longlong)(uVar14 + 8)) goto LAB_1408ccd0e;
      uVar10 = 0;
