...
void FUN_140326a00(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)uVar6) {
          do {
            ...
            if (0 < (longlong)uVar11) {
              ...
              if ((lVar23 - 1U < uVar11) &&
                 (bVar32 = *(byte *)(lVar23 * 3 + -3 + lVar10 + lVar27 + uVar28), bVar32 < bVar33))
              {
                bVar33 = bVar32;
              }
            }
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        if (0 < (longlong)uVar6) {
          ...
          do {
            ...
            if (0 < (longlong)uVar24) {
              ...
              if ((lVar26 - 1U < uVar24) &&
                 (bVar32 = *(byte *)(lVar26 * 3 + -3 + lVar27 + uVar11), bVar32 < bVar33)) {
                bVar33 = bVar32;
              }
            }
            uVar11 = uVar11 + 1;
        ...
        FUN_140328840(param_9,uVar22,param_3,uVar6,uVar25);
        uVar19 = uVar19 + 1;
        uVar25 = param_6[1];
                    ...
                    if ((longlong)(uStack_60 + 0x10) <= (longlong)uVar11) {
                      ...
                      if (uStack_60 != 0) {
                        do {
                          if ((*(char *)(uVar7 + uVar13) != '\0') &&
                             (bVar32 = *(byte *)(lVar17 + uVar7 * 3 + uVar28), bVar32 < bVar33)) {
                            bVar33 = bVar32;
                          }
                          uVar7 = uVar7 + 1;
                      ...
                      do {
                        ...
                        if ((((((((((((((((auVar30 >> 7 & (undefined1  [16])0x1) !=
                          ...
                          bVar4 = auVar35[0];
                          auVar31[0] = (bVar4 < bVar33) * bVar4 | (bVar4 >= bVar33) * bVar33;
                          bVar33 = auVar35[1];
                          auVar31[1] = (bVar33 < bVar32) * bVar33 | (bVar33 >= bVar32) * bVar32;
                          bVar33 = auVar35[2];
                          auVar31[2] = (bVar33 < bVar36) * bVar33 | (bVar33 >= bVar36) * bVar36;
                          bVar33 = auVar35[3];
                          auVar31[3] = (bVar33 < bVar37) * bVar33 | (bVar33 >= bVar37) * bVar37;
                          bVar33 = auVar35[4];
                          auVar31[4] = (bVar33 < bVar38) * bVar33 | (bVar33 >= bVar38) * bVar38;
                          bVar33 = auVar35[5];
                          auVar31[5] = (bVar33 < bVar39) * bVar33 | (bVar33 >= bVar39) * bVar39;
                          bVar33 = auVar35[6];
                          auVar31[6] = (bVar33 < bVar40) * bVar33 | (bVar33 >= bVar40) * bVar40;
                          bVar33 = auVar35[7];
                          auVar31[7] = (bVar33 < bVar41) * bVar33 | (bVar33 >= bVar41) * bVar41;
                          bVar33 = auVar35[8];
                          auVar31[8] = (bVar33 < bVar42) * bVar33 | (bVar33 >= bVar42) * bVar42;
                          bVar33 = auVar35[9];
                          auVar31[9] = (bVar33 < bVar15) * bVar33 | (bVar33 >= bVar15) * bVar15;
                          bVar33 = auVar35[10];
                          auVar31[10] = (bVar33 < bVar18) * bVar33 | (bVar33 >= bVar18) * bVar18;
                          bVar33 = auVar35[0xb];
                          auVar31[0xb] = (bVar33 < bVar2) * bVar33 | (bVar33 >= bVar2) * bVar2;
                          bVar33 = auVar35[0xc];
                          auVar31[0xc] = (bVar33 < bVar3) * bVar33 | (bVar33 >= bVar3) * bVar3;
                          bVar33 = auVar35[0xd];
                          auVar31[0xd] = (bVar33 < bVar12) * bVar33 | (bVar33 >= bVar12) * bVar12;
                          bVar33 = auVar35[0xe];
                          auVar31[0xe] = (bVar33 < bVar9) * bVar33 | (bVar33 >= bVar9) * bVar9;
                          bVar33 = auVar35[0xf];
                          auVar31[0xf] = (bVar33 < bVar21) * bVar33 | (bVar33 >= bVar21) * bVar21;
                      ...
                      bVar33 = auVar35[8];
                      bVar32 = auVar35[0];
                      bVar32 = (bVar33 < bVar32) * bVar33 | (bVar33 >= bVar32) * bVar32;
                      bVar33 = auVar35[9];
                      bVar36 = auVar35[1];
                      bVar36 = (bVar33 < bVar36) * bVar33 | (bVar33 >= bVar36) * bVar36;
                      bVar33 = auVar35[10];
                      bVar37 = auVar35[2];
                      bVar37 = (bVar33 < bVar37) * bVar33 | (bVar33 >= bVar37) * bVar37;
                      bVar33 = auVar35[0xb];
                      bVar38 = auVar35[3];
                      bVar38 = (bVar33 < bVar38) * bVar33 | (bVar33 >= bVar38) * bVar38;
                      bVar33 = auVar35[0xc];
                      bVar39 = auVar35[4];
                      bVar39 = (bVar33 < bVar39) * bVar33 | (bVar33 >= bVar39) * bVar39;
                      bVar33 = auVar35[0xd];
                      bVar40 = auVar35[5];
                      bVar40 = (bVar33 < bVar40) * bVar33 | (bVar33 >= bVar40) * bVar40;
                      bVar33 = auVar35[0xe];
                      bVar41 = auVar35[6];
                      bVar41 = (bVar33 < bVar41) * bVar33 | (bVar33 >= bVar41) * bVar41;
                      bVar33 = auVar35[0xf];
                      bVar42 = auVar35[7];
                      bVar42 = (bVar33 < bVar42) * bVar33 | (bVar33 >= bVar42) * bVar42;
                      bVar33 = (bVar39 < bVar32) * bVar39 | (bVar39 >= bVar32) * bVar32;
                      bVar32 = (bVar40 < bVar36) * bVar40 | (bVar40 >= bVar36) * bVar36;
                      bVar36 = (bVar41 < bVar37) * bVar41 | (bVar41 >= bVar37) * bVar37;
                      bVar37 = (bVar42 < bVar38) * bVar42 | (bVar42 >= bVar38) * bVar38;
                      bVar33 = (bVar36 < bVar33) * bVar36 | (bVar36 >= bVar33) * bVar33;
                      bVar32 = (bVar37 < bVar32) * bVar37 | (bVar37 >= bVar32) * bVar32;
