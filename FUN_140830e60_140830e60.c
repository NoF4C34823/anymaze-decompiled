...
void FUN_140830e60(longlong param_1,ulonglong param_2,longlong param_3,uint *param_4)

{
  ...
  if (7 < (longlong)uVar16) {
    uVar19 = param_2 & 0x1f;
    if (uVar19 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1408311b5;
    ...
    if ((longlong)(uVar19 + 8) <= (longlong)uVar16) {
      ...
      if (uVar19 != 0) {
        ...
        do {
          auVar30._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -0x12 + uVar17 * 2) +
                      (uint)*(ushort *)(param_1 + 0x12 + uVar17 * 2));
          auVar30._4_12_ = auVar27._4_12_;
          auVar27._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -0xc + uVar17 * 2) +
                      (uint)*(ushort *)(param_1 + 0xc + uVar17 * 2));
          auVar27._4_8_ = SUB128(ZEXT812(0),4);
          auVar27._12_4_ = 0;
          auVar30 = vunpcklps_avx(auVar30,auVar27);
          auVar25._0_4_ =
               (float)((uint)*(ushort *)(param_1 + -6 + uVar17 * 2) +
                      (uint)*(ushort *)(param_1 + 6 + uVar17 * 2));
          auVar25._4_8_ = SUB128(ZEXT812(0),4);
          auVar25._12_4_ = 0;
          auVar27 = ZEXT416((uint)(float)*(ushort *)(param_1 + uVar17 * 2));
      ...
      do {
        ...
        auVar2 = vpmovzxwd_avx(auVar14);
        auVar15._8_8_ = 0;
        auVar15._0_8_ = *(ulonglong *)(param_1 + 8 + uVar19 * 2);
        auVar4 = vpmovzxwd_avx(auVar15);
...
LAB_140831105:
  if (uVar18 < uVar16) {
    ...
    do {
      auVar21._0_4_ =
           (float)((uint)*(ushort *)(param_1 + -0x12 + uVar18 * 2) +
                  (uint)*(ushort *)(param_1 + 0x12 + uVar18 * 2));
      auVar21._4_8_ = SUB128(ZEXT812(0),4);
      auVar21._12_4_ = 0;
      auVar22._0_4_ =
           (float)((uint)*(ushort *)(param_1 + -0xc + uVar18 * 2) +
                  (uint)*(ushort *)(param_1 + 0xc + uVar18 * 2));
      auVar22._4_8_ = SUB128(ZEXT812(0),4);
      auVar22._12_4_ = 0;
      auVar23._0_4_ =
           (float)((uint)*(ushort *)(param_1 + -6 + uVar18 * 2) +
                  (uint)*(ushort *)(param_1 + 6 + uVar18 * 2));
      auVar23._4_8_ = SUB128(ZEXT812(0),4);
      auVar23._12_4_ = 0;
      auVar24._0_4_ = (float)*(ushort *)(param_1 + uVar18 * 2);
