...
void FUN_1400ab980(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)
...
LAB_1400abc81:
    ...
    uVar55 = param_2 & 0x1f;
    if (uVar55 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1400abc81;
      uVar55 = 0x20 - uVar55 >> 2;
    }
    if ((longlong)uVar57 < (longlong)(uVar55 + 0x10)) goto LAB_1400abc81;
    uVar54 = 0;
