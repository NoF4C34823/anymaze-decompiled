...
void FUN_140325fc0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        if (0 < (longlong)uVar4) {
          ...
          do {
            ...
            if (0 < (longlong)uVar31) {
              ...
              for (; uVar32 < uVar31; uVar32 = uVar32 + 1) {
                bVar40 = *(byte *)(uVar32 + uVar23);
                if (bVar39 <= *(byte *)(uVar32 + uVar23)) {
                  bVar40 = bVar39;
                }
                bVar39 = bVar40;
              }
        ...
        FUN_140328840(param_9,uVar29,param_3,uVar4,uVar33);
        uVar28 = uVar28 + 1;
        uVar33 = param_6[1];
                      ...
                      if (uVar24 != 0) {
                        do {
                          if ((*(char *)(uVar27 + uVar32) != '\0') &&
                             (bVar40 = *(byte *)(lVar26 + uVar23 + uVar27), bVar40 < bVar39)) {
                            bVar39 = bVar40;
                          }
                          uVar27 = uVar27 + 1;
                        } while (uVar27 < uVar24);
