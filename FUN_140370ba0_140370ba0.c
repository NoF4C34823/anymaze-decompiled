...
void FUN_140370ba0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
  ...
  if (param_7 == 0) {
        ...
        if (0 < (longlong)uVar13) {
          ...
          do {
            ...
            if (0 < (longlong)uVar3) {
              ...
              if ((lVar18 - 1U < uVar3) &&
                 (lVar18 = (lVar18 - 1U) * 3 + lVar4 + lVar10, bVar9 < *(byte *)(lVar18 + uVar11)))
              {
    ...
    if (0 < param_5[1]) {
      ...
      do {
        ...
        if (0 < (longlong)uVar3) {
          ...
          do {
            ...
            if (0 < (longlong)uVar20) {
              ...
              if ((lVar10 - 1U < uVar20) &&
                 (lVar10 = (lVar10 - 1U) * 3 + lVar5, bVar9 < *(byte *)(lVar10 + uVar13))) {
        ...
        FUN_140374ca0(param_9,uVar17,param_3,uVar3,uVar12);
        uVar16 = uVar16 + 1;
        uVar12 = param_6[1];
