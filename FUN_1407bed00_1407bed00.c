...
void FUN_1407bed00(longlong param_1,ulonglong param_2,ulonglong param_3,float *param_4)

{
  ...
  if (3 < (longlong)param_3) {
    uVar5 = param_2 & 0xf;
    if (uVar5 != 0) {
      if ((param_2 & 3) != 0) goto LAB_1407beed6;
      uVar5 = 0x10 - uVar5 >> 2;
    }
    uVar7 = uVar5 + 4;
    if ((longlong)uVar7 <= (longlong)param_3) {
      ...
      if (uVar5 != 0) {
        do {
          *(float *)(param_2 + uVar6 * 4) =
               (float)((int)*(short *)(param_1 + -4 + uVar6 * 2) +
                      (int)*(short *)(param_1 + 4 + uVar6 * 2)) * fVar2 +
               (float)((int)*(short *)(param_1 + -2 + uVar6 * 2) +
                      (int)*(short *)(param_1 + 2 + uVar6 * 2)) * fVar3 +
               (float)(int)*(short *)(param_1 + uVar6 * 2) * fVar4;
          uVar6 = uVar6 + 1;
        } while (uVar6 < uVar5);
      }
      do {
        auVar9 = pmovsxwd(unaff_XMM7,*(undefined8 *)(param_1 + -4 + uVar5 * 2));
        auVar8 = pmovsxwd(unaff_XMM6,*(undefined8 *)(param_1 + 4 + uVar5 * 2));
        ...
        auVar8 = pmovsxwd(auVar8,*(undefined8 *)(param_1 + 2 + uVar5 * 2));
        auVar9 = pmovsxwd(auVar10,*(undefined8 *)(param_1 + -2 + uVar5 * 2));
        ...
        unaff_XMM7 = pmovsxwd(auVar11,*(undefined8 *)(param_1 + uVar5 * 2));
      ...
      for (; uVar7 < param_3; uVar7 = uVar7 + 1) {
        *(float *)(param_2 + uVar7 * 4) =
             (float)((int)*(short *)(param_1 + -4 + uVar7 * 2) +
                    (int)*(short *)(param_1 + 4 + uVar7 * 2)) * fVar2 +
             (float)((int)*(short *)(param_1 + -2 + uVar7 * 2) +
                    (int)*(short *)(param_1 + 2 + uVar7 * 2)) * fVar3 +
...
LAB_1407beed6:
  FUN_1407bee64(fVar4,uVar7,fVar2,0);
  return;
}
