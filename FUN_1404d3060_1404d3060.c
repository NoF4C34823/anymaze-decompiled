...
void FUN_1404d3060(undefined1 (*param_1) [32],longlong param_2,undefined1 (*param_3) [16],
  ...
  if (0 < param_6) {
    do {
      ...
      if (uVar5 != 0) {
        ...
        FUN_1404d32e0(param_1,param_2,param_3,uVar5);
      ...
      if (lVar10 != 0) {
        ...
        auVar13 = vminps_avx(*pauVar4,*pauVar6);
        ...
        if (1 < lVar10) {
          do {
            ...
            auVar13 = vminps_avx(pauVar4[1],auVar13);
      ...
      if ((uVar9 & 7) != 0) {
        FUN_1404d32e0(pauVar4,param_2,pauVar8);
      }
      lVar7 = lVar7 + 1;
