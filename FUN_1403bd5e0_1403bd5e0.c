...
void FUN_1403bd5e0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar18 - 1)) {
      while( true ) {
        FUN_1403a4f20(param_1,lVar6,uVar8,uVar11,3);
        uVar18 = param_6[1];
        lVar5 = lVar5 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_1403a4f20(param_1,lVar6,uVar8,*param_6,3);
                  ...
                  if (uVar11 >> 1 != 0) {
                    ...
                    do {
                      ...
                      if ((*(char *)(param_7 + lVar16 + 1 + uVar7 * 2) != '\0') &&
                         (fVar2 = *(float *)(lVar3 + 0xc + lVar9), fVar19 <= fVar2)) {
                        fVar19 = fVar2;
                      }
                      uVar7 = uVar7 + 1;
                      lVar3 = lVar3 + 0x18;
