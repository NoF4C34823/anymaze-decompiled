...
void FUN_1402baee0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar26 - 1)) {
      while( true ) {
        FUN_14031cfa0(lVar27,lVar15,uVar4,uVar21,4);
        uVar26 = param_6[1];
        lVar23 = lVar23 + 1;
    ...
    if (0 < param_5[1]) {
      do {
        FUN_14031cfa0(lVar27,lVar15,uVar4,*param_6,4);
        FUN_140328840(param_9,uVar11,param_3,uVar4,param_6[1]);
        lVar23 = lVar23 + 1;
        lVar24 = lVar24 + 1;
        lVar15 = lVar15 + uVar11;
...
LAB_1402bb5f1:
                    ...
                    if ((longlong)uVar21 < (longlong)(uVar13 + 0x10)) goto LAB_1402bb5f1;
                    uVar17 = 0;
                    uVar19 = uVar21 - (uVar21 - uVar13 & 0xf);
                    if (uVar13 != 0) {
                      do {
                        if ((*(char *)(uVar17 + uVar22) != '\0') &&
                           (bVar30 = *(byte *)(lVar1 + lVar24 + uVar17 * 4), bVar30 < bVar31)) {
                          bVar31 = bVar30;
                        }
                        uVar17 = uVar17 + 1;
                      } while (uVar17 < uVar13);
                    ...
                    do {
                      ...
                      if ((((((((((((((((auVar28 >> 7 & (undefined1  [16])0x1) !=
                        ...
                        bVar31 = auVar33[9];
                        auVar29[9] = (bVar31 < bVar5) * bVar31 | (bVar31 >= bVar5) * bVar5;
                        bVar31 = auVar33[10];
                        auVar29[10] = (bVar31 < bVar6) * bVar31 | (bVar31 >= bVar6) * bVar6;
                        bVar31 = auVar33[0xb];
                  ...
                  for (; uVar19 < uVar21; uVar19 = uVar19 + 1) {
                    if ((*(char *)(uVar19 + uVar22) != '\0') &&
                       (bVar30 = *(byte *)(lVar1 + lVar24 + uVar19 * 4), bVar30 < bVar31)) {
                      bVar31 = bVar30;
                    }
                  }
                }
