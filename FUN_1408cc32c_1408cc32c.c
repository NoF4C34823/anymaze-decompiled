...
void FUN_1408cc32c(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4)

{
  ...
  do {
    pfVar1 = (float *)(param_1 + -0xc + param_4 * 4);
    pfVar2 = (float *)(param_1 + -0x18 + param_4 * 4);
    pfVar3 = (float *)(param_1 + 0xc + param_4 * 4);
    ...
    pfVar1 = (float *)(param_1 + 0x18 + param_4 * 4);
    auVar6._4_4_ = unaff_XMM9_Da * (pfVar2[1] + pfVar1[1]);
    auVar6._0_4_ = unaff_XMM9_Da * (*pfVar2 + *pfVar1);
    auVar6._8_4_ = unaff_XMM9_Da * (pfVar2[2] + pfVar1[2]);
    auVar6._12_4_ = unaff_XMM9_Da * (pfVar2[3] + pfVar1[3]);
    auVar6._16_4_ = unaff_XMM9_Da * (pfVar2[4] + pfVar1[4]);
    auVar6._20_4_ = unaff_XMM9_Da * (pfVar2[5] + pfVar1[5]);
    auVar6._24_4_ = unaff_XMM9_Da * (pfVar2[6] + pfVar1[6]);
    auVar6._28_4_ = pfVar2[7];
    pfVar1 = (float *)(param_1 + -0x24 + param_4 * 4);
    pfVar2 = (float *)(param_1 + 0x24 + param_4 * 4);
    ...
    auVar4 = vfmadd231ps_fma(ZEXT1632(auVar4),auVar9,*(undefined1 (*) [32])(param_1 + param_4 * 4));
    *(undefined1 (*) [32])(param_2 + param_4 * 4) = ZEXT1632(auVar4);
    param_4 = param_4 + 8;
  ...
  if (in_RAX < in_R10) {
    do {
      ...
      auVar4 = vfmadd231ss_fma(ZEXT416((uint)(unaff_XMM9_Da *
                                             (*(float *)(param_1 + -0x18 + in_RAX * 4) +
                                             *(float *)(param_1 + 0x18 + in_RAX * 4)))),
                               ZEXT416((uint)(*(float *)(param_1 + -0x24 + in_RAX * 4) +
                                             *(float *)(param_1 + 0x24 + in_RAX * 4))),auVar4);
      auVar4 = vfmadd231ss_fma(auVar4,ZEXT416((uint)(*(float *)(param_1 + -0xc + in_RAX * 4) +
