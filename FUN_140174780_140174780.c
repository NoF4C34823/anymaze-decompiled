...
void FUN_140174780(longlong param_1,ulonglong param_2,longlong param_3,float *param_4,int param_5)
...
LAB_1401750d0:
      uVar94 = 0;
      if (uVar100 == 0) goto LAB_140174983;
      uVar95 = 0;
      uVar98 = uVar100;
    }
    else {
      uVar98 = param_2 & 0xf;
      if (uVar98 != 0) {
        if ((param_2 & 3) != 0) goto LAB_1401750d0;
        uVar98 = 0x10 - uVar98 >> 2;
      }
      if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_1401750d0;
      ...
      if (uVar100 < uVar94 + 1) goto LAB_140174983;
...
LAB_1401750ab:
          uVar94 = 0;
          if (uVar100 == 0) goto LAB_140174eec;
          uVar95 = 0;
          uVar98 = uVar100;
        }
        else {
          uVar98 = param_2 & 0xf;
          if (uVar98 != 0) {
            if ((param_2 & 3) != 0) goto LAB_1401750ab;
            uVar98 = 0x10 - uVar98 >> 2;
          }
          if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_1401750ab;
          uVar94 = uVar100 - (uVar100 - uVar98 & 7);
          ...
          if (uVar100 < uVar94 + 1) goto LAB_140174eec;
          uVar98 = uVar100 - uVar94;
          if ((longlong)uVar98 < 4) {
            uVar95 = 0;
          }
...
LAB_140175098:
    ...
    uVar98 = param_2 & 0xf;
    if (uVar98 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140175098;
      uVar98 = 0x10 - uVar98 >> 2;
    }
    if ((longlong)uVar100 < (longlong)(uVar98 + 8)) goto LAB_140175098;
    uVar95 = 0;
    uVar94 = uVar100 - (uVar100 - uVar98 & 7);
    if (uVar98 != 0) {
      do {
