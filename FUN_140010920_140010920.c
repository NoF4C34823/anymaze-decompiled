...
void FUN_140010920(undefined8 *param_1,undefined4 *param_2,uint param_3)

{
  ...
  if ((param_3 & 4) != 0) {
    ...
    auVar33 = paddusw(auVar33,_DAT_1430864f0);
  ...
  if (bVar20) {
    ...
    if (bVar20) {
      ...
      if (uVar17 >> 1 != 0) {
        ...
        do {
          ...
          *(char *)((longlong)param_2 + uVar18 * 2) =
               (char)((uint)*(byte *)(lVar16 + (longlong)param_1) * (uint)uVar10 +
                      (uint)*(byte *)(lVar16 + 1 + (longlong)param_1) * (uint)uVar11 + 0x4000 +
                      (uint)*(byte *)(lVar16 + 2 + (longlong)param_1) * (uint)uVar12 >> 0xf);
          lVar1 = lVar16 + 3;
          lVar2 = lVar16 + 4;
          lVar3 = lVar16 + 5;
          lVar16 = lVar16 + 6;
        ...
        iVar15 = (int)uVar18 + 2 + (int)uVar19;
      }
      if (iVar15 - 1U < uVar17) {
        lVar16 = (longlong)iVar15 * 3;
        *(char *)((longlong)iVar15 + -1 + (longlong)param_2) =
             (char)((uint)uVar10 * (uint)*(byte *)(lVar16 + -3 + (longlong)param_1) +
                    (uint)uVar11 * (uint)*(byte *)(lVar16 + -2 + (longlong)param_1) + 0x4000 +
                    (uint)uVar12 * (uint)*(byte *)(lVar16 + -1 + (longlong)param_1) >> 0xf);
      }
    }
  }
  return;
