...
void FUN_1401c8c60(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (0 < (longlong)param_5) {
    if (3 < (longlong)param_5) {
      ...
      uVar46 = uVar45 & 0xf;
      if (uVar46 != 0) {
        if ((uVar45 & 3) != 0) goto LAB_1401c9125;
...
LAB_1401c9125:
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar39 = param_4 & 0xf;
      if (uVar39 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1401c953c;
...
LAB_1401c949f:
  ...
  if (7 < (longlong)param_5) {
    uVar39 = param_4 & 0xf;
    if (uVar39 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1401c9535;
      uVar39 = 0x10 - uVar39 >> 1;
    }
    if ((longlong)(uVar39 + 8) <= (longlong)param_5) {
      uVar46 = 0;
