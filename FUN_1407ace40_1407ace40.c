...
void FUN_1407ace40(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001407ae075. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c280)[lVar22])(pbVar37,param_4,*param_5);
    return;
  }
  if (uVar32 == 6) {
    uVar26 = (uint)*param_8;
          ...
          if (uVar32 != 6) {
            if (uVar32 == 1) {
              ...
              if (lVar28 < 2) {
                ...
                if (lVar27 < 0) goto LAB_1407ae000;
                while (uVar26 == 0) {
                  for (lVar24 = (lVar28 + -1) * 2 - lVar24; lVar24 < 0; lVar24 = -lVar24) {
LAB_1407ae000:
                    if ((uint)lStack_70 != 0) goto LAB_1407adf03;
                  }
          ...
          bVar33 = bVar35;
          if (uVar19 != 0) goto LAB_1407adf03;
        }
        else {
LAB_1407adf03:
        ...
        *(byte *)(lVar30 + param_11) = bVar33;
        lVar30 = lVar30 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001407adf67. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c280)[lVar22])(param_11 + uVar31,param_4,lVar28,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar31 == 1) {
...
LAB_1407adf7b:
              ...
              if ((longlong)uVar25 < (longlong)(uVar36 + 0x10)) goto LAB_1407adf7b;
...
LAB_1407adf89:
              ...
              if ((longlong)uVar31 < (longlong)(uVar29 + 0x10)) goto LAB_1407adf89;
              uVar34 = 0;
...
LAB_1407adf82:
          ...
          if ((longlong)uVar31 < (longlong)(uVar29 + 0x10)) goto LAB_1407adf82;
          uVar34 = 0;
          uVar36 = uVar31 - (uVar31 - uVar29 & 0xf);
          if (uVar29 != 0) {
            do {
      ...
      in_XMM0._0_8_ =
           (*(code *)(&PTR_FUN_14308c280)[lVar22])(lStack_70,param_4,uVar31,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001407adfe6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&PTR_FUN_14308c280)[lVar22])(pbVar37,param_4,lVar28);
    return;
  }
  if ((longlong)uVar31 < lVar28) {
    lVar28 = lVar28 - uVar31;
    in_XMM0._0_8_ = (*(code *)(&PTR_FUN_14308c280)[lVar22])(pbVar37,param_4,lVar28,param_9,param_10)
    ;
...
LAB_1407adf90:
          ...
          if ((longlong)uVar25 < (longlong)(uVar29 + 0x10)) goto LAB_1407adf90;
...
LAB_1407ad9ff:
  if (uVar32 == 1) {
    if ((longlong)uVar31 < 1) goto LAB_1407addb3;
    if ((longlong)uVar31 < 7) {
      lVar28 = 1;
      if (uVar31 >> 1 != 0) {
...
LAB_1407adfa7:
      ...
      if ((longlong)uVar31 < (longlong)(uVar25 + 0x10)) goto LAB_1407adfa7;
      uVar36 = 0;
  ...
  if (uVar32 != 3) {
    if ((uVar32 != 6) || ((longlong)uVar31 < 1)) goto LAB_1407addb3;
    if ((longlong)uVar31 < 0x10) {
LAB_1407adf9f:
      uVar29 = 0;
    }
      ...
      if ((longlong)uVar31 < (longlong)(uVar25 + 0x10)) goto LAB_1407adf9f;
      uVar36 = 0;
      uVar29 = uVar31 - (uVar31 - uVar25 & 0xf);
      if (uVar25 != 0) {
        do {
...
LAB_1407adf97:
    ...
    if ((longlong)uVar31 < (longlong)(uVar25 + 0x10)) goto LAB_1407adf97;
    uVar36 = 0;
    lVar30 = 0;
    uVar29 = uVar31 - (uVar31 - uVar25 & 0xf);
    if (uVar25 != 0) {
...
LAB_1407addb3:
                    /* WARNING: Could not recover jumptable at 0x0001407addee. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&PTR_FUN_14308c280)[lVar22])(param_11 + uVar31,param_4,uVar31);
  return;
}
