...
void FUN_140174480(longlong param_1,ulonglong param_2,longlong param_3,float *param_4)

{
  ...
  if (3 < (longlong)uVar12) {
    uVar41 = param_2 & 0xf;
    if (uVar41 != 0) {
      if ((param_2 & 3) != 0) goto LAB_140174773;
      uVar41 = 0x10 - uVar41 >> 2;
    }
    if ((longlong)(uVar41 + 4) <= (longlong)uVar12) {
      uVar39 = 0;
      uVar40 = uVar12 - (uVar12 - uVar41 & 3);
      if (uVar41 != 0) {
        do {
          *(float *)(param_2 + uVar39 * 4) =
               (float)((uint)*(ushort *)(param_1 + -0x12 + uVar39 * 2) +
                      (uint)*(ushort *)(param_1 + 0x12 + uVar39 * 2)) * fVar2 +
               (float)((uint)*(ushort *)(param_1 + -0xc + uVar39 * 2) +
                      (uint)*(ushort *)(param_1 + 0xc + uVar39 * 2)) * fVar3 +
               (float)((uint)*(ushort *)(param_1 + -6 + uVar39 * 2) +
                      (uint)*(ushort *)(param_1 + 6 + uVar39 * 2)) * fVar4 +
               (float)*(ushort *)(param_1 + uVar39 * 2) * fVar5;
          uVar39 = uVar39 + 1;
        } while (uVar39 < uVar41);
      }
      do {
        uVar39 = *(ulonglong *)(param_1 + -0xc + uVar41 * 2);
        uVar6 = *(ulonglong *)(param_1 + -0x12 + uVar41 * 2);
        uVar7 = *(ulonglong *)(param_1 + 0x12 + uVar41 * 2);
        uVar8 = *(ulonglong *)(param_1 + 0xc + uVar41 * 2);
        auVar19._8_4_ = 0;
        auVar19._0_8_ = uVar39;
        auVar19._12_2_ = (short)(uVar39 >> 0x30);
        auVar26._8_2_ = (short)(uVar39 >> 0x20);
        auVar26._0_8_ = uVar39;
        auVar26._10_4_ = auVar19._10_4_;
        auVar32._6_8_ = 0;
        auVar32._0_6_ = auVar26._8_6_;
        auVar13._8_4_ = 0;
        auVar13._0_8_ = uVar6;
        ...
        uVar9 = *(ulonglong *)(param_1 + 6 + uVar41 * 2);
        uVar10 = *(ulonglong *)(param_1 + -6 + uVar41 * 2);
        auVar16._8_4_ = 0;
        auVar16._0_8_ = uVar9;
        ...
        uVar11 = *(ulonglong *)(param_1 + uVar41 * 2);
        auVar18._8_4_ = 0;
        ...
        *pfVar1 = (float)(((uint)uVar6 & 0xffff) + (uint)(ushort)uVar7) * fVar2 +
                  (float)((uint)(ushort)uVar39 + ((uint)uVar8 & 0xffff)) * fVar3 +
                  (float)(((uint)uVar10 & 0xffff) + ((uint)uVar9 & 0xffff)) * fVar4 +
                  (float)((uint)uVar11 & 0xffff) * fVar5;
        pfVar1[1] = (float)(auVar27._4_4_ +
                           (int)CONCAT82(SUB148(auVar34 << 0x40,6),(short)(uVar7 >> 0x10))) * fVar2
                    + (float)((int)CONCAT82(SUB148(auVar32 << 0x40,6),(short)(uVar39 >> 0x10)) +
                             auVar28._4_4_) * fVar3 + (float)(auVar30._4_4_ + auVar29._4_4_) * fVar4
                    + (float)auVar31._4_4_ * fVar5;
        pfVar1[2] = (float)(auVar20._8_4_ + auVar21._8_4_) * fVar2 +
                    (float)(auVar26._8_4_ + auVar22._8_4_) * fVar3 +
                    (float)(auVar24._8_4_ + auVar23._8_4_) * fVar4 + (float)auVar25._8_4_ * fVar5;
        pfVar1[3] = (float)((auVar13._10_4_ >> 0x10) + (auVar14._10_4_ >> 0x10)) * fVar2 +
                    (float)((auVar19._10_4_ >> 0x10) + (auVar15._10_4_ >> 0x10)) * fVar3 +
                    (float)((auVar17._10_4_ >> 0x10) + (auVar16._10_4_ >> 0x10)) * fVar4 +
                    (float)(auVar18._10_4_ >> 0x10) * fVar5;
        uVar41 = uVar41 + 4;
      } while (uVar41 < uVar40);
      for (; uVar40 < uVar12; uVar40 = uVar40 + 1) {
        *(float *)(param_2 + uVar40 * 4) =
             (float)((uint)*(ushort *)(param_1 + -0x12 + uVar40 * 2) +
                    (uint)*(ushort *)(param_1 + 0x12 + uVar40 * 2)) * fVar2 +
             (float)((uint)*(ushort *)(param_1 + -0xc + uVar40 * 2) +
                    (uint)*(ushort *)(param_1 + 0xc + uVar40 * 2)) * fVar3 +
             (float)((uint)*(ushort *)(param_1 + -6 + uVar40 * 2) +
                    (uint)*(ushort *)(param_1 + 6 + uVar40 * 2)) * fVar4 +
