...
void FUN_1401e9940(longlong param_1,longlong param_2,int param_3,longlong param_4,ulonglong param_5,
...
LAB_1401ea12e:
      uVar57 = 0;
      if (param_5 == 0) goto LAB_1401e9e9d;
      uVar54 = 0;
      uVar50 = param_5;
    }
    else {
      ...
      uVar50 = uVar49 & 0x1f;
      if (uVar50 != 0) {
        if ((uVar49 & 3) != 0) goto LAB_1401ea12e;
        uVar50 = 0x20 - uVar50 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar50 + 0x10)) goto LAB_1401ea12e;
      ...
      if (param_5 < uVar57 + 1) goto LAB_1401e9e9d;
...
LAB_1401e9e9d:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      ...
      uVar49 = uVar50 & 0xf;
      if (uVar49 != 0) {
        if ((uVar50 & 3) != 0) goto LAB_1401ea14d;
...
LAB_1401ea0c2:
  ...
  if (7 < (longlong)param_5) {
    ...
    uVar49 = uVar50 & 0xf;
    if (uVar49 != 0) {
      if ((uVar50 & 3) != 0) goto LAB_1401ea146;
      uVar49 = 0x10 - uVar49 >> 2;
    }
    if ((longlong)(uVar49 + 8) <= (longlong)param_5) {
      uVar54 = 0;
