...
void FUN_1403319c0(longlong param_1,longlong param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (0 < (longlong)(uVar23 - 1)) {
      while( true ) {
        FUN_14031cfa0(lVar17,lVar12,uVar4,uVar22,1);
        uVar23 = param_6[1];
        lVar26 = lVar26 + 1;
    ...
    if (0 < (longlong)param_5[1]) {
      ...
      do {
        ...
        FUN_14031cfa0(lVar17,lVar12,uVar4,*param_6,1);
        uVar23 = param_6[1];
        if (0 < (longlong)uVar4) {
          uVar22 = 0;
          do {
            ...
            if (0 < (longlong)uVar23) {
              ...
              if (uVar9 <= uVar23) {
                    /* WARNING: Could not recover jumptable at 0x000140331e0c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_140331e0e + (byte)(&DAT_143089c88)[(uint)((int)uVar23 - (int)uVar9)]
                          ))();
                return;
              }
            }
...
LAB_14033248f:
                    ...
                    if ((longlong)uVar22 < (longlong)(uVar11 + 0x10)) goto LAB_14033248f;
                    uVar13 = 0;
                    uVar15 = uVar22 - (uVar22 - uVar11 & 0xf);
                    if (uVar11 != 0) {
                      do {
                        if ((*(char *)(uVar13 + uVar19) != '\0') &&
                           (bVar30 = *(byte *)(lVar24 + lVar27 + uVar13), bVar30 < bVar31)) {
                          bVar31 = bVar30;
                        }
                        uVar13 = uVar13 + 1;
                      } while (uVar13 < uVar11);
                    ...
                    do {
                      ...
                      bVar31 = auVar33[9];
                      auVar29[9] = (bVar31 < bVar2) * bVar31 | (bVar31 >= bVar2) * bVar2;
                      bVar31 = auVar33[10];
                      auVar29[10] = (bVar31 < bVar3) * bVar31 | (bVar31 >= bVar3) * bVar3;
                      bVar31 = auVar33[0xb];
                  ...
                  for (; uVar15 < uVar22; uVar15 = uVar15 + 1) {
                    if ((*(char *)(uVar15 + uVar19) != '\0') &&
                       (bVar30 = *(byte *)(lVar24 + lVar27 + uVar15), bVar30 < bVar31)) {
                      bVar31 = bVar30;
                    }
                  }
                }
