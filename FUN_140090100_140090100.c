...
void FUN_140090100(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...

{
  ...
  if (param_8 != 0) {
    ...
    if (3 < (longlong)param_5) {
      uVar37 = param_4 & 0xf;
      if (uVar37 != 0) {
        if ((param_4 & 3) != 0) goto LAB_1400908a5;
...
LAB_140090895:
    ...
    uVar37 = param_4 & 0xf;
    if (uVar37 != 0) {
      if ((param_4 & 3) != 0) goto LAB_140090895;
      uVar37 = 0x10 - uVar37 >> 2;
    }
    if ((longlong)param_5 < (longlong)(uVar37 + 8)) goto LAB_140090895;
