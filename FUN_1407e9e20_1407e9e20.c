...
void FUN_1407e9e20(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1407ea610:
      uVar56 = 0;
      if (param_5 == 0) goto LAB_1407ea35e;
      uVar54 = 0;
      uVar49 = param_5;
    }
    else {
      ...
      uVar49 = uVar48 & 0x1f;
      if (uVar49 != 0) {
        if ((uVar48 & 3) != 0) goto LAB_1407ea610;
        uVar49 = 0x20 - uVar49 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar49 + 0x10)) goto LAB_1407ea610;
      ...
      if (param_5 < uVar56 + 1) goto LAB_1407ea35e;
...
LAB_1407ea35e:
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar48 = param_4 & 0x1f;
      if (uVar48 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1407ea62f;
...
LAB_1407ea58b:
  ...
  if (7 < (longlong)param_5) {
    uVar48 = param_4 & 0xf;
    if (uVar48 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1407ea628;
