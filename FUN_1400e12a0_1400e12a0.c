...
void FUN_1400e12a0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1400e1a7c:
      ...
      if ((longlong)param_5 < 0x1d) {
        ...
        uVar11 = uVar12 & 0x1f;
        if (uVar11 != 0) {
          if ((uVar12 & 3) != 0) goto LAB_1400e1a7c;
          uVar11 = 0x20 - uVar11 >> 2;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 0x10)) goto LAB_1400e1a7c;
        lStack_58 = param_2 * lVar8 + param_1;
        lStack_68 = param_2 * lVar19 + param_1;
        lStack_60 = param_2 * lVar17 + param_1;
        lStack_70 = param_2 * lVar10 + param_1;
...
LAB_1400e1ae1:
      ...
      if ((longlong)param_5 < 0x7b9) {
        ...
        uVar11 = param_4 & 0x1f;
        if (uVar11 != 0) {
          if ((param_4 & 1) != 0) goto LAB_1400e1ae1;
          uVar11 = 0x20 - uVar11 >> 1;
        }
        if ((longlong)param_5 < (longlong)(uVar11 + 0x10)) goto LAB_1400e1ae1;
        lVar8 = param_2 * 5 + param_1;
        uVar13 = 0;
  ...
  if (0xf < (longlong)param_5) {
    uVar12 = param_4 & 0x1f;
    if (uVar12 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1400e1b04;
