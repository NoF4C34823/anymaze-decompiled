...
uint FUN_140a7dc40(undefined1 *param_1,ulonglong param_2,uint param_3,undefined8 param_4,
...
LAB_140a80a6c:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a80a6c;
            uVar6 = 0;
...
LAB_140a805a2:
    ...
    if (lVar17 < 1) {
      uVar4 = 4 - param_5;
      if ((param_6 & 0x80) != 0) goto LAB_140a808d6;
LAB_140a807d0:
      if ((int)uVar4 < 1) {
        return param_5;
      }
...
LAB_140a80a7b:
        ...
        if ((longlong)uVar7 < (longlong)(uVar8 + 0x10)) goto LAB_140a80a7b;
...
LAB_140a80a73:
          ...
          iVar5 = (int)uVar12;
          if (param_3 < iVar5 + 0x10U) goto LAB_140a80a73;
          uVar8 = 0;
      ...
      if (lVar17 < 5) {
        uVar4 = 4 - param_5;
        if ((param_6 & 0x80) == 0) goto LAB_140a807d0;
LAB_140a808d6:
        if ((int)uVar4 < 1) {
          return param_5;
        }
        ...
        *(undefined1 *)(lVar19 + 3 + param_2) = param_1[lVar17 + -1];
        lVar19 = (longlong)(int)uVar11;
        if ((param_6 & 0x80) == 0) {
          if ((int)uVar4 < 1) goto LAB_140a80a4b;
          goto LAB_140a807d9;
        }
        if ((int)uVar4 < 1) goto LAB_140a80a4b;
      }
...
LAB_140a80a82:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a80a82;
            uVar13 = 0;
...
LAB_140a80305:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a80305;
            uVar6 = 0;
            uVar8 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar12 & 0xf));
            if (uVar12 != 0) {
              do {
...
LAB_140a8030c:
          ...
          iVar5 = (int)uVar12;
          if (param_3 < iVar5 + 0x10U) goto LAB_140a8030c;
          uVar8 = 0;
          iVar9 = param_3 - (param_3 - iVar5 & 0xf);
          if (iVar5 != 0) {
            do {
    ...
    iVar5 = (int)lVar19;
    if ((param_6 & 0x80) != 0) {
      if ((int)uVar4 < 1) goto LAB_140a802dd;
      if (6 < (int)uVar4) {
        uVar7 = param_2 + lVar19;
        uVar12 = 4 - (longlong)(int)param_5;
...
LAB_140a8031a:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a8031a;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a80313:
      ...
      if ((longlong)uVar7 < (longlong)(uVar8 + 0x10)) goto LAB_140a80313;
...
LAB_140a7fbfb:
                ...
                if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a7fbfb;
                uVar6 = 0;
        ...
        if ((int)(param_5 - 1) < 0) goto LAB_140a7f565;
        if (6 < (int)param_5) {
...
LAB_140a7fc03:
              ...
              if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a7fc03;
              uVar6 = 0;
              uVar8 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar12 & 0xfU));
              if (uVar12 != 0) {
                do {
        ...
        if (iVar5 - 1U < param_5) goto LAB_140a7f54d;
      }
    }
    else {
      uVar11 = (uint)uVar7;
...
LAB_140a7ee58:
        ...
        if (((longlong)(uVar12 - (longlong)param_1) < (longlong)uVar7) &&
           ((longlong)-(uVar12 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a7ee58;
        if (uVar11 < 0x10) {
LAB_140a7fbe5:
          uVar8 = 0;
        }
          ...
          iVar5 = (int)uVar7;
          if (uVar11 < iVar5 + 0x10U) goto LAB_140a7fbe5;
          uVar8 = 0;
      ...
      if (lVar17 < 5) goto LAB_140a7f1f9;
      if ((param_6 & 0x40) == 0) {
        if ((int)(param_5 - 1) < 0) goto LAB_140a7f565;
        if (6 < (int)param_5) {
          lVar20 = (longlong)(int)param_5;
...
LAB_140a7fbec:
              ...
              if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a7fbec;
              uVar6 = 0;
...
LAB_140a7fbf4:
            ...
            if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a7fbf4;
            uVar6 = 0;
            uVar8 = (ulonglong)(int)((int)uVar7 - ((int)uVar7 - (int)uVar12 & 0xfU));
            if (uVar12 != 0) {
              do {
      ...
      if (param_5 <= iVar5 - 1U) goto LAB_140a7f565;
LAB_140a7f54d:
      *(undefined1 *)(((longlong)(int)param_5 + param_2) - (longlong)iVar5) =
...
LAB_140a7f565:
    ...
    if (lVar17 < 5) {
      ...
      uVar11 = iVar9 + 4;
      if ((param_6 & 0x80) != 0) {
        if ((int)uVar11 < 1) goto LAB_140a7fbc4;
        if (6 < (int)uVar11) {
          uVar7 = param_2 + lVar19;
          puVar2 = param_1 + lVar17;
          uVar12 = 4 - (longlong)(int)param_5;
...
LAB_140a7fc20:
              ...
              if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7fc20;
              uVar13 = 0;
              uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
              if (uVar8 != 0) {
                do {
...
LAB_140a7fc18:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7fc18;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a7fc11:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7fc11;
            uVar13 = 0;
            uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
            if (uVar8 != 0) {
              do {
...
LAB_140a7fc0a:
          ...
          if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7fc0a;
          uVar13 = 0;
          uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
          if (uVar8 != 0) {
            do {
            ...
            do {
              while( true ) {
                *(undefined1 *)(lVar20 + param_2) = param_1[lVar20 - lVar14];
                ...
                do {
                  if (lVar20 < 0) goto LAB_140a7e61b;
LAB_140a7ed09:
                  uVar12 = uVar7;
            ...
            bVar22 = -1 < lVar20;
            if ((((bVar22) && (bVar22)) && (bVar22)) && (bVar22)) goto LAB_140a7ed09;
          }
        }
        goto LAB_140a7e61b;
      }
            ...
            do {
              while( true ) {
                ...
                *(undefined1 *)(lVar20 + param_2) = *puVar2;
                ...
                if ((longlong)(uVar12 + 1) < lVar17) break;
                do {
                  if (lVar20 < 0) goto LAB_140a7e749;
LAB_140a7ecc9:
                  lVar21 = (longlong)(int)((int)lVar20 + uVar4) + 1;
                  uVar12 = uVar7;
                } while (lVar17 <= (longlong)uVar7);
          ...
          else if (-1 < lVar20) goto LAB_140a7ecc9;
        }
LAB_140a7e749:
        if (4 < lVar17) goto LAB_140a7e84a;
        goto LAB_140a7e753;
      }
      if (-1 < (int)(param_5 - 1)) {
        iVar5 = 1;
      ...
      if (lVar17 < 5) goto LAB_140a7eab0;
    }
    else {
      uVar10 = (uint)uVar12;
      if (uVar10 < 7) {
LAB_140a7e2f7:
        ...
        if (((longlong)(uVar8 - (longlong)param_1) < (longlong)uVar12) &&
           ((longlong)-(uVar8 - (longlong)param_1) < (longlong)uVar12)) goto LAB_140a7e2f7;
        if (uVar10 < 0x10) {
LAB_140a7eca9:
          uVar6 = 0;
        }
          ...
          iVar5 = (int)uVar12;
          if (uVar10 < iVar5 + 0x10U) goto LAB_140a7eca9;
          uVar6 = 0;
      ...
      lVar19 = (longlong)(int)uVar11;
      if (lVar17 < 5) goto LAB_140a7e6db;
      if ((param_6 & 0x40) == 0) {
        if (-1 < (int)(param_5 - 1)) {
          iVar5 = 1;
          lVar20 = 0;
...
LAB_140a7ecb0:
            ...
            if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7ecb0;
...
LAB_140a7eab0:
        uVar4 = -param_5 + 4;
        if ((int)uVar4 < 1) goto LAB_140a7ec42;
        iVar5 = (int)lVar19;
        if (6 < (int)uVar4) {
          uVar7 = param_2 + lVar19;
          puVar2 = param_1 + lVar17;
...
LAB_140a7ecf4:
              ...
              if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7ecf4;
              uVar13 = 0;
              uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
              if (uVar8 != 0) {
                do {
...
LAB_140a7eced:
          ...
          if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7eced;
          uVar13 = 0;
          uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
          if (uVar8 != 0) {
            do {
...
LAB_140a7e1a6:
          ...
          if ((longlong)uVar7 < (longlong)(uVar12 + 0x10)) goto LAB_140a7e1a6;
          uVar6 = 0;
          uVar8 = (ulonglong)(int)(param_5 - (param_5 - (int)uVar12 & 0xf));
          if (uVar12 != 0) {
            do {
...
LAB_140a7df37:
      ...
      uVar12 = param_2 + lVar19;
      if (((longlong)(uVar12 - (longlong)param_1) < (longlong)uVar7) &&
         ((longlong)-(uVar12 - (longlong)param_1) < (longlong)uVar7)) goto LAB_140a7df37;
      if (uVar4 < 0x10) {
LAB_140a7e1ad:
        uVar8 = 0;
      }
        ...
        iVar5 = (int)uVar7;
        if (uVar4 < iVar5 + 0x10U) goto LAB_140a7e1ad;
        uVar8 = 0;
    ...
    uVar11 = uVar10;
    lVar19 = (longlong)(int)uVar11;
    if (lVar17 < 5) goto LAB_140a7dfe6;
    uVar11 = uVar11 + 4;
    *(undefined1 *)(lVar19 + param_2) = param_1[lVar17 + -4];
    uVar4 = 4 - param_5;
    *(undefined1 *)(lVar19 + 1 + param_2) = param_1[lVar17 + -3];
    ...
    *(undefined1 *)(lVar19 + 3 + param_2) = param_1[lVar17 + -1];
    lVar19 = (longlong)(int)uVar11;
    if ((int)uVar4 < 1) goto LAB_140a7e168;
  }
  iVar5 = (int)lVar19;
  if ((int)uVar4 < 7) {
LAB_140a7e0f7:
    ...
    if (((longlong)(uVar7 - (longlong)puVar2) < (longlong)uVar12) &&
       ((longlong)-(uVar7 - (longlong)puVar2) < (longlong)uVar12)) goto LAB_140a7e0f7;
    if ((longlong)uVar12 < 0x10) {
LAB_140a7e1b4:
      uVar6 = 0;
    }
      ...
      if ((longlong)uVar12 < (longlong)(uVar8 + 0x10)) goto LAB_140a7e1b4;
      uVar13 = 0;
      uVar6 = (ulonglong)(int)((int)uVar12 - ((int)uVar12 - (int)uVar8 & 0xfU));
      if (uVar8 != 0) {
        do {
