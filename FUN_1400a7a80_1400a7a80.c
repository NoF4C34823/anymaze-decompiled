...
void FUN_1400a7a80(longlong param_1,longlong param_2,longlong param_3,float *param_4,
...

{
  ...
  if ((param_7 & 0xf0) == 0xf0) {
                    /* WARNING: Could not recover jumptable at 0x0001400a8b35. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086aa0 + lVar4 * 8))(psVar25,param_4,*param_5);
    return;
  }
  if (uVar14 == 6) {
    sVar19 = *param_8;
          ...
          if (uVar14 != 6) {
            if (uVar14 == 1) {
              ...
              if (lVar20 < 2) {
                ...
                if (lVar12 < 0) goto LAB_1400a8ac0;
                while (uVar8 == 0) {
                  for (lVar23 = (lVar20 + -1) * 2 - lVar23; lVar23 < 0; lVar23 = -lVar23) {
LAB_1400a8ac0:
                    if (uVar16 != 0) goto LAB_1400a89c3;
                  }
...
LAB_1400a89c3:
        ...
        *(short *)(param_11 + lVar9 * 2) = sVar22;
        lVar9 = lVar9 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001400a8a26. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086aa0 + lVar4 * 8))(param_11 + uVar10 * 2,param_4,lVar20,param_9);
    return;
  }
  if ((param_7 & 0x40) == 0) {
    if (uVar10 == 1) {
...
LAB_1400a8a3a:
              ...
              uVar17 = uVar7 & 0xf;
              if (uVar17 != 0) {
                if ((uVar7 & 1) != 0) goto LAB_1400a8a3a;
                uVar17 = 0x10 - uVar17 >> 1;
              }
              if ((longlong)uVar18 < (longlong)(uVar17 + 8)) goto LAB_1400a8a3a;
...
LAB_1400a7f5d:
      if (uVar14 == 1) {
        if ((longlong)uVar10 < 1) goto LAB_1400a816d;
...
LAB_1400a8a9a:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a8a9a;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_1400a8a9a;
          uVar5 = 0;
...
LAB_1400a8a41:
          ...
          uVar17 = param_11 & 0xf;
          if (uVar17 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a8a41;
            uVar17 = 0x10 - uVar17 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar17 + 8)) goto LAB_1400a8a41;
          uVar5 = 0;
          uVar21 = uVar10 - (uVar10 - uVar17 & 7);
          if (uVar17 != 0) {
            do {
...
LAB_1400a816d:
      in_XMM0._0_8_ =
           (**(code **)(&UNK_143086aa0 + lVar4 * 8))(uVar7,param_4,uVar10,param_9,param_10);
  ...
  if ((param_7 & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x0001400a8a97. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&UNK_143086aa0 + lVar4 * 8))(psVar25,param_4,lVar20);
    return;
  }
  if ((longlong)uVar10 < lVar20) {
    lVar20 = lVar20 - uVar10;
    in_XMM0._0_8_ =
         (**(code **)(&UNK_143086aa0 + lVar4 * 8))(psVar25,param_4,lVar20,param_9,param_10);
...
LAB_1400a8a48:
          ...
          uVar7 = param_11 & 0xf;
          if (uVar7 != 0) {
            if ((param_11 & 1) != 0) goto LAB_1400a8a48;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar18 < (longlong)(uVar7 + 8)) goto LAB_1400a8a48;
...
LAB_1400a85dc:
  if (uVar14 == 1) {
    if ((longlong)uVar10 < 1) goto LAB_1400a887b;
...
LAB_1400a8a58:
          ...
          uVar7 = uVar18 & 0xf;
          if (uVar7 != 0) {
            if ((uVar18 & 1) != 0) goto LAB_1400a8a58;
            uVar7 = 0x10 - uVar7 >> 1;
          }
          if ((longlong)uVar10 < (longlong)(uVar7 + 8)) goto LAB_1400a8a58;
          uVar17 = 0;
  ...
  if ((uVar14 != 6) || ((longlong)uVar10 < 1)) goto LAB_1400a887b;
  if ((longlong)uVar10 < 8) {
LAB_1400a8a50:
    uVar7 = 0;
  }
    ...
    if (uVar18 != 0) {
      if ((lVar20 - 2U & 1) != 0) goto LAB_1400a8a50;
      uVar18 = 0x10 - uVar18 >> 1;
    }
    if ((longlong)uVar10 < (longlong)(uVar18 + 8)) goto LAB_1400a8a50;
    uVar17 = 0;
...
LAB_1400a887b:
                    /* WARNING: Could not recover jumptable at 0x0001400a88b4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&UNK_143086aa0 + lVar4 * 8))(param_11 + uVar10 * 2,param_4,uVar10);
  return;
}
