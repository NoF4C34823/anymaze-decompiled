...
/* WARNING: Removing unreachable block (ram,0x0001409437ea) */

void FUN_140941a00(longlong param_1,longlong param_2,float *param_3,longlong param_4,
...

{
  ...
  lStack_60 = param_2;
  if (iVar19 < 1) {
    if ((param_7 & 0x10) != 0) goto LAB_140943dbd;
  }
  else {
    ...
    if ((param_7 & 0x10) != 0) {
      ...
      uStack_1b0 = 0;
      uStack_110 = 0;
      pcStack_d8 = (code *)(&PTR_FUN_14308d700)[lVar14];
            ...
            if (lStack_c8 < (longlong)(uVar18 + uVar22)) {
              ...
              do {
                ...
                if (lVar8 < 0) {
                  if (uStack_118 != 0xf0) {
                    if (iVar19 == 6) {
                      if (uStack_e0 == 0) goto LAB_140943d37;
                    }
                    else {
                      if (iVar19 != 1) goto LAB_140943cad;
LAB_140943e5b:
                      lVar12 = 0;
                      if (uStack_e0 != 0) {
                        lVar12 = lVar8;
...
LAB_140943d1b:
                  ...
                  if ((lVar8 < (longlong)uVar22) || (uStack_118 == 0xf0)) goto LAB_140943d1b;
                  if (iVar19 != 6) {
                    if (iVar19 == 1) {
                      if (lVar8 < 0) goto LAB_140943e5b;
                      if (uStack_b8 == 0) {
                        lVar12 = lStack_100;
                      }
                    }
...
LAB_140943e80:
                  ...
                  if (uStack_b8 != 0) goto LAB_140943d1b;
LAB_140943d37:
                  uVar6 = *puVar24;
                  uVar16 = puVar24[1];
                  uVar21 = puVar24[2];
...
LAB_140943dfb:
                      ...
                      if ((longlong)uStack_f8 < 0x2b9) {
                        ...
                        if (((uStack_148 != 0) && (uVar15 = uStack_190, uStack_150 != 0)) ||
                           ((longlong)uStack_f8 < (longlong)(uVar15 + 0x10))) goto LAB_140943dfb;
...
LAB_140942c41:
                    ...
                    uVar6 = puStack_d0[2];
                    if ((longlong)uStack_178 < 0x10) goto LAB_140942c41;
                    uVar15 = 0;
                    lVar14 = 0;
                    do {
                      uVar16 = *puStack_d0;
...
LAB_140941ec5:
            ...
            if ((longlong)uVar18 < 0xbd) {
              ...
              if (uVar15 != 0) {
                if (((ulonglong)pfVar17 & 3) != 0) goto LAB_140941ec5;
                uVar15 = 0x20 - uVar15 >> 2;
              }
              if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_140941ec5;
              uVar26 = 0;
    ...
    if ((uStack_48 ^ (ulonglong)auStack_218) != DAT_1436b4680) goto LAB_140941bda;
  }
  else {
    if (uVar13 == 3) {
...
LAB_140941d65:
              ...
              if ((longlong)uVar18 < 0xbd) {
                ...
                uVar15 = (ulonglong)pfVar17 & 0x1f;
                if (uVar15 != 0) {
                  if (((ulonglong)pfVar17 & 3) != 0) goto LAB_140941d65;
                  uVar15 = 0x20 - uVar15 >> 2;
                }
                if ((longlong)uVar18 < (longlong)(uVar15 + 8)) goto LAB_140941d65;
                lVar8 = (longlong)param_3 + (lVar25 - lVar8);
                uVar26 = 0;
                uVar22 = uVar18 - (uVar18 - uVar15 & 7);
                if (uVar15 != 0) {
