...
void FUN_14085fce0(longlong param_1,longlong param_2,int param_3,ulonglong param_4,ulonglong param_5
...
LAB_1408604cc:
      ...
      uVar47 = uVar46 & 0x1f;
      if (uVar47 != 0) {
        if ((uVar46 & 3) != 0) goto LAB_1408604cc;
        uVar47 = 0x20 - uVar47 >> 2;
      }
      if ((longlong)param_5 < (longlong)(uVar47 + 8)) goto LAB_1408604cc;
  ...
  if (param_8 != 0) {
    ...
    if (7 < (longlong)param_5) {
      uVar46 = param_4 & 0x1f;
      if (uVar46 != 0) {
        if ((param_4 & 1) != 0) goto LAB_1408604da;
...
LAB_14086044d:
  ...
  if (7 < (longlong)param_5) {
    uVar46 = param_4 & 0xf;
    if (uVar46 != 0) {
      if ((param_4 & 1) != 0) goto LAB_1408604d3;
